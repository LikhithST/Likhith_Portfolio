import { Bn as darken_default, Jn as __name, Ln as setupGraphViewbox, Mn as sanitizeText, Mt as load, Nt as selectSvgElement, Sn as getConfig2, Un as is_dark_default, Vn as lighten_default, Yn as log, _ as positionNode, h as insertNode, jt as JSON_SCHEMA, m as insertCluster, vn as defaultConfig_default } from "./index-BgJKKt_a.js";
...
var getSection = /* @__PURE__ */ __name((level) => {
  ...
  if (level === (lastSection == null ? void 0 : lastSection.level)) return null;
  return lastSection;
}, "getSection");
...
var addNode = /* @__PURE__ */ __name((level, id, descr, type, shapeData) => {
  ...
  if (shapeData !== void 0) {
    ...
    if ((doc == null ? void 0 : doc.shape) && doc.shape === "kanbanItem") node.shape = doc == null ? void 0 : doc.shape;
    if (doc == null ? void 0 : doc.label) node.label = doc == null ? void 0 : doc.label;
    if (doc == null ? void 0 : doc.icon) node.icon = doc == null ? void 0 : doc.icon.toString();
    if (doc == null ? void 0 : doc.assigned) node.assigned = doc == null ? void 0 : doc.assigned.toString();
    if (doc == null ? void 0 : doc.ticket) node.ticket = doc == null ? void 0 : doc.ticket.toString();
    if (doc == null ? void 0 : doc.priority) node.priority = doc == null ? void 0 : doc.priority;
  }
...
var kanbanRenderer_default = { draw: /* @__PURE__ */ __name(async (text, id, _version, diagObj) => {
  ...
  setupGraphViewbox(void 0, svg, ((_d = conf.mindmap) == null ? void 0 : _d.padding) ?? defaultConfig_default.kanban.padding, ((_e = conf.mindmap) == null ? void 0 : _e.useMaxWidth) ?? defaultConfig_default.kanban.useMaxWidth);
}, "draw") };
