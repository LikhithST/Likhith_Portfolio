import { B as e, C as t, V as n, W as r, _ as i, a, b as o, c as s, v as c } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { h as l, p as u } from "./src-BWB47EtT.js";
import "./path-CAD_RBb9.js";
import "./dist-DAHuMNYw.js";
import { t as d } from "./arc-BIRuGYHE.js";
import { t as f } from "./chunk-FMBD7UC4-DqZjeowl.js";
import { a as p, n as m, o as h, s as g } from "./chunk-YZCP3GAM-C30yAzNl.js";
var _ = (function() {
...
var v = _, y = ``, b = [], x = [], S = [], C = l(function() {
  ...
  return t2;
}, `compileTasks`), j = { getConfig: l(() => o().journey, `getConfig`), clear: C, setDiagramTitle: r, getDiagramTitle: t, setAccTitle: n, getAccTitle: c, setAccDescription: e, getAccDescription: i, addSection: w, getSections: T, getTasks: E, addTask: O, addTaskOrg: k, getActors: l(function() {
  return D();
...
}, `drawSection`), z = -1, B = l(function(e2, t2, n2, r2) {
...
})(), U = { drawRect: N, drawCircle: F, drawSection: R, drawText: I, drawLabel: L, drawTask: B, drawBackgroundRect: V, initGraphics: l(function(e2, t2) {
...
l(q, `drawActorLegend`);
var J = o().journey, Y = 0, ee = l(function(e2, t2, n2, r2) {
  let i2 = o(), a2 = i2.journey.titleColor, c2 = i2.journey.titleFontSize, l2 = i2.journey.titleFontFamily, d2 = i2.securityLevel, f2;
  ...
  let y2 = X.getBounds();
  g2 && m2.append(`text`).text(g2).attr(`x`, Y).attr(`font-size`, c2).attr(`font-weight`, `bold`).attr(`y`, 25).attr(`fill`, a2).attr(`font-family`, l2);
  let b2 = y2.stopy - y2.starty + 2 * J.diagramMarginY, x2 = Y + y2.stopx + 2 * J.diagramMarginX;
  s(m2, b2, x2, J.useMaxWidth), m2.append(`line`).attr(`x1`, Y).attr(`y1`, J.height * 4).attr(`x2`, x2 - Y - 4).attr(`y2`, J.height * 4).attr(`stroke-width`, 4).attr(`stroke`, `black`).attr(`marker-end`, `url(#` + t2 + `-arrowhead)`);
  let S2 = g2 ? 70 : 0;
  ...
  let i2 = o().journey, a2 = this, s2 = 0;
  function c2(o2) {
    return l(function(c3) {
      s2++;
      let l2 = a2.sequenceItems.length - s2 + 1;
      a2.updateVal(c3, `starty`, t2 - l2 * i2.boxMargin, Math.min), a2.updateVal(c3, `stopy`, r2 + l2 * i2.boxMargin, Math.max), a2.updateVal(X.data, `startx`, e2 - l2 * i2.boxMargin, Math.min), a2.updateVal(X.data, `stopx`, n2 + l2 * i2.boxMargin, Math.max), o2 !== `activation` && (a2.updateVal(c3, `startx`, e2 - l2 * i2.boxMargin, Math.min), a2.updateVal(c3, `stopx`, n2 + l2 * i2.boxMargin, Math.max), a2.updateVal(X.data, `starty`, t2 - l2 * i2.boxMargin, Math.min), a2.updateVal(X.data, `stopy`, r2 + l2 * i2.boxMargin, Math.max));
    }, `updateItemBounds`);
  }
  ...
  return this.data;
}, `getBounds`) }, Z = J.sectionFills, Q = J.sectionColours, te = l(function(e2, t2, n2, r2) {
...
}, `drawTasks`), $ = { setConf: W, draw: ee }, ne = { parser: v, db: j, renderer: $, styles: M, init: l((e2) => {
