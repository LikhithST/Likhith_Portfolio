import { R as on, aY as $n, V as cn, Y as un, a as ln, aK as ue, al as On, a6 as oe, a2 as Hn, b1 as Nn, a7 as Pn, b4 as Rn, a3 as Vn, b2 as zn, b as d, a5 as Ft, a$ as Bt, F as qn, P as rt, aF as Tt, A as Zn, W as Bn, u as Xn, bl as Gn } from "./index-ZamPsWkW.js";
import { b as jn, t as Ne, c as Qn, a as Jn, l as Kn } from "./linear-CN2gQIx8.js";
...
cn(ft, mr, un(ln, { brighter(t) {
  return new ft(this.l + ne * (t ?? 1), this.a, this.b, this.opacity);
}, darker(t) {
  return new ft(this.l - ne * (t ?? 1), this.a, this.b, this.opacity);
}, rgb() {
  var t = (this.l + 16) / 116, e = isNaN(this.a) ? t : t + this.a / 500, n = isNaN(this.b) ? t : t - this.b / 200;
  return e = dn * de(e), t = hn * de(t), n = mn * de(n), new on(he(3.1338561 * e - 1.6168667 * t - 0.4906146 * n), he(-0.9787684 * e + 1.9161415 * t + 0.033454 * n), he(0.0719453 * e - 0.2289914 * t + 1.4052427 * n), this.opacity);
} }));
function fe(t) {
...
function et(t, e, n, r) {
  ...
  return i.floor = (a) => (t(a = /* @__PURE__ */ new Date(+a)), a), i.ceil = (a) => (t(a = new Date(a - 1)), e(a, 1), t(a), a), i.round = (a) => {
    ...
    if (c >= c) if (m < 0) for (; ++m <= 0; ) for (; e(c, -1), !a(c); ) ;
...
Tr.range;
const xt = et((t) => t.setHours(0, 0, 0, 0), (t, e) => t.setDate(t.getDate() + e), (t, e) => (e - t - (e.getTimezoneOffset() - t.getTimezoneOffset()) * ct) / yt, (t) => t.getDate() - 1);
xt.range;
const _e = et((t) => {
...
function Sr(t, e, n, r, i, a) {
  const c = [[vt, 1, mt], [vt, 5, 5 * mt], [vt, 15, 15 * mt], [vt, 30, 30 * mt], [a, 1, ct], [a, 5, 5 * ct], [a, 15, 15 * ct], [a, 30, 30 * ct], [i, 1, gt], [i, 3, 3 * gt], [i, 6, 6 * gt], [i, 12, 12 * gt], [r, 1, yt], [r, 2, 2 * yt], [n, 1, Se], [e, 1, Re], [e, 3, 3 * Re], [t, 1, ke]];
  function m(C, k, L) {
    const _ = k < C;
    _ && ([C, k] = [k, C]);
...
var St, ie;
Yi({ dateTime: "%x, %X", date: "%-m/%-d/%Y", time: "%-I:%M:%S %p", periods: ["AM", "PM"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] });
function Yi(t) {
  ...
  return tn || (tn = 1, (function(t, e) {
    (function(n, r) {
      ...
      return function(U, I, N) {
        N.p.customParseFormat = true, U && U.parseTwoDigitYear && (C = U.parseTwoDigitYear);
        ...
        W.parse = function(j) {
          ...
          if (typeof h == "string") {
            ...
            })(p, h, g, N), this.init(), v && v !== true && (this.$L = this.locale(v).$L), T && p != this.format(h) && (this.$d = /* @__PURE__ */ new Date("")), Y = {};
  ...
  return nn || (nn = 1, (function(t, e) {
    (function(n, r) {
      ...
      var n, r, i = 1e3, a = 6e4, c = 36e5, m = 864e5, Y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, C = 31536e6, k = 2628e6, L = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, _ = { years: C, months: k, days: m, hours: c, minutes: a, seconds: i, milliseconds: 1, weeks: 6048e5 }, S = function(p) {
        ...
        return p ? U(p) ? { negative: true, format: "" + N(p) + g } : { negative: false, format: "" + p + g } : { negative: false, format: "" };
      }, q = (function() {
        function p(y, h, D) {
          var w = this;
...
` + O.showPosition() + `
Expecting ` + Zt.join(", ") + ", got '" + (this.terminals_[$] || $) + "'" : ce = "Parse error on line " + (E + 1) + ": Unexpected " + ($ == P ? "end of input" : "'" + (this.terminals_[$] || $) + "'"), this.parseError(ce, { text: O.match, token: this.terminals_[$] || $, line: O.yylineno, loc: H, expected: Zt });
      }
      if (G[0] instanceof Array && G.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + Q + ", token: " + $);
      switch (G[0]) {
        case 1:
          x.push($), F.push(O.yytext), o.push(O.yylloc), x.push(G[1]), $ = null, z = O.yyleng, s = O.yytext, E = O.yylineno, H = O.yylloc;
          break;
        case 2:
          if (ut = this.productions_[G[1]][1], at.$ = F[F.length - ut], at._$ = { first_line: o[o.length - (ut || 1)].first_line, last_line: o[o.length - 1].last_line, first_column: o[o.length - (ut || 1)].first_column, last_column: o[o.length - 1].last_column }, R && (at._$.range = [o[o.length - (ut || 1)].range[0], o[o.length - 1].range[1]]), it = this.performAction.apply(at, [s, z, E, st.yy, G[1], F, o].concat(K)), typeof it < "u") return it;
    ...
    var v = { EOF: 1, parseError: d(function(f, x) {
      if (this.yy.parser) this.yy.parser.parseError(f, x);
      else throw new Error(f);
    }, "parseError"), setInput: d(function(u, f) {
      return this.yy = f || this.yy || {}, this._input = u, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: x ? (x.length === b.length ? this.yylloc.first_column : 0) + b[b.length - x.length].length - x[0].length : this.yylloc.first_column - f }, this.options.ranges && (this.yylloc.range = [F[0], F[0] + this.yyleng - f]), this.yyleng = this.yytext.length, this;
...
` + f + "^";
      ...
      for (var F = this._currentRules(), o = 0; o < F.length; o++) if (x = this._input.match(this.rules[F[o]]), x && (!f || x[0].length > f[0].length)) {
        if (f = x, b = o, this.options.backtrack_lexer) {
          if (u = this.test_match(x, F[o]), u !== false) return u;
          if (this._backtrack) {
            f = false;
            continue;
          } else return false;
      ...
      return f ? (u = this.test_match(f, F[b]), u !== false ? u : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: d(function() {
      var f = this.next();
      return f || this.lex();
    }, "lex"), begin: d(function(f) {
    ...
    }, "_currentRules"), topState: d(function(f) {
      return f = this.conditionStack.length - 1 - Math.abs(f || 0), f >= 0 ? this.conditionStack[f] : "INITIAL";
    }, "topState"), pushState: d(function(f) {
      this.begin(f);
    }, "pushState"), stateStackSize: d(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: d(function(f, x, b, F) {
      switch (b) {
        case 0:
...
rt.extend(Pi);
rt.extend(qi);
var rn = { friday: 5, saturday: 6 }, lt = "", Fe = "", Ye = void 0, Ue = "", Vt = [], zt = [], Ee = /* @__PURE__ */ new Map(), Ie = [], se = [], Lt = "", Le = "", Fn = ["active", "done", "crit", "milestone", "vert"], Ae = [], _t = "", qt = false, We = false, $e = "sunday", ae = "saturday", De = 0, Qi = d(function() {
  Ie = [], se = [], Lt = "", Ae = [], te = 0, Ce = void 0, ee = void 0, tt = [], lt = "", Fe = "", Le = "", Ye = void 0, Ue = "", Vt = [], zt = [], qt = false, We = false, De = 0, Ee = /* @__PURE__ */ new Map(), _t = "", Xn(), $e = "sunday", ae = "saturday";
}, "clear"), Ji = d(function(t) {
  _t = t;
}, "setDiagramId"), Ki = d(function(t) {
  Fe = t;
}, "setAxisFormat"), ts = d(function() {
  return Fe;
}, "getAxisFormat"), es = d(function(t) {
  Ye = t;
}, "setTickInterval"), ns = d(function() {
  return Ye;
}, "getTickInterval"), rs = d(function(t) {
  Ue = t;
}, "setTodayMarker"), is = d(function() {
  return Ue;
}, "getTodayMarker"), ss = d(function(t) {
  lt = t;
}, "setDateFormat"), as = d(function() {
  qt = true;
}, "enableInclusiveEndDates"), os = d(function() {
  return qt;
}, "endDatesAreInclusive"), cs = d(function() {
  We = true;
}, "enableTopAxis"), us = d(function() {
  return We;
}, "topAxisEnabled"), ls = d(function(t) {
  Le = t;
}, "setDisplayMode"), fs = d(function() {
  return Le;
}, "getDisplayMode"), ds = d(function() {
  return lt;
}, "getDateFormat"), hs = d(function(t) {
  Vt = t.toLowerCase().split(/[\s,]+/);
}, "setIncludes"), ms = d(function() {
  return Vt;
}, "getIncludes"), gs = d(function(t) {
  zt = t.toLowerCase().split(/[\s,]+/);
}, "setExcludes"), ys = d(function() {
  return zt;
}, "getExcludes"), ks = d(function() {
  return Ee;
}, "getLinks"), ps = d(function(t) {
  Lt = t, Ie.push(t);
}, "addSection"), vs = d(function() {
  return Ie;
}, "getSections"), Ts = d(function() {
  let t = sn();
  const e = 10;
  let n = 0;
  for (; !t && n < e; ) t = sn(), n++;
  return se = tt, se;
}, "getTasks"), Yn = d(function(t, e, n, r) {
  const i = t.format(e.trim()), a = t.format("YYYY-MM-DD");
  return r.includes(i) || r.includes(a) ? false : n.includes("weekends") && (t.isoWeekday() === rn[ae] || t.isoWeekday() === rn[ae] + 1) || n.includes(t.format("dddd").toLowerCase()) ? true : n.includes(i) || n.includes(a);
}, "isInvalidDate"), xs = d(function(t) {
  $e = t;
}, "setWeekday"), bs = d(function() {
  return $e;
}, "getWeekday"), ws = d(function(t) {
  ae = t;
}, "setWeekend"), Un = d(function(t, e, n, r) {
  if (!n.length || t.manualEndTime) return;
  let i;
  t.startTime instanceof Date ? i = rt(t.startTime) : i = rt(t.startTime, e, true), i = i.add(1, "d");
  let a;
  t.endTime instanceof Date ? a = rt(t.endTime) : a = rt(t.endTime, e, true);
  const [c, m] = Ds(i, a, e, n, r);
  t.endTime = c.toDate(), t.renderEndTime = m;
}, "checkTaskDates"), Ds = d(function(t, e, n, r, i) {
  let a = false, c = null;
  const m = e.add(1e4, "d");
  for (; t <= e; ) {
    if (a || (c = e.toDate()), a = Yn(t, n, r, i), a && (e = e.add(1, "d"), e > m)) throw new Error("Failed to find a valid date that was not excluded by `excludes` after 10,000 iterations.");
    t = t.add(1, "d");
  }
  return [e, c];
}, "fixTaskDates"), Me = d(function(t, e, n) {
  if (n = n.trim(), d((m) => {
    const Y = m.trim();
    return Y === "x" || Y === "X";
  }, "isTimestampFormat")(e) && /^\d+$/.test(n)) return new Date(Number(n));
  ...
  let c = rt(n, e.trim(), true);
  if (c.isValid()) return c.toDate();
  {
    Tt.debug("Invalid date:" + n), Tt.debug("With date format:" + e.trim());
    const m = new Date(n);
    if (m === void 0 || isNaN(m.getTime()) || m.getFullYear() < -1e4 || m.getFullYear() > 1e4) throw new Error("Invalid date:" + n);
    return m;
  }
}, "getStartDate"), En = d(function(t) {
  const e = /^(\d+(?:\.\d+)?)([Mdhmswy]|ms)$/.exec(t.trim());
  return e !== null ? [Number.parseFloat(e[1]), e[2]] : [NaN, "ms"];
}, "parseDuration"), In = d(function(t, e, n, r = false) {
  n = n.trim();
  ...
  return m.toDate();
}, "getEndDate"), te = 0, Ut = d(function(t) {
  return t === void 0 ? (te = te + 1, "task" + te) : t;
}, "parseId"), Ms = d(function(t, e) {
  let n;
  ...
  return a && (i.endTime = In(i.startTime, lt, a, qt), i.manualEndTime = rt(a, "YYYY-MM-DD", true).isValid(), Un(i, lt, zt, Vt)), i;
}, "compileData"), Cs = d(function(t, e) {
  let n;
  e.substr(0, 1) === ":" ? n = e.substr(1, e.length) : n = e;
  const r = n.split(","), i = {};
  Oe(r, i, Fn);
  ...
  return i;
}, "parseData"), Ce, ee, tt = [], Ln = {}, Ss = d(function(t, e) {
  const n = { section: Lt, type: Lt, processed: false, manualEndTime: false, renderEndTime: null, raw: { data: e }, task: t, classes: [] }, r = Cs(ee, e);
  ...
  const e = Ln[t];
  return tt[e];
}, "findTaskById"), _s = d(function(t, e) {
  const n = { section: Lt, type: Lt, description: t, task: t, classes: [] }, r = Ms(Ce, e);
  ...
  const t = d(function(n) {
    ...
    return tt[n].startTime && (tt[n].endTime = In(tt[n].startTime, lt, tt[n].raw.endTime.data, qt), tt[n].endTime && (tt[n].processed = true, tt[n].manualEndTime = rt(tt[n].raw.endTime.data, "YYYY-MM-DD", true).isValid(), Un(tt[n], lt, zt, Vt))), tt[n].processed;
  }, "compileTask");
  let e = true;
  for (const [n, r] of tt.entries()) t(n), e = e && r.processed;
  return e;
}, "compileTasks"), Fs = d(function(t, e) {
  let n = e;
...
}, "setLink"), An = d(function(t, e) {
  t.split(",").forEach(function(n) {
    let r = Ct(n);
    r !== void 0 && r.classes.push(e);
  });
}, "setClass"), Ys = d(function(t, e, n) {
...
}, "pushFun"), Us = d(function(t, e, n) {
  t.split(",").forEach(function(r) {
    Ys(r, e, n);
  }), An(t, "clickable");
}, "setClickEvent"), Es = d(function(t) {
...
function Oe(t, e, n) {
  ...
  for (; r; ) r = false, n.forEach(function(i) {
    ...
    t[0].match(c) && (e[i] = true, t.shift(1), r = true);
  });
}
d(Oe, "getTaskTags");
rt.extend(Gi);
var Ls = d(function() {
...
}, "setConf"), an = { monday: Nt, tuesday: vn, wednesday: Tn, thursday: bt, friday: xn, saturday: bn, sunday: Rt }, As = d((t, e) => {
  let n = [...t].map(() => -1 / 0), r = [...t].sort((a, c) => a.startTime - c.startTime || a.order - c.order), i = 0;
  for (const a of r) for (let c = 0; c < n.length; c++) if (a.startTime >= n[c]) {
    n[c] = a.endTime, a.order = c + e, c > i && (i = c);
    break;
  }
  return i;
}, "getMaxIntersections"), dt, Te = 1e4, Ws = d(function(t, e, n, r) {
  const i = Ft().gantt;
  r.db.setDiagramId(e);
  ...
  const Z = m.select(`[id="${e}"]`), A = Ii().domain([nr(k, function(h) {
    return h.startTime;
  }), er(k, function(h) {
    return h.endTime;
  ...
  function I(h, D, w) {
    ...
    W(v, u, f, D, w, h, r.db.getExcludes(), r.db.getIncludes()), j(f, u, D, w), N(h, v, u, f, T, x, D), p(v, u), g(f, u, D, w);
  }
  d(I, "makeGantt");
  function N(h, D, w, T, v, u, f) {
    ...
    Z.append("g").selectAll("rect").data(b).enter().append("rect").attr("x", 0).attr("y", function(s, E) {
      ...
      for (const [E, z] of L.entries()) if (s.type === z) return "section section" + E % i.numberSectionStyles;
    ...
    if (F.append("rect").attr("id", function(s) {
      ...
      if (s.milestone && (E += 0.5 * (A(s.endTime) - A(s.startTime)) - 0.5 * v, z = E + v), s.vert) return A(s.startTime) + T;
  ...
  function W(h, D, w, T, v, u, f, x) {
    ...
    let b, F;
    for (const { startTime: V, endTime: P } of u) (b === void 0 || V < b) && (b = V), (F === void 0 || P > F) && (F = P);
    if (!b || !F) return;
    ...
    let s = null, E = rt(b);
    for (; E.valueOf() <= F; ) r.db.isInvalidDate(E, o, f, x) ? s ? s.end = E : s = { start: E, end: E } : s && (X.push(s), s = null), E = E.add(1, "d");
  ...
  function j(h, D, w, T) {
    ...
    if (F !== null) {
      ...
      if (isNaN(o) || o <= 0) Tt.warn(`Invalid tick interval value: "${F[1]}". Skipping custom tick interval.`);
        ...
        if (P > Te) Tt.warn(`The tick interval "${o}${X}" would generate ${P} ticks, which exceeds the maximum allowed (${Te}). This may indicate an invalid date or time range. Skipping custom tick interval.`);
        else switch (X) {
          case "millisecond":
            x.ticks(Et.every(o));
            break;
  ...
  function p(h, D) {
    ...
    Z.append("g").selectAll("text").data(T).enter().append(function(v) {
      ...
      for (const [u, f] of L.entries()) if (v[0] === f) return "sectionTitle sectionTitle" + u % i.numberSectionStyles;
      return "sectionTitle";
    });
  }
  d(p, "vertLabels");
  ...
  function y(h) {
    const D = {}, w = [];
    for (let T = 0, v = h.length; T < v; ++T) Object.prototype.hasOwnProperty.call(D, h[T]) || (D[h[T]] = true, w.push(h[T]));
    return w;
  }
  d(y, "checkUnique");
}, "draw"), $s = { setConf: Ls, draw: Ws }, Os = d((t) => `
  .mermaid-main-font {
...
`, "getStyles"), Hs = Os, zs = { parser: ji, db: Is, renderer: $s, styles: Hs };
export {
  zs as diagram
};
