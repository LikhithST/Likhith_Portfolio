var _a, _b, _c;
import { B as e, C as t, K as n, V as r, W as i, _ as a, a as o, b as s, s as c, u as l, v as u } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { h as d, p as f } from "./src-BWB47EtT.js";
import { t as p } from "./ordinal-BV8Hym1O.js";
...
var J = q, Y = [], X = [], Z = /* @__PURE__ */ new Map(), se = d(() => {
...
}, d(_b, `SankeyNode`), _b), Q = { nodesMap: Z, getConfig: d(() => s().sankey, `getConfig`), getNodes: d(() => X, `getNodes`), getLinks: d(() => Y, `getLinks`), getGraph: d(() => ({ nodes: X.map((e2) => ({ id: e2.ID })), links: Y.map((e2) => ({ source: e2.source.ID, target: e2.target.ID, value: e2.value })) }), `getGraph`), addLink: le, findOrCreateNode: d((e2) => {
  e2 = c.sanitizeText(e2, s());
  let t2 = Z.get(e2);
  return t2 === void 0 && (t2 = new ue(e2), Z.set(e2, t2), X.push(t2)), t2;
}, `findOrCreateNode`), getAccTitle: u, setAccTitle: r, getAccDescription: a, setAccDescription: e, getDiagramTitle: t, setDiagramTitle: i, clear: se }, $ = (_c = class {
  static next(t2) {
  ...
  let { securityLevel: a2, sankey: o2 } = s(), c2 = l.sankey, u2;
  a2 === `sandbox` && (u2 = f(`#i` + t2));
  let m2 = f(a2 === `sandbox` ? u2.nodes()[0].contentDocument.body : `body`), g2 = a2 === `sandbox` ? m2.select(`[id="${t2}"]`) : f(`[id="${t2}"]`), _2 = (o2 == null ? void 0 : o2.width) ?? c2.width, v2 = (o2 == null ? void 0 : o2.height) ?? c2.width, y2 = (o2 == null ? void 0 : o2.useMaxWidth) ?? c2.useMaxWidth, b2 = (o2 == null ? void 0 : o2.nodeAlignment) ?? c2.nodeAlignment, x2 = (o2 == null ? void 0 : o2.prefix) ?? c2.prefix, S2 = (o2 == null ? void 0 : o2.suffix) ?? c2.suffix, C2 = (o2 == null ? void 0 : o2.showValues) ?? c2.showValues, w2 = i2.db.getGraph(), T2 = de[b2];
...
${x2}${Math.round(t3 * 100) / 100}${S2}` : e3, `getText`);
  ...
  let O2 = g2.append(`g`).attr(`class`, `links`).attr(`fill`, `none`).attr(`stroke-opacity`, 0.5).selectAll(`.link`).data(w2.links).join(`g`).attr(`class`, `link`).style(`mix-blend-mode`, `multiply`), k2 = (o2 == null ? void 0 : o2.linkColor) ?? `gradient`;
  if (k2 === `gradient`) {
