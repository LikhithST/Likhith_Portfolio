var _a;
import { g as He } from "./chunk-FMBD7UC4-CWNI7bB4.js";
import { b, b3 as Oe, aF as Q, a5 as g1, ac as qe, aW as Xe, bl as ie, b2 as Qe, b1 as Je, b4 as Ze, a3 as $e, a2 as et, a7 as tt, A as st, aE as it, J as rt, aA as at, a8 as te, a$ as se, aS as nt, u as ut, S as ot, aZ as lt } from "./index-ZamPsWkW.js";
import { c as ct } from "./chunk-ND2GUHAM-DzmzNlAU.js";
import { g as ht } from "./chunk-55IACEB6-CnEpZait.js";
import { s as dt } from "./chunk-2J33WTMH-Cyrzu2p0.js";
import { c as pt } from "./channel-NKhVdN5B.js";
var ft = "flowchart-", gt = (_a = class {
  constructor() {
    this.vertexCounter = 0, this.config = g1(), this.diagramId = "", this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = true, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = Qe, this.setAccDescription = Je, this.setDiagramTitle = Ze, this.getAccTitle = $e, this.getAccDescription = et, this.getDiagramTitle = tt, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen("gen-2");
  }
  sanitizeText(e) {
  ...
  lookUpDomId(e) {
    for (const i of this.vertices.values()) if (i.id === e) return this.diagramId ? `${this.diagramId}-${i.domId}` : i.domId;
...
` + f + `
    ...
    if (g === void 0 && (i === void 0 && r === void 0 && a !== void 0 && a !== null && Q.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), g = { id: e, labelType: "text", domId: ft + e + "-" + this.vertexCounter, styles: [], classes: [] }, this.vertices.set(e, g)), this.vertexCounter++, i !== void 0 ? (this.config = g1(), S = this.sanitizeText(i.text.trim()), g.labelType = i.type, S.startsWith('"') && S.endsWith('"') && (S = S.substring(1, S.length - 1)), g.text = S) : g.text === void 0 && (g.text = e), r !== void 0 && (g.type = r), a == null ? void 0 : a.forEach((E) => {
      g.styles.push(E);
    }), o == null ? void 0 : o.forEach((E) => {
      g.classes.push(E);
    }), d !== void 0 && (g.dir = d), g.props === void 0 ? g.props = l : l !== void 0 && Object.assign(g.props, l), n !== void 0) {
      if (n.shape) {
        if (n.shape !== n.shape.toLowerCase() || n.shape.includes("_")) throw new Error(`No such shape: ${n.shape}. Shape names should be lowercase.`);
        if (!at(n.shape)) throw new Error(`No such shape: ${n.shape}.`);
        g.type = n == null ? void 0 : n.shape;
      }
      (n == null ? void 0 : n.label) && (g.text = n == null ? void 0 : n.label, g.labelType = this.sanitizeNodeLabelType(n == null ? void 0 : n.labelType)), (n == null ? void 0 : n.icon) && (g.icon = n == null ? void 0 : n.icon, !((_a2 = n.label) == null ? void 0 : _a2.trim()) && g.text === e && (g.text = "")), (n == null ? void 0 : n.form) && (g.form = n == null ? void 0 : n.form), (n == null ? void 0 : n.pos) && (g.pos = n == null ? void 0 : n.pos), (n == null ? void 0 : n.img) && (g.img = n == null ? void 0 : n.img, !((_b = n.label) == null ? void 0 : _b.trim()) && g.text === e && (g.text = "")), (n == null ? void 0 : n.constraint) && (g.constraint = n.constraint), n.w && (g.assetWidth = Number(n.w)), n.h && (g.assetHeight = Number(n.h));
    }
  }
  addSingleLink(e, i, r, a) {
    const l = { start: e, end: i, type: void 0, text: "", labelType: "text", classes: [], isUserDefinedId: false, interpolate: this.edges.defaultInterpolate };
    Q.info("abc78 Got edge...", l);
    const f = r.text;
    if (f !== void 0 && (l.text = this.sanitizeText(f.text.trim()), l.text.startsWith('"') && l.text.endsWith('"') && (l.text = l.text.substring(1, l.text.length - 1)), l.labelType = this.sanitizeNodeLabelType(f.type)), r !== void 0 && (l.type = r.type, l.stroke = r.stroke, l.length = r.length > 10 ? 10 : r.length), a && !this.edges.some((n) => n.id === a)) l.id = a, l.isUserDefinedId = true;
    else {
      const n = this.edges.filter((A) => A.start === l.start && A.end === l.end);
      n.length === 0 ? l.id = te(l.start, l.end, { counter: 0, prefix: "L" }) : l.id = te(l.start, l.end, { counter: n.length + 1, prefix: "L" });
    }
    if (this.edges.length < (this.config.maxEdges ?? 500)) Q.info("Pushing edge..."), this.edges.push(l);
...
You have to call mermaid.initialize.`);
  ...
  addLink(e, i, r) {
    ...
    for (const o of e) for (const d of i) {
  ...
  setTooltip(e, i) {
    if (i !== void 0) {
      ...
      for (const r of e.split(",")) this.tooltips.set(this.version === "gen-1" ? this.lookUpDomId(r) : r, i);
    }
  }
  setClickFun(e, i, r) {
    ...
    o && (o.haveCallback = true, this.funs.push(() => {
  ...
  setupToolTips(e) {
    ...
    se(e).select("svg").selectAll("g.node").on("mouseover", (o) => {
      ...
      if (l === null) return;
      const f = (_a2 = o.currentTarget) == null ? void 0 : _a2.getBoundingClientRect();
      i.transition().duration(200).style("opacity", ".9"), i.text(d.attr("title")).style("left", window.scrollX + f.left + (f.right - f.left) / 2 + "px").style("top", window.scrollY + f.bottom + "px"), i.html(nt.sanitize(l)), d.classed("hover", true);
    }).on("mouseout", (o) => {
      i.transition().duration(500).style("opacity", 0), se(o.currentTarget).classed("hover", false);
    });
  }
  clear(e = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = "", this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = true, this.version = e, this.config = g1(), ut();
  }
  setGen(e) {
  ...
  addSubGraph(e, i, r) {
    ...
    const l = b((g) => {
      ...
      return { nodeList: g.filter(function(K) {
        const h1 = typeof K;
        return K.stmt && K.stmt === "dir" ? (_ = K.value, false) : K.trim() === "" ? false : h1 in E ? E[h1].hasOwnProperty(K) ? false : E[h1][K] = true : Z.includes(K) ? false : Z.push(K);
      }), dir: _ };
    }, "uniq")(i.flat()), f = l.nodeList;
    let n = l.dir;
    const A = g1().flowchart ?? {};
    if (n = n ?? (A.inheritDir ? this.getDirection() ?? g1().direction ?? void 0 : void 0), this.version === "gen-1") for (let g = 0; g < f.length; g++) f[g] = this.lookUpDomId(f[g]);
    a = a ?? "subGraph" + this.subCount, o = o || "", o = this.sanitizeText(o), this.subCount = this.subCount + 1;
    const S = { id: a, nodes: f, title: o.trim(), classes: [], dir: n, labelType: this.sanitizeNodeLabelType(r == null ? void 0 : r.type) };
  ...
  getPosForId(e) {
    for (const [i, r] of this.subGraphs.entries()) if (r.id === e) return i;
    return -1;
  }
  indexNodes2(e, i) {
    const r = this.subGraphs[i].nodes;
    if (this.secCount = this.secCount + 1, this.secCount > 2e3) return { result: false, count: 0 };
    if (this.posCrossRef[this.secCount] = i, this.subGraphs[i].id === e) return { result: true, count: 0 };
    let a = 0, o = 1;
    for (; a < r.length; ) {
  ...
  exists(e, i) {
    for (const r of e) if (r.nodes.includes(i)) return true;
    return false;
  }
  makeUniq(e, i) {
    const r = [];
  ...
  addNodeFromVertex(e, i, r, a, o, d) {
    var _a2;
    const l = r.get(e.id), f = a.get(e.id) ?? false, n = this.findNode(i, e.id);
    if (n) n.cssStyles = e.styles, n.cssCompiledStyles = this.getCompiledStyles(e.classes), n.cssClasses = e.classes.join(" ");
    else {
      const A = { id: e.id, label: e.text, labelType: e.labelType, labelStyle: "", parentId: l, padding: ((_a2 = o.flowchart) == null ? void 0 : _a2.padding) || 8, cssStyles: e.styles, cssCompiledStyles: this.getCompiledStyles(["default", "node", ...e.classes]), cssClasses: "default " + e.classes.join(" "), dir: e.dir, domId: e.domId, look: d, link: e.link, linkTarget: e.linkTarget, tooltip: this.getTooltip(e.id), icon: e.icon, pos: e.pos, img: e.img, assetWidth: e.assetWidth, assetHeight: e.assetHeight, constraint: e.constraint };
      f ? i.push({ ...A, isGroup: true, shape: "rect" }) : i.push({ ...A, isGroup: false, shape: this.getTypeFromVertex(e) });
    }
  }
  getCompiledStyles(e) {
    let i = [];
  ...
  getData() {
    ...
    for (let n = a.length - 1; n >= 0; n--) {
      const A = a[n];
      A.nodes.length > 0 && d.set(A.id, true);
      for (const S of A.nodes) o.set(S, A.id);
    }
    for (let n = a.length - 1; n >= 0; n--) {
      const A = a[n];
      i.push({ id: A.id, label: A.title, labelStyle: "", labelType: A.labelType, parentId: o.get(A.id), padding: 8, cssCompiledStyles: this.getCompiledStyles(A.classes), cssClasses: A.classes.join(" "), shape: "rect", dir: A.dir, isGroup: true, look: e.look });
    }
    ...
    return f.forEach((n, A) => {
      ...
      const Z = { id: te(n.start, n.end, { counter: A, prefix: "L" }, n.id), isUserDefinedId: n.isUserDefinedId, start: n.start, end: n.end, type: n.type ?? "normal", label: n.text, labelType: n.labelType, labelpos: "c", thickness: n.stroke, minlen: n.length, classes: (n == null ? void 0 : n.stroke) === "invisible" ? "" : "edge-thickness-normal edge-pattern-solid flowchart-link", arrowTypeStart: (n == null ? void 0 : n.stroke) === "invisible" || (n == null ? void 0 : n.type) === "arrow_open" ? "none" : S, arrowTypeEnd: (n == null ? void 0 : n.stroke) === "invisible" || (n == null ? void 0 : n.type) === "arrow_open" ? "none" : g, arrowheadStyle: "fill: #333", cssCompiledStyles: this.getCompiledStyles(n.classes), labelStyle: E, style: E, pattern: n.stroke, look: e.look, animate: n.animate, animation: n.animation, curve: n.interpolate || this.edges.defaultInterpolate || ((_a2 = e.flowchart) == null ? void 0 : _a2.curve) };
      r.push(Z);
...
}, b(_a, "FlowDB"), _a), bt = b(function(e, i) {
  return i.db.getClasses();
}, "getClasses"), At = b(async function(e, i, r, a) {
  var _a2;
  ...
  var e = b(function(f1, c, h, p) {
    ...
    for (var j, k1, X, $1, w1 = {}, H1, c1, Pe, q1; ; ) {
      if (k1 = p[p.length - 1], this.defaultActions[k1] ? X = this.defaultActions[k1] : ((j === null || typeof j > "u") && (j = Ge()), X = R1[k1] && R1[k1][j]), typeof X > "u" || !X.length || !X[0]) {
        var ee = "";
        q1 = [];
        for (H1 in R1[k1]) this.terminals_[H1] && H1 > ze && q1.push("'" + this.terminals_[H1] + "'");
        M.showPosition ? ee = "Parse error on line " + (B + 1) + `:
` + M.showPosition() + `
Expecting ` + q1.join(", ") + ", got '" + (this.terminals_[j] || j) + "'" : ee = "Parse error on line " + (B + 1) + ": Unexpected " + (j == Ne ? "end of input" : "'" + (this.terminals_[j] || j) + "'"), this.parseError(ee, { text: M.match, token: this.terminals_[j] || j, line: M.yylineno, loc: Z1, expected: q1 });
      }
      if (X[0] instanceof Array && X.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + k1 + ", token: " + j);
      switch (X[0]) {
        case 1:
          p.push(j), x.push(M.yytext), t.push(M.yylloc), p.push(X[1]), j = null, Re = M.yyleng, s = M.yytext, B = M.yylineno, Z1 = M.yylloc;
          break;
        case 2:
          if (c1 = this.productions_[X[1]][1], w1.$ = x[x.length - c1], w1._$ = { first_line: t[t.length - (c1 || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (c1 || 1)].first_column, last_column: t[t.length - 1].last_column }, je && (w1._$.range = [t[t.length - (c1 || 1)].range[0], t[t.length - 1].range[1]]), $1 = this.performAction.apply(w1, [s, Re, B, A1.yy, X[1], x, t].concat(Ke)), typeof $1 < "u") return $1;
    ...
    var f1 = { EOF: 1, parseError: b(function(h, p) {
      if (this.yy.parser) this.yy.parser.parseError(h, p);
      else throw new Error(h);
    }, "parseError"), setInput: b(function(c, h) {
...
` + h + "^";
    }, "showPosition"), test_match: b(function(c, h) {
      var p, u, x;
      if (this.options.backtrack_lexer && (x = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (x.yylloc.range = this.yylloc.range.slice(0))), u = c[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + c[0].length }, this.yytext += c[0], this.match += c[0], this.matches = c, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(c[0].length), this.matched += c[0], p = this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), p) return p;
      if (this._backtrack) {
      ...
      for (var x = this._currentRules(), t = 0; t < x.length; t++) if (p = this._input.match(this.rules[x[t]]), p && (!h || p[0].length > h[0].length)) {
        if (h = p, u = t, this.options.backtrack_lexer) {
          if (c = this.test_match(p, x[t]), c !== false) return c;
          if (this._backtrack) {
            h = false;
            continue;
          } else return false;
      ...
      return h ? (c = this.test_match(h, x[u]), c !== false ? c : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: b(function() {
      var h = this.next();
      return h || this.lex();
    }, "lex"), begin: b(function(h) {
...
var mt = Ue, Ct = b((e, i) => {
  ...
  ${He()}
`, "getStyles"), Et = Dt, Bt = { parser: mt, get db() {
  return new gt();
}, renderer: kt, styles: Et, init: b((e) => {
