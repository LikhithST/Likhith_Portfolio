...
function H(e, n, r) {
  n == "__proto__" && Ee ? Ee(e, n, { configurable: true, enumerable: true, value: r, writable: true }) : e[n] = r;
}
...
function S(e, n, r) {
  if (!O(r)) return false;
  var t = typeof n;
  return (t == "number" ? K(r) && Ke(n, r.length) : t == "string" && n in r) ? q(r[n], e) : false;
}
function pr(e) {
...
function mr(e) {
  if (!O(e)) return br(e);
  var n = Xe(e), r = [];
  for (var t in e) t == "constructor" && (n || !gr.call(e, t)) || r.push(t);
  return r;
}
function P(e) {
  return K(e) ? jn(e, true) : mr(e);
}
function A(e) {
...
b[ln] = b[bt] = b[It] = b[_t] = b[wt] = b[gt] = b[Ct] = b[At] = b[kt] = b[St] = b[jt] = b[xt] = b[Ot] = b[vn] = b[Et] = b[Tt] = b[Pt] = b[Lt] = b[Mt] = b[Rt] = b[$t] = b[Ft] = true;
b[mt] = b[hn] = b[Nt] = false;
function D(e, n, r, t, i, o) {
  ...
  var s = N(e);
  if (s) {
    if (a = Rr(e), !u) return an(e, a);
  } else {
    var l = ce(e), h = l == hn || l == yt;
    if (Je(e)) return fn(e, u);
    if (l == vn || l == ln || h && !i) {
      if (a = f || h ? {} : cn(e), !u) return f ? kr(e, Ir(a, e)) : Cr(e, Nr(a, e));
    } else {
      if (!b[l]) return i ? e : {};
      a = ot(e, l, u);
    }
...
var pn = Object.prototype, Yt = pn.hasOwnProperty, Ut = fe(function(e, n) {
  ...
  for (i && S(n[0], n[1], i) && (t = 1); ++r < t; ) for (var o = n[r], a = P(o), u = -1, f = a.length; ++u < f; ) {
    var d = a[u], s = e[d];
...
function Wt(e, n, r, t, i, o, a) {
  ...
  if (l) {
    ...
    s = f, h || v || p ? N(u) ? s = u : qn(u) ? s = an(u) : v ? (l = false, s = fn(f, true)) : p ? (l = false, s = sn(f, true)) : s = [] : Lr(f) || Le(f) ? (s = u, Le(u) ? s = Vt(u) : (!O(u) || Kn(u)) && (s = cn(f))) : l = false;
  }
  l && (a.set(f, s), i(s, f, t, o, a), a.delete(f)), ie(e, r, s);
}
function bn(e, n, r, t, i) {
  e !== n && Qe(n, function(o, a) {
    if (i || (i = new Ze()), O(o)) Wt(e, n, a, r, bn, t, i);
    else {
...
function we(e, n, r) {
  for (var t = -1, i = e.length; ++t < i; ) {
    var o = e[t], a = n(o);
    if (a != null && (u === void 0 ? a === a && !Y(a) : r(a, u))) var u = a, f = o;
  }
  return f;
}
function T(e) {
...
function ii(e, n) {
  if (e !== n) {
    ...
    if (!u && !d && !o && e > n || o && a && f && !u && !d || t && a && f || !r && f || !i) return 1;
    if (!t && !o && !d && e < n || d && r && i && !t && !o || u && r && i || !a && i || !f) return -1;
  }
  return 0;
}
function ai(e, n, r) {
...
function si(e, n, r, t) {
  for (var i = -1, o = di(fi((n - e) / (r || 1)), 0), a = Array(o); o--; ) a[++i] = e, e += r;
  return a;
}
function ci(e) {
  return function(n, r, t) {
...
class pi {
  ...
  toString() {
    for (var n = [], r = this._sentinel, t = r._prev; t !== r; ) n.push(JSON.stringify(t, bi)), t = t._prev;
    return "[" + n.join(", ") + "]";
  }
}
function $e(e) {
...
function xi(e) {
  ...
  c(n, function(t) {
    var i = e.edge(t);
    e.removeEdge(t), i.forwardName = t.name, i.reversed = true, e.setEdge(t.w, t.v, i, me("rev"));
  });
  function r(t) {
    return function(i) {
...
function Oi(e) {
  var n = [], r = {}, t = {};
  function i(o) {
    Object.prototype.hasOwnProperty.call(t, o) || (t[o] = true, r[o] = true, c(e.outEdges(o), function(a) {
...
function _i(e) {
  function n(r) {
    ...
    if (t.length && c(t, n), Object.prototype.hasOwnProperty.call(i, "minRank")) {
      ...
      for (var o = i.minRank, a = i.maxRank + 1; o < a; ++o) Ge(e, "borderLeft", "_bl", r, i, o), Ge(e, "borderRight", "_br", r, i, o);
    }
  }
  c(e.children(), n);
}
...
function Mi(e, n) {
  ...
  if (o !== t + 1) {
    e.removeEdge(n);
    var d = void 0, s, l;
    for (l = 0, ++t; t < o; ++l, ++t) u.points = [], d = { width: 0, height: 0, edgeLabel: u, edgeObj: n, rank: t }, s = k(e, "edge", d, "_d"), t === f && (d.width = u.width, d.height = u.height, d.dummy = "edge-label", d.labelpos = u.labelpos), e.setEdge(r, s, { weight: u.weight }, a), l === 0 && e.graph().dummyChains.push(s), r = s;
...
function Ri(e) {
  c(e.graph().dummyChains, function(n) {
    ...
    for (e.setEdge(r.edgeObj, t); r.dummy; ) i = e.successors(n)[0], e.removeNode(n), t.points.push({ x: r.x, y: r.y }), r.dummy === "edge-label" && (t.x = r.x, t.y = r.y, t.width = r.width, t.height = r.height), n = i, r = e.node(n);
  });
}
function ye(e) {
  var n = {};
  function r(t) {
    ...
    n[t] = true;
    var o = j(g(e.outEdges(t), function(a) {
...
function En(e) {
  var n = new E({ directed: false }), r = e.nodes()[0], t = e.nodeCount();
  n.setNode(r, {});
  for (var i, o; $i(n, e) < t; ) i = Fi(n, e), o = n.hasNode(i.v) ? M(e, i) : -M(e, i), Bi(n, e, o);
  return n;
}
function $i(e, n) {
  function r(t) {
...
function Fi(e, n) {
  return ge(n.edges(), function(r) {
    if (e.hasNode(r.v) !== e.hasNode(r.w)) return M(n, r);
  });
}
function Bi(e, n, r) {
...
function Pn(e, n, r, t, i, o) {
  Object.prototype.hasOwnProperty.call(t, n) || (t[n] = true, r || o.push(n), c(i(n), function(a) {
    Pn(e, a, r, t, i, o);
  }), r && o.push(n));
}
function Di(e, n) {
...
function L(e) {
  ...
  var n = En(e);
  Oe(n), xe(n, e);
  for (var r, t; r = In(n); ) t = _n(n, e, r), Cn(n, e, r, t);
}
function xe(e, n) {
  var r = Di(e, e.nodes());
...
function Ln(e, n, r) {
  ...
  return a || (o = false, a = n.edge(i, r)), u = a.weight, c(n.nodeEdges(r), function(f) {
...
function Nn(e, n, r, t, i) {
  var o = r, a = e.node(t);
  return n[t] = true, c(e.neighbors(t), function(u) {
...
function _n(e, n, r) {
  ...
  var o = e.node(t), a = e.node(i), u = o, f = false;
  o.lim > a.lim && (u = a, f = true);
...
function An(e, n, r, t, i, o, a) {
  ...
  e.setParent(f, a), s.borderTop = f, e.setParent(d, a), s.borderBottom = d, c(u, function(l) {
    ...
    e.setEdge(f, v, { weight: w, minlen: m, nestingEdge: true }), e.setEdge(p, d, { weight: w, minlen: m, nestingEdge: true });
...
function ea(e, n, r) {
  var t = na(e), i = new E({ compound: true }).setGraph({ root: t }).setDefaultNodeLabel(function(o) {
    return e.node(o);
  });
  return c(e.nodes(), function(o) {
    ...
    }), Object.prototype.hasOwnProperty.call(a, "minRank") && i.setNode(o, { borderLeft: a.borderLeft[n], borderRight: a.borderRight[n] }));
  }), i;
}
function na(e) {
...
function ra(e, n) {
  for (var r = 0, t = 1; t < n.length; ++t) r += ta(e, n[t - 1], n[t]);
  return r;
}
function ta(e, n, r) {
  for (var t = vi(r, g(r, function(d, s) {
    return s;
  })), i = A(g(n, function(d) {
    return F(g(e.outEdges(d), function(s) {
...
function Ve(e, n, r) {
  for (var t; n.length && (t = V(n)).i <= r; ) n.pop(), e.push(t.vs), r++;
  return r;
}
function sa(e) {
  return function(n, r) {
...
function pa(e) {
  ...
  c(e.graph().dummyChains, function(r) {
    for (var t = e.node(r), i = t.edgeObj, o = ba(e, n, i.v, i.w), a = o.path, u = o.lca, f = 0, d = a[f], s = true; r !== i.w; ) {
      if (t = e.node(r), s) {
        for (; (d = a[f]) !== u && e.node(d).maxRank < t.rank; ) f++;
        d === u && (s = false);
      }
      if (!s) {
        for (; f < a.length - 1 && e.node(d = a[f + 1]).minRank <= t.rank; ) f++;
        d = a[f];
      }
...
function ya(e, n) {
  if (e.node(n).dummy) return be(e.predecessors(n), function(r) {
...
function Sn(e, n, r) {
  ...
  var i = e[n];
  Object.defineProperty(i, r, { enumerable: true, configurable: true, value: true, writable: true });
}
function xa(e, n, r) {
  if (n > r) {
    var t = n;
...
function Ea(e, n, r, t, i) {
  ...
  function f(l, h) {
    for (var v = a.nodes(), p = v.pop(), w = {}; p; ) w[p] ? l(p) : (w[p] = true, v.push(p), v = v.concat(h(p))), p = v.pop();
  }
  function d(l) {
...
function _a(e, n, r) {
  return function(t, i, o) {
    ...
    if (f += a.width / 2, Object.prototype.hasOwnProperty.call(a, "labelpos")) switch (a.labelpos.toLowerCase()) {
      case "l":
        d = -a.width / 2;
        break;
      case "r":
    ...
    if (d && (f += r ? d : -d), d = 0, f += (a.dummy ? n : e) / 2, f += (u.dummy ? n : e) / 2, f += u.width / 2, Object.prototype.hasOwnProperty.call(u, "labelpos")) switch (u.labelpos.toLowerCase()) {
      case "l":
        d = u.width / 2;
        break;
      case "r":
...
var Ma = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], Ra = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, $a = ["acyclicer", "ranker", "rankdir", "align"], Fa = ["width", "height"], Ba = { width: 0, height: 0 }, Ga = ["minlen", "weight", "width", "height", "labeloffset"], Da = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" }, Ya = ["labelpos"];
function Ua(e) {
  var n = new E({ multigraph: true, compound: true }), r = te(e.graph());
  return n.setGraph(oe({}, Ra, re(r, Ma), W(r, $a))), c(e.nodes(), function(t) {
    var i = te(e.node(t));
    n.setNode(t, Ut(re(i, Fa), Ba)), n.setParent(t, e.parent(t));
  }), c(e.edges(), function(t) {
    var i = te(e.edge(t));
    n.setEdge(t, oe({}, Da, re(i, Ga), W(i, Ya)));
  }), n;
}
function Va(e) {
  var n = e.graph();
  ...
  c(n, function(r) {
    ...
    c(r, function(i, o) {
      ...
      a.order = o + t, c(a.selfEdges, function(u) {
        k(e, "selfedge", { width: u.label.width, height: u.label.height, rank: a.rank, order: o + ++t, e: u.e, label: u.label }, "_se");
      }), delete a.selfEdges;
    });
  });
}
function no(e) {
  c(e.nodes(), function(n) {
    ...
    if (r.dummy === "selfedge") {
      ...
      e.setEdge(r.e, r.label), e.removeNode(n), r.label.points = [{ x: i + 2 * a / 3, y: o - u }, { x: i + 5 * a / 6, y: o - u }, { x: i + a, y: o }, { x: i + 5 * a / 6, y: o + u }, { x: i + 2 * a / 3, y: o + u }], r.label.x = r.x, r.label.y = r.y;
    }
  });
}
function re(e, n) {
