import { g as gt } from "./chunk-FMBD7UC4-CT_3MNe0.js";
import { d as mt, g as lt, f as xt, e as kt } from "./chunk-ND2GUHAM-DaT9l4oE.js";
import { a2 as _t, b1 as vt, a3 as bt, b2 as wt, a7 as Tt, b4 as St, b as s, a5 as R, a$ as X, F as $t, u as Mt } from "./index-bLSjIDix.js";
import { d as it } from "./arc-BCoPnixk.js";
var U = (function() {
  var t = s(function(h, r, n, l) {
    for (n = n || {}, l = h.length; l--; n[h[l]] = r) ;
    return n;
  }, "o"), e = [6, 8, 10, 11, 12, 14, 16, 17, 18], a = [1, 9], f = [1, 10], i = [1, 11], u = [1, 12], p = [1, 13], o = [1, 14], g = { trace: s(function() {
  }, "trace"), yy: {}, symbols_: { error: 2, start: 3, journey: 4, document: 5, EOF: 6, line: 7, SPACE: 8, statement: 9, NEWLINE: 10, title: 11, acc_title: 12, acc_title_value: 13, acc_descr: 14, acc_descr_value: 15, acc_descr_multiline_value: 16, section: 17, taskName: 18, taskData: 19, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "journey", 6: "EOF", 8: "SPACE", 10: "NEWLINE", 11: "title", 12: "acc_title", 13: "acc_title_value", 14: "acc_descr", 15: "acc_descr_value", 16: "acc_descr_multiline_value", 17: "section", 18: "taskName", 19: "taskData" }, productions_: [0, [3, 3], [5, 0], [5, 2], [7, 2], [7, 1], [7, 1], [7, 1], [9, 1], [9, 2], [9, 2], [9, 1], [9, 1], [9, 2]], performAction: s(function(r, n, l, y, d, c, v) {
    var k = c.length - 1;
    switch (d) {
      case 1:
        return c[k - 1];
  ...
  }, "anonymous"), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, t(e, [2, 2], { 5: 3 }), { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: a, 12: f, 14: i, 16: u, 17: p, 18: o }, t(e, [2, 7], { 1: [2, 1] }), t(e, [2, 3]), { 9: 15, 11: a, 12: f, 14: i, 16: u, 17: p, 18: o }, t(e, [2, 5]), t(e, [2, 6]), t(e, [2, 8]), { 13: [1, 16] }, { 15: [1, 17] }, t(e, [2, 11]), t(e, [2, 12]), { 19: [1, 18] }, t(e, [2, 4]), t(e, [2, 9]), t(e, [2, 10]), t(e, [2, 13])], defaultActions: {}, parseError: s(function(r, n) {
...
` + _.showPosition() + `
Expecting ` + z.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : H = "Parse error on line " + (C + 1) + ": Unexpected " + (b == D ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(H, { text: _.match, token: this.terminals_[b] || b, line: _.yylineno, loc: Y, expected: z });
      }
      if (T[0] instanceof Array && T.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + A + ", token: " + b);
      switch (T[0]) {
        case 1:
          l.push(b), d.push(_.yytext), c.push(_.yylloc), l.push(T[1]), b = null, Q = _.yyleng, k = _.yytext, C = _.yylineno, Y = _.yylloc;
          break;
        case 2:
          if (M = this.productions_[T[1]][1], F.$ = d[d.length - M], F._$ = { first_line: c[c.length - (M || 1)].first_line, last_line: c[c.length - 1].last_line, first_column: c[c.length - (M || 1)].first_column, last_column: c[c.length - 1].last_column }, ft && (F._$.range = [c[c.length - (M || 1)].range[0], c[c.length - 1].range[1]]), q = this.performAction.apply(F, [k, Q, C, I.yy, T[1], d, c].concat(dt)), typeof q < "u") return q;
    ...
    var h = { EOF: 1, parseError: s(function(n, l) {
      if (this.yy.parser) this.yy.parser.parseError(n, l);
      else throw new Error(n);
    }, "parseError"), setInput: s(function(r, n) {
...
` + n + "^";
    }, "showPosition"), test_match: s(function(r, n) {
      var l, y, d;
      if (this.options.backtrack_lexer && (d = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (d.yylloc.range = this.yylloc.range.slice(0))), y = r[0].match(/(?:\r\n?|\n).*/g), y && (this.yylineno += y.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: y ? y[y.length - 1].length - y[y.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + r[0].length }, this.yytext += r[0], this.match += r[0], this.matches = r, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(r[0].length), this.matched += r[0], l = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), l) return l;
      if (this._backtrack) {
      ...
      for (var d = this._currentRules(), c = 0; c < d.length; c++) if (l = this._input.match(this.rules[d[c]]), l && (!n || l[0].length > n[0].length)) {
        if (n = l, y = c, this.options.backtrack_lexer) {
          if (r = this.test_match(l, d[c]), r !== false) return r;
          if (this._backtrack) {
            n = false;
            continue;
          } else return false;
      ...
      return n ? (r = this.test_match(n, d[y]), r !== false ? r : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: s(function() {
      var n = this.next();
      return n || this.lex();
    }, "lex"), begin: s(function(n) {
    ...
    }, "_currentRules"), topState: s(function(n) {
      return n = this.conditionStack.length - 1 - Math.abs(n || 0), n >= 0 ? this.conditionStack[n] : "INITIAL";
    }, "topState"), pushState: s(function(n) {
      this.begin(n);
    }, "pushState"), stateStackSize: s(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: s(function(n, l, y, d) {
      switch (y) {
        case 0:
          break;
        case 1:
...
U.parser = U;
var Et = U, V = "", J = [], L = [], B = [], Ct = s(function() {
  J.length = 0, L.length = 0, V = "", B.length = 0, Mt();
}, "clear"), Pt = s(function(t) {
  V = t, J.push(t);
}, "addSection"), It = s(function() {
  return J;
}, "getSections"), At = s(function() {
  let t = rt();
  const e = 100;
  let a = 0;
  for (; !t && a < e; ) t = rt(), a++;
  return L.push(...B), L;
}, "getTasks"), Ft = s(function() {
  const t = [];
  return L.forEach((a) => {
    a.people && t.push(...a.people);
  }), [...new Set(t)].sort();
}, "updateActors"), Vt = s(function(t, e) {
  const a = e.substr(1).split(":");
  let f = 0, i = [];
  a.length === 1 ? (f = Number(a[0]), i = []) : (f = Number(a[0]), i = a[1].split(","));
  const u = i.map((o) => o.trim()), p = { section: V, type: V, people: u, task: t, score: f };
  B.push(p);
}, "addTask"), Rt = s(function(t) {
  const e = { section: V, type: V, description: t, task: t, classes: [] };
  L.push(e);
}, "addTaskOrg"), rt = s(function() {
  ...
  return e;
}, "compileTasks"), Lt = s(function() {
  return Ft();
}, "getActors"), nt = { getConfig: s(() => R().journey, "getConfig"), clear: Ct, setDiagramTitle: St, getDiagramTitle: Tt, setAccTitle: wt, getAccTitle: bt, setAccDescription: vt, getAccDescription: _t, addSection: Pt, getSections: It, getTasks: At, addTask: Vt, addTaskOrg: Rt, getActors: Lt }, Bt = s((t) => `.label {
  ...
  ${gt()}
`, "getStyles"), jt = Bt, K = s(function(t, e) {
  return kt(t, e);
}, "drawRect"), Nt = s(function(t, e) {
...
}, "drawCircle"), ct = s(function(t, e) {
  return xt(t, e);
}, "drawText"), zt = s(function(t, e) {
...
}, "drawLabel"), Wt = s(function(t, e, a) {
  const f = t.append("g"), i = lt();
  i.x = e.x, i.y = e.y, i.fill = e.fill, i.width = a.width * e.taskCount + a.diagramMarginX * (e.taskCount - 1), i.height = a.height, i.class = "journey-section section-type-" + e.num, i.rx = 3, i.ry = 3, K(f, i), ht(a)(e.text, f, i.x, i.y, i.width, i.height, { class: "journey-section section-type-" + e.num }, a, e.colour);
}, "drawSection"), Z = -1, Ot = s(function(t, e, a, f) {
  const i = e.x + a.width / 2, u = t.append("g");
  Z++, u.append("line").attr("id", f + "-task" + Z).attr("x1", i).attr("y1", e.y).attr("x2", i).attr("y2", 450).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Nt(u, { cx: i, cy: 300 + (5 - e.score) * 30, score: e.score });
  const o = lt();
  o.x = e.x, o.y = e.y, o.fill = e.fill, o.width = a.width, o.height = a.height, o.class = "task task-type-" + e.num, o.rx = 3, o.ry = 3, K(u, o);
  let g = e.x + 14;
  e.people.forEach((m) => {
    const x = e.actors[m].color, h = { cx: g, cy: e.y, r: 7, fill: x, stroke: "#000", title: m, pos: e.actors[m].position };
    ot(u, h), g += 10;
  }), ht(a)(e.task, u, o.x, o.y, o.width, o.height, { class: "task" }, a, e.colour);
}, "drawTask"), Yt = s(function(t, e) {
  mt(t, e);
...
}, "initGraphics"), j = { drawRect: K, drawCircle: ot, drawSection: Wt, drawText: ct, drawLabel: zt, drawTask: Ot, drawBackgroundRect: Yt, initGraphics: qt }, Ht = s(function(t) {
...
function ut(t) {
  ...
  Object.keys(E).forEach((i) => {
    const u = E[i].color, p = { cx: 20, cy: f, r: 7, fill: u, stroke: "#000", pos: E[i].position };
    j.drawCircle(t, p);
      ...
      o = t.append("text").attr("visibility", "hidden"), x.forEach((r) => {
        ...
        if (o.text(n), o.node().getBoundingClientRect().width > a) {
          if (h && m.push(h), h = r, o.text(r), o.node().getBoundingClientRect().width > a) {
            let y = "";
            for (const d of r) y += d, o.text(y + "-"), o.node().getBoundingClientRect().width > a && (m.push(y.slice(0, -1) + "-"), y = d);
            h = y;
          }
        } else h = n;
      }), h && m.push(h), o.remove();
    ...
    m.forEach((x, h) => {
      const r = { x: 40, y: f + 7 + h * 20, fill: "#666", text: x, textMargin: e.boxTextMargin ?? 5 }, l = j.drawText(t, r).node().getBoundingClientRect().width;
      l > W && l > e.leftMargin - l && (W = l);
    }), f += Math.max(20, m.length * 20);
  });
}
s(ut, "drawActorLegend");
var $ = R().journey, P = 0, Xt = s(function(t, e, a, f) {
...
}, "draw"), S = { data: { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, verticalPos: 0, sequenceItems: [], init: s(function() {
  this.sequenceItems = [], this.data = { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, this.verticalPos = 0;
}, "init"), updateVal: s(function(t, e, a, f) {
  t[e] === void 0 ? t[e] = a : t[e] = f(a, t[e]);
}, "updateVal"), updateBounds: s(function(t, e, a, f) {
...
}, "updateBounds"), insert: s(function(t, e, a, f) {
  ...
  return this.data;
}, "getBounds") }, G = $.sectionFills, st = $.sectionColours, Gt = s(function(t, e, a, f) {
  const i = R().journey;
  let u = "";
  ...
  for (const [r, n] of e.entries()) {
    if (u !== n.section) {
      ...
      const c = { x: r * i.taskMargin + r * i.width + P, y: 50, text: n.section, fill: m, num: h, colour: x, taskCount: y };
...
}, "drawTasks"), at = { setConf: Ht, draw: Xt }, Qt = { parser: Et, db: nt, renderer: at, styles: jt, init: s((t) => {
