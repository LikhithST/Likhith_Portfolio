var _a, _b;
import { D as e, L as t, a as n, b as r, c as i, nt as a, s as o, w as s, y as c } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as l, h as u, p as d } from "./src-BWB47EtT.js";
import { t as f } from "./channel-DWcnL53n.js";
import "./path-CAD_RBb9.js";
import "./dist-DAHuMNYw.js";
import "./array-BsT2bq1e.js";
import { U as p, a as m, g as h, l as g } from "./chunk-5PVQY5BW-DyH3Wf6D.js";
import { t as _ } from "./line-CKQlCIK2.js";
import { n as v, t as y } from "./chunk-BSJP7CBP-BBDH2KVu.js";
import "./identity-B9owP9ru.js";
import { n as b, t as x } from "./chunk-ZZ45TVLE-BXYMKbdF.js";
import { n as S } from "./chunk-U2HBQHQK-B952OdWg.js";
import "./isEmpty-DOQ62aC5.js";
import "./reduce-mGdWE-KL.js";
import { t as C } from "./chunk-FMBD7UC4-DqZjeowl.js";
import { t as w } from "./graphlib-SyXxdm4S.js";
import { t as T } from "./clone-BE6M_zqu.js";
var E = (function() {
...
E.parser = E;
var D = E, O = /* @__PURE__ */ new Map(), k = [], A = /* @__PURE__ */ new Map(), j = `color`, M = `fill`, ee = `bgFill`, te = `,`, ne = r(), N = /* @__PURE__ */ new Map(), re = ``, ie = u((e2) => o.sanitizeText(e2, ne), `sanitizeText`), ae = u(function(e2, t2 = ``) {
  let n2 = N.get(e2);
...
}, `addStyleClass`), oe = u(function(e2, t2 = ``) {
  let n2 = O.get(e2);
  t2 != null && (n2.styles = t2.split(te));
}, `addStyle2Node`), se = u(function(e2, t2) {
...
}, `setCssClass`), ce = u((e2, t2) => {
  var _a2;
  let n2 = e2.flat(), r2 = [], i2 = ((_a2 = n2.find((e3) => (e3 == null ? void 0 : e3.type) === `column-setting`)) == null ? void 0 : _a2.columns) ?? -1;
  for (let e3 of n2) {
    if (typeof i2 == `number` && i2 > 0 && e3.type !== `column-setting` && typeof e3.widthInColumns == `number` && e3.widthInColumns > i2 && l.warn(`Block ${e3.id} width ${e3.widthInColumns} exceeds configured column width ${i2}`), e3.label && (e3.label = ie(e3.label)), e3.type === `classDef`) {
      ae(e3.id, e3.css);
      continue;
    }
  ...
  t2.children = r2;
}, `populateBlockDatabase`), le = [], P = { id: `root`, type: `composite`, children: [], columns: -1 }, ue = u(() => {
  l.debug(`Clear called`), n(), P = { id: `root`, type: `composite`, children: [], columns: -1 }, O = /* @__PURE__ */ new Map([[`root`, P]]), le = [], N = /* @__PURE__ */ new Map(), k = [], A = /* @__PURE__ */ new Map(), re = ``;
}, `clear`);
function de(e2) {
...
var me = 0, he = { getConfig: u(() => c().block, `getConfig`), typeStr2Type: de, edgeTypeStr2Type: fe, edgeStrToEdgeData: pe, getLogger: u(() => l, `getLogger`), getBlocksFlat: u(() => [...O.values()], `getBlocksFlat`), getBlocks: u(() => le || [], `getBlocks`), getEdges: u(() => k, `getEdges`), setHierarchy: u((e2) => {
  P.children = e2, ce(e2, P), le = P.children;
}, `setHierarchy`), getBlock: u((e2) => O.get(e2), `getBlock`), setBlock: u((e2) => {
  O.set(e2.id, e2);
  ...
  return N;
}, `getClasses`), clear: ue, generateId: u(() => (me++, `id-` + Math.random().toString(36).substr(2, 12) + `-` + me), `generateId`), setDiagramId: u((e2) => {
  re = e2;
}, `setDiagramId`), getDiagramId: u(() => re, `getDiagramId`) }, F = u((e2, t2) => {
  let n2 = f;
  ...
  ${C()}
`, `getStyles`), _e = u((e2, t2, n2, r2) => {
  t2.forEach((t3) => {
    ve[t3](e2, n2, r2);
  });
}, `insertMarkers`), ve = { extension: u((e2, t2, n2) => {
...
}, `barb`) }, ye = _e, I = ((_b = (_a = r()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) ?? 8;
function L(e2, t2) {
...
var be = u((e2) => {
  ...
  for (let r2 of e2.children) {
    ...
    l.debug(`getMaxChildSize abc95 child:`, r2.id, `width:`, e3, `height:`, i2, `x:`, a2, `y:`, o2, r2.type), r2.type !== `space` && (e3 > t2 && (t2 = e3 / (r2.widthInColumns ?? 1)), i2 > n2 && (n2 = i2));
  }
...
function R(e2, t2, n2 = 0, r2 = 0) {
  ...
  if (((_c = e2.children) == null ? void 0 : _c.length) > 0) {
    ...
    for (let t3 of e2.children) t3.size && (l.debug(`abc95 Setting size of children of ${e2.id} id=${t3.id} ${i2} ${a2} ${JSON.stringify(t3.size)}`), t3.size.width = i2 * (t3.widthInColumns ?? 1) + I * ((t3.widthInColumns ?? 1) - 1), t3.size.height = a2, t3.size.x = 0, t3.size.y = 0, l.debug(`abc95 updating size of ${e2.id} children child:${t3.id} maxWidth:${i2} maxHeight:${a2}`));
    ...
    s2 > 0 && s2 < c2 && (u2 = s2);
    let d2 = Math.ceil(c2 / u2), f2 = u2 * (i2 + I) + I, p2 = d2 * (a2 + I) + I;
    if (f2 < n2) {
      l.debug(`Detected to small sibling: abc95 ${e2.id} siblingWidth ${n2} siblingHeight ${r2} width ${f2}`), f2 = n2, p2 = r2;
      let t3 = (n2 - u2 * I - I) / u2, o3 = (r2 - d2 * I - I) / d2;
      l.debug(`Size indata abc88`, e2.id, `childWidth`, t3, `maxWidth`, i2), l.debug(`Size indata abc88`, e2.id, `childHeight`, o3, `maxHeight`, a2), l.debug(`Size indata abc88 xSize`, u2, `padding`, I);
...
function z(e2, t2) {
  ...
  if (l.debug(`layoutBlocks columns abc95`, e2.id, `=>`, n2, e2), e2.children && e2.children.length > 0) {
    ...
    let c2 = ((_g = e2 == null ? void 0 : e2.size) == null ? void 0 : _g.x) ? ((_h = e2 == null ? void 0 : e2.size) == null ? void 0 : _h.x) + (-((_i = e2 == null ? void 0 : e2.size) == null ? void 0 : _i.width) / 2 || 0) : -I, u2 = 0;
    for (let r3 of e2.children) {
      let i3 = e2;
      if (!r3.size) continue;
      let { width: d2, height: f2 } = r3.size, { px: p2, py: m2 } = L(n2, s2);
      if (m2 != u2 && (u2 = m2, c2 = ((_j = e2 == null ? void 0 : e2.size) == null ? void 0 : _j.x) ? ((_k = e2 == null ? void 0 : e2.size) == null ? void 0 : _k.x) + (-((_l = e2 == null ? void 0 : e2.size) == null ? void 0 : _l.width) / 2 || 0) : -I, l.debug(`New row in layout for block`, e2.id, ` and child `, r3.id, u2)), l.debug(`abc89 layout blocks (child) id: ${r3.id} Pos: ${s2} (px, py) ${p2},${m2} (${(_m = i3 == null ? void 0 : i3.size) == null ? void 0 : _m.x},${(_n = i3 == null ? void 0 : i3.size) == null ? void 0 : _n.y}) parent: ${i3.id} width: ${d2}${I}`), i3.size) {
        let e3 = d2 / 2;
        r3.size.x = c2 + I + e3, l.debug(`abc91 layout blocks (calc) px, pyid:${r3.id} startingPos=X${c2} new startingPosX${r3.size.x} ${e3} padding=${I} width=${d2} halfWidth=${e3} => x:${r3.size.x} y:${r3.size.y} ${r3.widthInColumns} (width * (child?.w || 1)) / 2 ${d2 * ((r3 == null ? void 0 : r3.widthInColumns) ?? 1) / 2}`), c2 = r3.size.x + e3;
        let t3 = o2.get(m2) ?? 0, n3 = a2.get(m2) ?? f2;
        r3.size.y = i3.size.y - i3.size.height / 2 + t3 + n3 / 2 + I, l.debug(`abc88 layout blocks (calc) px, pyid:${r3.id}startingPosX${c2}${I}${e3}=>x:${r3.size.x}y:${r3.size.y}${r3.widthInColumns}(width * (child?.w || 1)) / 2${d2 * ((r3 == null ? void 0 : r3.widthInColumns) ?? 1) / 2}`);
      }
      r3.children && z(r3, t2);
      let h2 = (r3 == null ? void 0 : r3.widthInColumns) ?? 1;
      n2 > 0 && (h2 = Math.min(h2, n2 - s2 % n2)), s2 += h2, l.debug(`abc88 columnsPos`, r3, s2);
    }
  }
...
u(xe, `layout`);
var V = u(async (e2, t2, n2, i2 = false, a2 = false) => {
  let o2 = t2 || ``;
  typeof o2 == `object` && (o2 = o2[0]);
  let c2 = r(), l2 = s(c2);
  return await S(e2, o2, { style: n2, isTitle: i2, useHtmlLabels: l2, markdown: false, isNode: a2, width: 1 / 0 }, c2);
}, `createLabel`), Se = u((e2, t2, n2, r2, i2) => {
  t2.arrowTypeStart && we(e2, `start`, t2.arrowTypeStart, n2, r2, i2), t2.arrowTypeEnd && we(e2, `end`, t2.arrowTypeEnd, n2, r2, i2);
}, `addEdgeMarkers`), Ce = { arrow_cross: `cross`, arrow_point: `point`, arrow_barb: `barb`, arrow_circle: `circle`, aggregation: `aggregation`, extension: `extension`, composition: `composition`, dependency: `dependency`, lollipop: `lollipop` }, we = u((e2, t2, n2, r2, i2, a2) => {
  let o2 = Ce[n2];
  if (!o2) {
...
}, `addEdgeMarker`), H = {}, U = {}, Te = u(async (e2, t2) => {
  let n2 = r(), i2 = s(n2), a2 = e2.insert(`g`).attr(`class`, `edgeLabel`), o2 = a2.insert(`g`).attr(`class`, `label`), c2 = t2.labelType === `markdown`, l2 = await S(e2, t2.label, { style: t2.labelStyle, useHtmlLabels: i2, addSvgBackground: c2, isNode: false, markdown: c2, width: c2 ? void 0 : 1 / 0 }, n2);
  o2.node().appendChild(l2);
  let u2 = l2.getBBox(), f2 = u2;
  if (i2) {
    let e3 = l2.children[0], t3 = d(l2);
    u2 = e3.getBoundingClientRect(), f2 = u2, t3.attr(`width`, u2.width), t3.attr(`height`, u2.height);
  } else {
    let e3 = d(l2).select(`text`).node();
    e3 && typeof e3.getBBox == `function` && (f2 = e3.getBBox());
  }
  o2.attr(`transform`, y(f2, i2)), H[t2.id] = a2, t2.width = u2.width, t2.height = u2.height;
  let p2;
  if (t2.startLabelLeft) {
    let n3 = e2.insert(`g`).attr(`class`, `edgeTerminals`), r2 = n3.insert(`g`).attr(`class`, `inner`), a3 = await V(r2, t2.startLabelLeft, t2.labelStyle);
    p2 = a3;
    let o3 = a3.getBBox();
    if (i2) {
      let e3 = a3.children[0], t3 = d(a3);
      o3 = e3.getBoundingClientRect(), t3.attr(`width`, o3.width), t3.attr(`height`, o3.height);
    }
    r2.attr(`transform`, y(o3, i2)), U[t2.id] || (U[t2.id] = {}), U[t2.id].startLeft = n3, W(p2, t2.startLabelLeft);
  }
  if (t2.startLabelRight) {
    let n3 = e2.insert(`g`).attr(`class`, `edgeTerminals`), r2 = n3.insert(`g`).attr(`class`, `inner`), a3 = await V(n3, t2.startLabelRight, t2.labelStyle);
    p2 = a3, r2.node().appendChild(a3);
    let o3 = a3.getBBox();
    if (i2) {
      let e3 = a3.children[0], t3 = d(a3);
      o3 = e3.getBoundingClientRect(), t3.attr(`width`, o3.width), t3.attr(`height`, o3.height);
    }
    r2.attr(`transform`, y(o3, i2)), U[t2.id] || (U[t2.id] = {}), U[t2.id].startRight = n3, W(p2, t2.startLabelRight);
  }
  if (t2.endLabelLeft) {
    let n3 = e2.insert(`g`).attr(`class`, `edgeTerminals`), r2 = n3.insert(`g`).attr(`class`, `inner`), a3 = await V(r2, t2.endLabelLeft, t2.labelStyle);
    p2 = a3;
    let o3 = a3.getBBox();
    if (i2) {
      let e3 = a3.children[0], t3 = d(a3);
    ...
    r2.attr(`transform`, y(o3, i2)), n3.node().appendChild(a3), U[t2.id] || (U[t2.id] = {}), U[t2.id].endLeft = n3, W(p2, t2.endLabelLeft);
  }
  if (t2.endLabelRight) {
    let n3 = e2.insert(`g`).attr(`class`, `edgeTerminals`), r2 = n3.insert(`g`).attr(`class`, `inner`), a3 = await V(r2, t2.endLabelRight, t2.labelStyle);
    p2 = a3;
    let o3 = a3.getBBox();
    if (i2) {
      let e3 = a3.children[0], t3 = d(a3);
    ...
    r2.attr(`transform`, y(o3, i2)), n3.node().appendChild(a3), U[t2.id] || (U[t2.id] = {}), U[t2.id].endRight = n3, W(p2, t2.endLabelRight);
  }
  return l2;
}, `insertEdgeLabel`);
function W(e2, t2) {
  s(r()) && e2 && (e2.style.width = t2.length * 9 + `px`, e2.style.height = `12px`);
}
u(W, `setTerminalWidth`);
var Ee = u((e2, t2) => {
  l.debug(`Moving label abc88 `, e2.id, e2.label, H[e2.id], t2);
  let n2 = t2.updatedPath ? t2.updatedPath : t2.originalPath, { subGraphTitleTotalMargin: i2 } = b(r());
  if (e2.label) {
    let r2 = H[e2.id], a2 = e2.x, o2 = e2.y;
    if (n2) {
  ...
  if (e2.startLabelLeft) {
    let t3 = U[e2.id].startLeft, r2 = e2.x, i3 = e2.y;
    if (n2) {
  ...
  if (e2.startLabelRight) {
    let t3 = U[e2.id].startRight, r2 = e2.x, i3 = e2.y;
    if (n2) {
  ...
  if (e2.endLabelLeft) {
    let t3 = U[e2.id].endLeft, r2 = e2.x, i3 = e2.y;
    if (n2) {
  ...
  if (e2.endLabelRight) {
    let t3 = U[e2.id].endRight, r2 = e2.x, i3 = e2.y;
    if (n2) {
...
}, `cutPathAtIntersect`), Ae = u(function(t2, n2, i2, a2, o2, s2, c2) {
  let u2 = i2.points;
  l.debug(`abc88 InsertEdge: edge=`, i2, `e=`, n2);
  let d2 = false, f2 = s2.node(n2.v);
  var m2 = s2.node(n2.w);
  (m2 == null ? void 0 : m2.intersect) && (f2 == null ? void 0 : f2.intersect) && (u2 = u2.slice(1, i2.points.length - 1), u2.unshift(f2.intersect(u2[0])), u2.push(m2.intersect(u2[u2.length - 1]))), i2.toCluster && (l.debug(`to cluster abc88`, a2[i2.toCluster]), u2 = ke(i2.points, a2[i2.toCluster].node), d2 = true), i2.fromCluster && (l.debug(`from cluster abc88`, a2[i2.fromCluster]), u2 = ke(u2.reverse(), a2[i2.fromCluster].node).reverse(), d2 = true);
  ...
  (r().flowchart.arrowMarkerAbsolute || r().state.arrowMarkerAbsolute) && (w2 = e(true)), Se(C2, i2, w2, c2, o2);
  let T2 = {};
  ...
  return t2;
}, `expandAndDeduplicateDirections`), Me = u((e2, t2, n2) => {
...
var K = { node: Pe, circle: Re, ellipse: Ie, polygon: Ve, rect: u((e2, t2) => {
  ...
  let o2 = r(), c2, l2 = n2.useHtmlLabels || s(o2);
  c2 = i2 || `node default`;
  let u2 = e2.insert(`g`).attr(`class`, c2).attr(`id`, n2.domId || n2.id), f2 = u2.insert(`g`).attr(`class`, `label`).attr(`style`, n2.labelStyle), p2;
  p2 = n2.labelText === void 0 ? `` : typeof n2.labelText == `string` ? n2.labelText : n2.labelText[0];
  let h2;
  h2 = n2.labelType === `markdown` ? S(f2, t(m(p2), o2), { useHtmlLabels: l2, width: n2.width || o2.flowchart.wrappingWidth, classes: `markdown-node-label` }, o2) : await V(f2, t(m(p2), o2), n2.labelStyle, false, a2);
  let g2 = h2.getBBox(), _2 = n2.padding / 2;
  if (s(o2)) {
    let e3 = h2.children[0], t2 = d(h2);
    await x(e3, p2), g2 = e3.getBoundingClientRect(), t2.attr(`width`, g2.width), t2.attr(`height`, g2.height);
  }
  return l2 ? f2.attr(`transform`, `translate(` + -g2.width / 2 + `, ` + -g2.height / 2 + `)`) : f2.attr(`transform`, `translate(0, ` + -g2.height / 2 + `)`), n2.centerLabel && f2.attr(`transform`, `translate(` + -g2.width / 2 + `, ` + -g2.height / 2 + `)`), f2.insert(`rect`, `:first-child`), { shapeSvg: u2, bbox: g2, halfPadding: _2, label: f2 };
...
var Ue = u(async (e2, t2) => {
  t2.useHtmlLabels || s(r()) || (t2.centerLabel = true);
...
var at = u(async (e2, t2) => {
  ...
  let a2 = e2.insert(`g`).attr(`class`, i2).attr(`id`, t2.domId || t2.id), o2 = a2.insert(`rect`, `:first-child`), c2 = a2.insert(`line`), l2 = a2.insert(`line`), u2 = 0, f2 = 4, p2 = a2.insert(`g`).attr(`class`, `label`), m2 = 0, h2 = (_a2 = t2.classData.annotations) == null ? void 0 : _a2[0], g2 = await V(p2, t2.classData.annotations[0] ? `\xAB` + t2.classData.annotations[0] + `\xBB` : ``, t2.labelStyle, true, true), _2 = g2.getBBox();
  if (s(r())) {
    let e3 = g2.children[0], t3 = d(g2);
    _2 = e3.getBoundingClientRect(), t3.attr(`width`, _2.width), t3.attr(`height`, _2.height);
  }
  t2.classData.annotations[0] && (f2 += _2.height + 4, u2 += _2.width);
  let v2 = t2.classData.label;
  t2.classData.type !== void 0 && t2.classData.type !== `` && (s(r()) ? v2 += `&lt;` + t2.classData.type + `&gt;` : v2 += `<` + t2.classData.type + `>`);
  let y2 = await V(p2, v2, t2.labelStyle, true, true);
  d(y2).attr(`class`, `classTitle`);
  let b2 = y2.getBBox();
  if (s(r())) {
    let e3 = y2.children[0], t3 = d(y2);
    b2 = e3.getBoundingClientRect(), t3.attr(`width`, b2.width), t3.attr(`height`, b2.height);
  }
  f2 += b2.height + 4, b2.width > u2 && (u2 = b2.width);
  let x2 = [];
  t2.classData.members.forEach(async (e3) => {
    let n3 = e3.getDisplayDetails(), i3 = n3.displayText;
    s(r()) && (i3 = i3.replace(/</g, `&lt;`).replace(/>/g, `&gt;`));
    let a3 = await V(p2, i3, n3.cssStyle ? n3.cssStyle : t2.labelStyle, true, true), o3 = a3.getBBox();
    if (s(r())) {
      let e4 = a3.children[0], t3 = d(a3);
      o3 = e4.getBoundingClientRect(), t3.attr(`width`, o3.width), t3.attr(`height`, o3.height);
    }
    o3.width > u2 && (u2 = o3.width), f2 += o3.height + 4, x2.push(a3);
  }), f2 += 8;
  let S2 = [];
  if (t2.classData.methods.forEach(async (e3) => {
    ...
    o3.width > u2 && (u2 = o3.width), f2 += o3.height + 4, S2.push(a3);
  }), f2 += 8, h2) {
    let e3 = (u2 - _2.width) / 2;
    d(g2).attr(`transform`, `translate( ` + (-1 * u2 / 2 + e3) + `, ` + -1 * f2 / 2 + `)`), m2 = _2.height + 4;
  }
  let C2 = (u2 - b2.width) / 2;
  return d(y2).attr(`transform`, `translate( ` + (-1 * u2 / 2 + C2) + `, ` + (-1 * f2 / 2 + m2) + `)`), m2 += b2.height + 4, c2.attr(`class`, `divider`).attr(`x1`, -u2 / 2 - n2).attr(`x2`, u2 / 2 + n2).attr(`y1`, -f2 / 2 - n2 + 8 + m2).attr(`y2`, -f2 / 2 - n2 + 8 + m2), m2 += 8, x2.forEach((e3) => {
    d(e3).attr(`transform`, `translate( ` + -u2 / 2 + `, ` + (-1 * f2 / 2 + m2 + 8 / 2) + `)`);
    let t3 = e3 == null ? void 0 : e3.getBBox();
    m2 += ((t3 == null ? void 0 : t3.height) ?? 0) + 4;
  }), m2 += 8, l2.attr(`class`, `divider`).attr(`x1`, -u2 / 2 - n2).attr(`x2`, u2 / 2 + n2).attr(`y1`, -f2 / 2 - n2 + 8 + m2).attr(`y2`, -f2 / 2 - n2 + 8 + m2), m2 += 8, S2.forEach((e3) => {
    d(e3).attr(`transform`, `translate( ` + -u2 / 2 + `, ` + (-1 * f2 / 2 + m2) + `)`);
    let t3 = e3 == null ? void 0 : e3.getBBox();
    m2 += ((t3 == null ? void 0 : t3.height) ?? 0) + 4;
  }), o2.attr(`style`, t2.style).attr(`class`, `outer title-state`).attr(`x`, -u2 / 2 - n2).attr(`y`, -(f2 / 2) - n2).attr(`width`, u2 + t2.padding).attr(`height`, f2 + t2.padding), J(t2, o2), t2.intersect = function(e3) {
    return K.rect(t2, e3);
  }, a2;
...
function ht(e2, t2, n2 = false) {
  ...
  let l2 = g((r2 == null ? void 0 : r2.styles) ?? []), u2 = r2.label, d2 = r2.size ?? { width: 0, height: 0, x: 0, y: 0 }, f2 = t2.getDiagramId();
  return { labelStyle: l2.labelStyle, shape: o2, labelText: u2, rx: a2, ry: a2, class: i2, style: l2.style, id: r2.id, domId: f2 ? `${f2}-${r2.id}` : r2.id, directions: r2.directions, width: d2.width, height: d2.height, x: d2.x, y: d2.y, positioned: n2, intersect: void 0, type: r2.type, padding: s2 ?? ((_c = (_b2 = c()) == null ? void 0 : _b2.block) == null ? void 0 : _c.padding) ?? 0 };
}
...
u(bt, `insertEdges`);
var xt = { parser: D, db: he, renderer: { draw: u(async function(e2, t2, n2, r2) {
  let { securityLevel: a2, block: o2 } = c(), s2 = r2.db;
  s2.setDiagramId(t2);
  let u2;
  a2 === `sandbox` && (u2 = d(`#i` + t2));
  let f2 = d(a2 === `sandbox` ? u2.nodes()[0].contentDocument.body : `body`), p2 = a2 === `sandbox` ? f2.select(`[id="${t2}"]`) : d(`[id="${t2}"]`);
  ye(p2, [`point`, `circle`, `cross`], r2.type, t2);
