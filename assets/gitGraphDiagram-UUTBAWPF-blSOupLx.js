import { B as utils_default, Cn as getDiagramTitle, In as setDiagramTitle, Jn as __name, N as cleanAndMerge, Nn as setAccDescription, Pn as setAccTitle, Rn as setupGraphViewbox2, Sn as getConfig2, Yn as log, bn as getAccTitle, hn as common_default, pn as clear, un as select_default, vn as defaultConfig_default, xn as getConfig, yn as getAccDescription, z as random } from "./index-BgJKKt_a.js";
...
var merge = /* @__PURE__ */ __name((mergeDB) => {
  ...
  if (customId && state.records.commits.has(customId)) {
    ...
    error.hash = {
      ...
      expected: [`merge ${otherBranch} ${customId}_UNIQUE ${overrideType} ${customTags == null ? void 0 : customTags.join(" ")}`]
    };
    throw error;
  }
...
var drawCommits = /* @__PURE__ */ __name((svg, commits, modifyGraph, gitGraphConfig) => {
  ...
  sortedKeys.forEach((key) => {
    ...
    if (modifyGraph) {
      ...
      drawCommitBullet(gBullets, commit2, commitPosition, typeClass, ((_a = branchPos.get(commit2.branch)) == null ? void 0 : _a.index) ?? 0, commitSymbolType);
...
var drawArrow = /* @__PURE__ */ __name((svg, commitA, commitB, allCommits) => {
  ...
  if (commitB.type === commitType.MERGE && commitA.id !== commitB.parents[0]) colorClassNum = (_b = branchPos.get(commitA.branch)) == null ? void 0 : _b.index;
  let lineDef;
