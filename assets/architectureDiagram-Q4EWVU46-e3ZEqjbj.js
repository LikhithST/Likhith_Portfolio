var _a;
import { C as getIconSVG, Cn as getDiagramTitle, I as getEdgeId, In as setDiagramTitle, Jn as __name, Ln as setupGraphViewbox, Mn as sanitizeText, N as cleanAndMerge, Nn as setAccDescription, Nt as selectSvgElement, Pn as setAccTitle, Qn as __commonJSMin, S as createText, Sn as getConfig2, T as unknownIcon, Yn as log, bn as getAccTitle, pn as clear, rr as __toESM, un as select_default, vn as defaultConfig_default, w as registerIconPacks, xn as getConfig, yn as getAccDescription } from "./index-BgJKKt_a.js";
...
import { t as cytoscape$1 } from "./cytoscape.esm-DBi9m-mj.js";
          ...
          ConstraintHandler.handleConstraints = function(layout) {
            ...
            var findAppropriatePositionForRelativePlacement = function findAppropriatePositionForRelativePlacement$1(graph, direction, fixedNodes$1, dummyPositions, componentSources) {
              ...
              inDegrees.forEach(function(value, key) {
                ...
                if (fixedNodes$1) pastMap.set(key, /* @__PURE__ */ new Set([key]));
              });
...
var ArchitectureDB = (_a = class {
  ...
  addGroup({ id, icon, in: parent, title }) {
    var _a2, _b, _c;
    if (((_a2 = this.registeredIds) == null ? void 0 : _a2[id]) !== void 0) throw new Error(`The group id [${id}] is already in use by another ${this.registeredIds[id]}`);
    if (parent !== void 0) {
      if (id === parent) throw new Error(`The group [${id}] cannot be placed within itself`);
      if (((_b = this.registeredIds) == null ? void 0 : _b[parent]) === void 0) throw new Error(`The group [${id}]'s parent does not exist. Please make sure the parent is created before this group`);
      if (((_c = this.registeredIds) == null ? void 0 : _c[parent]) === "node") throw new Error(`The group [${id}]'s parent is not a group`);
    }
...
var drawEdges = /* @__PURE__ */ __name(async function(edgesEl, cy, db, diagramId) {
  ...
  await Promise.all(cy.edges().map(async (edge) => {
    ...
    if (!sourceGroup && ((_a2 = db.getNode(source)) == null ? void 0 : _a2.type) === "junction") if (isArchitectureDirectionX(sourceDir)) startX += sourceDir === "L" ? halfIconSize : -halfIconSize;
    else startY += sourceDir === "T" ? halfIconSize : -halfIconSize;
    if (!targetGroup && ((_b = db.getNode(target)) == null ? void 0 : _b.type) === "junction") if (isArchitectureDirectionX(targetDir)) endX += targetDir === "L" ? halfIconSize : -halfIconSize;
...
var drawGroups = /* @__PURE__ */ __name(async function(groupsEl, cy, db, diagramId) {
  const groupIconSize = db.getConfigField("padding") * 0.75;
  ...
  const flattenAlignments = /* @__PURE__ */ __name((alignmentObj, alignmentDir) => {
    return Object.entries(alignmentObj).reduce((prev, [dir, alignments2]) => {
      ...
      for (let i = 0; i < arr.length - 1; i++) for (let j = i + 1; j < arr.length; j++) {
        ...
        if (((_a2 = groupAlignments[aGroupId]) == null ? void 0 : _a2[bGroupId]) === alignmentDir) {
          prev[dir] ?? (prev[dir] = []);
          prev[dir] = [
            ...prev[dir],
            ...aNodeIds,
  ...
  return new Promise((resolve) => {
    ...
    const layout = cy.layout({
      ...
      idealEdgeLength(edge) {
        ...
        return parentA === parentB ? 1.5 * db.getConfigField("iconSize") : 0.5 * db.getConfigField("iconSize");
      },
      edgeElasticity(edge) {
        const [nodeA, nodeB] = edge.connectedNodes();
        const { parent: parentA } = nodeData(nodeA);
        const { parent: parentB } = nodeData(nodeB);
        return parentA === parentB ? 0.45 : 1e-3;
      },
      alignmentConstraint,
    ...
    layout.one("layoutstop", () => {
      ...
      cy.startBatch();
      for (const edge of Object.values(cy.edges())) if ((_a2 = edge.data) == null ? void 0 : _a2.call(edge)) {
