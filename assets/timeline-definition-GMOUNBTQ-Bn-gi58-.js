import { t as arc_default } from "./arc-BjfzyXLn.js";
import { Bn as darken_default, Jn as __name, Ln as setupGraphViewbox, Nt as selectSvgElement, R as parseFontSize, Sn as getConfig2, Un as is_dark_default, Vn as lighten_default, Yn as log, mn as commonDb_exports, pn as clear, qn as __export, un as select_default, xn as getConfig } from "./index-BgJKKt_a.js";
var parser = (function() {
...
var drawNode = /* @__PURE__ */ __name(function(elem, node, fullSection, conf, diagramId, isEvent = false) {
  ...
  const section = fullSection % (((_a = conf == null ? void 0 : conf.themeVariables) == null ? void 0 : _a.THEME_COLOR_LIMIT) ?? 12) - 1;
  ...
  if (look === "neo") {
    ...
    if (isReduxTheme) {
      ...
      const rootSvg = select_default(((_c = elem.node()) == null ? void 0 : _c.ownerSVGElement) ?? elem.node());
...
var defaultBkg = /* @__PURE__ */ __name(function(elem, node, section, diagramId, config) {
  ...
  if (!(theme == null ? void 0 : theme.includes("redux"))) elem.append("line").attr("class", "node-line-" + section).attr("x1", 0).attr("y1", node.height).attr("x2", node.width).attr("y2", node.height);
}, "defaultBkg");
var svgDraw_default = {
  drawRect,
  drawCircle,
...
var draw = /* @__PURE__ */ __name(function(text, id, version, diagObj) {
  ...
  setupGraphViewbox(void 0, svg, ((_b = conf.timeline) == null ? void 0 : _b.padding) ?? 50, ((_c = conf.timeline) == null ? void 0 : _c.useMaxWidth) ?? false);
}, "draw");
...
var draw2 = /* @__PURE__ */ __name(function(text, id, version, diagObj) {
  ...
  lineWrapper.lower();
  setupGraphViewbox(void 0, svg, ((_d = conf.timeline) == null ? void 0 : _d.padding) ?? 50, ((_e = conf.timeline) == null ? void 0 : _e.useMaxWidth) ?? false);
}, "draw");
...
var diagram = {
  ...
  renderer: {
    ...
    draw: /* @__PURE__ */ __name((text, id, version, diagObj) => {
      var _a, _b;
      if ((((_b = (_a = diagObj == null ? void 0 : diagObj.db) == null ? void 0 : _a.getDirection) == null ? void 0 : _b.call(_a)) ?? "LR") === "TD") return timelineRendererVertical_default.draw(text, id, version, diagObj);
