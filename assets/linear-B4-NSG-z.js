import { H as j, at as p, y as w, au as k, av as q } from "./index-bLSjIDix.js";
import { i as D } from "./init-Gi6I4Gst.js";
import { e as g, b as F, a as z, f as B } from "./defaultLocale-CrowFXzY.js";
function M(n, r) {
...
const $ = R(M), x = $.right;
R(V).center;
const H = Math.sqrt(50), O = Math.sqrt(10), T = Math.sqrt(2);
function v(n, r, t) {
  const e = (r - n) / Math.max(0, t), u = Math.floor(Math.log10(e)), f = e / Math.pow(10, u), a = f >= H ? 10 : f >= O ? 5 : f >= T ? 2 : 1;
  let o, c, i;
...
function d(n, r) {
  var t = typeof r, e;
  return r == null || t === "boolean" ? j(r) : (t === "number" ? p : t === "string" ? (e = w(r)) ? (r = e, k) : q : r instanceof w ? k : r instanceof Date ? L : J(r) ? G : Array.isArray(r) ? K : typeof r.valueOf != "function" && typeof r.toString != "function" || isNaN(r) ? Q : p)(n, r);
}
function U(n, r) {
