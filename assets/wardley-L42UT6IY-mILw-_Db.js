...
var eu, uo, tu, Oi, ie, ee, Li, ru, fo, nu, au, iu, su, po, ou, lu, cu, Di, en, Vt, tn, je, dr, Mi, ua, da, fa, ho, Ei, kc, Sg, uu, du, xi, fu, mo, pa, pu, hu, mu, gu, yu, vu, Tu, Ru, Fi, $u, Au, Eu, _u, Cu, Su, bu, wu, Iu, Nu, ku, Gi, Pu, Ou, Lu, Du, Mu, xu, Fu, Gu, ju, Uu, zu, Bu, Ku, go, yo, qu, Wu, Vu, Hu, Yu, Xu, Ju, Zu, bg, Qu, Mh, $, _s = nw({ "../../node_modules/.pnpm/vscode-languageserver-types@3.17.5/node_modules/vscode-languageserver-types/lib/esm/main.js"() {
  ...
  (function(e) {
    ...
    function t(n, a) {
      return n === Number.MAX_VALUE && (n = Oi.MAX_VALUE), a === Number.MAX_VALUE && (a = Oi.MAX_VALUE), { line: n, character: a };
    }
    ...
    function t(n, a, s, o) {
      if ($.uinteger(n) && $.uinteger(a) && $.uinteger(s) && $.uinteger(o)) return { start: ie.create(n, a), end: ie.create(s, o) };
      if (ie.is(n) && ie.is(a)) return { start: n, end: a };
    ...
    function t(n, a, s, o) {
      return { red: n, green: a, blue: s, alpha: o };
    }
    i(t, "create"), e.create = t;
    function r(n) {
      const a = n;
    ...
    function t(n, a) {
      return { range: n, color: a };
    }
    i(t, "create"), e.create = t;
    function r(n) {
      const a = n;
      return $.objectLiteral(a) && ee.is(a.range) && fo.is(a.color);
    }
    i(r, "is"), e.is = r;
  })(nu || (nu = {})), (function(e) {
    function t(n, a, s) {
      return { label: n, textEdit: a, additionalTextEdits: s };
    }
    i(t, "create"), e.create = t;
    function r(n) {
      const a = n;
      return $.objectLiteral(a) && $.string(a.label) && ($.undefined(a.textEdit) || Vt.is(a)) && ($.undefined(a.additionalTextEdits) || $.typedArray(a.additionalTextEdits, Vt.is));
    }
    i(r, "is"), e.is = r;
  })(au || (au = {})), (function(e) {
    ...
    function t(n, a) {
      return { location: n, message: a };
    }
    i(t, "create"), e.create = t;
    function r(n) {
      let a = n;
      return $.defined(a) && Li.is(a.location) && $.string(a.message);
    }
    i(r, "is"), e.is = r;
  })(po || (po = {})), (function(e) {
    ...
    function r(n) {
      var a;
      let s = n;
      return $.defined(s) && ee.is(s.range) && $.string(s.message) && ($.number(s.severity) || $.undefined(s.severity)) && ($.integer(s.code) || $.string(s.code) || $.undefined(s.code)) && ($.undefined(s.codeDescription) || $.string((a = s.codeDescription) === null || a === void 0 ? void 0 : a.href)) && ($.string(s.source) || $.undefined(s.source)) && ($.undefined(s.relatedInformation) || $.typedArray(s.relatedInformation, po.is));
    }
    i(r, "is"), e.is = r;
  })(Di || (Di = {})), (function(e) {
    function t(n, a, ...s) {
    ...
    function a(s) {
      const o = s;
      return Vt.is(o) && (tn.is(o.annotationId) || je.is(o.annotationId));
    }
    i(a, "is"), e.is = a;
  })(dr || (dr = {})), (function(e) {
    function t(n, a) {
    ...
    function r(n) {
      let a = n;
      return $.defined(a) && xi.is(a.textDocument) && Array.isArray(a.edits);
    }
    i(r, "is"), e.is = r;
  })(Mi || (Mi = {})), (function(e) {
    function t(n, a, s) {
    ...
    function t(n, a, s, o) {
      let l = { kind: "rename", oldUri: n, newUri: a };
    ...
    function t(r) {
      let n = r;
      return n && (n.changes !== void 0 || n.documentChanges !== void 0) && (n.documentChanges === void 0 || n.documentChanges.every((a) => $.string(a.kind) ? ua.is(a) || da.is(a) || fa.is(a) : Mi.is(a)));
    }
    i(t, "is"), e.is = t;
  })(ho || (ho = {})), Ei = (_a3 = class {
    constructor(e, t) {
    ...
    insert(e, t, r) {
      let n, a;
      if (r === void 0 ? n = Vt.insert(e, t) : je.is(r) ? (a = r, n = dr.insert(e, t, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), n = dr.insert(e, t, a)), this.edits.push(n), a !== void 0) return a;
    }
    replace(e, t, r) {
      let n, a;
      if (r === void 0 ? n = Vt.replace(e, t) : je.is(r) ? (a = r, n = dr.replace(e, t, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), n = dr.replace(e, t, a)), this.edits.push(n), a !== void 0) return a;
    }
    delete(e, t) {
      let r, n;
      if (t === void 0 ? r = Vt.del(e) : je.is(t) ? (n = t, r = dr.del(e, t)) : (this.assertChangeAnnotations(this.changeAnnotations), n = this.changeAnnotations.manage(t), r = dr.del(e, n)), this.edits.push(r), n !== void 0) return n;
    }
    add(e) {
      this.edits.push(e);
    }
  ...
  }, i(_a3, "TextEditChangeImpl"), _a3), kc = (_b3 = class {
    constructor(e) {
    ...
    manage(e, t) {
      let r;
      if (je.is(e) ? r = e : (r = this.nextId(), t = e), this._annotations[r] !== void 0) throw new Error(`Id ${r} is already in use.`);
  ...
  }, i(_b3, "ChangeAnnotations"), _b3), Sg = (_c3 = class {
    constructor(e) {
      this._textEditChanges = /* @__PURE__ */ Object.create(null), e !== void 0 ? (this._workspaceEdit = e, e.documentChanges ? (this._changeAnnotations = new kc(e.changeAnnotations), e.changeAnnotations = this._changeAnnotations.all(), e.documentChanges.forEach((t) => {
        if (Mi.is(t)) {
          const r = new Ei(t.edits, this._changeAnnotations);
          this._textEditChanges[t.textDocument.uri] = r;
        }
      })) : e.changes && Object.keys(e.changes).forEach((t) => {
        const r = new Ei(e.changes[t]);
    ...
    getTextEditChange(e) {
      if (xi.is(e)) {
        ...
        if (!r) {
          const n = [], a = { textDocument: t, edits: n };
          this._workspaceEdit.documentChanges.push(a), r = new Ei(n, this._changeAnnotations), this._textEditChanges[t.uri] = r;
        }
        return r;
      } else {
        ...
        if (!t) {
          let r = [];
          this._workspaceEdit.changes[e] = r, t = new Ei(r), this._textEditChanges[e] = t;
        }
        return t;
      }
    }
    initDocumentChanges() {
      this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new kc(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
    }
    initChanges() {
    ...
    createFile(e, t, r) {
      if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
      let n;
      tn.is(t) || je.is(t) ? n = t : r = t;
      let a, s;
      if (n === void 0 ? a = ua.create(e, r) : (s = je.is(n) ? n : this._changeAnnotations.manage(n), a = ua.create(e, r, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0) return s;
    }
    renameFile(e, t, r, n) {
      if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
      let a;
      tn.is(r) || je.is(r) ? a = r : n = r;
      let s, o;
      if (a === void 0 ? s = da.create(e, t, n) : (o = je.is(a) ? a : this._changeAnnotations.manage(a), s = da.create(e, t, n, o)), this._workspaceEdit.documentChanges.push(s), o !== void 0) return o;
    }
    deleteFile(e, t, r) {
      if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
      let n;
      tn.is(t) || je.is(t) ? n = t : r = t;
      let a, s;
      if (n === void 0 ? a = fa.create(e, r) : (s = je.is(n) ? n : this._changeAnnotations.manage(n), a = fa.create(e, r, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0) return s;
    }
  }, i(_c3, "WorkspaceChange"), _c3), (function(e) {
    function t(n) {
      return { uri: n };
    }
    i(t, "create"), e.create = t;
    ...
    function t(r) {
      const n = r;
      return $.objectLiteral(r) && mo.is(n.kind) && $.string(n.value);
    }
    i(t, "is"), e.is = t;
  })(pa || (pa = {})), (function(e) {
    ...
    function t(r) {
      let n = r;
      return !!n && $.objectLiteral(n) && (pa.is(n.contents) || Fi.is(n.contents) || $.typedArray(n.contents, Fi.is)) && (r.range === void 0 || ee.is(r.range));
    }
    i(t, "is"), e.is = t;
  })($u || ($u = {})), (function(e) {
    function t(r, n) {
    ...
    function t(r, n, a, s, o) {
      let l = { name: r, kind: n, location: { uri: s, range: a } };
    ...
    function t(n, a, s, o, l, c) {
      let u = { name: n, detail: a, kind: s, range: o, selectionRange: l };
    ...
    function r(n) {
      let a = n;
      return $.defined(a) && $.typedArray(a.diagnostics, Di.is) && (a.only === void 0 || $.typedArray(a.only, $.string)) && (a.triggerKind === void 0 || a.triggerKind === Gi.Invoked || a.triggerKind === Gi.Automatic);
    }
    i(r, "is"), e.is = r;
  })(Pu || (Pu = {})), (function(e) {
    function t(n, a, s) {
      let o = { title: n }, l = true;
      return typeof a == "string" ? (l = false, o.kind = a) : en.is(a) ? o.command = a : o.edit = a, l && s !== void 0 && (o.kind = s), o;
    }
    i(t, "create"), e.create = t;
    function r(n) {
      let a = n;
      return a && $.string(a.title) && (a.diagnostics === void 0 || $.typedArray(a.diagnostics, Di.is)) && (a.kind === void 0 || $.string(a.kind)) && (a.edit !== void 0 || a.command !== void 0) && (a.command === void 0 || en.is(a.command)) && (a.isPreferred === void 0 || $.boolean(a.isPreferred)) && (a.edit === void 0 || ho.is(a.edit));
    }
    i(r, "is"), e.is = r;
  })(Ou || (Ou = {})), (function(e) {
    function t(n, a) {
    ...
    function r(n) {
      let a = n;
      return $.defined(a) && ee.is(a.range) && ($.undefined(a.command) || en.is(a.command));
    }
    i(r, "is"), e.is = r;
  })(Lu || (Lu = {})), (function(e) {
    function t(n, a) {
    ...
    function r(n) {
      const a = n;
      return $.objectLiteral(a) && (a.tooltip === void 0 || $.string(a.tooltip) || pa.is(a.tooltip)) && (a.location === void 0 || Li.is(a.location)) && (a.command === void 0 || en.is(a.command));
    }
    i(r, "is"), e.is = r;
  })(yo || (yo = {})), (function(e) {
    function t(n, a, s) {
    ...
    function r(n) {
      const a = n;
      return $.objectLiteral(a) && ie.is(a.position) && ($.string(a.label) || $.typedArray(a.label, yo.is)) && (a.kind === void 0 || go.is(a.kind)) && a.textEdits === void 0 || $.typedArray(a.textEdits, Vt.is) && (a.tooltip === void 0 || $.string(a.tooltip) || pa.is(a.tooltip)) && (a.paddingLeft === void 0 || $.boolean(a.paddingLeft)) && (a.paddingRight === void 0 || $.boolean(a.paddingRight));
    }
    i(r, "is"), e.is = r;
  })(qu || (qu = {})), (function(e) {
    function t(r) {
    ...
    function t(r) {
      const n = r;
      return $.objectLiteral(n) && uo.is(n.uri) && $.string(n.name);
    }
    i(t, "is"), e.is = t;
  })(Zu || (Zu = {})), bg = [`
`, `\r
`, "\r"], (function(e) {
    ...
    i(r, "is"), e.is = r;
    function n(s, o) {
      let l = s.getText(), c = a(o, (d, f) => {
        let h = d.range.start.line - f.range.start.line;
        return h === 0 ? d.range.start.character - f.range.start.character : h;
      }), u = l.length;
      for (let d = c.length - 1; d >= 0; d--) {
        let f = c[d], h = s.offsetAt(f.range.start), y = s.offsetAt(f.range.end);
        if (y <= u) l = l.substring(0, h) + f.newText + l.substring(y, l.length);
...
` && n++;
  ...
  }, i(_d3, "FullTextDocument"), _d3), (function(e) {
    ...
    i(f, "objectLiteral"), e.objectLiteral = f;
    function h(y, v) {
      return Array.isArray(y) && y.every(v);
    }
    i(h, "typedArray"), e.typedArray = h;
  })($ || ($ = {}));
} }), kn = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/ral.js"(e) {
...
} }), Cs = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/is.js"(e) {
...
} }), qa = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/events.js"(e) {
  var _a3, _b3;
  ...
  var n = (_a3 = class {
    add(s, o = null, l) {
      this._callbacks || (this._callbacks = [], this._contexts = []), this._callbacks.push(s), this._contexts.push(o), Array.isArray(l) && l.push({ dispose: i(() => this.remove(s, o), "dispose") });
    }
    remove(s, o = null) {
      if (!this._callbacks) return;
      let l = false;
      for (let c = 0, u = this._callbacks.length; c < u; c++) if (this._callbacks[c] === s) if (this._contexts[c] === o) {
    ...
    invoke(...s) {
      ...
      for (let u = 0, d = l.length; u < d; u++) try {
  ...
  }, i(_a3, "CallbackList"), _a3), a = (_b3 = class {
    constructor(o) {
      this._options = o;
    }
    get event() {
      return this._event || (this._event = (o, l, c) => {
        ...
        const u = { dispose: i(() => {
          this._callbacks && (this._callbacks.remove(o, l), u.dispose = _b3._noop, this._options && this._options.onLastListenerRemove && this._callbacks.isEmpty() && this._options.onLastListenerRemove(this));
        }, "dispose") };
...
} }), El = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/cancellation.js"(e) {
  var _a3, _b3;
  Object.defineProperty(e, "__esModule", { value: true }), e.CancellationTokenSource = e.CancellationToken = void 0;
  var t = kn(), r = Cs(), n = qa(), a;
  (function(c) {
    c.None = Object.freeze({ isCancellationRequested: false, onCancellationRequested: n.Event.None }), c.Cancelled = Object.freeze({ isCancellationRequested: true, onCancellationRequested: n.Event.None });
    function u(d) {
      const f = d;
      return f && (f === c.None || f === c.Cancelled || r.boolean(f.isCancellationRequested) && !!f.onCancellationRequested);
    }
    i(u, "is"), c.is = u;
  })(a || (e.CancellationToken = a = {}));
  var s = Object.freeze(function(c, u) {
    const d = (0, t.default)().timer.setTimeout(c.bind(u), 0);
    return { dispose() {
      d.dispose();
    } };
  }), o = (_a3 = class {
  ...
  }, i(_a3, "MutableToken"), _a3), l = (_b3 = class {
    get token() {
  ...
  }, i(_b3, "CancellationTokenSource"), _b3);
  e.CancellationTokenSource = l;
} }), Ig = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messages.js"(e) {
  var _a3, _b3, _c3, _d3, _e3, _f3, _g3, _h3, _i3, _j2, _k3, _l3, _m3, _n3, _o3, _p3, _q2, _r3, _s3, _t3, _u3, _v3, _w3, _x3, _y3;
  ...
  var n = (_a3 = class extends Error {
    constructor(E, T, R) {
      super(T), this.code = t.number(E) ? E : r.UnknownErrorCode, this.data = R, Object.setPrototypeOf(this, _a3.prototype);
    }
    toJson() {
      const E = { code: this.code, message: this.message };
      return this.data !== void 0 && (E.data = this.data), E;
    }
  }, i(_a3, "ResponseError"), _a3);
  e.ResponseError = n;
  var a = (_b3 = class {
    constructor(E) {
      this.kind = E;
    ...
    static is(E) {
      return E === _b3.auto || E === _b3.byName || E === _b3.byPosition;
    }
    toString() {
      return this.kind;
    }
  }, i(_b3, "ParameterStructures"), _b3);
  ...
  }, i(_c3, "AbstractMessageSignature"), _c3);
  e.AbstractMessageSignature = s;
  var o = (_d3 = class extends s {
    constructor(g) {
      super(g, 0);
    }
  }, i(_d3, "RequestType0"), _d3);
  e.RequestType0 = o;
  var l = (_e3 = class extends s {
  ...
  }, i(_e3, "RequestType"), _e3);
  e.RequestType = l;
  var c = (_f3 = class extends s {
    constructor(g, E = a.auto) {
      super(g, 1), this._parameterStructures = E;
    }
    get parameterStructures() {
  ...
  }, i(_f3, "RequestType1"), _f3);
  e.RequestType1 = c;
  var u = (_g3 = class extends s {
    constructor(g) {
      super(g, 2);
    }
  }, i(_g3, "RequestType2"), _g3);
  e.RequestType2 = u;
  var d = (_h3 = class extends s {
    constructor(g) {
      super(g, 3);
    }
  }, i(_h3, "RequestType3"), _h3);
  e.RequestType3 = d;
  var f = (_i3 = class extends s {
    constructor(g) {
      super(g, 4);
    }
  }, i(_i3, "RequestType4"), _i3);
  e.RequestType4 = f;
  var h = (_j2 = class extends s {
    constructor(g) {
      super(g, 5);
    }
  }, i(_j2, "RequestType5"), _j2);
  e.RequestType5 = h;
  var y = (_k3 = class extends s {
    constructor(g) {
      super(g, 6);
    }
  }, i(_k3, "RequestType6"), _k3);
  e.RequestType6 = y;
  var v = (_l3 = class extends s {
    constructor(g) {
      super(g, 7);
    }
  }, i(_l3, "RequestType7"), _l3);
  e.RequestType7 = v;
  var C = (_m3 = class extends s {
    constructor(g) {
      super(g, 8);
    }
  }, i(_m3, "RequestType8"), _m3);
  e.RequestType8 = C;
  var b = (_n3 = class extends s {
    constructor(g) {
      super(g, 9);
    }
  }, i(_n3, "RequestType9"), _n3);
  e.RequestType9 = b;
  var w = (_o3 = class extends s {
    constructor(g, E = a.auto) {
      super(g, 1), this._parameterStructures = E;
    }
    get parameterStructures() {
  ...
  }, i(_o3, "NotificationType"), _o3);
  e.NotificationType = w;
  var I = (_p3 = class extends s {
    constructor(g) {
      super(g, 0);
    }
  }, i(_p3, "NotificationType0"), _p3);
  e.NotificationType0 = I;
  var A = (_q2 = class extends s {
    constructor(g, E = a.auto) {
      super(g, 1), this._parameterStructures = E;
    }
    get parameterStructures() {
  ...
  }, i(_q2, "NotificationType1"), _q2);
  e.NotificationType1 = A;
  var k = (_r3 = class extends s {
    constructor(g) {
      super(g, 2);
    }
  }, i(_r3, "NotificationType2"), _r3);
  e.NotificationType2 = k;
  var G = (_s3 = class extends s {
    constructor(g) {
      super(g, 3);
    }
  }, i(_s3, "NotificationType3"), _s3);
  e.NotificationType3 = G;
  var H = (_t3 = class extends s {
    constructor(g) {
      super(g, 4);
    }
  }, i(_t3, "NotificationType4"), _t3);
  e.NotificationType4 = H;
  var X = (_u3 = class extends s {
    constructor(g) {
      super(g, 5);
    }
  }, i(_u3, "NotificationType5"), _u3);
  e.NotificationType5 = X;
  var le = (_v3 = class extends s {
    constructor(g) {
      super(g, 6);
    }
  }, i(_v3, "NotificationType6"), _v3);
  e.NotificationType6 = le;
  var ce = (_w3 = class extends s {
    constructor(g) {
      super(g, 7);
    }
  }, i(_w3, "NotificationType7"), _w3);
  e.NotificationType7 = ce;
  var Ne = (_x3 = class extends s {
    constructor(g) {
      super(g, 8);
    }
  }, i(_x3, "NotificationType8"), _x3);
  e.NotificationType8 = Ne;
  var P = (_y3 = class extends s {
    constructor(g) {
      super(g, 9);
    }
  }, i(_y3, "NotificationType9"), _y3);
  ...
  (function(g) {
    ...
    function T(S) {
      const O = S;
      return O && t.string(O.method) && S.id === void 0;
    }
...
} }), kg = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/linkedMap.js"(e) {
  var _a3, _b3;
  var t;
  ...
  var n = (_a3 = class {
    ...
    set(s, o, l = r.None) {
      ...
      if (c) c.value = o, l !== r.None && this.touch(c, l);
      else {
    ...
    forEach(s, o) {
      ...
      let c = this._head;
      for (; c; ) {
        if (o ? s.bind(o)(c.value, c.key, this) : s(c.value, c.key, this), this._state !== l) throw new Error("LinkedMap got modified during iteration.");
        c = c.next;
      }
    }
    keys() {
    ...
    values() {
      ...
      const l = { [Symbol.iterator]: () => l, next: i(() => {
        if (this._state !== s) throw new Error("LinkedMap got modified during iteration.");
        if (o) {
          const c = { value: o.value, done: false };
          return o = o.next, c;
        } else return { value: void 0, done: true };
      }, "next") };
      return l;
    ...
    entries() {
      ...
      const l = { [Symbol.iterator]: () => l, next: i(() => {
        if (this._state !== s) throw new Error("LinkedMap got modified during iteration.");
        if (o) {
          const c = { value: [o.key, o.value], done: false };
          return o = o.next, c;
        } else return { value: void 0, done: true };
      }, "next") };
      return l;
  ...
  e.LRUCache = a;
} }), aw = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/disposable.js"(e) {
...
} }), iw = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/sharedArrayCancellation.js"(e) {
  var _a3, _b3, _c3, _d3;
  ...
  }, i(_a3, "SharedArraySenderStrategy"), _a3);
  ...
  }, i(_b3, "SharedArrayBufferCancellationToken"), _b3), s = (_c3 = class {
    constructor(l) {
      this.token = new a(l);
    }
    cancel() {
  ...
  }, i(_c3, "SharedArrayBufferCancellationTokenSource"), _c3), o = (_d3 = class {
    constructor() {
      this.kind = "request";
    }
  ...
  }, i(_d3, "SharedArrayReceiverStrategy"), _d3);
  e.SharedArrayReceiverStrategy = o;
} }), Pg = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/semaphore.js"(e) {
  var _a3;
  Object.defineProperty(e, "__esModule", { value: true }), e.Semaphore = void 0;
  var t = kn(), r = (_a3 = class {
    constructor(n = 1) {
  ...
  e.Semaphore = r;
} }), sw = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageReader.js"(e) {
  var _a3, _b3;
  ...
  }, i(_a3, "AbstractMessageReader"), _a3);
  ...
  (function(u) {
    function d(f) {
      ...
      if (f === void 0 || typeof f == "string") h = f ?? "utf-8";
      else {
        if (h = f.charset ?? "utf-8", f.contentDecoder !== void 0 && (y = f.contentDecoder, v.set(y.name, y)), f.contentDecoders !== void 0) for (const w of f.contentDecoders) v.set(w.name, w);
        if (f.contentTypeDecoder !== void 0 && (C = f.contentTypeDecoder, b.set(C.name, C)), f.contentTypeDecoders !== void 0) for (const w of f.contentTypeDecoders) b.set(w.name, w);
      }
      return C === void 0 && (C = (0, t.default)().applicationJson.decoder, b.set(C.name, C)), { charset: h, contentDecoder: y, contentDecoders: v, contentTypeDecoder: C, contentTypeDecoders: b };
    }
    i(d, "fromOptions"), u.fromOptions = d;
  })(l || (l = {}));
  var c = (_b3 = class extends o {
    constructor(u, d) {
      super(), this.readable = u, this.options = l.fromOptions(d), this.buffer = (0, t.default)().messageBuffer.create(this.options.charset), this._partialMessageTimeout = 1e4, this.nextMessageLength = -1, this.messageToken = 0, this.readSemaphore = new a.Semaphore(1);
    }
    ...
    listen(u) {
      ...
      const d = this.readable.onData((f) => {
        this.onData(f);
      });
      return this.readable.onError((f) => this.fireError(f)), this.readable.onClose(() => this.fireClose()), d;
    }
    onData(u) {
      try {
        for (this.buffer.append(u); ; ) {
          if (this.nextMessageLength === -1) {
            const f = this.buffer.tryReadHeaders(true);
            if (!f) return;
...
${JSON.stringify(Object.fromEntries(f))}`));
          ...
          this.clearPartialMessageTimer(), this.nextMessageLength = -1, this.readSemaphore.lock(async () => {
            const f = this.options.contentDecoder !== void 0 ? await this.options.contentDecoder.decode(d) : d, h = await this.options.contentTypeDecoder.decode(f, this.options);
            this.callback(h);
          }).catch((f) => {
            this.fireError(f);
          });
    ...
    setPartialMessageTimer() {
      this.clearPartialMessageTimer(), !(this._partialMessageTimeout <= 0) && (this.partialMessageTimer = (0, t.default)().timer.setTimeout((u, d) => {
        this.partialMessageTimer = void 0, u === this.messageToken && (this.firePartialMessage({ messageToken: u, waitingTime: d }), this.setPartialMessageTimer());
      }, this._partialMessageTimeout, this.messageToken, this._partialMessageTimeout));
    }
  }, i(_b3, "ReadableStreamMessageReader"), _b3);
  e.ReadableStreamMessageReader = c;
} }), ow = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageWriter.js"(e) {
  var _a3, _b3;
  ...
  var t = kn(), r = Cs(), n = Pg(), a = qa(), s = "Content-Length: ", o = `\r
`, l;
  (function(f) {
    function h(y) {
      let v = y;
  ...
  var c = (_a3 = class {
    ...
    fireError(f, h, y) {
      this.errorEmitter.fire([this.asError(f), h, y]);
    }
    get onClose() {
      return this.closeEmitter.event;
    }
    ...
    asError(f) {
      return f instanceof Error ? f : new Error(`Writer received error. Reason: ${r.string(f.message) ? f.message : "unknown"}`);
    }
  }, i(_a3, "AbstractMessageWriter"), _a3);
  ...
  (function(f) {
    ...
    i(h, "fromOptions"), f.fromOptions = h;
  })(u || (u = {}));
  var d = (_b3 = class extends c {
    constructor(f, h) {
      super(), this.writable = f, this.options = u.fromOptions(h), this.errorCount = 0, this.writeSemaphore = new n.Semaphore(1), this.writable.onError((y) => this.fireError(y)), this.writable.onClose(() => this.fireClose());
    }
    async write(f) {
      return this.writeSemaphore.lock(async () => this.options.contentTypeEncoder.encode(f, this.options).then((y) => this.options.contentEncoder !== void 0 ? this.options.contentEncoder.encode(y) : y).then((y) => {
        const v = [];
        return v.push(s, y.byteLength.toString(), o), v.push(o), this.doWrite(f, v, y);
      }, (y) => {
    ...
    async doWrite(f, h, y) {
      try {
        ...
        return this.handleError(v, f), Promise.reject(v);
      }
    }
    handleError(f, h) {
  ...
  }, i(_b3, "WriteableStreamMessageWriter"), _b3);
  e.WriteableStreamMessageWriter = d;
} }), lw = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageBuffer.js"(e) {
  var _a3;
...
`, a = (_a3 = class {
    ...
    tryReadHeaders(s = false) {
      ...
      if (o !== 4) return;
      const d = this._read(u + c), f = /* @__PURE__ */ new Map(), h = this.toString(d, "ascii").split(n);
      if (h.length < 2) return f;
      for (let y = 0; y < h.length - 2; y++) {
        const v = h[y], C = v.indexOf(":");
        if (C === -1) throw new Error(`Message header must separate key and value using ':'
${v}`);
        const b = v.substr(0, C), w = v.substr(C + 1).trim();
        f.set(s ? b.toLowerCase() : b, w);
      }
      return f;
    }
    tryReadBody(s) {
    ...
    _read(s) {
      ...
      if (this._chunks[0].byteLength > s) {
        const u = this._chunks[0], d = this.asNative(u, s);
        return this._chunks[0] = u.slice(s), this._totalLength -= s, d;
      }
      ...
      for (; s > 0; ) {
        ...
        if (u.byteLength > s) {
          const d = u.slice(0, s);
          o.set(d, l), l += s, this._chunks[c] = u.slice(s), this._totalLength -= s, s -= s;
        } else o.set(u, l), l += u.byteLength, this._chunks.shift(), this._totalLength -= u.byteLength, s -= u.byteLength;
      }
      return o;
    }
  }, i(_a3, "AbstractMessageBuffer"), _a3);
  e.AbstractMessageBuffer = a;
} }), cw = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/connection.js"(e) {
  var _a3, _b3;
  ...
  var t = kn(), r = Cs(), n = Ig(), a = kg(), s = qa(), o = El(), l;
  (function(g) {
  ...
  (function(g) {
    ...
    i(E, "is"), g.is = E;
  })(f || (f = {})), e.NullLogger = Object.freeze({ error: i(() => {
  }, "error"), warn: i(() => {
  }, "warn"), info: i(() => {
  }, "info"), log: i(() => {
  }, "log") });
  ...
  var I = (_b3 = class extends Error {
    constructor(E, T) {
      super(T), this.code = E, Object.setPrototypeOf(this, _b3.prototype);
    }
  }, i(_b3, "ConnectionError"), _b3);
  e.ConnectionError = I;
  var A;
  (function(g) {
    function E(T) {
  ...
  var H;
  (function(g) {
    g.Message = Object.freeze({ createCancellationTokenSource(T) {
  ...
  var X;
  (function(g) {
    g.Message = Object.freeze({ sendCancellation(T, R) {
  ...
  var le;
  (function(g) {
    g.Message = Object.freeze({ receiver: H.Message, sender: X.Message });
    function E(T) {
      const R = T;
  ...
  function _(g, E, T, R) {
    const S = T !== void 0 ? T : e.NullLogger;
    let O = 0, M = 0, D = 0;
    const z = "2.0";
    let B;
    ...
    let ct, Re = new a.LinkedMap(), Oe = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), Se = /* @__PURE__ */ new Map(), Q = h.Off, rt = v.Text, me, Nt = P.New;
    const Zn = new s.Emitter(), ri = new s.Emitter(), ni = new s.Emitter(), ai = new s.Emitter(), ii = new s.Emitter(), kt = R && R.cancellationStrategy ? R.cancellationStrategy : le.Message;
    function Qn(m) {
      if (m === null) throw new Error("Can't send requests with id null since the response can't be correlated.");
      return "req-" + m.toString();
    }
    i(Qn, "createRequestQueueKey");
    function si(m) {
      return m === null ? "res-unknown-" + (++D).toString() : "res-" + m.toString();
    }
    i(si, "createResponseQueueKey");
    function oi() {
      return "not-" + (++M).toString();
    }
    i(oi, "createNotificationQueueKey");
    function li(m, N) {
      n.Message.isRequest(N) ? m.set(Qn(N.id), N) : n.Message.isResponse(N) ? m.set(si(N.id), N) : m.set(oi(), N);
    }
    i(li, "addMessageToQueue");
    function ci(m) {
    }
    i(ci, "cancelUndispatched");
    function ea() {
    ...
    i(zt, "isDisposed");
    function ra() {
      (Nt === P.New || Nt === P.Listening) && (Nt = P.Closed, ri.fire(void 0));
    }
    i(ra, "closeHandler");
    function ui(m) {
      Zn.fire([m, void 0, void 0]);
    }
    i(ui, "readErrorHandler");
    function di(m) {
      Zn.fire(m);
    }
    i(di, "writeErrorHandler"), g.onClose(ra), g.onError(ui), E.onClose(ra), E.onError(di);
    function na() {
      ct || Re.size === 0 || (ct = (0, t.default)().timer.setImmediate(() => {
        ct = void 0, fi();
      }));
    }
    i(na, "triggerMessageQueue");
    function aa(m) {
      n.Message.isRequest(m) ? pi(m) : n.Message.isNotification(m) ? mi(m) : n.Message.isResponse(m) ? hi(m) : gi(m);
    }
    i(aa, "handleMessage");
    function fi() {
      if (Re.size === 0) return;
      const m = Re.shift();
      try {
        const N = R == null ? void 0 : R.messageStrategy;
        ce.is(N) ? N.handleMessage(m, aa) : aa(m);
      } finally {
        na();
      }
    }
    ...
    const qs = i((m) => {
      try {
        if (n.Message.isNotification(m) && m.method === l.type.method) {
          const N = m.params.id, L = Qn(N), x = Re.get(L);
          if (n.Message.isRequest(x)) {
            const ue = R == null ? void 0 : R.connectionStrategy, be = ue && ue.cancelUndispatched ? ue.cancelUndispatched(x, ci) : void 0;
            if (be && (be.error !== void 0 || be.result !== void 0)) {
              Re.delete(L), Se.delete(N), be.id = x.id, Pr(be, m.method, Date.now()), E.write(be).catch(() => S.error("Sending response for canceled message failed."));
              return;
            }
          }
          const ge = Se.get(N);
    ...
    function pi(m) {
      if (zt()) return;
      function N(re, Ee, se) {
        const De = { jsonrpc: z, id: m.id };
        re instanceof n.ResponseError ? De.error = re.toJson() : De.result = re === void 0 ? null : re, Pr(De, Ee, se), E.write(De).catch(() => S.error("Sending response failed."));
      }
      i(N, "reply");
      function L(re, Ee, se) {
        const De = { jsonrpc: z, id: m.id, error: re.toJson() };
        Pr(De, Ee, se), E.write(De).catch(() => S.error("Sending response failed."));
      }
      i(L, "replyError");
      function x(re, Ee, se) {
        re === void 0 && (re = null);
        const De = { jsonrpc: z, id: m.id, result: re };
        Pr(De, Ee, se), E.write(De).catch(() => S.error("Sending response failed."));
      }
      i(x, "replySuccess"), Ti(m);
      ...
      if (be || B) {
        ...
        m.id !== null && qe.has(m.id) && Ee.cancel(), m.id !== null && Se.set(re, Ee);
        try {
          let se;
          if (be) if (m.params === void 0) {
          ...
          se ? De.then ? De.then((We) => {
            Se.delete(re), N(We, m.method, ke);
          }, (We) => {
            Se.delete(re), We instanceof n.ResponseError ? L(We, m.method, ke) : We && r.string(We.message) ? L(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${m.method} failed with message: ${We.message}`), m.method, ke) : L(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${m.method} failed unexpectedly without providing any details.`), m.method, ke);
          }) : (Se.delete(re), N(se, m.method, ke)) : (Se.delete(re), x(se, m.method, ke));
        } catch (se) {
          Se.delete(re), se instanceof n.ResponseError ? N(se, m.method, ke) : se && r.string(se.message) ? L(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${m.method} failed with message: ${se.message}`), m.method, ke) : L(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${m.method} failed unexpectedly without providing any details.`), m.method, ke);
        }
      } else L(new n.ResponseError(n.ErrorCodes.MethodNotFound, `Unhandled method ${m.method}`), m.method, ke);
    }
    i(pi, "handleRequest");
    function hi(m) {
      if (!zt()) if (m.id === null) m.error ? S.error(`Received response message without id: Error is: 
${JSON.stringify(m.error, void 0, 4)}`) : S.error("Received response message without id. No further error information provided.");
      else {
        ...
        if (Ri(m, L), L !== void 0) {
          ...
          try {
            ...
            } else if (m.result !== void 0) L.resolve(m.result);
            else throw new Error("Should never happen.");
          } catch (x) {
            x.message ? S.error(`Response handler '${L.method}' failed with message: ${x.message}`) : S.error(`Response handler '${L.method}' failed unexpectedly.`);
          }
        }
      }
    }
    ...
    function mi(m) {
      ...
      if (L || J) try {
        if (Yr(m), L) if (m.params === void 0) N !== void 0 && N.numberOfParams !== 0 && N.parameterStructures !== n.ParameterStructures.byName && S.error(`Notification ${m.method} defines ${N.numberOfParams} params but received none.`), L();
        else if (Array.isArray(m.params)) {
          const x = m.params;
          m.method === u.type.method && x.length === 2 && c.is(x[0]) ? L({ token: x[0], value: x[1] }) : (N !== void 0 && (N.parameterStructures === n.ParameterStructures.byName && S.error(`Notification ${m.method} defines parameters by name but received parameters by position`), N.numberOfParams !== m.params.length && S.error(`Notification ${m.method} defines ${N.numberOfParams} params but received ${x.length} arguments`)), L(...x));
        } else N !== void 0 && N.parameterStructures === n.ParameterStructures.byPosition && S.error(`Notification ${m.method} defines parameters by position but received parameters by name`), L(m.params);
        else J && J(m.method, m.params);
      } catch (x) {
        x.message ? S.error(`Notification handler '${m.method}' failed with message: ${x.message}`) : S.error(`Notification handler '${m.method}' failed unexpectedly.`);
      }
      else ni.fire(m);
    }
    i(mi, "handleNotification");
    function gi(m) {
      if (!m) {
...
`), me.log(`Sending notification '${m.method}'.`, N);
      } else Bt("send-notification", m);
    }
    i(vi, "traceSendingNotification");
    function Pr(m, N, L) {
      if (!(Q === h.Off || !me)) if (rt === v.Text) {
        let x;
...
`)), me.log(`Sending response '${N} - (${m.id})'. Processing request took ${Date.now() - L}ms`, x);
      } else Bt("send-response", m);
    }
    i(Pr, "traceSendingResponse");
    function Ti(m) {
      if (!(Q === h.Off || !me)) if (rt === v.Text) {
        let N;
        (Q === h.Verbose || Q === h.Compact) && m.params && (N = `Params: ${$t(m.params)}
...
`), me.log(`Received request '${m.method} - (${m.id})'.`, N);
      } else Bt("receive-request", m);
    }
    i(Ti, "traceReceivedRequest");
    function Yr(m) {
      if (!(Q === h.Off || !me || m.method === b.type.method)) if (rt === v.Text) {
        let N;
        (Q === h.Verbose || Q === h.Compact) && (m.params ? N = `Params: ${$t(m.params)}
...
`), me.log(`Received notification '${m.method}'.`, N);
      } else Bt("receive-notification", m);
    }
    i(Yr, "traceReceivedNotification");
    function Ri(m, N) {
      if (!(Q === h.Off || !me)) if (rt === v.Text) {
        let L;
...
`)), N) {
        ...
        } else me.log(`Received response ${m.id} without active response promise.`, L);
      } else Bt("receive-response", m);
    }
    i(Ri, "traceReceivedResponse");
    function Bt(m, N) {
      if (!me || Q === h.Off) return;
      const L = { isLSPMessage: true, type: m, message: N, timestamp: Date.now() };
      me.log(L);
    }
    i(Bt, "logLSPMessage");
    function lr() {
      if (ta()) throw new I(w.Closed, "Connection is closed.");
      if (zt()) throw new I(w.Disposed, "Connection is disposed.");
    }
    i(lr, "throwIfClosedOrDisposed");
    function $i() {
      if (ea()) throw new I(w.AlreadyListening, "Connection is already listening");
    }
    i($i, "throwIfListening");
    function Ai() {
      if (!ea()) throw new Error("Call listen() first.");
    }
    i(Ai, "throwIfNotListening");
    function cr(m) {
    ...
    function ae(m, N) {
      switch (m) {
        case n.ParameterStructures.auto:
          return p(N) ? ia(N) : [cr(N)];
        case n.ParameterStructures.byName:
          if (!p(N)) throw new Error("Received parameters by name but param is not an object literal.");
          return ia(N);
    ...
    function $e(m, N) {
      ...
      switch (x) {
        ...
        default:
          L = [];
          for (let ge = 0; ge < N.length && ge < x; ge++) L.push(cr(N[ge]));
          if (N.length < x) for (let ge = N.length; ge < x; ge++) L.push(null);
          break;
      }
      return L;
    }
    i($e, "computeMessageParams");
    const W = { sendNotification: i((m, ...N) => {
      lr();
      let L, x;
      if (r.string(m)) {
        L = m;
        const ue = N[0];
        let be = 0, ke = n.ParameterStructures.auto;
        n.ParameterStructures.is(ue) && (be = 1, ke = ue);
        let re = N.length;
        const Ee = re - be;
        switch (Ee) {
          case 0:
          ...
          case 1:
            ...
            break;
          default:
            if (ke === n.ParameterStructures.byName) throw new Error(`Received ${Ee} parameters for 'by Name' notification parameter structure.`);
            x = N.slice(be, re).map((se) => cr(se));
            break;
        }
      } else {
        const ue = N;
      ...
      const ge = { jsonrpc: z, method: L, params: x };
      return vi(ge), E.write(ge).catch((ue) => {
        throw S.error("Sending notification failed."), ue;
      });
    }, "sendNotification"), onNotification: i((m, N) => {
      lr();
      let L;
      return r.func(m) ? J = m : N && (r.string(m) ? (L = m, te.set(m, { type: void 0, handler: N })) : (L = m.method, te.set(m.method, { type: m, handler: N }))), { dispose: i(() => {
        L !== void 0 ? te.delete(L) : J = void 0;
      }, "dispose") };
    }, "onNotification"), onProgress: i((m, N, L) => {
      if (de.has(N)) throw new Error(`Progress handler for token ${N} already registered`);
      return de.set(N, L), { dispose: i(() => {
        de.delete(N);
      }, "dispose") };
    }, "onProgress"), sendProgress: i((m, N, L) => W.sendNotification(u.type, { token: N, value: L }), "sendProgress"), onUnhandledProgress: ai.event, sendRequest: i((m, ...N) => {
      lr(), Ai();
      let L, x, ge;
      if (r.string(m)) {
        L = m;
        ...
        switch (Kt) {
          ...
          case 1:
            ...
            break;
          default:
            if (De === n.ParameterStructures.byName) throw new Error(`Received ${Kt} parameters for 'by Name' request parameter structure.`);
            x = N.slice(se, We).map((Zb) => cr(Zb));
            break;
        }
      } else {
        const re = N;
      ...
      ge && (be = ge.onCancellationRequested(() => {
        ...
        return re === void 0 ? (S.log(`Received no promise from cancellation strategy when cancelling id ${ue}`), Promise.resolve()) : re.catch(() => {
          S.log(`Sending cancellation messages for id ${ue} failed`);
        });
      }));
      const ke = { jsonrpc: z, id: ue, method: L, params: x };
      return yi(ke), typeof kt.sender.enableCancellation == "function" && kt.sender.enableCancellation(ke), new Promise(async (re, Ee) => {
        const se = i((Kt) => {
          re(Kt), kt.sender.cleanup(ue), be == null ? void 0 : be.dispose();
        }, "resolveWithCleanup"), De = i((Kt) => {
          Ee(Kt), kt.sender.cleanup(ue), be == null ? void 0 : be.dispose();
        }, "rejectWithCleanup"), We = { method: L, timerStart: Date.now(), resolve: se, reject: De };
        try {
          await E.write(ke), Oe.set(ue, We);
        } catch (Kt) {
          throw S.error("Sending request failed."), We.reject(new n.ResponseError(n.ErrorCodes.MessageWriteError, Kt.message ? Kt.message : "Unknown reason")), Kt;
        }
      });
    }, "sendRequest"), onRequest: i((m, N) => {
      lr();
      let L = null;
      return f.is(m) ? (L = void 0, B = m) : r.string(m) ? (L = null, N !== void 0 && (L = m, Z.set(m, { handler: N, type: void 0 }))) : N !== void 0 && (L = m.method, Z.set(m.method, { type: m, handler: N })), { dispose: i(() => {
        L !== null && (L !== void 0 ? Z.delete(L) : B = void 0);
      }, "dispose") };
    }, "onRequest"), hasPendingResponse: i(() => Oe.size > 0, "hasPendingResponse"), trace: i(async (m, N, L) => {
      let x = false, ge = v.Text;
      L !== void 0 && (r.boolean(L) ? x = L : (x = L.sendNotification || false, ge = L.traceFormat || v.Text)), Q = m, rt = ge, Q === h.Off ? me = void 0 : me = N, x && !ta() && !zt() && await W.sendNotification(C.type, { value: h.toString(m) });
    }, "trace"), onError: Zn.event, onClose: ri.event, onUnhandledNotification: ni.event, onDispose: ii.event, end: i(() => {
      E.end();
    }, "end"), dispose: i(() => {
      if (zt()) return;
      Nt = P.Disposed, ii.fire(void 0);
      const m = new n.ResponseError(n.ErrorCodes.PendingResponseRejected, "Pending response rejected since connection got disposed");
      for (const N of Oe.values()) N.reject(m);
      Oe = /* @__PURE__ */ new Map(), Se = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), Re = new a.LinkedMap(), r.func(E.dispose) && E.dispose(), r.func(g.dispose) && g.dispose();
    }, "dispose"), listen: i(() => {
      lr(), $i(), Nt = P.Listening, g.listen(qs);
    }, "listen"), inspect: i(() => {
      (0, t.default)().console.log("inspect");
    }, "inspect") };
    return W.onNotification(b.type, (m) => {
      if (Q === h.Off || !me) return;
      const N = Q === h.Verbose || Q === h.Compact;
      me.log(m.message, N ? m.verbose : void 0);
    }), W.onNotification(u.type, (m) => {
      const N = de.get(m.token);
      N ? N(m.value) : ai.fire(m);
    }), W;
  }
  i(_, "createMessageConnection"), e.createMessageConnection = _;
} }), ed = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/api.js"(e) {
  ...
  var t = Ig();
  Object.defineProperty(e, "Message", { enumerable: true, get: i(function() {
    return t.Message;
  }, "get") }), Object.defineProperty(e, "RequestType", { enumerable: true, get: i(function() {
    return t.RequestType;
  }, "get") }), Object.defineProperty(e, "RequestType0", { enumerable: true, get: i(function() {
    return t.RequestType0;
  }, "get") }), Object.defineProperty(e, "RequestType1", { enumerable: true, get: i(function() {
    return t.RequestType1;
  }, "get") }), Object.defineProperty(e, "RequestType2", { enumerable: true, get: i(function() {
    return t.RequestType2;
  }, "get") }), Object.defineProperty(e, "RequestType3", { enumerable: true, get: i(function() {
    return t.RequestType3;
  }, "get") }), Object.defineProperty(e, "RequestType4", { enumerable: true, get: i(function() {
    return t.RequestType4;
  }, "get") }), Object.defineProperty(e, "RequestType5", { enumerable: true, get: i(function() {
    return t.RequestType5;
  }, "get") }), Object.defineProperty(e, "RequestType6", { enumerable: true, get: i(function() {
    return t.RequestType6;
  }, "get") }), Object.defineProperty(e, "RequestType7", { enumerable: true, get: i(function() {
    return t.RequestType7;
  }, "get") }), Object.defineProperty(e, "RequestType8", { enumerable: true, get: i(function() {
    return t.RequestType8;
  }, "get") }), Object.defineProperty(e, "RequestType9", { enumerable: true, get: i(function() {
    return t.RequestType9;
  }, "get") }), Object.defineProperty(e, "ResponseError", { enumerable: true, get: i(function() {
    return t.ResponseError;
  }, "get") }), Object.defineProperty(e, "ErrorCodes", { enumerable: true, get: i(function() {
    return t.ErrorCodes;
  }, "get") }), Object.defineProperty(e, "NotificationType", { enumerable: true, get: i(function() {
    return t.NotificationType;
  }, "get") }), Object.defineProperty(e, "NotificationType0", { enumerable: true, get: i(function() {
    return t.NotificationType0;
  }, "get") }), Object.defineProperty(e, "NotificationType1", { enumerable: true, get: i(function() {
    return t.NotificationType1;
  }, "get") }), Object.defineProperty(e, "NotificationType2", { enumerable: true, get: i(function() {
    return t.NotificationType2;
  }, "get") }), Object.defineProperty(e, "NotificationType3", { enumerable: true, get: i(function() {
    return t.NotificationType3;
  }, "get") }), Object.defineProperty(e, "NotificationType4", { enumerable: true, get: i(function() {
    return t.NotificationType4;
  }, "get") }), Object.defineProperty(e, "NotificationType5", { enumerable: true, get: i(function() {
    return t.NotificationType5;
  }, "get") }), Object.defineProperty(e, "NotificationType6", { enumerable: true, get: i(function() {
    return t.NotificationType6;
  }, "get") }), Object.defineProperty(e, "NotificationType7", { enumerable: true, get: i(function() {
    return t.NotificationType7;
  }, "get") }), Object.defineProperty(e, "NotificationType8", { enumerable: true, get: i(function() {
    return t.NotificationType8;
  }, "get") }), Object.defineProperty(e, "NotificationType9", { enumerable: true, get: i(function() {
    return t.NotificationType9;
  }, "get") }), Object.defineProperty(e, "ParameterStructures", { enumerable: true, get: i(function() {
    return t.ParameterStructures;
  }, "get") });
  var r = kg();
  Object.defineProperty(e, "LinkedMap", { enumerable: true, get: i(function() {
    return r.LinkedMap;
  }, "get") }), Object.defineProperty(e, "LRUCache", { enumerable: true, get: i(function() {
    return r.LRUCache;
  }, "get") }), Object.defineProperty(e, "Touch", { enumerable: true, get: i(function() {
    return r.Touch;
  }, "get") });
  var n = aw();
  Object.defineProperty(e, "Disposable", { enumerable: true, get: i(function() {
    return n.Disposable;
  }, "get") });
  var a = qa();
  Object.defineProperty(e, "Event", { enumerable: true, get: i(function() {
    return a.Event;
  }, "get") }), Object.defineProperty(e, "Emitter", { enumerable: true, get: i(function() {
    return a.Emitter;
  }, "get") });
  var s = El();
  Object.defineProperty(e, "CancellationTokenSource", { enumerable: true, get: i(function() {
    return s.CancellationTokenSource;
  }, "get") }), Object.defineProperty(e, "CancellationToken", { enumerable: true, get: i(function() {
    return s.CancellationToken;
  }, "get") });
  var o = iw();
  Object.defineProperty(e, "SharedArraySenderStrategy", { enumerable: true, get: i(function() {
    return o.SharedArraySenderStrategy;
  }, "get") }), Object.defineProperty(e, "SharedArrayReceiverStrategy", { enumerable: true, get: i(function() {
    return o.SharedArrayReceiverStrategy;
  }, "get") });
  var l = sw();
  Object.defineProperty(e, "MessageReader", { enumerable: true, get: i(function() {
    return l.MessageReader;
  }, "get") }), Object.defineProperty(e, "AbstractMessageReader", { enumerable: true, get: i(function() {
    return l.AbstractMessageReader;
  }, "get") }), Object.defineProperty(e, "ReadableStreamMessageReader", { enumerable: true, get: i(function() {
    return l.ReadableStreamMessageReader;
  }, "get") });
  var c = ow();
  Object.defineProperty(e, "MessageWriter", { enumerable: true, get: i(function() {
    return c.MessageWriter;
  }, "get") }), Object.defineProperty(e, "AbstractMessageWriter", { enumerable: true, get: i(function() {
    return c.AbstractMessageWriter;
  }, "get") }), Object.defineProperty(e, "WriteableStreamMessageWriter", { enumerable: true, get: i(function() {
    return c.WriteableStreamMessageWriter;
  }, "get") });
  var u = lw();
  Object.defineProperty(e, "AbstractMessageBuffer", { enumerable: true, get: i(function() {
    return u.AbstractMessageBuffer;
  }, "get") });
  var d = cw();
  Object.defineProperty(e, "ConnectionStrategy", { enumerable: true, get: i(function() {
    return d.ConnectionStrategy;
  }, "get") }), Object.defineProperty(e, "ConnectionOptions", { enumerable: true, get: i(function() {
    return d.ConnectionOptions;
  }, "get") }), Object.defineProperty(e, "NullLogger", { enumerable: true, get: i(function() {
    return d.NullLogger;
  }, "get") }), Object.defineProperty(e, "createMessageConnection", { enumerable: true, get: i(function() {
    return d.createMessageConnection;
  }, "get") }), Object.defineProperty(e, "ProgressToken", { enumerable: true, get: i(function() {
    return d.ProgressToken;
  }, "get") }), Object.defineProperty(e, "ProgressType", { enumerable: true, get: i(function() {
    return d.ProgressType;
  }, "get") }), Object.defineProperty(e, "Trace", { enumerable: true, get: i(function() {
    return d.Trace;
  }, "get") }), Object.defineProperty(e, "TraceValues", { enumerable: true, get: i(function() {
    return d.TraceValues;
  }, "get") }), Object.defineProperty(e, "TraceFormat", { enumerable: true, get: i(function() {
    return d.TraceFormat;
  }, "get") }), Object.defineProperty(e, "SetTraceNotification", { enumerable: true, get: i(function() {
    return d.SetTraceNotification;
  }, "get") }), Object.defineProperty(e, "LogTraceNotification", { enumerable: true, get: i(function() {
    return d.LogTraceNotification;
  }, "get") }), Object.defineProperty(e, "ConnectionErrors", { enumerable: true, get: i(function() {
    return d.ConnectionErrors;
  }, "get") }), Object.defineProperty(e, "ConnectionError", { enumerable: true, get: i(function() {
    return d.ConnectionError;
  }, "get") }), Object.defineProperty(e, "CancellationReceiverStrategy", { enumerable: true, get: i(function() {
    return d.CancellationReceiverStrategy;
  }, "get") }), Object.defineProperty(e, "CancellationSenderStrategy", { enumerable: true, get: i(function() {
    return d.CancellationSenderStrategy;
  }, "get") }), Object.defineProperty(e, "CancellationStrategy", { enumerable: true, get: i(function() {
    return d.CancellationStrategy;
  }, "get") }), Object.defineProperty(e, "MessageStrategy", { enumerable: true, get: i(function() {
    return d.MessageStrategy;
  }, "get") });
  var f = kn();
  e.RAL = f.default;
} }), uw = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/browser/ril.js"(e) {
  var _a3, _b3, _c3;
  Object.defineProperty(e, "__esModule", { value: true });
  var t = ed(), r = (_a3 = class extends t.AbstractMessageBuffer {
    constructor(u = "utf-8") {
    ...
    toString(u, d) {
      return d === "ascii" ? this.asciiDecoder.decode(u) : new TextDecoder(d).decode(u);
    }
    asNative(u, d) {
      return d === void 0 ? u : u.slice(0, d);
    }
    allocNative(u) {
      return new Uint8Array(u);
    }
  }, i(_a3, "MessageBuffer"), _a3);
  r.emptyBuffer = new Uint8Array(0);
  var n = (_b3 = class {
    constructor(c) {
      this.socket = c, this._onData = new t.Emitter(), this._messageListener = (u) => {
        u.data.arrayBuffer().then((f) => {
  ...
  }, i(_b3, "ReadableStreamWrapper"), _b3), a = (_c3 = class {
    constructor(c) {
      this.socket = c;
    }
    onClose(c) {
    ...
    write(c, u) {
      if (typeof c == "string") {
        if (u !== void 0 && u !== "utf-8") throw new Error(`In a Browser environments only utf-8 text encoding is supported. But got encoding: ${u}`);
        this.socket.send(c);
  ...
  }, i(_c3, "WritableStreamWrapper"), _c3), s = new TextEncoder(), o = Object.freeze({ messageBuffer: Object.freeze({ create: i((c) => new r(c), "create") }), applicationJson: Object.freeze({ encoder: Object.freeze({ name: "application/json", encode: i((c, u) => {
    if (u.charset !== "utf-8") throw new Error(`In a Browser environments only utf-8 text encoding is supported. But got encoding: ${u.charset}`);
    return Promise.resolve(s.encode(JSON.stringify(c, void 0, 0)));
  }, "encode") }), decoder: Object.freeze({ name: "application/json", decode: i((c, u) => {
  ...
  }, "decode") }) }), stream: Object.freeze({ asReadableStream: i((c) => new n(c), "asReadableStream"), asWritableStream: i((c) => new a(c), "asWritableStream") }), console, timer: Object.freeze({ setTimeout(c, u, ...d) {
    const f = setTimeout(c, u, ...d);
    return { dispose: i(() => clearTimeout(f), "dispose") };
  }, setImmediate(c, ...u) {
    const d = setTimeout(c, 0, ...u);
    return { dispose: i(() => clearTimeout(d), "dispose") };
  }, setInterval(c, u, ...d) {
    const f = setInterval(c, u, ...d);
    return { dispose: i(() => clearInterval(f), "dispose") };
  } }) });
  function l() {
    return o;
  }
...
} }), Wa = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/browser/main.js"(e) {
  var _a3, _b3;
  var t = e && e.__createBinding || (Object.create ? (function(c, u, d, f) {
    f === void 0 && (f = d);
    var h = Object.getOwnPropertyDescriptor(u, d);
    (!h || ("get" in h ? !u.__esModule : h.writable || h.configurable)) && (h = { enumerable: true, get: i(function() {
      return u[d];
    }, "get") }), Object.defineProperty(c, f, h);
  }) : (function(c, u, d, f) {
    f === void 0 && (f = d), c[f] = u[d];
  })), r = e && e.__exportStar || function(c, u) {
    for (var d in c) d !== "default" && !Object.prototype.hasOwnProperty.call(u, d) && t(u, c, d);
  };
  ...
  var a = ed();
  r(ed(), e);
  var s = (_a3 = class extends a.AbstractMessageReader {
    constructor(c) {
  ...
  }, i(_a3, "BrowserMessageReader"), _a3);
  e.BrowserMessageReader = s;
  var o = (_b3 = class extends a.AbstractMessageWriter {
    constructor(c) {
  ...
  }, i(_b3, "BrowserMessageWriter"), _b3);
  e.BrowserMessageWriter = o;
  function l(c, u, d, f) {
    return d === void 0 && (d = a.NullLogger), a.ConnectionStrategy.is(f) && (f = { connectionStrategy: f }), (0, a.createMessageConnection)(c, u, d, f);
  }
  i(l, "createMessageConnection"), e.createMessageConnection = l;
} }), xh = V({ "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/browser.js"(e, t) {
  t.exports = Wa();
} }), Ce = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/messages.js"(e) {
  ...
  }, i(_a3, "RegistrationType"), _a3);
  e.RegistrationType = n;
  var a = (_b3 = class extends t.RequestType0 {
    constructor(c) {
      super(c);
    }
  }, i(_b3, "ProtocolRequestType0"), _b3);
  e.ProtocolRequestType0 = a;
  var s = (_c3 = class extends t.RequestType {
    constructor(c) {
      super(c, t.ParameterStructures.byName);
    }
  }, i(_c3, "ProtocolRequestType"), _c3);
  e.ProtocolRequestType = s;
  var o = (_d3 = class extends t.NotificationType0 {
    constructor(c) {
      super(c);
    }
  }, i(_d3, "ProtocolNotificationType0"), _d3);
  e.ProtocolNotificationType0 = o;
  var l = (_e3 = class extends t.NotificationType {
    constructor(c) {
      super(c, t.ParameterStructures.byName);
    }
  }, i(_e3, "ProtocolNotificationType"), _e3);
  e.ProtocolNotificationType = l;
} }), Qd = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/utils/is.js"(e) {
...
} }), dw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.implementation.js"(e) {
...
} }), fw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.typeDefinition.js"(e) {
...
} }), pw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.workspaceFolder.js"(e) {
...
} }), hw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.configuration.js"(e) {
...
} }), mw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.colorProvider.js"(e) {
...
} }), gw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.foldingRange.js"(e) {
...
} }), yw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.declaration.js"(e) {
...
} }), vw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.selectionRange.js"(e) {
...
} }), Tw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.progress.js"(e) {
...
} }), Rw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.callHierarchy.js"(e) {
...
} }), $w = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.semanticTokens.js"(e) {
...
} }), Aw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.showDocument.js"(e) {
...
} }), Ew = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.linkedEditingRange.js"(e) {
...
} }), _w = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.fileOperations.js"(e) {
...
} }), Cw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.moniker.js"(e) {
...
} }), Sw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.typeHierarchy.js"(e) {
...
} }), bw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.inlineValue.js"(e) {
...
} }), ww = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.inlayHint.js"(e) {
...
} }), Iw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.diagnostic.js"(e) {
...
} }), Nw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.notebook.js"(e) {
  ...
  (function(v) {
    function C(I, A) {
      ...
      return (A === true || A === false) && (k.success = A), k;
    }
  ...
  (function(v) {
    ...
    function I(A, k) {
      if (A === k) return true;
      if (A == null || k === null || k === void 0 || typeof A != typeof k || typeof A != "object") return false;
      const G = Array.isArray(A), H = Array.isArray(k);
      if (G !== H) return false;
      if (G && H) {
        if (A.length !== k.length) return false;
        for (let X = 0; X < A.length; X++) if (!I(A[X], k[X])) return false;
      }
      if (r.objectLiteral(A) && r.objectLiteral(k)) {
        const X = Object.keys(A), le = Object.keys(k);
        if (X.length !== le.length || (X.sort(), le.sort(), !I(X, le))) return false;
        for (let ce = 0; ce < X.length; ce++) {
          const Ne = X[ce];
          if (!I(A[Ne], k[Ne])) return false;
        }
      }
      return true;
    }
...
} }), kw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.inlineCompletion.js"(e) {
...
} }), Pw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.js"(e) {
  ...
  var t = Ce(), r = (_s(), Zd(Al)), n = Qd(), a = dw();
  Object.defineProperty(e, "ImplementationRequest", { enumerable: true, get: i(function() {
    return a.ImplementationRequest;
  }, "get") });
  var s = fw();
  Object.defineProperty(e, "TypeDefinitionRequest", { enumerable: true, get: i(function() {
    return s.TypeDefinitionRequest;
  }, "get") });
  var o = pw();
  Object.defineProperty(e, "WorkspaceFoldersRequest", { enumerable: true, get: i(function() {
    return o.WorkspaceFoldersRequest;
  }, "get") }), Object.defineProperty(e, "DidChangeWorkspaceFoldersNotification", { enumerable: true, get: i(function() {
    return o.DidChangeWorkspaceFoldersNotification;
  }, "get") });
  var l = hw();
  Object.defineProperty(e, "ConfigurationRequest", { enumerable: true, get: i(function() {
    return l.ConfigurationRequest;
  }, "get") });
  var c = mw();
  Object.defineProperty(e, "DocumentColorRequest", { enumerable: true, get: i(function() {
    return c.DocumentColorRequest;
  }, "get") }), Object.defineProperty(e, "ColorPresentationRequest", { enumerable: true, get: i(function() {
    return c.ColorPresentationRequest;
  }, "get") });
  var u = gw();
  Object.defineProperty(e, "FoldingRangeRequest", { enumerable: true, get: i(function() {
    return u.FoldingRangeRequest;
  }, "get") }), Object.defineProperty(e, "FoldingRangeRefreshRequest", { enumerable: true, get: i(function() {
    return u.FoldingRangeRefreshRequest;
  }, "get") });
  var d = yw();
  Object.defineProperty(e, "DeclarationRequest", { enumerable: true, get: i(function() {
    return d.DeclarationRequest;
  }, "get") });
  var f = vw();
  Object.defineProperty(e, "SelectionRangeRequest", { enumerable: true, get: i(function() {
    return f.SelectionRangeRequest;
  }, "get") });
  var h = Tw();
  Object.defineProperty(e, "WorkDoneProgress", { enumerable: true, get: i(function() {
    return h.WorkDoneProgress;
  }, "get") }), Object.defineProperty(e, "WorkDoneProgressCreateRequest", { enumerable: true, get: i(function() {
    return h.WorkDoneProgressCreateRequest;
  }, "get") }), Object.defineProperty(e, "WorkDoneProgressCancelNotification", { enumerable: true, get: i(function() {
    return h.WorkDoneProgressCancelNotification;
  }, "get") });
  var y = Rw();
  Object.defineProperty(e, "CallHierarchyIncomingCallsRequest", { enumerable: true, get: i(function() {
    return y.CallHierarchyIncomingCallsRequest;
  }, "get") }), Object.defineProperty(e, "CallHierarchyOutgoingCallsRequest", { enumerable: true, get: i(function() {
    return y.CallHierarchyOutgoingCallsRequest;
  }, "get") }), Object.defineProperty(e, "CallHierarchyPrepareRequest", { enumerable: true, get: i(function() {
    return y.CallHierarchyPrepareRequest;
  }, "get") });
  var v = $w();
  Object.defineProperty(e, "TokenFormat", { enumerable: true, get: i(function() {
    return v.TokenFormat;
  }, "get") }), Object.defineProperty(e, "SemanticTokensRequest", { enumerable: true, get: i(function() {
    return v.SemanticTokensRequest;
  }, "get") }), Object.defineProperty(e, "SemanticTokensDeltaRequest", { enumerable: true, get: i(function() {
    return v.SemanticTokensDeltaRequest;
  }, "get") }), Object.defineProperty(e, "SemanticTokensRangeRequest", { enumerable: true, get: i(function() {
    return v.SemanticTokensRangeRequest;
  }, "get") }), Object.defineProperty(e, "SemanticTokensRefreshRequest", { enumerable: true, get: i(function() {
    return v.SemanticTokensRefreshRequest;
  }, "get") }), Object.defineProperty(e, "SemanticTokensRegistrationType", { enumerable: true, get: i(function() {
    return v.SemanticTokensRegistrationType;
  }, "get") });
  var C = Aw();
  Object.defineProperty(e, "ShowDocumentRequest", { enumerable: true, get: i(function() {
    return C.ShowDocumentRequest;
  }, "get") });
  var b = Ew();
  Object.defineProperty(e, "LinkedEditingRangeRequest", { enumerable: true, get: i(function() {
    return b.LinkedEditingRangeRequest;
  }, "get") });
  var w = _w();
  Object.defineProperty(e, "FileOperationPatternKind", { enumerable: true, get: i(function() {
    return w.FileOperationPatternKind;
  }, "get") }), Object.defineProperty(e, "DidCreateFilesNotification", { enumerable: true, get: i(function() {
    return w.DidCreateFilesNotification;
  }, "get") }), Object.defineProperty(e, "WillCreateFilesRequest", { enumerable: true, get: i(function() {
    return w.WillCreateFilesRequest;
  }, "get") }), Object.defineProperty(e, "DidRenameFilesNotification", { enumerable: true, get: i(function() {
    return w.DidRenameFilesNotification;
  }, "get") }), Object.defineProperty(e, "WillRenameFilesRequest", { enumerable: true, get: i(function() {
    return w.WillRenameFilesRequest;
  }, "get") }), Object.defineProperty(e, "DidDeleteFilesNotification", { enumerable: true, get: i(function() {
    return w.DidDeleteFilesNotification;
  }, "get") }), Object.defineProperty(e, "WillDeleteFilesRequest", { enumerable: true, get: i(function() {
    return w.WillDeleteFilesRequest;
  }, "get") });
  var I = Cw();
  Object.defineProperty(e, "UniquenessLevel", { enumerable: true, get: i(function() {
    return I.UniquenessLevel;
  }, "get") }), Object.defineProperty(e, "MonikerKind", { enumerable: true, get: i(function() {
    return I.MonikerKind;
  }, "get") }), Object.defineProperty(e, "MonikerRequest", { enumerable: true, get: i(function() {
    return I.MonikerRequest;
  }, "get") });
  var A = Sw();
  Object.defineProperty(e, "TypeHierarchyPrepareRequest", { enumerable: true, get: i(function() {
    return A.TypeHierarchyPrepareRequest;
  }, "get") }), Object.defineProperty(e, "TypeHierarchySubtypesRequest", { enumerable: true, get: i(function() {
    return A.TypeHierarchySubtypesRequest;
  }, "get") }), Object.defineProperty(e, "TypeHierarchySupertypesRequest", { enumerable: true, get: i(function() {
    return A.TypeHierarchySupertypesRequest;
  }, "get") });
  var k = bw();
  Object.defineProperty(e, "InlineValueRequest", { enumerable: true, get: i(function() {
    return k.InlineValueRequest;
  }, "get") }), Object.defineProperty(e, "InlineValueRefreshRequest", { enumerable: true, get: i(function() {
    return k.InlineValueRefreshRequest;
  }, "get") });
  var G = ww();
  Object.defineProperty(e, "InlayHintRequest", { enumerable: true, get: i(function() {
    return G.InlayHintRequest;
  }, "get") }), Object.defineProperty(e, "InlayHintResolveRequest", { enumerable: true, get: i(function() {
    return G.InlayHintResolveRequest;
  }, "get") }), Object.defineProperty(e, "InlayHintRefreshRequest", { enumerable: true, get: i(function() {
    return G.InlayHintRefreshRequest;
  }, "get") });
  var H = Iw();
  Object.defineProperty(e, "DiagnosticServerCancellationData", { enumerable: true, get: i(function() {
    return H.DiagnosticServerCancellationData;
  }, "get") }), Object.defineProperty(e, "DocumentDiagnosticReportKind", { enumerable: true, get: i(function() {
    return H.DocumentDiagnosticReportKind;
  }, "get") }), Object.defineProperty(e, "DocumentDiagnosticRequest", { enumerable: true, get: i(function() {
    return H.DocumentDiagnosticRequest;
  }, "get") }), Object.defineProperty(e, "WorkspaceDiagnosticRequest", { enumerable: true, get: i(function() {
    return H.WorkspaceDiagnosticRequest;
  }, "get") }), Object.defineProperty(e, "DiagnosticRefreshRequest", { enumerable: true, get: i(function() {
    return H.DiagnosticRefreshRequest;
  }, "get") });
  var X = Nw();
  Object.defineProperty(e, "NotebookCellKind", { enumerable: true, get: i(function() {
    return X.NotebookCellKind;
  }, "get") }), Object.defineProperty(e, "ExecutionSummary", { enumerable: true, get: i(function() {
    return X.ExecutionSummary;
  }, "get") }), Object.defineProperty(e, "NotebookCell", { enumerable: true, get: i(function() {
    return X.NotebookCell;
  }, "get") }), Object.defineProperty(e, "NotebookDocument", { enumerable: true, get: i(function() {
    return X.NotebookDocument;
  }, "get") }), Object.defineProperty(e, "NotebookDocumentSyncRegistrationType", { enumerable: true, get: i(function() {
    return X.NotebookDocumentSyncRegistrationType;
  }, "get") }), Object.defineProperty(e, "DidOpenNotebookDocumentNotification", { enumerable: true, get: i(function() {
    return X.DidOpenNotebookDocumentNotification;
  }, "get") }), Object.defineProperty(e, "NotebookCellArrayChange", { enumerable: true, get: i(function() {
    return X.NotebookCellArrayChange;
  }, "get") }), Object.defineProperty(e, "DidChangeNotebookDocumentNotification", { enumerable: true, get: i(function() {
    return X.DidChangeNotebookDocumentNotification;
  }, "get") }), Object.defineProperty(e, "DidSaveNotebookDocumentNotification", { enumerable: true, get: i(function() {
    return X.DidSaveNotebookDocumentNotification;
  }, "get") }), Object.defineProperty(e, "DidCloseNotebookDocumentNotification", { enumerable: true, get: i(function() {
    return X.DidCloseNotebookDocumentNotification;
  }, "get") });
  var le = kw();
  Object.defineProperty(e, "InlineCompletionRequest", { enumerable: true, get: i(function() {
  ...
  (function(p) {
    function ae($e) {
      ...
      for (let W of $e) if (!n.string(W) && !ce.is(W) && !P.is(W)) return false;
      return true;
    }
    i(ae, "is"), p.is = ae;
  ...
  })(de || (e.DidChangeConfigurationNotification = de = {}));
  var ct;
  (function(p) {
  ...
  })(Se || (e.TelemetryEventNotification = Se = {}));
  var Q;
  (function(p) {
  ...
  })(Zn || (e.DidCloseTextDocumentNotification = Zn = {}));
  var ri;
  (function(p) {
  ...
  })(ri || (e.DidSaveTextDocumentNotification = ri = {}));
  var ni;
  (function(p) {
    p.Manual = 1, p.AfterDelay = 2, p.FocusOut = 3;
  })(ni || (e.TextDocumentSaveReason = ni = {}));
  var ai;
  (function(p) {
  ...
  })(ai || (e.WillSaveTextDocumentNotification = ai = {}));
  var ii;
  (function(p) {
  ...
  })(ii || (e.WillSaveTextDocumentWaitUntilRequest = ii = {}));
  var kt;
  (function(p) {
  ...
  })(ta || (e.CompletionResolveRequest = ta = {}));
  var zt;
  (function(p) {
  ...
  })(ra || (e.SignatureHelpTriggerKind = ra = {}));
  var ui;
  (function(p) {
  ...
  })(aa || (e.DocumentHighlightRequest = aa = {}));
  var fi;
  (function(p) {
  ...
  })(mi || (e.WorkspaceSymbolResolveRequest = mi = {}));
  var gi;
  (function(p) {
  ...
  })(yi || (e.CodeLensRefreshRequest = yi = {}));
  var vi;
  (function(p) {
  ...
  })(Ti || (e.DocumentFormattingRequest = Ti = {}));
  var Yr;
  (function(p) {
  ...
  })(Yr || (e.DocumentRangeFormattingRequest = Yr = {}));
  var Ri;
  (function(p) {
  ...
  })(Ri || (e.DocumentRangesFormattingRequest = Ri = {}));
  var Bt;
  (function(p) {
  ...
  (function(p) {
    p.Identifier = 1;
  })(lr || (e.PrepareSupportDefaultBehavior = lr = {}));
  var $i;
  (function(p) {
  ...
  })(ia || (e.ApplyWorkspaceEditRequest = ia = {}));
} }), Ow = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/connection.js"(e) {
...
} }), Lw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/api.js"(e) {
  var t = e && e.__createBinding || (Object.create ? (function(s, o, l, c) {
    c === void 0 && (c = l);
    var u = Object.getOwnPropertyDescriptor(o, l);
    (!u || ("get" in u ? !o.__esModule : u.writable || u.configurable)) && (u = { enumerable: true, get: i(function() {
      return o[l];
  ...
  Object.defineProperty(e, "__esModule", { value: true }), e.LSPErrorCodes = e.createProtocolConnection = void 0, r(Wa(), e), r((_s(), Zd(Al)), e), r(Ce(), e), r(Pw(), e);
  var n = Ow();
  Object.defineProperty(e, "createProtocolConnection", { enumerable: true, get: i(function() {
...
} }), Dw = V({ "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/browser/main.js"(e) {
  var t = e && e.__createBinding || (Object.create ? (function(s, o, l, c) {
    c === void 0 && (c = l);
    var u = Object.getOwnPropertyDescriptor(o, l);
    (!u || ("get" in u ? !o.__esModule : u.writable || u.configurable)) && (u = { enumerable: true, get: i(function() {
...
var rf = (_a2 = class {
  ...
  getReferenceType(e) {
    ...
    const r = (_a3 = t.properties[e.property]) == null ? void 0 : _a3.referenceType;
  ...
  isSubtype(e, t) {
    ...
    {
      const a = this.types[e], s = a ? a.superTypes.some((o) => this.isSubtype(o, t)) : false;
      return r[t] = s, s;
    }
  }
  getAllSubTypes(e) {
...
var Jt = (_b = class {
  ...
  iterator() {
    const t = { state: this.startFn(), next: i(() => this.nextFn(t.state), "next"), [Symbol.iterator]: () => t };
    return t;
  }
  [Symbol.iterator]() {
  ...
  toMap(t, r) {
    const n = this.map((a) => [t ? t(a) : a, r ? r(a) : a]);
    return new Map(n);
  }
  toString() {
    return this.join();
  ...
  join(t = ",") {
    ...
    let n = "", a, s = false;
    do
      a = r.next(), a.done || (s && (n += t), n += Mg(a.value)), s = true;
    while (!a.done);
    return n;
  }
  indexOf(t, r = 0) {
  ...
  map(t) {
    return new _b(this.startFn, (r) => {
      ...
      return n ? Ve : { done: false, value: t(a) };
    });
  }
  filter(t) {
    return new _b(this.startFn, (r) => {
  ...
  flatMap(t) {
    return new _b(() => ({ this: this.startFn() }), (r) => {
      do {
        ...
        if (!n) {
          const s = t(a);
          if (ss(s)) r.iterator = s[Symbol.iterator]();
  ...
  flat(t) {
    ...
    return new _b(() => ({ this: r.startFn() }), (n) => {
      do {
        ...
        if (!a) if (ss(s)) n.iterator = s[Symbol.iterator]();
        else return { done: false, value: s };
      } while (n.iterator);
      return Ve;
    });
  ...
  limit(t) {
    return new _b(() => ({ size: 0, state: this.startFn() }), (r) => (r.size++, r.size > t ? Ve : this.nextFn(r.state)));
  }
  distinct(t) {
...
function oe(...e) {
  if (e.length === 1) {
    ...
    if (ss(t)) return new Jt(() => t[Symbol.iterator](), (r) => r.next());
    if (typeof t.length == "number") return new Jt(() => ({ index: 0 }), (r) => r.index < t.length ? { done: false, value: t[r.index++] } : Ve);
  }
  return e.length > 1 ? new Jt(() => ({ collIndex: 0, arrIndex: 0 }), (t) => {
    do {
      if (t.iterator) {
      ...
      if (t.collIndex < e.length) {
        ...
        ss(r) ? t.iterator = r[Symbol.iterator]() : r && typeof r.length == "number" && (t.array = r);
      }
...
var La = (_c2 = class extends Jt {
  ...
  iterator() {
    const e = { state: this.startFn(), next: i(() => this.nextFn(e.state), "next"), prune: i(() => {
      e.state.pruned = true;
    }, "prune"), [Symbol.iterator]: () => e };
    return e;
  }
}, i(_c2, "TreeStreamImpl"), _c2), os;
(function(e) {
  function t(s) {
...
var nf = {};
Kr(nf, { assignMandatoryProperties: () => af, copyAstNode: () => Mo, findRootNode: () => Ia, getContainerOfType: () => On, getDocument: () => Dt, getReferenceNodes: () => Lo, hasContainerOfType: () => xg, linkContentToContainer: () => Da, streamAllContents: () => wr, streamAst: () => Mt, streamContents: () => Ss, streamReferences: () => Ma });
function Da(e, t = {}) {
  for (const [r, n] of Object.entries(e)) r.startsWith("$") || (Array.isArray(n) ? n.forEach((a, s) => {
    Le(a) && (a.$container = e, a.$containerProperty = r, a.$containerIndex = s, t.deep && Da(a, t));
  }) : Le(n) && (n.$container = e, n.$containerProperty = r, t.deep && Da(n, t)));
}
i(Da, "linkContentToContainer");
function On(e, t) {
  let r = e;
  for (; r; ) {
    if (t(r)) return r;
...
i(xg, "hasContainerOfType");
function Dt(e) {
  const r = Ia(e).$document;
...
i(Ia, "findRootNode");
function Lo(e) {
  return He(e) ? e.ref ? [e.ref] : [] : Qt(e) ? e.items.map((t) => t.ref) : [];
}
i(Lo, "getReferenceNodes");
function Ss(e, t) {
  if (!e) throw new Error("Node must be an AstNode.");
  const r = t == null ? void 0 : t.range;
  return new Jt(() => ({ keys: Object.keys(e), keyIndex: 0, arrayIndex: 0 }), (n) => {
    for (; n.keyIndex < n.keys.length; ) {
      const a = n.keys[n.keyIndex];
      if (!a.startsWith("$")) {
        const s = e[a];
        if (Le(s)) {
          if (n.keyIndex++, Do(s, r)) return { done: false, value: s };
        } else if (Array.isArray(s)) {
          for (; n.arrayIndex < s.length; ) {
            const o = n.arrayIndex++, l = s[o];
            if (Le(l) && Do(l, r)) return { done: false, value: l };
          }
          n.arrayIndex = 0;
        }
      }
...
function wr(e, t) {
  ...
  return new La(e, (r) => Ss(r, t));
}
i(wr, "streamAllContents");
function Mt(e, t) {
  if (e) {
    if ((t == null ? void 0 : t.range) && !Do(e, t.range)) return new La(e, () => []);
  } else throw new Error("Root node must be an AstNode.");
  return new La(e, (r) => Ss(r, t), { includeRoot: true });
}
i(Mt, "streamAst");
function Do(e, t) {
  var _a3;
  if (!t) return true;
  const r = (_a3 = e.$cstNode) == null ? void 0 : _a3.range;
  return r ? wf(r, t) : false;
}
i(Do, "isAstNodeInRange");
function Ma(e) {
  return new Jt(() => ({ keys: Object.keys(e), keyIndex: 0, arrayIndex: 0 }), (t) => {
    for (; t.keyIndex < t.keys.length; ) {
      const r = t.keys[t.keyIndex];
      if (!r.startsWith("$")) {
        const n = e[r];
        if (He(n) || Qt(n)) return t.keyIndex++, { done: false, value: { reference: n, container: e, property: r } };
        if (Array.isArray(n)) {
          for (; t.arrayIndex < n.length; ) {
            const a = t.arrayIndex++, s = n[a];
            if (He(s) || Qt(n)) return { done: false, value: { reference: s, container: e, property: r, index: a } };
          }
          t.arrayIndex = 0;
        }
      }
...
i(cf, "isCharacterRange");
var xr = { $type: "Condition" };
function zg(e) {
  return j.isInstance(e, xr.$type);
}
i(zg, "isCondition");
var Vi = { $type: "Conjunction", left: "left", right: "right" };
function uf(e) {
  return j.isInstance(e, Vi.$type);
}
i(uf, "isConjunction");
var Fr = { $type: "CrossReference", cardinality: "cardinality", deprecatedSyntax: "deprecatedSyntax", isMulti: "isMulti", terminal: "terminal", type: "type" };
function Dn(e) {
  return j.isInstance(e, Fr.$type);
}
i(Dn, "isCrossReference");
var Hi = { $type: "Disjunction", left: "left", right: "right" };
function df(e) {
...
i(ff, "isEndOfFile");
var mr = { $type: "Grammar", imports: "imports", interfaces: "interfaces", isDeclared: "isDeclared", name: "name", rules: "rules", types: "types" };
function Bg(e) {
  return j.isInstance(e, mr.$type);
}
i(Bg, "isGrammar");
var Uo = { $type: "GrammarImport", path: "path" };
function Kg(e) {
  return j.isInstance(e, Uo.$type);
}
i(Kg, "isGrammarImport");
var un = { $type: "Group", cardinality: "cardinality", elements: "elements", guardCondition: "guardCondition", predicate: "predicate" };
function Mn(e) {
  return j.isInstance(e, un.$type);
}
i(Mn, "isGroup");
var zo = { $type: "InferredType", name: "name" };
function bs(e) {
  return j.isInstance(e, zo.$type);
}
i(bs, "isInferredType");
var Ht = { $type: "InfixRule", call: "call", dataType: "dataType", inferredType: "inferredType", name: "name", operators: "operators", parameters: "parameters", returnType: "returnType" };
function xa(e) {
  return j.isInstance(e, Ht.$type);
}
i(xa, "isInfixRule");
var Yi = { $type: "InfixRuleOperatorList", associativity: "associativity", operators: "operators" };
function qg(e) {
  return j.isInstance(e, Yi.$type);
}
i(qg, "isInfixRuleOperatorList");
var Bo = { $type: "InfixRuleOperators", precedences: "precedences" };
function Wg(e) {
  return j.isInstance(e, Bo.$type);
}
i(Wg, "isInfixRuleOperators");
var Aa = { $type: "Interface", attributes: "attributes", name: "name", superTypes: "superTypes" };
function pf(e) {
  return j.isInstance(e, Aa.$type);
}
i(pf, "isInterface");
var Ea = { $type: "Keyword", cardinality: "cardinality", predicate: "predicate", value: "value" };
function Rr(e) {
  return j.isInstance(e, Ea.$type);
}
i(Rr, "isKeyword");
var _a = { $type: "NamedArgument", calledByName: "calledByName", parameter: "parameter", value: "value" };
function Vg(e) {
  return j.isInstance(e, _a.$type);
}
i(Vg, "isNamedArgument");
var dn = { $type: "NegatedToken", cardinality: "cardinality", lookahead: "lookahead", parenthesized: "parenthesized", terminal: "terminal" };
function hf(e) {
  return j.isInstance(e, dn.$type);
}
i(hf, "isNegatedToken");
var Ko = { $type: "Negation", value: "value" };
function mf(e) {
  return j.isInstance(e, Ko.$type);
}
i(mf, "isNegation");
var qo = { $type: "NumberLiteral", value: "value" };
function Hg(e) {
  return j.isInstance(e, qo.$type);
}
i(Hg, "isNumberLiteral");
var Ca = { $type: "Parameter", name: "name" };
function Yg(e) {
  return j.isInstance(e, Ca.$type);
}
i(Yg, "isParameter");
var Wo = { $type: "ParameterReference", parameter: "parameter" };
function gf(e) {
  return j.isInstance(e, Wo.$type);
}
i(gf, "isParameterReference");
var Pt = { $type: "ParserRule", dataType: "dataType", definition: "definition", entry: "entry", fragment: "fragment", inferredType: "inferredType", name: "name", parameters: "parameters", returnType: "returnType" };
function Je(e) {
  return j.isInstance(e, Pt.$type);
}
i(Je, "isParserRule");
var Xi = { $type: "ReferenceType", isMulti: "isMulti", referenceType: "referenceType" };
function yf(e) {
  return j.isInstance(e, Xi.$type);
}
i(yf, "isReferenceType");
...
i(vf, "isRegexToken");
var Vo = { $type: "ReturnType", name: "name" };
function Tf(e) {
  return j.isInstance(e, Vo.$type);
}
i(Tf, "isReturnType");
var pn = { $type: "RuleCall", arguments: "arguments", cardinality: "cardinality", predicate: "predicate", rule: "rule" };
function $r(e) {
  return j.isInstance(e, pn.$type);
}
i($r, "isRuleCall");
var Sa = { $type: "SimpleType", primitiveType: "primitiveType", stringType: "stringType", typeRef: "typeRef" };
function bl(e) {
  return j.isInstance(e, Sa.$type);
}
i(bl, "isSimpleType");
var Ho = { $type: "StringLiteral", value: "value" };
function Xg(e) {
  return j.isInstance(e, Ho.$type);
}
i(Xg, "isStringLiteral");
var hn = { $type: "TerminalAlternatives", cardinality: "cardinality", elements: "elements", lookahead: "lookahead", parenthesized: "parenthesized" };
function Rf(e) {
  return j.isInstance(e, hn.$type);
}
i(Rf, "isTerminalAlternatives");
var at = { $type: "TerminalElement", cardinality: "cardinality", lookahead: "lookahead", parenthesized: "parenthesized" };
function Jg(e) {
  return j.isInstance(e, at.$type);
}
i(Jg, "isTerminalElement");
var mn = { $type: "TerminalGroup", cardinality: "cardinality", elements: "elements", lookahead: "lookahead", parenthesized: "parenthesized" };
function $f(e) {
  return j.isInstance(e, mn.$type);
}
i($f, "isTerminalGroup");
var gr = { $type: "TerminalRule", definition: "definition", fragment: "fragment", hidden: "hidden", name: "name", type: "type" };
function bt(e) {
  return j.isInstance(e, gr.$type);
}
i(bt, "isTerminalRule");
var gn = { $type: "TerminalRuleCall", cardinality: "cardinality", lookahead: "lookahead", parenthesized: "parenthesized", rule: "rule" };
function wl(e) {
  return j.isInstance(e, gn.$type);
}
i(wl, "isTerminalRuleCall");
var Ji = { $type: "Type", name: "name", type: "type" };
function Il(e) {
  return j.isInstance(e, Ji.$type);
}
i(Il, "isType");
var yn = { $type: "TypeAttribute", defaultValue: "defaultValue", isOptional: "isOptional", name: "name", type: "type" };
function Zg(e) {
  return j.isInstance(e, yn.$type);
}
i(Zg, "isTypeAttribute");
var vn = { $type: "TypeDefinition" };
function Qg(e) {
  return j.isInstance(e, vn.$type);
}
i(Qg, "isTypeDefinition");
var Yo = { $type: "UnionType", types: "types" };
function Af(e) {
  return j.isInstance(e, Yo.$type);
}
i(Af, "isUnionType");
var Zi = { $type: "UnorderedGroup", cardinality: "cardinality", elements: "elements" };
function Nl(e) {
  return j.isInstance(e, Zi.$type);
}
i(Nl, "isUnorderedGroup");
var Tn = { $type: "UntilToken", cardinality: "cardinality", lookahead: "lookahead", parenthesized: "parenthesized", terminal: "terminal" };
function Ef(e) {
  return j.isInstance(e, Tn.$type);
}
i(Ef, "isUntilToken");
var Rn = { $type: "ValueLiteral" };
function ey(e) {
  return j.isInstance(e, Rn.$type);
}
i(ey, "isValueLiteral");
var ba = { $type: "Wildcard", cardinality: "cardinality", lookahead: "lookahead", parenthesized: "parenthesized" };
function _f(e) {
  return j.isInstance(e, ba.$type);
}
i(_f, "isWildcard");
var Cf = (_d2 = class extends rf {
  constructor() {
    super(...arguments), this.types = { AbstractElement: { name: nt.$type, properties: { cardinality: { name: nt.cardinality } }, superTypes: [] }, AbstractParserRule: { name: qi.$type, properties: {}, superTypes: [$a.$type, ut.$type] }, AbstractRule: { name: $a.$type, properties: {}, superTypes: [] }, AbstractType: { name: ut.$type, properties: {}, superTypes: [] }, Action: { name: Lr.$type, properties: { cardinality: { name: Lr.cardinality }, feature: { name: Lr.feature }, inferredType: { name: Lr.inferredType }, operator: { name: Lr.operator }, type: { name: Lr.type, referenceType: ut.$type } }, superTypes: [nt.$type] }, Alternatives: { name: Wi.$type, properties: { cardinality: { name: Wi.cardinality }, elements: { name: Wi.elements, defaultValue: [] } }, superTypes: [nt.$type] }, ArrayLiteral: { name: xo.$type, properties: { elements: { name: xo.elements, defaultValue: [] } }, superTypes: [Rn.$type] }, ArrayType: { name: Fo.$type, properties: { elementType: { name: Fo.elementType } }, superTypes: [vn.$type] }, Assignment: { name: Dr.$type, properties: { cardinality: { name: Dr.cardinality }, feature: { name: Dr.feature }, operator: { name: Dr.operator }, predicate: { name: Dr.predicate }, terminal: { name: Dr.terminal } }, superTypes: [nt.$type] }, BooleanLiteral: { name: Go.$type, properties: { true: { name: Go.true, defaultValue: false } }, superTypes: [xr.$type, Rn.$type] }, CharacterRange: { name: Mr.$type, properties: { cardinality: { name: Mr.cardinality }, left: { name: Mr.left }, lookahead: { name: Mr.lookahead }, parenthesized: { name: Mr.parenthesized, defaultValue: false }, right: { name: Mr.right } }, superTypes: [at.$type] }, Condition: { name: xr.$type, properties: {}, superTypes: [] }, Conjunction: { name: Vi.$type, properties: { left: { name: Vi.left }, right: { name: Vi.right } }, superTypes: [xr.$type] }, CrossReference: { name: Fr.$type, properties: { cardinality: { name: Fr.cardinality }, deprecatedSyntax: { name: Fr.deprecatedSyntax, defaultValue: false }, isMulti: { name: Fr.isMulti, defaultValue: false }, terminal: { name: Fr.terminal }, type: { name: Fr.type, referenceType: ut.$type } }, superTypes: [nt.$type] }, Disjunction: { name: Hi.$type, properties: { left: { name: Hi.left }, right: { name: Hi.right } }, superTypes: [xr.$type] }, EndOfFile: { name: jo.$type, properties: { cardinality: { name: jo.cardinality } }, superTypes: [nt.$type] }, Grammar: { name: mr.$type, properties: { imports: { name: mr.imports, defaultValue: [] }, interfaces: { name: mr.interfaces, defaultValue: [] }, isDeclared: { name: mr.isDeclared, defaultValue: false }, name: { name: mr.name }, rules: { name: mr.rules, defaultValue: [] }, types: { name: mr.types, defaultValue: [] } }, superTypes: [] }, GrammarImport: { name: Uo.$type, properties: { path: { name: Uo.path } }, superTypes: [] }, Group: { name: un.$type, properties: { cardinality: { name: un.cardinality }, elements: { name: un.elements, defaultValue: [] }, guardCondition: { name: un.guardCondition }, predicate: { name: un.predicate } }, superTypes: [nt.$type] }, InferredType: { name: zo.$type, properties: { name: { name: zo.name } }, superTypes: [ut.$type] }, InfixRule: { name: Ht.$type, properties: { call: { name: Ht.call }, dataType: { name: Ht.dataType }, inferredType: { name: Ht.inferredType }, name: { name: Ht.name }, operators: { name: Ht.operators }, parameters: { name: Ht.parameters, defaultValue: [] }, returnType: { name: Ht.returnType, referenceType: ut.$type } }, superTypes: [qi.$type] }, InfixRuleOperatorList: { name: Yi.$type, properties: { associativity: { name: Yi.associativity }, operators: { name: Yi.operators, defaultValue: [] } }, superTypes: [] }, InfixRuleOperators: { name: Bo.$type, properties: { precedences: { name: Bo.precedences, defaultValue: [] } }, superTypes: [] }, Interface: { name: Aa.$type, properties: { attributes: { name: Aa.attributes, defaultValue: [] }, name: { name: Aa.name }, superTypes: { name: Aa.superTypes, defaultValue: [], referenceType: ut.$type } }, superTypes: [ut.$type] }, Keyword: { name: Ea.$type, properties: { cardinality: { name: Ea.cardinality }, predicate: { name: Ea.predicate }, value: { name: Ea.value } }, superTypes: [nt.$type] }, NamedArgument: { name: _a.$type, properties: { calledByName: { name: _a.calledByName, defaultValue: false }, parameter: { name: _a.parameter, referenceType: Ca.$type }, value: { name: _a.value } }, superTypes: [] }, NegatedToken: { name: dn.$type, properties: { cardinality: { name: dn.cardinality }, lookahead: { name: dn.lookahead }, parenthesized: { name: dn.parenthesized, defaultValue: false }, terminal: { name: dn.terminal } }, superTypes: [at.$type] }, Negation: { name: Ko.$type, properties: { value: { name: Ko.value } }, superTypes: [xr.$type] }, NumberLiteral: { name: qo.$type, properties: { value: { name: qo.value } }, superTypes: [Rn.$type] }, Parameter: { name: Ca.$type, properties: { name: { name: Ca.name } }, superTypes: [] }, ParameterReference: { name: Wo.$type, properties: { parameter: { name: Wo.parameter, referenceType: Ca.$type } }, superTypes: [xr.$type] }, ParserRule: { name: Pt.$type, properties: { dataType: { name: Pt.dataType }, definition: { name: Pt.definition }, entry: { name: Pt.entry, defaultValue: false }, fragment: { name: Pt.fragment, defaultValue: false }, inferredType: { name: Pt.inferredType }, name: { name: Pt.name }, parameters: { name: Pt.parameters, defaultValue: [] }, returnType: { name: Pt.returnType, referenceType: ut.$type } }, superTypes: [qi.$type] }, ReferenceType: { name: Xi.$type, properties: { isMulti: { name: Xi.isMulti, defaultValue: false }, referenceType: { name: Xi.referenceType } }, superTypes: [vn.$type] }, RegexToken: { name: fn.$type, properties: { cardinality: { name: fn.cardinality }, lookahead: { name: fn.lookahead }, parenthesized: { name: fn.parenthesized, defaultValue: false }, regex: { name: fn.regex } }, superTypes: [at.$type] }, ReturnType: { name: Vo.$type, properties: { name: { name: Vo.name } }, superTypes: [] }, RuleCall: { name: pn.$type, properties: { arguments: { name: pn.arguments, defaultValue: [] }, cardinality: { name: pn.cardinality }, predicate: { name: pn.predicate }, rule: { name: pn.rule, referenceType: $a.$type } }, superTypes: [nt.$type] }, SimpleType: { name: Sa.$type, properties: { primitiveType: { name: Sa.primitiveType }, stringType: { name: Sa.stringType }, typeRef: { name: Sa.typeRef, referenceType: ut.$type } }, superTypes: [vn.$type] }, StringLiteral: { name: Ho.$type, properties: { value: { name: Ho.value } }, superTypes: [Rn.$type] }, TerminalAlternatives: { name: hn.$type, properties: { cardinality: { name: hn.cardinality }, elements: { name: hn.elements, defaultValue: [] }, lookahead: { name: hn.lookahead }, parenthesized: { name: hn.parenthesized, defaultValue: false } }, superTypes: [at.$type] }, TerminalElement: { name: at.$type, properties: { cardinality: { name: at.cardinality }, lookahead: { name: at.lookahead }, parenthesized: { name: at.parenthesized, defaultValue: false } }, superTypes: [nt.$type] }, TerminalGroup: { name: mn.$type, properties: { cardinality: { name: mn.cardinality }, elements: { name: mn.elements, defaultValue: [] }, lookahead: { name: mn.lookahead }, parenthesized: { name: mn.parenthesized, defaultValue: false } }, superTypes: [at.$type] }, TerminalRule: { name: gr.$type, properties: { definition: { name: gr.definition }, fragment: { name: gr.fragment, defaultValue: false }, hidden: { name: gr.hidden, defaultValue: false }, name: { name: gr.name }, type: { name: gr.type } }, superTypes: [$a.$type] }, TerminalRuleCall: { name: gn.$type, properties: { cardinality: { name: gn.cardinality }, lookahead: { name: gn.lookahead }, parenthesized: { name: gn.parenthesized, defaultValue: false }, rule: { name: gn.rule, referenceType: gr.$type } }, superTypes: [at.$type] }, Type: { name: Ji.$type, properties: { name: { name: Ji.name }, type: { name: Ji.type } }, superTypes: [ut.$type] }, TypeAttribute: { name: yn.$type, properties: { defaultValue: { name: yn.defaultValue }, isOptional: { name: yn.isOptional, defaultValue: false }, name: { name: yn.name }, type: { name: yn.type } }, superTypes: [] }, TypeDefinition: { name: vn.$type, properties: {}, superTypes: [] }, UnionType: { name: Yo.$type, properties: { types: { name: Yo.types, defaultValue: [] } }, superTypes: [vn.$type] }, UnorderedGroup: { name: Zi.$type, properties: { cardinality: { name: Zi.cardinality }, elements: { name: Zi.elements, defaultValue: [] } }, superTypes: [nt.$type] }, UntilToken: { name: Tn.$type, properties: { cardinality: { name: Tn.cardinality }, lookahead: { name: Tn.lookahead }, parenthesized: { name: Tn.parenthesized, defaultValue: false }, terminal: { name: Tn.terminal } }, superTypes: [at.$type] }, ValueLiteral: { name: Rn.$type, properties: {}, superTypes: [] }, Wildcard: { name: ba.$type, properties: { cardinality: { name: ba.cardinality }, lookahead: { name: ba.lookahead }, parenthesized: { name: ba.parenthesized, defaultValue: false } }, superTypes: [at.$type] } };
  }
}, i(_d2, "LangiumGrammarAstReflection"), _d2), j = new Cf();
function ty(e) {
  let t = e, r = false;
  for (; t; ) {
    const n = On(t.grammarSource, Je);
    if (n && n.dataType) t = t.container, r = true;
    else return r ? t : void 0;
  }
}
i(ty, "getDatatypeNode");
function Fa(e) {
  return new La(e, (t) => vr(t) ? t.content : [], { includeRoot: true });
}
i(Fa, "streamCst");
function ry(e) {
  return Fa(e).filter(Pn);
}
i(ry, "flattenCst");
function Sf(e, t) {
...
function bf(e, t) {
  if (e.end.line < t.start.line || e.end.line === t.start.line && e.end.character <= t.start.character) return Xt.Before;
  if (e.start.line > t.end.line || e.start.line === t.end.line && e.start.character >= t.end.character) return Xt.After;
  ...
  return r && n ? Xt.Inside : r ? Xt.OverlapBack : n ? Xt.OverlapFront : Xt.Outside;
}
i(bf, "compareRange");
function wf(e, t) {
  return bf(e, t) > Xt.After;
}
i(wf, "inRange");
var If = /^[\w\p{L}]$/u;
function ny(e, t, r = If) {
  if (e) {
    if (t > 0) {
...
i(ny, "findDeclarationNodeAtOffset");
function Nf(e, t) {
  if (e) {
    const r = Of(e, true);
    if (r && Xo(r, t)) return r;
    if (_l(e)) {
...
i(Nf, "findCommentNode");
function Xo(e, t) {
  return Pn(e) && t.includes(e.tokenType.name);
}
i(Xo, "isCommentNode");
function kl(e, t) {
  if (Pn(e)) return e;
  if (vr(e)) {
    const r = Pf(e, t, false);
    if (r) return kl(r, t);
  }
}
i(kl, "findLeafNodeAtOffset");
function kf(e, t) {
  if (Pn(e)) return e;
  if (vr(e)) {
    const r = Pf(e, t, true);
...
i(Of, "getPreviousNode");
function ay(e, t = true) {
  for (; e.container; ) {
    const r = e.container;
    let n = r.content.indexOf(e);
...
i(iy, "getStartlineNode");
function sy(e, t) {
  const r = oy(e, t);
  return r ? r.parent.content.slice(r.a + 1, r.b) : [];
}
i(sy, "getInteriorNodes");
function oy(e, t) {
  const r = td(e), n = td(t);
  let a;
  for (let s = 0; s < r.length && s < n.length; s++) {
    const o = r[s], l = n[s];
    if (o.parent === l.parent) a = { parent: o.parent, a: o.index, b: l.index };
    else break;
  }
  return a;
}
i(oy, "getCommonParent");
function td(e) {
  const t = [];
  for (; e.container; ) {
...
i(td, "getParentChain");
var Lf = {};
Kr(Lf, { findAssignment: () => Vf, findNameAssignment: () => Gl, findNodeForKeyword: () => Wf, findNodeForProperty: () => Ml, findNodesForKeyword: () => my, findNodesForKeywordInternal: () => Fl, findNodesForProperty: () => qf, getActionAtElement: () => Yf, getActionType: () => Jf, getAllReachableRules: () => Dl, getAllRulesUsedForCrossReferences: () => hy, getCrossReferenceTerminal: () => Bf, getEntryRule: () => jf, getExplicitRuleType: () => Is, getHiddenRules: () => Uf, getRuleType: () => Zf, getRuleTypeName: () => Ry, getTypeName: () => bn, isArrayCardinality: () => yy, isArrayOperator: () => vy, isCommentTerminal: () => Kf, isDataType: () => Ty, isDataTypeRule: () => ws, isOptionalCardinality: () => gy, terminalRegex: () => Ns });
var Pl = (_e2 = class extends Error {
  constructor(e, t) {
    super(e ? `${t} at ${e.range.start.line}:${e.range.start.character}` : t);
  }
}, i(_e2, "ErrorWithLocation"), _e2);
function qr(e, t = "Error: Got unexpected value.") {
  throw new Error(t);
}
i(qr, "assertUnreachable");
function Df(e, t = "Error: Condition is violated.") {
  if (!e) throw new Error(t);
}
i(Df, "assertCondition");
var Mf = {};
Kr(Mf, { NEWLINE_REGEXP: () => uy, escapeRegExp: () => Va, getTerminalParts: () => fy, isMultilineComment: () => xf, isWhitespace: () => Ll, partialMatches: () => Ff, partialRegExp: () => Gf, whitespaceCharacters: () => py });
function K(e) {
...
i(ly, "ASSERT_NEVER_REACH_HERE");
function rd(e) {
  return e.type === "Character";
}
i(rd, "isCharacter");
var Jo = [];
for (let e = K("0"); e <= K("9"); e++) Jo.push(e);
var Zo = [K("_")].concat(Jo);
for (let e = K("a"); e <= K("z"); e++) Zo.push(e);
for (let e = K("A"); e <= K("Z"); e++) Zo.push(e);
var Fh = [K(" "), K("\f"), K(`
`), K("\r"), K("	"), K("\v"), K("	"), K("\xA0"), K("\u1680"), K("\u2000"), K("\u2001"), K("\u2002"), K("\u2003"), K("\u2004"), K("\u2005"), K("\u2006"), K("\u2007"), K("\u2008"), K("\u2009"), K("\u200A"), K("\u2028"), K("\u2029"), K("\u202F"), K("\u205F"), K("\u3000"), K("\uFEFF")], xw = /[0-9a-fA-F]/, Ws = /[0-9]/, Fw = /[1-9]/, cy = (_f2 = class {
  constructor() {
  ...
  quantifier(e = false) {
    ...
    switch (this.popChar()) {
      ...
      case "{":
        ...
        switch (this.popChar()) {
          ...
          case ",":
            let a;
            this.isDigit() ? (a = this.integerIncludingZero(), t = { atLeast: n, atMost: a }) : t = { atLeast: n, atMost: 1 / 0 }, this.consumeChar("}");
            break;
        }
    ...
    if (!(e === true && t === void 0) && rn(t)) return this.peekChar(0) === "?" ? (this.consumeChar("?"), t.greedy = false) : t.greedy = true, t.type = "Quantifier", t.loc = this.loc(r), t;
  }
  atom() {
    let e;
    const t = this.idx;
    ...
    if (e === void 0 && this.isPatternCharacter() && (e = this.patternCharacter()), rn(e)) return e.loc = this.loc(t), this.isQuantifier() && (e.quantifier = this.quantifier()), e;
  }
  dotAll() {
...
`), K("\r"), K("\u2028"), K("\u2029")] };
  ...
  characterClassEscape() {
    ...
    if (rn(e)) return { type: "Set", value: e, complement: t };
  }
  controlEscapeAtom() {
    let e;
    switch (this.popChar()) {
...
`);
    ...
    if (rn(e)) return { type: "Character", value: e };
  }
...
`:
  ...
  positiveInteger() {
    let e = this.popChar();
    if (Fw.test(e) === false) throw Error("Expecting a positive integer");
    for (; Ws.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  integerIncludingZero() {
    let e = this.popChar();
    if (Ws.test(e) === false) throw Error("Expecting an integer");
    for (; Ws.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  patternCharacter() {
...
`:
  ...
  parseHexDigits(e) {
    ...
    for (let n = 0; n < e; n++) {
      ...
      if (xw.test(a) === false) throw Error("Expecting a HexDecimal digits");
      t += a;
    }
...
}, i(_f2, "RegExpParser"), _f2), Ol = (_g2 = class {
  visitChildren(e) {
    for (const t in e) {
      const r = e[t];
...
}, i(_g2, "BaseRegExpVisitor"), _g2), uy = /\r?\n/gm, dy = new cy(), Gw = (_h2 = class extends Ol {
  constructor() {
...
}, i(_h2, "TerminalRegExpVisitor"), _h2), $n = new Gw();
function fy(e) {
  try {
    typeof e != "string" && (e = e.source), e = `/${e}/`;
    const t = dy.pattern(e), r = [];
    for (const n of t.value.value) $n.reset(e), $n.visit(n), r.push({ start: $n.startRegexp, end: $n.endRegex });
    return r;
  } catch {
    return [];
  }
...
function xf(e) {
  try {
    return typeof e == "string" && (e = new RegExp(e)), e = e.toString(), $n.reset(e), $n.visit(dy.pattern(e)), $n.multiline;
  } catch {
    return false;
  }
}
i(xf, "isMultilineComment");
var py = `\f
\r	\v \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF`.split("");
function Ll(e) {
  const t = typeof e == "string" ? new RegExp(e) : e;
  return py.some((r) => t.test(r));
}
i(Ll, "isWhitespace");
function Va(e) {
  return e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
function Gf(e) {
  ...
  function a() {
    ...
    for (i(c, "appendOptional"); n < r.length; ) switch (r[n]) {
      case "\\":
        switch (r[n + 1]) {
          case "c":
            c(3);
...
i(jf, "getEntryRule");
function Uf(e) {
  return e.rules.filter((t) => bt(t) && t.hidden);
}
i(Uf, "getHiddenRules");
function Dl(e, t) {
  const r = /* @__PURE__ */ new Set(), n = jf(e);
  if (!n) return new Set(e.rules);
  const a = [n].concat(Uf(e));
  for (const o of a) zf(o, r, t);
  const s = /* @__PURE__ */ new Set();
  for (const o of e.rules) (r.has(o.name) || bt(o) && o.hidden) && s.add(o);
  return s;
}
i(Dl, "getAllReachableRules");
function zf(e, t, r) {
  t.add(e.name), wr(e).forEach((n) => {
    if ($r(n) || r && wl(n)) {
      const a = n.rule.ref;
      a && !t.has(a.name) && zf(a, t, r);
    }
  });
}
i(zf, "ruleDfs");
function hy(e) {
  ...
  return wr(e).forEach((r) => {
    Dn(r) && (Je(r.type.ref) && t.add(r.type.ref), bs(r.type.ref) && Je(r.type.ref.$container) && t.add(r.type.ref.$container));
  }), t;
}
i(hy, "getAllRulesUsedForCrossReferences");
function Bf(e) {
  var _a3;
  if (e.terminal) return e.terminal;
  if (e.type.ref) return (_a3 = Gl(e.type.ref)) == null ? void 0 : _a3.terminal;
}
i(Bf, "getCrossReferenceTerminal");
function Kf(e) {
  return e.hidden && !Ll(Ns(e));
}
i(Kf, "isCommentTerminal");
function qf(e, t) {
  return !e || !t ? [] : xl(e, t, e.astNode, true);
}
i(qf, "findNodesForProperty");
function Ml(e, t, r) {
  if (!e || !t) return;
  const n = xl(e, t, e.astNode, true);
  if (n.length !== 0) return r !== void 0 ? r = Math.max(0, Math.min(r, n.length - 1)) : r = 0, n[r];
}
i(Ml, "findNodeForProperty");
function xl(e, t, r, n) {
  if (!n) {
    const a = On(e.grammarSource, Tr);
    if (a && a.feature === t) return [e];
  }
  return vr(e) && e.astNode === r ? e.content.flatMap((a) => xl(a, t, r, false)) : [];
}
i(xl, "findNodesForPropertyInternal");
function my(e, t) {
  return e ? Fl(e, t, e == null ? void 0 : e.astNode) : [];
}
i(my, "findNodesForKeyword");
function Wf(e, t, r) {
  if (!e) return;
  const n = Fl(e, t, e == null ? void 0 : e.astNode);
  if (n.length !== 0) return r !== void 0 ? r = Math.max(0, Math.min(r, n.length - 1)) : r = 0, n[r];
}
i(Wf, "findNodeForKeyword");
function Fl(e, t, r) {
  if (e.astNode !== r) return [];
  if (Rr(e.grammarSource) && e.grammarSource.value === t) return [e];
  const n = Fa(e).iterator();
  let a;
  const s = [];
  do
    if (a = n.next(), !a.done) {
...
i(Fl, "findNodesForKeywordInternal");
function Vf(e) {
  var _a3;
  const t = e.astNode;
  for (; t === ((_a3 = e.container) == null ? void 0 : _a3.astNode); ) {
    const r = On(e.grammarSource, Tr);
    if (r) return r;
    e = e.container;
  }
}
...
function Gl(e) {
  let t = e;
  return bs(t) && (Gr(t.$container) ? t = t.$container.$container : Ln(t.$container) ? t = t.$container : qr(t.$container)), Hf(e, t, /* @__PURE__ */ new Map());
}
i(Gl, "findNameAssignment");
function Hf(e, t, r) {
  var _a3;
  function n(a, s) {
    let o;
    return On(a, Tr) || (o = Hf(s, s, r)), r.set(e, o), o;
  }
  if (i(n, "go"), r.has(e)) return r.get(e);
  r.set(e, void 0);
  for (const a of wr(t)) {
    if (Tr(a) && a.feature.toLowerCase() === "name") return r.set(e, a), a;
    if ($r(a) && Je(a.rule.ref)) return n(a, a.rule.ref);
    if (bl(a) && ((_a3 = a.typeRef) == null ? void 0 : _a3.ref)) return n(a, a.typeRef.ref);
  }
}
i(Hf, "findNameAssignmentInternal");
function Yf(e) {
  const t = e.$container;
  if (Mn(t)) {
...
i(Yf, "getActionAtElement");
function gy(e, t) {
  return e === "?" || e === "*" || Mn(t) && !!t.guardCondition;
}
i(gy, "isOptionalCardinality");
function yy(e) {
  return e === "*" || e === "+";
}
i(yy, "isArrayCardinality");
function vy(e) {
  return e === "+=";
}
i(vy, "isArrayOperator");
function ws(e) {
  return Xf(e, /* @__PURE__ */ new Set());
}
i(ws, "isDataTypeRule");
function Xf(e, t) {
  if (t.has(e)) return true;
  t.add(e);
  for (const r of wr(e)) if ($r(r)) {
    if (!r.rule.ref || Je(r.rule.ref) && !Xf(r.rule.ref, t) || xa(r.rule.ref)) return false;
  } else {
...
i(Xf, "isDataTypeRuleInternal");
function Ty(e) {
  return Qo(e.type, /* @__PURE__ */ new Set());
}
i(Ty, "isDataType");
function Qo(e, t) {
  if (t.has(e)) return true;
  if (t.add(e), of(e)) return false;
  if (yf(e)) return false;
  if (Af(e)) return e.types.every((r) => Qo(r, t));
  if (bl(e)) {
    if (e.primitiveType !== void 0) return true;
    if (e.stringType !== void 0) return true;
    if (e.typeRef !== void 0) {
      const r = e.typeRef.ref;
      return Il(r) ? Qo(r.type, t) : false;
    } else return false;
  } else return false;
}
i(Qo, "isDataTypeInternal");
function Is(e) {
  if (!bt(e)) {
...
i(Is, "getExplicitRuleType");
function bn(e) {
  if (Ln(e)) return Je(e) && ws(e) ? e.name : Is(e) ?? e.name;
  if (pf(e) || Il(e) || Tf(e)) return e.name;
  if (Gr(e)) {
    const t = Jf(e);
    if (t) return t;
  } else if (bs(e)) return e.name;
...
function Jf(e) {
  var _a3;
  if (e.inferredType) return e.inferredType.name;
  if ((_a3 = e.type) == null ? void 0 : _a3.ref) return bn(e.type.ref);
}
i(Jf, "getActionType");
function Ry(e) {
  var _a3;
  return bt(e) ? ((_a3 = e.type) == null ? void 0 : _a3.name) ?? "string" : Je(e) && ws(e) ? e.name : Is(e) ?? e.name;
}
i(Ry, "getRuleTypeName");
function Zf(e) {
  var _a3;
  return bt(e) ? ((_a3 = e.type) == null ? void 0 : _a3.name) ?? "string" : Is(e) ?? e.name;
}
i(Zf, "getRuleType");
function Ns(e) {
  const t = { s: false, i: false, u: false }, r = xn(e.definition, t), n = Object.entries(t).filter(([, a]) => a).map(([a]) => a).join("");
...
function xn(e, t) {
  ...
  if (wl(e)) {
    ...
    return er(xn(r.definition), { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized });
  } else {
    if (hf(e)) return _y(e);
    if (Ef(e)) return Ey(e);
    if (vf(e)) {
      const r = e.regex.lastIndexOf("/"), n = e.regex.substring(1, r), a = e.regex.substring(r + 1);
      return t && (t.i = a.includes("i"), t.s = a.includes("s"), t.u = a.includes("u")), er(n, { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized, wrap: false });
    } else {
      if (_f(e)) return er(Qf, { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized });
      throw new Error(`Invalid terminal element: ${e == null ? void 0 : e.$type}, ${(_a3 = e == null ? void 0 : e.$cstNode) == null ? void 0 : _a3.text}`);
    }
  }
}
i(xn, "abstractElementToRegex");
function $y(e) {
  return er(e.elements.map((t) => xn(t)).join("|"), { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized, wrap: false });
}
i($y, "terminalAlternativesToRegex");
function Ay(e) {
  return er(e.elements.map((t) => xn(t)).join(""), { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized, wrap: false });
}
i(Ay, "terminalGroupToRegex");
function Ey(e) {
  return er(`${Qf}*?${xn(e.terminal)}`, { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized });
}
i(Ey, "untilTokenToRegex");
function _y(e) {
  return er(`(?!${xn(e.terminal)})${Qf}*?`, { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized });
}
i(_y, "negateTokenToRegex");
function Cy(e) {
  return e.right ? er(`[${Ro(e.left)}-${Ro(e.right)}]`, { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized, wrap: false }) : er(Ro(e.left), { cardinality: e.cardinality, lookahead: e.lookahead, parenthesized: e.parenthesized, wrap: false });
}
i(Cy, "characterRangeToRegex");
function Ro(e) {
  return Va(e.value);
}
i(Ro, "keywordToRegex");
...
i(er, "withCardinality");
function ep(e) {
  const t = [], r = e.Grammar;
  for (const n of r.rules) bt(n) && Kf(n) && xf(Ns(n)) && t.push(n.name);
  return { multilineCommentRules: t, nameRegexp: If };
}
i(ep, "createGrammarConfig");
var jw = typeof global == "object" && global && global.Object === Object && global, Sy = jw, Uw = typeof self == "object" && self && self.Object === Object && self, zw = Sy || Uw || Function("return this")(), rr = zw, Bw = rr.Symbol, Ct = Bw, by = Object.prototype, Kw = by.hasOwnProperty, qw = by.toString, _i = Ct ? Ct.toStringTag : void 0;
function wy(e) {
  var t = Kw.call(e, _i), r = e[_i];
  try {
    e[_i] = void 0;
    var n = true;
  } catch {
...
i(wy, "getRawTag");
var Ww = wy, Vw = Object.prototype, Hw = Vw.toString;
function Iy(e) {
  return Hw.call(e);
}
i(Iy, "objectToString");
var Yw = Iy, Xw = "[object Null]", Jw = "[object Undefined]", Gh = Ct ? Ct.toStringTag : void 0;
function Ny(e) {
  return e == null ? e === void 0 ? Jw : Xw : Gh && Gh in Object(e) ? Ww(e) : Yw(e);
}
i(Ny, "baseGetTag");
var Wr = Ny;
function ky(e) {
...
i(ky, "isObjectLike");
var Gt = ky, Zw = "[object Symbol]";
function Py(e) {
  return typeof e == "symbol" || Gt(e) && Wr(e) == Zw;
}
i(Py, "isSymbol");
var jl = Py;
function Oy(e, t) {
...
i(Oy, "arrayMap");
var ks = Oy, Qw = Array.isArray, ne = Qw, jh = Ct ? Ct.prototype : void 0, Uh = jh ? jh.toString : void 0;
function tp(e) {
  if (typeof e == "string") return e;
  if (ne(e)) return ks(e, tp) + "";
  if (jl(e)) return Uh ? Uh.call(e) : "";
  var t = e + "";
...
i(My, "isObject");
var St = My, zh = NaN, iI = /^[-+]0x[0-9a-f]+$/i, sI = /^0b[01]+$/i, oI = /^0o[0-7]+$/i, lI = parseInt;
function xy(e) {
  ...
  e = aI(e);
  var r = sI.test(e);
  return r || oI.test(e) ? lI(e.slice(2), r ? 2 : 8) : iI.test(e) ? zh : +e;
}
i(xy, "toNumber");
var cI = xy, Bh = 1 / 0, uI = 17976931348623157e292;
function Fy(e) {
  if (!e) return e === 0 ? e : 0;
  if (e = cI(e), e === Bh || e === -Bh) {
    var t = e < 0 ? -1 : 1;
...
i(jy, "identity");
var ja = jy, fI = "[object AsyncFunction]", pI = "[object Function]", hI = "[object GeneratorFunction]", mI = "[object Proxy]";
function Uy(e) {
...
i(Uy, "isFunction");
var Ir = Uy, gI = rr["__core-js_shared__"], Pc = gI, Kh = (function() {
...
i(zy, "isMasked");
var yI = zy, vI = Function.prototype, TI = vI.toString;
function By(e) {
  if (e != null) {
    try {
      return TI.call(e);
...
i(By, "toSource");
var Fn = By, RI = /[\\^$.*+?()[\]{}|]/g, $I = /^\[object .+?Constructor\]$/, AI = Function.prototype, EI = Object.prototype, _I = AI.toString, CI = EI.hasOwnProperty, SI = RegExp("^" + _I.call(CI).replace(RI, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function Ky(e) {
  if (!St(e) || yI(e)) return false;
  var t = Ir(e) ? SI : $I;
  return t.test(Fn(e));
}
i(Ky, "baseIsNative");
...
i(Wy, "getNative");
var Gn = Wy, II = Gn(rr, "WeakMap"), nd = II, qh = Object.create, NI = (function() {
  function e() {
  }
...
i(Yy, "copyArray");
var OI = Yy, LI = 800, DI = 16, MI = Date.now;
function Xy(e) {
  var t = 0, r = 0;
  return function() {
    var n = MI(), a = DI - (n - r);
...
i(Jy, "constant");
var FI = Jy, GI = (function() {
  try {
    var e = Gn(Object, "defineProperty");
    return e({}, "", {}), e;
  } catch {
  }
})(), el = GI, jI = el ? function(e, t) {
  return el(e, "toString", { configurable: true, enumerable: false, value: FI(t), writable: true });
} : ja, UI = jI, zI = xI(UI), BI = zI;
function Zy(e, t) {
...
i(iv, "arrayIncludes");
var sv = iv, WI = 9007199254740991, VI = /^(?:0|[1-9]\d*)$/;
function ov(e, t) {
  var r = typeof e;
  return t = t ?? WI, !!t && (r == "number" || r != "symbol" && VI.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
i(ov, "isIndex");
var Ul = ov;
function lv(e, t, r) {
  t == "__proto__" && el ? el(e, t, { configurable: true, enumerable: true, value: r, writable: true }) : e[t] = r;
}
i(lv, "baseAssignValue");
var np = lv;
function cv(e, t) {
  return e === t || e !== e && t !== t;
}
i(cv, "eq");
var Os = cv, HI = Object.prototype, YI = HI.hasOwnProperty;
function uv(e, t, r) {
  var n = e[t];
  (!(YI.call(e, t) && Os(n, r)) || r === void 0 && !(t in e)) && np(e, t, r);
}
i(uv, "assignValue");
var zl = uv;
function dv(e, t, r, n) {
  ...
  for (var s = -1, o = t.length; ++s < o; ) {
    ...
    c === void 0 && (c = e[l]), a ? np(r, l, c) : zl(r, l, c);
  }
  return r;
}
i(dv, "copyObject");
var Ls = dv, Wh = Math.max;
function fv(e, t, r) {
  return t = Wh(t === void 0 ? e.length - 1 : t, 0), function() {
    for (var n = arguments, a = -1, s = Wh(n.length - t, 0), o = Array(s); ++a < s; ) o[a] = n[t + a];
    a = -1;
    for (var l = Array(t + 1); ++a < t; ) l[a] = n[a];
    return l[t] = r(o), PI(e, this, l);
  };
}
i(fv, "overRest");
var XI = fv;
function pv(e, t) {
  return BI(XI(e, t, ja), e + "");
}
i(pv, "baseRest");
var ap = pv, JI = 9007199254740991;
function hv(e) {
...
var ip = hv;
function mv(e) {
  return e != null && ip(e.length) && !Ir(e);
}
i(mv, "isArrayLike");
var nr = mv;
function gv(e, t, r) {
  ...
  var n = typeof t;
  return (n == "number" ? nr(r) && Ul(t, r.length) : n == "string" && t in r) ? Os(r[t], e) : false;
}
i(gv, "isIterateeCall");
var Bl = gv;
function yv(e) {
  return ap(function(t, r) {
    ...
    for (s = e.length > 3 && typeof s == "function" ? (a--, s) : void 0, o && Bl(r[0], r[1], o) && (s = a < 3 ? void 0 : s, a = 1), t = Object(t); ++n < a; ) {
      var l = r[n];
      l && e(t, l, n, s);
    }
    return t;
...
i(Cv, "baseUnary");
var Ms = Cv, Sv = typeof exports == "object" && exports && !exports.nodeType && exports, Qi = Sv && typeof module == "object" && module && !module.nodeType && module, LN = Qi && Qi.exports === Sv, Oc = LN && Sy.process, DN = (function() {
  try {
    var e = Qi && Qi.require && Qi.require("util").types;
    return e || Oc && Oc.binding && Oc.binding("util");
  } catch {
  }
})(), jr = DN, Xh = jr && jr.isTypedArray, MN = Xh ? Ms(Xh) : ON, sp = MN, xN = Object.prototype, FN = xN.hasOwnProperty;
function bv(e, t) {
  var r = ne(e), n = !r && Kl(e), a = !r && !n && cs(e), s = !r && !n && !a && sp(e), o = r || n || a || s, l = o ? eN(e.length, String) : [], c = l.length;
  for (var u in e) (t || FN.call(e, u)) && !(o && (u == "length" || a && (u == "offset" || u == "parent") || s && (u == "buffer" || u == "byteLength" || u == "byteOffset") || Ul(u, c))) && l.push(u);
  return l;
}
i(bv, "arrayLikeKeys");
var wv = bv;
...
i(Iv, "overArg");
var Nv = Iv, GN = Nv(Object.keys, Object), jN = GN, UN = Object.prototype, zN = UN.hasOwnProperty;
function kv(e) {
  if (!Ds(e)) return jN(e);
  var t = [];
  for (var r in Object(e)) zN.call(e, r) && r != "constructor" && t.push(r);
  return t;
}
i(kv, "baseKeys");
var Pv = kv;
function Ov(e) {
  return nr(e) ? wv(e) : Pv(e);
}
i(Ov, "keys");
var ft = Ov, BN = Object.prototype, KN = BN.hasOwnProperty, qN = ZI(function(e, t) {
  if (Ds(t) || nr(t)) {
    Ls(t, ft(t), e);
    return;
  }
  for (var r in t) KN.call(t, r) && zl(e, r, t[r]);
}), pt = qN;
function Lv(e) {
  var t = [];
...
i(Lv, "nativeKeysIn");
var WN = Lv, VN = Object.prototype, HN = VN.hasOwnProperty;
function Dv(e) {
  if (!St(e)) return WN(e);
  var t = Ds(e), r = [];
  for (var n in e) n == "constructor" && (t || !HN.call(e, n)) || r.push(n);
  return r;
}
i(Dv, "baseKeysIn");
var YN = Dv;
function Mv(e) {
  return nr(e) ? wv(e, true) : YN(e);
}
i(Mv, "keysIn");
var ql = Mv, XN = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, JN = /^\w*$/;
function xv(e, t) {
  if (ne(e)) return false;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || jl(e) ? true : JN.test(e) || !XN.test(e) || t != null && e in Object(t);
}
i(xv, "isKey");
var op = xv, ZN = Gn(Object, "create"), us = ZN;
function Fv() {
...
i(Gv, "hashDelete");
var ek = Gv, tk = "__lodash_hash_undefined__", rk = Object.prototype, nk = rk.hasOwnProperty;
function jv(e) {
  var t = this.__data__;
  if (us) {
    var r = t[e];
    return r === tk ? void 0 : r;
  }
  return nk.call(t, e) ? t[e] : void 0;
}
i(jv, "hashGet");
var ak = jv, ik = Object.prototype, sk = ik.hasOwnProperty;
function Uv(e) {
  var t = this.__data__;
  return us ? t[e] !== void 0 : sk.call(t, e);
}
i(Uv, "hashHas");
var ok = Uv, lk = "__lodash_hash_undefined__";
function zv(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = us && t === void 0 ? lk : t, this;
}
i(zv, "hashSet");
var ck = zv;
function jn(e) {
...
i(Kv, "assocIndexOf");
var Wl = Kv, dk = Array.prototype, fk = dk.splice;
function qv(e) {
  var t = this.__data__, r = Wl(t, e);
  if (r < 0) return false;
  var n = t.length - 1;
  return r == n ? t.pop() : fk.call(t, r, 1), --this.size, true;
}
i(qv, "listCacheDelete");
var pk = qv;
function Wv(e) {
  var t = this.__data__, r = Wl(t, e);
...
i(Un, "ListCache");
Un.prototype.clear = uk;
Un.prototype.delete = pk;
Un.prototype.get = hk;
Un.prototype.has = mk;
Un.prototype.set = gk;
var Vl = Un, yk = Gn(rr, "Map"), ds = yk;
function Yv() {
  this.size = 0, this.__data__ = { hash: new Jh(), map: new (ds || Vl)(), string: new Jh() };
}
i(Yv, "mapCacheClear");
var vk = Yv;
function Xv(e) {
...
function Jv(e, t) {
  var r = e.__data__;
  return Tk(t) ? r[typeof t == "string" ? "string" : "hash"] : r.map;
}
i(Jv, "getMapData");
var Hl = Jv;
function Zv(e) {
...
i(zn, "MapCache");
zn.prototype.clear = vk;
zn.prototype.delete = Rk;
zn.prototype.get = $k;
zn.prototype.has = Ak;
zn.prototype.set = Ek;
var Yl = zn, _k = "Expected a function";
function Xl(e, t) {
  if (typeof e != "function" || t != null && typeof t != "function") throw new TypeError(_k);
  var r = i(function() {
  ...
  return r.cache = new (Xl.Cache || Yl)(), r;
}
i(Xl, "memoize");
Xl.Cache = Yl;
var Ck = Xl, Sk = 500;
function rT(e) {
  var t = Ck(e, function(n) {
    return r.size === Sk && r.clear(), n;
  }), r = t.cache;
  return t;
}
i(rT, "memoizeCapped");
var bk = rT, wk = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Ik = /\\(\\)?/g, Nk = bk(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(wk, function(r, n, a, s) {
    t.push(a ? s.replace(Ik, "$1") : n || r);
  }), t;
}), kk = Nk;
function nT(e) {
  return e == null ? "" : eI(e);
...
var Pk = nT;
function aT(e, t) {
  return ne(e) ? e : op(e, t) ? [e] : kk(Pk(e));
}
i(aT, "castPath");
var Jl = aT;
function iT(e) {
...
function sT(e, t) {
  t = Jl(t, e);
  for (var r = 0, n = t.length; e != null && r < n; ) e = e[xs(t[r++])];
...
i(lT, "arrayPush");
var cp = lT, Zh = Ct ? Ct.isConcatSpreadable : void 0;
function cT(e) {
  return ne(e) || Kl(e) || !!(Zh && e && e[Zh]);
}
i(cT, "isFlattenable");
var Lk = cT;
function up(e, t, r, n, a) {
  ...
  for (r || (r = Lk), a || (a = []); ++s < o; ) {
    var l = e[s];
    t > 0 && r(l) ? t > 1 ? up(l, t - 1, r, n, a) : cp(a, l) : n || (a[a.length] = l);
  }
  return a;
}
i(up, "baseFlatten");
...
i(uT, "flatten");
var xt = uT, Dk = Nv(Object.getPrototypeOf, Object), dT = Dk;
function fT(e, t, r) {
  var n = -1, a = e.length;
...
function TT(e, t) {
  ...
  if (r instanceof Vl) {
    var n = r.__data__;
    if (!ds || n.length < Uk - 1) return n.push([e, t]), this.size = ++r.size, this;
...
i(Bn, "Stack");
Bn.prototype.clear = xk;
Bn.prototype.delete = Fk;
Bn.prototype.get = Gk;
Bn.prototype.has = jk;
Bn.prototype.set = zk;
var es = Bn;
function RT(e, t) {
  return e && Ls(t, ft(t), e);
}
i(RT, "baseAssign");
var Bk = RT;
function $T(e, t) {
  return e && Ls(t, ql(t), e);
}
i($T, "baseAssignIn");
var Kk = $T, AT = typeof exports == "object" && exports && !exports.nodeType && exports, Qh = AT && typeof module == "object" && module && !module.nodeType && module, qk = Qh && Qh.exports === AT, em = qk ? rr.Buffer : void 0, tm = em ? em.allocUnsafe : void 0;
function ET(e, t) {
  if (t) return e.slice();
  var r = e.length, n = tm ? tm(r) : new e.constructor(r);
  return e.copy(n), n;
}
i(ET, "cloneBuffer");
var Wk = ET;
...
i(CT, "stubArray");
var ST = CT, Vk = Object.prototype, Hk = Vk.propertyIsEnumerable, rm = Object.getOwnPropertySymbols, Yk = rm ? function(e) {
  return e == null ? [] : (e = Object(e), fp(rm(e), function(t) {
    return Hk.call(e, t);
  }));
} : ST, pp = Yk;
function bT(e, t) {
...
i(bT, "copySymbols");
var Xk = bT, Jk = Object.getOwnPropertySymbols, Zk = Jk ? function(e) {
  for (var t = []; e; ) cp(t, pp(e)), e = dT(e);
  return t;
} : ST, wT = Zk;
function IT(e, t) {
  return Ls(e, wT(e), t);
...
i(OT, "getAllKeysIn");
var LT = OT, eP = Gn(rr, "DataView"), id = eP, tP = Gn(rr, "Promise"), sd = tP, rP = Gn(rr, "Set"), Na = rP, nm = "[object Map]", nP = "[object Object]", am = "[object Promise]", im = "[object Set]", sm = "[object WeakMap]", om = "[object DataView]", aP = Fn(id), iP = Fn(ds), sP = Fn(sd), oP = Fn(Na), lP = Fn(nd), nn = Wr;
(id && nn(new id(new ArrayBuffer(1))) != om || ds && nn(new ds()) != nm || sd && nn(sd.resolve()) != am || Na && nn(new Na()) != im || nd && nn(new nd()) != sm) && (nn = i(function(e) {
  var t = Wr(e), r = t == nP ? e.constructor : void 0, n = r ? Fn(r) : "";
  if (n) switch (n) {
    case aP:
      return om;
    case iP:
...
var Ua = nn, cP = Object.prototype, uP = cP.hasOwnProperty;
function DT(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && uP.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
i(DT, "initCloneArray");
var dP = DT, fP = rr.Uint8Array, tl = fP;
function MT(e) {
  var t = new e.constructor(e.byteLength);
  return new tl(t).set(new tl(e)), t;
}
i(MT, "cloneArrayBuffer");
var hp = MT;
function xT(e, t) {
  var r = t ? hp(e.buffer) : e.buffer;
...
i(FT, "cloneRegExp");
var mP = FT, lm = Ct ? Ct.prototype : void 0, cm = lm ? lm.valueOf : void 0;
function GT(e) {
  return cm ? Object(cm.call(e)) : {};
}
i(GT, "cloneSymbol");
var gP = GT;
function jT(e, t) {
...
var xP = UT;
function zT(e) {
  return typeof e.constructor == "function" && !Ds(e) ? kI(dT(e)) : {};
}
i(zT, "initCloneObject");
var FP = zT, GP = "[object Map]";
function BT(e) {
  return Gt(e) && Ua(e) == GP;
}
i(BT, "baseIsMap");
var jP = BT, um = jr && jr.isMap, UP = um ? Ms(um) : jP, zP = UP, BP = "[object Set]";
function KT(e) {
  return Gt(e) && Ua(e) == BP;
}
i(KT, "baseIsSet");
var KP = KT, dm = jr && jr.isSet, qP = dm ? Ms(dm) : KP, WP = qP, VP = 1, HP = 2, YP = 4, qT = "[object Arguments]", XP = "[object Array]", JP = "[object Boolean]", ZP = "[object Date]", QP = "[object Error]", WT = "[object Function]", e0 = "[object GeneratorFunction]", t0 = "[object Map]", r0 = "[object Number]", VT = "[object Object]", n0 = "[object RegExp]", a0 = "[object Set]", i0 = "[object String]", s0 = "[object Symbol]", o0 = "[object WeakMap]", l0 = "[object ArrayBuffer]", c0 = "[object DataView]", u0 = "[object Float32Array]", d0 = "[object Float64Array]", f0 = "[object Int8Array]", p0 = "[object Int16Array]", h0 = "[object Int32Array]", m0 = "[object Uint8Array]", g0 = "[object Uint8ClampedArray]", y0 = "[object Uint16Array]", v0 = "[object Uint32Array]", fe = {};
fe[qT] = fe[XP] = fe[l0] = fe[c0] = fe[JP] = fe[ZP] = fe[u0] = fe[d0] = fe[f0] = fe[p0] = fe[h0] = fe[t0] = fe[r0] = fe[VT] = fe[n0] = fe[a0] = fe[i0] = fe[s0] = fe[m0] = fe[g0] = fe[y0] = fe[v0] = true;
fe[QP] = fe[WT] = fe[o0] = false;
function ts(e, t, r, n, a, s) {
  var o, l = t & VP, c = t & HP, u = t & YP;
  if (r && (o = a ? r(e, n, a, s) : r(e)), o !== void 0) return o;
  if (!St(e)) return e;
  var d = ne(e);
  if (d) {
    if (o = dP(e), !l) return OI(e, o);
  } else {
    var f = Ua(e), h = f == WT || f == e0;
    if (cs(e)) return Wk(e, l);
    if (f == VT || f == qT || h && !a) {
      if (o = c || h ? {} : FP(e), !l) return c ? Qk(e, Kk(o, e)) : Xk(e, Bk(o, e));
    } else {
      if (!fe[f]) return a ? e : {};
      o = xP(e, f, l);
    }
  ...
  var y = s.get(e);
  if (y) return y;
  s.set(e, o), WP(e) ? e.forEach(function(b) {
    o.add(ts(b, t, r, b, e, s));
  }) : zP(e) && e.forEach(function(b, w) {
    o.set(w, ts(b, t, r, w, e, s));
  });
  var v = u ? c ? LT : ad : c ? ql : ft, C = d ? void 0 : v(e);
  return Qy(C || e, function(b, w) {
    C && (w = b, b = e[w]), zl(o, w, ts(b, t, r, w, e, s));
  }), o;
}
i(ts, "baseClone");
var T0 = ts, R0 = 4;
...
i(YT, "compact");
var Fs = YT, $0 = "__lodash_hash_undefined__";
function XT(e) {
  return this.__data__.set(e, $0), this;
}
i(XT, "setCacheAdd");
var A0 = XT;
function JT(e) {
...
function fs(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.__data__ = new Yl(); ++t < r; ) this.add(e[t]);
}
i(fs, "SetCache");
fs.prototype.add = fs.prototype.push = A0;
fs.prototype.has = E0;
var mp = fs;
function ZT(e, t) {
...
function tR(e, t, r, n, a, s) {
  ...
  if (l != c && !(o && c > l)) return false;
  var u = s.get(e), d = s.get(t);
  if (u && d) return u == t && d == e;
  var f = -1, h = true, y = r & C0 ? new mp() : void 0;
  for (s.set(e, t), s.set(t, e); ++f < l; ) {
    var v = e[f], C = t[f];
    if (n) var b = o ? n(C, v, f, t, e, s) : n(v, C, f, e, t, s);
    if (b !== void 0) {
      if (b) continue;
      h = false;
      break;
    ...
    if (y) {
      if (!QT(t, function(w, I) {
        if (!gp(y, I) && (v === w || a(v, w, r, n, s))) return y.push(I);
      })) {
        h = false;
        break;
      }
...
i(aR, "setToArray");
var yp = aR, b0 = 1, w0 = 2, I0 = "[object Boolean]", N0 = "[object Date]", k0 = "[object Error]", P0 = "[object Map]", O0 = "[object Number]", L0 = "[object RegExp]", D0 = "[object Set]", M0 = "[object String]", x0 = "[object Symbol]", F0 = "[object ArrayBuffer]", G0 = "[object DataView]", fm = Ct ? Ct.prototype : void 0, Lc = fm ? fm.valueOf : void 0;
function iR(e, t, r, n, a, s, o) {
  switch (r) {
    case G0:
    ...
    case D0:
      var c = n & b0;
      if (l || (l = yp), e.size != t.size && !c) return false;
      var u = o.get(e);
      if (u) return u == t;
      n |= w0, o.set(e, t);
      var d = rR(l(e), l(t), n, a, s, o);
      return o.delete(e), d;
    case x0:
...
i(iR, "equalByTag");
var j0 = iR, U0 = 1, z0 = Object.prototype, B0 = z0.hasOwnProperty;
function sR(e, t, r, n, a, s) {
  var o = r & U0, l = ad(e), c = l.length, u = ad(t), d = u.length;
  if (c != d && !o) return false;
  for (var f = c; f--; ) {
    var h = l[f];
    if (!(o ? h in t : B0.call(t, h))) return false;
  }
  ...
  for (var b = o; ++f < c; ) {
    h = l[f];
    var w = e[h], I = t[h];
    if (n) var A = o ? n(I, w, h, t, e, s) : n(w, I, h, e, t, s);
  ...
  if (C && !b) {
    ...
    k != G && "constructor" in e && "constructor" in t && !(typeof k == "function" && k instanceof k && typeof G == "function" && G instanceof G) && (C = false);
  }
  return s.delete(e), s.delete(t), C;
}
i(sR, "equalObjects");
var K0 = sR, q0 = 1, pm = "[object Arguments]", hm = "[object Array]", Vs = "[object Object]", W0 = Object.prototype, mm = W0.hasOwnProperty;
function oR(e, t, r, n, a, s) {
  var o = ne(e), l = ne(t), c = o ? hm : Ua(e), u = l ? hm : Ua(t);
  c = c == pm ? Vs : c, u = u == pm ? Vs : u;
  var d = c == Vs, f = u == Vs, h = c == u;
  if (h && cs(e)) {
    if (!cs(t)) return false;
    o = true, d = false;
  }
  if (h && !d) return s || (s = new es()), o || sp(e) ? rR(e, t, r, n, a, s) : j0(e, t, c, r, n, a, s);
  if (!(r & q0)) {
    var y = d && mm.call(e, "__wrapped__"), v = f && mm.call(t, "__wrapped__");
    if (y || v) {
      var C = y ? e.value() : e, b = v ? t.value() : t;
      return s || (s = new es()), a(C, b, r, n, s);
    }
  }
  return h ? (s || (s = new es()), K0(e, t, r, n, a, s)) : false;
}
i(oR, "baseIsEqualDeep");
var V0 = oR;
function vp(e, t, r, n, a) {
  return e === t ? true : e == null || t == null || !Gt(e) && !Gt(t) ? e !== e && t !== t : V0(e, t, r, n, vp, a);
}
i(vp, "baseIsEqual");
var lR = vp, H0 = 1, Y0 = 2;
function cR(e, t, r, n) {
  ...
  for (; ++a < s; ) {
    ...
    if (o && l[2]) {
      if (u === void 0 && !(c in e)) return false;
    } else {
      var f = new es();
      if (n) var h = n(u, d, c, e, t, f);
      if (!(h === void 0 ? lR(d, u, H0 | Y0, n, f) : h)) return false;
    }
  }
  return true;
}
...
function yR(e, t, r) {
  t = Jl(t, e);
  for (var n = -1, a = t.length, s = false; ++n < a; ) {
    var o = xs(t[n]);
    if (!(s = e != null && r(e, o))) break;
    e = e[o];
  }
  return s || ++n != a ? s : (a = e == null ? 0 : e.length, !!a && ip(a) && Ul(o, a) && (ne(e) || Kl(e)));
}
i(yR, "hasPath");
var vR = yR;
function TR(e, t) {
  return e != null && vR(e, t, Q0);
}
i(TR, "hasIn");
var eO = TR, tO = 1, rO = 2;
function RR(e, t) {
  return op(e) && dR(t) ? hR(xs(e), t) : function(r) {
    var n = Ok(r, e);
    return n === void 0 && n === t ? eO(r, e) : lR(t, n, tO | rO);
  };
}
i(RR, "baseMatchesProperty");
var nO = RR;
function $R(e) {
  return function(t) {
...
i(AR, "basePropertyDeep");
var iO = AR;
function ER(e) {
  return op(e) ? aO(xs(e)) : iO(e);
}
i(ER, "property");
var sO = ER;
function _R(e) {
  return typeof e == "function" ? e : e == null ? ja : typeof e == "object" ? ne(e) ? nO(e[0], e[1]) : Z0(e) : sO(e);
}
i(_R, "baseIteratee");
var ar = _R;
function CR(e, t, r, n) {
...
i(CR, "arrayAggregator");
var oO = CR;
function SR(e) {
  return function(t, r, n) {
    for (var a = -1, s = Object(t), o = n(t), l = o.length; l--; ) {
      var c = o[e ? l : ++a];
      if (r(s[c], c, s) === false) break;
    }
    return t;
  };
}
i(SR, "createBaseFor");
var lO = SR, cO = lO(), uO = cO;
function bR(e, t) {
  return e && uO(e, t, ft);
}
i(bR, "baseForOwn");
...
function wR(e, t) {
  return function(r, n) {
    if (r == null) return r;
    if (!nr(r)) return e(r, n);
    for (var a = r.length, s = t ? a : -1, o = Object(r); (t ? s-- : ++s < a) && n(o[s], s, o) !== false; ) ;
    return r;
  };
}
i(wR, "createBaseEach");
var fO = wR, pO = fO(dO), Kn = pO;
function IR(e, t, r, n) {
  return Kn(e, function(a, s, o) {
    t(n, a, r(a), o);
  }), n;
}
i(IR, "baseAggregator");
...
function NR(e, t) {
  return function(r, n) {
    var a = ne(r) ? oO : hO, s = t ? t() : {};
    return a(r, e, ar(n), s);
  };
}
i(NR, "createAggregator");
var mO = NR, kR = Object.prototype, gO = kR.hasOwnProperty, yO = ap(function(e, t) {
  e = Object(e);
  var r = -1, n = t.length, a = n > 2 ? t[2] : void 0;
  for (a && Bl(t[0], t[1], a) && (n = 1); ++r < n; ) for (var s = t[r], o = ql(s), l = -1, c = o.length; ++l < c; ) {
    var u = o[l], d = e[u];
    (d === void 0 || Os(d, kR[u]) && !gO.call(e, u)) && (e[u] = s[u]);
  }
  return e;
}), Tp = yO;
function PR(e) {
...
i(PR, "isArrayLikeObject");
var gm = PR;
function OR(e, t, r) {
  for (var n = -1, a = e == null ? 0 : e.length; ++n < a; ) if (r(t, e[n])) return true;
  return false;
}
i(OR, "arrayIncludesWith");
var LR = OR, vO = 200;
function DR(e, t, r, n) {
  var a = -1, s = sv, o = true, l = e.length, c = [], u = t.length;
  if (!l) return c;
  r && (t = ks(t, Ms(r))), n ? (s = LR, o = false) : t.length >= vO && (s = gp, o = false, t = new mp(t));
  e: for (; ++a < l; ) {
    var d = e[a], f = r == null ? d : r(d);
    if (d = n || d !== 0 ? d : 0, o && f === f) {
      for (var h = u; h--; ) if (t[h] === f) continue e;
      c.push(d);
    } else s(t, f, n) || c.push(d);
  }
  return c;
}
i(DR, "baseDifference");
var TO = DR, RO = ap(function(e, t) {
  return gm(e) ? TO(e, dp(t, 1, gm, true)) : [];
}), Zl = RO;
function MR(e) {
  var t = e == null ? 0 : e.length;
...
function xR(e, t, r) {
  ...
  return n ? (t = r || t === void 0 ? 1 : Ps(t), pT(e, t < 0 ? 0 : t, n)) : [];
}
i(xR, "drop");
var ze = xR;
function FR(e, t, r) {
  var n = e == null ? 0 : e.length;
  return n ? (t = r || t === void 0 ? 1 : Ps(t), t = n - t, pT(e, 0, t < 0 ? 0 : t)) : [];
}
i(FR, "dropRight");
var ps = FR;
function GR(e) {
...
var q = jR;
function UR(e, t) {
  for (var r = -1, n = e == null ? 0 : e.length; ++r < n; ) if (!t(e[r], r, e)) return false;
  return true;
}
i(UR, "arrayEvery");
var AO = UR;
...
function BR(e, t, r) {
  var n = ne(e) ? AO : EO;
  return r && Bl(e, t, r) && (t = void 0), n(e, ar(t));
}
i(BR, "every");
var Ft = BR;
function KR(e, t) {
...
i(VR, "createFind");
var _O = VR, CO = Math.max;
function HR(e, t, r) {
  var n = e == null ? 0 : e.length;
  if (!n) return -1;
  var a = r == null ? 0 : Ps(r);
  return a < 0 && (a = CO(n + a, 0)), tv(e, ar(t), a);
}
i(HR, "findIndex");
var SO = HR, bO = _O(SO), za = bO;
function YR(e) {
...
i(ZR, "flatMap");
var _t = ZR, IO = Object.prototype, NO = IO.hasOwnProperty, kO = mO(function(e, t, r) {
  NO.call(e, r) ? e[r].push(t) : np(e, r, [t]);
}), PO = kO, OO = Object.prototype, LO = OO.hasOwnProperty;
function QR(e, t) {
...
var DO = QR;
function e$(e, t) {
  return e != null && vR(e, t, DO);
}
i(e$, "has");
var U = e$, MO = "[object String]";
function t$(e) {
  return typeof e == "string" || !ne(e) && Gt(e) && Wr(e) == MO;
}
i(t$, "isString");
var it = t$;
function r$(e, t) {
...
var xO = r$;
function n$(e) {
  return e == null ? [] : xO(e, ft(e));
}
i(n$, "values");
var xe = n$, FO = Math.max;
function a$(e, t, r, n) {
  e = nr(e) ? e : xe(e), r = r && !n ? Ps(r) : 0;
  var a = e.length;
  return r < 0 && (r = FO(a + r, 0)), it(e) ? r <= a && e.indexOf(t, r) > -1 : !!a && rp(e, t, r) > -1;
}
i(a$, "includes");
var tt = a$, GO = Math.max;
function i$(e, t, r) {
  var n = e == null ? 0 : e.length;
  if (!n) return -1;
  var a = r == null ? 0 : Ps(r);
  return a < 0 && (a = GO(n + a, 0)), rp(e, t, a);
}
i(i$, "indexOf");
var ym = i$, jO = "[object Map]", UO = "[object Set]", zO = Object.prototype, BO = zO.hasOwnProperty;
function s$(e) {
  if (e == null) return true;
  if (nr(e) && (ne(e) || typeof e == "string" || typeof e.splice == "function" || cs(e) || sp(e) || Kl(e))) return !e.length;
  var t = Ua(e);
  if (t == jO || t == UO) return !e.size;
  if (Ds(e)) return !Pv(e).length;
  for (var r in e) if (BO.call(e, r)) return false;
  return true;
}
i(s$, "isEmpty");
var he = s$, KO = "[object RegExp]";
function o$(e) {
  return Gt(e) && Wr(e) == KO;
}
i(o$, "baseIsRegExp");
var qO = o$, vm = jr && jr.isRegExp, WO = vm ? Ms(vm) : qO, Ar = WO;
function l$(e) {
  return e === void 0;
}
i(l$, "isUndefined");
var Er = l$, VO = "Expected a function";
function c$(e) {
...
function u$(e, t, r, n) {
  ...
  for (var a = -1, s = t.length, o = s - 1, l = e; l != null && ++a < s; ) {
    ...
    if (a != o) {
      var d = l[c];
      u = n ? n(d, c, l) : void 0, u === void 0 && (u = St(d) ? d : Ul(t[a + 1]) ? [] : {});
    }
    zl(l, c, u), l = l[c];
  }
  return e;
...
function f$(e, t) {
  if (e == null) return {};
  var r = ks(LT(e), function(n) {
    return [n];
  });
  return t = ar(t), XO(e, r, function(n, a) {
    return t(n, a[0]);
  });
}
i(f$, "pickBy");
...
function p$(e, t, r, n, a) {
  return a(e, function(s, o, l) {
    r = n ? (n = false, s) : t(r, s, o, l);
  }), r;
}
i(p$, "baseReduce");
var JO = p$;
function h$(e, t, r) {
  var n = ne(e) ? Mk : JO, a = arguments.length < 3;
  return n(e, ar(t), r, a, Kn);
}
i(h$, "reduce");
var ht = h$;
function m$(e, t) {
...
i(y$, "some");
var v$ = y$, QO = 1 / 0, eL = Na && 1 / yp(new Na([, -0]))[1] == QO ? function(e) {
  return new Na(e);
} : Me, tL = eL, rL = 200;
function T$(e, t, r) {
  var n = -1, a = sv, s = e.length, o = true, l = [], c = l;
  if (r) o = false, a = LR;
  else if (s >= rL) {
    var u = t ? null : tL(e);
    if (u) return yp(u);
    o = false, a = gp, c = new mp();
  } else c = t ? [] : l;
  e: for (; ++n < s; ) {
    var d = e[n], f = t ? t(d) : d;
    if (d = r || d !== 0 ? d : 0, o && f === f) {
      ...
      t && c.push(f), l.push(d);
    } else a(c, f, r) || (c !== l && c.push(f), l.push(d));
  }
  return l;
}
i(T$, "baseUniq");
...
i(Ep, "toFastProperties");
function $$(e) {
  return A$(e) ? e.LABEL : e.name;
}
i($$, "tokenLabel");
function A$(e) {
...
var ir = (_i2 = class {
...
}, i(_i2, "AbstractProduction"), _i2), Ze = (_j = class extends ir {
  constructor(e) {
...
}, i(_j, "NonTerminal"), _j), Ha = (_k2 = class extends ir {
  constructor(e) {
    super(e.definition), this.orgText = "", pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_k2, "Rule"), _k2), st = (_l2 = class extends ir {
  constructor(e) {
    super(e.definition), this.ignoreAmbiguities = false, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_l2, "Alternative"), _l2), Be = (_m2 = class extends ir {
  constructor(e) {
    super(e.definition), this.idx = 1, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_m2, "Option"), _m2), mt = (_n2 = class extends ir {
  constructor(e) {
    super(e.definition), this.idx = 1, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_n2, "RepetitionMandatory"), _n2), gt = (_o2 = class extends ir {
  constructor(e) {
    super(e.definition), this.idx = 1, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_o2, "RepetitionMandatoryWithSeparator"), _o2), we = (_p2 = class extends ir {
  constructor(e) {
    super(e.definition), this.idx = 1, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_p2, "Repetition"), _p2), ot = (_q = class extends ir {
  constructor(e) {
    super(e.definition), this.idx = 1, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_q, "RepetitionWithSeparator"), _q), lt = (_r2 = class extends ir {
  get definition() {
    return this._definition;
  }
  set definition(e) {
  ...
  constructor(e) {
    super(e.definition), this.idx = 1, this.ignoreAmbiguities = false, this.hasPredicates = false, pt(this, Ut(e, (t) => t !== void 0));
  }
}, i(_r2, "Alternation"), _r2), Te = (_s2 = class {
  constructor(e) {
...
i(E$, "serializeGrammar");
function rs(e) {
  function t(r) {
    return F(r, rs);
  }
  if (i(t, "convertDefinition"), e instanceof Ze) {
    const r = { type: "NonTerminal", name: e.nonTerminalName, idx: e.idx };
    return it(e.label) && (r.label = e.label), r;
  } else {
    if (e instanceof st) return { type: "Alternative", definition: t(e.definition) };
    if (e instanceof Be) return { type: "Option", idx: e.idx, definition: t(e.definition) };
    if (e instanceof mt) return { type: "RepetitionMandatory", idx: e.idx, definition: t(e.definition) };
    if (e instanceof gt) return { type: "RepetitionMandatoryWithSeparator", idx: e.idx, separator: rs(new Te({ terminalType: e.separator })), definition: t(e.definition) };
    if (e instanceof ot) return { type: "RepetitionWithSeparator", idx: e.idx, separator: rs(new Te({ terminalType: e.separator })), definition: t(e.definition) };
    if (e instanceof we) return { type: "Repetition", idx: e.idx, definition: t(e.definition) };
    if (e instanceof lt) return { type: "Alternation", idx: e.idx, definition: t(e.definition) };
    if (e instanceof Te) {
      const r = { type: "Terminal", name: e.terminalType.name, label: $$(e.terminalType), idx: e.idx };
      it(e.label) && (r.terminalLabel = e.label);
      const n = e.terminalType.PATTERN;
      return e.terminalType.PATTERN && (r.pattern = Ar(n) ? n.source : n), r;
    } else {
      if (e instanceof Ha) return { type: "Rule", name: e.name, orgText: e.orgText, definition: t(e.definition) };
      throw Error("non exhaustive match");
    }
  }
}
i(rs, "serializeProduction");
var Ya = (_t2 = class {
  visit(e) {
    const t = e;
...
}, i(_t2, "GAstVisitor"), _t2);
function _$(e) {
  return e instanceof st || e instanceof Be || e instanceof we || e instanceof mt || e instanceof gt || e instanceof ot || e instanceof Te || e instanceof Ha;
}
i(_$, "isSequenceProd");
function hs(e, t = []) {
  return e instanceof Be || e instanceof we || e instanceof ot ? true : e instanceof lt ? v$(e.definition, (n) => hs(n, t)) : e instanceof Ze && tt(t, e) ? false : e instanceof ir ? (e instanceof Ze && t.push(e), Ft(e.definition, (n) => hs(n, t))) : false;
}
i(hs, "isOptionalProd");
function C$(e) {
...
function Ot(e) {
  ...
  if (e instanceof Be) return "OPTION";
  if (e instanceof lt) return "OR";
  if (e instanceof mt) return "AT_LEAST_ONE";
  if (e instanceof gt) return "AT_LEAST_ONE_SEP";
  if (e instanceof ot) return "MANY_SEP";
  if (e instanceof we) return "MANY";
...
var ec = (_u2 = class {
  walk(e, t = []) {
    q(e.definition, (r, n) => {
      ...
      if (r instanceof Ze) this.walkProdRef(r, a, t);
      else if (r instanceof Te) this.walkTerminal(r, a, t);
      else if (r instanceof st) this.walkFlat(r, a, t);
      else if (r instanceof Be) this.walkOption(r, a, t);
      else if (r instanceof mt) this.walkAtLeastOne(r, a, t);
      else if (r instanceof gt) this.walkAtLeastOneSep(r, a, t);
      else if (r instanceof ot) this.walkManySep(r, a, t);
      else if (r instanceof we) this.walkMany(r, a, t);
      else if (r instanceof lt) this.walkOr(r, a, t);
  ...
  walkAtLeastOne(e, t, r) {
    const n = [new Be({ definition: e.definition })].concat(t, r);
    this.walk(e, n);
  }
...
}, i(_u2, "RestWalker"), _u2);
function od(e, t, r) {
  return [new Be({ definition: [new Te({ terminalType: e.separator })].concat(e.definition) })].concat(t, r);
}
i(od, "restForRepetitionWithSeparator");
function Xa(e) {
  if (e instanceof Ze) return Xa(e.referencedRule);
  if (e instanceof Te) return w$(e);
  if (_$(e)) return S$(e);
  if (C$(e)) return b$(e);
  throw Error("non exhaustive match");
}
...
function S$(e) {
  ...
  let n = 0, a = r.length > n, s, o = true;
  for (; a && o; ) s = r[n], o = hs(s), t = t.concat(Xa(s)), n = n + 1, a = r.length > n;
  return Rp(t);
}
i(S$, "firstForSequence");
function b$(e) {
  const t = F(e.definition, (r) => Xa(r));
  return Rp(xt(t));
}
...
i(w$, "firstForTerminal");
var I$ = "_~IN~_", aL = (_v2 = class extends ec {
  constructor(e) {
  ...
  walkProdRef(e, t, r) {
    const n = k$(e.referencedRule, e.idx) + this.topProd.name, a = t.concat(r), s = new st({ definition: a }), o = Xa(s);
    this.follows[n] = o;
  }
}, i(_v2, "ResyncFollowsWalker"), _v2);
function N$(e) {
  const t = {};
  return q(e, (r) => {
    const n = new aL(r).startWalking();
    pt(t, n);
  }), t;
}
i(N$, "computeAllProdsFollows");
function k$(e, t) {
  return e.name + t + I$;
}
i(k$, "buildBetweenProdsFollowPrefix");
var $o = {}, iL = new cy();
function Gs(e) {
  const t = e.toString();
  if ($o.hasOwnProperty(t)) return $o[t];
  {
    const r = iL.pattern(t);
    return $o[t] = r, r;
  }
}
i(Gs, "getRegExpAst");
...
i(P$, "clearRegExpParserCache");
var O$ = "Complement Sets are not supported for first char optimization", nl = `Unable to use "first char" lexer optimizations:
`;
function L$(e, t = false) {
  try {
    const r = Gs(e);
    return al(r.value, {}, r.flags.ignoreCase);
  } catch (r) {
    if (r.message === O$) t && $p(`${nl}	Unable to optimize: < ${e.toString()} >
	...
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#COMPLEMENT for details.`);
      ...
      t && (n = `
	This will disable the lexer's first char optimizations.
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`), rl(`${nl}
...
function al(e, t, r) {
  switch (e.type) {
    case "Disjunction":
      for (let a = 0; a < e.value.length; a++) al(e.value[a], t, r);
      break;
    case "Alternative":
      const n = e.value;
      for (let a = 0; a < n.length; a++) {
        ...
        switch (o.type) {
          case "Character":
            ...
            break;
          case "Set":
            if (o.complement === true) throw Error(O$);
            q(o.value, (c) => {
              if (typeof c == "number") ji(c, t, r);
              else {
                const u = c;
                if (r === true) for (let d = u.from; d <= u.to; d++) ji(d, t, r);
                else {
                  for (let d = u.from; d <= u.to && d < zi; d++) ji(d, t, r);
                  if (u.to >= zi) {
                    const d = u.from >= zi ? u.from : zi, f = u.to, h = _r(d), y = _r(f);
                    for (let v = h; v <= y; v++) t[v] = v;
                  }
                }
              }
            });
        ...
        if (o.type === "Group" && il(o) === false || o.type !== "Group" && l === false) break;
      }
      break;
    default:
      throw Error("non exhaustive match!");
...
i(al, "firstCharOptimizedIndices");
function ji(e, t, r) {
  const n = _r(e);
  t[n] = n, r === true && D$(e, t);
}
i(ji, "addOptimizedIdxToResult");
function D$(e, t) {
  const r = String.fromCharCode(e), n = r.toUpperCase();
  if (n !== r) {
    const a = _r(n.charCodeAt(0));
    t[a] = a;
  } else {
    const a = r.toLowerCase();
    if (a !== r) {
      const s = _r(a.charCodeAt(0));
      t[s] = s;
    }
  }
}
i(D$, "handleIgnoreCase");
function ld(e, t) {
  return za(e.value, (r) => {
    if (typeof r == "number") return tt(t, r);
    {
      const n = r;
      return za(t, (a) => n.from <= a && a <= n.to) !== void 0;
    }
  });
}
i(ld, "findCode");
function il(e) {
  ...
  return t && t.atLeast === 0 ? true : e.value ? ne(e.value) ? Ft(e.value, il) : il(e.value) : false;
}
i(il, "isWholeOptional");
var sL = (_w2 = class extends Ol {
  constructor(e) {
  ...
  visitCharacter(e) {
    tt(this.targetCharCodes, e.value) && (this.found = true);
  }
  visitSet(e) {
    e.complement ? ld(e, this.targetCharCodes) === void 0 && (this.found = true) : ld(e, this.targetCharCodes) !== void 0 && (this.found = true);
  }
}, i(_w2, "CharCodeFinder"), _w2);
function tc(e, t) {
  if (t instanceof RegExp) {
    const r = Gs(t), n = new sL(e);
    return n.visit(r), n.found;
  } else return za(t, (r) => tt(e, r.charCodeAt(0))) !== void 0;
}
i(tc, "canMatchCharCode");
var In = "PATTERN", Ui = "defaultMode", Hs = "modes", M$ = typeof new RegExp("(?:)").sticky == "boolean";
function x$(e, t) {
  t = Tp(t, { useSticky: M$, debug: false, safeMode: false, positionTracking: "full", lineTerminatorCharacters: ["\r", `
`], tracer: i((I, A) => A(), "tracer") });
  const r = t.tracer;
  ...
  r("Transform Patterns", () => {
    a = false, s = F(n, (I) => {
      ...
      if (Ar(A)) {
        const k = A.source;
        return k.length === 1 && k !== "^" && k !== "$" && k !== "." && !A.ignoreCase ? k : k.length === 2 && k[0] === "\\" && !tt(["d", "D", "s", "S", "t", "r", "n", "t", "0", "c", "b", "B", "f", "v", "w", "W"], k[1]) ? k[1] : t.useSticky ? ud(A) : cd(A);
      } else {
        if (Ir(A)) return a = true, { exec: A };
        if (typeof A == "object") return a = true, A;
        if (typeof A == "string") {
          if (A.length === 1) return A;
          {
            const k = A.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"), G = new RegExp(k);
            return t.useSticky ? ud(G) : cd(G);
          }
        } else throw Error("non exhaustive match");
      }
    });
  ...
  r("misc mapping", () => {
    o = F(n, (I) => I.tokenTypeIdx), l = F(n, (I) => {
      ...
      if (A !== Xe.SKIPPED) {
        if (it(A)) return A;
        if (Er(A)) return false;
        throw Error("non exhaustive match");
      }
    }), c = F(n, (I) => {
      const A = I.LONGER_ALT;
      if (A) return ne(A) ? F(A, (G) => ym(n, G)) : [ym(n, A)];
    }), u = F(n, (I) => I.PUSH_MODE), d = F(n, (I) => U(I, "POP_MODE"));
  });
  let f;
  r("Line Terminator Handling", () => {
    const I = Sp(t.lineTerminatorCharacters);
    f = F(n, (A) => false), t.positionTracking !== "onlyOffset" && (f = F(n, (A) => U(A, "LINE_BREAKS") ? !!A.LINE_BREAKS : Cp(A, I) === false && tc(I, A.PATTERN)));
  });
  let h, y, v, C;
  r("Misc Mapping #2", () => {
    h = F(n, _p), y = F(s, rA), v = ht(n, (I, A) => {
      const k = A.GROUP;
      return it(k) && k !== Xe.SKIPPED && (I[k] = []), I;
    }, {}), C = F(s, (I, A) => ({ pattern: s[A], longerAlt: c[A], canLineTerminator: f[A], isCustom: h[A], short: y[A], group: l[A], push: u[A], pop: d[A], tokenTypeIdx: o[A], tokenType: n[A] }));
  });
  let b = true, w = [];
  return t.safeMode || r("First Char Optimization", () => {
    w = ht(n, (I, A, k) => {
      if (typeof A.PATTERN == "string") {
        const G = A.PATTERN.charCodeAt(0), H = _r(G);
        Ao(I, H, C[k]);
      } else if (ne(A.START_CHARS_HINT)) {
        let G;
        q(A.START_CHARS_HINT, (H) => {
          const X = typeof H == "string" ? H.charCodeAt(0) : H, le = _r(X);
          G !== le && (G = le, Ao(I, le, C[k]));
        });
      } else if (Ar(A.PATTERN)) if (A.PATTERN.unicode) b = false, t.ensureOptimizations && rl(`${nl}	Unable to analyze < ${A.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
      else {
        const G = L$(A.PATTERN, t.ensureOptimizations);
        he(G) && (b = false), q(G, (H) => {
          Ao(I, H, C[k]);
        });
      }
      else t.ensureOptimizations && rl(`${nl}	TokenType: <${A.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_OPTIMIZE`), b = false;
      return I;
    }, []);
  }), { emptyGroups: v, patternIdxToConfig: C, charCodeToPatternIdxToConfig: w, hasCustom: a, canBeOptimized: b };
}
i(x$, "analyzeTokenTypes");
function F$(e, t) {
  let r = [];
  const n = j$(e);
  r = r.concat(n.errors);
  const a = U$(n.valid), s = a.valid;
  return r = r.concat(a.errors), r = r.concat(G$(s)), r = r.concat(V$(s)), r = r.concat(H$(s, t)), r = r.concat(Y$(s)), r;
}
i(F$, "validatePatterns");
function G$(e) {
  let t = [];
  const r = wt(e, (n) => Ar(n[In]));
  return t = t.concat(z$(r)), t = t.concat(K$(r)), t = t.concat(q$(r)), t = t.concat(W$(r)), t = t.concat(B$(r)), t;
}
i(G$, "validateRegExpPattern");
function j$(e) {
  const t = wt(e, (a) => !U(a, In)), r = F(t, (a) => ({ message: "Token Type: ->" + a.name + "<- missing static 'PATTERN' property", type: Ie.MISSING_PATTERN, tokenTypes: [a] })), n = Zl(e, t);
  return { errors: r, valid: n };
}
i(j$, "findMissingPatterns");
function U$(e) {
  const t = wt(e, (a) => {
    const s = a[In];
    return !Ar(s) && !Ir(s) && !U(s, "exec") && !it(s);
  }), r = F(t, (a) => ({ message: "Token Type: ->" + a.name + "<- static 'PATTERN' can only be a RegExp, a Function matching the {CustomPatternMatcherFunc} type or an Object matching the {ICustomPattern} interface.", type: Ie.INVALID_PATTERN, tokenTypes: [a] })), n = Zl(e, t);
  return { errors: r, valid: n };
}
i(U$, "findInvalidPatterns");
var oL = /[^\\][$]/;
function z$(e) {
  const _t3 = class _t3 extends Ol {
    constructor() {
  ...
  i(_t3, "EndAnchorFinder");
  let t = _t3;
  const r = wt(e, (a) => {
    const s = a.PATTERN;
    try {
      const o = Gs(s), l = new t();
      return l.visit(o), l.found;
    } catch {
      return oL.test(s.source);
    }
  });
  return F(r, (a) => ({ message: `Unexpected RegExp Anchor Error:
	Token Type: ->` + a.name + `<- static 'PATTERN' cannot contain end of input anchor '$'
	See chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`, type: Ie.EOI_ANCHOR_FOUND, tokenTypes: [a] }));
}
i(z$, "findEndOfInputAnchor");
function B$(e) {
  const t = wt(e, (n) => n.PATTERN.test(""));
  return F(t, (n) => ({ message: "Token Type: ->" + n.name + "<- static 'PATTERN' must not match an empty string", type: Ie.EMPTY_MATCH_PATTERN, tokenTypes: [n] }));
}
i(B$, "findEmptyMatchRegExps");
var lL = /[^\\[][\^]|^\^/;
function K$(e) {
  const _t3 = class _t3 extends Ol {
    constructor() {
  ...
  const r = wt(e, (a) => {
    ...
    try {
      ...
      return lL.test(s.source);
    }
  });
  return F(r, (a) => ({ message: `Unexpected RegExp Anchor Error:
	Token Type: ->` + a.name + `<- static 'PATTERN' cannot contain start of input anchor '^'
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`, type: Ie.SOI_ANCHOR_FOUND, tokenTypes: [a] }));
}
i(K$, "findStartOfInputAnchor");
function q$(e) {
  const t = wt(e, (n) => {
    const a = n[In];
    return a instanceof RegExp && (a.multiline || a.global);
  });
  return F(t, (n) => ({ message: "Token Type: ->" + n.name + "<- static 'PATTERN' may NOT contain global('g') or multiline('m')", type: Ie.UNSUPPORTED_FLAGS_FOUND, tokenTypes: [n] }));
}
i(q$, "findUnsupportedFlags");
function W$(e) {
  const t = [];
  ...
  return F(n, (s) => {
    ...
    return { message: `The same RegExp pattern ->${jt(s).PATTERN}<-has been used in all of the following Token Types: ${o.join(", ")} <-`, type: Ie.DUPLICATE_PATTERNS_FOUND, tokenTypes: s };
  });
}
i(W$, "findDuplicatePatterns");
function V$(e) {
  const t = wt(e, (n) => {
    if (!U(n, "GROUP")) return false;
    const a = n.GROUP;
    return a !== Xe.SKIPPED && a !== Xe.NA && !it(a);
  });
  return F(t, (n) => ({ message: "Token Type: ->" + n.name + "<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String", type: Ie.INVALID_GROUP_TYPE_FOUND, tokenTypes: [n] }));
}
i(V$, "findInvalidGroupType");
function H$(e, t) {
  const r = wt(e, (a) => a.PUSH_MODE !== void 0 && !tt(t, a.PUSH_MODE));
  return F(r, (a) => ({ message: `Token Type: ->${a.name}<- static 'PUSH_MODE' value cannot refer to a Lexer Mode ->${a.PUSH_MODE}<-which does not exist`, type: Ie.PUSH_MODE_DOES_NOT_EXIST, tokenTypes: [a] }));
}
i(H$, "findModesThatDoNotExist");
function Y$(e) {
  const t = [], r = ht(e, (n, a, s) => {
    const o = a.PATTERN;
    return o === Xe.NA || (it(o) ? n.push({ str: o, idx: s, tokenType: a }) : Ar(o) && J$(o) && n.push({ str: o.source, idx: s, tokenType: a })), n;
  }, []);
  return q(e, (n, a) => {
    q(r, ({ str: s, idx: o, tokenType: l }) => {
      if (a < o && X$(s, n.PATTERN)) {
        const c = `Token: ->${l.name}<- can never be matched.
Because it appears AFTER the Token Type ->${n.name}<-in the lexer's definition.
See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`;
        t.push({ message: c, type: Ie.UNREACHABLE_PATTERN, tokenTypes: [n, l] });
      }
    });
  }), t;
}
i(Y$, "findUnreachablePatterns");
function X$(e, t) {
  if (Ar(t)) {
    if (Z$(t)) return false;
    const r = t.exec(e);
    ...
    if (Ir(t)) return t(e, 0, [], {});
    if (U(t, "exec")) return t.exec(e, 0, [], {});
    if (typeof t == "string") return t === e;
    throw Error("non exhaustive match");
  }
}
i(X$, "tryToMatchStrToPattern");
function J$(e) {
  return za([".", "\\", "[", "]", "|", "^", "$", "(", ")", "?", "*", "+", "{"], (r) => e.source.indexOf(r) !== -1) === void 0;
}
i(J$, "noMetaChar");
function Z$(e) {
  return /(\(\?=)|(\(\?!)|(\(\?<=)|(\(\?<!)/.test(e.source);
}
i(Z$, "usesLookAheadOrBehind");
function cd(e) {
  const t = e.ignoreCase ? "i" : "";
  return new RegExp(`^(?:${e.source})`, t);
}
i(cd, "addStartOfInput");
function ud(e) {
...
function Q$(e, t, r) {
  const n = [];
  return U(e, Ui) || n.push({ message: "A MultiMode Lexer cannot be initialized without a <" + Ui + `> property in its definition
...
`, type: Ie.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY }), U(e, Hs) && U(e, Ui) && !U(e.modes, e.defaultMode) && n.push({ message: `A MultiMode Lexer cannot be initialized with a ${Ui}: <${e.defaultMode}>which does not exist
`, type: Ie.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST }), U(e, Hs) && q(e.modes, (a, s) => {
    q(a, (o, l) => {
      if (Er(o)) n.push({ message: `A Lexer cannot be initialized using an undefined Token Type. Mode:<${s}> at index: <${l}>
`, type: Ie.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED });
      else if (U(o, "LONGER_ALT")) {
        const c = ne(o.LONGER_ALT) ? o.LONGER_ALT : [o.LONGER_ALT];
        q(c, (u) => {
          !Er(u) && !tt(a, u) && n.push({ message: `A MultiMode Lexer cannot be initialized with a longer_alt <${u.name}> on token <${o.name}> outside of mode <${s}>
...
i(Q$, "performRuntimeChecks");
function eA(e, t, r) {
  const n = [];
  let a = false;
  const s = Fs(xt(xe(e.modes))), o = Ql(s, (c) => c[In] === Xe.NA), l = Sp(r);
  return t && q(o, (c) => {
    const u = Cp(c, l);
    if (u !== false) {
      const f = { message: nA(c, u), type: u.issue, tokenType: c };
      n.push(f);
    } else U(c, "LINE_BREAKS") ? c.LINE_BREAKS === true && (a = true) : tc(l, c.PATTERN) && (a = true);
  }), t && !a && n.push({ message: `Warning: No LINE_BREAKS Found.
	This Lexer has been defined to track line and column information,
	But none of the Token Types can be identified as matching a line terminator.
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#LINE_BREAKS 
	for details.`, type: Ie.NO_LINE_BREAKS_FLAGS }), n;
}
i(eA, "performWarningRuntimeChecks");
function tA(e) {
  const t = {}, r = ft(e);
  return q(r, (n) => {
    const a = e[n];
...
i(tA, "cloneEmptyGroups");
function _p(e) {
  const t = e.PATTERN;
  if (Ar(t)) return false;
  if (Ir(t)) return true;
  if (U(t, "exec")) return true;
  if (it(t)) return false;
  throw Error("non exhaustive match");
}
i(_p, "isCustomPattern");
function rA(e) {
  return it(e) && e.length === 1 ? e.charCodeAt(0) : false;
}
i(rA, "isShortPattern");
var cL = { test: i(function(e) {
  const t = e.length;
...
function Cp(e, t) {
  if (U(e, "LINE_BREAKS")) return false;
  if (Ar(e.PATTERN)) {
    try {
      tc(t, e.PATTERN);
    } catch (r) {
      return { issue: Ie.IDENTIFY_TERMINATOR, errMsg: r.message };
    }
    return false;
  } else {
    if (it(e.PATTERN)) return false;
    if (_p(e)) return { issue: Ie.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
i(Cp, "checkLineBreaksIssues");
function nA(e, t) {
  if (t.issue === Ie.IDENTIFY_TERMINATOR) return `Warning: unable to identify line terminator usage in pattern.
	The problem is in the <${e.name}> Token Type
	 Root cause: ${t.errMsg}.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#IDENTIFY_TERMINATOR`;
  if (t.issue === Ie.CUSTOM_LINE_BREAK) return `Warning: A Custom Token Pattern should specify the <line_breaks> option.
	The problem is in the <${e.name}> Token Type
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_LINE_BREAK`;
  throw Error("non exhaustive match");
}
i(nA, "buildLineBreakIssueMessage");
function Sp(e) {
...
i(Ao, "addToMapOfArrays");
var zi = 256, Eo = [];
function _r(e) {
  return e < zi ? e : Eo[e];
}
i(_r, "charCodeToOptimizedIndex");
function aA() {
  if (he(Eo)) {
    Eo = new Array(65536);
    for (let e = 0; e < 65536; e++) Eo[e] = e > 255 ? 255 + ~~(e / 255) : e;
  }
}
i(aA, "initCharCodeToOptimizedIndexMap");
function Ja(e, t) {
  const r = e.tokenTypeIdx;
  return r === t.tokenTypeIdx ? true : t.isParent === true && t.categoryMatchesMap[r] === true;
}
i(Ja, "tokenStructuredMatcher");
function ms(e, t) {
  return e.tokenTypeIdx === t.tokenTypeIdx;
}
i(ms, "tokenStructuredMatcherNoCategories");
var Tm = 1, iA = {};
function Za(e) {
  const t = sA(e);
  oA(t), cA(t), lA(t), q(t, (r) => {
    r.isParent = r.categoryMatches.length > 0;
  });
}
i(Za, "augmentTokenTypes");
function sA(e) {
  let t = Ke(e), r = e, n = true;
  for (; n; ) {
    r = Fs(xt(F(r, (s) => s.CATEGORIES)));
    const a = Zl(r, t);
    t = t.concat(a), he(a) ? n = false : r = a;
  }
  return t;
}
i(sA, "expandCategories");
function oA(e) {
  q(e, (t) => {
    wp(t) || (iA[Tm] = t, t.tokenTypeIdx = Tm++), dd(t) && !ne(t.CATEGORIES) && (t.CATEGORIES = [t.CATEGORIES]), dd(t) || (t.CATEGORIES = []), uA(t) || (t.categoryMatches = []), dA(t) || (t.categoryMatchesMap = {});
  });
}
i(oA, "assignTokenDefaultProps");
function lA(e) {
  q(e, (t) => {
    t.categoryMatches = [], q(t.categoryMatchesMap, (r, n) => {
      t.categoryMatches.push(iA[n].tokenTypeIdx);
    });
  });
}
i(lA, "assignCategoriesTokensProp");
function cA(e) {
  q(e, (t) => {
    bp([], t);
  });
}
i(cA, "assignCategoriesMapProp");
function bp(e, t) {
  q(e, (r) => {
...
i(wp, "hasShortKeyProperty");
function dd(e) {
  return U(e, "CATEGORIES");
}
i(dd, "hasCategoriesProperty");
function uA(e) {
  return U(e, "categoryMatches");
}
i(uA, "hasExtendingTokensTypesProperty");
function dA(e) {
  return U(e, "categoryMatchesMap");
}
i(dA, "hasExtendingTokensTypesMapProperty");
function fA(e) {
  return U(e, "tokenTypeIdx");
}
i(fA, "isTokenType");
var fd = { buildUnableToPopLexerModeMessage(e) {
...
var Bi = { deferDefinitionErrorsHandling: false, positionTracking: "full", lineTerminatorsPattern: /\n|\r\n?/g, lineTerminatorCharacters: [`
`, "\r"], ensureOptimizations: false, safeMode: false, errorMessageProvider: fd, traceInitPerf: false, skipValidations: false, recoveryEnabled: true };
Object.freeze(Bi);
var Xe = (_x2 = class {
  constructor(e, t = Bi) {
    if (this.lexerDefinition = e, this.lexerDefinitionErrors = [], this.lexerDefinitionWarning = [], this.patternIdxToConfig = {}, this.charCodeToPatternIdxToConfig = {}, this.modes = [], this.emptyGroups = {}, this.trackStartLines = true, this.trackEndLines = true, this.hasCustom = false, this.canModeBeOptimized = {}, this.TRACE_INIT = (n, a) => {
      if (this.traceInitPerf === true) {
        this.traceInitIndent++;
        const s = new Array(this.traceInitIndent + 1).join("	");
        this.traceInitIndent < this.traceInitMaxIdent && console.log(`${s}--> <${n}>`);
        const { time: o, value: l } = Ap(a), c = o > 10 ? console.warn : console.log;
...
a boolean 2nd argument is no longer supported`);
    ...
    r === true ? (this.traceInitMaxIdent = 1 / 0, this.traceInitPerf = true) : typeof r == "number" && (this.traceInitMaxIdent = r, this.traceInitPerf = true), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", () => {
      ...
      this.TRACE_INIT("Lexer Config handling", () => {
        if (this.config.lineTerminatorsPattern === Bi.lineTerminatorsPattern) this.config.lineTerminatorsPattern = cL;
        else if (this.config.lineTerminatorCharacters === Bi.lineTerminatorCharacters) throw Error(`Error: Missing <lineTerminatorCharacters> property on the Lexer config.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        ...
        this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking), this.trackEndLines = /full/i.test(this.config.positionTracking), ne(e) ? n = { modes: { defaultMode: Ke(e) }, defaultMode: Ui } : (a = false, n = Ke(e));
      }), this.config.skipValidations === false && (this.TRACE_INIT("performRuntimeChecks", () => {
        this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Q$(n, this.trackStartLines, this.config.lineTerminatorCharacters));
      }), this.TRACE_INIT("performWarningRuntimeChecks", () => {
        this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(eA(n, this.trackStartLines, this.config.lineTerminatorCharacters));
      })), n.modes = n.modes ? n.modes : {}, q(n.modes, (o, l) => {
        n.modes[l] = Ql(o, (c) => Er(c));
      });
      const s = ft(n.modes);
      if (q(n.modes, (o, l) => {
        this.TRACE_INIT(`Mode: <${l}> processing`, () => {
          if (this.modes.push(l), this.config.skipValidations === false && this.TRACE_INIT("validatePatterns", () => {
            this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(F$(o, s));
          }), he(this.lexerDefinitionErrors)) {
            Za(o);
            let c;
            this.TRACE_INIT("analyzeTokenTypes", () => {
              c = x$(o, { lineTerminatorCharacters: this.config.lineTerminatorCharacters, positionTracking: t.positionTracking, ensureOptimizations: t.ensureOptimizations, safeMode: t.safeMode, tracer: this.TRACE_INIT });
...
` + l);
      ...
      q(this.lexerDefinitionWarning, (o) => {
        ...
        if (M$ ? (this.chopInput = ja, this.match = this.matchWithTest) : (this.updateLastIndex = Me, this.match = this.matchWithExec), a && (this.handleModes = Me), this.trackStartLines === false && (this.computeNewColumn = ja), this.trackEndLines === false && (this.updateTokenEndLineColumnLocation = Me), /full/i.test(this.config.positionTracking)) this.createTokenInstance = this.createFullToken;
        ...
        const o = ht(this.canModeBeOptimized, (l, c, u) => (c === false && l.push(u), l), []);
        if (t.ensureOptimizations && !he(o)) throw Error(`Lexer Modes: < ${o.join(", ")} > cannot be optimized.
...
` + n);
  ...
  tokenizeInternal(e, t) {
    let r, n, a, s, o, l, c, u, d, f, h, y, v, C, b;
    ...
    const Ne = tA(this.emptyGroups), P = this.trackStartLines, _ = this.config.lineTerminatorsPattern;
    let g = 0, E = [], T = [];
    const R = [], S = [];
    Object.freeze(S);
    let O;
    ...
    function D(te) {
      const de = _r(te), ct = T[de];
      return ct === void 0 ? S : ct;
    }
    i(D, "getPossiblePatternsOptimized");
    const z = i((te) => {
      if (R.length === 1 && te.tokenType.PUSH_MODE === void 0) {
        const de = this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(te);
        X.push({ offset: te.startOffset, line: te.startLine, column: te.startColumn, length: te.image.length, message: de });
      } else {
        R.pop();
        const de = wn(R);
        E = this.patternIdxToConfig[de], T = this.charCodeToPatternIdxToConfig[de], g = E.length;
        const ct = this.canModeBeOptimized[de] && this.config.safeMode === false;
        T && ct ? O = D : O = M;
      }
    }, "pop_mode");
    function B(te) {
      R.push(te), T = this.charCodeToPatternIdxToConfig[te], E = this.patternIdxToConfig[te], g = E.length, g = E.length;
      const de = this.canModeBeOptimized[te] && this.config.safeMode === false;
      T && de ? O = D : O = M;
    }
    ...
    for (; A < I; ) {
      l = null;
      const te = w.charCodeAt(A), de = O(te), ct = de.length;
      for (r = 0; r < ct; r++) {
        Z = de[r];
        const Re = Z.pattern;
        c = null;
        const Oe = Z.short;
        if (Oe !== false ? te === Oe && (l = Re) : Z.isCustom === true ? (b = Re.exec(w, A, H, Ne), b !== null ? (l = b[0], b.payload !== void 0 && (c = b.payload)) : l = null) : (this.updateLastIndex(Re, A), l = this.match(Re, e, A)), l !== null) {
          if (o = Z.longerAlt, o !== void 0) {
            const qe = o.length;
            for (a = 0; a < qe; a++) {
              const Se = E[o[a]], Q = Se.pattern;
              if (u = null, Se.isCustom === true ? (b = Q.exec(w, A, H, Ne), b !== null ? (s = b[0], b.payload !== void 0 && (u = b.payload)) : s = null) : (this.updateLastIndex(Q, A), s = this.match(Q, e, A)), s && s.length > l.length) {
                l = s, c = u, Z = Se;
                break;
              }
            }
      ...
      if (l !== null) {
        if (d = l.length, f = Z.group, f !== void 0 && (h = Z.tokenTypeIdx, y = this.createTokenInstance(l, A, h, Z.tokenType, le, ce, d), this.handlePayload(y, c), f === false ? k = this.addToken(H, k, y) : Ne[f].push(y)), e = this.chopInput(e, d), A = A + d, ce = this.computeNewColumn(ce, d), P === true && Z.canLineTerminator === true) {
          let Re = 0, Oe, qe;
          _.lastIndex = 0;
          do
            Oe = _.test(l), Oe === true && (qe = _.lastIndex - 1, Re++);
          while (Oe === true);
          Re !== 0 && (le = le + Re, ce = d - qe, this.updateTokenEndLineColumnLocation(y, f, qe, Re, le, ce, d));
        }
        this.handleModes(Z, z, B, y);
      } else {
        const Re = A, Oe = le, qe = ce;
        let Se = J === false;
        for (; Se === false && A < I; ) for (e = this.chopInput(e, 1), A++, n = 0; n < g; n++) {
          const Q = E[n], rt = Q.pattern, me = Q.short;
          if (me !== false ? w.charCodeAt(A) === me && (Se = true) : Q.isCustom === true ? Se = rt.exec(w, A, H, Ne) !== null : (this.updateLastIndex(rt, A), Se = rt.exec(e) !== null), Se === true) break;
        }
        if (v = A - Re, ce = this.computeNewColumn(ce, v), C = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(w, Re, v, Oe, qe, wn(R)), X.push({ offset: Re, line: Oe, column: qe, length: v, message: C }), J === false) break;
      }
    }
    return this.hasCustom || (H.length = k), { tokens: H, groups: Ne, errors: X };
  }
  handleModes(e, t, r, n) {
    if (e.pop === true) {
      const a = e.push;
  ...
  updateTokenEndLineColumnLocation(e, t, r, n, a, s, o) {
    let l, c;
    t !== void 0 && (l = r === o - 1, c = l ? -1 : 0, n === 1 && l === true || (e.endLine = a + c, e.endColumn = s - 1 + -c));
  }
  ...
  createStartOnlyToken(e, t, r, n, a, s) {
    return { image: e, startOffset: t, startLine: a, startColumn: s, tokenTypeIdx: r, tokenType: n };
  }
  createFullToken(e, t, r, n, a, s, o) {
    return { image: e, startOffset: t, endOffset: t + o - 1, startLine: a, endLine: a, startColumn: s, endColumn: s + o - 1, tokenTypeIdx: r, tokenType: n };
  }
...
i(Ip, "hasTokenLabel");
var uL = "parent", Rm = "categories", $m = "label", Am = "group", Em = "push_mode", _m = "pop_mode", Cm = "longer_alt", Sm = "line_breaks", bm = "start_chars_hint";
function ka(e) {
  return pA(e);
}
i(ka, "createToken");
function pA(e) {
  const t = e.pattern, r = {};
  if (r.name = e.name, Er(t) || (r.PATTERN = t), U(e, uL)) throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return U(e, Rm) && (r.CATEGORIES = e[Rm]), Za([r]), U(e, $m) && (r.LABEL = e[$m]), U(e, Am) && (r.GROUP = e[Am]), U(e, _m) && (r.POP_MODE = e[_m]), U(e, Em) && (r.PUSH_MODE = e[Em]), U(e, Cm) && (r.LONGER_ALT = e[Cm]), U(e, Sm) && (r.LINE_BREAKS = e[Sm]), U(e, bm) && (r.START_CHARS_HINT = e[bm]), r;
}
i(pA, "createTokenInternal");
var Ur = ka({ name: "EOF", pattern: Xe.NA });
Za([Ur]);
function js(e, t, r, n, a, s, o, l) {
  return { image: t, startOffset: r, endOffset: n, startLine: a, endLine: s, startColumn: o, endColumn: l, tokenTypeIdx: e.tokenTypeIdx, tokenType: e };
}
i(js, "createTokenInstance");
function Np(e, t) {
  return Ja(e, t);
}
i(Np, "tokenMatcher");
var wa = { buildMismatchTokenMessage({ expected: e, actual: t, previous: r, ruleName: n }) {
  return `Expecting ${Ip(e) ? `--> ${Cn(e)} <--` : `token of type --> ${e.name} <--`} but found --> '${t.image}' <--`;
...
but found: '` + jt(t).image + "'";
  if (n) return s + n + l;
  {
    const c = ht(e, (h, y) => h.concat(y), []), u = F(c, (h) => `[${F(h, (y) => Cn(y)).join(", ")}]`), f = `one of these possible Token sequences:
${F(u, (h, y) => `  ${y + 1}. ${h}`).join(`
`)}`;
    return s + f + l;
  }
...
but found: '` + jt(t).image + "'";
  ...
  <${F(e, (u) => `[${F(u, (d) => Cn(d)).join(",")}]`).join(" ,")}>`;
    return a + c + o;
  }
} };
Object.freeze(wa);
var dL = { buildRuleNotFoundError(e, t) {
  return "Invalid grammar, reference to a rule which is not defined: ->" + t.nonTerminalName + `<-
inside top level rule: ->` + e.name + "<-";
} }, An = { buildDuplicateFoundError(e, t) {
  function r(d) {
    return d instanceof Te ? d.terminalType.name : d instanceof Ze ? d.nonTerminalName : "";
  }
...
and Non-Terminal names start with a lower case letter.`;
  ...
  const t = F(e.prefixPath, (a) => Cn(a)).join(", "), r = e.alternation.idx === 0 ? "" : e.alternation.idx;
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
  ...
  let t;
  return e.topLevelRule instanceof Ha ? t = e.topLevelRule.name : t = e.topLevelRule, `Duplicate definition, rule: ->${t}<- is already defined in the grammar: ->${e.grammarName}<-`;
} };
function hA(e, t) {
  const r = new fL(e, t);
...
var fL = (_y2 = class extends Ya {
  ...
  visitNonTerminal(e) {
    ...
    if (t) e.referencedRule = t;
      ...
      this.errors.push({ message: r, type: Qe.UNRESOLVED_SUBRULE_REF, ruleName: this.currTopLevel.name, unresolvedRefName: e.nonTerminalName });
    }
  }
}, i(_y2, "GastRefResolverVisitor"), _y2), pL = (_z = class extends ec {
  constructor(e, t) {
  ...
  updateExpectedNext() {
    he(this.ruleStack) ? (this.nextProductionName = "", this.nextProductionOccurrence = 0, this.isAtEndOfPath = true) : (this.nextProductionName = this.ruleStack.pop(), this.nextProductionOccurrence = this.occurrenceStack.pop());
  }
}, i(_z, "AbstractNextPossibleTokensWalker"), _z), hL = (_A2 = class extends pL {
  constructor(e, t) {
  ...
  walkTerminal(e, t, r) {
    if (this.isAtEndOfPath && e.terminalType.name === this.nextTerminalName && e.idx === this.nextTerminalOccurrence && !this.found) {
      ...
      this.possibleTokTypes = Xa(a), this.found = true;
    }
  }
}, i(_A2, "NextAfterTokenWalker"), _A2), rc = (_B = class extends ec {
  constructor(e, t) {
...
}, i(_B, "AbstractNextTerminalAfterProductionWalker"), _B), mL = (_C2 = class extends rc {
  walkMany(e, t, r) {
...
}, i(_C2, "NextTerminalAfterManyWalker"), _C2), wm = (_D2 = class extends rc {
  walkManySep(e, t, r) {
    if (e.idx === this.occurrence) {
      const n = jt(t.concat(r));
      this.result.isEndOfRule = n === void 0, n instanceof Te && (this.result.token = n.terminalType, this.result.occurrence = n.idx);
...
}, i(_D2, "NextTerminalAfterManySepWalker"), _D2), gL = (_E2 = class extends rc {
  walkAtLeastOne(e, t, r) {
    if (e.idx === this.occurrence) {
      const n = jt(t.concat(r));
      this.result.isEndOfRule = n === void 0, n instanceof Te && (this.result.token = n.terminalType, this.result.occurrence = n.idx);
...
}, i(_E2, "NextTerminalAfterAtLeastOneWalker"), _E2), Im = (_F2 = class extends rc {
  walkAtLeastOneSep(e, t, r) {
    if (e.idx === this.occurrence) {
      const n = jt(t.concat(r));
      this.result.isEndOfRule = n === void 0, n instanceof Te && (this.result.token = n.terminalType, this.result.occurrence = n.idx);
...
}, i(_F2, "NextTerminalAfterAtLeastOneSepWalker"), _F2);
function sl(e, t, r = []) {
  r = Ke(r);
  let n = [], a = 0;
  function s(l) {
  ...
  for (i(o, "getAlternativesForProd"); r.length < t && a < e.length; ) {
    const l = e[a];
    if (l instanceof st) return o(l.definition);
    if (l instanceof Ze) return o(l.definition);
    if (l instanceof Be) n = o(l.definition);
    else if (l instanceof mt) {
      const c = l.definition.concat([new we({ definition: l.definition })]);
      return o(c);
    } else if (l instanceof gt) {
      const c = [new st({ definition: l.definition }), new we({ definition: [new Te({ terminalType: l.separator })].concat(l.definition) })];
      return o(c);
    } else if (l instanceof ot) {
      const c = l.definition.concat([new we({ definition: [new Te({ terminalType: l.separator })].concat(l.definition) })]);
      n = o(c);
    } else if (l instanceof we) {
      const c = l.definition.concat([new we({ definition: l.definition })]);
      n = o(c);
    } else {
      if (l instanceof lt) return q(l.definition, (c) => {
        he(c.definition) === false && (n = o(c.definition));
      }), n;
      if (l instanceof Te) r.push(l.terminalType);
      else throw Error("non exhaustive match");
    }
    a++;
  }
  return n.push({ partialPath: r, suffixDef: ze(e, a) }), n;
}
i(sl, "possiblePathsFrom");
function kp(e, t, r, n) {
  const a = "EXIT_NONE_TERMINAL", s = [a], o = "EXIT_ALTERNATIVE";
  let l = false;
  const c = t.length, u = c - n - 1, d = [], f = [];
  for (f.push({ idx: -1, def: e, ruleStack: [], occurrenceStack: [] }); !he(f); ) {
    const h = f.pop();
    if (h === o) {
      l && wn(f).idx <= u && f.pop();
      continue;
    }
    const y = h.def, v = h.idx, C = h.ruleStack, b = h.occurrenceStack;
    if (he(y)) continue;
    const w = y[0];
    if (w === a) {
      const I = { idx: v, def: ze(y), ruleStack: ps(C), occurrenceStack: ps(b) };
      f.push(I);
    } else if (w instanceof Te) if (v < c - 1) {
      const I = v + 1, A = t[I];
      if (r(A, w.terminalType)) {
        const k = { idx: I, def: ze(y), ruleStack: C, occurrenceStack: b };
        f.push(k);
      }
    } else if (v === c - 1) d.push({ nextTokenType: w.terminalType, nextTokenOccurrence: w.idx, ruleStack: C, occurrenceStack: b }), l = true;
    else throw Error("non exhaustive match");
      ...
      const A = Ke(b);
      A.push(w.idx);
      const k = { idx: v, def: w.definition.concat(s, ze(y)), ruleStack: I, occurrenceStack: A };
      f.push(k);
    } else if (w instanceof Be) {
      const I = { idx: v, def: ze(y), ruleStack: C, occurrenceStack: b };
      f.push(I), f.push(o);
      const A = { idx: v, def: w.definition.concat(ze(y)), ruleStack: C, occurrenceStack: b };
      f.push(A);
    } else if (w instanceof mt) {
      const I = new we({ definition: w.definition, idx: w.idx }), A = w.definition.concat([I], ze(y)), k = { idx: v, def: A, ruleStack: C, occurrenceStack: b };
      f.push(k);
    } else if (w instanceof gt) {
      const I = new Te({ terminalType: w.separator }), A = new we({ definition: [I].concat(w.definition), idx: w.idx }), k = w.definition.concat([A], ze(y)), G = { idx: v, def: k, ruleStack: C, occurrenceStack: b };
      f.push(G);
    } else if (w instanceof ot) {
      const I = { idx: v, def: ze(y), ruleStack: C, occurrenceStack: b };
      f.push(I), f.push(o);
      const A = new Te({ terminalType: w.separator }), k = new we({ definition: [A].concat(w.definition), idx: w.idx }), G = w.definition.concat([k], ze(y)), H = { idx: v, def: G, ruleStack: C, occurrenceStack: b };
      f.push(H);
    } else if (w instanceof we) {
      const I = { idx: v, def: ze(y), ruleStack: C, occurrenceStack: b };
      f.push(I), f.push(o);
      const A = new we({ definition: w.definition, idx: w.idx }), k = w.definition.concat([A], ze(y)), G = { idx: v, def: k, ruleStack: C, occurrenceStack: b };
      f.push(G);
    } else if (w instanceof lt) for (let I = w.definition.length - 1; I >= 0; I--) {
      const A = w.definition[I], k = { idx: v, def: A.definition.concat(ze(y)), ruleStack: C, occurrenceStack: b };
      f.push(k), f.push(o);
    }
    else if (w instanceof st) f.push({ idx: v, def: w.definition.concat(ze(y)), ruleStack: C, occurrenceStack: b });
    else if (w instanceof Ha) f.push(mA(w, v, C, b));
    else throw Error("non exhaustive match");
  }
  return d;
}
i(kp, "nextPossibleTokensAfter");
function mA(e, t, r, n) {
  const a = Ke(r);
  a.push(e.name);
  const s = Ke(n);
  return s.push(1), { idx: t, def: e.definition, ruleStack: a, occurrenceStack: s };
}
i(mA, "expandTopLevelRule");
var _e;
(function(e) {
...
function nc(e) {
  if (e instanceof Be || e === "Option") return _e.OPTION;
  if (e instanceof we || e === "Repetition") return _e.REPETITION;
  if (e instanceof mt || e === "RepetitionMandatory") return _e.REPETITION_MANDATORY;
  if (e instanceof gt || e === "RepetitionMandatoryWithSeparator") return _e.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (e instanceof ot || e === "RepetitionWithSeparator") return _e.REPETITION_WITH_SEPARATOR;
  if (e instanceof lt || e === "Alternation") return _e.ALTERNATION;
  throw Error("non exhaustive match");
}
i(nc, "getProdType");
function pd(e) {
  const { occurrence: t, rule: r, prodType: n, maxLookahead: a } = e, s = nc(n);
  return s === _e.ALTERNATION ? Us(t, r, a) : zs(t, r, s, a);
}
i(pd, "getLookaheadPaths");
function gA(e, t, r, n, a, s) {
  const o = Us(e, t, r), l = Op(o) ? ms : Ja;
  return s(o, n, l, a);
}
i(gA, "buildLookaheadFuncForOr");
function yA(e, t, r, n, a, s) {
  const o = zs(e, t, a, r), l = Op(o) ? ms : Ja;
  return s(o[0], l, n);
}
i(yA, "buildLookaheadFuncForOptionalProd");
function vA(e, t, r, n) {
  const a = e.length, s = Ft(e, (o) => Ft(o, (l) => l.length === 1));
  if (t) return function(o) {
    const l = F(o, (c) => c.GATE);
    for (let c = 0; c < a; c++) {
      const u = e[c], d = u.length, f = l[c];
      if (!(f !== void 0 && f.call(this) === false)) e: for (let h = 0; h < d; h++) {
        const y = u[h], v = y.length;
        for (let C = 0; C < v; C++) {
          const b = this.LA(C + 1);
          if (r(b, y[C]) === false) continue e;
        }
        return c;
      }
    }
  ...
  if (s && !n) {
    const o = F(e, (c) => xt(c)), l = ht(o, (c, u, d) => (q(u, (f) => {
      U(c, f.tokenTypeIdx) || (c[f.tokenTypeIdx] = d), q(f.categoryMatches, (h) => {
        U(c, h) || (c[h] = d);
      });
    }), c), {});
    return function() {
    ...
    for (let o = 0; o < a; o++) {
      ...
      e: for (let u = 0; u < c; u++) {
        const d = l[u], f = d.length;
        for (let h = 0; h < f; h++) {
          const y = this.LA(h + 1);
          if (r(y, d[h]) === false) continue e;
        }
        return o;
      }
    }
...
i(vA, "buildAlternativesLookAheadFunc");
function TA(e, t, r) {
  ...
  if (n && !r) {
    ...
    if (s.length === 1 && he(s[0].categoryMatches)) {
      ...
      const o = ht(s, (l, c, u) => (l[c.tokenTypeIdx] = true, q(c.categoryMatches, (d) => {
        l[d] = true;
      }), l), []);
      return function() {
        const l = this.LA(1);
...
i(TA, "buildSingleAlternativeLookaheadFunction");
var yL = (_G2 = class extends ec {
  constructor(e, t, r) {
...
}, i(_G2, "RestDefinitionFinderWalker"), _G2), RA = (_H = class extends Ya {
  constructor(e, t, r) {
...
}, i(_H, "InsideDefinitionFinderVisitor"), _H);
function hd(e) {
  const t = new Array(e);
  for (let r = 0; r < e; r++) t[r] = [];
  return t;
}
i(hd, "initializeArrayOfArrays");
function _o(e) {
  let t = [""];
...
function $A(e, t, r) {
  for (let n = 0; n < e.length; n++) {
    ...
    for (let s = 0; s < t.length; s++) {
      const o = t[s];
      if (a[o] === true) return false;
    }
  }
  return true;
}
i($A, "isUniquePrefixHash");
function Pp(e, t) {
  const r = F(e, (o) => sl([o], 1)), n = hd(r.length), a = F(r, (o) => {
    const l = {};
    return q(o, (c) => {
      const u = _o(c.partialPath);
      q(u, (d) => {
        l[d] = true;
      });
    }), l;
  ...
  for (let o = 1; o <= t; o++) {
    ...
    for (let c = 0; c < l.length; c++) {
      ...
      for (let d = 0; d < u.length; d++) {
        const f = u[d].partialPath, h = u[d].suffixDef, y = _o(f);
        if ($A(a, y, c) || he(h) || f.length === t) {
          const C = n[c];
          if (ol(C, f) === false) {
            C.push(f);
          ...
          const C = sl(h, o + 1, f);
          s[c] = s[c].concat(C), q(C, (b) => {
            const w = _o(b.partialPath);
            q(w, (I) => {
              a[c][I] = true;
            });
          });
...
i(Pp, "lookAheadSequenceFromAlternatives");
function Us(e, t, r, n) {
  const a = new RA(e, _e.ALTERNATION, n);
  return t.accept(a), Pp(a.result, r);
}
i(Us, "getLookaheadPathsForOr");
function zs(e, t, r, n) {
  const a = new RA(e, r);
  t.accept(a);
  const s = a.result, l = new yL(t, e, r).startWalking(), c = new st({ definition: s }), u = new st({ definition: l });
  return Pp([c, u], n);
}
i(zs, "getLookaheadPathsForOptionalProd");
function ol(e, t) {
...
i(AA, "isStrictPrefixOfPath");
function Op(e) {
  return Ft(e, (t) => Ft(t, (r) => Ft(r, (n) => he(n.categoryMatches))));
}
i(Op, "areTokenCategoriesNotUsed");
function EA(e) {
...
i(EA, "validateLookahead");
function _A(e, t, r, n) {
  const a = _t(e, (c) => CA(c, r)), s = DA(e, t, r), o = _t(e, (c) => kA(c, r)), l = _t(e, (c) => bA(c, e, n, r));
  return a.concat(s, o, l);
}
i(_A, "validateGrammar");
function CA(e, t) {
  const r = new vL();
  e.accept(r);
  const n = r.allProductions, a = PO(n, SA), s = Ut(a, (l) => l.length > 1);
  return F(xe(s), (l) => {
    const c = jt(l), u = t.buildDuplicateFoundError(e, l), d = Ot(c), f = { message: u, type: Qe.DUPLICATE_PRODUCTIONS, ruleName: e.name, dslName: d, occurrence: c.idx }, h = Lp(c);
    return h && (f.parameter = h), f;
  });
}
i(CA, "validateDuplicateProductions");
function SA(e) {
  return `${Ot(e)}_#_${e.idx}_#_${Lp(e)}`;
}
i(SA, "identifyProductionForDuplicates");
function Lp(e) {
  return e instanceof Te ? e.terminalType.name : e instanceof Ze ? e.nonTerminalName : "";
}
i(Lp, "getExtraProductionArgument");
var vL = (_I2 = class extends Ya {
  constructor() {
...
}, i(_I2, "OccurrenceValidationCollector"), _I2);
function bA(e, t, r, n) {
  const a = [];
  if (ht(t, (o, l) => l.name === e.name ? o + 1 : o, 0) > 1) {
    const o = n.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: r });
    a.push({ message: o, type: Qe.DUPLICATE_RULE_NAME, ruleName: e.name });
  }
  return a;
}
...
function wA(e, t, r) {
  const n = [];
  let a;
  return tt(t, e) || (a = `Invalid rule override, rule: ->${e}<- cannot be overridden in the grammar: ->${r}<-as it is not defined in any of the super grammars `, n.push({ message: a, type: Qe.INVALID_RULE_OVERRIDE, ruleName: e })), n;
}
i(wA, "validateRuleIsOverridden");
function Dp(e, t, r, n = []) {
  const a = [], s = ns(t.definition);
  if (he(s)) return [];
  {
    const o = e.name;
    tt(s, e) && a.push({ message: r.buildLeftRecursionError({ topLevelRule: e, leftRecursionPath: n }), type: Qe.LEFT_RECURSION, ruleName: o });
    const c = Zl(s, n.concat([e])), u = _t(c, (d) => {
      const f = Ke(n);
      return f.push(d), Dp(e, d, r, f);
    });
    return a.concat(u);
  }
}
i(Dp, "validateNoLeftRecursion");
function ns(e) {
  let t = [];
  if (he(e)) return t;
  const r = jt(e);
  if (r instanceof Ze) t.push(r.referencedRule);
  else if (r instanceof st || r instanceof Be || r instanceof mt || r instanceof gt || r instanceof ot || r instanceof we) t = t.concat(ns(r.definition));
  else if (r instanceof lt) t = xt(F(r.definition, (s) => ns(s.definition)));
  else if (!(r instanceof Te)) throw Error("non exhaustive match");
  const n = hs(r), a = e.length > 1;
  if (n && a) {
    const s = ze(e);
    return t.concat(ns(s));
  } else return t;
}
i(ns, "getFirstNoneTerminal");
var Mp = (_J = class extends Ya {
  constructor() {
...
function IA(e, t) {
  ...
  return _t(n, (s) => {
    const o = ps(s.definition);
    return _t(o, (l, c) => {
      const u = kp([l], [], Ja, 1);
      return he(u) ? [{ message: t.buildEmptyAlternationError({ topLevelRule: e, alternation: s, emptyChoiceIdx: c }), type: Qe.NONE_LAST_EMPTY_ALT, ruleName: e.name, occurrence: s.idx, alternative: c + 1 }] : [];
    });
  });
}
i(IA, "validateEmptyOrAlternative");
function NA(e, t, r) {
  const n = new Mp();
  e.accept(n);
  let a = n.alternations;
  return a = Ql(a, (o) => o.ignoreAmbiguities === true), _t(a, (o) => {
    const l = o.idx, c = o.maxLookahead || t, u = Us(l, e, c, o), d = OA(u, o, e, r), f = LA(u, o, e, r);
    return d.concat(f);
  });
}
i(NA, "validateAmbiguousAlternationAlternatives");
var TL = (_K = class extends Ya {
  constructor() {
    super(...arguments), this.allProductions = [];
  }
  visitRepetitionWithSeparator(e) {
...
}, i(_K, "RepetitionCollector"), _K);
function kA(e, t) {
  const r = new Mp();
  e.accept(r);
  const n = r.alternations;
  return _t(n, (s) => s.definition.length > 255 ? [{ message: t.buildTooManyAlternativesError({ topLevelRule: e, alternation: s }), type: Qe.TOO_MANY_ALTS, ruleName: e.name, occurrence: s.idx }] : []);
}
i(kA, "validateTooManyAlts");
function PA(e, t, r) {
  const n = [];
  return q(e, (a) => {
    const s = new TL();
    ...
    q(o, (l) => {
      const c = nc(l), u = l.maxLookahead || t, d = l.idx, h = zs(d, a, c, u)[0];
      if (he(xt(h))) {
        const y = r.buildEmptyRepetitionError({ topLevelRule: a, repetition: l });
        n.push({ message: y, type: Qe.NO_NON_EMPTY_LOOKAHEAD, ruleName: a.name });
      }
    });
  }), n;
}
i(PA, "validateSomeNonEmptyLookaheadPath");
function OA(e, t, r, n) {
  const a = [], s = ht(e, (l, c, u) => (t.definition[u].ignoreAmbiguities === true || q(c, (d) => {
    const f = [u];
    q(e, (h, y) => {
      u !== y && ol(h, d) && t.definition[y].ignoreAmbiguities !== true && f.push(y);
    }), f.length > 1 && !ol(a, d) && (a.push(d), l.push({ alts: f, path: d }));
  }), l), []);
  return F(s, (l) => {
    const c = F(l.alts, (d) => d + 1);
    return { message: n.buildAlternationAmbiguityError({ topLevelRule: r, alternation: t, ambiguityIndices: c, prefixPath: l.path }), type: Qe.AMBIGUOUS_ALTS, ruleName: r.name, occurrence: t.idx, alternatives: l.alts };
  });
}
i(OA, "checkAlternativesAmbiguities");
function LA(e, t, r, n) {
  const a = ht(e, (o, l, c) => {
    const u = F(l, (d) => ({ idx: c, path: d }));
    return o.concat(u);
  }, []);
  return Fs(_t(a, (o) => {
    if (t.definition[o.idx].ignoreAmbiguities === true) return [];
    const c = o.idx, u = o.path, d = wt(a, (h) => t.definition[h.idx].ignoreAmbiguities !== true && h.idx < c && AA(h.path, u));
    return F(d, (h) => {
      const y = [h.idx + 1, c + 1], v = t.idx === 0 ? "" : t.idx;
      return { message: n.buildAlternationPrefixAmbiguityError({ topLevelRule: r, alternation: t, ambiguityIndices: y, prefixPath: h.path }), type: Qe.AMBIGUOUS_PREFIX_ALTS, ruleName: r.name, occurrence: v, alternatives: y };
    });
  }));
}
i(LA, "checkPrefixAlternativesAmbiguities");
function DA(e, t, r) {
  ...
  return q(e, (s) => {
    ...
    if (tt(a, o)) {
      ...
      n.push({ message: l, type: Qe.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: o });
    }
  }), n;
}
i(DA, "checkTerminalAndNoneTerminalsNameSpace");
function MA(e) {
  const t = Tp(e, { errMsgProvider: dL }), r = {};
  return q(e.rules, (n) => {
    r[n.name] = n;
  }), hA(r, t.errMsgProvider);
}
i(MA, "resolveGrammar");
function xA(e) {
  return e = Tp(e, { errMsgProvider: An }), _A(e.rules, e.tokenTypes, e.errMsgProvider, e.grammarName);
}
i(xA, "validateGrammar");
var FA = "MismatchedTokenException", GA = "NoViableAltException", jA = "EarlyExitException", UA = "NotAllInputParsedException", zA = [FA, GA, jA, UA];
Object.freeze(zA);
function gs(e) {
  return tt(zA, e.name);
}
i(gs, "isRecognitionException");
var ac = (_L2 = class extends Error {
  constructor(e, t) {
...
}, i(_L2, "RecognitionException"), _L2), BA = (_M2 = class extends ac {
  constructor(e, t, r) {
    super(e, t), this.previousToken = r, this.name = FA;
  }
}, i(_M2, "MismatchedTokenException"), _M2), RL = (_N2 = class extends ac {
  constructor(e, t, r) {
    super(e, t), this.previousToken = r, this.name = GA;
  }
}, i(_N2, "NoViableAltException"), _N2), $L = (_O2 = class extends ac {
  constructor(e, t) {
    super(e, t), this.name = UA;
  }
}, i(_O2, "NotAllInputParsedException"), _O2), AL = (_P2 = class extends ac {
  constructor(e, t, r) {
    super(e, t), this.previousToken = r, this.name = jA;
  }
}, i(_P2, "EarlyExitException"), _P2), Dc = {}, KA = "InRuleRecoveryException", EL = (_Q = class extends Error {
  constructor(e) {
    super(e), this.name = KA;
  }
}, i(_Q, "InRuleRecoveryException"), _Q), _L = (_R2 = class {
  initRecoverable(e) {
    this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = U(e, "recoveryEnabled") ? e.recoveryEnabled : Cr.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = qA);
  }
  getTokenToInsert(e) {
  ...
  tryInRepetitionRecovery(e, t, r, n) {
    ...
    let u = this.LA(1);
    const d = i(() => {
      const f = this.LA(0), h = this.errorMessageProvider.buildMismatchTokenMessage({ expected: n, actual: c, previous: f, ruleName: this.getCurrRuleFullName() }), y = new BA(h, c, this.LA(0));
      y.resyncedTokens = ps(o), this.SAVE_ERROR(y);
    }, "generateErrorMessage");
    for (; !l; ) if (this.tokenMatcher(u, n)) {
      d();
      return;
    } else if (r.call(this)) {
      d(), e.apply(this, t);
      return;
    } else this.tokenMatcher(u, a) ? l = true : (u = this.SKIP_TOKEN(), this.addToResyncTokens(u, o));
  ...
  canRecoverWithSingleTokenInsertion(e, t) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || he(t)) return false;
    const r = this.LA(1);
    return za(t, (a) => this.tokenMatcher(r, a)) !== void 0;
  }
  ...
  findReSyncTokenType() {
    ...
    let t = this.LA(1), r = 2;
    for (; ; ) {
      const n = za(e, (a) => Np(t, a));
      if (n !== void 0) return n;
      t = this.LA(r), r++;
    }
  }
  getCurrFollowKey() {
    if (this.RULE_STACK.length === 1) return Dc;
  ...
  buildFullFollowKeyStack() {
    ...
    return F(e, (r, n) => n === 0 ? Dc : { ruleName: this.shortRuleNameToFullName(r), idxInCallingRule: t[n], inRule: this.shortRuleNameToFullName(e[n - 1]) });
  }
  flattenFollowSet() {
  ...
  getFollowSetFromFollowKey(e) {
    if (e === Dc) return [Ur];
    const t = e.ruleName + e.idxInCallingRule + I$ + e.inRule;
    return this.resyncFollows[t];
  }
  addToResyncTokens(e, t) {
    return this.tokenMatcher(e, Ur) || t.push(e), t;
  }
  reSyncTo(e) {
    const t = [];
    let r = this.LA(1);
...
}, i(_R2, "Recoverable"), _R2);
function qA(e, t, r, n, a, s, o) {
  ...
  this.RULE_STACK.length === 1 && f && u === void 0 && (u = Ur, d = 1), !(u === void 0 || d === void 0) && this.shouldInRepetitionRecoveryBeTried(u, d, o) && this.tryInRepetitionRecovery(e, t, r, u);
}
i(qA, "attemptInRepetitionRecovery");
var CL = 4, Vr = 8, WA = 1 << Vr, VA = 2 << Vr, md = 3 << Vr, gd = 4 << Vr, yd = 5 << Vr, Co = 6 << Vr;
function So(e, t, r) {
  return r | t | e;
}
i(So, "getKeyForAutomaticLookahead");
var xp = (_S2 = class {
  constructor(e) {
    var t;
    this.maxLookahead = (t = e == null ? void 0 : e.maxLookahead) !== null && t !== void 0 ? t : Cr.maxLookahead;
  }
  validate(e) {
  ...
  validateNoLeftRecursion(e) {
    return _t(e, (t) => Dp(t, t, An));
  }
  validateEmptyOrAlternatives(e) {
    return _t(e, (t) => IA(t, An));
  }
  validateAmbiguousAlternationAlternatives(e, t) {
    return _t(e, (r) => NA(r, t, An));
  }
  validateSomeNonEmptyLookaheadPath(e, t) {
    return PA(e, t, An);
  }
  buildLookaheadForAlternation(e) {
    return gA(e.prodOccurrence, e.rule, e.maxLookahead, e.hasPredicates, e.dynamicTokensEnabled, vA);
  }
  buildLookaheadForOptional(e) {
    return yA(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, nc(e.prodType), TA);
  }
}, i(_S2, "LLkLookaheadStrategy"), _S2), SL = (_T2 = class {
  initLooksAhead(e) {
    this.dynamicTokensEnabled = U(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : Cr.dynamicTokensEnabled, this.maxLookahead = U(e, "maxLookahead") ? e.maxLookahead : Cr.maxLookahead, this.lookaheadStrategy = U(e, "lookaheadStrategy") ? e.lookaheadStrategy : new xp({ maxLookahead: this.maxLookahead }), this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
  }
  preComputeLookaheadFunctions(e) {
    q(e, (t) => {
      this.TRACE_INIT(`${t.name} Rule Lookahead`, () => {
        const { alternation: r, repetition: n, option: a, repetitionMandatory: s, repetitionMandatoryWithSeparator: o, repetitionWithSeparator: l } = HA(t);
        q(r, (c) => {
          const u = c.idx === 0 ? "" : c.idx;
          this.TRACE_INIT(`${Ot(c)}${u}`, () => {
            const d = this.lookaheadStrategy.buildLookaheadForAlternation({ prodOccurrence: c.idx, rule: t, maxLookahead: c.maxLookahead || this.maxLookahead, hasPredicates: c.hasPredicates, dynamicTokensEnabled: this.dynamicTokensEnabled }), f = So(this.fullRuleNameToShort[t.name], WA, c.idx);
            this.setLaFuncCache(f, d);
          });
        }), q(n, (c) => {
          this.computeLookaheadFunc(t, c.idx, md, "Repetition", c.maxLookahead, Ot(c));
        }), q(a, (c) => {
          this.computeLookaheadFunc(t, c.idx, VA, "Option", c.maxLookahead, Ot(c));
        }), q(s, (c) => {
          this.computeLookaheadFunc(t, c.idx, gd, "RepetitionMandatory", c.maxLookahead, Ot(c));
        }), q(o, (c) => {
          this.computeLookaheadFunc(t, c.idx, Co, "RepetitionMandatoryWithSeparator", c.maxLookahead, Ot(c));
        }), q(l, (c) => {
          this.computeLookaheadFunc(t, c.idx, yd, "RepetitionWithSeparator", c.maxLookahead, Ot(c));
        });
      });
    });
  }
  computeLookaheadFunc(e, t, r, n, a, s) {
    this.TRACE_INIT(`${s}${t === 0 ? "" : t}`, () => {
      const o = this.lookaheadStrategy.buildLookaheadForOptional({ prodOccurrence: t, rule: e, maxLookahead: a || this.maxLookahead, dynamicTokensEnabled: this.dynamicTokensEnabled, prodType: n }), l = So(this.fullRuleNameToShort[e.name], r, t);
...
}, i(_T2, "LooksAhead"), _T2), bL = (_U = class extends Ya {
  constructor() {
...
}, i(_U, "DslMethodsCollectorVisitor"), _U), Ys = new bL();
function HA(e) {
  Ys.reset(), e.accept(Ys);
  const t = Ys.dslMethods;
  return Ys.reset(), t;
}
i(HA, "collectMethods");
function vd(e, t) {
...
i(vd, "setNodeLocationOnlyOffset");
function Td(e, t) {
...
i(Td, "setNodeLocationFull");
function YA(e, t, r) {
  e.children[r] === void 0 ? e.children[r] = [t] : e.children[r].push(t);
}
i(YA, "addTerminalToCst");
function XA(e, t, r) {
  e.children[t] === void 0 ? e.children[t] = [r] : e.children[t].push(r);
}
i(XA, "addNoneTerminalToCst");
var wL = "name";
function Fp(e, t) {
  Object.defineProperty(e, wL, { enumerable: false, configurable: true, writable: false, value: t });
}
i(Fp, "defineNameProp");
function JA(e, t) {
  const r = ft(e), n = r.length;
  for (let a = 0; a < n; a++) {
...
function ZA(e, t) {
  ...
  Fp(r, e + "BaseSemantics");
  const n = { visit: i(function(a, s) {
    if (ne(a) && (a = a[0]), !Er(a)) return this[a.name](a.children, s);
  }, "visit"), validateVisitor: i(function() {
    const a = eE(this, t);
    if (!he(a)) {
      const s = F(a, (o) => o.msg);
...
i(ZA, "createBaseSemanticVisitorConstructor");
function QA(e, t, r) {
  const n = i(function() {
  }, "derivedConstructor");
  Fp(n, e + "BaseSemanticsWithDefaults");
  const a = Object.create(r.prototype);
  return q(t, (s) => {
    a[s] = JA;
  }), n.prototype = a, n.prototype.constructor = n, n;
}
i(QA, "createBaseVisitorConstructorWithDefaults");
var Rd;
(function(e) {
...
i(eE, "validateVisitor");
function tE(e, t) {
  const r = wt(t, (a) => Ir(e[a]) === false), n = F(r, (a) => ({ msg: `Missing visitor method: <${a}> on ${e.constructor.name} CST Visitor.`, type: Rd.MISSING_METHOD, methodName: a }));
  return Fs(n);
}
i(tE, "validateMissingCstMethods");
var IL = (_V = class {
  initTreeBuilder(e) {
    if (this.CST_STACK = [], this.outputCst = e.outputCst, this.nodeLocationTracking = U(e, "nodeLocationTracking") ? e.nodeLocationTracking : Cr.nodeLocationTracking, !this.outputCst) this.cstInvocationStateUpdate = Me, this.cstFinallyStateUpdate = Me, this.cstPostTerminal = Me, this.cstPostNonTerminal = Me, this.cstPostRule = Me;
  ...
  cstPostTerminal(e, t) {
    ...
    YA(r, t, e), this.setNodeLocationFromToken(r.location, t);
  }
  cstPostNonTerminal(e, t) {
    const r = this.CST_STACK[this.CST_STACK.length - 1];
    XA(r, t, e), this.setNodeLocationFromNode(r.location, e.location);
  }
  getBaseCstVisitorConstructor() {
    if (Er(this.baseCstVisitorConstructor)) {
      const e = ZA(this.className, ft(this.gastProductionsCache));
  ...
  getBaseCstVisitorConstructorWithDefaults() {
    if (Er(this.baseCstVisitorWithDefaultsConstructor)) {
      const e = QA(this.className, ft(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
}, i(_V, "TreeBuilder"), _V), NL = (_W = class {
  initLexerAdapter() {
  ...
  SKIP_TOKEN() {
    return this.currIdx <= this.tokVector.length - 2 ? (this.consumeToken(), this.LA(1)) : ll;
  }
  LA(e) {
    const t = this.currIdx + e;
    return t < 0 || this.tokVectorLength <= t ? ll : this.tokVector[t];
  }
  consumeToken() {
    this.currIdx++;
  }
...
}, i(_W, "LexerAdapter"), _W), kL = (_X = class {
  ACTION(e) {
    return e.call(this);
  }
  consume(e, t, r) {
  ...
  RULE(e, t, r = cl) {
    if (tt(this.definedRulesNames, e)) {
      const s = { message: An.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }), type: Qe.DUPLICATE_RULE_NAME, ruleName: e };
  ...
  OVERRIDE_RULE(e, t, r = cl) {
    const n = wA(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return E$(xe(this.gastProductionsCache));
  }
}, i(_X, "RecognizerApi"), _X), PL = (_Y = class {
  initRecognizerEngine(e, t) {
    ...
    if (ne(e)) this.tokensMap = ht(e, (a, s) => (a[s.name] = s, a), {});
    else if (U(e, "modes") && Ft(xt(xe(e.modes)), fA)) {
      const a = xt(xe(e.modes)), s = Rp(a);
      this.tokensMap = ht(s, (o, l) => (o[l.name] = l, o), {});
    } else if (St(e)) this.tokensMap = Ke(e);
    ...
    this.tokenMatcher = n ? ms : Ja, Za(xe(this.tokensMap));
  }
  defineRule(e, t, r) {
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const n = U(r, "resyncEnabled") ? r.resyncEnabled : cl.resyncEnabled, a = U(r, "recoveryValueFunc") ? r.recoveryValueFunc : cl.recoveryValueFunc, s = this.ruleShortNameIdx << CL + Vr;
    this.ruleShortNameIdx++, this.shortRuleNameToFull[s] = e, this.fullRuleNameToShort[e] = s;
    let o;
    return this.outputCst === true ? o = i(function(...u) {
      try {
    ...
    }, "invokeRuleWithTry") : o = i(function(...u) {
      try {
  ...
  invokeRuleCatch(e, t, r) {
    ...
    if (gs(e)) {
      ...
      if (a) {
        ...
        if (this.isInCurrentRuleReSyncSet(o)) if (s.resyncedTokens = this.reSyncTo(o), this.outputCst) {
          ...
          if (this.outputCst) {
            const l = this.CST_STACK[this.CST_STACK.length - 1];
            l.recoveredNode = true, s.partialCstResult = l;
          }
          throw s;
        }
      } else {
  ...
  optionInternal(e, t) {
    const r = this.getKeyForAutomaticLookahead(VA, t);
  ...
  optionInternalLogic(e, t, r) {
    ...
    if (typeof e != "function") {
      ...
      if (s !== void 0) {
        const o = n;
        n = i(() => s.call(this) && o.call(this), "lookAheadFunc");
      }
    } else a = e;
    if (n.call(this) === true) return a.call(this);
  }
  atLeastOneInternal(e, t) {
    const r = this.getKeyForAutomaticLookahead(gd, e);
  ...
  atLeastOneInternalLogic(e, t, r) {
    ...
    if (n.call(this) === true) {
      ...
      for (; n.call(this) === true && s === true; ) s = this.doSingleRepetition(a);
    } else throw this.raiseEarlyExitException(e, _e.REPETITION_MANDATORY, t.ERR_MSG);
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], n, gd, e, gL);
  }
  atLeastOneSepFirstInternal(e, t) {
    const r = this.getKeyForAutomaticLookahead(Co, e);
  ...
  atLeastOneSepFirstInternalLogic(e, t, r) {
    ...
    if (this.getLaFuncFromCache(r).call(this) === true) {
      n.call(this);
      const o = i(() => this.tokenMatcher(this.LA(1), a), "separatorLookAheadFunc");
      for (; this.tokenMatcher(this.LA(1), a) === true; ) this.CONSUME(a), n.call(this);
      this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [e, a, o, n, Im], o, Co, e, Im);
    } else throw this.raiseEarlyExitException(e, _e.REPETITION_MANDATORY_WITH_SEPARATOR, t.ERR_MSG);
  }
  manyInternal(e, t) {
    const r = this.getKeyForAutomaticLookahead(md, e);
  ...
  manyInternalLogic(e, t, r) {
    ...
    if (typeof t != "function") {
      ...
      if (o !== void 0) {
        const l = n;
        n = i(() => o.call(this) && l.call(this), "lookaheadFunction");
      }
    } else a = t;
    let s = true;
    for (; n.call(this) === true && s === true; ) s = this.doSingleRepetition(a);
    this.attemptInRepetitionRecovery(this.manyInternal, [e, t], n, md, e, mL, s);
  }
  manySepFirstInternal(e, t) {
    const r = this.getKeyForAutomaticLookahead(yd, e);
  ...
  manySepFirstInternalLogic(e, t, r) {
    ...
    if (this.getLaFuncFromCache(r).call(this) === true) {
      ...
      const o = i(() => this.tokenMatcher(this.LA(1), a), "separatorLookAheadFunc");
      for (; this.tokenMatcher(this.LA(1), a) === true; ) this.CONSUME(a), n.call(this);
      this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [e, a, o, n, wm], o, yd, e, wm);
    }
  }
  repetitionSepSecondInternal(e, t, r, n, a) {
    for (; r(); ) this.CONSUME(t), n.call(this);
    this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [e, t, r, n, a], r, Co, e, a);
  }
  ...
  orInternal(e, t) {
    const r = this.getKeyForAutomaticLookahead(WA, t), n = ne(e) ? e : e.DEF, s = this.getLaFuncFromCache(r).call(this, n);
  ...
  subruleInternalError(e, t, r) {
    throw gs(e) && e.partialCstResult !== void 0 && (this.cstPostNonTerminal(e.partialCstResult, t !== void 0 && t.LABEL !== void 0 ? t.LABEL : r), delete e.partialCstResult), e;
  }
  consumeInternal(e, t, r) {
    let n;
    try {
      const a = this.LA(1);
      this.tokenMatcher(a, e) === true ? (this.consumeToken(), n = a) : this.consumeInternalError(e, a, r);
    } catch (a) {
  ...
  consumeInternalError(e, t, r) {
    let n;
    const a = this.LA(0);
    throw r !== void 0 && r.ERR_MSG ? n = r.ERR_MSG : n = this.errorMessageProvider.buildMismatchTokenMessage({ expected: e, actual: t, previous: a, ruleName: this.getCurrRuleFullName() }), this.SAVE_ERROR(new BA(n, t, a));
  }
...
}, i(_Y, "RecognizerEngine"), _Y), OL = (_Z = class {
  initErrorHandler(e) {
    this._errors = [], this.errorMessageProvider = U(e, "errorMessageProvider") ? e.errorMessageProvider : Cr.errorMessageProvider;
  }
  SAVE_ERROR(e) {
    if (gs(e)) return e.context = { ruleStack: this.getHumanReadableRuleStack(), ruleOccurrenceStack: Ke(this.RULE_OCCURRENCE_STACK) }, this._errors.push(e), e;
  ...
  raiseEarlyExitException(e, t, r) {
    const n = this.getCurrRuleFullName(), a = this.getGAstProductions()[n], o = zs(e, a, t, this.maxLookahead)[0], l = [];
    for (let u = 1; u <= this.maxLookahead; u++) l.push(this.LA(u));
    const c = this.errorMessageProvider.buildEarlyExitMessage({ expectedIterationPaths: o, actual: l, previous: this.LA(0), customUserDescription: r, ruleName: n });
    throw this.SAVE_ERROR(new AL(c, this.LA(1), this.LA(0)));
  }
  raiseNoAltException(e, t) {
    const r = this.getCurrRuleFullName(), n = this.getGAstProductions()[r], a = Us(e, n, this.maxLookahead), s = [];
    for (let c = 1; c <= this.maxLookahead; c++) s.push(this.LA(c));
    const o = this.LA(0), l = this.errorMessageProvider.buildNoViableAltMessage({ expectedPathsPerAlt: a, actual: s, previous: o, customUserDescription: t, ruleName: this.getCurrRuleFullName() });
    throw this.SAVE_ERROR(new RL(l, this.LA(1), o));
  }
}, i(_Z, "ErrorHandler"), _Z), LL = (__2 = class {
  initContentAssist() {
  }
  computeContentAssist(e, t) {
    const r = this.gastProductionsCache[e];
    if (Er(r)) throw Error(`Rule ->${e}<- does not exist in this grammar.`);
    return kp([r], t, this.tokenMatcher, this.maxLookahead);
  }
  getNextPossibleTokenTypes(e) {
    const t = jt(e.ruleStack), n = this.getGAstProductions()[t];
    return new hL(n, e).startWalking();
  }
}, i(__2, "ContentAssist"), __2), ic = { description: "This Object indicates the Parser is during Recording Phase" };
Object.freeze(ic);
var Nm = true, km = Math.pow(2, Vr) - 1, rE = ka({ name: "RECORDING_PHASE_TOKEN", pattern: Xe.NA });
Za([rE]);
var nE = js(rE, `This IToken indicates the Parser is in Recording Phase
	See: https://chevrotain.io/docs/guide/internals.html#grammar-recording for details`, -1, -1, -1, -1, -1, -1);
Object.freeze(nE);
var DL = { name: `This CSTNode indicates the Parser is in Recording Phase
	See: https://chevrotain.io/docs/guide/internals.html#grammar-recording for details`, children: {} }, ML = (_$2 = class {
  initGastRecorder(e) {
  ...
  topLevelRuleRecord(e, t) {
    try {
      const r = new Ha({ definition: [], name: e });
  ...
  optionInternalRecord(e, t) {
    return ma.call(this, Be, e, t);
  }
  atLeastOneInternalRecord(e, t) {
    ma.call(this, mt, t, e);
  }
  atLeastOneSepFirstInternalRecord(e, t) {
    ma.call(this, gt, t, e, Nm);
  }
  manyInternalRecord(e, t) {
    ma.call(this, we, t, e);
  }
  manySepFirstInternalRecord(e, t) {
    ma.call(this, ot, t, e, Nm);
  }
  orInternalRecord(e, t) {
    return aE.call(this, e, t);
  }
  subruleInternalRecord(e, t, r) {
    if (ys(t), !e || U(e, "ruleName") === false) {
      const o = new Error(`<SUBRULE${$d(t)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw o.KNOWN_RECORDER_ERROR = true, o;
    }
    const n = wn(this.recordingProdStack), a = e.ruleName, s = new Ze({ idx: t, nonTerminalName: a, label: r == null ? void 0 : r.LABEL, referencedRule: void 0 });
    return n.definition.push(s), this.outputCst ? DL : ic;
  }
  consumeInternalRecord(e, t, r) {
    if (ys(t), !wp(e)) {
      const s = new Error(`<CONSUME${$d(t)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw s.KNOWN_RECORDER_ERROR = true, s;
    }
    const n = wn(this.recordingProdStack), a = new Te({ idx: t, terminalType: e, label: r == null ? void 0 : r.LABEL });
    return n.definition.push(a), nE;
  }
}, i(_$2, "GastRecorder"), _$2);
function ma(e, t, r, n = false) {
  ys(r);
  const a = wn(this.recordingProdStack), s = Ir(t) ? t : t.DEF, o = new e({ definition: [], idx: r });
  return n && (o.separator = t.SEP), U(t, "MAX_LOOKAHEAD") && (o.maxLookahead = t.MAX_LOOKAHEAD), this.recordingProdStack.push(o), s.call(this), a.definition.push(o), this.recordingProdStack.pop(), ic;
}
i(ma, "recordProd");
function aE(e, t) {
  ys(t);
  const r = wn(this.recordingProdStack), n = ne(e) === false, a = n === false ? e : e.DEF, s = new lt({ definition: [], idx: t, ignoreAmbiguities: n && e.IGNORE_AMBIGUITIES === true });
  U(e, "MAX_LOOKAHEAD") && (s.maxLookahead = e.MAX_LOOKAHEAD);
  const o = v$(a, (l) => Ir(l.GATE));
  return s.hasPredicates = o, r.definition.push(s), q(a, (l) => {
    const c = new st({ definition: [] });
    s.definition.push(c), U(l, "IGNORE_AMBIGUITIES") ? c.ignoreAmbiguities = l.IGNORE_AMBIGUITIES : U(l, "GATE") && (c.ignoreAmbiguities = true), this.recordingProdStack.push(c), l.ALT.call(this), this.recordingProdStack.pop();
  }), ic;
}
i(aE, "recordOrProd");
function $d(e) {
...
function ys(e) {
  if (e < 0 || e > km) {
	...
	Idx value must be a none negative value smaller than ${km + 1}`);
    throw t.KNOWN_RECORDER_ERROR = true, t;
  }
}
i(ys, "assertMethodIdxIsValid");
var xL = (_aa = class {
  initPerformanceTracer(e) {
    ...
    } else this.traceInitMaxIdent = 0, this.traceInitPerf = Cr.traceInitPerf;
...
i(iE, "applyMixins");
var ll = js(Ur, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(ll);
var Cr = Object.freeze({ recoveryEnabled: false, maxLookahead: 3, dynamicTokensEnabled: false, outputCst: true, errorMessageProvider: wa, nodeLocationTracking: "none", traceInitPerf: false, skipValidations: false }), cl = Object.freeze({ recoveryValueFunc: i(() => {
}, "recoveryValueFunc"), resyncEnabled: true }), Qe;
(function(e) {
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        n = MA({ rules: xe(this.gastProductionsCache) }), this.definitionErrors = this.definitionErrors.concat(n);
      }), this.TRACE_INIT("Grammar Validations", () => {
        if (he(n) && this.skipValidations === false) {
          const a = xA({ rules: xe(this.gastProductionsCache), tokenTypes: xe(this.tokensMap), errMsgProvider: An, grammarName: r }), s = EA({ lookaheadStrategy: this.lookaheadStrategy, rules: xe(this.gastProductionsCache), tokenTypes: xe(this.tokensMap), grammarName: r });
        ...
        const a = N$(xe(this.gastProductionsCache));
      ...
      })), !_ba.DEFER_DEFINITION_ERRORS_HANDLING && !he(this.definitionErrors)) throw t = F(this.definitionErrors, (a) => a.message), new Error(`Parser Definition Errors detected:
 ${t.join(`
-------------------------------
`)}`);
    });
  ...
  constructor(t, r) {
    ...
    const n = this;
    if (n.initErrorHandler(r), n.initLexerAdapter(), n.initLooksAhead(r), n.initRecognizerEngine(t, r), n.initRecoverable(r), n.initTreeBuilder(r), n.initContentAssist(), n.initGastRecorder(r), n.initPerformanceTracer(r), U(r, "ignoredIssues")) throw new Error(`The <ignoredIssues> IParserConfig property has been deprecated.
	Please use the <IGNORE_AMBIGUITIES> flag on the relevant DSL method instead.
	See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#IGNORING_AMBIGUITIES
	For further details.`);
    this.skipValidations = U(r, "skipValidations") ? r.skipValidations : Cr.skipValidations;
  }
}, i(_ba, "Parser"), _ba);
Gp.DEFER_DEFINITION_ERRORS_HANDLING = false;
iE(Gp, [_L, SL, IL, NL, PL, kL, OL, LL, ML, xL]);
var FL = (_ca = class extends Gp {
  constructor(e, t = Cr) {
    const r = Ke(t);
    r.outputCst = false, super(e, r);
  }
}, i(_ca, "EmbeddedActionsParser"), _ca);
function oE(e, t) {
  for (var r = -1, n = e == null ? 0 : e.length, a = Array(n); ++r < n; ) a[r] = t(e[r], r, e);
  return a;
}
...
var dE = uE;
function fE(e, t) {
  for (var r = e.length; r--; ) if (dE(e[r][0], t)) return r;
  return -1;
}
i(fE, "assocIndexOf");
var sc = fE, jL = Array.prototype, UL = jL.splice;
function pE(e) {
  var t = this.__data__, r = sc(t, e);
  if (r < 0) return false;
  var n = t.length - 1;
  return r == n ? t.pop() : UL.call(t, r, 1), --this.size, true;
}
i(pE, "listCacheDelete");
var zL = pE;
function hE(e) {
  var t = this.__data__, r = sc(t, e);
  return r < 0 ? void 0 : t[r][1];
...
i(qn, "ListCache");
qn.prototype.clear = GL;
qn.prototype.delete = zL;
qn.prototype.get = BL;
qn.prototype.has = KL;
qn.prototype.set = qL;
var oc = qn;
...
i(RE, "stackHas");
var YL = RE, XL = typeof global == "object" && global && global.Object === Object && global, $E = XL, JL = typeof self == "object" && self && self.Object === Object && self, ZL = $E || JL || Function("return this")(), Nr = ZL, QL = Nr.Symbol, tr = QL, AE = Object.prototype, eD = AE.hasOwnProperty, tD = AE.toString, Ci = tr ? tr.toStringTag : void 0;
function EE(e) {
  var t = eD.call(e, Ci), r = e[Ci];
  try {
    e[Ci] = void 0;
    var n = true;
  } catch {
  ...
  var a = tD.call(e);
  return n && (t ? e[Ci] = r : delete e[Ci]), a;
}
i(EE, "getRawTag");
var rD = EE, nD = Object.prototype, aD = nD.toString;
function _E(e) {
  return aD.call(e);
}
i(_E, "objectToString");
var iD = _E, sD = "[object Null]", oD = "[object Undefined]", Pm = tr ? tr.toStringTag : void 0;
function CE(e) {
  return e == null ? e === void 0 ? oD : sD : Pm && Pm in Object(e) ? rD(e) : iD(e);
}
i(CE, "baseGetTag");
var Qa = CE;
function SE(e) {
...
i(SE, "isObject");
var jp = SE, lD = "[object AsyncFunction]", cD = "[object Function]", uD = "[object GeneratorFunction]", dD = "[object Proxy]";
function bE(e) {
  if (!jp(e)) return false;
  var t = Qa(e);
  return t == cD || t == uD || t == lD || t == dD;
}
i(bE, "isFunction");
var wE = bE, fD = Nr["__core-js_shared__"], Mc = fD, Om = (function() {
...
i(IE, "isMasked");
var pD = IE, hD = Function.prototype, mD = hD.toString;
function NE(e) {
  if (e != null) {
    try {
      return mD.call(e);
...
i(NE, "toSource");
var Wn = NE, gD = /[\\^$.*+?()[\]{}|]/g, yD = /^\[object .+?Constructor\]$/, vD = Function.prototype, TD = Object.prototype, RD = vD.toString, $D = TD.hasOwnProperty, AD = RegExp("^" + RD.call($D).replace(gD, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function kE(e) {
  if (!jp(e) || pD(e)) return false;
  var t = wE(e) ? AD : yD;
  return t.test(Wn(e));
}
i(kE, "baseIsNative");
...
i(OE, "getNative");
var ei = OE, CD = ei(Nr, "Map"), vs = CD, SD = ei(Object, "create"), Ts = SD;
function LE() {
...
i(DE, "hashDelete");
var wD = DE, ID = "__lodash_hash_undefined__", ND = Object.prototype, kD = ND.hasOwnProperty;
function ME(e) {
  var t = this.__data__;
  if (Ts) {
    var r = t[e];
    return r === ID ? void 0 : r;
  }
  return kD.call(t, e) ? t[e] : void 0;
}
i(ME, "hashGet");
var PD = ME, OD = Object.prototype, LD = OD.hasOwnProperty;
function xE(e) {
  var t = this.__data__;
  return Ts ? t[e] !== void 0 : LD.call(t, e);
}
i(xE, "hashHas");
var DD = xE, MD = "__lodash_hash_undefined__";
function FE(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = Ts && t === void 0 ? MD : t, this;
}
i(FE, "hashSet");
var xD = FE;
function Vn(e) {
...
i(Vn, "Hash");
Vn.prototype.clear = bD;
Vn.prototype.delete = wD;
Vn.prototype.get = PD;
Vn.prototype.has = DD;
Vn.prototype.set = xD;
var Lm = Vn;
function GE() {
  this.size = 0, this.__data__ = { hash: new Lm(), map: new (vs || oc)(), string: new Lm() };
}
i(GE, "mapCacheClear");
var FD = GE;
function jE(e) {
...
i(Hn, "MapCache");
Hn.prototype.clear = FD;
Hn.prototype.delete = jD;
Hn.prototype.get = UD;
Hn.prototype.has = zD;
Hn.prototype.set = BD;
var cc = Hn, KD = 200;
function WE(e, t) {
  ...
  if (r instanceof oc) {
    var n = r.__data__;
    if (!vs || n.length < KD - 1) return n.push([e, t]), this.size = ++r.size, this;
...
Yn.prototype.delete = VL;
Yn.prototype.get = HL;
Yn.prototype.has = YL;
Yn.prototype.set = qD;
var bo = Yn, WD = "__lodash_hash_undefined__";
function VE(e) {
...
i(Rs, "SetCache");
Rs.prototype.add = Rs.prototype.push = VD;
Rs.prototype.has = HD;
var YE = Rs;
function XE(e, t) {
  for (var r = -1, n = e == null ? 0 : e.length; ++r < n; ) if (t(e[r], r, e)) return true;
...
function QE(e, t, r, n, a, s) {
  var o = r & XD, l = e.length, c = t.length;
  if (l != c && !(o && c > l)) return false;
  var u = s.get(e), d = s.get(t);
  if (u && d) return u == t && d == e;
  var f = -1, h = true, y = r & JD ? new YE() : void 0;
  for (s.set(e, t), s.set(t, e); ++f < l; ) {
    var v = e[f], C = t[f];
    if (n) var b = o ? n(C, v, f, t, e, s) : n(v, C, f, e, t, s);
    if (b !== void 0) {
    ...
    if (y) {
      if (!YD(t, function(w, I) {
        if (!ZE(y, I) && (v === w || a(v, w, r, n, s))) return y.push(I);
      })) {
        h = false;
        break;
      }
...
i(QE, "equalArrays");
var e_ = QE, ZD = Nr.Uint8Array, Dm = ZD;
function t_(e) {
  var t = -1, r = Array(e.size);
  return e.forEach(function(n, a) {
    r[++t] = [a, n];
...
i(r_, "setToArray");
var Up = r_, eM = 1, tM = 2, rM = "[object Boolean]", nM = "[object Date]", aM = "[object Error]", iM = "[object Map]", sM = "[object Number]", oM = "[object RegExp]", lM = "[object Set]", cM = "[object String]", uM = "[object Symbol]", dM = "[object ArrayBuffer]", fM = "[object DataView]", Mm = tr ? tr.prototype : void 0, xc = Mm ? Mm.valueOf : void 0;
function n_(e, t, r, n, a, s, o) {
  switch (r) {
    case fM:
      if (e.byteLength != t.byteLength || e.byteOffset != t.byteOffset) return false;
      e = e.buffer, t = t.buffer;
    ...
    case lM:
      var c = n & eM;
      if (l || (l = Up), e.size != t.size && !c) return false;
      var u = o.get(e);
      if (u) return u == t;
      n |= tM, o.set(e, t);
      var d = e_(l(e), l(t), n, a, s, o);
      return o.delete(e), d;
    case uM:
...
i(a_, "arrayPush");
var i_ = a_, hM = Array.isArray, et = hM;
function s_(e, t, r) {
  var n = t(e);
  return et(e) ? n : i_(n, r(e));
}
i(s_, "baseGetAllKeys");
var mM = s_;
function o_(e, t) {
...
i(c_, "stubArray");
var gM = c_, yM = Object.prototype, vM = yM.propertyIsEnumerable, xm = Object.getOwnPropertySymbols, TM = xm ? function(e) {
  return e == null ? [] : (e = Object(e), l_(xm(e), function(t) {
    return vM.call(e, t);
  }));
} : gM, RM = TM;
function u_(e, t) {
...
i(d_, "isObjectLike");
var Ba = d_, AM = "[object Arguments]";
function f_(e) {
  return Ba(e) && Qa(e) == AM;
}
i(f_, "baseIsArguments");
var Fm = f_, p_ = Object.prototype, EM = p_.hasOwnProperty, _M = p_.propertyIsEnumerable, CM = Fm(/* @__PURE__ */ (function() {
  return arguments;
})()) ? Fm : function(e) {
  return Ba(e) && EM.call(e, "callee") && !_M.call(e, "callee");
}, uc = CM;
function h_() {
  return false;
}
i(h_, "stubFalse");
var SM = h_, m_ = typeof exports == "object" && exports && !exports.nodeType && exports, Gm = m_ && typeof module == "object" && module && !module.nodeType && module, bM = Gm && Gm.exports === m_, jm = bM ? Nr.Buffer : void 0, wM = jm ? jm.isBuffer : void 0, IM = wM || SM, ul = IM, NM = 9007199254740991, kM = /^(?:0|[1-9]\d*)$/;
function g_(e, t) {
  var r = typeof e;
  return t = t ?? NM, !!t && (r == "number" || r != "symbol" && kM.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
i(g_, "isIndex");
...
i(R_, "baseUnary");
var ax = R_, $_ = typeof exports == "object" && exports && !exports.nodeType && exports, as = $_ && typeof module == "object" && module && !module.nodeType && module, ix = as && as.exports === $_, Fc = ix && $E.process, sx = (function() {
  try {
    var e = as && as.require && as.require("util").types;
    return e || Fc && Fc.binding && Fc.binding("util");
  } catch {
  }
})(), Um = sx, zm = Um && Um.isTypedArray, ox = zm ? ax(zm) : nx, Bp = ox, lx = Object.prototype, cx = lx.hasOwnProperty;
function A_(e, t) {
  var r = et(e), n = !r && uc(e), a = !r && !n && ul(e), s = !r && !n && !a && Bp(e), o = r || n || a || s, l = o ? $M(e.length, String) : [], c = l.length;
  for (var u in e) (t || cx.call(e, u)) && !(o && (u == "length" || a && (u == "offset" || u == "parent") || s && (u == "buffer" || u == "byteLength" || u == "byteOffset") || y_(u, c))) && l.push(u);
  return l;
}
i(A_, "arrayLikeKeys");
var ux = A_, dx = Object.prototype;
function E_(e) {
  var t = e && e.constructor, r = typeof t == "function" && t.prototype || dx;
  return e === r;
}
i(E_, "isPrototype");
var __ = E_;
...
i(C_, "overArg");
var fx = C_, px = fx(Object.keys, Object), hx = px, mx = Object.prototype, gx = mx.hasOwnProperty;
function S_(e) {
  if (!__(e)) return hx(e);
  var t = [];
  for (var r in Object(e)) gx.call(e, r) && r != "constructor" && t.push(r);
  return t;
}
i(S_, "baseKeys");
var b_ = S_;
function w_(e) {
  return e != null && zp(e.length) && !wE(e);
}
i(w_, "isArrayLike");
var dc = w_;
function I_(e) {
  return dc(e) ? ux(e) : b_(e);
}
i(I_, "keys");
var Kp = I_;
function N_(e) {
...
i(N_, "getAllKeys");
var Bm = N_, yx = 1, vx = Object.prototype, Tx = vx.hasOwnProperty;
function k_(e, t, r, n, a, s) {
  var o = r & yx, l = Bm(e), c = l.length, u = Bm(t), d = u.length;
  if (c != d && !o) return false;
  for (var f = c; f--; ) {
    var h = l[f];
    if (!(o ? h in t : Tx.call(t, h))) return false;
  }
  var y = s.get(e), v = s.get(t);
  if (y && v) return y == t && v == e;
  var C = true;
...
i(k_, "equalObjects");
var Rx = k_, $x = ei(Nr, "DataView"), Ed = $x, Ax = ei(Nr, "Promise"), _d = Ax, Ex = ei(Nr, "Set"), Pa = Ex, _x = ei(Nr, "WeakMap"), Cd = _x, Km = "[object Map]", Cx = "[object Object]", qm = "[object Promise]", Wm = "[object Set]", Vm = "[object WeakMap]", Hm = "[object DataView]", Sx = Wn(Ed), bx = Wn(vs), wx = Wn(_d), Ix = Wn(Pa), Nx = Wn(Cd), an = Qa;
(Ed && an(new Ed(new ArrayBuffer(1))) != Hm || vs && an(new vs()) != Km || _d && an(_d.resolve()) != qm || Pa && an(new Pa()) != Wm || Cd && an(new Cd()) != Vm) && (an = i(function(e) {
  var t = Qa(e), r = t == Cx ? e.constructor : void 0, n = r ? Wn(r) : "";
  if (n) switch (n) {
    case Sx:
      return Hm;
    case bx:
...
var Sd = an, kx = 1, Ym = "[object Arguments]", Xm = "[object Array]", Xs = "[object Object]", Px = Object.prototype, Jm = Px.hasOwnProperty;
function P_(e, t, r, n, a, s) {
  var o = et(e), l = et(t), c = o ? Xm : Sd(e), u = l ? Xm : Sd(t);
  c = c == Ym ? Xs : c, u = u == Ym ? Xs : u;
  var d = c == Xs, f = u == Xs, h = c == u;
  if (h && ul(e)) {
    if (!ul(t)) return false;
    o = true, d = false;
  }
  if (h && !d) return s || (s = new bo()), o || Bp(e) ? e_(e, t, r, n, a, s) : pM(e, t, c, r, n, a, s);
  if (!(r & kx)) {
    var y = d && Jm.call(e, "__wrapped__"), v = f && Jm.call(t, "__wrapped__");
    if (y || v) {
      var C = y ? e.value() : e, b = v ? t.value() : t;
      return s || (s = new bo()), a(C, b, r, n, s);
    }
  }
  return h ? (s || (s = new bo()), Rx(e, t, r, n, a, s)) : false;
}
i(P_, "baseIsEqualDeep");
var Ox = P_;
function qp(e, t, r, n, a) {
  return e === t ? true : e == null || t == null || !Ba(e) && !Ba(t) ? e !== e && t !== t : Ox(e, t, r, n, qp, a);
}
i(qp, "baseIsEqual");
var O_ = qp, Lx = 1, Dx = 2;
function L_(e, t, r, n) {
  ...
  for (; ++a < s; ) {
    ...
    if (o && l[2]) {
      ...
      var f = new bo();
      if (n) var h = n(u, d, c, e, t, f);
      if (!(h === void 0 ? O_(d, u, Lx | Dx, n, f) : h)) return false;
    }
  }
  return true;
}
...
i(D_, "isStrictComparable");
var M_ = D_;
function x_(e) {
  for (var t = Kp(e), r = t.length; r--; ) {
    var n = t[r], a = e[n];
    t[r] = [n, a, M_(a)];
  }
  return t;
...
i(F_, "matchesStrictComparable");
var G_ = F_;
function j_(e) {
  var t = xx(e);
  return t.length == 1 && t[0][2] ? G_(t[0][0], t[0][1]) : function(r) {
    return r === e || Mx(r, e, t);
  };
}
i(j_, "baseMatches");
var Fx = j_, Gx = "[object Symbol]";
function U_(e) {
  return typeof e == "symbol" || Ba(e) && Qa(e) == Gx;
}
i(U_, "isSymbol");
var fc = U_, jx = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Ux = /^\w*$/;
function z_(e, t) {
  if (et(e)) return false;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || fc(e) ? true : Ux.test(e) || !jx.test(e) || t != null && e in Object(t);
}
i(z_, "isKey");
var Wp = z_, zx = "Expected a function";
function pc(e, t) {
  if (typeof e != "function" || t != null && typeof t != "function") throw new TypeError(zx);
  var r = i(function() {
    var n = arguments, a = t ? t.apply(this, n) : n[0], s = r.cache;
    if (s.has(a)) return s.get(a);
    var o = e.apply(this, n);
  ...
  return r.cache = new (pc.Cache || cc)(), r;
}
i(pc, "memoize");
pc.Cache = cc;
var Bx = pc, Kx = 500;
...
i(B_, "memoizeCapped");
var qx = B_, Wx = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Vx = /\\(\\)?/g, Hx = qx(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(Wx, function(r, n, a, s) {
    t.push(a ? s.replace(Vx, "$1") : n || r);
  }), t;
}), Yx = Hx, Zm = tr ? tr.prototype : void 0, Qm = Zm ? Zm.toString : void 0;
function Vp(e) {
  if (typeof e == "string") return e;
  if (et(e)) return lE(e, Vp) + "";
  if (fc(e)) return Qm ? Qm.call(e) : "";
  var t = e + "";
  return t == "0" && 1 / e == -1 / 0 ? "-0" : t;
}
i(Vp, "baseToString");
...
var Jx = K_;
function q_(e, t) {
  return et(e) ? e : Wp(e, t) ? [e] : Yx(Jx(e));
}
i(q_, "castPath");
var W_ = q_;
function V_(e) {
...
function Z_(e, t, r) {
  ...
  return s || ++n != a ? s : (a = e == null ? 0 : e.length, !!a && zp(a) && y_(o, a) && (et(e) || uc(e)));
}
i(Z_, "hasPath");
var e1 = Z_;
function Q_(e, t) {
  return e != null && e1(e, t, Qx);
}
i(Q_, "hasIn");
var t1 = Q_, r1 = 1, n1 = 2;
function eC(e, t) {
  return Wp(e) && M_(t) ? G_(hc(e), t) : function(r) {
    var n = Zx(r, e);
    return n === void 0 && n === t ? t1(r, e) : O_(t, n, r1 | n1);
  };
}
i(eC, "baseMatchesProperty");
var a1 = eC;
function tC(e) {
  return e;
}
...
i(nC, "basePropertyDeep");
var s1 = nC;
function aC(e) {
  return Wp(e) ? i1(hc(e)) : s1(e);
}
i(aC, "property");
var o1 = aC;
function iC(e) {
  return typeof e == "function" ? e : e == null ? Hp : typeof e == "object" ? et(e) ? a1(e[0], e[1]) : Fx(e) : o1(e);
}
i(iC, "baseIteratee");
var mc = iC;
function sC(e) {
...
function lC(e, t) {
  return function(r, n) {
    if (r == null) return r;
    if (!dc(r)) return e(r, n);
    for (var a = r.length, s = t ? a : -1, o = Object(r); (t ? s-- : ++s < a) && n(o[s], s, o) !== false; ) ;
    return r;
  };
}
i(lC, "createBaseEach");
var f1 = lC, p1 = f1(d1), gc = p1;
function cC(e, t) {
  var r = -1, n = dc(e) ? Array(e.length) : [];
  return gc(e, function(a, s, o) {
    n[++r] = t(a, s, o);
  }), n;
}
i(cC, "baseMap");
...
i(Nn, "buildATNKey");
var zr = 1, y1 = 2, pC = 4, hC = 5, Bs = 7, v1 = 8, T1 = 9, R1 = 10, $1 = 11, mC = 12, Yp = (_da = class {
  constructor(e) {
    this.target = e;
  }
  isEpsilon() {
...
}, i(_da, "AbstractTransition"), _da), Xp = (_ea = class extends Yp {
  constructor(e, t) {
    super(e), this.tokenType = t;
  }
}, i(_ea, "AtomTransition"), _ea), gC = (_fa = class extends Yp {
  constructor(e) {
    super(e);
  }
  isEpsilon() {
...
}, i(_fa, "EpsilonTransition"), _fa), Jp = (_ga = class extends Yp {
  constructor(e, t, r) {
...
}, i(_ga, "RuleTransition"), _ga);
function yC(e) {
  const t = { decisionMap: {}, decisionStates: [], ruleToStartState: /* @__PURE__ */ new Map(), ruleToStopState: /* @__PURE__ */ new Map(), states: [] };
  vC(t, e);
  const r = e.length;
  for (let n = 0; n < r; n++) {
    const a = e[n], s = Hr(t, a, a);
    s !== void 0 && IC(t, a, s);
  }
  return t;
}
...
function vC(e, t) {
  const r = t.length;
  for (let n = 0; n < r; n++) {
    const a = t[n], s = Fe(e, a, void 0, { type: y1 }), o = Fe(e, a, void 0, { type: Bs });
    s.stop = o, e.ruleToStartState.set(a, s), e.ruleToStopState.set(a, o);
  }
}
i(vC, "createRuleStartAndStopATNStates");
function Zp(e, t, r) {
  return r instanceof Te ? yc(e, t, r.terminalType, r) : r instanceof Ze ? wC(e, t, r) : r instanceof lt ? EC(e, t, r) : r instanceof Be ? _C(e, t, r) : r instanceof we ? TC(e, t, r) : r instanceof ot ? RC(e, t, r) : r instanceof mt ? $C(e, t, r) : r instanceof gt ? AC(e, t, r) : Hr(e, t, r);
}
i(Zp, "atom");
function TC(e, t, r) {
  const n = Fe(e, t, r, { type: hC });
  kr(e, n);
  const a = Xn(e, t, n, r, Hr(e, t, r));
  return eh(e, t, r, a);
}
i(TC, "repetition");
function RC(e, t, r) {
  const n = Fe(e, t, r, { type: hC });
  kr(e, n);
  const a = Xn(e, t, n, r, Hr(e, t, r)), s = yc(e, t, r.separator, r);
  return eh(e, t, r, a, s);
}
i(RC, "repetitionSep");
function $C(e, t, r) {
  const n = Fe(e, t, r, { type: pC });
  kr(e, n);
  const a = Xn(e, t, n, r, Hr(e, t, r));
  return Qp(e, t, r, a);
}
i($C, "repetitionMandatory");
function AC(e, t, r) {
  const n = Fe(e, t, r, { type: pC });
  kr(e, n);
  const a = Xn(e, t, n, r, Hr(e, t, r)), s = yc(e, t, r.separator, r);
...
i(AC, "repetitionMandatorySep");
function EC(e, t, r) {
  const n = Fe(e, t, r, { type: zr });
  kr(e, n);
  const a = yr(r.definition, (o) => Zp(e, t, o));
  return Xn(e, t, n, r, ...a);
}
i(EC, "alternation");
function _C(e, t, r) {
...
i(_C, "option");
function Hr(e, t, r) {
  const n = g1(yr(r.definition, (a) => Zp(e, t, a)), (a) => a !== void 0);
  return n.length === 1 ? n[0] : n.length === 0 ? void 0 : bC(e, n);
}
i(Hr, "block");
function Qp(e, t, r, n, a) {
  const s = n.left, o = n.right, l = Fe(e, t, r, { type: $1 });
  kr(e, l);
  const c = Fe(e, t, r, { type: mC });
  return s.loopback = l, c.loopback = l, e.decisionMap[Nn(t, a ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", r.idx)] = l, Pe(o, l), a === void 0 ? (Pe(l, s), Pe(l, c)) : (Pe(l, c), Pe(l, a.left), Pe(a.right, s)), { left: s, right: c };
}
i(Qp, "plus");
function eh(e, t, r, n, a) {
  const s = n.left, o = n.right, l = Fe(e, t, r, { type: R1 });
  kr(e, l);
  const c = Fe(e, t, r, { type: mC }), u = Fe(e, t, r, { type: T1 });
  return l.loopback = u, c.loopback = u, Pe(l, s), Pe(l, c), Pe(o, u), a !== void 0 ? (Pe(u, c), Pe(u, a.left), Pe(a.right, s)) : Pe(u, l), e.decisionMap[Nn(t, a ? "RepetitionWithSeparator" : "Repetition", r.idx)] = l, { left: l, right: c };
}
i(eh, "star");
function CC(e, t, r, n) {
  const a = n.left, s = n.right;
  return Pe(a, s), e.decisionMap[Nn(t, "Option", r.idx)] = a, n;
}
i(CC, "optional");
function kr(e, t) {
...
function Xn(e, t, r, n, ...a) {
  const s = Fe(e, t, n, { type: v1, start: r });
  r.end = s;
  for (const l of a) l !== void 0 ? (Pe(r, l.left), Pe(l.right, s)) : Pe(r, s);
  const o = { left: r, right: s };
  return e.decisionMap[Nn(t, SC(n), n.idx)] = r, o;
}
i(Xn, "makeAlts");
function SC(e) {
  if (e instanceof lt) return "Alternation";
  if (e instanceof Be) return "Option";
  if (e instanceof we) return "Repetition";
  if (e instanceof ot) return "RepetitionWithSeparator";
  if (e instanceof mt) return "RepetitionMandatory";
  if (e instanceof gt) return "RepetitionMandatoryWithSeparator";
...
function bC(e, t) {
  ...
  for (let s = 0; s < r - 1; s++) {
    ...
    const c = l instanceof Jp, u = l, d = t[s + 1].left;
    o.left.type === zr && o.right.type === zr && l !== void 0 && (c && u.followState === o.right || l.target === o.right) ? (c ? u.followState = d : l.target = d, NC(e, o.right)) : Pe(o.right, d);
  }
  const n = t[0], a = t[r - 1];
...
i(bC, "makeBlock");
function yc(e, t, r, n) {
  const a = Fe(e, t, n, { type: zr }), s = Fe(e, t, n, { type: zr });
  return vc(a, new Xp(s, r)), { left: a, right: s };
}
i(yc, "tokenRef");
function wC(e, t, r) {
  const n = r.referencedRule, a = e.ruleToStartState.get(n), s = Fe(e, t, r, { type: zr }), o = Fe(e, t, r, { type: zr }), l = new Jp(a, n, o);
  return vc(s, l), { left: s, right: o };
}
i(wC, "ruleRef");
function IC(e, t, r) {
  ...
  return Pe(r.right, a), { left: n, right: a };
}
i(IC, "buildRuleHandle");
function Pe(e, t) {
  const r = new gC(t);
  vc(e, r);
}
i(Pe, "epsilon");
function Fe(e, t, r, n) {
  const a = Object.assign({ atn: e, production: r, epsilonOnlyTransitions: false, rule: t, transitions: [], nextTokenWithinRule: [], stateNumber: e.states.length }, n);
...
var dl = {}, bd = (_ha = class {
  ...
  get alts() {
    return yr(this.configs, (e) => e.alt);
  }
  get key() {
    let e = "";
...
var E1 = PC;
function OC(e) {
  return e && e.length ? A1(e, Hp, E1) : void 0;
}
i(OC, "min");
var _1 = OC, eg = tr ? tr.isConcatSpreadable : void 0;
function LC(e) {
  return et(e) || uc(e) || !!(eg && e && e[eg]);
}
i(LC, "isFlattenable");
var C1 = LC;
function rh(e, t, r, n, a) {
  ...
  for (r || (r = C1), a || (a = []); ++s < o; ) {
    var l = e[s];
    t > 0 && r(l) ? t > 1 ? rh(l, t - 1, r, n, a) : i_(a, l) : n || (a[a.length] = l);
  }
  return a;
}
i(rh, "baseFlatten");
...
i(zC, "arrayIncludesWith");
var P1 = zC;
function BC() {
}
i(BC, "noop");
var O1 = BC, L1 = 1 / 0, D1 = Pa && 1 / Up(new Pa([, -0]))[1] == L1 ? function(e) {
  return new Pa(e);
} : O1, M1 = D1, x1 = 200;
function KC(e, t, r) {
  var n = -1, a = k1, s = e.length, o = true, l = [], c = l;
  if (r) o = false, a = P1;
  else if (s >= x1) {
    var u = t ? null : M1(e);
    if (u) return Up(u);
    o = false, a = ZE, c = new YE();
  } else c = t ? [] : l;
  e: for (; ++n < s; ) {
    var d = e[n], f = t ? t(d) : d;
    if (d = r || d !== 0 ? d : 0, o && f === f) {
...
i(YC, "forEach");
var Gc = YC, B1 = "[object Map]", K1 = "[object Set]", q1 = Object.prototype, W1 = q1.hasOwnProperty;
function XC(e) {
  if (e == null) return true;
  if (dc(e) && (et(e) || typeof e == "string" || typeof e.splice == "function" || ul(e) || Bp(e) || uc(e))) return !e.length;
  var t = Sd(e);
  if (t == B1 || t == K1) return !e.size;
  if (__(e)) return !b_(e).length;
  for (var r in e) if (W1.call(e, r)) return false;
  return true;
}
i(XC, "isEmpty");
var V1 = XC;
...
var Y1 = ZC;
function QC(e, t, r) {
  var n = et(e) ? H1 : Y1, a = arguments.length < 3;
  return n(e, mc(t), r, a, gc);
}
i(QC, "reduce");
var tg = QC;
function eS(e, t) {
  ...
  return (n) => {
    const a = n.toString();
    let s = r[a];
    return s !== void 0 || (s = { atnStartState: e, decision: t, states: {} }, r[a] = s), s;
  };
}
i(eS, "createDFACache");
var tS = (_ia = class {
...
}, i(_ia, "PredicateSet"), _ia), rg = new tS(), X1 = (_ja = class extends xp {
  constructor(e) {
    var t;
    super(), this.logging = (t = e == null ? void 0 : e.logging) !== null && t !== void 0 ? t : ((r) => console.log(r));
  }
  initialize(e) {
    this.atn = yC(e.rules), this.dfas = rS(this.atn);
  }
  ...
  buildLookaheadForAlternation(e) {
    const { prodOccurrence: t, rule: r, hasPredicates: n, dynamicTokensEnabled: a } = e, s = this.dfas, o = this.logging, l = Nn(r, "Alternation", t), u = this.atn.decisionMap[l].decision, d = yr(pd({ maxLookahead: 1, occurrence: t, prodType: "Alternation", rule: r }), (f) => yr(f, (h) => h[0]));
    if (wd(d, false) && !a) {
      const f = tg(d, (h, y, v) => (Gc(y, (C) => {
        C && (h[C.tokenTypeIdx] = v, Gc(C.categoryMatches, (b) => {
          h[b] = v;
        }));
      }), h), {});
      return n ? function(h) {
        var y;
        const v = this.LA(1), C = f[v.tokenTypeIdx];
        if (h !== void 0 && C !== void 0) {
          const b = (y = h[C]) === null || y === void 0 ? void 0 : y.GATE;
          if (b !== void 0 && b.call(this) === false) return;
        }
        return C;
      } : function() {
        const h = this.LA(1);
    ...
    } else return n ? function(f) {
      const h = new tS(), y = f === void 0 ? 0 : f.length;
      for (let C = 0; C < y; C++) {
        const b = f == null ? void 0 : f[C].GATE;
        h.set(C, b === void 0 || b.call(this));
      }
      const v = wo.call(this, s, u, h, o);
      return typeof v == "number" ? v : void 0;
    } : function() {
      const f = wo.call(this, s, u, rg, o);
      return typeof f == "number" ? f : void 0;
    };
  }
  buildLookaheadForOptional(e) {
    const { prodOccurrence: t, rule: r, prodType: n, dynamicTokensEnabled: a } = e, s = this.dfas, o = this.logging, l = Nn(r, n, t), u = this.atn.decisionMap[l].decision, d = yr(pd({ maxLookahead: 1, occurrence: t, prodType: n, rule: r }), (f) => yr(f, (h) => h[0]));
    if (wd(d) && d[0][0] && !a) {
      const f = d[0], h = j1(f);
      if (h.length === 1 && V1(h[0].categoryMatches)) {
        const v = h[0].tokenTypeIdx;
        return function() {
          return this.LA(1).tokenTypeIdx === v;
        };
      } else {
        const y = tg(h, (v, C) => (C !== void 0 && (v[C.tokenTypeIdx] = true, Gc(C.categoryMatches, (b) => {
          v[b] = true;
        })), v), {});
        return function() {
          const v = this.LA(1);
          return y[v.tokenTypeIdx] === true;
        };
      }
    }
    return function() {
      const f = wo.call(this, s, u, rg, o);
      return typeof f == "object" ? false : f === 0;
    };
  }
}, i(_ja, "LLStarLookaheadStrategy"), _ja);
function wd(e, t = true) {
  ...
  for (const n of e) {
    ...
    for (const s of n) {
      ...
      for (const l of o) if (r.has(l)) {
        if (!a.has(l)) return false;
      } else r.add(l), a.add(l);
    }
  }
  return true;
}
...
function rS(e) {
  ...
  for (let n = 0; n < t; n++) r[n] = eS(e.decisionStates[n], n);
  return r;
}
i(rS, "initATNSimulator");
function wo(e, t, r, n) {
  const a = e[t](r);
  let s = a.start;
  if (s === void 0) {
    const l = pS(a.atnStartState);
    s = ah(a, nh(l)), a.start = s;
  }
  return nS.apply(this, [a, s, r, n]);
}
i(wo, "adaptivePredict");
function nS(e, t, r, n) {
  let a = t, s = 1;
  const o = [];
  let l = this.LA(s++);
  for (; ; ) {
    let c = cS(a, l);
    if (c === void 0 && (c = aS.apply(this, [e, a, l, s, r, n])), c === dl) return lS(o, a, l);
    if (c.isAcceptState === true) return c.prediction;
    a = c, o.push(l), l = this.LA(s++);
  }
}
i(nS, "performLookahead");
function aS(e, t, r, n, a, s) {
  const o = uS(t.configs, r, a);
  if (o.size === 0) return Id(e, t, r, dl), dl;
  let l = nh(o);
  const c = fS(o, a);
  if (c !== void 0) l.isAcceptState = true, l.prediction = c, l.configs.uniqueAlt = c;
  else if (yS(o)) {
    const u = _1(o.alts);
    l.isAcceptState = true, l.prediction = u, l.configs.uniqueAlt = u, iS.apply(this, [e, n, o.alts, s]);
  }
  return l = Id(e, t, r, l), l;
}
i(aS, "computeLookaheadTarget");
function iS(e, t, r, n) {
  const a = [];
  for (let u = 1; u <= t; u++) a.push(this.LA(u).tokenType);
  const s = e.atnStartState, o = s.rule, l = s.production, c = sS({ topLevelRule: o, ambiguityIndices: r, production: l, prefixPath: a });
  n(c);
}
i(iS, "reportLookaheadAmbiguity");
function sS(e) {
  const t = yr(e.prefixPath, (a) => Cn(a)).join(", "), r = e.production.idx === 0 ? "" : e.production.idx;
  let n = `Ambiguous Alternatives Detected: <${e.ambiguityIndices.join(", ")}> in <${oS(e.production)}${r}> inside <${e.topLevelRule.name}> Rule,
<${t}> may appears as a prefix path in all these alternatives.
`;
  return n = n + `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`, n;
}
i(sS, "buildAmbiguityError");
function oS(e) {
  if (e instanceof Ze) return "SUBRULE";
  if (e instanceof Be) return "OPTION";
  if (e instanceof lt) return "OR";
...
i(oS, "getProductionDslName");
function lS(e, t, r) {
  const n = S1(t.configs.elements, (s) => s.state.transitions), a = G1(n.filter((s) => s instanceof Xp).map((s) => s.tokenType), (s) => s.tokenTypeIdx);
  return { actualToken: r, possibleTokenTypes: a, tokenPath: e };
}
i(lS, "buildAdaptivePredictError");
function cS(e, t) {
  return e.edges[t.tokenTypeIdx];
}
i(cS, "getExistingTargetState");
function uS(e, t, r) {
  const n = new bd(), a = [];
  for (const o of e.elements) {
    ...
    for (let c = 0; c < l; c++) {
      const u = o.state.transitions[c], d = dS(u, t);
  ...
  if (a.length === 0 && n.size === 1 && (s = n), s === void 0) {
    s = new bd();
    for (const o of n.elements) $s(o, s);
  }
  if (a.length > 0 && !mS(s)) for (const o of a) s.add(o);
  return s;
}
i(uS, "computeReachSet");
function dS(e, t) {
  if (e instanceof Xp && Np(t, e.tokenType)) return e.target;
}
i(dS, "getReachableTarget");
function fS(e, t) {
  let r;
  for (const n of e.elements) if (t.is(n.alt) === true) {
    if (r === void 0) r = n.alt;
...
i(nh, "newDFAState");
function Id(e, t, r, n) {
  return n = ah(e, n), t.edges[r.tokenTypeIdx] = n, n;
}
i(Id, "addDFAEdge");
function ah(e, t) {
  if (t === dl) return t;
...
i(ah, "addDFAState");
function pS(e) {
  const t = new bd(), r = e.transitions.length;
  for (let n = 0; n < r; n++) {
    const s = { state: e.transitions[n].target, alt: n, stack: [] };
    $s(s, t);
  }
  return t;
}
i(pS, "computeStartState");
function $s(e, t) {
  const r = e.state;
  if (r.type === Bs) {
    if (e.stack.length > 0) {
      const a = [...e.stack], o = { state: a.pop(), alt: e.alt, stack: a };
      $s(o, t);
    } else t.add(e);
    return;
  }
  ...
  for (let a = 0; a < n; a++) {
    const s = r.transitions[a], o = hS(e, s);
    o !== void 0 && $s(o, t);
  }
}
i($s, "closure");
function hS(e, t) {
  if (t instanceof gC) return { state: t.target, alt: e.alt, stack: e.stack };
  if (t instanceof Jp) {
    const r = [...e.stack, t.followState];
    return { state: t.target, alt: e.alt, stack: r };
  }
}
i(hS, "getEpsilonTarget");
function mS(e) {
  for (const t of e.elements) if (t.state.type === Bs) return true;
  return false;
}
i(mS, "hasConfigInRuleStopState");
function gS(e) {
  for (const t of e.elements) if (t.state.type !== Bs) return false;
  return true;
}
i(gS, "allConfigsInRuleStopStates");
function yS(e) {
  if (gS(e)) return true;
  const t = vS(e.elements);
  return TS(t) && !RS(t);
}
i(yS, "hasConflictTerminatingPrediction");
function vS(e) {
  const t = /* @__PURE__ */ new Map();
  for (const r of e) {
    const n = th(r, false);
    let a = t.get(n);
    a === void 0 && (a = {}, t.set(n, a)), a[r.alt] = true;
  }
  return t;
}
i(vS, "getConflictingAltSets");
function TS(e) {
  for (const t of Array.from(e.values())) if (Object.keys(t).length > 1) return true;
  return false;
}
i(TS, "hasConflictingAltSet");
function RS(e) {
  for (const t of Array.from(e.values())) if (Object.keys(t).length === 1) return true;
  return false;
}
i(RS, "hasStateAssociatedWithOneAlt");
_s();
var $S = (_ka = class {
  constructor() {
    this.nodeStack = [];
  ...
  buildRootNode(e) {
    return this.rootNode = new sh(e), this.rootNode.root = this.rootNode, this.nodeStack = [this.rootNode], this.rootNode;
  }
  ...
  buildLeafNode(e, t) {
    const r = new fl(e.startOffset, e.image.length, ls(e), e.tokenType, !t);
  ...
  addHiddenNodes(e) {
    const t = [];
    for (const a of e) {
      const s = new fl(a.startOffset, a.image.length, ls(a), a.tokenType, true);
    ...
    for (; r.container; ) {
      ...
      if (a > 0) {
        r.container.content.splice(a, 0, ...t), n = true;
        break;
      }
      r = r.container;
    }
...
}, i(_ka, "CstNodeBuilder"), _ka), ih = (_la = class {
  get hidden() {
    return false;
  }
  get astNode() {
    var _a3, _b3;
    const e = typeof ((_a3 = this._astNode) == null ? void 0 : _a3.$type) == "string" ? this._astNode : (_b3 = this.container) == null ? void 0 : _b3.astNode;
...
}, i(_la, "AbstractCstNode"), _la), fl = (_ma = class extends ih {
  get offset() {
    return this._offset;
  }
  get length() {
  ...
  constructor(e, t, r, n, a = false) {
    super(), this._hidden = a, this._offset = e, this._tokenType = n, this._length = t, this._range = r;
  }
}, i(_ma, "LeafCstNodeImpl"), _ma), Tc = (_na = class extends ih {
  constructor() {
    super(...arguments), this.content = new J1(this);
  }
  get offset() {
    var _a3;
...
}, i(_na, "CompositeCstNodeImpl"), _na), J1 = (_oa = class extends Array {
  constructor(t) {
  ...
  addParents(t) {
    for (const r of t) r.container = this.parent;
  }
}, i(_oa, "CstNodeContainer"), _oa), sh = (_pa = class extends Tc {
  get text() {
...
}, i(_pa, "RootCstNodeImpl"), _pa), pl = Symbol("Datatype");
function Io(e) {
  return e.$type === pl;
}
i(Io, "isDataTypeNode");
var ng = "\u200B", ES = i((e) => e.endsWith(ng) ? e : e + ng, "withRuleSuffix"), oh = (_qa = class {
  constructor(e) {
    var _a3;
...
}, i(_qa, "AbstractLangiumParser"), _qa), _S = (_ra = class extends oh {
  get current() {
    return this.stack[this.stack.length - 1];
  }
  constructor(e) {
    super(e), this.nodeBuilder = new $S(), this.stack = [], this.assignmentMap = /* @__PURE__ */ new Map(), this.operatorPrecedence = /* @__PURE__ */ new Map(), this.linker = e.references.Linker, this.converter = e.parser.ValueConverter, this.astReflection = e.shared.AstReflection;
  }
  rule(e, t) {
    const r = this.computeRuleType(e);
    let n;
    xa(e) && (n = e.name, this.registerPrecedenceMap(e));
    const a = this.wrapper.DEFINE_RULE(ES(e.name), this.startImplementation(r, n, t).bind(this));
  ...
  registerPrecedenceMap(e) {
    ...
    for (let n = 0; n < e.operators.precedences.length; n++) {
      ...
      for (const s of a.operators) r.set(s.value, { precedence: n, rightAssoc: a.associativity === "right" });
    }
    this.operatorPrecedence.set(t, r);
  }
  computeRuleType(e) {
    return xa(e) ? bn(e) : e.fragment ? void 0 : ws(e) ? pl : bn(e);
  }
  parse(e, t = {}) {
    ...
    return this.nodeBuilder.addHiddenNodes(r.hidden), this.unorderedGroups.clear(), this.lexerResult = void 0, Da(a, { deep: true }), { value: a, lexerErrors: r.errors, lexerReport: r.report, parserErrors: this.wrapper.errors };
  }
  doParse(e) {
  ...
  startImplementation(e, t, r) {
    return (n) => {
      ...
      if (a) {
        const s = { $type: e };
        this.stack.push(s), e === pl ? s.value = "" : t !== void 0 && (s.$infixName = t);
      }
  ...
  consume(e, t, r) {
    ...
    if (!this.isRecording() && this.isValidToken(n)) {
      ...
      if (o) {
        const u = Rr(r) ? n.image : this.converter.convert(n.image, s);
        this.assign(o.operator, o.feature, u, s, l);
      } else if (Io(c)) {
        let u = n.image;
        Rr(r) || (u = this.converter.convert(u, s).toString()), c.value += u;
      }
    }
  }
  isValidToken(e) {
  ...
  construct() {
    ...
    return this.nodeBuilder.construct(e), "$infixName" in e ? this.constructInfix(e, this.operatorPrecedence.get(e.$infixName)) : Io(e) ? this.converter.convert(e.value, e.$cstNode) : (af(this.astReflection, e), e);
  }
  constructInfix(e, t) {
    const r = e.parts;
    ...
    for (let v = 0; v < n.length; v++) {
      const C = n[v], b = t.get(C) ?? { precedence: 1 / 0, rightAssoc: false };
      b.precedence > s ? (s = b.precedence, a = v) : b.precedence === s && (b.rightAssoc || (a = v));
    }
    const o = n.slice(0, a), l = n.slice(a + 1), c = r.slice(0, a + 1), u = r.slice(a + 1), d = { $infixName: e.$infixName, $type: e.$type, $cstNode: e.$cstNode, parts: c, operators: o }, f = { $infixName: e.$infixName, $type: e.$type, $cstNode: e.$cstNode, parts: u, operators: l }, h = this.constructInfix(d, t), y = this.constructInfix(f, t);
    return { $type: e.$type, $cstNode: e.$cstNode, left: h, operator: n[a], right: y };
  }
  getAssignment(e) {
    if (!this.assignmentMap.has(e)) {
      const t = On(e, Tr);
      this.assignmentMap.set(e, { assignment: t, crossRef: t && Dn(t.terminal) ? t.terminal.isMulti ? "multi" : "single" : void 0 });
    }
...
}, i(_ra, "LangiumParser"), _ra), CS = (_sa = class {
  buildMismatchTokenMessage(e) {
    return wa.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return wa.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return wa.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return wa.buildEarlyExitMessage(e);
  }
}, i(_sa, "AbstractParserErrorMessageProvider"), _sa), lh = (_ta = class extends CS {
...
}, i(_ta, "LangiumParserErrorMessageProvider"), _ta), SS = (_ua = class extends oh {
  constructor() {
  ...
  rule(e, t) {
    const r = this.wrapper.DEFINE_RULE(ES(e.name), this.startImplementation(t).bind(this));
...
}, i(_ua, "LangiumCompletionParser"), _ua), Z1 = { recoveryEnabled: true, nodeLocationTracking: "full", skipValidations: true, errorMessageProvider: new lh() }, bS = (_va = class extends FL {
  constructor(e, t) {
    const r = t && "maxLookahead" in t;
    super(e, { ...Z1, lookaheadStrategy: r ? new xp({ maxLookahead: t.maxLookahead }) : new X1({ logging: t.skipValidations ? () => {
    } : void 0 }), ...t });
  }
  get IS_RECORDING() {
...
}, i(_va, "ChevrotainWrapper"), _va), Q1 = (_wa = class extends bS {
  constructor(e, t, r) {
...
}, i(_wa, "ProfilerWrapper"), _wa);
function Rc(e, t, r) {
  return wS({ parser: t, tokens: r, ruleNames: /* @__PURE__ */ new Map() }, e), t;
}
i(Rc, "createParser");
function wS(e, t) {
  const r = Dl(t, false), n = oe(t.rules).filter(Je).filter((s) => r.has(s));
  for (const s of n) {
    const o = { ...e, consume: 1, optional: 1, subrule: 1, many: 1, or: 1 };
    e.parser.rule(s, Br(o, s.definition));
  }
  const a = oe(t.rules).filter(xa).filter((s) => r.has(s));
  for (const s of a) e.parser.rule(s, IS(e, s));
}
i(wS, "buildRules");
function IS(e, t) {
  ...
  const n = t.operators.precedences.flatMap((y) => y.operators), a = { $type: "Group", elements: [] }, s = { $container: a, $type: "Assignment", feature: "parts", operator: "+=", terminal: t.call }, o = { $container: a, $type: "Group", elements: [], cardinality: "*" };
  a.elements.push(s, o);
  const c = { $container: o, $type: "Assignment", feature: "operators", operator: "+=", terminal: { $type: "Alternatives", elements: n } }, u = { ...s, $container: o };
  o.elements.push(c, u);
  const f = n.map((y) => e.tokens[y.value]).map((y, v) => ({ ALT: i(() => e.parser.consume(v, y, c), "ALT") }));
  let h;
  return (y) => {
    h ?? (h = $c(e, r)), e.parser.subrule(0, h, false, s, y), e.parser.many(0, { DEF: i(() => {
      e.parser.alternatives(0, f), e.parser.subrule(1, h, false, u, y);
    }, "DEF") });
  };
}
i(IS, "buildInfixRule");
function Br(e, t, r = false) {
  let n;
  if (Rr(t)) n = MS(e, t);
  else if (Gr(t)) n = NS(e, t);
  else if (Tr(t)) n = Br(e, t.terminal);
  else if (Dn(t)) n = ch(e, t);
  else if ($r(t)) n = kS(e, t);
  else if (Sl(t)) n = OS(e, t);
  else if (Nl(t)) n = LS(e, t);
  else if (Mn(t)) n = DS(e, t);
  else if (ff(t)) {
    const a = e.consume++;
    n = i(() => e.parser.consume(a, Ur, t), "method");
  } else throw new Pl(t.$cstNode, `Unexpected element type: ${t.$type}`);
  return uh(e, r ? void 0 : As(t), n, t.cardinality);
}
i(Br, "buildElement");
function NS(e, t) {
  const r = bn(t);
...
function kS(e, t) {
  const r = t.rule.ref;
  if (Ln(r)) {
    const n = e.subrule++, a = Je(r) && r.fragment, s = t.arguments.length > 0 ? PS(r, t.arguments) : () => ({});
    let o;
    return (l) => {
      o ?? (o = $c(e, r)), e.parser.subrule(n, o, a, t, s(l));
    };
  } else if (bt(r)) {
    const n = e.consume++, a = hl(e, r.name);
    return () => e.parser.consume(n, a, t);
  } else if (r) qr();
  else throw new Pl(t.$cstNode, `Undefined rule: ${t.rule.$refText}`);
}
i(kS, "buildRuleCall");
function PS(e, t) {
  if (t.some((n) => n.calledByName)) {
    const n = t.map((a) => {
      var _a3, _b3;
      return { parameterName: (_b3 = (_a3 = a.parameter) == null ? void 0 : _a3.ref) == null ? void 0 : _b3.name, predicate: Lt(a.value) };
    });
    return (a) => {
      const s = {};
      for (const { parameterName: o, predicate: l } of n) o && (s[o] = l(a));
      return s;
    };
  } else {
    ...
    return (a) => {
      const s = {};
      for (let o = 0; o < n.length; o++) if (o < e.parameters.length) {
...
i(Lt, "buildPredicate");
function OS(e, t) {
  if (t.elements.length === 1) return Br(e, t.elements[0]);
  {
    const r = [];
    for (const a of t.elements) {
      const s = { ALT: Br(e, a, true) }, o = As(a);
      o && (s.GATE = Lt(o)), r.push(s);
    }
    const n = e.or++;
    return (a) => e.parser.alternatives(n, r.map((s) => {
      const o = { ALT: i(() => s.ALT(a), "ALT") }, l = s.GATE;
      return l && (o.GATE = () => l(a)), o;
    }));
  }
}
i(OS, "buildAlternatives");
function LS(e, t) {
  if (t.elements.length === 1) return Br(e, t.elements[0]);
  const r = [];
  for (const l of t.elements) {
    const c = { ALT: Br(e, l, true) }, u = As(l);
    u && (c.GATE = Lt(u)), r.push(c);
  }
  const n = e.or++, a = i((l, c) => {
    const u = c.getRuleStack().join("-");
    return `uGroup_${l}_${u}`;
  }, "idFunc"), s = i((l) => e.parser.alternatives(n, r.map((c, u) => {
    const d = { ALT: i(() => true, "ALT") }, f = e.parser;
    d.ALT = () => {
      if (c.ALT(l), !f.isRecording()) {
        const y = a(n, f);
        f.unorderedGroups.get(y) || f.unorderedGroups.set(y, []);
        const v = f.unorderedGroups.get(y);
        typeof (v == null ? void 0 : v[u]) > "u" && (v[u] = true);
      }
    };
    const h = c.GATE;
    return h ? d.GATE = () => h(l) : d.GATE = () => {
      var _a3;
      return !((_a3 = f.unorderedGroups.get(a(n, f))) == null ? void 0 : _a3[u]);
    }, d;
  })), "alternatives"), o = uh(e, As(t), s, "*");
  return (l) => {
    o(l), e.parser.isRecording() || e.parser.unorderedGroups.delete(a(n, e.parser));
  };
}
i(LS, "buildUnorderedGroup");
function DS(e, t) {
  const r = t.elements.map((n) => Br(e, n));
  return (n) => r.forEach((a) => a(n));
}
i(DS, "buildGroup");
function As(e) {
  if (Mn(e)) return e.guardCondition;
}
i(As, "getGuardCondition");
function ch(e, t, r = t.terminal) {
  var _a3;
  if (r) if ($r(r) && Je(r.rule.ref)) {
    const n = r.rule.ref, a = e.subrule++;
    let s;
    return (o) => {
      s ?? (s = $c(e, n)), e.parser.subrule(a, s, false, t, o);
    };
  } else if ($r(r) && bt(r.rule.ref)) {
    const n = e.consume++, a = hl(e, r.rule.ref.name);
    return () => e.parser.consume(n, a, t);
  } else if (Rr(r)) {
    const n = e.consume++, a = hl(e, r.value);
    return () => e.parser.consume(n, a, t);
    ...
    const a = (_a3 = Gl(t.type.ref)) == null ? void 0 : _a3.terminal;
    if (!a) throw new Error("Could not find name assignment for type: " + bn(t.type.ref));
    return ch(e, t, a);
  }
}
i(ch, "buildCrossReference");
function MS(e, t) {
...
function uh(e, t, r, n) {
  ...
  if (!n) if (a) {
    const s = e.or++;
    return (o) => e.parser.alternatives(s, [{ ALT: i(() => r(o), "ALT"), GATE: i(() => a(o), "GATE") }, { ALT: Ad(), GATE: i(() => !a(o), "GATE") }]);
  } else return r;
  if (n === "*") {
    const s = e.many++;
    return (o) => e.parser.many(s, { DEF: i(() => r(o), "DEF"), GATE: a ? () => a(o) : void 0 });
  } else if (n === "+") {
    const s = e.many++;
    if (a) {
      const o = e.or++;
      return (l) => e.parser.alternatives(o, [{ ALT: i(() => e.parser.atLeastOne(s, { DEF: i(() => r(l), "DEF") }), "ALT"), GATE: i(() => a(l), "GATE") }, { ALT: Ad(), GATE: i(() => !a(l), "GATE") }]);
    } else return (o) => e.parser.atLeastOne(s, { DEF: i(() => r(o), "DEF") });
  } else if (n === "?") {
    const s = e.optional++;
    return (o) => e.parser.optional(s, { DEF: i(() => r(o), "DEF"), GATE: a ? () => a(o) : void 0 });
  } else qr();
}
i(uh, "wrap");
function $c(e, t) {
  const r = xS(e, t), n = e.parser.getRule(r);
...
function xS(e, t) {
  ...
  if (e.ruleNames.has(t)) return e.ruleNames.get(t);
  {
    ...
    for (; !Je(n); ) (Mn(n) || Sl(n) || Nl(n)) && (a = n.elements.indexOf(r).toString() + ":" + a), r = n, n = n.$container;
...
i(hl, "getToken");
function dh(e) {
  const t = e.Grammar, r = e.parser.Lexer, n = new SS(e);
  return Rc(t, n, r.definition), n.finalize(), n;
}
i(dh, "createCompletionParser");
function fh(e) {
  const t = ph(e);
  return t.finalize(), t;
}
...
function ph(e) {
  const t = e.Grammar, r = e.parser.Lexer, n = new _S(e);
  return Rc(t, n, r.definition);
}
i(ph, "prepareLangiumParser");
var Ac = (_xa = class {
  constructor() {
    this.diagnostics = [];
  }
  buildTokens(e, t) {
    const r = oe(Dl(e, false)), n = this.buildTerminalTokens(r), a = this.buildKeywordTokens(r, n, t);
    return a.push(...n), a;
  }
  flushLexingReport(e) {
  ...
  buildTerminalTokens(e) {
    return e.filter(bt).filter((t) => !t.fragment).map((t) => this.buildTerminalToken(t)).toArray();
  }
  buildTerminalToken(e) {
    const t = Ns(e), r = this.requiresCustomPattern(t) ? this.regexPatternFunction(t) : t, n = { name: e.name, PATTERN: r };
    return typeof r == "function" && (n.LINE_BREAKS = true), e.hidden && (n.GROUP = Ll(t) ? Xe.SKIPPED : "hidden"), n;
  }
  ...
  buildKeywordTokens(e, t, r) {
    return e.filter(Ln).flatMap((n) => wr(n).filter(Rr)).distinct((n) => n.value).toArray().sort((n, a) => a.value.length - n.value.length).map((n) => this.buildKeywordToken(n, t, !!(r == null ? void 0 : r.caseInsensitive)));
  }
  buildKeywordToken(e, t, r) {
    const n = this.buildKeywordPattern(e, r), a = { name: e.value, PATTERN: n, LONGER_ALT: this.findLongerAlt(e, t) };
    return typeof n == "function" && (a.LINE_BREAKS = true), a;
  }
  buildKeywordPattern(e, t) {
    return t ? new RegExp(Va(e.value), "i") : e.value;
  }
  findLongerAlt(e, t) {
    return t.reduce((r, n) => {
      const a = n == null ? void 0 : n.PATTERN;
      return (a == null ? void 0 : a.source) && Ff("^" + a.source + "$", e.value) && r.push(n), r;
    }, []);
  }
}, i(_xa, "DefaultTokenBuilder"), _xa), hh = (_ya = class {
  convert(e, t) {
  ...
  runConverter(e, t, r) {
    ...
    switch (e.name.toUpperCase()) {
      case "INT":
        return Yt.convertInt(t);
      case "STRING":
        return Yt.convertString(t);
      case "ID":
        return Yt.convertID(t);
    }
    switch ((_a3 = Zf(e)) == null ? void 0 : _a3.toLowerCase()) {
      case "number":
        return Yt.convertNumber(t);
      case "boolean":
        return Yt.convertBoolean(t);
      case "bigint":
        return Yt.convertBigint(t);
      case "date":
        return Yt.convertDate(t);
      default:
        return t;
    }
  }
}, i(_ya, "DefaultValueConverter"), _ya), Yt;
(function(e) {
  function t(u) {
    let d = "";
...
var No = 0, FS = 10;
function _c() {
  return No = performance.now(), new pe.CancellationTokenSource();
}
i(_c, "startCancelableOperation");
function mh(e) {
  FS = e;
}
i(mh, "setInterruptionPeriod");
var Zt = Symbol("OperationCancelled");
function Jn(e) {
  return e === Zt;
}
i(Jn, "isOperationCancelled");
async function Ge(e) {
  if (e === pe.CancellationToken.None) return;
  const t = performance.now();
  if (t - No >= FS && (No = t, await Ec(), No = performance.now()), e.isCancellationRequested) throw Zt;
}
...
var Sr = (_za = class {
...
}, i(_za, "Deferred"), _za), ag = (_Aa = class {
  constructor(t, r, n, a) {
  ...
  update(t, r) {
    for (const n of t) if (_Aa.isIncremental(n)) {
      const a = yh(n.range), s = this.offsetAt(a.start), o = this.offsetAt(a.end);
      ...
      const d = kd(n.text, false, s);
      if (c - l === d.length) for (let h = 0, y = d.length; h < y; h++) u[h + l + 1] = d[h];
      else d.length < 1e4 ? u.splice(l + 1, c - l, ...d) : this._lineOffsets = u = u.slice(0, l + 1).concat(d, u.slice(c + 1));
      const f = n.text.length - (o - s);
      if (f !== 0) for (let h = l + 1 + d.length, y = u.length; h < y; h++) u[h] = u[h] + f;
    } else if (_Aa.isFull(n)) this._content = n.text, this._lineOffsets = void 0;
    else throw new Error("Unknown change event received");
    this._version = r;
  }
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = kd(this._content, true)), this._lineOffsets;
  }
  positionAt(t) {
    t = Math.max(Math.min(t, this._content.length), 0);
    const r = this.getLineOffsets();
    let n = 0, a = r.length;
    if (a === 0) return { line: 0, character: t };
    for (; n < a; ) {
  ...
  ensureBeforeEOL(t, r) {
    for (; t > r && gh(this._content.charCodeAt(t - 1)); ) t--;
    return t;
  }
  get lineCount() {
    return this.getLineOffsets().length;
...
}, i(_Aa, "FullTextDocument"), _Aa), ml;
(function(e) {
  function t(a, s, o, l) {
    return new ag(a, s, o, l);
  }
  i(t, "create"), e.create = t;
  function r(a, s, o) {
    if (a instanceof ag) return a.update(s, o), a;
    throw new Error("TextDocument.update: document must be created by TextDocument.create");
  }
  i(r, "update"), e.update = r;
  function n(a, s) {
    const o = a.getText(), l = gl(s.map(GS), (d, f) => {
      const h = d.range.start.line - f.range.start.line;
      return h === 0 ? d.range.start.character - f.range.start.character : h;
    });
    let c = 0;
    const u = [];
    for (const d of l) {
      ...
      f > c && u.push(o.substring(c, f)), d.newText.length && u.push(d.newText), c = a.offsetAt(d.range.end);
    }
...
function gl(e, t) {
  ...
  gl(n, t), gl(a, t);
  let s = 0, o = 0, l = 0;
  for (; s < n.length && o < a.length; ) t(n[s], a[o]) <= 0 ? e[l++] = n[s++] : e[l++] = a[o++];
...
function kd(e, t, r = 0) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    gh(s) && (s === 13 && a + 1 < e.length && e.charCodeAt(a + 1) === 10 && a++, n.push(r + a + 1));
  }
  return n;
}
i(kd, "computeLineOffsets");
function gh(e) {
  return e === 13 || e === 10;
}
i(gh, "isEOL");
...
i(yh, "getWellformedRange");
function GS(e) {
  const t = yh(e.range);
  return t !== e.range ? { newText: e.newText, range: t } : e;
}
i(GS, "getWellformedEdit");
var jS;
(() => {
  var e = { 975: (P) => {
    function _(T) {
    ...
    i(_, "e");
    function g(T, R) {
      for (var S, O = "", M = 0, D = -1, z = 0, B = 0; B <= T.length; ++B) {
        if (B < T.length) S = T.charCodeAt(B);
        else {
          if (S === 47) break;
          S = 47;
        }
    ...
    i(g, "r");
    var E = { resolve: i(function() {
      for (var T, R = "", S = false, O = arguments.length - 1; O >= -1 && !S; O--) {
        var M;
        O >= 0 ? M = arguments[O] : (T === void 0 && (T = process.cwd()), M = T), _(M), M.length !== 0 && (R = M + "/" + R, S = M.charCodeAt(0) === 47);
      }
      return R = g(R, !S), S ? R.length > 0 ? "/" + R : "/" : R.length > 0 ? R : ".";
    }, "resolve"), normalize: i(function(T) {
      if (_(T), T.length === 0) return ".";
      var R = T.charCodeAt(0) === 47, S = T.charCodeAt(T.length - 1) === 47;
      return (T = g(T, !R)).length !== 0 || R || (T = "."), T.length > 0 && S && (T += "/"), R ? "/" + T : T;
    }, "normalize"), isAbsolute: i(function(T) {
      return _(T), T.length > 0 && T.charCodeAt(0) === 47;
    }, "isAbsolute"), join: i(function() {
      if (arguments.length === 0) return ".";
      for (var T, R = 0; R < arguments.length; ++R) {
        var S = arguments[R];
        _(S), S.length > 0 && (T === void 0 ? T = S : T += "/" + S);
      }
      return T === void 0 ? "." : E.normalize(T);
    }, "join"), relative: i(function(T, R) {
      if (_(T), _(R), T === R || (T = E.resolve(T)) === (R = E.resolve(R))) return "";
      for (var S = 1; S < T.length && T.charCodeAt(S) === 47; ++S) ;
      for (var O = T.length, M = O - S, D = 1; D < R.length && R.charCodeAt(D) === 47; ++D) ;
      for (var z = R.length - D, B = M < z ? M : z, Z = -1, J = 0; J <= B; ++J) {
        if (J === B) {
          if (z > B) {
            if (R.charCodeAt(D + J) === 47) return R.slice(D + J + 1);
            if (J === 0) return R.slice(D + J);
          } else M > B && (T.charCodeAt(S + J) === 47 ? Z = J : J === 0 && (Z = 0));
          break;
        }
        var te = T.charCodeAt(S + J);
        if (te !== R.charCodeAt(D + J)) break;
        te === 47 && (Z = J);
      }
      var de = "";
      for (J = S + Z + 1; J <= O; ++J) J !== O && T.charCodeAt(J) !== 47 || (de.length === 0 ? de += ".." : de += "/..");
      return de.length > 0 ? de + R.slice(D + Z) : (D += Z, R.charCodeAt(D) === 47 && ++D, R.slice(D));
    }, "relative"), _makeLong: i(function(T) {
      return T;
    }, "_makeLong"), dirname: i(function(T) {
      if (_(T), T.length === 0) return ".";
      for (var R = T.charCodeAt(0), S = R === 47, O = -1, M = true, D = T.length - 1; D >= 1; --D) if ((R = T.charCodeAt(D)) === 47) {
        if (!M) {
          O = D;
          break;
        }
      } else M = false;
      return O === -1 ? S ? "/" : "." : S && O === 1 ? "//" : T.slice(0, O);
    }, "dirname"), basename: i(function(T, R) {
      if (R !== void 0 && typeof R != "string") throw new TypeError('"ext" argument must be a string');
      _(T);
      var S, O = 0, M = -1, D = true;
      if (R !== void 0 && R.length > 0 && R.length <= T.length) {
        ...
        for (S = T.length - 1; S >= 0; --S) {
          ...
          } else B === -1 && (D = false, B = S + 1), z >= 0 && (Z === R.charCodeAt(z) ? --z == -1 && (M = S) : (z = -1, M = B));
        }
      ...
      } else M === -1 && (D = false, M = S + 1);
      return M === -1 ? "" : T.slice(O, M);
    }, "basename"), extname: i(function(T) {
      _(T);
      for (var R = -1, S = 0, O = -1, M = true, D = 0, z = T.length - 1; z >= 0; --z) {
        var B = T.charCodeAt(z);
        if (B !== 47) O === -1 && (M = false, O = z + 1), B === 46 ? R === -1 ? R = z : D !== 1 && (D = 1) : R !== -1 && (D = -1);
        else if (!M) {
          S = z + 1;
          break;
        }
      }
      return R === -1 || O === -1 || D === 0 || D === 1 && R === O - 1 && R === S + 1 ? "" : T.slice(R, O);
    }, "extname"), format: i(function(T) {
    ...
    }, "format"), parse: i(function(T) {
      _(T);
      var R = { root: "", dir: "", base: "", ext: "", name: "" };
      if (T.length === 0) return R;
      var S, O = T.charCodeAt(0), M = O === 47;
      M ? (R.root = "/", S = 1) : S = 0;
      for (var D = -1, z = 0, B = -1, Z = true, J = T.length - 1, te = 0; J >= S; --J) if ((O = T.charCodeAt(J)) !== 47) B === -1 && (Z = false, B = J + 1), O === 46 ? D === -1 ? D = J : te !== 1 && (te = 1) : D !== -1 && (te = -1);
      else if (!Z) {
        z = J + 1;
        break;
      }
  ...
  i(r, "r"), r.d = (P, _) => {
    for (var g in _) r.o(_, g) && !r.o(P, g) && Object.defineProperty(P, g, { enumerable: true, get: _[g] });
  ...
  var n = {};
  let a;
  r.r(n), r.d(n, { URI: i(() => h, "URI"), Utils: i(() => Ne, "Utils") }), typeof process == "object" ? a = process.platform === "win32" : typeof navigator == "object" && (a = navigator.userAgent.indexOf("Windows") >= 0);
  const s = /^\w[\w\d+.-]*$/, o = /^\//, l = /^\/\//;
  function c(P, _) {
  ...
  const _h3 = class _h3 {
    constructor(_, g, E, T, R, S = false) {
      ...
      typeof _ == "object" ? (this.scheme = _.scheme || u, this.authority = _.authority || u, this.path = _.path || u, this.query = _.query || u, this.fragment = _.fragment || u) : (this.scheme = /* @__PURE__ */ (function(O, M) {
        return O || M ? O : "file";
      })(_, S), this.authority = g || u, this.path = (function(O, M) {
        switch (O) {
          case "https":
          case "http":
          case "file":
        ...
        return M;
      })(this.scheme, E || u), this.query = T || u, this.fragment = R || u, c(this, S));
    }
    static isUri(_) {
      return _ instanceof _h3 || !!_ && typeof _.authority == "string" && typeof _.fragment == "string" && typeof _.path == "string" && typeof _.query == "string" && typeof _.scheme == "string" && typeof _.fsPath == "string" && typeof _.with == "function" && typeof _.toString == "function";
    }
    get fsPath() {
      return I(this, false);
    }
    with(_) {
      if (!_) return this;
      let { scheme: g, authority: E, path: T, query: R, fragment: S } = _;
      return g === void 0 ? g = this.scheme : g === null && (g = u), E === void 0 ? E = this.authority : E === null && (E = u), T === void 0 ? T = this.path : T === null && (T = u), R === void 0 ? R = this.query : R === null && (R = u), S === void 0 ? S = this.fragment : S === null && (S = u), g === this.scheme && E === this.authority && T === this.path && R === this.query && S === this.fragment ? this : new v(g, E, T, R, S);
    }
    static parse(_, g = false) {
      const E = f.exec(_);
      return E ? new v(E[2] || u, H(E[4] || u), H(E[5] || u), H(E[7] || u), H(E[9] || u), g) : new v(u, u, u, u, u);
    }
    static file(_) {
      let g = u;
      if (a && (_ = _.replace(/\\/g, d)), _[0] === d && _[1] === d) {
        const E = _.indexOf(d, 2);
        E === -1 ? (g = _.substring(2), _ = d) : (g = _.substring(2, E), _ = _.substring(E) || d);
      }
  ...
  const _v3 = class _v3 extends h {
    ...
    get fsPath() {
      return this._fsPath || (this._fsPath = I(this, false)), this._fsPath;
    }
    toString(_ = false) {
      return _ ? A(this, true) : (this._formatted || (this._formatted = A(this, false)), this._formatted);
    }
    toJSON() {
      const _ = { $mid: 1 };
  ...
  function b(P, _, g) {
    ...
    for (let R = 0; R < P.length; R++) {
      const S = P.charCodeAt(R);
      if (S >= 97 && S <= 122 || S >= 65 && S <= 90 || S >= 48 && S <= 57 || S === 45 || S === 46 || S === 95 || S === 126 || _ && S === 47 || g && S === 91 || g && S === 93 || g && S === 58) T !== -1 && (E += encodeURIComponent(P.substring(T, R)), T = -1), E !== void 0 && (E += P.charAt(R));
      else {
  ...
  function A(P, _) {
    const g = _ ? w : b;
    let E = "", { scheme: T, authority: R, path: S, query: O, fragment: M } = P;
    if (T && (E += T, E += ":"), (R || T === "file") && (E += d, E += d), R) {
      let D = R.indexOf("@");
      if (D !== -1) {
        const z = R.substr(0, D);
        R = R.substr(D + 1), D = z.lastIndexOf(":"), D === -1 ? E += g(z, false, false) : (E += g(z.substr(0, D), false, false), E += ":", E += g(z.substr(D + 1), false, true)), E += "@";
      }
      R = R.toLowerCase(), D = R.lastIndexOf(":"), D === -1 ? E += g(R, false, true) : (E += g(R.substr(0, D), false, true), E += R.substr(D));
    }
    if (S) {
    ...
    return O && (E += "?", E += g(O, false, false)), M && (E += "#", E += _ ? M : b(M, false, false)), E;
  }
  i(A, "b");
  function k(P) {
    try {
  ...
  (function(P) {
    P.joinPath = function(_, ...g) {
      ...
      let E = _.path, T = false;
      E[0] !== ce && (E = ce + E, T = true);
...
var { URI: dt, Utils: Si } = jS, Ye;
(function(e) {
  e.basename = Si.basename, e.dirname = Si.dirname, e.extname = Si.extname, e.joinPath = Si.joinPath, e.resolvePath = Si.resolvePath;
  const t = typeof process == "object" && (process == null ? void 0 : process.platform) === "win32";
  function r(o, l) {
    return (o == null ? void 0 : o.toString()) === (l == null ? void 0 : l.toString());
  }
  i(r, "equals"), e.equals = r;
  function n(o, l) {
    const c = typeof o == "string" ? dt.parse(o).path : o.path, u = typeof l == "string" ? dt.parse(l).path : l.path, d = c.split("/").filter((C) => C.length > 0), f = u.split("/").filter((C) => C.length > 0);
    if (t) {
      const C = /^[A-Z]:$/;
      if (d[0] && C.test(d[0]) && (d[0] = d[0].toLowerCase()), f[0] && C.test(f[0]) && (f[0] = f[0].toLowerCase()), d[0] !== f[0]) return u.substring(1);
    }
    let h = 0;
    for (; h < d.length && d[h] === f[h]; h++) ;
    const y = "../".repeat(d.length - h), v = f.slice(h).join("/");
    return y + v;
  }
  i(n, "relative"), e.relative = n;
  function a(o) {
    return dt.parse(o.toString()).toString();
  }
  i(a, "normalize"), e.normalize = a;
  function s(o, l) {
    let c = typeof o == "string" ? o : o.path, u = typeof l == "string" ? l : l.path;
    return u.charAt(u.length - 1) === "/" && (u = u.slice(0, -1)), c.charAt(c.length - 1) === "/" && (c = c.slice(0, -1)), u === c ? true : u.length < c.length || u.charAt(c.length) !== "/" ? false : u.startsWith(c);
  }
...
var vh = (_Ba = class {
  ...
  insert(e, t) {
    const r = this.getNode(this.normalizeUri(e), true);
    r.element = t;
  }
  delete(e) {
    const t = this.getNode(this.normalizeUri(e), false);
  ...
  findNode(e) {
    const t = this.normalizeUri(e), r = this.getNode(t, false);
    if (r) return { name: r.name, uri: Ye.joinPath(dt.parse(t), r.name).toString(), element: r.element };
  }
  findChildren(e) {
    const t = this.normalizeUri(e), r = this.getNode(t, false);
    return r ? Array.from(r.children.values()).map((n) => ({ name: n.name, uri: Ye.joinPath(dt.parse(t), n.name).toString(), element: n.element })) : [];
  }
  all() {
    return this.collectValues(this.root);
  }
  findAll(e) {
    const t = this.getNode(Ye.normalize(e), false);
  ...
  getNode(e, t) {
    ...
    for (const a of r) {
      ...
      if (!s) if (t) s = { name: a, children: /* @__PURE__ */ new Map(), parent: n }, n.children.set(a, s);
      else return;
      n = s;
    }
    return n;
  ...
  collectValues(e) {
    ...
    for (const r of e.children.values()) t.push(...this.collectValues(r));
    return t;
  }
}, i(_Ba, "UriTrie"), _Ba), Y;
(function(e) {
...
var US = (_Ca = class {
  ...
  createLangiumDocument(e, t, r, n) {
    let a;
    if (r) a = { parseResult: e, uri: t, state: Y.Parsed, references: [], textDocument: r };
    else {
      const s = this.createTextDocumentGetter(t, n);
      a = { parseResult: e, uri: t, state: Y.Parsed, references: [], get textDocument() {
        return s();
      } };
    }
  ...
  async update(e, t) {
    var _a3, _b3;
    const r = (_a3 = e.parseResult.value.$cstNode) == null ? void 0 : _a3.root.fullText, n = (_b3 = this.textDocuments) == null ? void 0 : _b3.get(e.uri.toString()), a = n ? n.getText() : await this.fileSystemProvider.readFile(e.uri);
  ...
  createTextDocumentGetter(e, t) {
    ...
    let n;
    return () => n ?? (n = ml.create(e.toString(), r.getServices(e).LanguageMetaData.languageId, 0, t ?? ""));
  }
}, i(_Ca, "DefaultLangiumDocumentFactory"), _Ca), zS = (_Da = class {
  constructor(e) {
    this.documentTrie = new vh(), this.services = e, this.langiumDocumentFactory = e.workspace.LangiumDocumentFactory, this.documentBuilder = () => e.workspace.DocumentBuilder;
  }
  get all() {
  ...
  deleteDocuments(e) {
    ...
    for (const n of r) n.state = Y.Changed;
    return this.documentTrie.delete(t), r;
  }
}, i(_Da, "DefaultLangiumDocuments"), _Da), sn = Symbol("RefResolving"), BS = (_Ea = class {
  constructor(e) {
  ...
  async link(e, t = pe.CancellationToken.None) {
    ...
    if ((_a3 = this.profiler) == null ? void 0 : _a3.isActive("linking")) {
      ...
      r.start();
      try {
        for (const n of Mt(e.parseResult.value)) await Ge(t), Ma(n).forEach((a) => {
    ...
    } else for (const r of Mt(e.parseResult.value)) await Ge(t), Ma(r).forEach((n) => this.doLink(n, e));
  }
  doLink(e, t) {
    const r = e.reference;
    if ("_ref" in r && r._ref === void 0) {
      ...
      try {
        ...
        r._ref = { info: e, message: `An error occurred while resolving reference to '${r.$refText}': ${a}` };
      }
      t.references.push(r);
  ...
  unlink(e) {
    for (const t of e.references) "_ref" in t ? (t._ref = void 0, delete t._nodeDescription) : "_items" in t && (t._items = void 0, delete t._linkingError);
    e.references = [];
  }
  getCandidate(e) {
  ...
  buildReference(e, t, r, n) {
    const a = this, s = { $refNode: r, $refText: n, _ref: void 0, get ref() {
      if (Le(this._ref)) return this._ref;
      if (tf(this._nodeDescription)) {
        ...
        this._ref = sn;
        const o = Ia(e).$document, l = a.getLinkedNode({ reference: s, container: e, property: t });
      ...
      } else this._ref === sn && a.throwCyclicReferenceError(e, t, n);
  ...
  buildMultiReference(e, t, r, n) {
    const a = this, s = { $refNode: r, $refText: n, _items: void 0, get items() {
      if (Array.isArray(this._items)) return this._items;
      if (this._items === void 0) {
        this._items = sn;
        const o = Ia(e).$document, l = a.getCandidates({ reference: s, container: e, property: t }), c = [];
        if (cn(l)) this._linkingError = l;
        else for (const u of l) {
          const d = a.loadAstNode(u);
          d && c.push({ ref: d, $nodeDescription: u });
        }
        this._items = c, o == null ? void 0 : o.references.push(this);
      } else this._items === sn && a.throwCyclicReferenceError(e, t, n);
      return Array.isArray(this._items) ? this._items : [];
    }, get error() {
      if (this._linkingError) return this._linkingError;
      if (!(this.items.length > 0)) return this._linkingError = a.createLinkingError({ reference: s, container: e, property: t });
    } };
    return s;
  }
  ...
  createLinkingError(e, t) {
    const r = Ia(e.container).$document;
...
var KS = (_Fa = class {
  ...
  getNameNode(e) {
    return Ml(e.$cstNode, "name");
  }
}, i(_Fa, "DefaultNameProvider"), _Fa), qS = (_Ga = class {
  constructor(e) {
    this.nameProvider = e.references.NameProvider, this.index = e.shared.workspace.IndexManager, this.nodeLocator = e.workspace.AstNodeLocator, this.documents = e.shared.workspace.LangiumDocuments, this.hasMultiReference = Mt(e.Grammar).some((t) => Dn(t) && t.isMulti);
  }
  findDeclarations(e) {
    if (e) {
      const t = Vf(e), r = e.astNode;
      if (t && r) {
        const n = r[t.feature];
        if (He(n) || Qt(n)) return Lo(n);
        if (Array.isArray(n)) {
          for (const a of n) if ((He(a) || Qt(a)) && a.$refNode && a.$refNode.offset <= e.offset && a.$refNode.end >= e.end) return Lo(a);
        }
      }
      if (r) {
        const n = this.nameProvider.getNameNode(r);
        if (n && (n === e || Sf(e, n))) return this.getSelfNodes(r);
      }
    }
    return [];
  }
  getSelfNodes(e) {
    if (this.hasMultiReference) {
      ...
      if (r) {
        for (const n of Ma(r)) if (Qt(n.reference) && n.reference.items.some((a) => a.ref === e)) return n.reference.items.map((a) => a.ref);
      }
      return [e];
    } else return [e];
  }
  ...
  getSelfReferences(e) {
    ...
    for (const n of t) {
      ...
      if (a) {
        ...
        r.push({ sourceUri: s.uri, sourcePath: o, targetUri: s.uri, targetPath: o, segment: Ga(a), local: true });
      }
    }
    return r;
  }
}, i(_Ga, "DefaultReferences"), _Ga), br = (_Ha = class {
  constructor(e) {
    if (this.map = /* @__PURE__ */ new Map(), e) for (const [t, r] of e) this.add(t, r);
  }
  get size() {
    return os.sum(oe(this.map.values()).map((e) => e.length));
  }
  clear() {
    this.map.clear();
  }
...
}, i(_Ha, "MultiMap"), _Ha), yl = (_Ia = class {
  get size() {
  ...
  async collectExportedSymbolsForNode(e, t, r = Ss, n = pe.CancellationToken.None) {
    const a = [];
    this.addExportedSymbol(e, a, t);
    for (const s of r(e)) await Ge(n), this.addExportedSymbol(s, a, t);
    return a;
  }
  ...
  async collectLocalSymbols(e, t = pe.CancellationToken.None) {
    ...
    for (const a of wr(r)) await Ge(t), this.addLocalSymbol(a, e, n);
    return n;
  }
...
}, i(_Ja, "DefaultScopeComputation"), _Ja), Pd = (_Ka = class {
  constructor(e, t, r) {
...
}, i(_Ka, "StreamScope"), _Ka), eF = (_La = class {
  constructor(e, t, r) {
...
}, i(_La, "MapScope"), _La), VS = (_Ma = class {
  constructor(e, t, r) {
    this.elements = new br(), this.caseInsensitive = (r == null ? void 0 : r.caseInsensitive) ?? false, this.concatOuterScope = (r == null ? void 0 : r.concatOuterScope) ?? true;
    for (const n of e) {
      const a = this.caseInsensitive ? n.name.toLowerCase() : n.name;
...
}, i(_Ma, "MultiMapScope"), _Ma), tF = { getElement() {
}, getElements() {
  return Oa;
}, getAllElements() {
  return Oa;
...
}, i(_Na, "DisposableCache"), _Na), Rh = (_Oa = class extends Cc {
  constructor() {
...
}, i(_Oa, "SimpleCache"), _Oa), Sc = (_Pa = class extends Cc {
  constructor(e) {
...
}, i(_Pa, "ContextCache"), _Pa), HS = (_Qa = class extends Sc {
  constructor(e, t) {
    super((r) => r.toString()), t ? (this.toDispose.push(e.workspace.DocumentBuilder.onDocumentPhase(t, (r) => {
      ...
      for (const a of n) this.clear(a);
    }))) : this.toDispose.push(e.workspace.DocumentBuilder.onUpdate((r, n) => {
      const a = r.concat(n);
      for (const s of a) this.clear(s);
    }));
  }
}, i(_Qa, "DocumentCache"), _Qa), $h = (_Ra = class extends Rh {
  constructor(e, t) {
...
}, i(_Ra, "WorkspaceCache"), _Ra), YS = (_Sa = class {
  constructor(e) {
    this.reflection = e.shared.AstReflection, this.nameProvider = e.references.NameProvider, this.descriptions = e.workspace.AstNodeDescriptionProvider, this.indexManager = e.shared.workspace.IndexManager, this.globalScopeCache = new $h(e.shared);
  }
  getScope(e) {
  ...
  getGlobalScope(e, t) {
    return this.globalScopeCache.get(e, () => new VS(this.indexManager.allElements(e)));
  }
}, i(_Sa, "DefaultScopeProvider"), _Sa);
function Ah(e) {
  return typeof e.$comment == "string";
}
i(Ah, "isAstNodeWithComment");
function Od(e) {
  return typeof e == "object" && !!e && ("$ref" in e || "$error" in e);
}
i(Od, "isIntermediateReference");
var XS = (_Ta = class {
  constructor(e) {
  ...
  serialize(e, t) {
    const r = t ?? {}, n = t == null ? void 0 : t.replacer, a = i((o, l) => this.replacer(o, l, r), "defaultReplacer"), s = n ? (o, l) => n(o, l, a) : a;
    try {
      return this.currentDocument = Dt(e), JSON.stringify(e, s, t == null ? void 0 : t.space);
    } finally {
  ...
  replacer(e, t, { refText: r, sourceText: n, textRegions: a, comments: s, uriConverter: o }) {
    var _a3, _b3, _c3;
    if (!this.ignoreProperties.has(e)) if (He(t)) {
      const l = t.ref, c = r ? t.$refText : void 0;
      if (l) {
        const u = Dt(l);
        let d = "";
        this.currentDocument && this.currentDocument !== u && (o ? d = o(u.uri, l) : d = u.uri.toString());
        const f = this.astNodeLocator.getAstNodePath(l);
        return { $ref: `${d}#${f}`, $refText: c };
      } else return { $error: ((_a3 = t.error) == null ? void 0 : _a3.message) ?? "Could not resolve reference", $refText: c };
    } else if (Qt(t)) {
      const l = r ? t.$refText : void 0, c = [];
      for (const u of t.items) {
        const d = u.ref, f = Dt(u.ref);
        let h = "";
        this.currentDocument && this.currentDocument !== f && (o ? h = o(f.uri, d) : h = f.uri.toString());
        const y = this.astNodeLocator.getAstNodePath(d);
        c.push(`${h}#${y}`);
      }
      return { $refs: c, $refText: l };
    } else if (Le(t)) {
      let l;
      if (a && (l = this.addAstNodeRegionWithAssignmentsTo({ ...t }), (!e || t.$document) && (l == null ? void 0 : l.$textRegion) && (l.$textRegion.documentURI = (_b3 = this.currentDocument) == null ? void 0 : _b3.uri.toString())), n && !e && (l ?? (l = { ...t }), l.$sourceText = (_c3 = t.$cstNode) == null ? void 0 : _c3.text), s) {
        l ?? (l = { ...t });
  ...
  addAstNodeRegionWithAssignmentsTo(e) {
    const t = i((r) => ({ offset: r.offset, end: r.end, length: r.length, range: r.range }), "createDocumentSegment");
    if (e.$cstNode) {
      const r = e.$textRegion = t(e.$cstNode), n = r.assignments = {};
      return Object.keys(e).filter((a) => !a.startsWith("$")).forEach((a) => {
        const s = qf(e.$cstNode, a).map(t);
        s.length !== 0 && (n[a] = s);
      }), e;
    }
  }
  linkNode(e, t, r, n, a, s) {
    for (const [l, c] of Object.entries(e)) if (Array.isArray(c)) for (let u = 0; u < c.length; u++) {
      const d = c[u];
      Od(d) ? c[u] = this.reviveReference(e, l, t, d, r) : Le(d) && this.linkNode(d, t, r, e, l, u);
    }
    else Od(c) ? e[l] = this.reviveReference(e, l, t, c, r) : Le(c) && this.linkNode(c, t, r, e, l);
    const o = e;
  ...
  reviveReference(e, t, r, n, a) {
    ...
    if (n.$ref) {
      ...
      if (Le(c)) return s || (s = this.nameProvider.getName(c)), { $refText: s ?? "", ref: c };
      o = c;
    } else if (n.$refs) {
      const c = [];
      for (const u of n.$refs) {
        const d = this.getRefNode(r, u, a.uriConverter);
        Le(d) && c.push({ ref: d });
      }
      if (c.length === 0) l = { $refText: s ?? "", items: c }, o ?? (o = "Could not resolve multi-reference");
      else return { $refText: s ?? "", items: c };
    }
    if (o) return l ?? (l = { $refText: s ?? "", ref: void 0 }), l.error = { info: { container: e, property: t, reference: l }, message: o }, l;
  }
  getRefNode(e, t, r) {
    try {
      const n = t.indexOf("#");
      ...
      if (n < 0) {
        const l = r ? r(t) : dt.parse(t), c = this.langiumDocuments.getDocument(l);
        return c ? c.parseResult.value : "Could not find document for URI: " + t;
      }
      const a = r ? r(t.substring(0, n)) : dt.parse(t.substring(0, n)), s = this.langiumDocuments.getDocument(a);
...
}, i(_Ta, "DefaultJsonSerializer"), _Ta), JS = (_Ua = class {
  get map() {
  ...
  register(e) {
    ...
    if (t.fileNames) for (const r of t.fileNames) this.fileNameMap.has(r) && console.warn(`The file name ${r} is used by multiple languages. It is now assigned to '${t.languageId}'.`), this.fileNameMap.set(r, e);
  ...
  getServices(e) {
    ...
    const t = (_b3 = (_a3 = this.textDocuments) == null ? void 0 : _a3.get(e)) == null ? void 0 : _b3.languageId;
    if (t !== void 0) {
    ...
    if (!a) throw t ? new Error(`The service registry contains no services for the extension '${r}' for language '${t}'.`) : new Error(`The service registry contains no services for the extension '${r}'.`);
    return a;
  }
  hasServices(e) {
    try {
...
}, i(_Ua, "DefaultServiceRegistry"), _Ua);
function En(e) {
  return { code: e };
}
i(En, "diagnosticData");
...
var ZS = (_Va = class {
  constructor(e) {
    this.entries = new br(), this.knownCategories = new Set(vl.defaults), this.entriesBefore = [], this.entriesAfter = [], this.reflection = e.shared.AstReflection;
  }
  register(e, t = this, r = "fast") {
    ...
    for (const [n, a] of Object.entries(e)) {
      ...
      if (Array.isArray(s)) for (const o of s) {
        ...
        const o = { check: this.wrapValidationException(s, t), category: r };
        this.addEntry(n, o);
      } else qr();
    }
  }
...
}, i(_Va, "ValidationRegistry"), _Va), QS = Object.freeze({ validateNode: true, validateChildren: true }), eb = (_Wa = class {
  constructor(e) {
  ...
  async validateDocument(e, t = {}, r = pe.CancellationToken.None) {
    ...
    if (await Ge(r), (!t.categories || t.categories.includes("built-in")) && (this.processLexingErrors(n, a, t), t.stopAfterLexingErrors && a.some((s) => {
      var _a3;
      return ((_a3 = s.data) == null ? void 0 : _a3.code) === Et.LexingError;
    }) || (this.processParsingErrors(n, a, t), t.stopAfterParsingErrors && a.some((s) => {
      var _a3;
      return ((_a3 = s.data) == null ? void 0 : _a3.code) === Et.ParsingError;
    })) || (this.processLinkingErrors(e, a, t), t.stopAfterLinkingErrors && a.some((s) => {
      var _a3;
      return ((_a3 = s.data) == null ? void 0 : _a3.code) === Et.LinkingError;
    })))) return a;
    try {
  ...
  processLexingErrors(e, t, r) {
    var _a3;
    const n = [...e.lexerErrors, ...((_a3 = e.lexerReport) == null ? void 0 : _a3.diagnostics) ?? []];
    for (const a of n) {
      const s = a.severity ?? "error", o = { severity: is(s), range: { start: { line: a.line - 1, character: a.column - 1 }, end: { line: a.line - 1, character: a.column + a.length - 1 } }, message: a.message, data: _h(s), source: this.getSource() };
      t.push(o);
    }
  }
  processParsingErrors(e, t, r) {
    for (const n of e.parserErrors) {
      ...
      if (a) {
        const s = { severity: is("error"), range: a, message: n.message, data: En(Et.ParsingError), source: this.getSource() };
        t.push(s);
      }
    }
  }
  processLinkingErrors(e, t, r) {
    ...
    for (const n of e.references) {
      const a = n.error;
      if (a) {
        const s = { node: a.info.container, range: (_a3 = n.$refNode) == null ? void 0 : _a3.range, property: a.info.property, index: a.info.index, data: { code: Et.LinkingError, containerType: a.info.container.$type, property: a.info.property, refText: a.info.reference.$refText } };
  ...
  async validateAstBefore(e, t, r, n = pe.CancellationToken.None) {
    ...
    for (const s of a) await Ge(n), await s(e, r, t.categories ?? [], n);
  }
    ...
    if ((_a3 = this.profiler) == null ? void 0 : _a3.isActive("validating")) {
      ...
      try {
        ...
        for (const o of s) {
          ...
          if (l.validateNode) try {
            ...
            for (const u of c) await u(o, r, n);
          } finally {
      ...
      for (const s of a) {
        ...
        if (o.validateNode) {
          ...
          for (const c of l) await c(s, r, n);
        }
  ...
  toDiagnostic(e, t, r) {
    return { message: t, range: Eh(r), severity: is(e), code: r.code, codeDescription: r.codeDescription, tags: r.tags, relatedInformation: r.relatedInformation, data: r.data, source: this.getSource() };
  }
  getSource() {
    return this.metadata.languageId;
  }
}, i(_Wa, "DefaultDocumentValidator"), _Wa);
function Eh(e) {
  if (e.range) return e.range;
  let t;
  return typeof e.property == "string" ? t = Ml(e.node.$cstNode, e.property, e.index) : typeof e.keyword == "string" && (t = Wf(e.node.$cstNode, e.keyword, e.index)), t ?? (t = e.node.$cstNode), t ? t.range : { start: { line: 0, character: 0 }, end: { line: 0, character: 0 } };
}
i(Eh, "getDiagnosticRange");
function is(e) {
  switch (e) {
    case "error":
      return 1;
...
i(is, "toDiagnosticSeverity");
function _h(e) {
  switch (e) {
    case "error":
      return En(Et.LexingError);
    case "warning":
      return En(Et.LexingWarning);
    case "info":
      return En(Et.LexingInfo);
    case "hint":
      return En(Et.LexingHint);
    default:
      throw new Error("Invalid diagnostic severity: " + e);
  }
}
i(_h, "toDiagnosticData");
var Et;
(function(e) {
...
var tb = (_Xa = class {
  ...
  createDescription(e, t, r) {
    ...
    let s;
    const o = i(() => s ?? (s = Ga(this.nameProvider.getNameNode(e) ?? e.$cstNode)), "nameSegmentGetter");
    return { node: e, name: t, get nameSegment() {
      return o();
    }, selectionSegment: Ga(e.$cstNode), type: e.$type, documentUri: n.uri, path: a };
  }
}, i(_Xa, "DefaultAstNodeDescriptionProvider"), _Xa), rb = (_Ya = class {
  constructor(e) {
  ...
  async createDescriptions(e, t = pe.CancellationToken.None) {
    ...
    for (const a of Mt(n)) await Ge(t), Ma(a).forEach((s) => {
  ...
  createInfoDescriptions(e) {
    ...
    let r = [];
    He(t) && t.$nodeDescription ? r = [t.$nodeDescription] : Qt(t) && (r = t.items.map((l) => l.$nodeDescription).filter((l) => l !== void 0));
    const n = Dt(e.container).uri, a = this.nodeLocator.getAstNodePath(e.container), s = [], o = Ga(t.$refNode);
    for (const l of r) s.push({ sourceUri: n, sourcePath: a, targetUri: l.documentUri, targetPath: l.path, segment: o, local: Ye.equals(l.documentUri, n) });
    return s;
  }
}, i(_Ya, "DefaultReferenceDescriptionProvider"), _Ya), nb = (_Za = class {
  constructor() {
  ...
  getAstNode(e, t) {
    return t.split(this.segmentSeparator).reduce((n, a) => {
      ...
      if (s > 0) {
        ...
        return (_a3 = n[o]) == null ? void 0 : _a3[l];
      }
      return n[a];
    }, e);
  }
}, i(_Za, "DefaultAstNodeLocator"), _Za), bc = {};
$l(bc, Jd(qa()));
var ab = (__a = class {
  constructor(e) {
    this._ready = new Sr(), this.onConfigurationSectionUpdateEmitter = new bc.Emitter(), this.settings = {}, this.workspaceConfig = false, this.serviceRegistry = e.ServiceRegistry;
  }
  get ready() {
  ...
  async initialized(e) {
    if (this.workspaceConfig) {
      ...
      if (e.fetchConfiguration) {
        const t = this.serviceRegistry.all.map((n) => ({ section: this.toSectionName(n.LanguageMetaData.languageId) })), r = await e.fetchConfiguration(t);
        t.forEach((n, a) => {
...
}, i(__a, "DefaultConfigurationProvider"), __a), Js = Jd(Dw()), Sn;
(function(e) {
  function t(r) {
    return { dispose: i(async () => await r(), "dispose") };
  }
  i(t, "create"), e.create = t;
})(Sn || (Sn = {}));
var ib = (_$a = class {
    ...
    for (const n of e) {
      ...
      if (n.state === Y.Validated) {
        if (typeof t.validation == "boolean" && t.validation) this.resetToState(n, Y.IndexedReferences);
          ...
          s.length > 0 && (this.buildState.set(a, { completed: false, options: { validation: { categories: s } }, result: (_a3 = this.buildState.get(a)) == null ? void 0 : _a3.result }), n.state = Y.IndexedReferences);
        }
  ...
  async update(e, t, r = pe.CancellationToken.None) {
    ...
    for (const l of t) {
      ...
      for (const u of c) n.push(u.uri), this.cleanUpDeleted(u);
    }
  ...
  findMissingValidationCategories(e, t) {
    var _a3, _b3;
    const r = this.buildState.get(e.uri.toString()), n = this.serviceRegistry.getServices(e.uri).validation.ValidationRegistry.getAllValidationCategories(e), a = ((_a3 = r == null ? void 0 : r.result) == null ? void 0 : _a3.validationChecks) ? new Set((_b3 = r == null ? void 0 : r.result) == null ? void 0 : _b3.validationChecks) : (r == null ? void 0 : r.completed) ? n : /* @__PURE__ */ new Set(), s = t === void 0 || t.validation === true ? n : typeof t.validation == "object" ? t.validation.categories ?? n : [];
  ...
  onUpdate(e) {
    return this.updateListeners.push(e), Sn.create(() => {
  ...
  async buildDocuments(e, t, r) {
    ...
    const a = e.filter((s) => this.shouldValidate(s) ? true : (this.markAsCompleted(s), false));
  ...
  prepareBuild(e, t) {
    for (const r of e) {
      ...
      (!a || a.completed) && this.buildState.set(n, { completed: false, options: t, result: a == null ? void 0 : a.result });
    }
  }
  async runCancelable(e, t, r, n) {
    for (const s of e) s.state < t && (await Ge(r), await n(s), s.state = t, await this.notifyDocumentPhase(s, t, r));
    const a = e.filter((s) => s.state === t);
    await this.notifyBuildPhase(a, t, r), this.currentState = t;
  }
  onBuildPhase(e, t) {
    return this.buildPhaseListeners.add(e, t), Sn.create(() => {
      this.buildPhaseListeners.delete(e, t);
    });
  }
  onDocumentPhase(e, t) {
    return this.documentPhaseListeners.add(e, t), Sn.create(() => {
  ...
  awaitDocumentState(e, t, r) {
    ...
    if (n) {
      ...
      if (r.isCancellationRequested) return Promise.reject(Zt);
      if (this.currentState >= e && e > n.state) return Promise.reject(new Js.ResponseError(Js.LSPErrorCodes.RequestFailed, `Document state of ${t.toString()} is ${Y[n.state]}, requiring ${Y[e]}, but workspace state is already ${Y[this.currentState]}. Returning undefined.`));
    } else return Promise.reject(new Js.ResponseError(Js.LSPErrorCodes.ServerCancelled, `No document found for URI: ${t.toString()}`));
    return new Promise((a, s) => {
      const o = this.onDocumentPhase(e, (c) => {
        Ye.equals(c.uri, t) && (o.dispose(), l.dispose(), a(c.uri));
      }), l = r.onCancellationRequested(() => {
        o.dispose(), l.dispose(), s(Zt);
      });
    });
  }
  awaitBuilderState(e, t) {
    return this.currentState >= e ? Promise.resolve() : t.isCancellationRequested ? Promise.reject(Zt) : new Promise((r, n) => {
      const a = this.onBuildPhase(e, () => {
        a.dispose(), s.dispose(), r();
      }), s = t.onCancellationRequested(() => {
        a.dispose(), s.dispose(), n(Zt);
      });
    });
  }
  ...
  async notifyBuildPhase(e, t, r) {
    ...
    for (const s of a) await Ge(r), await s(e, r);
  }
  shouldLink(e) {
...
}, i(_$a, "DefaultDocumentBuilder"), _$a), sb = (_ab = class {
  constructor(e) {
    this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new Sc(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
  }
...
}, i(_ab, "DefaultIndexManager"), _ab), ob = (_bb = class {
  constructor(e) {
...
}, i(_bb, "DefaultWorkspaceManager"), _bb), lb = (_cb = class {
  buildUnexpectedCharactersMessage(e, t, r, n, a) {
    return fd.buildUnexpectedCharactersMessage(e, t, r, n, a);
  }
  buildUnableToPopLexerModeMessage(e) {
    return fd.buildUnableToPopLexerModeMessage(e);
  }
}, i(_cb, "DefaultLexerErrorMessageProvider"), _cb), Ch = { mode: "full" }, Sh = (_db = class {
  constructor(e) {
    ...
    const r = Tl(t) ? Object.values(t) : t, n = e.LanguageMetaData.mode === "production";
    this.chevrotainLexer = new Xe(r, { positionTracking: "full", skipValidations: n, errorMessageProvider: this.errorMessageProvider });
  }
  get definition() {
  ...
  tokenize(e, t = Ch) {
    ...
    return { tokens: r.tokens, errors: r.errors, hidden: r.groups.hidden ?? [], report: (_b3 = (_a3 = this.tokenBuilder).flushLexingReport) == null ? void 0 : _b3.call(_a3, e) };
  }
  toTokenTypeDictionary(e) {
    if (Tl(e)) return e;
    const t = Ic(e) ? Object.values(e.modes).flat() : e, r = {};
    return t.forEach((n) => r[n.name] = n), r;
  }
}, i(_db, "DefaultLexer"), _db);
function wc(e) {
  return Array.isArray(e) && (e.length === 0 || "name" in e[0]);
}
i(wc, "isTokenTypeArray");
function Ic(e) {
  return e && "modes" in e && "defaultMode" in e;
}
i(Ic, "isIMultiModeLexerDefinition");
function Tl(e) {
  return !wc(e) && !Ic(e);
}
i(Tl, "isTokenTypeDictionary");
_s();
function bh(e, t, r) {
  let n, a;
  typeof e == "string" ? (a = t, n = r) : (a = e.range.start, n = t), a || (a = ie.create(0, 0));
  const s = Ih(e), o = Nc(n), l = cb({ lines: s, position: a, options: o });
  return fb({ index: 0, tokens: l, position: a });
}
i(bh, "parseJSDoc");
function wh(e, t) {
  const r = Nc(t), n = Ih(e);
  ...
  return !!(o == null ? void 0 : o.exec(a)) && !!(l == null ? void 0 : l.exec(s));
}
i(wh, "isJSDoc");
function Ih(e) {
  let t = "";
  return typeof e == "string" ? t = e : t = e.text, t.split(uy);
}
i(Ih, "getLines");
var ig = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy, rF = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function cb(e) {
  var _a3, _b3, _c3;
  const t = [];
  ...
  for (let a = 0; a < e.lines.length; a++) {
    ...
    if (s && e.options.start) {
      const d = (_a3 = e.options.start) == null ? void 0 : _a3.exec(l);
      d && (c = d.index + d[0].length);
    } else {
      const d = (_b3 = e.options.line) == null ? void 0 : _b3.exec(l);
      d && (c = d.index + d[0].length);
    }
    if (o) {
      const d = (_c3 = e.options.end) == null ? void 0 : _c3.exec(l);
      d && (l = l.substring(0, d.index));
    }
    if (l = l.substring(0, db(l)), Rl(l, c) >= l.length) {
      if (t.length > 0) {
        const d = ie.create(r, n);
        t.push({ type: "break", content: "", range: ee.create(d, d) });
      }
    } else {
      ig.lastIndex = c;
      const d = ig.exec(l);
      if (d) {
        const f = d[0], h = d[1], y = ie.create(r, n + c), v = ie.create(r, n + c + f.length);
        t.push({ type: "tag", content: h, range: ee.create(y, v) }), c += f.length, c = Rl(l, c);
      }
      if (c < l.length) {
        const f = l.substring(c), h = Array.from(f.matchAll(rF));
        t.push(...ub(h, f, r, n + c));
      }
    }
    r++, n = 0;
...
function ub(e, t, r, n) {
  ...
  if (e.length === 0) {
    ...
    a.push({ type: "text", content: t, range: ee.create(s, o) });
  } else {
    let s = 0;
    for (const l of e) {
      const c = l.index, u = t.substring(s, c);
      u.length > 0 && a.push({ type: "text", content: t.substring(s, c), range: ee.create(ie.create(r, s + n), ie.create(r, c + n)) });
      let d = u.length + 1;
      const f = l[1];
      if (a.push({ type: "inline-tag", content: f, range: ee.create(ie.create(r, s + d + n), ie.create(r, s + d + f.length + n)) }), d += f.length, l.length === 4) {
        d += l[2].length;
        const h = l[3];
        a.push({ type: "text", content: h, range: ee.create(ie.create(r, s + d + n), ie.create(r, s + d + h.length + n)) });
      } else a.push({ type: "text", content: "", range: ee.create(ie.create(r, s + d + n), ie.create(r, s + d + n)) });
      s = c + l[0].length;
    }
    const o = t.substring(s);
    o.length > 0 && a.push({ type: "text", content: o, range: ee.create(ie.create(r, s + n), ie.create(r, s + n + o.length)) });
  }
  return a;
}
i(ub, "buildInlineTokens");
var nF = /\S/, aF = /\s*$/;
function Rl(e, t) {
  const r = e.substring(t).match(nF);
...
function fb(e) {
  ...
  if (e.tokens.length === 0) return new sg([], ee.create(t, t));
  const r = [];
  for (; e.index < e.tokens.length; ) {
    const s = pb(e, r[r.length - 1]);
    s && r.push(s);
  }
  const n = ((_a3 = r[0]) == null ? void 0 : _a3.range.start) ?? t, a = ((_b3 = r[r.length - 1]) == null ? void 0 : _b3.range.end) ?? t;
  return new sg(r, ee.create(n, a));
}
i(fb, "parseJSDocComment");
function pb(e, t) {
  const r = e.tokens[e.index];
  if (r.type === "tag") return kh(e, false);
  if (r.type === "text" || r.type === "inline-tag") return Nh(e);
  hb(r, t), e.index++;
}
i(pb, "parseJSDocElement");
function hb(e, t) {
  if (t) {
    const r = new vb("", e.range);
    "inlines" in t ? t.inlines.push(r) : t.content.inlines.push(r);
  }
}
i(hb, "appendEmptyLine");
function Nh(e) {
  let t = e.tokens[e.index];
  const r = t;
  let n = t;
  const a = [];
  for (; t && t.type !== "break" && t.type !== "tag"; ) a.push(mb(e)), n = t, t = e.tokens[e.index];
  return new Ld(a, ee.create(r.range.start, n.range.end));
}
i(Nh, "parseJSDocText");
function mb(e) {
  return e.tokens[e.index].type === "inline-tag" ? kh(e, true) : Ph(e);
}
i(mb, "parseJSDocInline");
function kh(e, t) {
  var _a3;
  const r = e.tokens[e.index++], n = r.content.substring(1);
  if (((_a3 = e.tokens[e.index]) == null ? void 0 : _a3.type) === "text") if (t) {
    const s = Ph(e);
    return new jc(n, new Ld([s], s.range), t, ee.create(r.range.start, s.range.end));
  } else {
    const s = Nh(e);
    return new jc(n, s, t, ee.create(r.range.start, s.range.end));
  }
  else {
    const s = r.range;
    return new jc(n, new Ld([], s), t, s);
  }
}
i(kh, "parseJSDocTag");
function Ph(e) {
  const t = e.tokens[e.index++];
  return new vb(t.content, t.range);
}
i(Ph, "parseJSDocLine");
function Nc(e) {
  if (!e) return Nc({ start: "/**", end: "*/", line: "*" });
  const { start: t, end: r, line: n } = e;
  return { start: ko(t, true), end: ko(r, false), line: ko(n, true) };
}
i(Nc, "normalizeOptions");
function ko(e, t) {
  if (typeof e == "string" || typeof e == "object") {
    const r = typeof e == "string" ? Va(e) : e.source;
    return t ? new RegExp(`^\\s*${r}`) : new RegExp(`\\s*${r}\\s*$`);
  } else return e;
}
i(ko, "normalizeOption");
var sg = (_eb = class {
  constructor(e, t) {
...
}, i(_eb, "JSDocCommentImpl"), _eb), jc = (_fb = class {
  constructor(e, t, r, n) {
...
function gb(e, t, r) {
  ...
  if (e === "linkplain" || e === "linkcode" || e === "link") {
    ...
    return (e === "linkcode" || e === "link" && r.link === "code") && (a = `\`${a}\``), ((_a3 = r.renderLink) == null ? void 0 : _a3.call(r, t, a)) ?? yb(t, a);
  }
}
i(gb, "renderInlineTag");
function yb(e, t) {
  try {
    return dt.parse(e, true), `[${t}](${e})`;
  } catch {
    return e;
  }
}
i(yb, "renderLinkDefault");
var Ld = (_gb = class {
  constructor(e, t) {
...
}, i(_gb, "JSDocTextImpl"), _gb), vb = (_hb = class {
  constructor(e, t) {
...
var Tb = (_ib = class {
  ...
  getDocumentation(e) {
    ...
    if (t && wh(t)) return bh(t).toMarkdown({ renderLink: i((n, a) => this.documentationLinkRenderer(e, n, a), "renderLink"), renderTag: i((n) => this.documentationTagRenderer(e, n), "renderTag") });
  }
...
}, i(_ib, "JSDocDocumentationProvider"), _ib), Rb = (_jb = class {
  constructor(e) {
    this.grammarConfig = () => e.parser.GrammarConfig;
  }
  getComment(e) {
    var _a3;
    return Ah(e) ? e.$comment : (_a3 = Nf(e.$cstNode, this.grammarConfig().multilineCommentRules)) == null ? void 0 : _a3.text;
  }
}, i(_jb, "DefaultCommentProvider"), _jb), $b = (_kb = class {
  constructor(e) {
...
}, i(_kb, "DefaultAsyncParser"), _kb), iF = (_lb = class {
  constructor(e) {
  ...
  async acquireParserWorker(e) {
    ...
    for (const r of this.workerPool) if (r.ready) return r.lock(), r;
    const t = new Sr();
    return e.onCancellationRequested(() => {
      const r = this.queue.indexOf(t);
      r >= 0 && this.queue.splice(r, 1), t.reject(Zt);
    }), this.queue.push(t), t.promise;
  }
}, i(_lb, "AbstractThreadedAsyncParser"), _lb), sF = (_mb = class {
  get ready() {
    return this._ready;
  }
  get onReady() {
  ...
  constructor(e, t, r, n) {
    this.onReadyEmitter = new bc.Emitter(), this.deferred = new Sr(), this._ready = true, this._parsing = false, this.sendMessage = e, this._terminate = n, t((a) => {
      const s = a;
  ...
  terminate() {
    this.deferred.reject(Zt), this._terminate();
  }
  lock() {
    this._ready = false;
  }
  ...
  parse(e) {
    ...
    return this._parsing = true, this.deferred = new Sr(), this.sendMessage(e), this.deferred.promise;
  }
}, i(_mb, "ParserWorker"), _mb), Ab = (_nb = class {
  constructor() {
    this.previousTokenSource = new pe.CancellationTokenSource(), this.writeQueue = [], this.readQueue = [], this.done = true;
  }
  write(e) {
    this.cancelWrite();
    const t = _c();
  ...
  enqueue(e, t, r = pe.CancellationToken.None) {
    const n = new Sr(), a = { action: t, deferred: n, cancellationToken: r };
  ...
  async performNextOperation() {
    ...
    this.done = false, await Promise.all(e.map(async ({ action: t, deferred: r, cancellationToken: n }) => {
      try {
        ...
        Jn(a) ? r.resolve(void 0) : r.reject(a);
      }
...
}, i(_nb, "DefaultWorkspaceLock"), _nb), Eb = (_ob = class {
  constructor(e) {
    this.grammarElementIdMap = new yl(), this.tokenTypeIdMap = new yl(), this.grammar = e.Grammar, this.lexer = e.parser.Lexer, this.linker = e.references.Linker;
  }
  dehydrate(e) {
  ...
  createDehyrationContext(e) {
    ...
    for (const n of Mt(e)) t.set(n, {});
    if (e.$cstNode) for (const n of Fa(e.$cstNode)) r.set(n, {});
  ...
  dehydrateAstNode(e, t) {
    ...
    for (const [n, a] of Object.entries(e)) if (!n.startsWith("$")) if (Array.isArray(a)) {
      const s = [];
      r[n] = s;
      for (const o of a) Le(o) ? s.push(this.dehydrateAstNode(o, t)) : He(o) ? s.push(this.dehydrateReference(o, t)) : s.push(o);
  ...
  createHydrationContext(e) {
    const t = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map();
    for (const a of Mt(e)) t.set(a, {});
    let n;
    if (e.$cstNode) for (const a of Fa(e.$cstNode)) {
      let s;
      "fullText" in a ? (s = new sh(a.fullText), n = s) : "content" in a ? s = new Tc() : "tokenType" in a && (s = this.hydrateCstLeafNode(a)), s && (r.set(a, s), s.root = n);
    }
    return { astNodes: t, cstNodes: r };
  }
  hydrateAstNode(e, t) {
    ...
    for (const [n, a] of Object.entries(e)) if (!n.startsWith("$")) if (Array.isArray(a)) {
      const s = [];
      r[n] = s;
      for (const o of a) Le(o) ? s.push(this.setParent(this.hydrateAstNode(o, t), r)) : He(o) ? s.push(this.hydrateReference(o, r, n, t)) : s.push(o);
  ...
  hydrateCstNode(e, t, r = 0) {
    ...
    if (typeof e.grammarSource == "number" && (n.grammarSource = this.getGrammarElement(e.grammarSource)), n.astNode = t.astNodes.get(e.astNode), vr(n)) for (const a of e.content) {
  ...
  hydrateCstLeafNode(e) {
    ...
    return new fl(r, n, { start: { line: a, character: s }, end: { line: o, character: l } }, t, c);
  }
  getTokenType(e) {
...
function xd(e, t, r, n) {
  if (t in e) {
    ...
    if (e[t] === og) throw new Error('Cycle detected. Please make "' + String(t) + '" lazy. Visit https://langium.org/docs/reference/configuration-services/#resolving-cyclic-dependencies');
    return e[t];
  } else if (t in r) {
    const a = r[t];
    e[t] = og;
    try {
      e[t] = typeof a == "function" ? a(n) : Lh(a, n);
    } catch (s) {
...
function Ka(e, t) {
  if (t) {
    for (const [r, n] of Object.entries(t)) if (n != null) if (typeof n == "object") {
      const a = e[r];
      typeof a == "object" && a !== null ? e[r] = Ka(a, n) : e[r] = Ka({}, n);
    } else e[r] = n;
  }
  return e;
}
i(Ka, "_merge");
var Fd = { indentTokenName: "INDENT", dedentTokenName: "DEDENT", whitespaceTokenName: "WS", ignoreIndentationDelimiters: [] }, _n;
(function(e) {
  e.REGULAR = "indentation-sensitive", e.IGNORE_INDENTATION = "ignore-indentation";
})(_n || (_n = {}));
var Cb = (_pb = class extends Ac {
  constructor(e = Fd) {
    super(), this.indentationStack = [0], this.whitespaceRegExp = /[ \t]+/y, this.options = { ...Fd, ...e }, this.indentTokenType = ka({ name: this.options.indentTokenName, pattern: this.indentMatcher.bind(this), line_breaks: false }), this.dedentTokenType = ka({ name: this.options.dedentTokenName, pattern: this.dedentMatcher.bind(this), line_breaks: false });
  }
  buildTokens(e, t) {
    const r = super.buildTokens(e, t);
    if (!wc(r)) throw new Error("Invalid tokens built by default builder");
    const { indentTokenName: n, dedentTokenName: a, whitespaceTokenName: s, ignoreIndentationDelimiters: o } = this.options;
    let l, c, u;
    const d = [];
    for (const f of r) {
      for (const [h, y] of o) f.name === h ? f.PUSH_MODE = _n.IGNORE_INDENTATION : f.name === y && (f.POP_MODE = true);
      f.name === a ? l = f : f.name === n ? c = f : f.name === s ? u = f : d.push(f);
    }
    if (!l || !c || !u) throw new Error("Some indentation/whitespace tokens not found!");
    return o.length > 0 ? { modes: { [_n.REGULAR]: [l, c, ...d, u], [_n.IGNORE_INDENTATION]: [...d, u] }, defaultMode: _n.REGULAR } : [l, c, u, ...d];
  }
  flushLexingReport(e) {
...
`.includes(e[t - 1]);
  ...
  createIndentationTokenInstance(e, t, r, n) {
    ...
    return js(e, r, n, n + r.length, a, a, 1, r.length);
  }
  getLineNumber(e, t) {
  ...
  dedentMatcher(e, t, r, n) {
    ...
    if (l === -1) return this.diagnostics.push({ severity: "error", message: `Invalid dedent level ${a} at offset: ${t}. Current indentation stack: ${this.indentationStack}`, offset: t, length: ((_a3 = o == null ? void 0 : o[0]) == null ? void 0 : _a3.length) ?? 0, line: this.getLineNumber(e, t), column: 1 }), null;
    const c = this.indentationStack.length - l - 1, u = ((_b3 = e.substring(0, t).match(/[\r\n]+$/)) == null ? void 0 : _b3[0].length) ?? 1;
    for (let d = 0; d < c; d++) {
      const f = this.createIndentationTokenInstance(this.dedentTokenType, e, "", t - (u - 1));
      r.push(f), this.indentationStack.pop();
    }
    return null;
  }
  buildTerminalToken(e) {
    const t = super.buildTerminalToken(e), { indentTokenName: r, dedentTokenName: n, whitespaceTokenName: a } = this.options;
    return t.name === r ? this.indentTokenType : t.name === n ? this.dedentTokenType : t.name === a ? ka({ name: a, pattern: this.whitespaceRegExp, group: Xe.SKIPPED }) : t;
  }
...
}, i(_pb, "IndentationAwareTokenBuilder"), _pb), oF = (_qb = class extends Sh {
  constructor(e) {
    if (super(e), e.parser.TokenBuilder instanceof Cb) this.indentationTokenBuilder = e.parser.TokenBuilder;
  ...
  tokenize(e, t = Ch) {
    ...
    for (let d = 0; d < u; d++) {
      const f = r.tokens[d], h = r.tokens[d + 1];
      if (f.tokenTypeIdx === o && h.tokenTypeIdx === l) {
        d++;
        continue;
      }
      c.push(f);
...
}, i(_rb, "EmptyFileSystemProvider"), _rb), It = { fileSystemProvider: i(() => new Sb(), "fileSystemProvider") }, lF = { Grammar: i(() => {
}, "Grammar"), LanguageMetaData: i(() => ({ caseInsensitive: false, fileExtensions: [".langium"], languageId: "langium" }), "LanguageMetaData") }, cF = { AstReflection: i(() => new Cf(), "AstReflection") };
function bb() {
  const e = Ae(vt(It), cF), t = Ae(yt({ shared: e }), lF);
  return e.ServiceRegistry.register(t), t;
}
i(bb, "createMinimalGrammarServices");
function Tt(e) {
  const t = bb(), r = t.serializer.JsonSerializer.deserialize(e);
...
var uF = (_sb = class {
  ...
  createTask(e, t) {
    ...
    return console.log(`Creating profiling task for '${e}.${t}'.`), new wb((r) => this.records.add(e, this.dumpRecord(e, r)), t);
  }
  dumpRecord(e, t) {
...
}, i(_sb, "DefaultLangiumProfiler"), _sb), wb = (_tb = class {
  constructor(e, t) {
  ...
  stop() {
    ...
    const e = { identifier: this.identifier, date: /* @__PURE__ */ new Date(), duration: performance.now() - this.startTime, entries: this.entries };
...
}, i(_vb, "AbstractMermaidValueConverter"), _vb), Ks = (_wb = class extends ti {
  runCustomConverter(e, t, r) {
  }
}, i(_wb, "CommonValueConverter"), _wb), or = (_xb = class extends Ac {
  constructor(e) {
...
}, i(_xb, "AbstractMermaidTokenBuilder"), _xb);
_yb = class extends or {
}, i(_yb, "CommonTokenBuilder"), _yb;
...
lodash-es/lodash.js:
   ...
   *)
*/
var iG = (_zb = class extends or {
  constructor() {
    super(["radar-beta"]);
  }
}, i(_zb, "RadarTokenBuilder"), _zb), Nb = { parser: { TokenBuilder: i(() => new iG(), "TokenBuilder"), ValueConverter: i(() => new Ks(), "ValueConverter") } };
function kb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), JF, Nb);
  return t.ServiceRegistry.register(r), { shared: t, Radar: r };
}
i(kb, "createRadarServices");
var sG = (_Ab = class extends or {
  constructor() {
    super(["treemap"]);
  }
}, i(_Ab, "TreemapTokenBuilder"), _Ab), oG = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/, lG = (_Bb = class extends ti {
  runCustomConverter(e, t, r) {
...
}, i(_Bb, "TreemapValueConverter"), _Bb);
function Pb(e) {
  const t = e.validation.TreemapValidator, r = e.validation.ValidationRegistry;
  if (r) {
    const n = { Treemap: t.checkSingleRoot.bind(t) };
    r.register(n, t);
  }
}
...
var cG = (_Cb = class {
  checkSingleRoot(e, t) {
    let r;
    for (const n of e.TreemapRows) n.item && (r === void 0 && n.indent === void 0 ? r = 0 : n.indent === void 0 ? t("error", "Multiple root nodes are not allowed in a treemap.", { node: n, property: "item" }) : r !== void 0 && r >= parseInt(n.indent, 10) && t("error", "Multiple root nodes are not allowed in a treemap.", { node: n, property: "item" }));
  }
}, i(_Cb, "TreemapValidator"), _Cb), Ob = { parser: { TokenBuilder: i(() => new sG(), "TokenBuilder"), ValueConverter: i(() => new lG(), "ValueConverter") }, validation: { TreemapValidator: i(() => new cG(), "TreemapValidator") } };
function Lb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), ZF, Ob);
  return t.ServiceRegistry.register(r), Pb(r), { shared: t, Treemap: r };
}
i(Lb, "createTreemapServices");
var uG = (_Db = class extends ti {
  runCustomConverter(e, t, r) {
    switch (e.name.toUpperCase()) {
      case "LINK_LABEL":
...
}, i(_Db, "WardleyValueConverter"), _Db), Db = { parser: { ValueConverter: i(() => new uG(), "ValueConverter") } };
function Mb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), eG, Db);
  return t.ServiceRegistry.register(r), { shared: t, Wardley: r };
}
i(Mb, "createWardleyServices");
var dG = (_Eb = class extends or {
  constructor() {
    super(["gitGraph"]);
  }
}, i(_Eb, "GitGraphTokenBuilder"), _Eb), xb = { parser: { TokenBuilder: i(() => new dG(), "TokenBuilder"), ValueConverter: i(() => new Ks(), "ValueConverter") } };
function Fb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), VF, xb);
  return t.ServiceRegistry.register(r), { shared: t, GitGraph: r };
}
i(Fb, "createGitGraphServices");
var fG = (_Fb = class extends or {
  constructor() {
    super(["info", "showInfo"]);
  }
}, i(_Fb, "InfoTokenBuilder"), _Fb), Gb = { parser: { TokenBuilder: i(() => new fG(), "TokenBuilder"), ValueConverter: i(() => new Ks(), "ValueConverter") } };
function jb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), HF, Gb);
  return t.ServiceRegistry.register(r), { shared: t, Info: r };
}
i(jb, "createInfoServices");
var pG = (_Gb = class extends or {
  constructor() {
    super(["packet"]);
  }
}, i(_Gb, "PacketTokenBuilder"), _Gb), Ub = { parser: { TokenBuilder: i(() => new pG(), "TokenBuilder"), ValueConverter: i(() => new Ks(), "ValueConverter") } };
function zb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), YF, Ub);
  return t.ServiceRegistry.register(r), { shared: t, Packet: r };
}
i(zb, "createPacketServices");
var hG = (_Hb = class extends or {
  constructor() {
    super(["pie", "showData"]);
  }
}, i(_Hb, "PieTokenBuilder"), _Hb), mG = (_Ib = class extends ti {
  runCustomConverter(e, t, r) {
    if (e.name === "PIE_SECTION_LABEL") return t.replace(/"/g, "").trim();
  }
}, i(_Ib, "PieValueConverter"), _Ib), Bb = { parser: { TokenBuilder: i(() => new hG(), "TokenBuilder"), ValueConverter: i(() => new mG(), "ValueConverter") } };
function Kb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), XF, Bb);
  return t.ServiceRegistry.register(r), { shared: t, Pie: r };
}
i(Kb, "createPieServices");
var gG = (_Jb = class extends ti {
  runCustomConverter(e, t, r) {
    if (e.name === "INDENTATION") return (t == null ? void 0 : t.length) || 0;
    if (e.name === "STRING2") return t.substring(1, t.length - 1);
  }
}, i(_Jb, "TreeViewValueConverter"), _Jb), yG = (_Kb = class extends or {
  constructor() {
    super(["treeView-beta"]);
  }
}, i(_Kb, "TreeViewTokenBuilder"), _Kb), qb = { parser: { TokenBuilder: i(() => new yG(), "TokenBuilder"), ValueConverter: i(() => new gG(), "ValueConverter") } };
function Wb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), QF, qb);
  return t.ServiceRegistry.register(r), { shared: t, TreeView: r };
}
i(Wb, "createTreeViewServices");
var vG = (_Lb = class extends or {
  constructor() {
    super(["architecture"]);
  }
}, i(_Lb, "ArchitectureTokenBuilder"), _Lb), TG = (_Mb = class extends ti {
  runCustomConverter(e, t, r) {
...
}, i(_Mb, "ArchitectureValueConverter"), _Mb), Vb = { parser: { TokenBuilder: i(() => new vG(), "TokenBuilder"), ValueConverter: i(() => new TG(), "ValueConverter") } };
function Hb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), qF, Vb);
  return t.ServiceRegistry.register(r), { shared: t, Architecture: r };
}
i(Hb, "createArchitectureServices");
var RG = (_Nb = class extends or {
  constructor() {
    super(["eventmodeling"]);
  }
}, i(_Nb, "EventModelingTokenBuilder"), _Nb), Ag = /* @__PURE__ */ new Set(["cmd", "command"]), Eg = /* @__PURE__ */ new Set(["evt", "event"]), Qc = /* @__PURE__ */ new Set(["rmo", "readmodel"]), _g = /* @__PURE__ */ new Set(["pcr", "processor"]), Cg = /* @__PURE__ */ new Set(["ui"]);
function Yb(e) {
  const t = e.validation.EventModelingValidator, r = e.validation.ValidationRegistry;
  if (r) {
    const n = { EmTimeFrame: t.checkSourceFrameTypes.bind(t), EmResetFrame: t.checkSourceFrameTypes.bind(t) };
    r.register(n, t);
  }
}
i(Yb, "registerValidationChecks");
var $G = (_Ob = class {
  checkSourceFrameTypes(e, t) {
    e.sourceFrames.length !== 0 && (Ag.has(e.modelEntityType) ? this.validateSources(e, /* @__PURE__ */ new Set([...Cg, ..._g]), "command", "ui or processor", t) : Eg.has(e.modelEntityType) ? this.validateSources(e, Ag, "event", "command", t) : Qc.has(e.modelEntityType) ? this.validateSources(e, Eg, "read model", "event", t) : _g.has(e.modelEntityType) ? this.validateSources(e, Qc, "processor", "read model", t) : Cg.has(e.modelEntityType) && this.validateSources(e, Qc, "ui", "read model", t));
  }
  validateSources(e, t, r, n, a) {
    for (const s of e.sourceFrames) {
      const o = s.ref;
      o !== void 0 && !t.has(o.modelEntityType) && a("error", `A ${r} can only receive input from a ${n}, not from '${o.modelEntityType}'.`, { node: e, property: "sourceFrames" });
    }
  }
}, i(_Ob, "EventModelingValidator"), _Ob), Xb = { parser: { TokenBuilder: i(() => new RG(), "TokenBuilder"), ValueConverter: i(() => new Ks(), "ValueConverter") }, validation: { EventModelingValidator: i(() => new $G(), "EventModelingValidator") } };
function Jb(e = It) {
  const t = Ae(vt(e), sr), r = Ae(yt({ shared: t }), WF, Xb);
  return t.ServiceRegistry.register(r), Yb(r), { shared: t, EventModel: r };
}
i(Jb, "createEventModelingServices");
var At = {}, AG = { info: i(async () => {
  const { createInfoServices: e } = await qt(async () => {
    const { createInfoServices: r } = await Promise.resolve().then(() => CG);
    return { createInfoServices: r };
  }, void 0), t = e().Info.parser.LangiumParser;
  At.info = t;
}, "info"), packet: i(async () => {
  const { createPacketServices: e } = await qt(async () => {
    const { createPacketServices: r } = await Promise.resolve().then(() => SG);
    return { createPacketServices: r };
  }, void 0), t = e().Packet.parser.LangiumParser;
  At.packet = t;
}, "packet"), pie: i(async () => {
  const { createPieServices: e } = await qt(async () => {
    const { createPieServices: r } = await Promise.resolve().then(() => bG);
    return { createPieServices: r };
  }, void 0), t = e().Pie.parser.LangiumParser;
  At.pie = t;
}, "pie"), treeView: i(async () => {
  const { createTreeViewServices: e } = await qt(async () => {
    const { createTreeViewServices: r } = await Promise.resolve().then(() => wG);
    return { createTreeViewServices: r };
  }, void 0), t = e().TreeView.parser.LangiumParser;
  At.treeView = t;
}, "treeView"), architecture: i(async () => {
  const { createArchitectureServices: e } = await qt(async () => {
    const { createArchitectureServices: r } = await Promise.resolve().then(() => IG);
    return { createArchitectureServices: r };
  }, void 0), t = e().Architecture.parser.LangiumParser;
  At.architecture = t;
}, "architecture"), gitGraph: i(async () => {
  const { createGitGraphServices: e } = await qt(async () => {
    const { createGitGraphServices: r } = await Promise.resolve().then(() => NG);
    return { createGitGraphServices: r };
  }, void 0), t = e().GitGraph.parser.LangiumParser;
  At.gitGraph = t;
}, "gitGraph"), eventmodeling: i(async () => {
  const { createEventModelingServices: e } = await qt(async () => {
    const { createEventModelingServices: r } = await Promise.resolve().then(() => kG);
    return { createEventModelingServices: r };
  }, void 0), t = e().EventModel.parser.LangiumParser;
  At.eventmodeling = t;
}, "eventmodeling"), radar: i(async () => {
  const { createRadarServices: e } = await qt(async () => {
    const { createRadarServices: r } = await Promise.resolve().then(() => PG);
    return { createRadarServices: r };
  }, void 0), t = e().Radar.parser.LangiumParser;
  At.radar = t;
}, "radar"), treemap: i(async () => {
  const { createTreemapServices: e } = await qt(async () => {
    const { createTreemapServices: r } = await Promise.resolve().then(() => OG);
    return { createTreemapServices: r };
  }, void 0), t = e().Treemap.parser.LangiumParser;
  At.treemap = t;
}, "treemap"), wardley: i(async () => {
  const { createWardleyServices: e } = await qt(async () => {
    const { createWardleyServices: r } = await Promise.resolve().then(() => LG);
    return { createWardleyServices: r };
  }, void 0), t = e().Wardley.parser.LangiumParser;
  At.wardley = t;
}, "wardley") };
async function EG(e, t) {
  ...
  if (a.lexerErrors.length > 0 || a.parserErrors.length > 0) throw new _G(a);
  return a.value;
}
i(EG, "parse");
var _G = (_Pb = class extends Error {
  constructor(e) {
