...
var genColor = /* @__PURE__ */ __name((options) => {
  ...
  if (!(borderColorArray == null ? void 0 : borderColorArray.length)) return "";
  let sections = "";
...
var draw = /* @__PURE__ */ __name(async function(text, id, _version, diag) {
  ...
  const padding = 8;
  utils_default.insertTitle(svg, "requirementDiagramTitleText", (conf == null ? void 0 : conf.titleTopMargin) ?? 25, diag.db.getDiagramTitle());
