var _a;
import { t as ordinal } from "./ordinal-Bs01uwBv.js";
import { t as format } from "./defaultLocale-BExgBGLN.js";
import "./init-B8xRTswO.js";
import { Cn as getDiagramTitle, D as styles2String, E as isLabelStyle, In as setDiagramTitle, Jn as __name, N as cleanAndMerge, Nn as setAccDescription, Nt as selectSvgElement, Pn as setAccTitle, Tn as getThemeVariables3, Yn as log, bn as getAccTitle, gn as configureSvgSize, pn as clear, un as select_default, vn as defaultConfig_default, xn as getConfig, yn as getAccDescription } from "./index-BgJKKt_a.js";
...
var TreeMapDB = (_a = class {
  ...
  addClass(id, _style) {
    ...
    if (styles) styles.forEach((s) => {
      if (isLabelStyle(s)) if (styleClass == null ? void 0 : styleClass.textStyles) styleClass.textStyles.push(s);
      else styleClass.textStyles = [s];
      if (styleClass == null ? void 0 : styleClass.styles) styleClass.styles.push(s);
...
function buildHierarchy(items) {
  ...
  items.forEach((item) => {
    ...
    if (item == null ? void 0 : item.cssCompiledStyles) node.cssCompiledStyles = item.cssCompiledStyles;
...
var renderer = {
  draw: /* @__PURE__ */ __name((_text, id, _version, diagram2) => {
    ...
    setupViewPortForSVG(svg, config.diagramPadding ?? 8, "flowchart", (config == null ? void 0 : config.useMaxWidth) || false);
  }, "draw"),
