import { o as e, t } from "./chunk-Dpv4RYZm.js";
import { B as n, C as r, V as i, W as a, _ as o, a as s, b as c, c as l, s as u, v as d } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { a as f, c as p, d as m, f as h, g, h as _, i as v, p as y, s as b, u as x, v as S } from "./src-BWB47EtT.js";
import { a as C, i as w, n as T, r as E, t as D } from "./linear-CWOc3ypC.js";
import "./defaultLocale-DPK_2BZd.js";
import { t as O } from "./init-BNJjXmOc.js";
import { t as k } from "./dist-DAHuMNYw.js";
import { g as A } from "./chunk-5PVQY5BW-DyH3Wf6D.js";
...
var ne = 1, re = 2, ie = 3, ae = 4, oe = 1e-6;
function se(e2) {
...
function fe(e2, t2) {
  var n2 = [], r2 = null, i2 = null, a2 = 6, o2 = 6, s2 = 3, c2 = typeof window < `u` && window.devicePixelRatio > 1 ? 0 : 0.5, l2 = e2 === ne || e2 === ae ? -1 : 1, u2 = e2 === ae || e2 === re ? `x` : `y`, d2 = e2 === ne || e2 === ie ? se : ce;
  function f2(f3) {
    var p2 = r2 ?? (t2.ticks ? t2.ticks.apply(t2, n2) : t2.domain()), m2 = i2 ?? (t2.tickFormat ? t2.tickFormat.apply(t2, n2) : te), h2 = Math.max(a2, 0) + s2, g2 = t2.range(), _2 = +g2[0] + c2, v2 = +g2[g2.length - 1] + c2, y2 = (t2.bandwidth ? ue : le)(t2.copy(), c2), b2 = f3.selection ? f3.selection() : f3, x2 = b2.selectAll(`.domain`).data([null]), S2 = b2.selectAll(`.tick`).data(p2, t2).order(), C2 = S2.exit(), w2 = S2.enter().append(`g`).attr(`class`, `tick`), T2 = S2.select(`line`), E2 = S2.select(`text`);
    x2 = x2.merge(x2.enter().insert(`path`, `.tick`).attr(`class`, `domain`).attr(`stroke`, `currentColor`)), S2 = S2.merge(w2), T2 = T2.merge(w2.append(`line`).attr(`stroke`, `currentColor`).attr(u2 + `2`, l2 * a2)), E2 = E2.merge(w2.append(`text`).attr(`fill`, `currentColor`).attr(u2, l2 * h2).attr(`dy`, e2 === ne ? `0em` : e2 === ie ? `0.71em` : `0.32em`)), f3 !== b2 && (x2 = x2.transition(f3), S2 = S2.transition(f3), T2 = T2.transition(f3), E2 = E2.transition(f3), C2 = C2.transition(f3).attr(`opacity`, oe).attr(`transform`, function(e3) {
      return isFinite(e3 = y2(e3)) ? d2(e3 + c2) : this.getAttribute(`transform`);
    }), w2.attr(`opacity`, oe).attr(`transform`, function(e3) {
      var t3 = this.parentNode.__axis;
      return d2((t3 && isFinite(t3 = t3(e3)) ? t3 : y2(e3)) + c2);
    })), C2.remove(), x2.attr(`d`, e2 === ae || e2 === re ? o2 ? `M` + l2 * o2 + `,` + _2 + `H` + c2 + `V` + v2 + `H` + l2 * o2 : `M` + c2 + `,` + _2 + `V` + v2 : o2 ? `M` + _2 + `,` + l2 * o2 + `V` + c2 + `H` + v2 + `V` + l2 * o2 : `M` + _2 + `,` + c2 + `H` + v2), S2.attr(`opacity`, 1).attr(`transform`, function(e3) {
      return d2(y2(e3) + c2);
    }), T2.attr(u2 + `2`, l2 * a2), E2.attr(u2, l2 * h2).text(m2), b2.filter(de).attr(`fill`, `none`).attr(`font-size`, 10).attr(`font-family`, `sans-serif`).attr(`text-anchor`, e2 === re ? `start` : e2 === ae ? `end` : `middle`), b2.each(function() {
      this.__axis = y2;
    });
  }
...
const he = Math.PI / 180, ge = 180 / Math.PI;
var _e = 18, ve = 0.96422, ye = 1, be = 0.82521, xe = 4 / 29, Se = 6 / 29, Ce = 3 * Se * Se, we = Se * Se * Se;
function Te(e2) {
  if (e2 instanceof M) return new M(e2.l, e2.a, e2.b, e2.opacity);
  if (e2 instanceof N) return Ne(e2);
  e2 instanceof p || (e2 = x(e2));
  var t2 = Ae(e2.r), n2 = Ae(e2.g), r2 = Ae(e2.b), i2 = De((0.2225045 * t2 + 0.7168786 * n2 + 0.0606169 * r2) / ye), a2, o2;
  return t2 === n2 && n2 === r2 ? a2 = o2 = i2 : (a2 = De((0.4360747 * t2 + 0.3850649 * n2 + 0.1430804 * r2) / ve), o2 = De((0.0139322 * t2 + 0.0971045 * n2 + 0.7141733 * r2) / be)), new M(116 * i2 - 16, 500 * (a2 - i2), 200 * (i2 - o2), e2.opacity);
}
function Ee(e2, t2, n2, r2) {
  return arguments.length === 1 ? Te(e2) : new M(e2, t2, n2, r2 ?? 1);
}
function M(e2, t2, n2, r2) {
  this.l = +e2, this.a = +t2, this.b = +n2, this.opacity = +r2;
}
m(M, Ee, h(b, { brighter(e2) {
  return new M(this.l + _e * (e2 ?? 1), this.a, this.b, this.opacity);
}, darker(e2) {
  return new M(this.l - _e * (e2 ?? 1), this.a, this.b, this.opacity);
}, rgb() {
  var e2 = (this.l + 16) / 116, t2 = isNaN(this.a) ? e2 : e2 + this.a / 500, n2 = isNaN(this.b) ? e2 : e2 - this.b / 200;
  return t2 = ve * Oe(t2), e2 = ye * Oe(e2), n2 = be * Oe(n2), new p(ke(3.1338561 * t2 - 1.6168667 * e2 - 0.4906146 * n2), ke(-0.9787684 * t2 + 1.9161415 * e2 + 0.033454 * n2), ke(0.0719453 * t2 - 0.2289914 * e2 + 1.4052427 * n2), this.opacity);
} }));
function De(e2) {
  return e2 > we ? e2 ** (1 / 3) : e2 / Ce + xe;
}
function Oe(e2) {
  return e2 > Se ? e2 * e2 * e2 : Ce * (e2 - xe);
}
function ke(e2) {
...
function je(e2) {
  if (e2 instanceof N) return new N(e2.h, e2.c, e2.l, e2.opacity);
  if (e2 instanceof M || (e2 = Te(e2)), e2.a === 0 && e2.b === 0) return new N(NaN, 0 < e2.l && e2.l < 100 ? 0 : NaN, e2.l, e2.opacity);
  var t2 = Math.atan2(e2.b, e2.a) * ge;
  return new N(t2 < 0 ? t2 + 360 : t2, Math.sqrt(e2.a * e2.a + e2.b * e2.b), e2.l, e2.opacity);
}
function Me(e2, t2, n2, r2) {
  return arguments.length === 1 ? je(e2) : new N(e2, t2, n2, r2 ?? 1);
}
function N(e2, t2, n2, r2) {
  this.h = +e2, this.c = +t2, this.l = +n2, this.opacity = +r2;
}
function Ne(e2) {
  if (isNaN(e2.h)) return new M(e2.l, 0, 0, e2.opacity);
  var t2 = e2.h * he;
  return new M(e2.l, Math.cos(t2) * e2.c, Math.sin(t2) * e2.c, e2.opacity);
}
m(N, Me, h(b, { brighter(e2) {
  return new N(this.h, this.c, this.l + _e * (e2 ?? 1), this.opacity);
}, darker(e2) {
  return new N(this.h, this.c, this.l - _e * (e2 ?? 1), this.opacity);
}, rgb() {
  return Ne(this).rgb();
...
function Pe(e2) {
  return function(t2, n2) {
    var r2 = e2((t2 = Me(t2)).h, (n2 = Me(n2)).h), i2 = f(t2.c, n2.c), a2 = f(t2.l, n2.l), o2 = f(t2.opacity, n2.opacity);
    return function(e3) {
...
function P(e2, t2, n2, r2) {
  ...
  }), n2 && (i2.count = (t3, r3) => (Le.setTime(+t3), Re.setTime(+r3), e2(Le), e2(Re), Math.floor(n2(Le, Re))), i2.every = (e3) => (e3 = Math.floor(e3), !isFinite(e3) || !(e3 > 0) ? null : e3 > 1 ? i2.filter(r2 ? (t3) => r2(t3) % e3 === 0 : (t3) => i2.count(0, t3) % e3 === 0) : i2)), i2;
}
const ze = P(() => {
}, (e2, t2) => {
  e2.setTime(+e2 + t2);
}, (e2, t2) => t2 - e2);
ze.every = (e2) => (e2 = Math.floor(e2), !isFinite(e2) || !(e2 > 0) ? null : e2 > 1 ? P((t2) => {
  t2.setTime(Math.floor(t2 / e2) * e2);
}, (t2, n2) => {
  t2.setTime(+t2 + n2 * e2);
}, (t2, n2) => (n2 - t2) / e2) : ze), ze.range;
const F = 1e3, I = F * 60, L = I * 60, R = L * 24, Be = R * 7, Ve = R * 30, He = R * 365, z = P((e2) => {
...
Ke.range;
const B = P((e2) => e2.setHours(0, 0, 0, 0), (e2, t2) => e2.setDate(e2.getDate() + t2), (e2, t2) => (t2 - e2 - (t2.getTimezoneOffset() - e2.getTimezoneOffset()) * I) / R, (e2) => e2.getDate() - 1);
B.range;
const qe = P((e2) => {
...
const tt = U(0), nt = U(1), rt = U(2), it = U(3), at = U(4), ot = U(5), st = U(6);
...
W.every = (e2) => !isFinite(e2 = Math.floor(e2)) || !(e2 > 0) ? null : P((t2) => {
...
G.every = (e2) => !isFinite(e2 = Math.floor(e2)) || !(e2 > 0) ? null : P((t2) => {
...
function ut(e2, t2, n2, r2, i2, a2) {
  ...
  function c2(t3, n3, r3) {
    ...
    if (a3 === 0) return ze.every(Math.max(w(t3, n3, r3), 1));
...
function vt(e2) {
  var t2 = e2.dateTime, n2 = e2.date, r2 = e2.time, i2 = e2.periods, a2 = e2.days, o2 = e2.shortDays, s2 = e2.months, c2 = e2.shortMonths, l2 = Ct(i2), u2 = wt(i2), d2 = Ct(a2), f2 = wt(a2), p2 = Ct(o2), m2 = wt(o2), h2 = Ct(s2), g2 = wt(s2), _2 = Ct(c2), v2 = wt(c2), y2 = { a: te2, A: ne2, b: re2, B: ie2, c: null, d: Gt, e: Gt, f: Xt, g: cn, G: un, H: Kt, I: qt, j: Jt, L: Yt, m: Zt, M: Qt, p: ae2, q: oe2, Q: Nn, s: Pn, S: $t, u: en, U: tn, V: rn, w: an, W: on, x: null, X: null, y: sn, Y: ln, Z: dn, "%": Mn }, b2 = { a: se2, A: ce2, b: le2, B: ue2, c: null, d: fn, e: fn, f: _n, g: On, G: An, H: pn, I: mn, j: hn, L: gn, m: vn, M: yn, p: de2, q: fe2, Q: Nn, s: Pn, S: bn, u: xn, U: Sn, V: wn, w: Tn, W: En, x: null, X: null, y: Dn, Y: kn, Z: jn, "%": Mn }, x2 = { a: E2, A: D2, b: O2, B: k2, c: A2, d: Ft, e: Ft, f: Vt, g: jt, G: At, H: Lt, I: Lt, j: It, L: Bt, m: Pt, M: Rt, p: T2, q: Nt, Q: Ut, s: Wt, S: zt, u: Et, U: Dt, V: Ot, w: Tt, W: kt, x: j2, X: ee2, y: jt, Y: At, Z: Mt, "%": Ht };
  ...
  function S2(e3, t3) {
    return function(n3) {
      ...
      for (n3 instanceof Date || (n3 = /* @__PURE__ */ new Date(+n3)); ++i3 < o3; ) e3.charCodeAt(i3) === 37 && (r3.push(e3.slice(a3, i3)), (c3 = yt[s3 = e3.charAt(++i3)]) == null ? c3 = s3 === `e` ? ` ` : `0` : s3 = e3.charAt(++i3), (l3 = t3[s3]) && (s3 = l3(n3, c3)), r3.push(s3), a3 = i3 + 1);
      return r3.push(e3.slice(a3, i3)), r3.join(``);
    };
  }
  function C2(e3, t3) {
    return function(n3) {
      var r3 = _t(1900, void 0, 1), i3 = w2(r3, e3, n3 += ``, 0), a3, o3;
      ...
      if (t3 && !(`Z` in r3) && (r3.Z = 0), `p` in r3 && (r3.H = r3.H % 12 + r3.p * 12), r3.m === void 0 && (r3.m = `q` in r3 ? r3.q : 0), `V` in r3) {
        ...
        `w` in r3 || (r3.w = 1), `Z` in r3 ? (a3 = gt(_t(r3.y, 0, 1)), o3 = a3.getUTCDay(), a3 = o3 > 4 || o3 === 0 ? nt.ceil(a3) : nt(a3), a3 = qe.offset(a3, (r3.V - 1) * 7), r3.y = a3.getUTCFullYear(), r3.m = a3.getUTCMonth(), r3.d = a3.getUTCDate() + (r3.w + 6) % 7) : (a3 = ht(_t(r3.y, 0, 1)), o3 = a3.getDay(), a3 = o3 > 4 || o3 === 0 ? Xe.ceil(a3) : Xe(a3), a3 = B.offset(a3, (r3.V - 1) * 7), r3.y = a3.getFullYear(), r3.m = a3.getMonth(), r3.d = a3.getDate() + (r3.w + 6) % 7);
      } else (`W` in r3 || `U` in r3) && (`w` in r3 || (r3.w = `u` in r3 ? r3.u % 7 : `W` in r3 ? 1 : 0), o3 = `Z` in r3 ? gt(_t(r3.y, 0, 1)).getUTCDay() : ht(_t(r3.y, 0, 1)).getDay(), r3.m = 0, r3.d = `W` in r3 ? (r3.w + 6) % 7 + r3.W * 7 - (o3 + 5) % 7 : r3.w + r3.U * 7 - (o3 + 6) % 7);
      return `Z` in r3 ? (r3.H += r3.Z / 100 | 0, r3.M += r3.Z % 100, gt(r3)) : ht(r3);
    };
  }
  function w2(e3, t3, n3, r3) {
    for (var i3 = 0, a3 = t3.length, o3 = n3.length, s3, c3; i3 < a3; ) {
      ...
      if (s3 = t3.charCodeAt(i3++), s3 === 37) {
        if (s3 = t3.charAt(i3++), c3 = x2[s3 in yt ? t3.charAt(i3++) : s3], !c3 || (r3 = c3(e3, n3, r3)) < 0) return -1;
...
function Dt(e2, t2, n2) {
  var r2 = K.exec(t2.slice(n2, n2 + 2));
  return r2 ? (e2.U = +r2[0], n2 + r2[0].length) : -1;
}
...
function At(e2, t2, n2) {
  var r2 = K.exec(t2.slice(n2, n2 + 4));
...
function It(e2, t2, n2) {
  var r2 = K.exec(t2.slice(n2, n2 + 3));
...
function Gt(e2, t2) {
  return q(e2.getDate(), t2, 2);
}
function Kt(e2, t2) {
  return q(e2.getHours(), t2, 2);
}
function qt(e2, t2) {
  return q(e2.getHours() % 12 || 12, t2, 2);
}
function Jt(e2, t2) {
  return q(1 + B.count(W(e2), e2), t2, 3);
}
function Yt(e2, t2) {
  return q(e2.getMilliseconds(), t2, 3);
}
function Xt(e2, t2) {
  return Yt(e2, t2) + `000`;
}
function Zt(e2, t2) {
  return q(e2.getMonth() + 1, t2, 2);
}
function Qt(e2, t2) {
  return q(e2.getMinutes(), t2, 2);
}
function $t(e2, t2) {
  return q(e2.getSeconds(), t2, 2);
}
function en(e2) {
  var t2 = e2.getDay();
  return t2 === 0 ? 7 : t2;
...
function tn(e2, t2) {
  return q(Ye.count(W(e2) - 1, e2), t2, 2);
}
function nn(e2) {
  var t2 = e2.getDay();
...
function rn(e2, t2) {
  return e2 = nn(e2), q(H.count(W(e2), e2) + (W(e2).getDay() === 4), t2, 2);
}
function an(e2) {
  return e2.getDay();
}
function on(e2, t2) {
  return q(Xe.count(W(e2) - 1, e2), t2, 2);
}
function sn(e2, t2) {
  return q(e2.getFullYear() % 100, t2, 2);
}
function cn(e2, t2) {
  return e2 = nn(e2), q(e2.getFullYear() % 100, t2, 2);
}
function ln(e2, t2) {
  return q(e2.getFullYear() % 1e4, t2, 4);
}
function un(e2, t2) {
  var n2 = e2.getDay();
  return e2 = n2 >= 4 || n2 === 0 ? H(e2) : H.ceil(e2), q(e2.getFullYear() % 1e4, t2, 4);
}
function dn(e2) {
  var t2 = e2.getTimezoneOffset();
  return (t2 > 0 ? `-` : (t2 *= -1, `+`)) + q(t2 / 60 | 0, `0`, 2) + q(t2 % 60, `0`, 2);
}
function fn(e2, t2) {
  return q(e2.getUTCDate(), t2, 2);
}
function pn(e2, t2) {
  return q(e2.getUTCHours(), t2, 2);
}
function mn(e2, t2) {
  return q(e2.getUTCHours() % 12 || 12, t2, 2);
}
function hn(e2, t2) {
  return q(1 + qe.count(G(e2), e2), t2, 3);
}
function gn(e2, t2) {
  return q(e2.getUTCMilliseconds(), t2, 3);
}
function _n(e2, t2) {
  return gn(e2, t2) + `000`;
}
function vn(e2, t2) {
  return q(e2.getUTCMonth() + 1, t2, 2);
}
function yn(e2, t2) {
  return q(e2.getUTCMinutes(), t2, 2);
}
function bn(e2, t2) {
  return q(e2.getUTCSeconds(), t2, 2);
}
function xn(e2) {
  var t2 = e2.getUTCDay();
  return t2 === 0 ? 7 : t2;
...
function Sn(e2, t2) {
  return q(tt.count(G(e2) - 1, e2), t2, 2);
}
function Cn(e2) {
  var t2 = e2.getUTCDay();
  return t2 >= 4 || t2 === 0 ? at(e2) : at.ceil(e2);
}
function wn(e2, t2) {
  return e2 = Cn(e2), q(at.count(G(e2), e2) + (G(e2).getUTCDay() === 4), t2, 2);
}
function Tn(e2) {
  return e2.getUTCDay();
}
function En(e2, t2) {
  return q(nt.count(G(e2) - 1, e2), t2, 2);
}
function Dn(e2, t2) {
  return q(e2.getUTCFullYear() % 100, t2, 2);
}
function On(e2, t2) {
  return e2 = Cn(e2), q(e2.getUTCFullYear() % 100, t2, 2);
}
function kn(e2, t2) {
  return q(e2.getUTCFullYear() % 1e4, t2, 4);
}
function An(e2, t2) {
  var n2 = e2.getUTCDay();
  return e2 = n2 >= 4 || n2 === 0 ? at(e2) : at.ceil(e2), q(e2.getUTCFullYear() % 1e4, t2, 4);
}
function jn() {
  return `+0000`;
}
...
function In(e2) {
  return J = vt(e2), Fn = J.format, J.parse, J.utcFormat, J.utcParse, J;
}
function Ln(e2) {
  return new Date(e2);
}
...
function zn(e2, t2, n2, r2, i2, a2, o2, s2, c2, l2) {
  ...
  return u2.invert = function(e3) {
    ...
    var n3 = f2();
    return (!e3 || typeof e3.range != `function`) && (e3 = t2(n3[0], n3[n3.length - 1], e3 ?? 10)), e3 ? f2(Ie(n3, e3)) : u2;
  }, u2.copy = function() {
    return E(u2, zn(e2, t2, n2, r2, i2, a2, o2, s2, c2, l2));
  }, u2;
}
function Bn() {
  return O.apply(zn(pt, mt, W, ct, Ye, B, Ge, Ue, z, Fn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
var Vn = t(((e2, t2) => {
  (function(n2, r2) {
...
})), Gn = k(), Y = e(S(), 1), Kn = e(Vn(), 1), qn = e(Hn(), 1), Jn = e(Un(), 1), Yn = e(S(), 1), Xn = e(Wn(), 1), Zn = (function() {
  var e2 = _(function(e3, t3, n3, r3) {
    ...
    _(x3, `lex`);
    for (var S3, C3, w3, T3, E3, D3 = {}, O3, k2, A2, j2; ; ) {
      if (w3 = n3[n3.length - 1], this.defaultActions[w3] ? T3 = this.defaultActions[w3] : (S3 ?? (S3 = x3()), T3 = o3[w3] && o3[w3][S3]), T3 === void 0 || !T3.length || !T3[0]) {
        ...
        ee2 = m3.showPosition ? `Parse error on line ` + (c3 + 1) + `:
` + m3.showPosition() + `
Expecting ` + j2.join(`, `) + `, got '` + (this.terminals_[S3] || S3) + `'` : `Parse error on line ` + (c3 + 1) + `: Unexpected ` + (S3 == f3 ? `end of input` : `'` + (this.terminals_[S3] || S3) + `'`), this.parseError(ee2, { text: m3.match, token: this.terminals_[S3] || S3, line: m3.yylineno, loc: v3, expected: j2 });
      }
      ...
      switch (T3[0]) {
        ...
        case 2:
          ...
          k2 && (n3 = n3.slice(0, -1 * k2 * 2), i3 = i3.slice(0, -1 * k2), a3 = a3.slice(0, -1 * k2)), n3.push(this.productions_[T3[1]][0]), i3.push(D3.$), a3.push(D3._$), A2 = o3[n3[n3.length - 2]][n3[n3.length - 1]], n3.push(A2);
          break;
        case 3:
          return true;
      }
...
var $n = { friday: 5, saturday: 6 }, X = ``, er = ``, tr = void 0, nr = ``, rr = [], ir = [], ar = /* @__PURE__ */ new Map(), or = [], sr = [], cr = ``, lr = ``, ur = [`active`, `done`, `crit`, `milestone`, `vert`], dr = [], fr = ``, pr = false, mr = false, hr = `sunday`, gr = `saturday`, _r = 0, vr = _(function() {
  or = [], sr = [], cr = ``, dr = [], Zr = 0, ti = void 0, ni = void 0, Z = [], X = ``, er = ``, lr = ``, tr = void 0, nr = ``, rr = [], ir = [], pr = false, mr = false, _r = 0, ar = /* @__PURE__ */ new Map(), fr = ``, s(), hr = `sunday`, gr = `saturday`;
}, `clear`), yr = _(function(e2) {
  fr = e2;
}, `setDiagramId`), br = _(function(e2) {
  er = e2;
}, `setAxisFormat`), xr = _(function() {
  return er;
}, `getAxisFormat`), Sr = _(function(e2) {
  tr = e2;
}, `setTickInterval`), Cr = _(function() {
  return tr;
}, `getTickInterval`), wr = _(function(e2) {
  nr = e2;
}, `setTodayMarker`), Tr = _(function() {
  return nr;
}, `getTodayMarker`), Er = _(function(e2) {
  X = e2;
}, `setDateFormat`), Dr = _(function() {
  pr = true;
}, `enableInclusiveEndDates`), Or = _(function() {
  return pr;
}, `endDatesAreInclusive`), kr = _(function() {
  mr = true;
}, `enableTopAxis`), Ar = _(function() {
  return mr;
}, `topAxisEnabled`), jr = _(function(e2) {
  lr = e2;
}, `setDisplayMode`), Mr = _(function() {
  return lr;
}, `getDisplayMode`), Nr = _(function() {
  return X;
}, `getDateFormat`), Pr = _(function(e2) {
  rr = e2.toLowerCase().split(/[\s,]+/);
}, `setIncludes`), Fr = _(function() {
  return rr;
}, `getIncludes`), Ir = _(function(e2) {
  ir = e2.toLowerCase().split(/[\s,]+/);
}, `setExcludes`), Lr = _(function() {
  return ir;
}, `getExcludes`), Rr = _(function() {
  return ar;
}, `getLinks`), zr = _(function(e2) {
  cr = e2, or.push(e2);
}, `addSection`), Br = _(function() {
  return or;
}, `getSections`), Vr = _(function() {
  let e2 = oi(), t2 = 0;
  for (; !e2 && t2 < 10; ) e2 = oi(), t2++;
  return sr = Z, sr;
}, `getTasks`), Hr = _(function(e2, t2, n2, r2) {
  let i2 = e2.format(t2.trim()), a2 = e2.format(`YYYY-MM-DD`);
  return r2.includes(i2) || r2.includes(a2) ? false : n2.includes(`weekends`) && (e2.isoWeekday() === $n[gr] || e2.isoWeekday() === $n[gr] + 1) || n2.includes(e2.format(`dddd`).toLowerCase()) ? true : n2.includes(i2) || n2.includes(a2);
}, `isInvalidDate`), Ur = _(function(e2) {
  hr = e2;
}, `setWeekday`), Wr = _(function() {
  return hr;
}, `getWeekday`), Gr = _(function(e2) {
  gr = e2;
}, `setWeekend`), Kr = _(function(e2, t2, n2, r2) {
  ...
  let [o2, s2] = qr(i2, a2, t2, n2, r2);
  e2.endTime = o2.toDate(), e2.renderEndTime = s2;
}, `checkTaskDates`), qr = _(function(e2, t2, n2, r2, i2) {
  let a2 = false, o2 = null;
  for (; e2 <= t2; ) a2 || (o2 = t2.toDate()), a2 = Hr(e2, n2, r2, i2), a2 && (t2 = t2.add(1, `d`)), e2 = e2.add(1, `d`);
  return [t2, o2];
}, `fixTaskDates`), Jr = _(function(e2, t2, n2) {
  if (n2 = n2.trim(), _((e3) => {
    let t3 = e3.trim();
    return t3 === `x` || t3 === `X`;
  ...
  let o2 = (0, Y.default)(e2), [s2, c2] = Yr(n2);
  if (!Number.isNaN(s2)) {
    let e3 = o2.add(s2, c2);
    e3.isValid() && (o2 = e3);
  }
  return o2.toDate();
}, `getEndDate`), Zr = 0, Qr = _(function(e2) {
  return e2 === void 0 ? (Zr += 1, `task` + Zr) : e2;
}, `parseId`), $r = _(function(e2, t2) {
  let n2;
  ...
  switch (r2.length) {
    case 1:
      i2.id = Qr(), i2.startTime = e2.endTime, a2 = r2[0];
      break;
    case 2:
      i2.id = Qr(), i2.startTime = Jr(void 0, X, r2[0]), a2 = r2[1];
      break;
    case 3:
      i2.id = Qr(r2[0]), i2.startTime = Jr(void 0, X, r2[1]), a2 = r2[2];
      break;
    default:
  }
  return a2 && (i2.endTime = Xr(i2.startTime, X, a2, pr), i2.manualEndTime = (0, Y.default)(a2, `YYYY-MM-DD`, true).isValid(), Kr(i2, X, ir, rr)), i2;
}, `compileData`), ei = _(function(e2, t2) {
  let n2;
  n2 = t2.substr(0, 1) === `:` ? t2.substr(1, t2.length) : t2;
  let r2 = n2.split(`,`), i2 = {};
  fi(r2, i2, ur);
  ...
  switch (r2.length) {
    case 1:
      i2.id = Qr(), i2.startTime = { type: `prevTaskEnd`, id: e2 }, i2.endTime = { data: r2[0] };
      break;
    case 2:
      i2.id = Qr(), i2.startTime = { type: `getStartDate`, startData: r2[0] }, i2.endTime = { data: r2[1] };
      break;
    case 3:
      i2.id = Qr(r2[0]), i2.startTime = { type: `getStartDate`, startData: r2[1] }, i2.endTime = { data: r2[2] };
      break;
    default:
  }
  return i2;
}, `parseData`), ti, ni, Z = [], ri = {}, ii = _(function(e2, t2) {
  let n2 = { section: cr, type: cr, processed: false, manualEndTime: false, renderEndTime: null, raw: { data: t2 }, task: e2, classes: [] }, r2 = ei(ni, t2);
  n2.raw.startTime = r2.startTime, n2.raw.endTime = r2.endTime, n2.id = r2.id, n2.prevTaskId = ni, n2.active = r2.active, n2.done = r2.done, n2.crit = r2.crit, n2.milestone = r2.milestone, n2.vert = r2.vert, n2.order = _r, _r++;
  let i2 = Z.push(n2);
  ni = n2.id, ri[n2.id] = i2 - 1;
}, `addTask`), Q = _(function(e2) {
  let t2 = ri[e2];
  return Z[t2];
}, `findTaskById`), ai = _(function(e2, t2) {
  let n2 = { section: cr, type: cr, description: e2, task: e2, classes: [] }, r2 = $r(ti, t2);
  n2.startTime = r2.startTime, n2.endTime = r2.endTime, n2.id = r2.id, n2.active = r2.active, n2.done = r2.done, n2.crit = r2.crit, n2.milestone = r2.milestone, n2.vert = r2.vert, ti = n2, sr.push(n2);
}, `addTaskOrg`), oi = _(function() {
  let e2 = _(function(e3) {
    ...
    switch (Z[e3].raw.startTime.type) {
      case `prevTaskEnd`:
        ...
        break;
      case `getStartDate`:
        n2 = Jr(void 0, X, Z[e3].raw.startTime.startData), n2 && (Z[e3].startTime = n2);
        break;
    }
    return Z[e3].startTime && (Z[e3].endTime = Xr(Z[e3].startTime, X, Z[e3].raw.endTime.data, pr), Z[e3].endTime && (Z[e3].processed = true, Z[e3].manualEndTime = (0, Y.default)(Z[e3].raw.endTime.data, `YYYY-MM-DD`, true).isValid(), Kr(Z[e3], X, ir, rr))), Z[e3].processed;
  }, `compileTask`), t2 = true;
  for (let [n2, r2] of Z.entries()) e2(n2), t2 && (t2 = r2.processed);
  return t2;
}, `compileTasks`), si = _(function(e2, t2) {
  let n2 = t2;
  c().securityLevel !== `loose` && (n2 = (0, Gn.sanitizeUrl)(t2)), e2.split(`,`).forEach(function(e3) {
    Q(e3) !== void 0 && (ui(e3, () => {
      window.open(n2, `_self`);
    }), ar.set(e3, n2));
  }), ci(e2, `clickable`);
}, `setLink`), ci = _(function(e2, t2) {
  e2.split(`,`).forEach(function(e3) {
    let n2 = Q(e3);
    n2 !== void 0 && n2.classes.push(t2);
  });
}, `setClass`), li = _(function(e2, t2, n2) {
  if (c().securityLevel !== `loose` || t2 === void 0) return;
  let r2 = [];
  if (typeof n2 == `string`) {
    r2 = n2.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
  ...
  r2.length === 0 && r2.push(e2), Q(e2) !== void 0 && ui(e2, () => {
    A.runFunc(t2, ...r2);
  });
}, `setClickFun`), ui = _(function(e2, t2) {
  dr.push(function() {
    let n2 = fr ? `${fr}-${e2}` : e2, r2 = document.querySelector(`[id="${n2}"]`);
    r2 !== null && r2.addEventListener(`click`, function() {
      t2();
    });
  }, function() {
    let n2 = fr ? `${fr}-${e2}` : e2, r2 = document.querySelector(`[id="${n2}-text"]`);
    r2 !== null && r2.addEventListener(`click`, function() {
      t2();
    });
  });
}, `pushFun`), di = { getConfig: _(() => c().gantt, `getConfig`), clear: vr, setDateFormat: Er, getDateFormat: Nr, enableInclusiveEndDates: Dr, endDatesAreInclusive: Or, enableTopAxis: kr, topAxisEnabled: Ar, setAxisFormat: br, getAxisFormat: xr, setTickInterval: Sr, getTickInterval: Cr, setTodayMarker: wr, getTodayMarker: Tr, setAccTitle: i, getAccTitle: d, setDiagramTitle: a, getDiagramTitle: r, setDiagramId: yr, setDisplayMode: jr, getDisplayMode: Mr, setAccDescription: n, getAccDescription: o, addSection: zr, getSections: Br, getTasks: Vr, addTask: ii, findTaskById: Q, addTaskOrg: ai, setIncludes: Pr, getIncludes: Fr, setExcludes: Ir, getExcludes: Lr, setClickEvent: _(function(e2, t2, n2) {
  e2.split(`,`).forEach(function(e3) {
    li(e3, t2, n2);
  }), ci(e2, `clickable`);
}, `setClickEvent`), setLink: si, getLinks: Rr, bindFunctions: _(function(e2) {
  dr.forEach(function(t2) {
    t2(e2);
  });
}, `bindFunctions`), parseDuration: Yr, isInvalidDate: Hr, setWeekday: Ur, getWeekday: Wr, setWeekend: Gr };
...
_(fi, `getTaskTags`), Yn.default.extend(Xn.default);
var pi = _(function() {
  g.debug(`Something is calling, setConf, remove the call`);
}, `setConf`), mi = { monday: Xe, tuesday: Ze, wednesday: Qe, thursday: H, friday: $e, saturday: et, sunday: Ye }, hi = _((e2, t2) => {
  ...
  return i2;
}, `getMaxIntersections`), $, gi = 1e4, _i = { parser: Qn, db: di, renderer: { setConf: pi, draw: _(function(e2, t2, n2, r2) {
  let i2 = c().gantt;
  r2.db.setDiagramId(t2);
  let a2 = c().securityLevel, o2;
  a2 === `sandbox` && (o2 = y(`#i` + t2));
  let s2 = y(a2 === `sandbox` ? o2.nodes()[0].contentDocument.body : `body`), d2 = a2 === `sandbox` ? o2.nodes()[0].contentDocument : document, f2 = d2.getElementById(t2);
  ...
  let b2 = s2.select(`[id="${t2}"]`), x2 = Bn().domain([ee(p2, function(e3) {
    return e3.startTime;
  }), j(p2, function(e3) {
    return e3.endTime;
  ...
  _(S2, `taskCompare`), p2.sort(S2), C2(p2, $, v2), l(b2, v2, $, i2.useMaxWidth), b2.append(`text`).text(r2.db.getDiagramTitle()).attr(`x`, $ / 2).attr(`y`, i2.titleTopMargin).attr(`class`, `titleText`);
  function C2(e3, t3, n3) {
    let a3 = i2.barHeight, o3 = a3 + i2.barGap, s3 = i2.topPadding, c2 = i2.leftPadding, l2 = D().domain([0, m2.length]).range([`#00B9FA`, `#F95002`]).interpolate(Fe);
    T2(o3, s3, c2, t3, n3, e3, r2.db.getExcludes(), r2.db.getIncludes()), O2(c2, s3, t3, n3), w2(e3, o3, s3, c2, a3, l2, t3, n3), k2(o3, s3, c2, a3, l2), A2(c2, s3, t3, n3);
  }
  _(C2, `makeGantt`);
  function w2(e3, n3, a3, o3, s3, l2, u2) {
    ...
    if (f3.append(`rect`).attr(`id`, function(e4) {
      ...
      return e4.milestone ? x2(e4.startTime) + o3 + 0.5 * (x2(e4.endTime) - x2(e4.startTime)) - 0.5 * s3 : x2(e4.startTime) + o3;
    }).attr(`y`, function(e4, t3) {
      return t3 = e4.order, e4.vert ? i2.gridLineStartPadding : t3 * n3 + a3;
    }).attr(`width`, function(e4) {
      return e4.milestone ? s3 : e4.vert ? 0.08 * s3 : x2(e4.renderEndTime || e4.endTime) - x2(e4.startTime);
    }).attr(`height`, function(e4) {
      return e4.vert ? p2.length * (i2.barHeight + i2.barGap) + i2.barHeight * 2 : s3;
    }).attr(`transform-origin`, function(e4, t3) {
      return t3 = e4.order, (x2(e4.startTime) + o3 + 0.5 * (x2(e4.endTime) - x2(e4.startTime))).toString() + `px ` + (t3 * n3 + a3 + 0.5 * s3).toString() + `px`;
      ...
      return t2 + `-` + e4.id + `-text`;
    }).text(function(e4) {
      return e4.task;
    }).attr(`font-size`, i2.fontSize).attr(`x`, function(e4) {
      let t3 = x2(e4.startTime), n4 = x2(e4.renderEndTime || e4.endTime);
      if (e4.milestone && (t3 += 0.5 * (x2(e4.endTime) - x2(e4.startTime)) - 0.5 * s3, n4 = t3 + s3), e4.vert) return x2(e4.startTime) + o3;
      let r3 = this.getBBox().width;
      return r3 > n4 - t3 ? n4 + r3 + 1.5 * i2.leftPadding > u2 ? t3 + o3 - 5 : n4 + o3 + 5 : (n4 - t3) / 2 + t3 + o3;
    }).attr(`y`, function(e4, t3) {
    ...
    }).attr(`text-height`, s3).attr(`class`, function(e4) {
      let t3 = x2(e4.startTime), n4 = x2(e4.endTime);
      e4.milestone && (n4 = t3 + s3);
      ...
      let c2 = ``;
      return e4.active && (c2 = e4.crit ? `activeCritText` + o4 : `activeText` + o4), e4.done ? c2 = e4.crit ? c2 + ` doneCritText` + o4 : c2 + ` doneText` + o4 : e4.crit && (c2 = c2 + ` critText` + o4), e4.milestone && (c2 += ` milestoneText`), e4.vert && (c2 += ` vertText`), r3 > n4 - t3 ? n4 + r3 + 1.5 * i2.leftPadding > u2 ? a4 + ` taskTextOutsideLeft taskTextOutside` + o4 + ` ` + c2 : a4 + ` taskTextOutsideRight taskTextOutside` + o4 + ` ` + c2 + ` width-` + r3 : a4 + ` taskText taskText` + o4 + ` ` + c2 + ` width-` + r3;
      ...
      f3.filter(function(e5) {
        ...
        var r3 = n4.querySelector(`#` + CSS.escape(t2 + `-` + e5.id)), i3 = n4.querySelector(`#` + CSS.escape(t2 + `-` + e5.id + `-text`));
        let a4 = r3.parentNode;
        var o4 = n4.createElement(`a`);
        o4.setAttribute(`xlink:href`, h3.get(e5.id)), o4.setAttribute(`target`, `_top`), a4.appendChild(o4), o4.appendChild(r3), o4.appendChild(i3);
      });
    }
  }
  _(w2, `drawRects`);
  function T2(e3, n3, a3, o3, s3, c2, l2, u2) {
    if (l2.length === 0 && u2.length === 0) return;
    let d3, f3;
    for (let { startTime: e4, endTime: t3 } of c2) (d3 === void 0 || e4 < d3) && (d3 = e4), (f3 === void 0 || t3 > f3) && (f3 = t3);
    if (!d3 || !f3) return;
    if ((0, Yn.default)(f3).diff((0, Yn.default)(d3), `year`) > 5) {
    ...
    let p3 = r2.db.getDateFormat(), m3 = [], h3 = null, _2 = (0, Yn.default)(d3);
    for (; _2.valueOf() <= f3; ) r2.db.isInvalidDate(_2, p3, l2, u2) ? h3 ? h3.end = _2 : h3 = { start: _2, end: _2 } : h3 && (h3 = (m3.push(h3), null)), _2 = _2.add(1, `d`);
    b2.append(`g`).selectAll(`rect`).data(m3).enter().append(`rect`).attr(`id`, (e4) => t2 + `-exclude-` + e4.start.format(`YYYY-MM-DD`)).attr(`x`, (e4) => x2(e4.start.startOf(`day`)) + a3).attr(`y`, i2.gridLineStartPadding).attr(`width`, (e4) => x2(e4.end.endOf(`day`)) - x2(e4.start.startOf(`day`))).attr(`height`, s3 - n3 - i2.gridLineStartPadding).attr(`transform-origin`, function(t3, n4) {
      return (x2(t3.start) + a3 + 0.5 * (x2(t3.end) - x2(t3.start))).toString() + `px ` + (n4 * e3 + 0.5 * s3).toString() + `px`;
  ...
  function O2(e3, t3, n3, a3) {
    let o3 = r2.db.getDateFormat(), s3 = r2.db.getAxisFormat(), c2;
    c2 = s3 || (o3 === `D` ? `%d` : i2.axisFormat ?? `%Y-%m-%d`);
    let l2 = me(x2).tickSize(-a3 + t3 + i2.gridLineStartPadding).tickFormat(Fn(c2)), u2 = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(r2.db.getTickInterval() || i2.tickInterval);
    if (u2 !== null) {
      let e4 = parseInt(u2[1], 10);
      if (isNaN(e4) || e4 <= 0) g.warn(`Invalid tick interval value: "${u2[1]}". Skipping custom tick interval.`);
      else {
        let t4 = u2[2], n4 = r2.db.getWeekday() || i2.weekday, a4 = x2.domain(), o4 = a4[0], s4 = a4[1], c3 = E2(o4, s4, e4, t4);
        if (c3 > gi) g.warn(`The tick interval "${e4}${t4}" would generate ${c3} ticks, which exceeds the maximum allowed (${gi}). This may indicate an invalid date or time range. Skipping custom tick interval.`);
        else switch (t4) {
          case `millisecond`:
            l2.ticks(ze.every(e4));
            break;
          case `second`:
            l2.ticks(z.every(e4));
            break;
          ...
          case `day`:
            ...
            break;
          case `week`:
            l2.ticks(mi[n4].every(e4));
            break;
          case `month`:
            l2.ticks(ct.every(e4));
            break;
        }
      }
    }
    if (b2.append(`g`).attr(`class`, `grid`).attr(`transform`, `translate(` + e3 + `, ` + (a3 - 50) + `)`).call(l2).selectAll(`text`).style(`text-anchor`, `middle`).attr(`fill`, `#000`).attr(`stroke`, `none`).attr(`font-size`, 10).attr(`dy`, `1em`), r2.db.topAxisEnabled() || i2.topAxis) {
      let n4 = pe(x2).tickSize(-a3 + t3 + i2.gridLineStartPadding).tickFormat(Fn(c2));
      if (u2 !== null) {
        let e4 = parseInt(u2[1], 10);
        if (isNaN(e4) || e4 <= 0) g.warn(`Invalid tick interval value: "${u2[1]}". Skipping custom tick interval.`);
        else {
          let t4 = u2[2], a4 = r2.db.getWeekday() || i2.weekday, o4 = x2.domain(), s4 = o4[0], c3 = o4[1];
          if (E2(s4, c3, e4, t4) <= gi) switch (t4) {
            case `millisecond`:
              n4.ticks(ze.every(e4));
              break;
            case `second`:
              n4.ticks(z.every(e4));
              break;
            ...
            case `day`:
              ...
              break;
            case `week`:
              n4.ticks(mi[a4].every(e4));
              break;
            case `month`:
              n4.ticks(ct.every(e4));
              break;
          }
        }
      }
  ...
  function k2(e3, t3) {
    ...
    b2.append(`g`).selectAll(`text`).data(r3).enter().append(function(e4) {
      let t4 = e4[0].split(u.lineBreakRegex), n4 = -(t4.length - 1) / 2, r4 = d2.createElementNS(`http://www.w3.org/2000/svg`, `text`);
  ...
  _(k2, `vertLabels`);
  function A2(e3, t3, n3, a3) {
    let o3 = r2.db.getTodayMarker();
    if (o3 === `off`) return;
    let s3 = b2.append(`g`).attr(`class`, `today`), c2 = /* @__PURE__ */ new Date(), l2 = s3.append(`line`);
  ...
  .doneText3.taskTextOutsideRight {
    fill: ${e2.taskTextOutsideColor} !important;
  }
