  ...
  if (null != t) {
    ...
    try {
      if (i$1 = (t = t.call(r)).next, 0 === l) {
        ...
        f = false;
      } else for (; !(f = (e = i$1.call(t)).done) && (a.push(e.value), a.length !== l); f = true) ;
    } catch (r$1) {
      o = true, n = r$1;
    } finally {
      try {
...
var memoize = function memoize$1(fn$72, keyFn) {
  ...
  var _memoizedFn = function memoizedFn() {
    ...
    var cache$12 = _memoizedFn.cache;
    if (!(ret = cache$12[k])) ret = cache$12[k] = fn$72.apply(self$1, args);
    return ret;
  };
  _memoizedFn.cache = {};
  return _memoizedFn;
...
var endsWith = function endsWith$1(string$12, suffix) {
  return string$12.slice(-1 * suffix.length) === suffix;
};
...
var setMap = function setMap$1(options2) {
  ...
  for (var i$1 = 0; i$1 < l; i$1++) {
    ...
    if (i$1 < keys.length - 1) {
      ...
      obj = obj[key];
    } else obj[key] = options2.value;
  }
};
var getMap = function getMap$1(options2) {
  var obj = options2.map;
  var keys = options2.keys;
  var l = keys.length;
  for (var i$1 = 0; i$1 < l; i$1++) {
...
function require_trimmedEndIndex() {
  ...
  var reWhitespace = /\s/;
  function trimmedEndIndex(string$12) {
    var index = string$12.length;
    while (index-- && reWhitespace.test(string$12.charAt(index))) ;
    return index;
  }
...
function require_baseTrim() {
  ...
  var reTrimStart = /^\s+/;
  function baseTrim(string$12) {
    return string$12 ? string$12.slice(0, trimmedEndIndex(string$12) + 1).replace(reTrimStart, "") : string$12;
  }
  _baseTrim = baseTrim;
  return _baseTrim;
}
...
function requireDebounce() {
  ...
  function debounce$1(func, wait, options2) {
    ...
    function trailingEdge(time2) {
      timerId = void 0;
      if (trailing && lastArgs) return invokeFunc(time2);
      lastArgs = lastThis = void 0;
      return result;
    }
    function cancel() {
...
var raf = (function() {
  if (_window) {
    if (_window.requestAnimationFrame) return function(fn$72) {
      _window.requestAnimationFrame(fn$72);
    };
    else if (_window.mozRequestAnimationFrame) return function(fn$72) {
      _window.mozRequestAnimationFrame(fn$72);
    };
    else if (_window.webkitRequestAnimationFrame) return function(fn$72) {
      _window.webkitRequestAnimationFrame(fn$72);
    };
    else if (_window.msRequestAnimationFrame) return function(fn$72) {
      _window.msRequestAnimationFrame(fn$72);
    };
  }
  return function(fn$72) {
    if (fn$72) setTimeout(function() {
      fn$72(pnow());
    }, 1e3 / 60);
  };
})();
var requestAnimationFrame = function requestAnimationFrame$1(fn$72) {
  return raf(fn$72);
};
...
var Element = function Element$1(cy, params) {
  ...
  if (group2 == null) if (params.data && params.data.source != null && params.data.target != null) group2 = "edges";
  else group2 = "nodes";
  ...
  var classes2 = [];
  if (array(params.classes)) classes2 = params.classes;
  else if (string(params.classes)) classes2 = params.classes.split(/\s+/);
  for (var i$1 = 0, l = classes2.length; i$1 < l; i$1++) {
    var cls = classes2[i$1];
    if (!cls || cls === "") continue;
    _p.classes.add(cls);
  }
  this.createEmitter();
...
var defineSearch = function defineSearch$1(params) {
  ...
  return function searchFn(roots, fn$72, directed) {
    var options2;
    if (plainObject(roots) && !elementOrCollection(roots)) {
      options2 = roots;
      roots = options2.roots || options2.root;
      fn$72 = options2.visit;
      directed = options2.directed;
    }
    directed = arguments.length === 2 && !fn$6(fn$72) ? fn$72 : directed;
    fn$72 = fn$6(fn$72) ? fn$72 : function() {
    };
    ...
    var _loop = function _loop$1() {
      ...
      var ret = fn$72(v$1, prevEdge, prevNode, j++, depth);
      if (ret === true) {
        found = v$1;
        return 1;
      }
      ...
      var vwEdges = v$1.connectedEdges().filter(function(e$1) {
        return (!directed || e$1.source().same(v$1)) && edges3.has(e$1);
      });
      for (var _i2 = 0; _i2 < vwEdges.length; _i2++) {
        var e = vwEdges[_i2];
        var w = e.connectedNodes().filter(function(n) {
          return !n.same(v$1) && nodes3.has(n);
        });
        var wId = w.id();
        if (w.length !== 0 && !V[wId]) {
          w = w[0];
...
function requireHeap$1() {
  ...
  (function(module, exports) {
    (function() {
      var Heap$1, defaultCmp, floor = Math.floor, heapify, heappop, heappush, heappushpop, heapreplace, insort, min$13 = Math.min, nlargest, nsmallest, updateItem, _siftdown, _siftup;
      ...
      heappush = function(array$12, item, cmp) {
        if (cmp == null) cmp = defaultCmp;
        array$12.push(item);
        return _siftdown(array$12, 0, array$12.length - 1, cmp);
      };
      heappop = function(array$12, cmp) {
        var lastelt, returnitem;
        if (cmp == null) cmp = defaultCmp;
        lastelt = array$12.pop();
        if (array$12.length) {
          returnitem = array$12[0];
          array$12[0] = lastelt;
          _siftup(array$12, 0, cmp);
        } else returnitem = lastelt;
        return returnitem;
      };
      heapreplace = function(array$12, item, cmp) {
        var returnitem;
        if (cmp == null) cmp = defaultCmp;
        returnitem = array$12[0];
        array$12[0] = item;
      ...
      heappushpop = function(array$12, item, cmp) {
        var _ref;
        if (cmp == null) cmp = defaultCmp;
        if (array$12.length && cmp(array$12[0], item) < 0) {
          _ref = [array$12[0], item], item = _ref[0], array$12[0] = _ref[1];
          _siftup(array$12, 0, cmp);
        }
        return item;
      };
      heapify = function(array$12, cmp) {
        var i$1, _i, _len, _ref1, _results, _results1;
        if (cmp == null) cmp = defaultCmp;
        _ref1 = (function() {
          _results1 = [];
          for (var _j = 0, _ref = floor(array$12.length / 2); 0 <= _ref ? _j < _ref : _j > _ref; 0 <= _ref ? _j++ : _j--) _results1.push(_j);
          return _results1;
        }).apply(this).reverse();
        _results = [];
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          i$1 = _ref1[_i];
          _results.push(_siftup(array$12, i$1, cmp));
        }
        return _results;
      };
      updateItem = function(array$12, item, cmp) {
        var pos;
        if (cmp == null) cmp = defaultCmp;
        pos = array$12.indexOf(item);
        if (pos === -1) return;
        _siftdown(array$12, 0, pos, cmp);
        return _siftup(array$12, pos, cmp);
      };
      nlargest = function(array$12, n, cmp) {
        var elem, result, _i, _len, _ref;
        if (cmp == null) cmp = defaultCmp;
        result = array$12.slice(0, n);
        if (!result.length) return result;
        heapify(result, cmp);
        _ref = array$12.slice(n);
      ...
      nsmallest = function(array$12, n, cmp) {
        var elem, los, result, _i, _j, _len, _ref, _ref1, _results;
        if (cmp == null) cmp = defaultCmp;
        if (n * 10 <= array$12.length) {
          result = array$12.slice(0, n).sort(cmp);
          if (!result.length) return result;
        ...
        heapify(array$12, cmp);
        _results = [];
        for (_j = 0, _ref1 = min$13(n, array$12.length); 0 <= _ref1 ? _j < _ref1 : _j > _ref1; 0 <= _ref1 ? ++_j : --_j) _results.push(heappop(array$12, cmp));
        return _results;
      };
      _siftdown = function(array$12, startpos, pos, cmp) {
        var newitem, parent4, parentpos;
        if (cmp == null) cmp = defaultCmp;
        newitem = array$12[pos];
        while (pos > startpos) {
          parentpos = pos - 1 >> 1;
          parent4 = array$12[parentpos];
          if (cmp(newitem, parent4) < 0) {
            array$12[pos] = parent4;
            pos = parentpos;
            continue;
          }
          break;
        }
        return array$12[pos] = newitem;
      };
      _siftup = function(array$12, pos, cmp) {
        var childpos, endpos, newitem, rightpos, startpos;
        if (cmp == null) cmp = defaultCmp;
        endpos = array$12.length;
        startpos = pos;
        newitem = array$12[pos];
        childpos = 2 * pos + 1;
        while (childpos < endpos) {
          rightpos = childpos + 1;
          if (rightpos < endpos && !(cmp(array$12[childpos], array$12[rightpos]) < 0)) childpos = rightpos;
          array$12[pos] = array$12[childpos];
          pos = childpos;
          childpos = 2 * pos + 1;
        }
        array$12[pos] = newitem;
        return _siftdown(array$12, startpos, pos, cmp);
      };
      Heap$1 = (function() {
...
var elesfn$u = { dijkstra: function dijkstra(options2) {
  ...
  var getDist$12 = function getDist$2(node$1) {
    return dist$12[node$1.id()];
  };
  ...
  var Q = new Heap(function(a, b) {
    return getDist$12(a) - getDist$12(b);
  });
  for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
    var node = nodes3[i$1];
    dist$12[node.id()] = node.same(source) ? 0 : Infinity;
    Q.push(node);
  }
  var distBetween = function distBetween$1(u$1, v$1) {
    var uvs = (directed ? u$1.edgesTo(v$1) : u$1.edgesWith(v$1)).intersect(edges3);
  ...
  return {
    distanceTo: function distanceTo(node$1) {
      return knownDist[(string(node$1) ? nodes3.filter(node$1)[0] : node$1[0]).id()];
    },
    pathTo: function pathTo(node$1) {
      var target = string(node$1) ? nodes3.filter(node$1)[0] : node$1[0];
      var S = [];
      var u$1 = target;
      var uid$1 = u$1.id();
      if (target.length > 0) {
...
var elesfn$t = { kruskal: function kruskal(weightFn) {
  ...
  for (var i$1 = 0; i$1 < numNodes; i$1++) forest[i$1] = this.spawn(nodes3[i$1]);
...
var elesfn$s = { aStar: function aStar(options2) {
  var cy = this.cy();
  ...
  var cameFrom = {};
  var cameFromEdge = {};
  var addToOpenSet = function addToOpenSet$1(ele, id2) {
    openSet.push(ele);
    openSetIds.add(id2);
  };
  var cMin, cMinId;
  ...
  var isInOpenSet = function isInOpenSet$1(id2) {
...
var elesfn$r = { floydWarshall: function floydWarshall(options2) {
  var cy = this.cy();
  ...
  var dist$12 = new Array(Nsq);
  for (var n = 0; n < Nsq; n++) {
    var j = n % N;
    if ((n - j) / N === j) dist$12[n] = 0;
    else dist$12[n] = Infinity;
  }
  ...
  for (var _i = 0; _i < edges3.length; _i++) {
    ...
    if (!directed) {
      var ts = t * N + s;
      if (!directed && dist$12[ts] > _weight) {
        dist$12[ts] = _weight;
        next[ts] = s;
        edgeNext[ts] = edge;
      }
  ...
  for (var k = 0; k < N; k++) for (var _i2 = 0; _i2 < N; _i2++) {
    ...
    for (var _j = 0; _j < N; _j++) {
      var ij = _i2 * N + _j;
      var kj = k * N + _j;
      if (dist$12[ik] + dist$12[kj] < dist$12[ij]) {
        dist$12[ij] = dist$12[ik] + dist$12[kj];
        next[ij] = next[ik];
      }
    }
  }
...
var elesfn$q = { bellmanFord: function bellmanFord(options2) {
  var _this = this;
  ...
  root = cy.collection(root)[0];
  edges3.unmergeBy(function(edge$1) {
    return edge$1.isLoop();
  });
  var numEdges = edges3.length;
  var getInfo$12 = function getInfo$2(node$1) {
  ...
  var distanceTo = function distanceTo$1(to) {
    return getInfo$12(getNodeFromTo(to)).dist;
  };
  var pathTo = function pathTo$1(to) {
    ...
    for (; ; ) {
      ...
      var _getInfo = getInfo$12(node$1), edge$1 = _getInfo.edge, pred = _getInfo.pred;
  ...
  var checkForEdgeReplacement = function checkForEdgeReplacement$1(node1, node2, edge$1, info1, info2, weight$1) {
    var dist$12 = info1.dist + weight$1;
    if (dist$12 < info2.dist && !edge$1.same(info1.edge)) {
      info2.dist = dist$12;
      info2.pred = node1;
      info2.edge = edge$1;
      replacedEdge = true;
  ...
  for (var _i = 1; _i < numNodes; _i++) {
    ...
    for (var e = 0; e < numEdges; e++) {
      ...
      var tgt = edge.target();
      var _weight = weightFn(edge);
      var srcInfo = getInfo$12(src);
      var tgtInfo = getInfo$12(tgt);
  ...
  if (replacedEdge) {
    ...
    for (var _e = 0; _e < numEdges; _e++) {
      ...
      var srcDist = getInfo$12(_src).dist;
      var tgtDist = getInfo$12(_tgt).dist;
      if (srcDist + _weight2 < tgtDist || !directed && tgtDist + _weight2 < srcDist) {
        ...
        if (options2.findNegativeWeightCycles !== false) {
          ...
          for (var n = 0; n < numNegativeNodes; n++) {
            ...
            var cycle = [start];
            cycle.push(getInfo$12(start).edge);
            var _node = getInfo$12(start).pred;
            while (cycle.indexOf(_node) === -1) {
              cycle.push(_node);
              cycle.push(getInfo$12(_node).edge);
              _node = getInfo$12(_node).pred;
            }
...
var contractUntil = function contractUntil$1(metaNodeMap, remainingEdges, size3, sizeLimit) {
...
var elesfn$p = { kargerStein: function kargerStein() {
  ...
  for (var i$1 = 0; i$1 < numEdges; i$1++) {
    ...
    edgeIndexes.push([
      i$1,
      nodes3.indexOf(e.source()),
      nodes3.indexOf(e.target())
    ]);
  }
  ...
  var constructComponent = function constructComponent$1(subset) {
    ...
    subset.forEach(function(node$1) {
      component2.merge(node$1);
      node$1.connectedEdges().forEach(function(edge) {
        if (_this.contains(edge) && !cut.contains(edge)) component2.merge(edge);
      });
    });
    return component2;
  };
...
var modelToRenderedPosition$1 = function modelToRenderedPosition$2(p$1, zoom2, pan2) {
  return {
    x: p$1.x * zoom2 + pan2.x,
    y: p$1.y * zoom2 + pan2.y
  };
};
var renderedToModelPosition = function renderedToModelPosition$1(p$1, zoom2, pan2) {
  return {
    x: (p$1.x - pan2.x) / zoom2,
    y: (p$1.y - pan2.y) / zoom2
  };
};
...
var median = function median$1(arr) {
  var begin = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
  var end = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : arr.length;
  var copy$12 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
  ...
  if (copy$12) arr = arr.slice(begin, end);
  else {
  ...
  if (sort2) arr.sort(function(a, b) {
    return a - b;
  });
  var len = arr.length;
...
var bound = function bound$1(min$13, val, max$14) {
  return Math.max(min$13, Math.min(max$14, val));
};
...
function inflatePolygon(polygon$1, d) {
  ...
  var normalize$12 = function normalize$2(v) {
  ...
  var intersectLines = function intersectLines$1(p1, p2, p3, p4) {
    ...
    var s = sub(p4, p3);
    var denom = cross(r, s);
    if (Math.abs(denom) < 1e-9) return add3(p1, scale$1(r, 0.5));
    return add3(p1, scale$1(r, cross(sub(p3, p1), s) / denom));
  };
  ...
  var offsetEdges = normals.map(function(nrm, i$2) {
    return {
      p1: add3(pts$1[i$2], scale$1(nrm, d)),
      p2: add3(pts$1[(i$2 + 1) % n], scale$1(nrm, d))
    };
  });
  var inflated = [];
...
function miterBox(pts$1, centerX, centerY, width2, height2, strokeWidth) {
  var offsetPoints = inflatePolygon(transformPoints(pts$1, centerX, centerY, width2, height2), strokeWidth);
...
var roundRectangleIntersectLine = function roundRectangleIntersectLine$1(x$1, y$1, nodeX, nodeY, width2, height2, padding) {
  var radius$1 = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "auto";
  var cornerRadius = radius$1 === "auto" ? getRoundRectangleRadius(width2, height2) : radius$1;
...
var pointInsidePolygon = function pointInsidePolygon$1(x$1, y$1, basePoints, centerX, centerY, width2, height2, direction, padding) {
  ...
  for (var i$1 = 0; i$1 < transformedPoints.length / 2; i$1++) {
    transformedPoints[i$1 * 2] = width2 / 2 * (basePoints[i$1 * 2] * cos$1 - basePoints[i$1 * 2 + 1] * sin$1);
    transformedPoints[i$1 * 2 + 1] = height2 / 2 * (basePoints[i$1 * 2 + 1] * cos$1 + basePoints[i$1 * 2] * sin$1);
...
var pointInsideRoundPolygon = function pointInsideRoundPolygon$1(x$1, y$1, basePoints, centerX, centerY, width2, height2, corners) {
...
var checkInEllipse = function checkInEllipse$1(x$1, y$1, width2, height2, centerX, centerY, padding) {
  x$1 -= centerX;
  y$1 -= centerY;
  x$1 /= width2 / 2 + padding;
  y$1 /= height2 / 2 + padding;
...
var transformPoints = function transformPoints$1(points, centerX, centerY, width2, height2) {
  var ret = [];
  var halfW = width2 / 2;
  var halfH = height2 / 2;
  var x$1 = centerX;
...
var polygonIntersectLine = function polygonIntersectLine$1(x$1, y$1, basePoints, centerX, centerY, width2, height2, padding) {
  var intersections = [];
  var intersection$1;
  var transformedPoints = new Array(basePoints.length);
  var doTransform = true;
  if (width2 == null) doTransform = false;
  var points;
  if (doTransform) {
    for (var i$1 = 0; i$1 < transformedPoints.length / 2; i$1++) {
      transformedPoints[i$1 * 2] = basePoints[i$1 * 2] * width2 + centerX;
      transformedPoints[i$1 * 2 + 1] = basePoints[i$1 * 2 + 1] * height2 + centerY;
    }
    if (padding > 0) points = joinLines(expandPolygon(transformedPoints, -padding));
    else points = transformedPoints;
...
var roundPolygonIntersectLine = function roundPolygonIntersectLine$1(x$1, y$1, basePoints, centerX, centerY, width2, height2, padding, corners) {
  var intersections = [];
  var intersection$1;
...
var getRoundRectangleRadius = function getRoundRectangleRadius$1(width2, height2) {
  return Math.min(width2 / 4, height2 / 4, 8);
};
var getRoundPolygonRadius = function getRoundPolygonRadius$1(width2, height2) {
...
var getBarrelCurveConstants = function getBarrelCurveConstants$1(width2, height2) {
  return {
  ...
  function project(polygon$1, axis$1) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        ...
        min$13 = Math.min(min$13, projection$1);
        max$14 = Math.max(max$14, projection$1);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
var elesfn$o = { pageRank: function pageRank(options2) {
...
var elesfn$n = {
  ...
  degreeCentrality: function degreeCentrality(options2) {
    ...
    if (!directed) {
      ...
      var s = 0;
      for (var i$1 = 0; i$1 < connEdges.length; i$1++) s += weight8(connEdges[i$1]);
      ...
      var s_in = 0;
      var s_out = 0;
      for (var _i2 = 0; _i2 < incoming.length; _i2++) s_in += weight8(incoming[_i2]);
      for (var _i3 = 0; _i3 < outgoing.length; _i3++) s_out += weight8(outgoing[_i3]);
      return {
...
var elesfn$m = {
  closenessCentralityNormalized: function closenessCentralityNormalized(options2) {
    ...
    for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
      var currCloseness = 0;
      var node_i = nodes3[i$1];
      for (var j = 0; j < nodes3.length; j++) if (i$1 !== j) {
...
var elesfn$l = { betweennessCentrality: function betweennessCentrality(options2) {
  ...
  var ret = {
    ...
    betweennessNormalized: function betweennessNormalized(node) {
      if (max$14 == 0) return 0;
      var id2 = cy.collection(node).id();
      return C.get(id2) / max$14;
    }
  };
...
var setOptions$3 = function setOptions$4(options2) {
...
var assign$2 = function assign$3(M, n, nodes3, cy) {
  var clusters = [];
  for (var i$1 = 0; i$1 < n; i$1++) {
    var cluster = [];
    for (var j = 0; j < n; j++) if (Math.round(M[i$1 * n + j] * 1e3) / 1e3 > 0) cluster.push(nodes3[j]);
...
var markovClustering = function markovClustering$2(options2) {
  var nodes3 = this.nodes();
  var edges3 = this.edges();
  var cy = this.cy();
  var opts = setOptions$3(options2);
  var id2position = {};
  for (var i$1 = 0; i$1 < nodes3.length; i$1++) id2position[nodes3[i$1].id()] = i$1;
...
var distances = {
  ...
  max: function max$12(length, getP, getQ) {
...
var setOptions$2 = function setOptions$42(options2) {
...
var randomCentroids = function randomCentroids$1(nodes3, k, attributes) {
  var ndim = attributes.length;
  var min$13 = new Array(ndim);
  var max$14 = new Array(ndim);
  var centroids = new Array(k);
  var centroid = null;
  for (var i$1 = 0; i$1 < ndim; i$1++) {
    min$13[i$1] = nodes3.min(attributes[i$1]).value;
    max$14[i$1] = nodes3.max(attributes[i$1]).value;
  }
  for (var c = 0; c < k; c++) {
    centroid = [];
    for (var _i = 0; _i < ndim; _i++) centroid[_i] = Math.random() * (max$14[_i] - min$13[_i]) + min$13[_i];
...
var classify = function classify$1(node, centroids, distance, attributes, type) {
  ...
  for (var i$1 = 0; i$1 < centroids.length; i$1++) {
    var dist$12 = getDist(distance, node, centroids[i$1], attributes, type);
    if (dist$12 < min$13) {
      min$13 = dist$12;
      index = i$1;
    }
...
var buildCluster = function buildCluster$1(centroid, nodes3, assignment) {
  var cluster = [];
  var node = null;
...
var randomMedoids = function randomMedoids$1(nodes3, k) {
  var medoids = new Array(k);
  if (nodes3.length < 50) for (var i$1 = 0; i$1 < k; i$1++) {
    var node = nodes3[Math.floor(Math.random() * nodes3.length)];
    while (seenBefore(node, medoids, i$1)) node = nodes3[Math.floor(Math.random() * nodes3.length)];
    medoids[i$1] = node;
  }
  else for (var _i2 = 0; _i2 < k; _i2++) medoids[_i2] = nodes3[Math.floor(Math.random() * nodes3.length)];
  return medoids;
};
...
var kMeans = function kMeans$1(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  var node = null;
  ...
  else centroids = randomCentroids(nodes3, opts.k, opts.attributes);
  else centroids = randomCentroids(nodes3, opts.k, opts.attributes);
  var isStillMoving = true;
  var iterations = 0;
  while (isStillMoving && iterations < opts.maxIterations) {
...
var kMedoids = function kMedoids$1(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  var node = null;
  var opts = setOptions$2(options2);
  ...
  else medoids = randomMedoids(nodes3, opts.k);
  else medoids = randomMedoids(nodes3, opts.k);
  var isStillMoving = true;
  var iterations = 0;
  while (isStillMoving && iterations < opts.maxIterations) {
...
var updateCentroids = function updateCentroids$1(centroids, nodes3, U, weight8, opts) {
  var numerator, denominator;
  for (var n = 0; n < nodes3.length; n++) for (var c = 0; c < centroids.length; c++) weight8[n][c] = Math.pow(U[n][c], opts.m);
...
var updateMembership = function updateMembership$1(U, _U, centroids, nodes3, opts) {
  for (var i$1 = 0; i$1 < U.length; i$1++) _U[i$1] = U[i$1].slice();
  var sum, numerator, denominator;
  var pow = 2 / (opts.m - 1);
  for (var c = 0; c < centroids.length; c++) for (var n = 0; n < nodes3.length; n++) {
    sum = 0;
...
var assign$1 = function assign$32(nodes3, U, opts, cy) {
  var clusters = new Array(opts.k);
  ...
  for (var n = 0; n < U.length; n++) {
    max$14 = -Infinity;
    index = -1;
    for (var _c2 = 0; _c2 < U[0].length; _c2++) if (U[n][_c2] > max$14) {
      max$14 = U[n][_c2];
      index = _c2;
    }
...
var fuzzyCMeans = function fuzzyCMeans$1(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  var opts = setOptions$2(options2);
  var clusters;
  ...
  for (var i$1 = 0; i$1 < nodes3.length; i$1++) _U[i$1] = new Array(opts.k);
  U = new Array(nodes3.length);
  for (var _i3 = 0; _i3 < nodes3.length; _i3++) U[_i3] = new Array(opts.k);
  ...
  for (var _i6 = 0; _i6 < nodes3.length; _i6++) weight8[_i6] = new Array(opts.k);
  var isStillMoving = true;
  var iterations = 0;
  while (isStillMoving && iterations < opts.maxIterations) {
    isStillMoving = false;
...
var setOptions$1 = function setOptions$43(options2) {
...
var mergeClosest = function mergeClosest$1(clusters, index, dists, mins, opts) {
  ...
  var getDist$12 = function getDist$2(n1, n2) {
  ...
  if (opts.mode === "threshold" && min$13 >= opts.threshold || opts.mode === "dendrogram" && clusters.length === 1) return false;
  var c1 = index[minKey];
  ...
  for (var _i = 0; _i < clusters.length; _i++) {
    var cur = clusters[_i];
    if (c1.key === cur.key) dist$12 = Infinity;
    else if (opts.linkage === "min") {
      dist$12 = dists[c1.key][cur.key];
      if (dists[c1.key][cur.key] > dists[c2.key][cur.key]) dist$12 = dists[c2.key][cur.key];
    } else if (opts.linkage === "max") {
      dist$12 = dists[c1.key][cur.key];
      if (dists[c1.key][cur.key] < dists[c2.key][cur.key]) dist$12 = dists[c2.key][cur.key];
    } else if (opts.linkage === "mean") dist$12 = (dists[c1.key][cur.key] * c1.size + dists[c2.key][cur.key] * c2.size) / (c1.size + c2.size);
    else if (opts.mode === "dendrogram") dist$12 = getDist$12(cur.value, c1.value);
    else dist$12 = getDist$12(cur.value[0], c1.value[0]);
    dists[c1.key][cur.key] = dists[cur.key][c1.key] = dist$12;
  }
...
var hierarchicalClustering = function hierarchicalClustering$2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  ...
  for (var i$1 = 0; i$1 < clusters.length; i$1++) for (var j = 0; j <= i$1; j++) {
    var dist$12 = void 0;
    if (opts.mode === "dendrogram") dist$12 = i$1 === j ? Infinity : getDist$12(clusters[i$1].value, clusters[j].value);
    else dist$12 = i$1 === j ? Infinity : getDist$12(clusters[i$1].value[0], clusters[j].value[0]);
    dists[i$1][j] = dist$12;
    dists[j][i$1] = dist$12;
    if (dist$12 < dists[i$1][mins[i$1]]) mins[i$1] = j;
  }
...
var setOptions = function setOptions$44(options2) {
...
var getSimilarity = function getSimilarity$22(type, n1, n2, attributes) {
...
var assign = function assign$33(n, S, exemplars) {
...
var affinityPropagation = function affinityPropagation$2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  ...
  for (var _i2 = 0; _i2 < n; _i2++) for (var j = 0; j < n; j++) if (_i2 !== j) S[_i2 * n + j] = getSimilarity(opts.distance, nodes3[_i2], nodes3[j], opts.attributes);
  ...
  for (iter = 0; iter < opts.maxIterations; iter++) {
    for (var _i8 = 0; _i8 < n; _i8++) {
      var max$14 = -Infinity, max2 = -Infinity, maxI = -1, AS = 0;
      for (var _j = 0; _j < n; _j++) {
        old[_j] = R[_i8 * n + _j];
      ...
      for (var _j2 = 0; _j2 < n; _j2++) R[_i8 * n + _j2] = (1 - opts.damping) * (S[_i8 * n + _j2] - max$14) + opts.damping * old[_j2];
  ...
  for (var _i12 = 0; _i12 < nodes3.length; _i12++) {
    var clusterIndex = clusterIndices[id2position[nodes3[_i12].id()]];
    if (clusterIndex != null) clusters[clusterIndex].push(nodes3[_i12]);
  }
...
var elesfn$k = { hierholzer: function hierholzer(options2) {
  if (!plainObject(options2)) {
    var args = arguments;
    options2 = {
      root: args[0],
  ...
  if (directed) eles.forEach(function(ele) {
    ...
    } else edges3[id2] = [void 0, ele.target().id()];
  });
  else eles.forEach(function(ele) {
    var id2 = ele.id();
    if (ele.isNode()) {
      if (ele.degree(true) % 2) if (!oddIn) oddIn = id2;
    ...
    } else edges3[id2] = [ele.source().id(), ele.target().id()];
  });
  var result = {
    found: false,
    trail: void 0
  ...
  while (subtour.length != 1) if (nodes3[subtour[0]].length == 0) {
    trail.unshift(eles.getElementById(subtour.shift()));
    trail.unshift(eles.getElementById(subtour.shift()));
  } else subtour = walk(subtour.shift()).concat(subtour);
  trail.unshift(eles.getElementById(subtour.shift()));
  for (var d in nodes3) if (nodes3[d].length) return result;
  result.found = true;
...
var hopcroftTarjanBiconnected = function hopcroftTarjanBiconnected$2() {
  ...
  var buildComponent = function buildComponent$1(x$1, y$1) {
    ...
    cutset.forEach(function(edge) {
      ...
      connectedNodes.forEach(function(node) {
        ...
        if (!nodes3[nodeId].cutVertex) component2.merge(connectedEdges);
        else component2.merge(connectedEdges.filter(function(edge$1) {
          return edge$1.isLoop();
        }));
      });
    });
  ...
  var _biconnectedSearch = function biconnectedSearch(root, currentNode, parent4) {
    ...
    if (edges3.size() === 0) components2.push(eles.spawn(eles.getElementById(currentNode)));
    else {
      ...
      edges3.forEach(function(edge) {
        ...
        if (otherNodeId !== parent4) {
          ...
          } else nodes3[currentNode].low = Math.min(nodes3[currentNode].low, nodes3[otherNodeId].id);
        }
      });
    }
  };
  ...
  var cutVertices = Object.keys(nodes3).filter(function(id$1) {
    return nodes3[id$1].cutVertex;
  }).map(function(id$1) {
...
var tarjanStronglyConnected = function tarjanStronglyConnected$2() {
  ...
  var _stronglyConnectedSearch = function stronglyConnectedSearch(sourceNodeId) {
    ...
    eles.getElementById(sourceNodeId).connectedEdges().intersection(eles).forEach(function(edge) {
      ...
      if (targetNodeId !== sourceNodeId) {
        if (!(targetNodeId in nodes3)) _stronglyConnectedSearch(targetNodeId);
        if (!nodes3[targetNodeId].explored) nodes3[sourceNodeId].low = Math.min(nodes3[sourceNodeId].low, nodes3[targetNodeId].low);
      }
    });
  ...
  eles.forEach(function(ele) {
    if (ele.isNode()) {
      var nodeId = ele.id();
      if (!(nodeId in nodes3)) _stronglyConnectedSearch(nodeId);
    }
  });
  return {
    cut,
...
var _resolve = function resolve(promise$13, x$1) {
  if (promise$13 === x$1 || promise$13.proxy === x$1) {
    promise$13.reject(/* @__PURE__ */ new TypeError("cannot resolve promise with itself"));
    return;
  }
  var then2;
  ...
  if (typeof then2 === "function") {
    var resolved = false;
    try {
      then2.call(x$1, function(y$1) {
        if (resolved) return;
        resolved = true;
        if (y$1 === x$1) promise$13.reject(/* @__PURE__ */ new TypeError("circular thenable chain"));
        else _resolve(promise$13, y$1);
      }, function(r) {
        if (resolved) return;
        resolved = true;
        promise$13.reject(r);
      ...
      if (!resolved) promise$13.reject(e);
    }
    return;
  }
  promise$13.fulfill(x$1);
};
_api.all = function(ps) {
  return new _api(function(resolveAll, rejectAll) {
    var vals = new Array(ps.length);
    var doneCount = 0;
    var fulfill2 = function fulfill$1(i$2, val) {
      vals[i$2] = val;
      doneCount++;
...
extend(anifn, {
  ...
  promise: function promise$12(type) {
    var _p = this._private;
    var arr;
    switch (type) {
      case "frame":
  ...
  animation: function animation() {
    return function animationImpl(properties, params) {
      ...
      if (isEles && properties.renderedPosition != null) {
        ...
        var pan2 = cy.pan();
        properties.position = renderedToModelPosition(rpos, cy.zoom(), pan2);
      }
  ...
  stop: function stop2() {
    return function stopImpl(clearQueue2, jumpToEnd) {
      ...
      for (var i$1 = 0; i$1 < all.length; i$1++) {
        ...
        if (clearQueue2) _p.animation.queue = [];
...
function require_isKey() {
  ...
  function isKey(value, object$12) {
    if (isArray(value)) return false;
    var type = typeof value;
    if (type == "number" || type == "symbol" || type == "boolean" || value == null || isSymbol(value)) return true;
    return reIsPlainProp.test(value) || !reIsDeepProp.test(value) || object$12 != null && value in Object(object$12);
  }
  _isKey = isKey;
  return _isKey;
}
...
function require_getValue() {
  ...
  function getValue$1(object$12, key) {
    return object$12 == null ? void 0 : object$12[key];
  }
...
function require_getNative() {
  ...
  function getNative(object$12, key) {
    var value = getValue$1(object$12, key);
...
function require_hashGet() {
  ...
  function hashGet(key) {
    var data$23 = this.__data__;
    if (nativeCreate) {
      var result = data$23[key];
      return result === HASH_UNDEFINED ? void 0 : result;
    }
    return hasOwnProperty.call(data$23, key) ? data$23[key] : void 0;
  }
  _hashGet = hashGet;
  return _hashGet;
}
...
function require_hashHas() {
  ...
  function hashHas(key) {
    var data$23 = this.__data__;
    return nativeCreate ? data$23[key] !== void 0 : hasOwnProperty.call(data$23, key);
  }
  _hashHas = hashHas;
  return _hashHas;
}
...
function require_hashSet() {
  ...
  function hashSet(key, value) {
    ...
    data$23[key] = nativeCreate && value === void 0 ? HASH_UNDEFINED : value;
    return this;
  }
  _hashSet = hashSet;
  return _hashSet;
...
function require_assocIndexOf() {
  ...
  var eq2 = requireEq();
  function assocIndexOf(array$12, key) {
    var length = array$12.length;
    while (length--) if (eq2(array$12[length][0], key)) return length;
    return -1;
  }
...
function require_listCacheDelete() {
  ...
  function listCacheDelete(key) {
    var data$23 = this.__data__, index = assocIndexOf(data$23, key);
    if (index < 0) return false;
    if (index == data$23.length - 1) data$23.pop();
    else splice.call(data$23, index, 1);
    --this.size;
    return true;
  }
...
function require_listCacheGet() {
  ...
  function listCacheGet(key) {
    var data$23 = this.__data__, index = assocIndexOf(data$23, key);
    return index < 0 ? void 0 : data$23[index][1];
  }
...
function require_listCacheSet() {
  ...
  function listCacheSet(key, value) {
    ...
    if (index < 0) {
      ++this.size;
      data$23.push([key, value]);
    } else data$23[index][1] = value;
    return this;
  }
...
function require_getMapData() {
  ...
  function getMapData(map2, key) {
    var data$23 = map2.__data__;
    return isKeyable(key) ? data$23[typeof key == "string" ? "string" : "hash"] : data$23.map;
  }
...
function require_mapCacheSet() {
  ...
  function mapCacheSet(key, value) {
    var data$23 = getMapData(this, key), size3 = data$23.size;
    data$23.set(key, value);
    this.size += data$23.size == size3 ? 0 : 1;
    return this;
  }
...
function requireMemoize() {
  ...
  var FUNC_ERROR_TEXT = "Expected a function";
  function memoize$12(func, resolver$12) {
    if (typeof func != "function" || resolver$12 != null && typeof resolver$12 != "function") throw new TypeError(FUNC_ERROR_TEXT);
    var memoized = function() {
      var args = arguments, key = resolver$12 ? resolver$12.apply(this, args) : args[0], cache$12 = memoized.cache;
      if (cache$12.has(key)) return cache$12.get(key);
      var result = func.apply(this, args);
      memoized.cache = cache$12.set(key, result) || cache$12;
      return result;
    };
    memoized.cache = new (memoize$12.Cache || MapCache)();
    return memoized;
  }
  memoize$12.Cache = MapCache;
  memoize_1 = memoize$12;
  return memoize_1;
}
var _memoizeCapped;
...
function require_memoizeCapped() {
  ...
  var memoize$12 = requireMemoize();
  var MAX_MEMOIZE_SIZE = 500;
  function memoizeCapped(func) {
    var result = memoize$12(func, function(key) {
      if (cache$12.size === MAX_MEMOIZE_SIZE) cache$12.clear();
      return key;
    });
    var cache$12 = result.cache;
    return result;
  }
...
function require_stringToPath() {
  ...
  var reEscapeChar = /\\(\\)?/g;
  _stringToPath = memoizeCapped(function(string$12) {
    var result = [];
    if (string$12.charCodeAt(0) === 46) result.push("");
    string$12.replace(rePropName, function(match$1, number$22, quote, subString) {
      result.push(quote ? subString.replace(reEscapeChar, "$1") : number$22 || match$1);
    });
    return result;
  });
...
function require_arrayMap() {
  ...
  function arrayMap(array$12, iteratee) {
    var index = -1, length = array$12 == null ? 0 : array$12.length, result = Array(length);
    while (++index < length) result[index] = iteratee(array$12[index], index, array$12);
    return result;
  }
  _arrayMap = arrayMap;
  return _arrayMap;
...
function require_castPath() {
  ...
  function castPath(value, object$12) {
    if (isArray(value)) return value;
    return isKey(value, object$12) ? [value] : stringToPath(toString2(value));
  }
  _castPath = castPath;
  return _castPath;
}
...
function require_baseGet() {
  ...
  function baseGet(object$12, path) {
    path = castPath(path, object$12);
    var index = 0, length = path.length;
    while (object$12 != null && index < length) object$12 = object$12[toKey(path[index++])];
    return index && index == length ? object$12 : void 0;
  }
  _baseGet = baseGet;
  return _baseGet;
}
...
function requireGet() {
  ...
  function get$1(object$12, path, defaultValue) {
    var result = object$12 == null ? void 0 : baseGet(object$12, path);
...
function require_baseAssignValue() {
  ...
  function baseAssignValue(object$12, key, value) {
    if (key == "__proto__" && defineProperty) defineProperty(object$12, key, {
      "configurable": true,
      "enumerable": true,
      "value": value,
      "writable": true
    });
    else object$12[key] = value;
  }
...
function require_assignValue() {
  ...
  var hasOwnProperty = Object.prototype.hasOwnProperty;
  function assignValue(object$12, key, value) {
    var objValue = object$12[key];
    if (!(hasOwnProperty.call(object$12, key) && eq2(objValue, value)) || value === void 0 && !(key in object$12)) baseAssignValue(object$12, key, value);
  }
...
function require_baseSet() {
  ...
  function baseSet(object$12, path, value, customizer) {
    if (!isObject(object$12)) return object$12;
    path = castPath(path, object$12);
    var index = -1, length = path.length, lastIndex = length - 1, nested = object$12;
    while (nested != null && ++index < length) {
      var key = toKey(path[index]), newValue = value;
      if (key === "__proto__" || key === "constructor" || key === "prototype") return object$12;
      if (index != lastIndex) {
...
function requireSet() {
  ...
  function set$1(object$12, path, value) {
    return object$12 == null ? object$12 : baseSet(object$12, path, value);
  }
  set_1 = set$1;
  return set_1;
}
...
function require_copyArray() {
  ...
  function copyArray$12(source, array$12) {
    var index = -1, length = source.length;
    array$12 || (array$12 = Array(length));
    while (++index < length) array$12[index] = source[index];
    return array$12;
  }
  _copyArray = copyArray$12;
  return _copyArray;
}
var toPath_1;
...
function requireToPath() {
  ...
  hasRequiredToPath = 1;
  var arrayMap = require_arrayMap(), copyArray$12 = require_copyArray(), isArray = requireIsArray(), isSymbol = requireIsSymbol(), stringToPath = require_stringToPath(), toKey = require_toKey(), toString2 = requireToString();
  function toPath$1(value) {
    if (isArray(value)) return arrayMap(value, toKey);
    return isSymbol(value) ? [value] : copyArray$12(stringToPath(toString2(value)));
  }
  toPath_1 = toPath$1;
  return toPath_1;
}
...
var define$2 = {
  data: function data$2(params) {
    params = extend({}, {
      ...
      immutableKeys: {},
      updateStyle: false,
      beforeGet: function beforeGet2(self$1) {
      },
      beforeSet: function beforeSet3(self$1, obj) {
      },
      onSet: function onSet3(self$1) {
      },
      canSet: function canSet2(self$1) {
        return true;
      }
    }, params);
    return function dataImpl(name, value) {
      ...
      if (string(name)) {
        ...
        var fn$72 = name;
        self$1.on(p$1.bindingEvent, fn$72);
...
var elesfn$h = {
  ...
  toggleClass: function toggleClass(classes2, toggle) {
    if (!array(classes2)) classes2 = classes2.match(/\S+/g) || [];
    var self$1 = this;
  ...
  flashClass: function flashClass(classes2, duration) {
    ...
    self$1.addClass(classes2);
    setTimeout(function() {
      self$1.removeClass(classes2);
    }, duration);
    return self$1;
  }
};
...
var exprs = [
  {
    ...
    populate: function populate(selector, query, _ref) {
      var group2 = _slicedToArray(_ref, 1)[0];
      query.checks.push({
        type: Type.GROUP,
  ...
  },
  {
    ...
    populate: function populate3(selector, query, _ref5) {
      var id2 = _slicedToArray(_ref5, 1)[0];
      query.checks.push({
        type: Type.ID,
  ...
  },
  {
    ...
    populate: function populate8(selector, query, _ref15) {
      var _ref16 = _slicedToArray(_ref15, 3), meta$12 = _ref16[0], comparatorOp = _ref16[1], number$22 = _ref16[2];
      query.checks.push({
        type: Type.META_COMPARE,
        field: cleanMetaChars(meta$12),
        operator: comparatorOp,
        value: parseFloat(number$22)
      });
    }
  },
  {
...
var valCmp = function valCmp$1(fieldVal, operator, value) {
  ...
  switch (operator) {
    case "*=":
      matches32 = fieldStr.indexOf(valStr) >= 0;
      break;
    case "$=":
      matches32 = fieldStr.indexOf(valStr, fieldStr.length - valStr.length) >= 0;
      break;
    case "^=":
      matches32 = fieldStr.indexOf(valStr) === 0;
      break;
    case "=":
      matches32 = fieldVal === value;
      break;
    case ">":
      isIneqCmp = true;
      matches32 = fieldVal > value;
  ...
  if (notExpr && (fieldVal != null || !isIneqCmp)) matches32 = !matches32;
  return matches32;
};
...
var data$1 = function data$22(ele, field) {
...
var matching = {
  matches: function matches31(ele) {
    var self$1 = this;
    for (var j = 0; j < self$1.length; j++) {
      var query = self$1[j];
  ...
  filter: function filter(collection$13) {
    var self$1 = this;
    if (self$1.length === 1 && self$1[0].checks.length === 1 && self$1[0].checks[0].type === Type.ID) return collection$13.getElementById(self$1[0].checks[0].value).collection();
    var selectorFunction = function selectorFunction$1(element$12) {
      for (var j = 0; j < self$1.length; j++) {
        var query = self$1[j];
        if (matches$1(query, element$12)) return true;
      }
      return false;
    };
    ...
    return collection$13.filter(selectorFunction);
  }
};
...
var elesfn$g = {
  ...
  some: function some(fn$72, thisArg) {
    for (var i$1 = 0; i$1 < this.length; i$1++) if (!thisArg ? fn$72(this[i$1], i$1, this) : fn$72.apply(thisArg, [
      this[i$1],
      i$1,
      this
    ])) return true;
  ...
  every: function every(fn$72, thisArg) {
    for (var i$1 = 0; i$1 < this.length; i$1++) if (!(!thisArg ? fn$72(this[i$1], i$1, this) : fn$72.apply(thisArg, [
      this[i$1],
      i$1,
      this
  ...
  same: function same(collection$13) {
    if (this === collection$13) return true;
    collection$13 = this.cy().collection(collection$13);
    var thisLength = this.length;
    if (thisLength !== collection$13.length) return false;
    if (thisLength === 1) return this[0] === collection$13[0];
    return this.every(function(ele) {
      return collection$13.hasElementWithId(ele.id());
    });
  },
  anySame: function anySame(collection$13) {
    collection$13 = this.cy().collection(collection$13);
    return this.some(function(ele) {
      return collection$13.hasElementWithId(ele.id());
    });
  },
  allAreNeighbors: function allAreNeighbors(collection$13) {
    collection$13 = this.cy().collection(collection$13);
    var nhood = this.neighborhood();
    return collection$13.every(function(ele) {
      return nhood.hasElementWithId(ele.id());
    });
  },
  contains: function contains(collection$13) {
    collection$13 = this.cy().collection(collection$13);
    var self$1 = this;
    return collection$13.every(function(ele) {
...
var cache = function cache$1(fn$72, name) {
  return function traversalCache(arg1, arg2, arg3, arg4) {
    ...
    if (eles.length === 1 && key) {
      ...
      else return ch[hash] = fn$72.call(eles, arg1, arg2, arg3, arg4);
    } else return fn$72.call(eles, arg1, arg2, arg3, arg4);
  };
};
var elesfn$f = {
  parent: function parent(selector) {
    ...
    for (var i$1 = 0; i$1 < this.length; i$1++) {
      ...
      if (_parent) parents2.push(_parent);
    }
  ...
  descendants: function descendants(selector) {
    ...
    function add3(eles) {
      for (var i$1 = 0; i$1 < eles.length; i$1++) {
        var ele = eles[i$1];
        elements.push(ele);
        if (ele.children().nonempty()) add3(ele.children());
      }
    }
    add3(this.children());
...
function forEachCompound(eles, fn$72, includeSelf, recursiveStep) {
  var q = [];
  var did = new Set$1();
...
elesfn$f.forEachDown = function(fn$72) {
  var includeSelf = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
  return forEachCompound(this, fn$72, includeSelf, addChildren);
};
function addParent(q, did, ele) {
  if (ele.isChild()) {
    var parent4 = ele._private.parent;
    if (!did.has(parent4.id())) q.push(parent4);
  }
}
elesfn$f.forEachUp = function(fn$72) {
  var includeSelf = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
  return forEachCompound(this, fn$72, includeSelf, addParent);
};
function addParentAndChildren(q, did, ele) {
  addParent(q, did, ele);
  addChildren(q, did, ele);
}
elesfn$f.forEachUpAndDown = function(fn$72) {
  var includeSelf = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
  return forEachCompound(this, fn$72, includeSelf, addParentAndChildren);
};
...
function defineDegreeBoundsFunction(degreeFn, callback) {
  return function(includeLoops) {
    ...
    var nodes3 = this.nodes();
    for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
      var degree = nodes3[i$1][degreeFn](includeLoops);
...
extend(elesfn$d, {
  minDegree: defineDegreeBoundsFunction("degree", function(degree, min$13) {
    return degree < min$13;
  }),
  maxDegree: defineDegreeBoundsFunction("degree", function(degree, max$14) {
    return degree > max$14;
  }),
  minIndegree: defineDegreeBoundsFunction("indegree", function(degree, min$13) {
    return degree < min$13;
  }),
  maxIndegree: defineDegreeBoundsFunction("indegree", function(degree, max$14) {
    return degree > max$14;
  }),
  minOutdegree: defineDegreeBoundsFunction("outdegree", function(degree, min$13) {
    return degree < min$13;
  }),
  maxOutdegree: defineDegreeBoundsFunction("outdegree", function(degree, max$14) {
    return degree > max$14;
  })
});
extend(elesfn$d, { totalDegree: function totalDegree(includeLoops) {
  var total = 0;
  var nodes3 = this.nodes();
  for (var i$1 = 0; i$1 < nodes3.length; i$1++) total += nodes3[i$1].degree(includeLoops);
  return total;
} });
var fn$4, elesfn$c;
...
fn$4 = elesfn$c = {
  ...
  renderedPosition: function renderedPosition(dim, val) {
    ...
    if (ele && ele.isNode()) if (setting) for (var i$1 = 0; i$1 < this.length; i$1++) {
      var _ele = this[i$1];
      if (val !== void 0) _ele.position(dim, (val - pan2[dim]) / zoom2);
      else if (rpos !== void 0) _ele.position(renderedToModelPosition(rpos, zoom2, pan2));
    }
    else {
      rpos = modelToRenderedPosition$1(ele.position(), zoom2, pan2);
  ...
  relativePosition: function relativePosition(dim, val) {
    ...
    if (ele && ele.isNode()) if (setting) for (var i$1 = 0; i$1 < this.length; i$1++) {
      ...
      if (hasParent) parent4 = parent4[0];
...
elesfn$b.updateCompoundBounds = function() {
  ...
  function update(parent4) {
    if (!parent4.isParent()) return;
    var _p$1 = parent4._private;
    ...
    var leftVal = min$13.width.left.value;
    if (min$13.width.left.units === "px" && min$13.width.val > 0) leftVal = leftVal * 100 / min$13.width.val;
    var rightVal = min$13.width.right.value;
    if (min$13.width.right.units === "px" && min$13.width.val > 0) rightVal = rightVal * 100 / min$13.width.val;
    var topVal = min$13.height.top.value;
    if (min$13.height.top.units === "px" && min$13.height.val > 0) topVal = topVal * 100 / min$13.height.val;
    var bottomVal = min$13.height.bottom.value;
    if (min$13.height.bottom.units === "px" && min$13.height.val > 0) bottomVal = bottomVal * 100 / min$13.height.val;
    var widthBiasDiffs = computeBiasValues(min$13.width.val - bb.w, leftVal, rightVal);
    var diffLeft = widthBiasDiffs.biasDiff;
    var diffRight = widthBiasDiffs.biasComplementDiff;
    var heightBiasDiffs = computeBiasValues(min$13.height.val - bb.h, topVal, bottomVal);
    var diffTop = heightBiasDiffs.biasDiff;
    var diffBottom = heightBiasDiffs.biasComplementDiff;
    _p$1.autoPadding = computePaddingValues(bb.w, bb.h, parent4.pstyle("padding"), parent4.pstyle("padding-relative-to").value);
    _p$1.autoWidth = Math.max(bb.w, min$13.width.val);
    pos.x = (-diffLeft + bb.x1 + bb.x2 + diffRight) / 2;
    _p$1.autoHeight = Math.max(bb.h, min$13.height.val);
...
var boundingBoxImpl = function boundingBoxImpl$1(ele, options2) {
  ...
  if (displayed) {
    ...
    if (isNode2 && options2.includeNodes) {
      ...
      if (styleEnabled2) updateBoundsFromOutline(bounds$1, ele);
      if (styleEnabled2 && options2.includeOutlines && !headless2) updateBoundsFromOutline(bounds$1, ele);
      if (styleEnabled2) updateBoundsFromMiterBorder(bounds$1, ele);
    } else if (isEdge2 && options2.includeEdges) if (styleEnabled2 && !headless2) {
    ...
    if (styleEnabled2 && options2.includeLabels) {
      if (options2.includeMainLabels) updateBoundsFromLabel(bounds$1, ele, null);
      if (isEdge2) {
        if (options2.includeSourceLabels) updateBoundsFromLabel(bounds$1, ele, "source");
        if (options2.includeTargetLabels) updateBoundsFromLabel(bounds$1, ele, "target");
      }
    }
  }
...
var cachedBoundingBoxImpl = function cachedBoundingBoxImpl$1(ele, opts) {
  ...
  if (!usingDefOpts) {
    var isNode2 = ele.isNode();
    bb = makeBoundingBox();
    if (opts.includeNodes && isNode2 || opts.includeEdges && !isNode2) if (opts.includeOverlays) updateBoundsFromBox(bb, _p.overlayBounds);
    else updateBoundsFromBox(bb, _p.bodyBounds);
    if (opts.includeLabels) if (opts.includeMainLabels && (!isEdge2 || opts.includeSourceLabels && opts.includeTargetLabels)) updateBoundsFromBox(bb, _p.labelBounds.all);
    else {
...
elesfn$b.boundingBox = function(options2) {
  ...
  if (useCache && this.length === 1 && !isDirty(this[0])) {
    if (options2 === void 0) options2 = defBbOpts;
    else options2 = filledBbOpts(options2);
    bounds$1 = cachedBoundingBoxImpl(this[0], options2);
  } else {
    bounds$1 = makeBoundingBox();
    options2 = options2 || defBbOpts;
    var opts = filledBbOpts(options2);
    var eles = this;
    var styleEnabled2 = eles.cy().styleEnabled();
    this.edges().forEach(isDirty);
    this.nodes().forEach(isDirty);
    if (styleEnabled2) this.recalculateRenderedStyle(useCache);
...
elesfn$b.boundingBoxAt = function(fn$72) {
  var nodes3 = this.nodes();
  var cy = this.cy();
  var hasCompoundNodes2 = cy.hasCompoundNodes();
  ...
  var storeOldPos = function storeOldPos$1(node, i$1) {
    return node._private.bbAtOldPos = fn$72(node, i$1);
  };
  var getOldPos = function getOldPos$1(node) {
    return node._private.bbAtOldPos;
  };
  cy.startBatch();
  nodes3.forEach(storeOldPos).silentPositions(fn$72);
  if (hasCompoundNodes2) {
...
var defineDimFns = function defineDimFns$1(opts) {
  ...
  fn$2[opts.name] = function dimImpl() {
    var ele = this[0];
    var _p = ele._private;
    var styleEnabled2 = _p.cy._private.styleEnabled;
    if (ele) if (styleEnabled2) {
      if (ele.isParent()) {
        ele.updateCompoundBounds();
  ...
  fn$2["outer" + opts.uppercaseName] = function outerDimImpl() {
    var ele = this[0];
    var styleEnabled2 = ele._private.cy._private.styleEnabled;
    if (ele) if (styleEnabled2) {
...
var ifEdgeRenderedPositions = function ifEdgeRenderedPositions$1(ele, getPoints) {
  if (ele.isEdge() && ele.takesUpSpace()) {
    ...
    return getPoints(ele).map(function(p$1) {
      return modelToRenderedPosition$1(p$1, zoom2, pan2);
    });
  }
};
var pts = {
...
p.on = p.addListener = function(events, qualifier, callback, conf, confOverrides) {
  forEachEvent(this, function(self$1, event$12, type, namespace, qualifier$1, callback$1, conf$1) {
...
p.removeListener = p.off = function(events, qualifier, callback, conf) {
  ...
  var _loop = function _loop$1(i$2) {
    ...
    forEachEvent(_this, function(self$1, event$12, type, namespace, qualifier$1, callback$1) {
...
var elesfn$9 = {
  ...
  emitAndNotify: function emitAndNotify(event$12, extraParams) {
    if (this.length === 0) return;
    this.cy().notify(event$12, this);
    this.emit(event$12, extraParams);
    return this;
  }
};
...
var elesfn$8 = {
  ...
  byGroup: function byGroup() {
    ...
    for (var i$1 = 0; i$1 < this.length; i$1++) {
      var ele = this[i$1];
      if (ele.isNode()) nodes3.push(ele);
      else edges3.push(ele);
    }
    return {
      nodes: nodes3,
      edges: edges3
  ...
  not: function not(toRemove) {
    if (!toRemove) return this;
      ...
      for (var i$1 = 0; i$1 < this.length; i$1++) {
        var element$12 = this[i$1];
        if (!toRemove.has(element$12)) elements.push(element$12);
      }
      return elements;
    }
  },
  ...
  xor: function xor(other) {
    ...
    var col1 = this;
    var col2 = other;
    var add3 = function add$1(col, other$1) {
      for (var i$1 = 0; i$1 < col.length; i$1++) {
        var ele = col[i$1];
        var id2 = ele._private.data.id;
        if (!other$1.hasElementWithId(id2)) elements.push(ele);
      }
    };
    add3(col1, col2);
    add3(col2, col1);
  ...
  diff: function diff(other) {
    ...
    var col1 = this;
    var col2 = other;
    var add3 = function add$1(col, other$1, retEles) {
      for (var i$1 = 0; i$1 < col.length; i$1++) {
        var ele = col[i$1];
        var id2 = ele._private.data.id;
        if (other$1.hasElementWithId(id2)) both.merge(ele);
  ...
  reduce: function reduce(fn$72, initialValue) {
    var val = initialValue;
    var eles = this;
    for (var i$1 = 0; i$1 < eles.length; i$1++) val = fn$72(val, eles[i$1], i$1, eles);
    return val;
  },
  max: function max$13(valFn, thisArg) {
    var max$2 = -Infinity;
    var maxEle;
    var eles = this;
    for (var i$1 = 0; i$1 < eles.length; i$1++) {
  ...
  min: function min$12(valFn, thisArg) {
    var min$2 = Infinity;
    var minEle;
    var eles = this;
    for (var i$1 = 0; i$1 < eles.length; i$1++) {
...
var zIndexSort = function zIndexSort$1(a, b) {
  var hasCompoundNodes2 = a.cy().hasCompoundNodes();
  function getDepth(ele) {
    var style3 = ele.pstyle("z-compound-depth");
    if (style3.value === "auto") return hasCompoundNodes2 ? ele.zDepth() : 0;
    else if (style3.value === "bottom") return -1;
    else if (style3.value === "top") return MAX_INT$1;
    return 0;
  }
...
var elesfn$6 = {
  forEach: function forEach(fn$72, thisArg) {
    if (fn$6(fn$72)) {
      var N = this.length;
      for (var i$1 = 0; i$1 < N; i$1++) {
        var ele = this[i$1];
        if ((thisArg ? fn$72.apply(thisArg, [
          ele,
          i$1,
          this
        ]) : fn$72(ele, i$1, this)) === false) break;
      }
    }
    return this;
  },
  toArray: function toArray() {
    var array$12 = [];
    for (var i$1 = 0; i$1 < this.length; i$1++) array$12.push(this[i$1]);
    return array$12;
  },
  slice: function slice(start, end) {
    ...
    for (var i$1 = start; i$1 >= 0 && i$1 < end && i$1 < thisSize; i$1++) array$12.push(this[i$1]);
    return this.spawn(array$12);
  },
  size: function size() {
    return this.length;
  },
...
var elesfn$5 = {
  ...
  layoutPositions: function layoutPositions(layout$13, options2, fn$72) {
    ...
    var fnMem = memoize(fn$72, getMemoizeKey);
    layout$13.emit({
      type: "layoutstart",
      layout: layout$13
    });
    layout$13.animations = [];
    ...
    var bb = (function spacingBb() {
      ...
      for (var i$2 = 0; i$2 < nodes3.length; i$2++) {
        var node$1 = nodes3[i$2];
    ...
    var getFinalPos = memoize(function(node$1, i$2) {
      ...
      if (useSpacingFactor) newPos$1 = calculateSpacing(Math.abs(options2.spacingFactor), bb, newPos$1);
      if (options2.transform != null) newPos$1 = options2.transform(node$1, newPos$1);
      return newPos$1;
    }, getMemoizeKey);
    if (options2.animate) {
      for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
        ...
        if (options2.animateFilter == null || options2.animateFilter(node, i$1)) {
          var ani = node.animation({
            position: newPos,
            duration: options2.animationDuration,
            easing: options2.animationEasing
          });
          layout$13.animations.push(ani);
      ...
      if (options2.fit) {
        ...
        layout$13.animations.push(fitAni);
        ...
        layout$13.animations.push(zoomPanAni);
      }
      layout$13.animations.forEach(function(ani$1) {
        return ani$1.play();
      });
      layout$13.one("layoutready", options2.ready);
      layout$13.emit({
        type: "layoutready",
        layout: layout$13
      });
      Promise$1.all(layout$13.animations.map(function(ani$1) {
        return ani$1.promise();
      })).then(function() {
        layout$13.one("layoutstop", options2.stop);
        layout$13.emit({
          type: "layoutstop",
          layout: layout$13
        });
      ...
      if (options2.fit) cy.fit(options2.eles, options2.padding);
      if (options2.zoom != null) cy.zoom(options2.zoom);
      if (options2.pan) cy.pan(options2.pan);
      layout$13.one("layoutready", options2.ready);
      layout$13.emit({
        type: "layoutready",
        layout: layout$13
  ...
  layout: function layout$1(options2) {
    return this.cy().makeLayout(extend({}, options2, { eles: this }));
  }
};
elesfn$5.createLayout = elesfn$5.makeLayout = elesfn$5.layout;
function styleCache(key, fn$72, ele) {
  var _p = ele._private;
  var cache$12 = _p.styleCache = _p.styleCache || [];
  var val;
  if ((val = cache$12[key]) != null) return val;
  else {
    val = cache$12[key] = fn$72(ele);
    return val;
  }
}
function cacheStyleFunction(key, fn$72) {
  key = hashString(key);
  return function cachedStyleFunction(ele) {
    return styleCache(key, fn$72, ele);
  };
}
function cachePrototypeStyleFunction(key, fn$72) {
  key = hashString(key);
  var selfFn = function selfFn$1(ele) {
    return fn$72.call(ele);
  };
...
var elesfn$4 = {
  recalculateRenderedStyle: function recalculateRenderedStyle(useCache) {
    ...
    var styleEnabled2 = cy.styleEnabled();
    if (renderer2 && styleEnabled2) renderer2.recalculateRenderedStyle(this, useCache);
    return this;
  },
  ...
  effectiveOpacity: function effectiveOpacity() {
    ...
    if (ele) {
      ...
      if (!hasCompoundNodes2) return parentOpacity;
      var parents2 = !_p.data.parent ? null : ele.parents();
      if (parents2) for (var i$1 = 0; i$1 < parents2.length; i$1++) parentOpacity = parents2[i$1].pstyle("opacity").value * parentOpacity;
  ...
  transparent: function transparent() {
    ...
    if (ele) if (!hasCompoundNodes2) return ele.pstyle("opacity").value === 0;
...
function checkCompound(ele, parentOk) {
  var parents2 = ele._private.data.parent ? ele.parents() : null;
  if (parents2) for (var i$1 = 0; i$1 < parents2.length; i$1++) {
    var parent4 = parents2[i$1];
    if (!parentOk(parent4)) return false;
  }
  return true;
}
function defineDerivedStateFunction(specs) {
  ...
  return function() {
    ...
    if (ele) {
      ...
      if (ele.isNode()) return !hasCompoundNodes2 || checkCompound(ele, parentOk);
      else {
        var src = _p.source;
        var tgt = _p.target;
...
elesfn$4.interactive = cachePrototypeStyleFunction("interactive", defineDerivedStateFunction({
  ...
  parentOk: cacheStyleFunction("parentInteractive", function(parent4) {
...
function defineSwitchFunction(params) {
  return function() {
    ...
    if (args.length === 2) {
      var data$23 = args[0];
      var handler = args[1];
      this.on(params.event, data$23, handler);
...
function defineEdgesWithFunction(params) {
  return function edgesWithImpl(otherNodes) {
    ...
    for (var h = 0; h < otherNodes.length; h++) {
      ...
      for (var i$1 = 0; i$1 < edges3.length; i$1++) {
        var edge = edges3[i$1];
...
function defineParallelEdgesFunction(params) {
  ...
  return function parallelEdgesImpl(selector) {
    ...
    var p$1 = params;
    for (var i$1 = 0; i$1 < edges3.length; i$1++) {
      var edge1_p = edges3[i$1]._private;
...
extend(elesfn$2, {
  components: function components(root) {
    ...
    var visitInComponent = function visitInComponent$1(node, component2) {
      visited.merge(node);
...
var Collection = function Collection$1(cy, elements) {
  ...
  if (!elements) elements = [];
    ...
    for (var i$1 = 0, l = elements.length; i$1 < l; i$1++) {
      var json2 = elements[i$1];
      if (json2.data == null) json2.data = {};
  ...
  if (unique) this._private.map = map2;
...
elesfn$1.json = function(obj) {
  ...
  if (plainObject(obj)) {
    ...
    if (obj.data) {
      ...
      if (ele.isEdge()) {
        ...
        if (newParentValSpecd && (parent4 != null || _data2.parent != null) && parent4 != _data2.parent) {
          if (parent4 === void 0) parent4 = null;
          if (parent4 != null) parent4 = "" + parent4;
          ele = ele.move({ parent: parent4 });
        }
      }
    }
    ...
    p$1.classes.forEach(function(cls) {
      return json2.classes += i$1++ === 0 ? cls : " " + cls;
    });
    return json2;
  }
};
...
elesfn$1.clone = function() {
  ...
  var elesArr = [];
  for (var i$1 = 0; i$1 < this.length; i$1++) {
    var clone$12 = new Element(cy, this[i$1].json(), false);
    elesArr.push(clone$12);
  }
...
elesfn$1.restore = function() {
  ...
  for (var _i3 = 0, l = self$1.length; _i3 < l; _i3++) {
    var ele = self$1[_i3];
    if (addToPool2 && !ele.removed()) continue;
    if (ele.isNode()) nodes3.push(ele);
    else edges3.push(ele);
  }
  ...
  for (i$1 = 0; i$1 < elements.length; i$1++) {
    ...
    if (addToPool2) cy.addToPool(_ele2);
  }
  for (var _i4 = 0; _i4 < nodes3.length; _i4++) {
    var node = nodes3[_i4];
    ...
    if (parentId != null || node._private.parent) {
      ...
      if (parent4.empty()) _data4.parent = void 0;
  ...
  if (elements.length > 0) {
    ...
    else if (addToPool2) restored.emit("add");
  }
  return self$1;
};
...
elesfn$1.remove = function() {
  ...
  function addConnectedEdges(node) {
    var edges3 = node._private.edges;
    for (var i$2 = 0; i$2 < edges3.length; i$2++) add3(edges3[i$2]);
  }
  function addChildren$1(node) {
    var children = node._private.children;
    for (var i$2 = 0; i$2 < children.length; i$2++) add3(children[i$2]);
  }
  function add3(ele$1) {
    var alreadyAdded = elesToRemoveIds[ele$1.id()];
    if (removeFromPool2 && ele$1.removed() || alreadyAdded) return;
  ...
  if (removeFromPool2) cy.removeFromPool(elesToRemove);
  for (var _i6 = 0; _i6 < elesToRemove.length; _i6++) {
    ...
    if (_ele4.isEdge()) {
      ...
      if (parent4.length !== 0) removeChildRef(parent4, _ele4);
    }
    if (removeFromPool2) _ele4._private.removed = true;
  }
  ...
  if (removedElements.size() > 0) {
    ...
    else if (removeFromPool2) removedElements.emit("remove");
  }
  for (var _i8 = 0; _i8 < alteredParents.length; _i8++) {
    var _ele6 = alteredParents[_i8];
    if (!removeFromPool2 || !_ele6.removed()) _ele6.updateStyle();
  }
...
elesfn$1.move = function(struct) {
  ...
  var toString2 = function toString$1(id2) {
...
var corefn$9 = {
    ...
    if (elementOrCollection(opts)) {
      ...
      for (var _i = 0, il = grs.length; _i < il; _i++) {
        ...
        if (array(elesArray)) for (var j = 0, jl = elesArray.length; j < jl; j++) {
          var json2 = extend({ group: group2 }, elesArray[j]);
          _jsons2.push(json2);
        }
      }
  ...
  remove: function remove(collection$13) {
    if (elementOrCollection(collection$13)) ;
    else if (string(collection$13)) {
      var selector = collection$13;
      collection$13 = this.$(selector);
    }
    return collection$13.remove();
  }
};
function generateCubicBezier(mX1, mY1, mX2, mY2) {
  ...
  function getTForX(aX) {
    ...
    --currentSample;
    var dist$12 = (aX - mSampleValues[currentSample]) / (mSampleValues[currentSample + 1] - mSampleValues[currentSample]), guessForT = intervalStart + dist$12 * kSampleStepSize, initialSlope = getSlope(guessForT, mX1, mX2);
...
function step$1(self$1, ani, now, isCore) {
  ...
  var style3 = (isCore ? self$1 : self$1.cy()).style();
  if (!ani_p.easingImpl) if (pEasing == null) ani_p.easingImpl = easings["linear"];
  else {
    var easingVals;
    if (string(pEasing)) easingVals = style3.parse("transition-timing-function", pEasing).value;
  ...
  if (ani_p.delay == null) {
    ...
    if (animatingPan) {
      if (valid(startPan.x, endPan.x)) pan2.x = ease(startPan.x, endPan.x, percent, easing);
      if (valid(startPan.y, endPan.y)) pan2.y = ease(startPan.y, endPan.y, percent, easing);
      self$1.emit("pan");
    }
    ...
    if (props && props.length > 0 && isEles) {
      for (var i$1 = 0; i$1 < props.length; i$1++) {
        ...
        style3.overrideBypass(self$1, _name, easedVal);
      }
      self$1.emit("style");
    }
  }
...
var corefn$8 = {
  ...
  startAnimationLoop: function startAnimationLoop() {
    ...
    var renderer2 = cy.renderer();
    if (renderer2 && renderer2.beforeRender) renderer2.beforeRender(function rendererAnimationStep(willDraw, now) {
      stepAll(now, cy);
...
var argSelector = function argSelector$22(arg) {
  if (string(arg)) return new Selector(arg);
  else return arg;
};
var elesfn = {
  ...
  emitAndNotify: function emitAndNotify2(event$12, eles) {
    this.emit(event$12);
    this.notify(event$12, eles);
    return this;
  }
};
...
var corefn$6 = { layout: function layout$12(options2) {
  var cy = this;
  if (options2 == null) {
  ...
  var eles;
  if (string(options2.eles)) eles = cy.$(options2.eles);
  else eles = options2.eles != null ? options2.eles : cy.$();
  return new Layout(extend({}, options2, {
    cy,
    eles
  }));
} };
...
var corefn$5 = {
  notify: function notify(eventName, eventEles) {
    ...
    if (this.destroyed() || !renderer2) return;
  ...
  endBatch: function endBatch() {
    ...
    if (_p.batchCount === 0) {
      ...
      Object.keys(_p.batchNotifications).forEach(function(eventName) {
        ...
        if (eles.empty()) renderer2.notify(eventName);
        else renderer2.notify(eventName, eles);
      });
    }
    return this;
  },
  ...
  batchData: function batchData(map2) {
    ...
    return this.batch(function() {
      ...
      for (var i$1 = 0; i$1 < ids.length; i$1++) {
        var id2 = ids[i$1];
        var data$23 = map2[id2];
        cy.getElementById(id2).data(data$23);
      }
    });
  }
};
...
var corefn$4 = {
  renderTo: function renderTo(context, zoom2, pan2, pxRatio) {
    this._private.renderer.renderTo(context, zoom2, pan2, pxRatio);
    return this;
  },
  ...
  onRender: function onRender(fn$72) {
    return this.on("render", fn$72);
  },
  offRender: function offRender(fn$72) {
    return this.off("render", fn$72);
  }
};
corefn$4.invalidateDimensions = corefn$4.resize;
var corefn$3 = {
  collection: function collection$12(eles, opts) {
...
styfn$8.getPropertiesDiff = function(oldCxtKey, newCxtKey) {
  var self$1 = this;
  var cache$12 = self$1._private.propDiffs = self$1._private.propDiffs || {};
  var dualCxtKey = oldCxtKey + "-" + newCxtKey;
  var cachedVal = cache$12[dualCxtKey];
...
styfn$8.getContextStyle = function(cxtMeta) {
  ...
  var style3 = { _private: { key: cxtKey } };
  for (var i$1 = 0; i$1 < self$1.length; i$1++) {
    var cxt = self$1[i$1];
...
styfn$8.applyParsedProperty = function(ele, parsedProp) {
  ...
  switch (prop.mapped) {
    ...
    case types.data:
      ...
      break;
    case types.fn:
      var fn$72 = prop.value;
      var fnRetVal = prop.fnValue != null ? prop.fnValue : fn$72(ele);
...
styfn$8.updateTransitions = function(ele, diffProps) {
  ...
  if (props.length > 0 && duration > 0) {
    ...
    new Promise$1(function(resolve2) {
      if (delay2 > 0) ele.delayAnimation(delay2).play().promise().then(resolve2);
      else resolve2();
    }).then(function() {
...
styfn$6.containerCss = function(propName) {
  var cy = this._private.cy;
  var domElement$12 = cy.container();
  var containerWindow = cy.window();
  if (containerWindow && domElement$12 && containerWindow.getComputedStyle) return containerWindow.getComputedStyle(domElement$12).getPropertyValue(propName);
};
var styfn$5 = {};
...
styfn$4.appendFromJson = function(json2) {
  var style3 = this;
  for (var i$1 = 0; i$1 < json2.length; i$1++) {
    var context = json2[i$1];
...
var styfn$3 = {};
styfn$3.appendFromString = function(string$12) {
  var self$1 = this;
  var style3 = this;
  var remaining = "" + string$12;
  var selAndBlockStr;
  var blockRem;
  var propAndValStr;
  ...
  for (; ; ) {
    ...
    for (; ; ) {
      ...
      if (!style3.parse(propStr, valStr)) {
...
styfn$3.fromString = function(string$12) {
  var style3 = this;
  style3.resetToDefault();
  style3.appendFromString(string$12);
  return style3;
};
var styfn$2 = {};
(function() {
  ...
  var hex3$1 = hex3;
  var hex6$1 = hex6;
  var data$23 = function data$3(prefix) {
  ...
  styfn$2.types = {
    ...
    layoutData: {
      mapping: true,
      regex: data$23("layoutData")
    },
    scratch: {
      mapping: true,
      regex: data$23("scratch")
    },
    mapData: {
      mapping: true,
  ...
  var props = styfn$2.properties = [].concat(behavior, transition, visibility, overlay, underlay, ghost, commonLabel, labelDimensions, mainLabel, sourceLabel, targetLabel, nodeBody, nodeBorder, nodeOutline, backgroundImage, pie, stripe, compound, edgeLine, edgeArrow, core$12);
...
styfn$1.parseImpl = function(name, value, propIsBypass, propIsFlat) {
  ...
  else if (value.length >= 7 && value[0] === "d" && (data$23 = new RegExp(types.data.regex).exec(value))) {
...
styfn.css = function() {
  ...
  if (args.length === 1) {
    ...
    for (var i$1 = 0; i$1 < self$1.properties.length; i$1++) {
      ...
      if (mapVal === void 0) mapVal = map2[dash2camel(prop.name)];
...
styfn.append = function(style3) {
  if (stylesheet(style3)) style3.appendToStyle(this);
  else if (array(style3)) this.appendFromJson(style3);
  else if (string(style3)) this.appendFromString(style3);
  return this;
};
...
_Style.fromString = function(cy, string$12) {
  return new _Style(cy).fromString(string$12);
};
[
  styfn$8,
  styfn$7,
...
var corefn$2 = {
  ...
  setStyle: function setStyle(style3) {
    var _p = this._private;
    if (stylesheet(style3)) _p.style = style3.generateStyle(this);
    else if (array(style3)) _p.style = _Style.fromJson(this, style3);
    else if (string(style3)) _p.style = _Style.fromString(this, style3);
...
var corefn$1 = {
    ...
    switch (args.length) {
      case 1:
        if (plainObject(arg0)) {
          ...
          x$1 = dims.x;
          y$1 = dims.y;
          if (number$1(x$1)) pan2.x += x$1;
          if (number$1(y$1)) pan2.y += y$1;
          this.emit("pan viewport");
        }
        break;
      case 2:
        dim = arg0;
        val = arg1;
        if ((dim === "x" || dim === "y") && number$1(val)) pan2[dim] += val;
        this.emit("pan viewport");
        break;
    }
    this.notify("viewport");
  ...
  zoomRange: function zoomRange(min$13, max$14) {
    var _p = this._private;
    if (max$14 == null) {
      var opts = min$13;
      min$13 = opts.min;
    ...
    if (number$1(min$13) && number$1(max$14) && min$13 <= max$14) {
      _p.minZoom = min$13;
      _p.maxZoom = max$14;
    } else if (number$1(min$13) && max$14 === void 0 && min$13 <= _p.maxZoom) _p.minZoom = min$13;
    else if (number$1(max$14) && min$13 === void 0 && max$14 >= _p.minZoom) _p.maxZoom = max$14;
    return this;
  },
  minZoom: function minZoom(zoom2) {
    if (zoom2 === void 0) return this._private.minZoom;
    else return this.zoomRange({ min: zoom2 });
  },
  maxZoom: function maxZoom$2(zoom2) {
    if (zoom2 === void 0) return this._private.maxZoom;
    else return this.zoomRange({ max: zoom2 });
  },
  getZoomedViewport: function getZoomedViewport(params) {
    ...
    if (number$1(params)) zoom2 = params;
    ...
    if (bail || !number$1(zoom2) || zoom2 === currentZoom || pos != null && (!number$1(pos.x) || !number$1(pos.y))) return null;
    if (pos != null) {
      var pan1 = currentPan;
...
var Core = function Core$1(opts) {
  ...
  if (container2 && !htmlElement(container2) && htmlElement(container2[0])) container2 = container2[0];
  ...
  if (container2) container2._cyreg = reg;
  reg.cy = cy;
  var head = _window !== void 0 && container2 !== void 0 && !opts.headless;
  var options2 = opts;
  options2.layout = extend({ name: head ? "grid" : "null" }, options2.layout);
  options2.renderer = extend({ name: head ? "canvas" : "null" }, options2.renderer);
  ...
  loadExtData([options2.style, options2.elements], function(thens) {
    ...
    setElesAndLayout(initEles, function() {
      ...
      _p.ready = true;
      if (fn$6(options2.ready)) cy.on("ready", options2.ready);
      for (var i$1 = 0; i$1 < readies.length; i$1++) {
        var fn$72 = readies[i$1];
        cy.on("ready", fn$72);
      }
      if (reg) reg.readies = [];
      cy.emit("ready");
...
extend(corefn, {
  ...
  ready: function ready(fn$72) {
    if (this.isReady()) this.emitter().emit("ready", [], fn$72);
    else this.on("ready", fn$72);
    return this;
  },
  ...
  mount: function mount(container2) {
    ...
    if (!htmlElement(container2) && htmlElement(container2[0])) container2 = container2[0];
    cy.stopAnimationLoop();
    cy.destroyRenderer();
    _p.container = container2;
    _p.styleEnabled = true;
    cy.invalidateSize();
    cy.initRenderer(extend({}, options2, options2.renderer, { name: options2.renderer.name === "null" ? "canvas" : options2.renderer.name }));
    cy.startAnimationLoop();
    ...
    if (plainObject(obj)) {
      ...
      if (flat) json$1.elements = this.elements().map(function(ele) {
        ...
        eles.forEach(function(ele) {
          ...
          if (!json$1.elements[group2]) json$1.elements[group2] = [];
          json$1.elements[group2].push(ele.json());
        });
      }
      ...
      json$1.renderer = copy(options2.renderer);
      json$1.hideEdgesOnViewport = options2.hideEdgesOnViewport;
      json$1.textureOnViewport = options2.textureOnViewport;
      json$1.wheelSensitivity = options2.wheelSensitivity;
      json$1.motionBlur = options2.motionBlur;
      json$1.multiClickDebounceTime = options2.multiClickDebounceTime;
      return json$1;
    }
  }
});
...
var defaults$7 = {
  ...
  ready: void 0,
  stop: void 0,
  transform: function transform(node, position$12) {
    return position$12;
  }
};
...
BreadthFirstLayout.prototype.run = function() {
  ...
  var nodes3 = eles.nodes().filter(function(n) {
  ...
  var roots;
  if (elementOrCollection(options2.roots)) roots = options2.roots;
  else if (array(options2.roots)) {
    var rootsArray = [];
    for (var i$1 = 0; i$1 < options2.roots.length; i$1++) {
      var id2 = options2.roots[i$1];
      var ele = cy.getElementById(id2);
      rootsArray.push(ele);
    }
    roots = cy.collection(rootsArray);
  } else if (string(options2.roots)) roots = cy.$(options2.roots);
  else if (directed) roots = nodes3.roots();
  else {
    ...
    for (var _i = 0; _i < components2.length; _i++) _loop();
  }
  var depths = [];
  var foundByBfs = {};
  ...
  var adjustMaximally = function adjustMaximally$1(ele$1, shifted$1) {
    ...
    if (eInfo.depth <= maxDepth) {
      if (!options2.acyclic && shifted$1[id$1]) return null;
  ...
  var minDistance = 0;
  if (options2.avoidOverlap) for (var _i3 = 0; _i3 < nodes3.length; _i3++) {
    var nbb = nodes3[_i3].layoutDimensions(options2);
    var w = nbb.w;
    var h = nbb.h;
  ...
  var getWeightedPercent = function getWeightedPercent$1(ele$1) {
    ...
    for (var _i4 = 0; _i4 < neighbors.length; _i4++) {
      ...
      if (neighbor.isEdge() || neighbor.isParent() || !nodes3.has(neighbor)) continue;
  ...
  var sortFn = function sortFn$1(a, b) {
    var diff2 = getWeightedPercent(a) - getWeightedPercent(b);
    if (diff2 === 0) return ascending(a.id(), b.id());
    else return diff2;
  };
  if (options2.depthSort !== void 0) sortFn = options2.depthSort;
  ...
  var aveNodeSize = nodes3.reduce(function(acc, node) {
    ...
    })(node.boundingBox({ includeLabels: options2.nodeDimensionsIncludeLabels }));
  }, {
    w: -1,
    h: -1
  });
  var distanceY = Math.max(depthsLen === 1 ? 0 : hasBoundingBox ? (bb.h - options2.padding * 2 - aveNodeSize.h) / (depthsLen - 1) : (bb.h - options2.padding * 2 - aveNodeSize.h) / (depthsLen + 1), minDistance);
  var maxDepthSize = depths.reduce(function(max$14, eles$1) {
    return Math.max(max$14, eles$1.length);
  }, 0);
  var getPositionTopBottom = function getPositionTopBottom$1(ele$1) {
    ...
    if (options2.circle) {
      ...
      return {
        x: center2.x + radius$1 * Math.cos(theta),
        y: center2.y + radius$1 * Math.sin(theta)
      };
    } else {
      var depthSize = depths[depth].length;
      var distanceX = Math.max(depthSize === 1 ? 0 : hasBoundingBox ? (bb.w - options2.padding * 2 - aveNodeSize.w) / ((options2.grid ? maxDepthSize : depthSize) - 1) : (bb.w - options2.padding * 2 - aveNodeSize.w) / ((options2.grid ? maxDepthSize : depthSize) + 1), minDistance);
      return {
  ...
  if (Object.keys(rotateDegrees).indexOf(options2.direction) === -1) error("Invalid direction '".concat(options2.direction, "' specified for breadthfirst layout. Valid values are: ").concat(Object.keys(rotateDegrees).join(", ")));
  eles.nodes().layoutPositions(this, options2, function getPosition(ele$1) {
    return rotatePosAndSkewByBox(getPositionTopBottom(ele$1), bb, rotateDegrees[options2.direction]);
  });
  return this;
};
var defaults$6 = {
  ...
  animationDuration: 500,
  animationEasing: void 0,
  animateFilter: function animateFilter2(node, i$1) {
    return true;
  },
  ready: void 0,
  stop: void 0,
  transform: function transform2(node, position$12) {
    return position$12;
  }
};
...
CircleLayout.prototype.run = function() {
  ...
  if (options2.sort) nodes3 = nodes3.sort(options2.sort);
  ...
  var dTheta = (options2.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / nodes3.length : options2.sweep) / Math.max(1, nodes3.length - 1);
  var r;
  var minDistance = 0;
  for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
    var nbb = nodes3[i$1].layoutDimensions(options2);
    var w = nbb.w;
    var h = nbb.h;
    minDistance = Math.max(minDistance, w, h);
  }
  if (number$1(options2.radius)) r = options2.radius;
  else if (nodes3.length <= 1) r = 0;
  ...
  eles.nodes().layoutPositions(this, options2, function getPos(ele, i$2) {
    var theta = options2.startAngle + i$2 * dTheta * (clockwise ? 1 : -1);
...
var defaults$5 = {
  ...
  animationDuration: 500,
  animationEasing: void 0,
  animateFilter: function animateFilter3(node, i$1) {
    return true;
  },
  ready: void 0,
  stop: void 0,
  transform: function transform3(node, position$12) {
    return position$12;
  }
};
...
ConcentricLayout.prototype.run = function() {
  ...
  for (var _i = 0; _i < nodes3.length; _i++) {
    var nbb = nodes3[_i].layoutDimensions(options2);
  ...
  for (var _i2 = 0; _i2 < nodeValues.length; _i2++) {
    ...
    if (currentLevel.length > 0) {
      if (Math.abs(currentLevel[0].value - val.value) >= levelWidth2) {
        currentLevel = [];
  ...
  for (var _i3 = 0; _i3 < levels.length; _i3++) {
    ...
    var dTheta = level.dTheta = (options2.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / level.length : options2.sweep) / Math.max(1, level.length - 1);
...
var defaults$4 = {
  ...
  animateFilter: function animateFilter4(node, i$1) {
    return true;
  },
...
CoseLayout.prototype.run = function() {
  ...
  var cy = options2.cy;
  var layout$13 = this;
  layout$13.stopped = false;
  if (options2.animate === true || options2.animate === false) layout$13.emit({
    type: "layoutstart",
    layout: layout$13
  });
  if (true === options2.debug) DEBUG = true;
  else DEBUG = false;
  var layoutInfo = createLayoutInfo(cy, layout$13, options2);
  if (DEBUG) printLayoutInfo(layoutInfo);
  if (options2.randomize) randomizePositions(layoutInfo);
  var startTime = performanceNow();
  var refresh = function refresh$1() {
    refreshPositions(layoutInfo, cy, options2);
    if (true === options2.fit) cy.fit(options2.padding);
  };
  var mainLoop = function mainLoop$1(i$2) {
    if (layout$13.stopped || i$2 >= options2.numIter) return false;
    step(layoutInfo, options2);
    layoutInfo.temperature = layoutInfo.temperature * options2.coolingFactor;
    if (layoutInfo.temperature < options2.minTemp) return false;
    return true;
  };
  var done = function done$1() {
    if (options2.animate === true || options2.animate === false) {
      ...
      nodes3.layoutPositions(layout$13, options2, getScaledPos);
    }
  };
  var i$1 = 0;
  var loopRet = true;
  if (options2.animate === true) {
    var _frame = function frame() {
      ...
      if (!loopRet) {
        ...
        if (performanceNow() - startTime >= options2.animationThreshold) refresh();
...
var createLayoutInfo = function createLayoutInfo$1(cy, layout$13, options2) {
  ...
  var id2cmptId = {};
  for (var i$1 = 0; i$1 < components2.length; i$1++) {
    var component2 = components2[i$1];
...
var getScaleInBoundsFn = function getScaleInBoundsFn$1(layoutInfo, options2, nodes3) {
...
var refreshPositions = function refreshPositions$1(layoutInfo, cy, options2) {
  var layout$13 = options2.layout;
  var nodes3 = options2.eles.nodes();
  var getScaledPos = getScaleInBoundsFn(layoutInfo, options2, nodes3);
...
var step = function step$2(layoutInfo, options2, _step) {
...
var calculateNodeForces = function calculateNodeForces$1(layoutInfo, options2) {
  for (var i$1 = 0; i$1 < layoutInfo.graphSet.length; i$1++) {
    var graph = layoutInfo.graphSet[i$1];
...
var randomDistance = function randomDistance$1(max$14) {
  return -1 + 2 * max$14 * Math.random();
};
var nodeRepulsion = function nodeRepulsion$12(node1, node2, layoutInfo, options2) {
...
var calculateEdgeForces = function calculateEdgeForces$1(layoutInfo, options2) {
  for (var i$1 = 0; i$1 < layoutInfo.edgeSize; i$1++) {
...
var calculateGravityForces = function calculateGravityForces$1(layoutInfo, options2) {
  if (options2.gravity === 0) return;
  var distThreshold = 1;
  for (var i$1 = 0; i$1 < layoutInfo.graphSet.length; i$1++) {
    var graph = layoutInfo.graphSet[i$1];
    var numNodes = graph.length;
...
var propagateForces = function propagateForces$1(layoutInfo, options2) {
  var queue = [];
  var start = 0;
  var end = -1;
...
var updatePositions = function updatePositions$1(layoutInfo, options2) {
  for (var i$1 = 0; i$1 < layoutInfo.nodeSize; i$1++) {
    var n = layoutInfo.layoutNodes[i$1];
...
var limitForce = function limitForce$1(forceX, forceY, max$14) {
  var force = Math.sqrt(forceX * forceX + forceY * forceY);
  if (force > max$14) var res = {
    x: max$14 * forceX / force,
    y: max$14 * forceY / force
  };
  else var res = {
    x: forceX,
    y: forceY
...
var separateComponents = function separateComponents$1(layoutInfo, options2) {
  var nodes3 = layoutInfo.layoutNodes;
  var components2 = [];
  for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
    var node = nodes3[i$1];
    var cid = node.cmptId;
    (components2[cid] = components2[cid] || []).push(node);
  }
  var totalA = 0;
  for (var i$1 = 0; i$1 < components2.length; i$1++) {
    var c = components2[i$1];
    if (!c) continue;
    c.x1 = Infinity;
    c.x2 = -Infinity;
    c.y1 = Infinity;
  ...
  for (var i$1 = 0; i$1 < components2.length; i$1++) {
    ...
    x$1 += c.w + options2.componentSpacing;
    usedW += c.w + options2.componentSpacing;
    rowH = Math.max(rowH, c.h);
    if (usedW > maxRowW) {
      y$1 += rowH + options2.componentSpacing;
      x$1 = 0;
      usedW = 0;
      rowH = 0;
    }
...
var defaults$3 = {
  ...
  animationDuration: 500,
  animationEasing: void 0,
  animateFilter: function animateFilter5(node, i$1) {
    return true;
  },
  ready: void 0,
  stop: void 0,
  transform: function transform4(node, position$12) {
    return position$12;
  }
};
...
GridLayout.prototype.run = function() {
  ...
  if (bb.h === 0 || bb.w === 0) eles.nodes().layoutPositions(this, options2, function(ele) {
    return {
      x: bb.x1,
      y: bb.y1
    };
    ...
    if (options2.avoidOverlap) for (var i$1 = 0; i$1 < nodes3.length; i$1++) {
      var node = nodes3[i$1];
      ...
      var p$1 = options2.avoidOverlapPadding;
      var w = nbb.w + p$1;
      var h = nbb.h + p$1;
    ...
    nodes3.layoutPositions(this, options2, function getPos(element$12, i$2) {
      var x$1, y$1;
      if (element$12.locked() || element$12.isParent()) return false;
      var rcPos$1 = id2manPos[element$12.id()];
      if (rcPos$1) {
...
NullLayout.prototype.run = function() {
  ...
  layout$13.one("layoutready", options2.ready);
  layout$13.emit("layoutready");
  layout$13.one("layoutstop", options2.stop);
  layout$13.emit("layoutstop");
  return this;
};
...
var defaults$1 = {
  ...
  animationDuration: 500,
  animationEasing: void 0,
  animateFilter: function animateFilter6(node, i$1) {
    return true;
  },
  ready: void 0,
  stop: void 0,
  transform: function transform5(node, position$12) {
    return position$12;
  }
};
...
PresetLayout.prototype.run = function() {
  ...
  function getPosition(node) {
    if (options2.positions == null) return copyPosition(node.position());
    if (posIsFn) return options2.positions(node);
    var pos = options2.positions[node._private.data.id];
    if (pos == null) return null;
    return pos;
  }
  nodes3.layoutPositions(this, options2, function(node, i$1) {
    var position$12 = getPosition(node);
    if (node.locked() || position$12 == null) return false;
    return position$12;
  });
  return this;
};
var defaults = {
  ...
  animationDuration: 500,
  animationEasing: void 0,
  animateFilter: function animateFilter7(node, i$1) {
    return true;
  },
  ready: void 0,
  stop: void 0,
  transform: function transform6(node, position$12) {
    return position$12;
  }
};
...
RandomLayout.prototype.run = function() {
  ...
  eles.nodes().layoutPositions(this, options2, function getPos(node, i$1) {
    return {
...
BRp$f.registerArrowShapes = function() {
  ...
  var renderer2 = this;
  var bbCollide = function bbCollide$1(x$1, y$1, size3, angle$1, translation, edgeWidth, padding) {
  ...
  var transform7 = function transform$1(x$1, y$1, size3, angle$1, translation) {
  ...
  var transformPoints$12 = function transformPoints$2(pts$1, size3, angle$1, translation) {
    var retPts = [];
    for (var i$1 = 0; i$1 < pts$1.length; i$1 += 2) {
      var x$1 = pts$1[i$1];
      var y$1 = pts$1[i$1 + 1];
      retPts.push(transform7(x$1, y$1, size3, angle$1, translation));
    }
    return retPts;
  };
  ...
  var defineArrowShape = function defineArrowShape$1(name, defn) {
    ...
    arrowShapes[name] = extend({
      ...
      collide: function collide(x$1, y$1, size3, angle$1, translation, padding) {
        return pointInsidePolygonPoints(x$1, y$1, pointsToArr(transformPoints$12(this.points, size3 + 2 * padding, angle$1, translation)));
      },
      roughCollide: bbCollide,
      draw: function draw(context, size3, angle$1, translation) {
        var points = transformPoints$12(this.points, size3, angle$1, translation);
  ...
  defineArrowShape("triangle-backcurve", {
    ...
    controlPoint: [0, -0.15],
    roughCollide: bbCollide,
    draw: function draw(context, size3, angle$1, translation, edgeWidth) {
      var ptsTrans = transformPoints$12(this.points, size3, angle$1, translation);
      var ctrlPt = this.controlPoint;
      var ctrlPtTrans = transform7(ctrlPt[0], ctrlPt[1], size3, angle$1, translation);
  ...
  defineArrowShape("triangle-tee", {
    ...
    collide: function collide(x$1, y$1, size3, angle$1, translation, edgeWidth, padding) {
      var triPts = pointsToArr(transformPoints$12(this.points, size3 + 2 * padding, angle$1, translation));
      var teePts = pointsToArr(transformPoints$12(this.pointsTee, size3 + 2 * padding, angle$1, translation));
      return pointInsidePolygonPoints(x$1, y$1, triPts) || pointInsidePolygonPoints(x$1, y$1, teePts);
    },
    draw: function draw(context, size3, angle$1, translation, edgeWidth) {
      var triPts = transformPoints$12(this.points, size3, angle$1, translation);
      var teePts = transformPoints$12(this.pointsTee, size3, angle$1, translation);
  ...
  defineArrowShape("circle-triangle", {
    ...
    collide: function collide(x$1, y$1, size3, angle$1, translation, edgeWidth, padding) {
      var t = translation;
      var circleInside = Math.pow(t.x - x$1, 2) + Math.pow(t.y - y$1, 2) <= Math.pow((size3 + 2 * padding) * this.radius, 2);
      return pointInsidePolygonPoints(x$1, y$1, pointsToArr(transformPoints$12(this.points, size3 + 2 * padding, angle$1, translation))) || circleInside;
    },
    draw: function draw(context, size3, angle$1, translation, edgeWidth) {
      var triPts = transformPoints$12(this.pointsTr, size3, angle$1, translation);
      renderer2.arrowShapeImpl(this.name)(context, triPts, translation.x, translation.y, this.radius * size3);
    },
    spacing: function spacing(edge) {
  ...
  defineArrowShape("triangle-cross", {
    ...
    collide: function collide(x$1, y$1, size3, angle$1, translation, edgeWidth, padding) {
      var triPts = pointsToArr(transformPoints$12(this.points, size3 + 2 * padding, angle$1, translation));
      var teePts = pointsToArr(transformPoints$12(this.crossLinePts(size3, edgeWidth), size3 + 2 * padding, angle$1, translation));
      return pointInsidePolygonPoints(x$1, y$1, triPts) || pointInsidePolygonPoints(x$1, y$1, teePts);
    },
    draw: function draw(context, size3, angle$1, translation, edgeWidth) {
      var triPts = transformPoints$12(this.points, size3, angle$1, translation);
      var crossLinePts = transformPoints$12(this.crossLinePts(size3, edgeWidth), size3, angle$1, translation);
  ...
  defineArrowShape("circle", {
    ...
    collide: function collide(x$1, y$1, size3, angle$1, translation, edgeWidth, padding) {
      var t = translation;
      return Math.pow(t.x - x$1, 2) + Math.pow(t.y - y$1, 2) <= Math.pow((size3 + 2 * padding) * this.radius, 2);
    },
    draw: function draw(context, size3, angle$1, translation, edgeWidth) {
      renderer2.arrowShapeImpl(this.name)(context, translation.x, translation.y, this.radius * size3);
    },
    spacing: function spacing(edge) {
      return renderer2.getArrowWidth(edge.pstyle("width").pfValue, edge.pstyle("arrow-scale").value) * this.radius;
    }
...
BRp$e.projectIntoViewport = function(clientX, clientY) {
  ...
  var pan2 = cy.pan();
  var zoom2 = cy.zoom();
  return [((clientX - offsetLeft) / scale$1 - pan2.x) / zoom2, ((clientY - offsetTop) / scale$1 - pan2.y) / zoom2];
};
...
BRp$e.findNearestElements = function(x$1, y$1, interactiveElementsOnly, isTouch) {
  ...
  function checkNode(node) {
    ...
    if (pos.x - hw <= x$1 && x$1 <= pos.x + hw && pos.y - hh <= y$1 && y$1 <= pos.y + hh) {
      if (r.nodeShapes[self$1.getNodeShape(node)].checkPoint(x$1, y$1, 0, width2, height2, pos.x, pos.y, cornerRadius, rs)) {
        addEle(node, 0);
        return true;
      }
    }
  ...
  function checkEdge(edge) {
    ...
    if (rs.edgeType === "segments" || rs.edgeType === "straight" || rs.edgeType === "haystack") {
      var pts$1 = rs.allpts;
      for (var i$2 = 0; i$2 + 3 < pts$1.length; i$2 += 2) if (inLineVicinity(x$1, y$1, pts$1[i$2], pts$1[i$2 + 1], pts$1[i$2 + 2], pts$1[i$2 + 3], width22) && widthSq > (sqDist = sqdistToFiniteLine(x$1, y$1, pts$1[i$2], pts$1[i$2 + 1], pts$1[i$2 + 2], pts$1[i$2 + 3]))) {
        addEle(edge, sqDist);
        return true;
      }
    } else if (rs.edgeType === "bezier" || rs.edgeType === "multibezier" || rs.edgeType === "self" || rs.edgeType === "compound") {
      var pts$1 = rs.allpts;
      for (var i$2 = 0; i$2 + 5 < rs.allpts.length; i$2 += 4) if (inBezierVicinity(x$1, y$1, pts$1[i$2], pts$1[i$2 + 1], pts$1[i$2 + 2], pts$1[i$2 + 3], pts$1[i$2 + 4], pts$1[i$2 + 5], width22) && widthSq > (sqDist = sqdistToQuadraticBezier(x$1, y$1, pts$1[i$2], pts$1[i$2 + 1], pts$1[i$2 + 2], pts$1[i$2 + 3], pts$1[i$2 + 4], pts$1[i$2 + 5]))) {
        addEle(edge, sqDist);
        return true;
      }
    }
...
BRp$d.calculateArrowAngles = function(edge) {
  ...
  if (isSegments) {
    ...
    var pts$1 = rs.allpts;
    var bX = qbezierAt(pts$1[0], pts$1[2], pts$1[4], 0.1);
    var bY = qbezierAt(pts$1[1], pts$1[3], pts$1[5], 0.1);
    dispX = startX$1 - bX;
    dispY = startY$1 - bY;
  } else {
    dispX = startX$1 - midX;
  ...
  if (isSegments) {
    ...
    if (cpts.length / 2 % 2 === 0) {
      ...
      var p0 = ic - 2;
      var p1 = ic + 2;
      bp0x = qbezierAt(pts$1[p0], pts$1[ic], pts$1[p1], 0.4999);
      bp0y = qbezierAt(pts$1[p0 + 1], pts$1[ic + 1], pts$1[p1 + 1], 0.4999);
      bp1x = qbezierAt(pts$1[p0], pts$1[ic], pts$1[p1], 0.5);
      bp1y = qbezierAt(pts$1[p0 + 1], pts$1[ic + 1], pts$1[p1 + 1], 0.5);
    }
    dispX = bp1x - bp0x;
    dispY = bp1y - bp0y;
  }
  ...
  if (isSegments) {
    ...
    var pts$1 = rs.allpts;
    var l = pts$1.length;
    var bX = qbezierAt(pts$1[l - 6], pts$1[l - 4], pts$1[l - 2], 0.9);
    var bY = qbezierAt(pts$1[l - 5], pts$1[l - 3], pts$1[l - 1], 0.9);
    dispX = endX - bX;
    dispY = endY - bY;
  } else {
    dispX = endX - midX;
...
BRp$d.getArrowWidth = BRp$d.getArrowHeight = function(edgeWidth, scale$1) {
  var cache$12 = this.arrowWidthCache = this.arrowWidthCache || {};
  var cachedVal = cache$12[edgeWidth + ", " + scale$1];
  if (cachedVal) return cachedVal;
  cachedVal = Math.max(Math.pow(edgeWidth * 13.37, 0.9), 29) * scale$1;
  cache$12[edgeWidth + ", " + scale$1] = cachedVal;
  return cachedVal;
};
...
BRp$c.findBezierPoints = function(edge, pairInfo, i$1, edgeIsUnbundled, edgeIsSwapped) {
  ...
  for (var b = 0; b < bezierN; b++) {
    var normctrlptDist = (0.5 - pairInfo.eles.length / 2 + i$1) * stepSize * (edgeIsSwapped ? -1 : 1);
...
BRp$c.findEdgeControlPoints = function(edges3) {
  var _this = this;
  if (!edges3 || edges3.length === 0) return;
  var r = this;
  var hasCompounds = r.cy.hasCompoundNodes();
  var hashTable = new Map$1();
  var getKey$12 = function getKey$2(pairId$1, edgeIsUnbundled$1) {
  ...
  for (var i$1 = 0; i$1 < edges3.length; i$1++) {
    ...
    var key = getKey$12(pairId, edgeIsUnbundled);
  ...
  var _loop = function _loop$1() {
    ...
    var key$1 = getKey$12(pairId$1, edgeIsUnbundled$1);
...
BRp$b.findEndpoints = function(edge) {
  ...
  if (tgtManEndptVal === "inside-to-node") intersect2 = [tgtPos.x, tgtPos.y];
  else if (tgtManEndpt.units) intersect2 = this.manualEndptToPx(target, tgtManEndpt);
  else if (tgtManEndptVal === "outside-to-line") intersect2 = rs.tgtIntn;
  else {
      ...
      if (labelIntersect.length > 0) {
        ...
        if (labelIntersect.length > 2) {
          if (sqdist(refPt, {
            x: labelIntersect[2],
            y: labelIntersect[3]
          }) < minSqDist) intersect2 = [labelIntersect[2], labelIntersect[3]];
        }
      }
    }
  }
  ...
  if (srcManEndptVal === "inside-to-node") intersect2 = [srcPos.x, srcPos.y];
  else if (srcManEndpt.units) intersect2 = this.manualEndptToPx(source, srcManEndpt);
  else if (srcManEndptVal === "outside-to-line") intersect2 = rs.srcIntn;
  else {
      ...
      if (_labelIntersect.length > 0) {
        ...
        if (_labelIntersect.length > 2) {
          if (sqdist(_refPt, {
            x: _labelIntersect[2],
            y: _labelIntersect[3]
          }) < _minSqDist) intersect2 = [_labelIntersect[2], _labelIntersect[3]];
        }
      }
    }
  }
...
function pushBezierPts(r, edge, pts$1) {
  var qbezierAt$12 = function qbezierAt$1$1(p1, p2, p3, t) {
  ...
  for (var i$1 = 0; i$1 < r.bezierProjPcts.length; i$1++) {
    ...
    bpts.push({
      x: qbezierAt$12(pts$1[0], pts$1[2], pts$1[4], p$1),
      y: qbezierAt$12(pts$1[1], pts$1[3], pts$1[5], p$1)
    });
  }
}
...
BRp$9.calculateLabelAngle = function(ele, prefix) {
  ...
  else if (isEdge2 && rotStr === "autorotate") return rs.labelAutoAngle;
...
BRp$7.onUpdateEleCalcs = function(fn$72) {
  (this.onUpdateEleCalcsFns = this.onUpdateEleCalcsFns || []).push(fn$72);
};
BRp$7.recalculateRenderedStyle = function(eles, useCache) {
  ...
  for (var i$1 = 0; i$1 < eles.length; i$1++) {
    ...
    if (_p.group === "nodes") nodes3.push(ele);
    else edges3.push(ele);
    rstyle.clean = true;
  }
  for (var _i2 = 0; _i2 < nodes3.length; _i2++) {
...
BRp$4.getCachedImage = function(url, crossOrigin, onLoad) {
  ...
  var cache$12 = imageCache[url];
  if (cache$12) {
    if (!cache$12.image.complete) cache$12.image.addEventListener("load", onLoad);
    return cache$12.image;
  } else {
    cache$12 = imageCache[url] = imageCache[url] || {};
    var image = cache$12.image = new Image();
...
var BRp$3 = {};
BRp$3.registerBinding = function(target, event$12, handler, useCapture) {
...
BRp$3.binder = function(tgt) {
  ...
  var on3 = function on$1(event$12, handler, useCapture) {
...
BRp$3.load = function() {
  ...
  var getShadowRoot = function getShadowRoot$1(element$12) {
    var rootNode = element$12.getRootNode();
    if (rootNode && rootNode.nodeType === 11 && rootNode.host !== void 0) return rootNode;
  };
  var triggerEvents = function triggerEvents$1(target, names, e, position$12) {
  ...
  var addNodesToDrag = function addNodesToDrag$1(nodes3, opts) {
    opts = opts || {};
    ...
    if (opts.addToList) nodes3.forEach(function(ele) {
      addToDragList(ele, opts);
    });
    addDescendantsToDrag(nodes3, opts);
    updateAncestorsInDragLayer(nodes3, { inDragLayer: opts.inDragLayer });
  ...
  var forEachUp = function forEachUp$1(domEle, fn$72) {
    while (domEle != null) {
      fn$72(domEle);
  ...
  var eventInContainer = function eventInContainer$1(e) {
    ...
    for (var i$1 = 0; i$1 < positions2.length; i$1++) {
      var p$1 = positions2[i$1];
      if (x$1 <= p$1.clientX && p$1.clientX <= x$1 + width2 && y$1 <= p$1.clientY && p$1.clientY <= y$1 + height2) {
  ...
  r.registerBinding([containerWindow, shadowRoot], "mousemove", function mousemoveHandler(e) {
    ...
    if (r.hoverData.which === 3) {
      ...
      if ((!down || !down.grabbed()) && near != last2) {
        if (last2) triggerEvents(last2, ["mouseout", "tapdragout"], e, {
          x: pos[0],
          y: pos[1]
        });
  ...
  r.registerBinding(containerWindow, "touchmove", touchmoveHandler = function touchmoveHandler$1(e) {
    ...
    if (capture && r.touchData.cxt) {
      ...
      if ((!start || !start.grabbed()) && near != last2) {
        if (last2) last2.emit(makeEvent("tapdragout"));
  ...
  r.registerBinding(containerWindow, "touchend", touchendHandler = function touchendHandler$1(e) {
    ...
    if (e.touches[2]) {
      ...
      var rdist2 = (dx2 + dy * dy) * zoom2 * zoom2;
...
BRp$2.generatePolygon = function(name, points) {
  return this.nodeShapes[name] = {
    ...
    intersectLine: function intersectLine(nodeX, nodeY, width2, height2, x$1, y$1, padding, cornerRadius) {
      return polygonIntersectLine(x$1, y$1, this.points, nodeX, nodeY, width2 / 2, height2 / 2, padding);
    },
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius) {
      return pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2, height2, [0, -1], padding);
    },
...
BRp$2.generateEllipse = function() {
  return this.nodeShapes["ellipse"] = {
    ...
    intersectLine: function intersectLine(nodeX, nodeY, width2, height2, x$1, y$1, padding, cornerRadius) {
      return intersectLineEllipse(x$1, y$1, nodeX, nodeY, width2 / 2 + padding, height2 / 2 + padding);
    },
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius) {
      return checkInEllipse(x$1, y$1, width2, height2, centerX, centerY, padding);
    }
  };
};
BRp$2.generateRoundPolygon = function(name, points) {
  return this.nodeShapes[name] = {
    ...
    intersectLine: function intersectLine(nodeX, nodeY, width2, height2, x$1, y$1, padding, cornerRadius, rs) {
      return roundPolygonIntersectLine(x$1, y$1, this.points, nodeX, nodeY, width2, height2, padding, this.getOrCreateCorners(nodeX, nodeY, width2, height2, cornerRadius, rs, "corners"));
    },
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius, rs) {
      return pointInsideRoundPolygon(x$1, y$1, this.points, centerX, centerY, width2, height2, this.getOrCreateCorners(centerX, centerY, width2, height2, cornerRadius, rs, "corners"));
    }
  };
};
BRp$2.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes["roundrectangle"] = {
    ...
    intersectLine: function intersectLine(nodeX, nodeY, width2, height2, x$1, y$1, padding, cornerRadius) {
      return roundRectangleIntersectLine(x$1, y$1, nodeX, nodeY, width2, height2, padding, cornerRadius);
    },
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius) {
      var halfWidth = width2 / 2;
      var halfHeight = height2 / 2;
      ...
      if (pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2, height2 - diam, [0, -1], padding)) return true;
      if (pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2 - diam, height2, [0, -1], padding)) return true;
...
BRp$2.generateCutRectangle = function() {
  return this.nodeShapes["cut-rectangle"] = this.nodeShapes["cutrectangle"] = {
    ...
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius) {
      var cl = cornerRadius === "auto" ? this.cornerLength : cornerRadius;
      if (pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2, height2 - 2 * cl, [0, -1], padding)) return true;
      if (pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2 - 2 * cl, height2, [0, -1], padding)) return true;
...
BRp$2.generateBarrel = function() {
  return this.nodeShapes["barrel"] = {
    ...
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius) {
      ...
      var hOffset = curveConstants.heightOffset;
      var wOffset = curveConstants.widthOffset;
      if (pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2, height2 - 2 * hOffset, [0, -1], padding)) return true;
      if (pointInsidePolygon(x$1, y$1, this.points, centerX, centerY, width2 - 2 * wOffset, height2, [0, -1], padding)) return true;
...
BRp$2.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes["bottomroundrectangle"] = {
    ...
    intersectLine: function intersectLine(nodeX, nodeY, width2, height2, x$1, y$1, padding, cornerRadius) {
      ...
      var topIntersections = finiteLinesIntersect(x$1, y$1, nodeX, nodeY, topStartX, topStartY, nodeX + (width2 / 2 + padding), topEndY, false);
    ...
    checkPoint: function checkPoint(x$1, y$1, padding, width2, height2, centerX, centerY, cornerRadius) {
      ...
      if (checkInEllipse(x$1, y$1, diam, diam, centerX + width2 / 2 - cornerRadius, centerY + height2 / 2 - cornerRadius, padding)) return true;
      if (checkInEllipse(x$1, y$1, diam, diam, centerX - width2 / 2 + cornerRadius, centerY + height2 / 2 - cornerRadius, padding)) return true;
      return false;
    }
  };
...
BRp$1.beforeRender = function(fn$72, priority3) {
  if (this.destroyed) return;
  if (priority3 == null) error("Priority is not optional for beforeRender");
...
var BR = function BaseRenderer(options2) {
  this.init(options2);
};
...
BRp.init = function(options2) {
  ...
  if (containerWindow) {
    ...
    if (!stylesheetAlreadyExists) {
      var stylesheet$12 = document$1.createElement("style");
      stylesheet$12.id = stylesheetId;
      stylesheet$12.textContent = "." + className + " { position: relative; }";
      head.insertBefore(stylesheet$12, head.children[0]);
    }
  ...
  return function setupDequeueingImpl() {
    ...
    var dequeue = function dequeue$1(willDraw, frameStartTime) {
      ...
      while (true) {
        ...
        var thisDeqd = opts.deq(self$1, pixelRatio, extent2);
        if (thisDeqd.length > 0) for (var i$1 = 0; i$1 < thisDeqd.length; i$1++) deqd.push(thisDeqd[i$1]);
        else break;
      }
      if (deqd.length > 0) {
        opts.onDeqd(self$1, deqd);
        if (!willDraw && opts.shouldRedraw(self$1, deqd, pixelRatio, extent2)) queueRedraw();
      }
    };
    var priority3 = opts.priority || noop$1;
    r.beforeRender(dequeue, priority3(self$1));
  };
} };
var ElementTextureCacheLookup = /* @__PURE__ */ (function() {
  function ElementTextureCacheLookup$1(getKey$12) {
  ...
  return _createClass(ElementTextureCacheLookup$1, [
    ...
    },
    {
      ...
      value: function addIdForKey(key, id2) {
        if (key != null) this.getIdsFor(key).add(id2);
      }
    },
    {
      key: "deleteIdForKey",
      value: function deleteIdForKey(key, id2) {
        if (key != null) this.getIdsFor(key)["delete"](id2);
      }
    },
    {
    ...
    },
    {
      ...
      value: function keyHasChangedFor(ele) {
        var id2 = ele.id();
        return this.keyForId.get(id2) !== this.getKey(ele);
      }
    },
    {
      key: "isInvalid",
    ...
    },
    {
      ...
      value: function get$1(ele, lvl) {
        ...
        var cache$12 = this.getCache(key, lvl);
        if (cache$12 != null) this.updateKeyMappingFor(ele);
        return cache$12;
      }
    },
    {
    ...
    {
      key: "setCache",
      value: function setCache(key, lvl, cache$12) {
        cache$12.key = key;
        this.getCachesAt(lvl).set(key, cache$12);
      }
    },
    {
      key: "set",
      value: function set$1(ele, lvl, cache$12) {
        var key = this.getKey(ele);
        this.setCache(key, lvl, cache$12);
...
var ElementTextureCache = function ElementTextureCache$1(renderer2, initOptions) {
  var self$1 = this;
  self$1.renderer = renderer2;
  self$1.onDequeues = [];
...
ETCp.getElement = function(ele, bb, pxRatio, lvl, reason) {
  ...
  if (lvl == null) lvl = Math.ceil(log2(zoom2 * pxRatio));
  if (lvl < minLvl$1) lvl = minLvl$1;
  else if (zoom2 >= maxZoom$1 || lvl > maxLvl$1) return null;
...
ETCp.invalidateElement = function(ele) {
  ...
  for (var lvl = minLvl$1; lvl <= maxLvl$1; lvl++) {
    var cache$12 = lookup$1.getForCachedKey(ele, lvl);
    if (cache$12) caches.push(cache$12);
  }
...
ETCp.onDequeue = function(fn$72) {
  this.onDequeues.push(fn$72);
};
ETCp.offDequeue = function(fn$72) {
  removeFromArray(this.onDequeues, fn$72);
};
ETCp.setupDequeueing = defs.setupDequeueing({
  ...
  deq: function deq(self$1, pxRatio, extent2) {
    return self$1.dequeue(pxRatio, extent2);
  },
  onDeqd: function onDeqd(self$1, deqd) {
    for (var i$1 = 0; i$1 < self$1.onDequeues.length; i$1++) {
      var fn$72 = self$1.onDequeues[i$1];
      fn$72(deqd);
    }
  },
  shouldRedraw: function shouldRedraw(self$1, deqd, pxRatio, extent2) {
    for (var i$1 = 0; i$1 < deqd.length; i$1++) {
      var eles = deqd[i$1].eles;
      for (var j = 0; j < eles.length; j++) if (boundingBoxesIntersect(eles[j].boundingBox(), extent2)) return true;
    }
    return false;
  },
...
var LayeredTextureCache = function LayeredTextureCache$1(renderer2) {
  var self$1 = this;
  var r = self$1.renderer = renderer2;
  var cy = r.cy;
...
LTCp.applyLayerReplacement = function(layer) {
  ...
  for (var i$1 = 0; i$1 < layer.eles.length; i$1++) {
    ...
    var cache$12 = _p.imgLayerCaches = _p.imgLayerCaches || {};
    if (cache$12) cache$12[layer.level] = layer;
  }
  self$1.requestRedraw();
};
...
LTCp.setupDequeueing = defs.setupDequeueing({
  ...
  deqNoDrawCost,
  deqFastCost,
  deq: function deq2(self$1, pxRatio) {
    return self$1.dequeue(pxRatio);
  },
  onDeqd: noop$1,
  shouldRedraw: trueify,
  priority: function priority2(self$1) {
...
CRp$a.drawCachedElementPortion = function(context, ele, eleTxrCache, pxRatio, lvl, reason, getRotation, getOpacity$12) {
  var r = this;
  var bb = eleTxrCache.getBoundingBox(ele);
  if (bb.w === 0 || bb.h === 0) return;
  var eleCache = eleTxrCache.getElement(ele, bb, pxRatio, lvl, reason);
  if (eleCache != null) {
    var opacity = getOpacity$12(r, ele);
    if (opacity === 0) return;
...
CRp$a.drawCachedElement = function(context, ele, pxRatio, extent2, lvl, requestHighQuality) {
  ...
  if (!extent2 || boundingBoxesIntersect(bb, extent2)) {
    ...
    if (!isEdge2 || !badLine) r.drawCachedElementPortion(context, ele, lblTxrCache, pxRatio, lvl, reason, getLabelRotation, getTextOpacity);
    if (isEdge2 && !badLine) {
...
CRp$a.drawLayeredElements = function(context, eles, pxRatio, extent2) {
  ...
  else r.drawCachedElements(context, eles, pxRatio, extent2);
};
var CRp$9 = {};
...
var drawEdgeOverlayUnderlay = function drawEdgeOverlayUnderlay$1(overlayOrUnderlay) {
  ...
  return function(context, edge) {
    ...
    var rs = edge._private.rscratch;
    var width2 = 2 * edge.pstyle("".concat(overlayOrUnderlay, "-padding")).pfValue;
...
CRp$9.drawArrowShape = function(edge, context, fill, edgeWidth, shape, shapeWidth, x$1, y$1, angle$1) {
  ...
  var scale$1 = edge.pstyle("arrow-scale").value;
  var size3 = this.getArrowWidth(edgeWidth, scale$1);
  var shapeImpl = r.arrowShapes[shape];
  if (usePaths) {
    var cache$12 = r.arrowPathCache = r.arrowPathCache || [];
    var key = hashString(shape);
    var cachedPath = cache$12[key];
    if (cachedPath != null) {
  ...
  if (!pathCacheHit) {
    ...
    else shapeImpl.draw(context, size3, angle$1, translation, edgeWidth);
    if (context.closePath) context.closePath();
  }
...
CRp$7.getFontCache = function(context) {
  ...
  for (var i$1 = 0; i$1 < this.fontCaches.length; i$1++) {
    cache$12 = this.fontCaches[i$1];
    if (cache$12.context === context) return cache$12;
  }
  cache$12 = { context };
  this.fontCaches.push(cache$12);
  return cache$12;
};
...
function circle(ctx, x$1, y$1, width2, height2) {
  var radius$1 = Math.min(width2, height2) / 2;
  var centerX = x$1 + width2 / 2;
  var centerY = y$1 + height2 / 2;
  ctx.beginPath();
  ctx.arc(centerX, centerY, radius$1, 0, Math.PI * 2);
  ctx.closePath();
}
function roundRect(ctx, x$1, y$1, width2, height2) {
  var radius$1 = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : 5;
  var r = Math.min(radius$1, width2 / 2, height2 / 2);
  ctx.beginPath();
  ctx.moveTo(x$1 + r, y$1);
  ctx.lineTo(x$1 + width2 - r, y$1);
  ctx.quadraticCurveTo(x$1 + width2, y$1, x$1 + width2, y$1 + r);
  ctx.lineTo(x$1 + width2, y$1 + height2 - r);
  ctx.quadraticCurveTo(x$1 + width2, y$1 + height2, x$1 + width2 - r, y$1 + height2);
  ctx.lineTo(x$1 + r, y$1 + height2);
  ctx.quadraticCurveTo(x$1, y$1 + height2, x$1, y$1 + height2 - r);
...
CRp$6.drawNode = function(context, node, shiftToOriginWithBb) {
  ...
  var getPath = function getPath$1(width2, height2, shape, points) {
...
CRp$6.drawPie = function(context, node, nodeOpacity, pos) {
  ...
  for (var i$1 = 1; i$1 <= cyStyle.pieBackgroundN; i$1++) {
    var size3 = node.pstyle("pie-" + i$1 + "-background-size").value;
    ...
    if (size3 === 0 || lastPercent >= 1 || lastPercent + percent > 1) continue;
    if (holeRadius === 0) {
      context.beginPath();
...
CRp$6.drawStripe = function(context, node, nodeOpacity, pos) {
  ...
  for (var i$1 = 1; i$1 <= cyStyle.stripeBackgroundN; i$1++) {
    var size3 = node.pstyle("stripe-" + i$1 + "-background-size").value;
...
CRp$5.createGradientStyleFor = function(context, shapeStyleName, ele, fill, opacity) {
  var gradientStyle;
  var usePaths = this.usePaths();
  var colors$1 = ele.pstyle(shapeStyleName + "-gradient-stop-colors").value, positions2 = ele.pstyle(shapeStyleName + "-gradient-stop-positions").pfValue;
  ...
  var hasPositions = positions2.length === colors$1.length;
  var length = colors$1.length;
  for (var i$1 = 0; i$1 < length; i$1++) gradientStyle.addColorStop(hasPositions ? positions2[i$1] : i$1 / (length - 1), "rgba(" + colors$1[i$1][0] + "," + colors$1[i$1][1] + "," + colors$1[i$1][2] + "," + opacity + ")");
...
CRp$5.matchCanvasSize = function(container2) {
  ...
  if (container2 === r.data.bufferCanvases[r.MOTIONBLUR_BUFFER_NODE] || container2 === r.data.bufferCanvases[r.MOTIONBLUR_BUFFER_DRAG]) pixelRatio = mbPxRatio;
  ...
  for (var i$1 = 0; i$1 < r.BUFFER_COUNT; i$1++) {
    canvas = data$23.bufferCanvases[i$1];
    canvas.width = canvasWidth;
    canvas.height = canvasHeight;
    canvas.style.width = width2 + "px";
    canvas.style.height = height2 + "px";
  ...
  r.textureMult = 1;
  if (pixelRatio <= 1) {
    canvas = data$23.bufferCanvases[r.TEXTURE_BUFFER];
    r.textureMult = 2;
...
CRp$5.clearCanvas = function() {
  ...
  clear(data$23.contexts[r.NODE]);
  clear(data$23.contexts[r.DRAG]);
};
CRp$5.render = function(options2) {
  ...
  var data$23 = r.data;
  var needDraw = data$23.canvasNeedsRedraw;
  ...
  if (!(prevVp === void 0 || vp.zoom !== prevVp.zoom || vp.pan.x !== prevVp.pan.x || vp.pan.y !== prevVp.pan.y) && !(inNodeDragGesture && !hasCompoundNodes2)) r.motionBlurPxRatio = 1;
  ...
  function setContextTransform$1(context$1, clear) {
    var ePan, eZoom, w, h;
    if (!r.clearingMotionBlur && (context$1 === data$23.bufferContexts[r.MOTIONBLUR_BUFFER_NODE] || context$1 === data$23.bufferContexts[r.MOTIONBLUR_BUFFER_DRAG])) {
      ePan = {
        x: pan2.x * mbPxRatio,
        y: pan2.y * mbPxRatio
      };
  ...
  if (textureDraw) {
    ...
    var context = data$23.contexts[r.NODE];
  ...
  if (needDraw[r.NODE] || drawAllLayers || drawOnlyNodeLayer || needMbClear[r.NODE]) {
    ...
    var context = forcedContext || (useBuffer ? r.data.bufferContexts[r.MOTIONBLUR_BUFFER_NODE] : data$23.contexts[r.NODE]);
    setContextTransform$1(context, motionBlur && !useBuffer ? "motionBlur" : void 0);
    if (hideEdges) r.drawCachedNodes(context, eles.nondrag, pixelRatio, extent2);
    else r.drawLayeredElements(context, eles.nondrag, pixelRatio, extent2);
  ...
  if (!drawOnlyNodeLayer && (needDraw[r.DRAG] || drawAllLayers || needMbClear[r.DRAG])) {
    ...
    var context = forcedContext || (useBuffer ? r.data.bufferContexts[r.MOTIONBLUR_BUFFER_DRAG] : data$23.contexts[r.DRAG]);
    setContextTransform$1(context, motionBlur && !useBuffer ? "motionBlur" : void 0);
    if (hideEdges) r.drawCachedNodes(context, eles.drag, pixelRatio, extent2);
    else r.drawCachedElements(context, eles.drag, pixelRatio, extent2);
    if (r.debug) r.drawDebugPoints(context, eles.drag);
    if (!drawAllLayers && !motionBlur) needDraw[r.DRAG] = false;
  }
  this.drawSelectionRectangle(options2, setContextTransform$1);
  if (motionBlur && mbPxRatio !== 1) {
    var cxtNode = data$23.contexts[r.NODE];
    var txtNode = r.data.bufferCanvases[r.MOTIONBLUR_BUFFER_NODE];
    var cxtDrag = data$23.contexts[r.DRAG];
...
var fpsHeight;
CRp$5.drawSelectionRectangle = function(options2, setContextTransform$1) {
  var r = this;
  var cy = r.cy;
  var data$23 = r.data;
  var style3 = cy.style();
  ...
  if (r.showFps || !drawOnlyNodeLayer && needDraw[r.SELECT_BOX] && !drawAllLayers) {
    var context = forcedContext || data$23.contexts[r.SELECT_BOX];
    ...
    if (data$23.bgActivePosistion && !r.hoverData.selecting) {
      var zoom2 = r.cy.zoom();
      var pos = data$23.bgActivePosistion;
...
function createTextureCanvas(r, width2, height2) {
  if (height2 === void 0) height2 = width2;
...
function modelToRenderedPosition(r, pan2, zoom2, x$1, y$1) {
  var rx = x$1 * zoom2 + pan2.x;
  var ry = y$1 * zoom2 + pan2.y;
...
function createTypedArrayView(gl, glType, array$12, stride, size3, i$1) {
  switch (glType) {
    case gl.FLOAT:
      return new Float32Array(array$12.buffer, i$1 * stride, size3);
    case gl.INT:
      return new Int32Array(array$12.buffer, i$1 * stride, size3);
  }
}
function createBufferStaticDraw(gl, type, attributeLoc, dataArray) {
  var _getTypeInfo2 = _slicedToArray(getTypeInfo(gl, type), 2), size3 = _getTypeInfo2[0], glType = _getTypeInfo2[1];
  var data$23 = createTypedArray(gl, glType, dataArray);
  var buffer = gl.createBuffer();
  gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
  gl.bufferData(gl.ARRAY_BUFFER, data$23, gl.STATIC_DRAW);
  if (glType === gl.FLOAT) gl.vertexAttribPointer(attributeLoc, size3, glType, false, 0, 0);
  else if (glType === gl.INT) gl.vertexAttribIPointer(attributeLoc, size3, glType, 0, 0);
  gl.enableVertexAttribArray(attributeLoc);
  gl.bindBuffer(gl.ARRAY_BUFFER, null);
  return buffer;
}
function createBufferDynamicDraw(gl, instances, type, attributeLoc) {
  var _getTypeInfo4 = _slicedToArray(getTypeInfo(gl, type), 3), size3 = _getTypeInfo4[0], glType = _getTypeInfo4[1], bytes = _getTypeInfo4[2];
  ...
  gl.enableVertexAttribArray(attributeLoc);
  if (glType === gl.FLOAT) gl.vertexAttribPointer(attributeLoc, size3, glType, false, stride, 0);
  else if (glType === gl.INT) gl.vertexAttribIPointer(attributeLoc, size3, glType, stride, 0);
  gl.vertexAttribDivisor(attributeLoc, 1);
  gl.bindBuffer(gl.ARRAY_BUFFER, null);
  var views = new Array(instances);
  for (var i$1 = 0; i$1 < instances; i$1++) views[i$1] = createTypedArrayView(gl, glType, dataArray, stride, size3, i$1);
  ...
  buffer.bufferSubData = function(count) {
    gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
    if (count) gl.bufferSubData(gl.ARRAY_BUFFER, 0, dataArray, 0, count * size3);
  ...
  return _createClass(AtlasManager$1, [
    ...
    },
    {
      ...
      value: function addRenderType(type, renderTypeOptions) {
        var collection$13 = renderTypeOptions.collection;
        if (!this.collections.has(collection$13)) throw new Error("invalid atlas collection name '".concat(collection$13, "'"));
        var opts = extend({
          type,
          atlasCollection: this.collections.get(collection$13)
        }, renderTypeOptions);
  ...
  return _createClass(ElementDrawingWebGL$1, [
    ...
    },
    {
      ...
      value: function drawEdgeArrow(edge, eleIndex, prefix) {
        ...
        identity(transform7);
        translate(transform7, transform7, [x$1, y$1]);
        scale(transform7, transform7, [size3, size3]);
        rotate(transform7, transform7, angle$1);
    ...
    },
    {
      ...
      value: function _getEdgePoints(edge) {
        ...
        var controlPoints2 = rs.allpts;
        if (controlPoints2.length == 4) return controlPoints2;
        var numSegments = this._getNumSegments(edge);
        return this._getCurveSegmentPoints(controlPoints2, numSegments);
      }
    },
    {
      key: "_getNumSegments",
    ...
    },
    {
      ...
      value: function _getCurveSegmentPoints(controlPoints2, segments) {
        if (controlPoints2.length == 4) return controlPoints2;
        var curvePoints = Array((segments + 1) * 2);
        for (var i$1 = 0; i$1 <= segments; i$1++) if (i$1 == 0) {
          curvePoints[0] = controlPoints2[0];
          curvePoints[1] = controlPoints2[1];
        } else if (i$1 == segments) {
          curvePoints[i$1 * 2] = controlPoints2[controlPoints2.length - 2];
          curvePoints[i$1 * 2 + 1] = controlPoints2[controlPoints2.length - 1];
        } else {
          var t = i$1 / segments;
          this._setCurvePoint(controlPoints2, t, curvePoints, i$1 * 2);
        }
        return curvePoints;
      }
    },
...
CRp$4.initWebgl = function(opts, fns) {
  ...
  var getLabelRotation$12 = function getLabelRotation$2(prop) {
    return function(ele) {
  ...
  r.drawing.addTextureAtlasRenderType("label", {
    ...
    getRotation: getLabelRotation$12(null),
  ...
  r.drawing.addTextureAtlasRenderType("edge-source-label", {
    ...
    getRotation: getLabelRotation$12("source"),
  ...
  r.drawing.addTextureAtlasRenderType("edge-target-label", {
    ...
    getRotation: getLabelRotation$12("target"),
...
function getBGColor(r) {
  ...
  return color2tuple(container2 && container2.style && container2.style.backgroundColor || "white");
}
function getLabelLines(ele, prefix) {
  var rs = ele._private.rscratch;
  return getPrefixedProperty(rs, "labelWrapCachedLines", prefix) || [];
}
var getStyleKeysForLabel = function getStyleKeysForLabel$1(getKey$12, prefix) {
  return function(ele) {
    var key = getKey$12(ele);
...
function drawAtlases(r) {
  var draw = function draw$1(drawing, name, row) {
    var collection$13 = drawing.atlasManager.getAtlasCollection(name);
    var context = r.data.contexts[r.NODE];
    var atlases = collection$13.atlases;
...
function getPickingIndexes(r, mX1, mY1, mX2, mY2) {
  ...
  var _util$modelToRendered2 = _slicedToArray(modelToRenderedPosition(r, pan2, zoom2, mX1, mY1), 2), cX1 = _util$modelToRendered2[0], cY1 = _util$modelToRendered2[1];
  var t = 6;
  x$1 = cX1 - t / 2;
  y$1 = cY1 - t / 2;
  w = t;
  ...
  var n = w * h;
  var data$23 = new Uint8Array(n * 4);
  gl.readPixels(x$1, y$1, w, h, gl.RGBA, gl.UNSIGNED_BYTE, data$23);
  gl.bindFramebuffer(gl.FRAMEBUFFER, null);
  var indexes = /* @__PURE__ */ new Set();
  for (var i$1 = 0; i$1 < n; i$1++) {
    var index = vec4ToIndex(data$23.slice(i$1 * 4, i$1 * 4 + 4)) - 1;
...
function renderWebgl(r, options2, renderTarget) {
  ...
  if (renderTarget.screen) {
    if (r.data.canvasNeedsRedraw[r.SELECT_BOX]) drawSelectionRectangle(r, options2);
  }
  ...
  if (r.webglDebug) {
    ...
    if (compact) console.log("WebGL (".concat(renderTarget.name, ") - time ").concat(time2, "ms, ").concat(report));
    else {
...
var CRp$3 = {};
CRp$3.drawPolygonPath = function(context, x$1, y$1, width2, height2, points) {
  var halfW = width2 / 2;
  var halfH = height2 / 2;
  if (context.beginPath) context.beginPath();
...
CRp$3.drawRoundPolygonPath = function(context, x$1, y$1, width2, height2, points, corners) {
  corners.forEach(function(corner) {
    return drawPreparedRoundCorner(context, corner);
  });
  context.closePath();
};
CRp$3.drawRoundRectanglePath = function(context, x$1, y$1, width2, height2, radius$1) {
  var halfWidth = width2 / 2;
  var halfHeight = height2 / 2;
  var cornerRadius = radius$1 === "auto" ? getRoundRectangleRadius(width2, height2) : Math.min(radius$1, halfHeight, halfWidth);
  if (context.beginPath) context.beginPath();
...
CRp$3.drawBottomRoundRectanglePath = function(context, x$1, y$1, width2, height2, radius$1) {
  var halfWidth = width2 / 2;
  var halfHeight = height2 / 2;
  var cornerRadius = radius$1 === "auto" ? getRoundRectangleRadius(width2, height2) : radius$1;
  if (context.beginPath) context.beginPath();
...
CRp$3.drawCutRectanglePath = function(context, x$1, y$1, width2, height2, points, corners) {
  var halfWidth = width2 / 2;
  var halfHeight = height2 / 2;
...
CRp$3.drawBarrelPath = function(context, x$1, y$1, width2, height2) {
  var halfWidth = width2 / 2;
  var halfHeight = height2 / 2;
...
CRp$3.drawEllipsePath = function(context, centerX, centerY, width2, height2) {
  if (context.beginPath) context.beginPath();
  if (context.ellipse) context.ellipse(centerX, centerY, width2 / 2, height2 / 2, 0, 0, 2 * Math.PI);
  else {
    var xPos, yPos;
    var rw = width2 / 2;
    var rh = height2 / 2;
...
CRp$2.bufferCanvasImage = function(options2) {
  ...
  if (options2.scale !== void 0) {
    ...
    scale$1 = options2.scale;
  } else if (specdMaxDims) {
    var maxScaleW = Infinity;
    var maxScaleH = Infinity;
    if (number$1(options2.maxWidth)) maxScaleW = scale$1 * options2.maxWidth / width2;
    if (number$1(options2.maxHeight)) maxScaleH = scale$1 * options2.maxHeight / height2;
      ...
      return new Promise$1(function(resolve2, reject2) {
        try {
          canvas.toBlob(function(blob) {
            if (blob != null) resolve2(blob);
            else reject2(/* @__PURE__ */ new Error("`canvas.toBlob()` sent a null value in its callback"));
...
function CanvasRenderer(options2) {
  ...
  if (options2.webgl) r.initWebgl(options2, {
    getStyleKey,
    getLabelKey,
    getSourceLabelKey,
    getTargetLabelKey,
...
CRp.path2dEnabled = function(on3) {
  if (on3 === void 0) return this.pathsEnabled;
...
CRp.makeOffscreenCanvas = function(width2, height2) {
  var canvas;
  if ((typeof OffscreenCanvas === "undefined" ? "undefined" : _typeof(OffscreenCanvas)) !== "undefined") canvas = new OffscreenCanvas(width2, height2);
  else {
...
function setExtension(type, name, registrant) {
  ...
  if (type === "core") if (Core.prototype[name]) return overrideErr(name);
    ...
    var Layout = function Layout$1(options2) {
      this.options = options2;
    ...
    var getCy = function getCy$1(layout$13) {
      return layout$13._private.cy;
    };
    var emitterOpts = {
      addEventFields: function addEventFields4(layout$13, evt) {
        evt.layout = layout$13;
        evt.cy = getCy(layout$13);
        evt.target = layout$13;
      },
      bubble: function bubble3() {
        return true;
      },
      parent: function parent4(layout$13) {
        return getCy(layout$13);
      }
    };
    extend(layoutProto, {
...
var version = "3.33.1";
var cytoscape = function cytoscape$1(options2) {
  if (options2 === void 0) options2 = {};
  if (plainObject(options2)) return new Core(options2);
  else if (string(options2)) return extension.apply(extension, arguments);
};
