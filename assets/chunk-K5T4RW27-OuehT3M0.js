...
import { $n as e, Qn as t, er as n, nr as r, rr as i, t as a, tr as o } from "./index-4Ava25sD.js";
import { a as s, c, d as l, n as u, s as d, t as f } from "./reduce-BYgg84dj.js";
import { a as p, n as m, t as h } from "./flatten-COzv_UkG.js";
function g(e6) {
...
var ae = n({ assignMandatoryProperties: () => pe, copyAstNode: () => he, findRootNode: () => le, getContainerOfType: () => se, getDocument: () => O, getReferenceNodes: () => k, hasContainerOfType: () => ce, linkContentToContainer: () => oe, streamAllContents: () => A, streamAst: () => j, streamContents: () => ue, streamReferences: () => fe });
function oe(e6, t2 = {}) {
...
}, Qn = n({ NEWLINE_REGEXP: () => $n, escapeRegExp: () => or, getTerminalParts: () => nr, isMultilineComment: () => rr, isWhitespace: () => ar, partialMatches: () => sr, partialRegExp: () => cr, whitespaceCharacters: () => ir });
const $n = /\r?\n/gm;
...
var RO = class {
  ...
  buildLookaheadForOptional(e6) {
    let { prodOccurrence: t2, rule: n2, prodType: r2, dynamicTokensEnabled: i2 } = e6, o2 = this.dfas, s2 = this.logging, c2 = tO(n2, r2, t2), l2 = this.atn.decisionMap[c2].decision, d2 = p(dE({ maxLookahead: 1, occurrence: t2, prodType: r2, rule: n2 }), (e7) => p(e7, (e8) => e8[0]));
    if (VO(d2) && d2[0][0] && !i2) {
      let e7 = d2[0], t3 = h(e7);
      if (t3.length === 1 && a(t3[0].categoryMatches)) {
    ...
    return function() {
      let e7 = UO.call(this, o2, l2, zO, s2);
...
`)), t3) {
  ...
  Object.defineProperty(e6, `__esModule`, { value: true }), e6.DidCloseNotebookDocumentNotification = e6.DidSaveNotebookDocumentNotification = e6.DidChangeNotebookDocumentNotification = e6.NotebookCellArrayChange = e6.DidOpenNotebookDocumentNotification = e6.NotebookDocumentSyncRegistrationType = e6.NotebookDocument = e6.NotebookCell = e6.ExecutionSummary = e6.NotebookCellKind = void 0;
  var t2 = (VA(), r(fk)), n2 = QM(), i2 = Q(), a2;
  (function(e7) {
    e7.Markup = 1, e7.Code = 2;
    function t3(e8) {
      return e8 === 1 || e8 === 2;
    }
    e7.is = t3;
  })(a2 || (e6.NotebookCellKind = a2 = {}));
  var o2;
  (function(e7) {
    function r2(e8, t3) {
      let n3 = { executionOrder: e8 };
      return (t3 === true || t3 === false) && (n3.success = t3), n3;
    }
    e7.create = r2;
    function i3(e8) {
      let r3 = e8;
      return n2.objectLiteral(r3) && t2.uinteger.is(r3.executionOrder) && (r3.success === void 0 || n2.boolean(r3.success));
    }
    e7.is = i3;
    function a3(e8, t3) {
      return e8 === t3 ? true : e8 == null || t3 == null ? false : e8.executionOrder === t3.executionOrder && e8.success === t3.success;
    }
    e7.equals = a3;
  })(o2 || (e6.ExecutionSummary = o2 = {}));
  var s2;
  (function(e7) {
    function r2(e8, t3) {
      return { kind: e8, document: t3 };
    }
    e7.create = r2;
    function i3(e8) {
      let r3 = e8;
      return n2.objectLiteral(r3) && a2.is(r3.kind) && t2.DocumentUri.is(r3.document) && (r3.metadata === void 0 || n2.objectLiteral(r3.metadata));
    }
    e7.is = i3;
    function s3(e8, t3) {
      let n3 = /* @__PURE__ */ new Set();
      return e8.document !== t3.document && n3.add(`document`), e8.kind !== t3.kind && n3.add(`kind`), e8.executionSummary !== t3.executionSummary && n3.add(`executionSummary`), (e8.metadata !== void 0 || t3.metadata !== void 0) && !c3(e8.metadata, t3.metadata) && n3.add(`metadata`), (e8.executionSummary !== void 0 || t3.executionSummary !== void 0) && !o2.equals(e8.executionSummary, t3.executionSummary) && n3.add(`executionSummary`), n3;
    }
    e7.diff = s3;
    function c3(e8, t3) {
      if (e8 === t3) return true;
      if (e8 == null || t3 == null || typeof e8 != typeof t3 || typeof e8 != `object`) return false;
      let r3 = Array.isArray(e8), i4 = Array.isArray(t3);
      if (r3 !== i4) return false;
      if (r3 && i4) {
        if (e8.length !== t3.length) return false;
        for (let n3 = 0; n3 < e8.length; n3++) if (!c3(e8[n3], t3[n3])) return false;
      }
      if (n2.objectLiteral(e8) && n2.objectLiteral(t3)) {
        let n3 = Object.keys(e8), r4 = Object.keys(t3);
        if (n3.length !== r4.length || (n3.sort(), r4.sort(), !c3(n3, r4))) return false;
        for (let r5 = 0; r5 < n3.length; r5++) {
          let i5 = n3[r5];
          if (!c3(e8[i5], t3[i5])) return false;
        }
      }
      return true;
    }
  })(s2 || (e6.NotebookCell = s2 = {}));
  var c2;
  (function(e7) {
    function r2(e8, t3, n3, r3) {
      return { uri: e8, notebookType: t3, version: n3, cells: r3 };
    }
    e7.create = r2;
    function i3(e8) {
      let r3 = e8;
      return n2.objectLiteral(r3) && n2.string(r3.uri) && t2.integer.is(r3.version) && n2.typedArray(r3.cells, s2.is);
    }
    e7.is = i3;
  })(c2 || (e6.NotebookDocument = c2 = {}));
  var l2;
  (function(e7) {
    e7.method = `notebookDocument/sync`, e7.messageDirection = i2.MessageDirection.clientToServer, e7.type = new i2.RegistrationType(e7.method);
  })(l2 || (e6.NotebookDocumentSyncRegistrationType = l2 = {}));
  var u2;
  (function(e7) {
    e7.method = `notebookDocument/didOpen`, e7.messageDirection = i2.MessageDirection.clientToServer, e7.type = new i2.ProtocolNotificationType(e7.method), e7.registrationMethod = l2.method;
  })(u2 || (e6.DidOpenNotebookDocumentNotification = u2 = {}));
  var d2;
  (function(e7) {
    function r2(e8) {
      let r3 = e8;
      return n2.objectLiteral(r3) && t2.uinteger.is(r3.start) && t2.uinteger.is(r3.deleteCount) && (r3.cells === void 0 || n2.typedArray(r3.cells, s2.is));
    }
    e7.is = r2;
    function i3(e8, t3, n3) {
      let r3 = { start: e8, deleteCount: t3 };
      return n3 !== void 0 && (r3.cells = n3), r3;
    }
    e7.create = i3;
  })(d2 || (e6.NotebookCellArrayChange = d2 = {}));
  var f2;
  (function(e7) {
    e7.method = `notebookDocument/didChange`, e7.messageDirection = i2.MessageDirection.clientToServer, e7.type = new i2.ProtocolNotificationType(e7.method), e7.registrationMethod = l2.method;
  })(f2 || (e6.DidChangeNotebookDocumentNotification = f2 = {}));
  var p2;
  (function(e7) {
    e7.method = `notebookDocument/didSave`, e7.messageDirection = i2.MessageDirection.clientToServer, e7.type = new i2.ProtocolNotificationType(e7.method), e7.registrationMethod = l2.method;
  })(p2 || (e6.DidSaveNotebookDocumentNotification = p2 = {}));
  var m2;
  (function(e7) {
    e7.method = `notebookDocument/didClose`, e7.messageDirection = i2.MessageDirection.clientToServer, e7.type = new i2.ProtocolNotificationType(e7.method), e7.registrationMethod = l2.method;
  })(m2 || (e6.DidCloseNotebookDocumentNotification = m2 = {}));
})), yN = t(((e6) => {
  ...
  Object.defineProperty(e6, `__esModule`, { value: true }), e6.WorkspaceSymbolRequest = e6.CodeActionResolveRequest = e6.CodeActionRequest = e6.DocumentSymbolRequest = e6.DocumentHighlightRequest = e6.ReferencesRequest = e6.DefinitionRequest = e6.SignatureHelpRequest = e6.SignatureHelpTriggerKind = e6.HoverRequest = e6.CompletionResolveRequest = e6.CompletionRequest = e6.CompletionTriggerKind = e6.PublishDiagnosticsNotification = e6.WatchKind = e6.RelativePattern = e6.FileChangeType = e6.DidChangeWatchedFilesNotification = e6.WillSaveTextDocumentWaitUntilRequest = e6.WillSaveTextDocumentNotification = e6.TextDocumentSaveReason = e6.DidSaveTextDocumentNotification = e6.DidCloseTextDocumentNotification = e6.DidChangeTextDocumentNotification = e6.TextDocumentContentChangeEvent = e6.DidOpenTextDocumentNotification = e6.TextDocumentSyncKind = e6.TelemetryEventNotification = e6.LogMessageNotification = e6.ShowMessageRequest = e6.ShowMessageNotification = e6.MessageType = e6.DidChangeConfigurationNotification = e6.ExitNotification = e6.ShutdownRequest = e6.InitializedNotification = e6.InitializeErrorCodes = e6.InitializeRequest = e6.WorkDoneProgressOptions = e6.TextDocumentRegistrationOptions = e6.StaticRegistrationOptions = e6.PositionEncodingKind = e6.FailureHandlingKind = e6.ResourceOperationKind = e6.UnregistrationRequest = e6.RegistrationRequest = e6.DocumentSelector = e6.NotebookCellTextDocumentFilter = e6.NotebookDocumentFilter = e6.TextDocumentFilter = void 0, e6.MonikerRequest = e6.MonikerKind = e6.UniquenessLevel = e6.WillDeleteFilesRequest = e6.DidDeleteFilesNotification = e6.WillRenameFilesRequest = e6.DidRenameFilesNotification = e6.WillCreateFilesRequest = e6.DidCreateFilesNotification = e6.FileOperationPatternKind = e6.LinkedEditingRangeRequest = e6.ShowDocumentRequest = e6.SemanticTokensRegistrationType = e6.SemanticTokensRefreshRequest = e6.SemanticTokensRangeRequest = e6.SemanticTokensDeltaRequest = e6.SemanticTokensRequest = e6.TokenFormat = e6.CallHierarchyPrepareRequest = e6.CallHierarchyOutgoingCallsRequest = e6.CallHierarchyIncomingCallsRequest = e6.WorkDoneProgressCancelNotification = e6.WorkDoneProgressCreateRequest = e6.WorkDoneProgress = e6.SelectionRangeRequest = e6.DeclarationRequest = e6.FoldingRangeRefreshRequest = e6.FoldingRangeRequest = e6.ColorPresentationRequest = e6.DocumentColorRequest = e6.ConfigurationRequest = e6.DidChangeWorkspaceFoldersNotification = e6.WorkspaceFoldersRequest = e6.TypeDefinitionRequest = e6.ImplementationRequest = e6.ApplyWorkspaceEditRequest = e6.ExecuteCommandRequest = e6.PrepareRenameRequest = e6.RenameRequest = e6.PrepareSupportDefaultBehavior = e6.DocumentOnTypeFormattingRequest = e6.DocumentRangesFormattingRequest = e6.DocumentRangeFormattingRequest = e6.DocumentFormattingRequest = e6.DocumentLinkResolveRequest = e6.DocumentLinkRequest = e6.CodeLensRefreshRequest = e6.CodeLensResolveRequest = e6.CodeLensRequest = e6.WorkspaceSymbolResolveRequest = void 0, e6.InlineCompletionRequest = e6.DidCloseNotebookDocumentNotification = e6.DidSaveNotebookDocumentNotification = e6.DidChangeNotebookDocumentNotification = e6.NotebookCellArrayChange = e6.DidOpenNotebookDocumentNotification = e6.NotebookDocumentSyncRegistrationType = e6.NotebookDocument = e6.NotebookCell = e6.ExecutionSummary = e6.NotebookCellKind = e6.DiagnosticRefreshRequest = e6.WorkspaceDiagnosticRequest = e6.DocumentDiagnosticRequest = e6.DocumentDiagnosticReportKind = e6.DiagnosticServerCancellationData = e6.InlayHintRefreshRequest = e6.InlayHintResolveRequest = e6.InlayHintRequest = e6.InlineValueRefreshRequest = e6.InlineValueRequest = e6.TypeHierarchySupertypesRequest = e6.TypeHierarchySubtypesRequest = e6.TypeHierarchyPrepareRequest = void 0;
  var t2 = Q(), n2 = (VA(), r(fk)), i2 = QM(), a2 = $M();
  Object.defineProperty(e6, `ImplementationRequest`, { enumerable: true, get: function() {
    return a2.ImplementationRequest;
  } });
  var o2 = eN();
  Object.defineProperty(e6, `TypeDefinitionRequest`, { enumerable: true, get: function() {
    return o2.TypeDefinitionRequest;
  } });
  var s2 = tN();
  Object.defineProperty(e6, `WorkspaceFoldersRequest`, { enumerable: true, get: function() {
    return s2.WorkspaceFoldersRequest;
  } }), Object.defineProperty(e6, `DidChangeWorkspaceFoldersNotification`, { enumerable: true, get: function() {
    return s2.DidChangeWorkspaceFoldersNotification;
  } });
  var c2 = nN();
  Object.defineProperty(e6, `ConfigurationRequest`, { enumerable: true, get: function() {
    return c2.ConfigurationRequest;
  } });
  var l2 = rN();
  Object.defineProperty(e6, `DocumentColorRequest`, { enumerable: true, get: function() {
    return l2.DocumentColorRequest;
  } }), Object.defineProperty(e6, `ColorPresentationRequest`, { enumerable: true, get: function() {
    return l2.ColorPresentationRequest;
  } });
  var u2 = iN();
  Object.defineProperty(e6, `FoldingRangeRequest`, { enumerable: true, get: function() {
    return u2.FoldingRangeRequest;
  } }), Object.defineProperty(e6, `FoldingRangeRefreshRequest`, { enumerable: true, get: function() {
    return u2.FoldingRangeRefreshRequest;
  } });
  var d2 = aN();
  Object.defineProperty(e6, `DeclarationRequest`, { enumerable: true, get: function() {
    return d2.DeclarationRequest;
  } });
  var f2 = oN();
  Object.defineProperty(e6, `SelectionRangeRequest`, { enumerable: true, get: function() {
    return f2.SelectionRangeRequest;
  } });
  var p2 = sN();
  Object.defineProperty(e6, `WorkDoneProgress`, { enumerable: true, get: function() {
    return p2.WorkDoneProgress;
  } }), Object.defineProperty(e6, `WorkDoneProgressCreateRequest`, { enumerable: true, get: function() {
    return p2.WorkDoneProgressCreateRequest;
  } }), Object.defineProperty(e6, `WorkDoneProgressCancelNotification`, { enumerable: true, get: function() {
    return p2.WorkDoneProgressCancelNotification;
  } });
  var m2 = cN();
  Object.defineProperty(e6, `CallHierarchyIncomingCallsRequest`, { enumerable: true, get: function() {
    return m2.CallHierarchyIncomingCallsRequest;
  } }), Object.defineProperty(e6, `CallHierarchyOutgoingCallsRequest`, { enumerable: true, get: function() {
    return m2.CallHierarchyOutgoingCallsRequest;
  } }), Object.defineProperty(e6, `CallHierarchyPrepareRequest`, { enumerable: true, get: function() {
    return m2.CallHierarchyPrepareRequest;
  } });
  var h2 = lN();
  Object.defineProperty(e6, `TokenFormat`, { enumerable: true, get: function() {
    return h2.TokenFormat;
  } }), Object.defineProperty(e6, `SemanticTokensRequest`, { enumerable: true, get: function() {
    return h2.SemanticTokensRequest;
  } }), Object.defineProperty(e6, `SemanticTokensDeltaRequest`, { enumerable: true, get: function() {
    return h2.SemanticTokensDeltaRequest;
  } }), Object.defineProperty(e6, `SemanticTokensRangeRequest`, { enumerable: true, get: function() {
    return h2.SemanticTokensRangeRequest;
  } }), Object.defineProperty(e6, `SemanticTokensRefreshRequest`, { enumerable: true, get: function() {
    return h2.SemanticTokensRefreshRequest;
  } }), Object.defineProperty(e6, `SemanticTokensRegistrationType`, { enumerable: true, get: function() {
    return h2.SemanticTokensRegistrationType;
  } });
  var g2 = uN();
  Object.defineProperty(e6, `ShowDocumentRequest`, { enumerable: true, get: function() {
    return g2.ShowDocumentRequest;
  } });
  var _2 = dN();
  Object.defineProperty(e6, `LinkedEditingRangeRequest`, { enumerable: true, get: function() {
    return _2.LinkedEditingRangeRequest;
  } });
  var v2 = fN();
  Object.defineProperty(e6, `FileOperationPatternKind`, { enumerable: true, get: function() {
    return v2.FileOperationPatternKind;
  } }), Object.defineProperty(e6, `DidCreateFilesNotification`, { enumerable: true, get: function() {
    return v2.DidCreateFilesNotification;
  } }), Object.defineProperty(e6, `WillCreateFilesRequest`, { enumerable: true, get: function() {
    return v2.WillCreateFilesRequest;
  } }), Object.defineProperty(e6, `DidRenameFilesNotification`, { enumerable: true, get: function() {
    return v2.DidRenameFilesNotification;
  } }), Object.defineProperty(e6, `WillRenameFilesRequest`, { enumerable: true, get: function() {
    return v2.WillRenameFilesRequest;
  } }), Object.defineProperty(e6, `DidDeleteFilesNotification`, { enumerable: true, get: function() {
    return v2.DidDeleteFilesNotification;
  } }), Object.defineProperty(e6, `WillDeleteFilesRequest`, { enumerable: true, get: function() {
    return v2.WillDeleteFilesRequest;
  } });
  var y2 = pN();
  Object.defineProperty(e6, `UniquenessLevel`, { enumerable: true, get: function() {
    return y2.UniquenessLevel;
  } }), Object.defineProperty(e6, `MonikerKind`, { enumerable: true, get: function() {
    return y2.MonikerKind;
  } }), Object.defineProperty(e6, `MonikerRequest`, { enumerable: true, get: function() {
    return y2.MonikerRequest;
  } });
  var b2 = mN();
  Object.defineProperty(e6, `TypeHierarchyPrepareRequest`, { enumerable: true, get: function() {
    return b2.TypeHierarchyPrepareRequest;
  } }), Object.defineProperty(e6, `TypeHierarchySubtypesRequest`, { enumerable: true, get: function() {
    return b2.TypeHierarchySubtypesRequest;
  } }), Object.defineProperty(e6, `TypeHierarchySupertypesRequest`, { enumerable: true, get: function() {
    return b2.TypeHierarchySupertypesRequest;
  } });
  var x2 = hN();
  Object.defineProperty(e6, `InlineValueRequest`, { enumerable: true, get: function() {
    return x2.InlineValueRequest;
  } }), Object.defineProperty(e6, `InlineValueRefreshRequest`, { enumerable: true, get: function() {
    return x2.InlineValueRefreshRequest;
  } });
  var S2 = gN();
  Object.defineProperty(e6, `InlayHintRequest`, { enumerable: true, get: function() {
    return S2.InlayHintRequest;
  } }), Object.defineProperty(e6, `InlayHintResolveRequest`, { enumerable: true, get: function() {
    return S2.InlayHintResolveRequest;
  } }), Object.defineProperty(e6, `InlayHintRefreshRequest`, { enumerable: true, get: function() {
    return S2.InlayHintRefreshRequest;
  } });
  var C2 = _N();
  Object.defineProperty(e6, `DiagnosticServerCancellationData`, { enumerable: true, get: function() {
    return C2.DiagnosticServerCancellationData;
  } }), Object.defineProperty(e6, `DocumentDiagnosticReportKind`, { enumerable: true, get: function() {
    return C2.DocumentDiagnosticReportKind;
  } }), Object.defineProperty(e6, `DocumentDiagnosticRequest`, { enumerable: true, get: function() {
    return C2.DocumentDiagnosticRequest;
  } }), Object.defineProperty(e6, `WorkspaceDiagnosticRequest`, { enumerable: true, get: function() {
    return C2.WorkspaceDiagnosticRequest;
  } }), Object.defineProperty(e6, `DiagnosticRefreshRequest`, { enumerable: true, get: function() {
    return C2.DiagnosticRefreshRequest;
  } });
  var w2 = vN();
  Object.defineProperty(e6, `NotebookCellKind`, { enumerable: true, get: function() {
    return w2.NotebookCellKind;
  } }), Object.defineProperty(e6, `ExecutionSummary`, { enumerable: true, get: function() {
    return w2.ExecutionSummary;
  } }), Object.defineProperty(e6, `NotebookCell`, { enumerable: true, get: function() {
    return w2.NotebookCell;
  } }), Object.defineProperty(e6, `NotebookDocument`, { enumerable: true, get: function() {
    return w2.NotebookDocument;
  } }), Object.defineProperty(e6, `NotebookDocumentSyncRegistrationType`, { enumerable: true, get: function() {
    return w2.NotebookDocumentSyncRegistrationType;
  } }), Object.defineProperty(e6, `DidOpenNotebookDocumentNotification`, { enumerable: true, get: function() {
    return w2.DidOpenNotebookDocumentNotification;
  } }), Object.defineProperty(e6, `NotebookCellArrayChange`, { enumerable: true, get: function() {
    return w2.NotebookCellArrayChange;
  } }), Object.defineProperty(e6, `DidChangeNotebookDocumentNotification`, { enumerable: true, get: function() {
    return w2.DidChangeNotebookDocumentNotification;
  } }), Object.defineProperty(e6, `DidSaveNotebookDocumentNotification`, { enumerable: true, get: function() {
    return w2.DidSaveNotebookDocumentNotification;
  } }), Object.defineProperty(e6, `DidCloseNotebookDocumentNotification`, { enumerable: true, get: function() {
    return w2.DidCloseNotebookDocumentNotification;
  } });
  var T2 = yN();
  Object.defineProperty(e6, `InlineCompletionRequest`, { enumerable: true, get: function() {
  ...
  (function(e7) {
    ...
    e7.is = t3;
  })(te2 || (e6.NotebookDocumentFilter = te2 = {}));
  var ne2;
  (function(e7) {
    function t3(e8) {
      let t4 = e8;
    ...
    e7.is = t3;
  })(ne2 || (e6.NotebookCellTextDocumentFilter = ne2 = {}));
  var E2;
  (function(e7) {
    function t3(e8) {
      if (!Array.isArray(e8)) return false;
      for (let t4 of e8) if (!i2.string(t4) && !ee2.is(t4) && !ne2.is(t4)) return false;
      return true;
    }
    e7.is = t3;
  })(E2 || (e6.DocumentSelector = E2 = {}));
  var D2;
  (function(e7) {
    e7.method = `client/registerCapability`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolRequestType(e7.method);
  })(D2 || (e6.RegistrationRequest = D2 = {}));
  var re2;
  (function(e7) {
    e7.method = `client/unregisterCapability`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolRequestType(e7.method);
  })(re2 || (e6.UnregistrationRequest = re2 = {}));
  var ie2;
  (function(e7) {
    e7.Create = `create`, e7.Rename = `rename`, e7.Delete = `delete`;
  })(ie2 || (e6.ResourceOperationKind = ie2 = {}));
  var ae2;
  (function(e7) {
    e7.Abort = `abort`, e7.Transactional = `transactional`, e7.TextOnlyTransactional = `textOnlyTransactional`, e7.Undo = `undo`;
  })(ae2 || (e6.FailureHandlingKind = ae2 = {}));
  var oe2;
  (function(e7) {
    e7.UTF8 = `utf-8`, e7.UTF16 = `utf-16`, e7.UTF32 = `utf-32`;
  })(oe2 || (e6.PositionEncodingKind = oe2 = {}));
  var se2;
  (function(e7) {
    function t3(e8) {
      let t4 = e8;
    ...
    e7.hasId = t3;
  })(se2 || (e6.StaticRegistrationOptions = se2 = {}));
  var ce2;
  (function(e7) {
    function t3(e8) {
      let t4 = e8;
    ...
    e7.is = t3;
  })(ce2 || (e6.TextDocumentRegistrationOptions = ce2 = {}));
  var O2;
  (function(e7) {
    function t3(e8) {
      let t4 = e8;
    ...
    e7.hasWorkDoneProgress = n3;
  })(O2 || (e6.WorkDoneProgressOptions = O2 = {}));
  var le2;
  (function(e7) {
    e7.method = `initialize`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(le2 || (e6.InitializeRequest = le2 = {}));
  var k2;
  (function(e7) {
    e7.unknownProtocolVersion = 1;
  })(k2 || (e6.InitializeErrorCodes = k2 = {}));
  var ue2;
  (function(e7) {
    e7.method = `initialized`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(ue2 || (e6.InitializedNotification = ue2 = {}));
  var A2;
  (function(e7) {
    e7.method = `shutdown`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType0(e7.method);
  })(A2 || (e6.ShutdownRequest = A2 = {}));
  var j2;
  (function(e7) {
    e7.method = `exit`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType0(e7.method);
  })(j2 || (e6.ExitNotification = j2 = {}));
  var de2;
  (function(e7) {
    e7.method = `workspace/didChangeConfiguration`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(de2 || (e6.DidChangeConfigurationNotification = de2 = {}));
  var fe2;
  (function(e7) {
    e7.Error = 1, e7.Warning = 2, e7.Info = 3, e7.Log = 4, e7.Debug = 5;
  })(fe2 || (e6.MessageType = fe2 = {}));
  var pe2;
  (function(e7) {
    e7.method = `window/showMessage`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(pe2 || (e6.ShowMessageNotification = pe2 = {}));
  var me2;
  (function(e7) {
    e7.method = `window/showMessageRequest`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolRequestType(e7.method);
  })(me2 || (e6.ShowMessageRequest = me2 = {}));
  var he2;
  (function(e7) {
    e7.method = `window/logMessage`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(he2 || (e6.LogMessageNotification = he2 = {}));
  var ge2;
  (function(e7) {
    e7.method = `telemetry/event`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(ge2 || (e6.TelemetryEventNotification = ge2 = {}));
  var _e3;
  (function(e7) {
    e7.None = 0, e7.Full = 1, e7.Incremental = 2;
  })(_e3 || (e6.TextDocumentSyncKind = _e3 = {}));
  var ve2;
  (function(e7) {
    e7.method = `textDocument/didOpen`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(ve2 || (e6.DidOpenTextDocumentNotification = ve2 = {}));
  var ye2;
  (function(e7) {
    function t3(e8) {
      let t4 = e8;
    ...
    e7.isFull = n3;
  })(ye2 || (e6.TextDocumentContentChangeEvent = ye2 = {}));
  var be2;
  (function(e7) {
    e7.method = `textDocument/didChange`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(be2 || (e6.DidChangeTextDocumentNotification = be2 = {}));
  var xe2;
  (function(e7) {
    e7.method = `textDocument/didClose`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(xe2 || (e6.DidCloseTextDocumentNotification = xe2 = {}));
  var Se2;
  (function(e7) {
    e7.method = `textDocument/didSave`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(Se2 || (e6.DidSaveTextDocumentNotification = Se2 = {}));
  var Ce2;
  (function(e7) {
    e7.Manual = 1, e7.AfterDelay = 2, e7.FocusOut = 3;
  })(Ce2 || (e6.TextDocumentSaveReason = Ce2 = {}));
  var M2;
  (function(e7) {
    e7.method = `textDocument/willSave`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(M2 || (e6.WillSaveTextDocumentNotification = M2 = {}));
  var we2;
  (function(e7) {
    e7.method = `textDocument/willSaveWaitUntil`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(we2 || (e6.WillSaveTextDocumentWaitUntilRequest = we2 = {}));
  var Te2;
  (function(e7) {
    e7.method = `workspace/didChangeWatchedFiles`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(Te2 || (e6.DidChangeWatchedFilesNotification = Te2 = {}));
  var Ee2;
  (function(e7) {
    e7.Created = 1, e7.Changed = 2, e7.Deleted = 3;
  })(Ee2 || (e6.FileChangeType = Ee2 = {}));
  var De2;
  (function(e7) {
    function t3(e8) {
      let t4 = e8;
      return i2.objectLiteral(t4) && (n2.URI.is(t4.baseUri) || n2.WorkspaceFolder.is(t4.baseUri)) && i2.string(t4.pattern);
    }
    e7.is = t3;
  })(De2 || (e6.RelativePattern = De2 = {}));
  var Oe2;
  (function(e7) {
    e7.Create = 1, e7.Change = 2, e7.Delete = 4;
  })(Oe2 || (e6.WatchKind = Oe2 = {}));
  var ke2;
  (function(e7) {
    e7.method = `textDocument/publishDiagnostics`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolNotificationType(e7.method);
  })(ke2 || (e6.PublishDiagnosticsNotification = ke2 = {}));
  var Ae2;
  (function(e7) {
    e7.Invoked = 1, e7.TriggerCharacter = 2, e7.TriggerForIncompleteCompletions = 3;
  })(Ae2 || (e6.CompletionTriggerKind = Ae2 = {}));
  var je2;
  (function(e7) {
    e7.method = `textDocument/completion`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(je2 || (e6.CompletionRequest = je2 = {}));
  var Me2;
  (function(e7) {
    e7.method = `completionItem/resolve`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Me2 || (e6.CompletionResolveRequest = Me2 = {}));
  var Ne2;
  (function(e7) {
    e7.method = `textDocument/hover`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ne2 || (e6.HoverRequest = Ne2 = {}));
  var Pe2;
  (function(e7) {
    e7.Invoked = 1, e7.TriggerCharacter = 2, e7.ContentChange = 3;
  })(Pe2 || (e6.SignatureHelpTriggerKind = Pe2 = {}));
  var Fe2;
  (function(e7) {
    e7.method = `textDocument/signatureHelp`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Fe2 || (e6.SignatureHelpRequest = Fe2 = {}));
  var Ie2;
  (function(e7) {
    e7.method = `textDocument/definition`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ie2 || (e6.DefinitionRequest = Ie2 = {}));
  var Le2;
  (function(e7) {
    e7.method = `textDocument/references`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Le2 || (e6.ReferencesRequest = Le2 = {}));
  var Re2;
  (function(e7) {
    e7.method = `textDocument/documentHighlight`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Re2 || (e6.DocumentHighlightRequest = Re2 = {}));
  var ze2;
  (function(e7) {
    e7.method = `textDocument/documentSymbol`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(ze2 || (e6.DocumentSymbolRequest = ze2 = {}));
  var Be2;
  (function(e7) {
    e7.method = `textDocument/codeAction`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Be2 || (e6.CodeActionRequest = Be2 = {}));
  var Ve2;
  (function(e7) {
    e7.method = `codeAction/resolve`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ve2 || (e6.CodeActionResolveRequest = Ve2 = {}));
  var He2;
  (function(e7) {
    e7.method = `workspace/symbol`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(He2 || (e6.WorkspaceSymbolRequest = He2 = {}));
  var Ue2;
  (function(e7) {
    e7.method = `workspaceSymbol/resolve`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ue2 || (e6.WorkspaceSymbolResolveRequest = Ue2 = {}));
  var We2;
  (function(e7) {
    e7.method = `textDocument/codeLens`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(We2 || (e6.CodeLensRequest = We2 = {}));
  var Ge2;
  (function(e7) {
    e7.method = `codeLens/resolve`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ge2 || (e6.CodeLensResolveRequest = Ge2 = {}));
  var Ke2;
  (function(e7) {
    e7.method = `workspace/codeLens/refresh`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolRequestType0(e7.method);
  })(Ke2 || (e6.CodeLensRefreshRequest = Ke2 = {}));
  var qe2;
  (function(e7) {
    e7.method = `textDocument/documentLink`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(qe2 || (e6.DocumentLinkRequest = qe2 = {}));
  var Je2;
  (function(e7) {
    e7.method = `documentLink/resolve`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Je2 || (e6.DocumentLinkResolveRequest = Je2 = {}));
  var Ye2;
  (function(e7) {
    e7.method = `textDocument/formatting`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ye2 || (e6.DocumentFormattingRequest = Ye2 = {}));
  var Xe2;
  (function(e7) {
    e7.method = `textDocument/rangeFormatting`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Xe2 || (e6.DocumentRangeFormattingRequest = Xe2 = {}));
  var Ze2;
  (function(e7) {
    e7.method = `textDocument/rangesFormatting`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Ze2 || (e6.DocumentRangesFormattingRequest = Ze2 = {}));
  var Qe2;
  (function(e7) {
    e7.method = `textDocument/onTypeFormatting`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(Qe2 || (e6.DocumentOnTypeFormattingRequest = Qe2 = {}));
  var $e2;
  (function(e7) {
    e7.Identifier = 1;
  })($e2 || (e6.PrepareSupportDefaultBehavior = $e2 = {}));
  var et2;
  (function(e7) {
    e7.method = `textDocument/rename`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(et2 || (e6.RenameRequest = et2 = {}));
  var tt2;
  (function(e7) {
    e7.method = `textDocument/prepareRename`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(tt2 || (e6.PrepareRenameRequest = tt2 = {}));
  var nt2;
  (function(e7) {
    e7.method = `workspace/executeCommand`, e7.messageDirection = t2.MessageDirection.clientToServer, e7.type = new t2.ProtocolRequestType(e7.method);
  })(nt2 || (e6.ExecuteCommandRequest = nt2 = {}));
  var rt2;
  (function(e7) {
    e7.method = `workspace/applyEdit`, e7.messageDirection = t2.MessageDirection.serverToClient, e7.type = new t2.ProtocolRequestType(`workspace/applyEdit`);
  })(rt2 || (e6.ApplyWorkspaceEditRequest = rt2 = {}));
})), xN = t(((e6) => {
  ...
  var t2 = e6 && e6.__createBinding || (Object.create ? (function(e7, t3, n3, r2) {
    r2 === void 0 && (r2 = n3);
    var i3 = Object.getOwnPropertyDescriptor(t3, n3);
    (!i3 || (`get` in i3 ? !t3.__esModule : i3.writable || i3.configurable)) && (i3 = { enumerable: true, get: function() {
      return t3[n3];
    } }), Object.defineProperty(e7, r2, i3);
  }) : (function(e7, t3, n3, r2) {
    r2 === void 0 && (r2 = n3), e7[r2] = t3[n3];
  })), n2 = e6 && e6.__exportStar || function(e7, n3) {
    for (var r2 in e7) r2 !== `default` && !Object.prototype.hasOwnProperty.call(n3, r2) && t2(n3, e7, r2);
  };
  Object.defineProperty(e6, `__esModule`, { value: true }), e6.LSPErrorCodes = e6.createProtocolConnection = void 0, n2(XM(), e6), n2((VA(), r(fk)), e6), n2(Q(), e6), n2(bN(), e6);
  var i2 = xN();
  Object.defineProperty(e6, `createProtocolConnection`, { enumerable: true, get: function() {
    return i2.createProtocolConnection;
  } });
  var a2;
  (function(e7) {
    e7.lspReservedErrorRangeStart = -32899, e7.RequestFailed = -32803, e7.ServerCancelled = -32802, e7.ContentModified = -32801, e7.RequestCancelled = -32800, e7.lspReservedErrorRangeEnd = -32800;
  })(a2 || (e6.LSPErrorCodes = a2 = {}));
})), CN = t(((e6) => {
  var t2 = e6 && e6.__createBinding || (Object.create ? (function(e7, t3, n3, r3) {
    r3 === void 0 && (r3 = n3);
    var i3 = Object.getOwnPropertyDescriptor(t3, n3);
