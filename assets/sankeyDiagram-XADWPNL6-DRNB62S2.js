...
import { Cn as getDiagramTitle, In as setDiagramTitle, Jn as __name, Ln as setupGraphViewbox, Nn as setAccDescription, Pn as setAccTitle, Sn as getConfig2, _n as defaultConfig2, bn as getAccTitle, hn as common_default, pn as clear, un as select_default, yn as getAccDescription } from "./index-BgJKKt_a.js";
...
${prefix}${Math.round(value$1 * 100) / 100}${suffix}`;
  ...
  const link$1 = svg.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(graph.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply");
