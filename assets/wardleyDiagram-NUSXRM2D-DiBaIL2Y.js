var _a;
import { Cn as getDiagramTitle, In as setDiagramTitle, Jn as __name, Mn as sanitizeText, Nn as setAccDescription, Nt as selectSvgElement, Pn as setAccTitle, Sn as getConfig2, Yn as log, bn as getAccTitle, gn as configureSvgSize, pn as clear, yn as getAccDescription } from "./index-BgJKKt_a.js";
...
var extractFlowFromArrow = /* @__PURE__ */ __name((arrow) => {
  var _a2;
  if (!(arrow == null ? void 0 : arrow.startsWith("+"))) return {};
  const flowLabel = (_a2 = /^\+'([^']*)'/.exec(arrow)) == null ? void 0 : _a2[1];
  ...
  renderer: { draw: /* @__PURE__ */ __name((text, id, _version, diagObj) => {
    ...
    if (stages.length > 0) {
      ...
      stages.forEach((stage, index) => {
        ...
        if (index > 0) stageGroup.append("line").attr("x1", startX).attr("x2", startX).attr("y1", configValues.padding).attr("y2", height - configValues.padding).attr("stroke", "#000").attr("stroke-width", 1).attr("stroke-dasharray", "5 5").attr("opacity", 0.8);
    ...
    const validLinks = data.links.filter((link) => {
      ...
      if ((_a3 = pipelineMap.get(link.target)) == null ? void 0 : _a3.has(link.source)) return false;
      return true;
    });
