var _a;
import { B as utils_default, Cn as getDiagramTitle, F as generateId, In as setDiagramTitle, Jn as __name, Nn as setAccDescription, Pn as setAccTitle, Sn as getConfig2, Yn as log, bn as getAccTitle, hn as common_default, o as render, pn as clear, yn as getAccDescription } from "./index-BgJKKt_a.js";
...
var stateRenderer_v3_unified_default = {
  ...
  draw: /* @__PURE__ */ __name(async function(text, id, _version, diag) {
    ...
    try {
      (typeof diag.db.getLinks === "function" ? diag.db.getLinks() : /* @__PURE__ */ new Map()).forEach((linkInfo, key) => {
        ...
        allNodes == null ? void 0 : allNodes.forEach((g) => {
          var _a3;
          if (((_a3 = g.textContent) == null ? void 0 : _a3.trim()) === stateId) matchedElem = g;
        });
        if (!matchedElem) {
    ...
    utils_default.insertTitle(svg, "statediagramTitleText", (conf == null ? void 0 : conf.titleTopMargin) ?? 25, diag.db.getDiagramTitle());
...
var dataFetcher = /* @__PURE__ */ __name((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.description) {
      ...
      } else if (((_a2 = newNode.description) == null ? void 0 : _a2.length) && newNode.description.length > 0) {
        newNode.shape = SHAPE_STATE_WITH_DESC;
    ...
    if (((_b = newNode.description) == null ? void 0 : _b.length) === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) if (newNode.type === "group") newNode.shape = SHAPE_GROUP;
...
var StateDB = (_a = class {
  ...
  handleStyleDef(item) {
    ...
    for (const id of ids) {
      ...
      if (state) state.styles = styles.map((s) => {
        var _a2;
...
export {
  styles_default as i,
  stateDiagram_default as n,
  stateRenderer_v3_unified_default as r,
  StateDB as t
};
