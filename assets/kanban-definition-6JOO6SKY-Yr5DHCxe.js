import { $ as e, K as t, L as n, Q as r, b as i, d as a, tt as o } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as s, h as c } from "./src-BWB47EtT.js";
import "./dist-DAHuMNYw.js";
import "./chunk-5PVQY5BW-DyH3Wf6D.js";
import { t as l } from "./chunk-426QAEUC-BhmuD47R.js";
import { n as u, t as d } from "./chunk-XPW4576I-DW7HTQl0.js";
...
import { a as f, c as p, i as m } from "./chunk-5FUZZQ4R-CDUw6eb4.js";
import { t as h } from "./chunk-FMBD7UC4-DqZjeowl.js";
var g = (function() {
...
var _ = g, v = [], y = [], b = 0, x = {}, S = c(() => {
  ...
  let e2 = [], t2 = [], r2 = w(), a2 = i();
  for (let e3 of r2) {
    let r3 = { id: e3.id, label: n(e3.label ?? ``, a2), labelType: `markdown`, isGroup: true, ticket: e3.ticket, shape: `kanbanSection`, level: e3.level, look: a2.look };
    t2.push(r3);
    let i2 = v.filter((t3) => t3.parentId === e3.id);
    for (let r4 of i2) {
      let i3 = { id: r4.id, parentId: e3.id, label: n(r4.label ?? ``, a2), labelType: `markdown`, isGroup: false, ticket: r4 == null ? void 0 : r4.ticket, priority: r4 == null ? void 0 : r4.priority, assigned: r4 == null ? void 0 : r4.assigned, icon: r4 == null ? void 0 : r4.icon, shape: `kanbanItem`, level: r4.level, rx: 5, ry: 5, cssStyles: [`text-align: left`] };
      t2.push(i3);
    }
  }
  return { nodes: t2, edges: e2, other: {}, config: i() };
}, `getData`), E = c((e2, t2, r2, o2, s2) => {
  var _a, _b;
  let c2 = i(), l2 = ((_a = c2.mindmap) == null ? void 0 : _a.padding) ?? a.mindmap.padding;
  switch (o2) {
    case D.ROUNDED_RECT:
    case D.RECT:
    case D.HEXAGON:
  ...
  let f2 = { id: n(t2, c2) || `kbn` + b++, level: e2, label: n(r2, c2), width: ((_b = c2.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? a.mindmap.maxNodeWidth, padding: l2, isGroup: false };
  if (s2 !== void 0) {
    let e3;
    e3 = s2.includes(`
`) ? s2 + `
...
}, `type2Str`), getLogger: c(() => s, `getLogger`), getElementById: c((e2) => x[e2], `getElementById`) }, k = { draw: c(async (e2, n2, r2, o2) => {
  var _a, _b, _c, _d, _e;
  s.debug(`Rendering kanban diagram
` + e2);
  let c2 = o2.db.getData(), u2 = i();
  u2.htmlLabels = false;
  let d2 = l(n2);
  for (let e3 of c2.nodes) e3.domId = `${n2}-${e3.id}`;
  let h2 = d2.append(`g`);
  ...
  for (let e3 of _2) {
    let t2 = y2[x2];
    x2 += 1;
    let n3 = ((_c = u2 == null ? void 0 : u2.kanban) == null ? void 0 : _c.sectionWidth) || 200, r3 = -n3 * 3 / 2 + b2, i2 = r3, a2 = c2.nodes.filter((t3) => t3.parentId === e3.id);
    for (let t3 of a2) {
      ...
      t3.y = i2 + r4.height / 2, await p(t3), i2 = t3.y + r4.height / 2 + 10 / 2;
    }
    let o3 = t2.cluster.select(`rect`), s2 = Math.max(i2 - r3 + 30, 50) + (b2 - 25);
    o3.attr(`height`, s2);
  }
  t(void 0, d2, ((_d = u2.mindmap) == null ? void 0 : _d.padding) ?? a.kanban.padding, ((_e = u2.mindmap) == null ? void 0 : _e.useMaxWidth) ?? a.kanban.useMaxWidth);
}, `draw`) }, A = c((t2) => {
  let n2 = ``;
  ...
  let i2 = c((n3, i3) => t2.darkMode ? r(n3, i3) : e(n3, i3), `adjuster`);
  for (let e2 = 0; e2 < t2.THEME_COLOR_LIMIT; e2++) {
    ...
    .section-${e2 - 1} rect, .section-${e2 - 1} path, .section-${e2 - 1} circle, .section-${e2 - 1} polygon, .section-${e2 - 1} path  {
      fill: ${i2(t2[`cScale` + e2], 10)};
      stroke: ${i2(t2[`cScale` + e2], 10)};
