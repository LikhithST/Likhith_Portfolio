var _a;
import { C as e, Cn as t, I as n, In as r, Jn as i, Ln as a, Mn as o, N as s, Nn as c, Nt as l, Pn as u, Qn as d, S as f, Sn as p, T as m, Yn as h, bn as g, pn as _, rr as v, un as y, vn as b, w as x, xn as S, yn as C } from "./index-4Ava25sD.js";
...
import { t as w } from "./chunk-4BX2VUAB-BsqOnTl0.js";
import { t as T } from "./mermaid-parser.core-C5_5uso8.js";
import { t as E } from "./cytoscape.esm-DBi9m-mj.js";
var D = d(((e2, t2) => {
  (function(n2, r2) {
...
}))(), 1), A = { L: `left`, R: `right`, T: `top`, B: `bottom` }, j = { L: i((e2) => `${e2},${e2 / 2} 0,${e2} 0,0`, `L`), R: i((e2) => `0,${e2 / 2} ${e2},0 ${e2},${e2}`, `R`), T: i((e2) => `0,0 ${e2},0 ${e2 / 2},${e2}`, `T`), B: i((e2) => `${e2 / 2},0 ${e2},${e2} 0,${e2}`, `B`) }, M = { L: i((e2, t2) => e2 - t2 + 2, `L`), R: i((e2, t2) => e2 - 2, `R`), T: i((e2, t2) => e2 - t2 + 2, `T`), B: i((e2, t2) => e2 - 2, `B`) }, N = i(function(e2) {
  return F(e2) ? e2 === `L` ? `R` : `L` : e2 === `T` ? `B` : `T`;
}, `getOppositeArchitectureDirection`), P = i(function(e2) {
  let t2 = e2;
  return t2 === `L` || t2 === `R` || t2 === `T` || t2 === `B`;
}, `isArchitectureDirection`), F = i(function(e2) {
  let t2 = e2;
  return t2 === `L` || t2 === `R`;
}, `isArchitectureDirectionX`), I = i(function(e2) {
  let t2 = e2;
  return t2 === `T` || t2 === `B`;
}, `isArchitectureDirectionY`), L = i(function(e2, t2) {
  let n2 = F(e2) && I(t2), r2 = I(e2) && F(t2);
  return n2 || r2;
}, `isArchitectureDirectionXY`), R = i(function(e2) {
  let t2 = e2[0], n2 = e2[1], r2 = F(t2) && I(n2), i2 = I(t2) && F(n2);
  return r2 || i2;
}, `isArchitecturePairXY`), z = i(function(e2) {
  return e2 !== `LL` && e2 !== `RR` && e2 !== `TT` && e2 !== `BB`;
}, `isValidArchitectureDirectionPair`), B = i(function(e2, t2) {
  let n2 = `${e2}${t2}`;
  return z(n2) ? n2 : void 0;
}, `getArchitectureDirectionPair`), V = i(function([e2, t2], n2) {
  let r2 = n2[0], i2 = n2[1];
  return F(r2) ? I(i2) ? [e2 + (r2 === `L` ? -1 : 1), t2 + (i2 === `T` ? 1 : -1)] : [e2 + (r2 === `L` ? -1 : 1), t2] : F(i2) ? [e2 + (i2 === `L` ? 1 : -1), t2 + (r2 === `T` ? 1 : -1)] : [e2, t2 + (r2 === `T` ? 1 : -1)];
}, `shiftPositionByArchitectureDirectionPair`), ee = i(function(e2) {
  return e2 === `LT` || e2 === `TL` ? [1, 1] : e2 === `BL` || e2 === `LB` ? [1, -1] : e2 === `BR` || e2 === `RB` ? [-1, -1] : [-1, 1];
}, `getArchitectureDirectionXYFactors`), te = i(function(e2, t2) {
  return L(e2, t2) ? `bend` : F(e2) ? `horizontal` : `vertical`;
}, `getArchitectureDirectionAlignment`), H = i(function(e2) {
  return e2.type === `service`;
}, `isArchitectureService`), ne = i(function(e2) {
  return e2.type === `junction`;
}, `isArchitectureJunction`), re = i((e2) => e2.data(), `edgeData`), U = i((e2) => e2.data(), `nodeData`), W = b.architecture, G = (_a = class {
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.diagramId = ``, this.setAccTitle = u, this.getAccTitle = g, this.setDiagramTitle = r, this.getDiagramTitle = t, this.getAccDescription = C, this.setAccDescription = c, this.clear();
  }
  setDiagramId(e2) {
    this.diagramId = e2;
  }
  ...
  clear() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.dataStructures = void 0, this.elements = {}, this.diagramId = ``, _();
  }
  ...
  addJunction({ id: e2, in: t2 }) {
    ...
    if (t2 !== void 0) {
      ...
      if (this.registeredIds[t2] === `node`) throw Error(`The junction [${e2}]'s parent is not a group`);
    }
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      let e2 = {}, t2 = Object.entries(this.nodes).reduce((t3, [n3, r3]) => (t3[n3] = r3.edges.reduce((t4, r4) => {
        var _a2, _b;
        let i2 = (_a2 = this.getNode(r4.lhsId)) == null ? void 0 : _a2.in, a3 = (_b = this.getNode(r4.rhsId)) == null ? void 0 : _b.in;
        if (i2 && a3 && i2 !== a3) {
          let t5 = te(r4.lhsDir, r4.rhsDir);
          t5 !== `bend` && (e2[i2] ?? (e2[i2] = {}), e2[i2][a3] = t5, e2[a3] ?? (e2[a3] = {}), e2[a3][i2] = t5);
        }
        if (r4.lhsId === n3) {
        ...
        return t4;
      }, {}), t3), {}), n2 = Object.keys(t2)[0], r2 = { [n2]: 1 }, a2 = Object.keys(t2).reduce((e3, t3) => t3 === n2 ? e3 : { ...e3, [t3]: 1 }, {}), o2 = i((e3) => {
        let n3 = { [e3]: [0, 0] }, i2 = [e3];
        for (; i2.length > 0; ) {
          let e4 = i2.shift();
          if (e4) {
            r2[e4] = 1, delete a2[e4];
            let o3 = t2[e4], [s3, c2] = n3[e4];
            Object.entries(o3).forEach(([e5, t3]) => {
              r2[t3] || (n3[t3] = V([s3, c2], e5), i2.push(t3));
            });
          }
        }
        return n3;
      }, `BFS`), s2 = [o2(n2)];
      for (; Object.keys(a2).length > 0; ) s2.push(o2(Object.keys(a2)[0]));
      this.dataStructures = { adjList: t2, spatialMaps: s2, groupAlignments: e2 };
    }
  ...
  getConfig() {
    return s({ ...W, ...S().architecture });
  }
  getConfigField(e2) {
    return this.getConfig()[e2];
  }
}, i(_a, `ArchitectureDB`), _a), ie = i((e2, t2) => {
...
}, `populateDb`), K = { parser: { yy: void 0 }, parse: i(async (e2) => {
  var _a2;
...
`, `getStyles`), J = i((e2) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e2}</g>`, `wrapIcon`), Y = { prefix: `mermaid-architecture`, height: 80, width: 80, icons: { database: { body: J(`<path id="b" data-name="4" d="m20,57.86c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="c" data-name="3" d="m20,45.95c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="d" data-name="2" d="m20,34.05c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse id="e" data-name="1" cx="40" cy="22.14" rx="20" ry="7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="20" y1="57.86" x2="20" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="60" y1="57.86" x2="60" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>`) }, server: { body: J(`<rect x="17.5" y="17.5" width="45" height="45" rx="2" ry="2" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="32.5" x2="62.5" y2="32.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="47.5" x2="62.5" y2="47.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><g><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g>`) }, disk: { body: J(`<rect x="20" y="15" width="40" height="50" rx="1" ry="1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="14" ry="14.58" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="4" ry="4.17" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m37.51,42.52l-4.83,13.22c-.26.71-1.1,1.02-1.76.64l-4.18-2.42c-.66-.38-.81-1.26-.33-1.84l9.01-10.8c.88-1.05,2.56-.08,2.09,1.2Z" style="fill: #fff; stroke-width: 0px;"/>`) }, internet: { body: J(`<circle cx="40" cy="40" r="22.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="40" y1="17.5" x2="40" y2="62.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="40" x2="62.5" y2="40" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m39.99,17.51c-15.28,11.1-15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m40.01,17.51c15.28,11.1,15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="30.1" x2="60.25" y2="30.1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="49.9" x2="60.25" y2="49.9" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>`) }, cloud: { body: J(`<path d="m65,47.5c0,2.76-2.24,5-5,5H20c-2.76,0-5-2.24-5-5,0-1.87,1.03-3.51,2.56-4.36-.04-.21-.06-.42-.06-.64,0-2.6,2.48-4.74,5.65-4.97,1.65-4.51,6.34-7.76,11.85-7.76.86,0,1.69.08,2.5.23,2.09-1.57,4.69-2.5,7.5-2.5,6.1,0,11.19,4.38,12.28,10.17,2.14.56,3.72,2.51,3.72,4.83,0,.03,0,.07-.01.1,2.29.46,4.01,2.48,4.01,4.9Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>`) }, unknown: m, blank: { body: J(``) } } }, ae = i(async function(e2, t2, r2, i2) {
  let a2 = r2.getConfigField(`padding`), o2 = r2.getConfigField(`iconSize`), s2 = o2 / 2, c2 = o2 / 6, l2 = c2 / 2;
  await Promise.all(t2.edges().map(async (t3) => {
    var _a2, _b;
    let { source: o3, sourceDir: u2, sourceArrow: d2, sourceGroup: m2, target: h2, targetDir: g2, targetArrow: _2, targetGroup: v2, label: y2 } = re(t3), { x: b2, y: x2 } = t3[0].sourceEndpoint(), { x: S2, y: C2 } = t3[0].midpoint(), { x: w2, y: T2 } = t3[0].targetEndpoint(), E2 = a2 + 4;
    if (m2 && (F(u2) ? b2 += u2 === `L` ? -E2 : E2 : x2 += u2 === `T` ? -E2 : E2 + 18), v2 && (F(g2) ? w2 += g2 === `L` ? -E2 : E2 : T2 += g2 === `T` ? -E2 : E2 + 18), !m2 && ((_a2 = r2.getNode(o3)) == null ? void 0 : _a2.type) === `junction` && (F(u2) ? b2 += u2 === `L` ? s2 : -s2 : x2 += u2 === `T` ? s2 : -s2), !v2 && ((_b = r2.getNode(h2)) == null ? void 0 : _b.type) === `junction` && (F(g2) ? w2 += g2 === `L` ? s2 : -s2 : T2 += g2 === `T` ? s2 : -s2), t3[0]._private.rscratch) {
      let t4 = e2.insert(`g`);
      if (t4.insert(`path`).attr(`d`, `M ${b2},${x2} L ${S2},${C2} L${w2},${T2} `).attr(`class`, `edge`).attr(`id`, `${i2}-${n(o3, h2, { prefix: `L` })}`), d2) {
        let e3 = F(u2) ? M[u2](b2, c2) : b2 - l2, n2 = I(u2) ? M[u2](x2, c2) : x2 - l2;
        t4.insert(`polygon`).attr(`points`, j[u2](c2)).attr(`transform`, `translate(${e3},${n2})`).attr(`class`, `arrow`);
      }
      if (_2) {
        let e3 = F(g2) ? M[g2](w2, c2) : w2 - l2, n2 = I(g2) ? M[g2](T2, c2) : T2 - l2;
        t4.insert(`polygon`).attr(`points`, j[g2](c2)).attr(`transform`, `translate(${e3},${n2})`).attr(`class`, `arrow`);
      }
      if (y2) {
        let e3 = L(u2, g2) ? `XY` : F(u2) ? `X` : `Y`, n2 = 0;
        n2 = e3 === `X` ? Math.abs(b2 - w2) : e3 === `Y` ? Math.abs(x2 - T2) / 1.5 : Math.abs(b2 - w2) / 2;
        let r3 = t4.append(`g`);
        if (await f(r3, y2, { useHtmlLabels: false, width: n2, classes: `architecture-service-label` }, p()), r3.attr(`dy`, `1em`).attr(`alignment-baseline`, `middle`).attr(`dominant-baseline`, `middle`).attr(`text-anchor`, `middle`), e3 === `X`) r3.attr(`transform`, `translate(` + S2 + `, ` + C2 + `)`);
        else if (e3 === `Y`) r3.attr(`transform`, `translate(` + S2 + `, ` + C2 + `) rotate(-90)`);
        else if (e3 === `XY`) {
          let e4 = B(u2, g2);
          if (e4 && R(e4)) {
            let t5 = r3.node().getBoundingClientRect(), [n3, i3] = ee(e4);
            r3.attr(`dominant-baseline`, `auto`).attr(`transform`, `rotate(${-1 * n3 * i3 * 45})`);
            let a3 = r3.node().getBoundingClientRect();
            r3.attr(`transform`, `
                translate(${S2}, ${C2 - t5.height / 2})
                translate(${n3 * a3.width / 2}, ${i3 * a3.height / 2})
                rotate(${-1 * n3 * i3 * 45}, 0, ${t5.height / 2})
              `);
          }
        }
      }
...
}, `drawEdges`), X = i(async function(t2, n2, r2, i2) {
  let a2 = r2.getConfigField(`padding`) * 0.75, o2 = r2.getConfigField(`fontSize`), s2 = r2.getConfigField(`iconSize`) / 2;
  await Promise.all(n2.nodes().map(async (n3) => {
    let c2 = U(n3);
    if (c2.type === `group`) {
      let { h: l2, w: u2, x1: d2, y1: m2 } = n3.boundingBox(), h2 = t2.append(`rect`);
      h2.attr(`id`, `${i2}-group-${c2.id}`).attr(`x`, d2 + s2).attr(`y`, m2 + s2).attr(`width`, u2).attr(`height`, l2).attr(`class`, `node-bkg`);
      let g2 = t2.append(`g`), _2 = d2, v2 = m2;
      if (c2.icon) {
        let t3 = g2.append(`g`);
        t3.html(`<g>${await e(c2.icon, { height: a2, width: a2, fallbackPrefix: Y.prefix })}</g>`), t3.attr(`transform`, `translate(` + (_2 + s2 + 1) + `, ` + (v2 + s2 + 1) + `)`), _2 += a2, v2 += o2 / 2 - 1 - 2;
      }
      if (c2.label) {
        let e2 = g2.append(`g`);
        await f(e2, c2.label, { useHtmlLabels: false, width: u2, classes: `architecture-service-label` }, p()), e2.attr(`dy`, `1em`).attr(`alignment-baseline`, `middle`).attr(`dominant-baseline`, `start`).attr(`text-anchor`, `start`), e2.attr(`transform`, `translate(` + (_2 + s2 + 4) + `, ` + (v2 + s2 + 2) + `)`);
      }
      r2.setElementForId(c2.id, h2);
    }
  }));
}, `drawGroups`), oe = i(async function(t2, n2, r2, i2) {
  let a2 = p();
  for (let s2 of r2) {
    let r3 = n2.append(`g`), c2 = t2.getConfigField(`iconSize`);
    if (s2.title) {
      let e2 = r3.append(`g`);
      await f(e2, s2.title, { useHtmlLabels: false, width: c2 * 1.5, classes: `architecture-service-label` }, a2), e2.attr(`dy`, `1em`).attr(`alignment-baseline`, `middle`).attr(`dominant-baseline`, `middle`).attr(`text-anchor`, `middle`), e2.attr(`transform`, `translate(` + c2 / 2 + `, ` + c2 + `)`);
    }
    let l2 = r3.append(`g`);
    if (s2.icon) l2.html(`<g>${await e(s2.icon, { height: c2, width: c2, fallbackPrefix: Y.prefix })}</g>`);
    else if (s2.iconText) {
      l2.html(`<g>${await e(`blank`, { height: c2, width: c2, fallbackPrefix: Y.prefix })}</g>`);
      let t3 = l2.append(`g`).append(`foreignObject`).attr(`width`, c2).attr(`height`, c2).append(`div`).attr(`class`, `node-icon-text`).attr(`style`, `height: ${c2}px;`).append(`div`).html(o(s2.iconText, a2)), n3 = parseInt(window.getComputedStyle(t3.node(), null).getPropertyValue(`font-size`).replace(/\D/g, ``)) ?? 16;
      t3.attr(`style`, `-webkit-line-clamp: ${Math.floor((c2 - 2) / n3)};`);
    } else l2.append(`path`).attr(`class`, `node-bkg`).attr(`id`, `${i2}-node-${s2.id}`).attr(`d`, `M0,${c2} V5 Q0,0 5,0 H${c2 - 5} Q${c2},0 ${c2},5 V${c2} Z`);
    r3.attr(`id`, `${i2}-service-${s2.id}`).attr(`class`, `architecture-service`);
    let { width: u2, height: d2 } = r3.node().getBBox();
    s2.width = u2, s2.height = d2, t2.setElementForId(s2.id, r3);
  }
  return 0;
}, `drawServices`), Z = i(function(e2, t2, n2, r2) {
  n2.forEach((n3) => {
    let i2 = t2.append(`g`), a2 = e2.getConfigField(`iconSize`);
    i2.append(`g`).append(`rect`).attr(`id`, `${r2}-node-${n3.id}`).attr(`fill-opacity`, `0`).attr(`width`, a2).attr(`height`, a2), i2.attr(`class`, `architecture-junction`);
    let { width: o2, height: s2 } = i2._groups[0][0].getBBox();
    i2.width = o2, i2.height = s2, e2.setElementForId(n3.id, i2);
  });
}, `drawJunctions`);
...
function fe(e2, t2, n2) {
  let r2 = i((e3, t3) => Object.entries(e3).reduce((e4, [r3, i2]) => {
    var _a2;
    let a3 = 0, o3 = Object.entries(i2);
    if (o3.length === 1) return e4[r3] = o3[0][1], e4;
    for (let i3 = 0; i3 < o3.length - 1; i3++) for (let s2 = i3 + 1; s2 < o3.length; s2++) {
      let [c2, l2] = o3[i3], [u2, d2] = o3[s2];
    ...
    return e4;
  }, {}), `flattenAlignments`), [a2, o2] = t2.map((t3) => {
    let n3 = {}, i2 = {};
    return Object.entries(t3).forEach(([t4, [r3, a3]]) => {
      var _a2, _b, _c;
      let o3 = ((_a2 = e2.getNode(t4)) == null ? void 0 : _a2.in) ?? `default`;
      n3[a3] ?? (n3[a3] = {}), (_b = n3[a3])[o3] ?? (_b[o3] = []), n3[a3][o3].push(t4), i2[r3] ?? (i2[r3] = {}), (_c = i2[r3])[o3] ?? (_c[o3] = []), i2[r3][o3].push(t4);
    }), { horiz: Object.values(r2(n3, `horizontal`)).filter((e3) => e3.length > 1), vert: Object.values(r2(i2, `vertical`)).filter((e3) => e3.length > 1) };
  }).reduce(([e3, t3], { horiz: n3, vert: r3 }) => [[...e3, ...n3], [...t3, ...r3]], [[], []]);
  return { horizontal: a2, vertical: o2 };
}
i(fe, `getAlignments`);
function pe(e2, t2) {
  let n2 = [], r2 = i((e3) => `${e3[0]},${e3[1]}`, `posToStr`), a2 = i((e3) => e3.split(`,`).map((e4) => parseInt(e4)), `strToPos`);
  return e2.forEach((e3) => {
    let i2 = Object.fromEntries(Object.entries(e3).map(([e4, t3]) => [r2(t3), e4])), o2 = [r2([0, 0])], s2 = {}, c2 = { L: [-1, 0], R: [1, 0], T: [0, 1], B: [0, -1] };
    for (; o2.length > 0; ) {
      let e4 = o2.shift();
      if (e4) {
        s2[e4] = 1;
        ...
        if (l2) {
          let u2 = a2(e4);
          Object.entries(c2).forEach(([e5, a3]) => {
            let c3 = r2([u2[0] + a3[0], u2[1] + a3[1]]), d2 = i2[c3];
...
i(pe, `getRelativeConstraints`);
function me(e2, t2, n2, r2, a2, { spatialMaps: o2, groupAlignments: s2 }) {
  return new Promise((c2) => {
    let l2 = y(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`), u2 = E({ container: document.getElementById(`cy`), style: [{ selector: `edge`, style: { "curve-style": `straight`, "source-endpoint": `data(sourceEndpoint)`, "target-endpoint": `data(targetEndpoint)` } }, { selector: `edge[label]`, style: { label: `data(label)` } }, { selector: `edge.segments`, style: { "curve-style": `segments`, "segment-weights": `0`, "segment-distances": [0.5], "edge-distances": `endpoints`, "source-endpoint": `data(sourceEndpoint)`, "target-endpoint": `data(targetEndpoint)` } }, { selector: `node`, style: { "compound-sizing-wrt-labels": `include` } }, { selector: `node[label]`, style: { "text-valign": `bottom`, "text-halign": `center`, "font-size": `${a2.getConfigField(`fontSize`)}px` } }, { selector: `.node-service`, style: { label: `data(label)`, width: `data(width)`, height: `data(height)` } }, { selector: `.node-junction`, style: { width: `data(width)`, height: `data(height)` } }, { selector: `.node-group`, style: { padding: `${a2.getConfigField(`padding`)}px` } }], layout: { name: `grid`, boundingBox: { x1: 0, x2: 100, y1: 0, y2: 100 } } });
    l2.remove(), ue(n2, u2), se(e2, u2, a2), ce(t2, u2, a2), de(r2, u2);
    let d2 = fe(a2, o2, s2), f2 = pe(o2, a2), p2 = u2.layout({ name: `fcose`, quality: `proof`, randomize: a2.getConfigField(`randomize`), styleEnabled: false, animate: false, nodeDimensionsIncludeLabels: false, idealEdgeLength(e3) {
      let [t3, n3] = e3.connectedNodes(), { parent: r3 } = U(t3), { parent: i2 } = U(n3);
      return r3 === i2 ? 1.5 * a2.getConfigField(`iconSize`) : 0.5 * a2.getConfigField(`iconSize`);
    }, edgeElasticity(e3) {
      let [t3, n3] = e3.connectedNodes(), { parent: r3 } = U(t3), { parent: i2 } = U(n3);
      return r3 === i2 ? 0.45 : 1e-3;
    }, alignmentConstraint: d2, relativePlacementConstraint: f2 });
    p2.one(`layoutstop`, () => {
      var _a2;
      function e3(e4, t3, n3, r3) {
        let i2, a3, { x: o3, y: s3 } = e4, { x: c3, y: l3 } = t3;
        a3 = (r3 - s3 + (o3 - n3) * (s3 - l3) / (o3 - c3)) / Math.sqrt(1 + ((s3 - l3) / (o3 - c3)) ** 2), i2 = Math.sqrt((r3 - s3) ** 2 + (n3 - o3) ** 2 - a3 ** 2);
        ...
        return a3 = Math.abs(a3) * d3, i2 *= f3, { distances: a3, weights: i2 };
      }
      i(e3, `getSegmentWeights`), u2.startBatch();
      for (let t3 of Object.values(u2.edges())) if ((_a2 = t3.data) == null ? void 0 : _a2.call(t3)) {
        let { x: n3, y: r3 } = t3.source().position(), { x: i2, y: a3 } = t3.target().position();
        if (n3 !== i2 && r3 !== a3) {
          let n4 = t3.sourceEndpoint(), r4 = t3.targetEndpoint(), { sourceDir: i3 } = re(t3), [a4, o3] = I(i3) ? [n4.x, r4.y] : [r4.x, n4.y], { weights: s3, distances: c3 } = e3(n4, r4, a4, o3);
          t3.style(`segment-distances`, c3), t3.style(`segment-weights`, s3);
        }
      }
      u2.endBatch(), p2.run();
    }), p2.run(), u2.ready((e3) => {
      h.info(`Ready`, e3), c2(u2);
    });
  });
}
i(me, `layoutArchitecture`);
var he = { parser: K, get db() {
  return new G();
}, renderer: { draw: i(async (e2, t2, n2, r2) => {
  let i2 = r2.db;
  i2.setDiagramId(t2);
  let o2 = i2.getServices(), s2 = i2.getJunctions(), c2 = i2.getGroups(), u2 = i2.getEdges(), d2 = i2.getDataStructures(), f2 = l(t2), p2 = f2.append(`g`);
  p2.attr(`class`, `architecture-edges`);
  let m2 = f2.append(`g`);
  m2.attr(`class`, `architecture-services`);
  let h2 = f2.append(`g`);
  h2.attr(`class`, `architecture-groups`), await oe(i2, m2, o2, t2), Z(i2, m2, s2, t2);
  let g2 = await me(o2, s2, c2, u2, i2, d2);
  await ae(p2, g2, i2, t2), await X(h2, g2, i2, t2), le(i2, g2), a(void 0, f2, i2.getConfigField(`padding`), i2.getConfigField(`useMaxWidth`));
}, `draw`) }, styles: q };
export {
  he as diagram
};
