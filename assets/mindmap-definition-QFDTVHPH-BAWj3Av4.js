var _a;
import { Bn as darken_default, Dn as getUserDefinedConfig, Jn as __name, Mn as sanitizeText, Sn as getConfig2, Un as is_dark_default, Vn as lighten_default, Yn as log, a as getRegisteredLayoutAlgorithm, o as render, vn as defaultConfig_default, xn as getConfig } from "./index-BgJKKt_a.js";
...
var MindmapDB = (_a = class {
  ...
  flattenNodes(node, processedNodes) {
    ...
    const getShapeFromType = /* @__PURE__ */ __name((type) => {
      var _a2;
      const isReduxTheme = (((_a2 = conf.theme) == null ? void 0 : _a2.toLowerCase()) ?? "").includes("redux");
      switch (type) {
...
var mindmapRenderer_default = { draw: /* @__PURE__ */ __name(async (text, id, _version, diagObj) => {
  ...
  setupViewPortForSVG(svg, ((_a2 = data4Layout.config.mindmap) == null ? void 0 : _a2.padding) ?? defaultConfig_default.mindmap.padding, "mindmapDiagram", ((_b = data4Layout.config.mindmap) == null ? void 0 : _b.useMaxWidth) ?? defaultConfig_default.mindmap.useMaxWidth);
}, "draw") };
