var _a, _b;
import { B as e, C as t, E as n, L as r, V as i, W as a, _ as o, a as s, b as c, c as l, d as u, v as d } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as f, h as p, p as m } from "./src-BWB47EtT.js";
import { t as h } from "./linear-CWOc3ypC.js";
...
var _ = g, v = n(), y = (_a = class {
  ...
  getDefaultConfig() {
    ...
    return { showXAxis: true, showYAxis: true, showTitle: true, chartHeight: ((_a2 = u.quadrantChart) == null ? void 0 : _a2.chartWidth) || 500, chartWidth: ((_b2 = u.quadrantChart) == null ? void 0 : _b2.chartHeight) || 500, titlePadding: ((_c = u.quadrantChart) == null ? void 0 : _c.titlePadding) || 10, titleFontSize: ((_d = u.quadrantChart) == null ? void 0 : _d.titleFontSize) || 20, quadrantPadding: ((_e = u.quadrantChart) == null ? void 0 : _e.quadrantPadding) || 5, xAxisLabelPadding: ((_f = u.quadrantChart) == null ? void 0 : _f.xAxisLabelPadding) || 5, yAxisLabelPadding: ((_g = u.quadrantChart) == null ? void 0 : _g.yAxisLabelPadding) || 5, xAxisLabelFontSize: ((_h = u.quadrantChart) == null ? void 0 : _h.xAxisLabelFontSize) || 16, yAxisLabelFontSize: ((_i = u.quadrantChart) == null ? void 0 : _i.yAxisLabelFontSize) || 16, quadrantLabelFontSize: ((_j = u.quadrantChart) == null ? void 0 : _j.quadrantLabelFontSize) || 16, quadrantTextTopPadding: ((_k = u.quadrantChart) == null ? void 0 : _k.quadrantTextTopPadding) || 5, pointTextPadding: ((_l = u.quadrantChart) == null ? void 0 : _l.pointTextPadding) || 5, pointLabelFontSize: ((_m = u.quadrantChart) == null ? void 0 : _m.pointLabelFontSize) || 12, pointRadius: ((_n = u.quadrantChart) == null ? void 0 : _n.pointRadius) || 5, xAxisPosition: ((_o = u.quadrantChart) == null ? void 0 : _o.xAxisPosition) || `top`, yAxisPosition: ((_p = u.quadrantChart) == null ? void 0 : _p.yAxisPosition) || `left`, quadrantInternalBorderStrokeWidth: ((_q = u.quadrantChart) == null ? void 0 : _q.quadrantInternalBorderStrokeWidth) || 1, quadrantExternalBorderStrokeWidth: ((_r = u.quadrantChart) == null ? void 0 : _r.quadrantExternalBorderStrokeWidth) || 2 };
  }
...
p(z, `setHeight`);
function B() {
  let { themeVariables: e2, quadrantChart: n2 } = c();
...
var ee = { parser: _, db: { setWidth: R, setHeight: z, setQuadrant1Text: D, setQuadrant2Text: O, setQuadrant3Text: k, setQuadrant4Text: A, setXAxisLeftText: j, setXAxisRightText: M, setYAxisTopText: N, setYAxisBottomText: P, parseStyles: F, addPoint: I, addClass: L, getQuadrantData: B, clear: p(function() {
  E.clear(), s();
}, `clear`), setAccTitle: i, getAccTitle: d, setDiagramTitle: a, getDiagramTitle: t, getAccDescription: o, setAccDescription: e }, renderer: { draw: p((e2, t2, n2, r2) => {
  var _a2, _b2, _c;
  function i2(e3) {
...
` + e2);
  let u2 = s2.securityLevel, d2;
  u2 === `sandbox` && (d2 = m(`#i` + t2));
  let h2 = m(u2 === `sandbox` ? d2.nodes()[0].contentDocument.body : `body`).select(`[id="${t2}"]`), g2 = h2.append(`g`).attr(`class`, `main`), _2 = ((_a2 = s2.quadrantChart) == null ? void 0 : _a2.chartWidth) ?? 500, v2 = ((_b2 = s2.quadrantChart) == null ? void 0 : _b2.chartHeight) ?? 500;
  l(h2, v2, _2, ((_c = s2.quadrantChart) == null ? void 0 : _c.useMaxWidth) ?? true), h2.attr(`viewBox`, `0 0 ` + _2 + ` ` + v2), r2.db.setHeight(v2), r2.db.setWidth(_2);
