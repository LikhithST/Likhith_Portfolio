import { $ as e, B as t, C as n, Q as r, V as i, W as a, _ as o, a as s, c, d as l, et as u, tt as d, v as f, y as p } from "./chunk-ICPOFSXX-cosQBm9P.js";
import { h as m, p as h } from "./src-DiRGiyL4.js";
import "./dist-BhM2qfql.js";
import { i as g } from "./chunk-5PVQY5BW-BPITZuxu.js";
import { t as _ } from "./chunk-426QAEUC-DnOBqw_y.js";
import "./identity-B9owP9ru.js";
import { t as v } from "./rough.esm-1QChbhql.js";
var y = (e2, t2) => u(e2, `a`, -t2), b = 1e-10;
function x(e2, t2) {
...
var U = (function() {
  var e2 = m(function(e3, t3, n3, r3) {
    ...
    return n3;
  }, `o`), t2 = [5, 8], n2 = [7, 8, 11, 12, 17, 19, 22, 24], r2 = [1, 17], i2 = [1, 18], a2 = [7, 8, 11, 12, 14, 15, 16, 17, 19, 20, 21, 22, 24, 27], o2 = [1, 31], s2 = [1, 39], c2 = [7, 8, 11, 12, 17, 19, 22, 24, 27], l2 = [1, 57], u2 = [1, 56], d2 = [1, 58], f2 = [1, 59], p2 = [1, 60], h2 = [7, 8, 11, 12, 16, 17, 19, 20, 22, 24, 27, 31, 32, 33], g2 = { trace: m(function() {
  }, `trace`), yy: {}, symbols_: { error: 2, start: 3, optNewlines: 4, VENN: 5, document: 6, EOF: 7, NEWLINE: 8, line: 9, statement: 10, TITLE: 11, SET: 12, identifier: 13, BRACKET_LABEL: 14, COLON: 15, NUMERIC: 16, UNION: 17, identifierList: 18, TEXT: 19, IDENTIFIER: 20, STRING: 21, INDENT_TEXT: 22, indentedTextTail: 23, STYLE: 24, stylesOpt: 25, styleField: 26, COMMA: 27, styleValue: 28, valueTokens: 29, valueToken: 30, HEXCOLOR: 31, RGBCOLOR: 32, RGBACOLOR: 33, $accept: 0, $end: 1 }, terminals_: { 2: `error`, 5: `VENN`, 7: `EOF`, 8: `NEWLINE`, 11: `TITLE`, 12: `SET`, 14: `BRACKET_LABEL`, 15: `COLON`, 16: `NUMERIC`, 17: `UNION`, 19: `TEXT`, 20: `IDENTIFIER`, 21: `STRING`, 22: `INDENT_TEXT`, 24: `STYLE`, 27: `COMMA`, 31: `HEXCOLOR`, 32: `RGBCOLOR`, 33: `RGBACOLOR` }, productions_: [0, [3, 4], [4, 0], [4, 2], [6, 0], [6, 2], [9, 1], [9, 1], [10, 1], [10, 2], [10, 3], [10, 4], [10, 5], [10, 2], [10, 3], [10, 4], [10, 5], [10, 3], [10, 3], [10, 3], [10, 4], [10, 4], [10, 2], [10, 3], [23, 1], [23, 1], [23, 1], [23, 2], [23, 2], [25, 1], [25, 3], [26, 3], [28, 1], [28, 1], [29, 1], [29, 2], [30, 1], [30, 1], [30, 1], [30, 1], [30, 1], [18, 1], [18, 3], [13, 1], [13, 1]], performAction: m(function(e3, t3, n3, r3, i3, a3, o3) {
    var s3 = a3.length - 1;
    switch (i3) {
      case 1:
        return a3[s3 - 1];
  ...
  }, `anonymous`), table: [e2(t2, [2, 2], { 3: 1, 4: 2 }), { 1: [3] }, { 5: [1, 3], 8: [1, 4] }, e2(n2, [2, 4], { 6: 5 }), e2(t2, [2, 3]), { 7: [1, 6], 8: [1, 8], 9: 7, 10: 9, 11: [1, 10], 12: [1, 11], 17: [1, 12], 19: [1, 13], 22: [1, 14], 24: [1, 15] }, { 1: [2, 1] }, e2(n2, [2, 5]), e2(n2, [2, 6]), e2(n2, [2, 7]), e2(n2, [2, 8]), { 13: 16, 20: r2, 21: i2 }, { 13: 20, 18: 19, 20: r2, 21: i2 }, { 13: 20, 18: 21, 20: r2, 21: i2 }, { 16: [1, 25], 20: [1, 23], 21: [1, 24], 23: 22 }, { 13: 20, 18: 26, 20: r2, 21: i2 }, e2(n2, [2, 9], { 14: [1, 27], 15: [1, 28] }), e2(a2, [2, 43]), e2(a2, [2, 44]), e2(n2, [2, 13], { 14: [1, 29], 15: [1, 30], 27: o2 }), e2(a2, [2, 41]), { 16: [1, 34], 20: [1, 32], 21: [1, 33], 27: o2 }, e2(n2, [2, 22]), e2(n2, [2, 24], { 14: [1, 35] }), e2(n2, [2, 25], { 14: [1, 36] }), e2(n2, [2, 26]), { 20: s2, 25: 37, 26: 38, 27: o2 }, e2(n2, [2, 10], { 15: [1, 40] }), { 16: [1, 41] }, e2(n2, [2, 14], { 15: [1, 42] }), { 16: [1, 43] }, { 13: 44, 20: r2, 21: i2 }, e2(n2, [2, 17], { 14: [1, 45] }), e2(n2, [2, 18], { 14: [1, 46] }), e2(n2, [2, 19]), e2(n2, [2, 27]), e2(n2, [2, 28]), e2(n2, [2, 23], { 27: [1, 47] }), e2(c2, [2, 29]), { 15: [1, 48] }, { 16: [1, 49] }, e2(n2, [2, 11]), { 16: [1, 50] }, e2(n2, [2, 15]), e2(a2, [2, 42]), e2(n2, [2, 20]), e2(n2, [2, 21]), { 20: s2, 26: 51 }, { 16: l2, 20: u2, 21: [1, 53], 28: 52, 29: 54, 30: 55, 31: d2, 32: f2, 33: p2 }, e2(n2, [2, 12]), e2(n2, [2, 16]), e2(c2, [2, 30]), e2(c2, [2, 31]), e2(c2, [2, 32]), e2(c2, [2, 33], { 30: 61, 16: l2, 20: u2, 31: d2, 32: f2, 33: p2 }), e2(h2, [2, 34]), e2(h2, [2, 36]), e2(h2, [2, 37]), e2(h2, [2, 38]), e2(h2, [2, 39]), e2(h2, [2, 40]), e2(h2, [2, 35])], defaultActions: { 6: [2, 1] }, parseError: m(function(e3, t3) {
    ...
    for (var S2, C2, w2, T2, E2, D2 = {}, O2, k2, A2, j2; ; ) {
      if (w2 = n3[n3.length - 1], this.defaultActions[w2] ? T2 = this.defaultActions[w2] : (S2 ?? (S2 = x2()), T2 = o3[w2] && o3[w2][S2]), T2 === void 0 || !T2.length || !T2[0]) {
        var M2 = ``;
        for (O2 in j2 = [], o3[w2]) this.terminals_[O2] && O2 > d3 && j2.push(`'` + this.terminals_[O2] + `'`);
        M2 = h3.showPosition ? `Parse error on line ` + (c3 + 1) + `:
` + h3.showPosition() + `
Expecting ` + j2.join(`, `) + `, got '` + (this.terminals_[S2] || S2) + `'` : `Parse error on line ` + (c3 + 1) + `: Unexpected ` + (S2 == f3 ? `end of input` : `'` + (this.terminals_[S2] || S2) + `'`), this.parseError(M2, { text: h3.match, token: this.terminals_[S2] || S2, line: h3.yylineno, loc: v2, expected: j2 });
      }
      if (T2[0] instanceof Array && T2.length > 1) throw Error(`Parse Error: multiple actions possible at state: ` + w2 + `, token: ` + S2);
      switch (T2[0]) {
        case 1:
          n3.push(S2), i3.push(h3.yytext), a3.push(h3.yylloc), n3.push(T2[1]), S2 = null, C2 ? (S2 = C2, C2 = null) : (l3 = h3.yyleng, s3 = h3.yytext, c3 = h3.yylineno, v2 = h3.yylloc, u3 > 0 && u3--);
          break;
        case 2:
          if (k2 = this.productions_[T2[1]][1], D2.$ = i3[i3.length - k2], D2._$ = { first_line: a3[a3.length - (k2 || 1)].first_line, last_line: a3[a3.length - 1].last_line, first_column: a3[a3.length - (k2 || 1)].first_column, last_column: a3[a3.length - 1].last_column }, y2 && (D2._$.range = [a3[a3.length - (k2 || 1)].range[0], a3[a3.length - 1].range[1]]), E2 = this.performAction.apply(D2, [s3, l3, c3, g3.yy, T2[1], i3, a3].concat(p3)), E2 !== void 0) return E2;
...
` + this.showPosition(), { text: ``, token: null, line: this.yylineno });
    ...
    }, `stateStackSize`), options: { "case-insensitive": true }, performAction: m(function(e3, t3, n3, r3) {
      switch (n3) {
        case 0:
          break;
        case 1:
  ...
  return m(_2, `Parser`), _2.prototype = g2, g2.Parser = _2, new _2();
})();
U.parser = U;
var Ee = U, W = [], G = [], K = [], q = /* @__PURE__ */ new Set(), J, Y = false, De = m((e2, t2, n2) => {
  let r2 = Z(e2).sort(), i2 = n2 ?? 10 / e2.length ** 2;
  J = r2, r2.length === 1 && q.add(r2[0]), W.push({ sets: r2, size: i2, label: t2 ? X(t2) : void 0 });
}, `addSubsetData`), Oe = m(() => W, `getSubsetData`), X = m((e2) => {
  let t2 = e2.trim();
  return t2.length >= 2 && t2.startsWith(`"`) && t2.endsWith(`"`) ? t2.slice(1, -1) : t2;
}, `normalizeText`), ke = m((e2) => e2 && X(e2), `normalizeStyleValue`), Ae = m((e2, t2, n2) => {
  let r2 = X(t2);
  G.push({ sets: Z(e2).sort(), id: r2, label: n2 ? X(n2) : void 0 });
}, `addTextData`), je = m((e2, t2) => {
  let n2 = Z(e2).sort(), r2 = {};
  for (let [e3, n3] of t2) r2[e3] = ke(n3) ?? n3;
  K.push({ targets: n2, styles: r2 });
}, `addStyleData`), Me = m(() => K, `getStyleData`), Z = m((e2) => e2.map((e3) => X(e3)), `normalizeIdentifierList`), Ne = m((e2) => {
  let t2 = Z(e2).filter((e3) => !q.has(e3));
  if (t2.length > 0) throw Error(`unknown set identifier: ${t2.join(`, `)}`);
}, `validateUnionIdentifiers`), Pe = m(() => G, `getTextData`), Fe = m(() => J, `getCurrentSets`), Ie = m(() => Y, `getIndentMode`), Le = m((e2) => {
  Y = e2;
}, `setIndentMode`), Re = l.venn;
function ze() {
  return g(Re, p().venn);
}
m(ze, `getConfig`);
var Be = { getConfig: ze, clear: m(() => {
  s(), W.length = 0, G.length = 0, K.length = 0, q.clear(), J = void 0, Y = false;
}, `customClear`), setAccTitle: i, getAccTitle: f, setDiagramTitle: a, getDiagramTitle: n, getAccDescription: o, setAccDescription: t, addSubsetData: De, getSubsetData: Oe, addTextData: Ae, addStyleData: je, validateUnionIdentifiers: Ne, getTextData: Pe, getStyleData: Me, getCurrentSets: Fe, getIndentMode: Ie, setIndentMode: Le }, Ve = m((e2) => `
  .venn-title {
    font-size: 32px;
...
m(He, `buildStyleByKey`);
var Ue = m((t2, n2, i2, a2) => {
  var _a, _b, _c;
  let o2 = a2.db, s2 = (_a = o2.getConfig) == null ? void 0 : _a.call(o2), { themeVariables: l2, look: u2, handDrawnSeed: f2 } = p(), m2 = u2 === `handDrawn`, g2 = [l2.venn1, l2.venn2, l2.venn3, l2.venn4, l2.venn5, l2.venn6, l2.venn7, l2.venn8].filter(Boolean), b2 = (_b = o2.getDiagramTitle) == null ? void 0 : _b.call(o2), x2 = o2.getSubsetData(), S2 = o2.getTextData(), C2 = He(o2.getStyleData()), w2 = (s2 == null ? void 0 : s2.width) ?? 800, T2 = (s2 == null ? void 0 : s2.height) ?? 450, E2 = w2 / 1600, D2 = b2 ? 48 * E2 : 0, O2 = l2.primaryTextColor ?? l2.textColor, k2 = _(n2);
  k2.attr(`viewBox`, `0 0 ${w2} ${T2}`), b2 && k2.append(`text`).text(b2).attr(`class`, `venn-title`).attr(`font-size`, `${32 * E2}px`).attr(`text-anchor`, `middle`).attr(`dominant-baseline`, `middle`).attr(`x`, `50%`).attr(`y`, 32 * E2).style(`fill`, l2.vennTitleTextColor || l2.titleColor);
  let A2 = h(document.createElement(`div`)), j2 = ge().width(w2).height(T2 - D2);
  A2.datum(x2).call(j2);
  let M2 = m2 ? v.svg(A2.select(`svg`).node()) : void 0, N2 = Te(x2, { width: w2, height: T2 - D2, padding: (s2 == null ? void 0 : s2.padding) ?? 15 }), P2 = /* @__PURE__ */ new Map();
  for (let e2 of N2) {
    let t3 = Q([...e2.data.sets].sort());
    P2.set(t3, e2);
  }
  S2.length > 0 && $(s2, P2, A2, S2, E2, C2);
  let F2 = d(l2.background || `#f4f4f4`);
  A2.selectAll(`.venn-circle`).each(function(t3, n3) {
    var _a2;
    let i3 = h(this), a3 = Q([...t3.sets].sort()), o3 = C2.get(a3), s3 = (o3 == null ? void 0 : o3.fill) || g2[n3 % g2.length] || l2.primaryColor;
    i3.classed(`venn-set-${n3 % 8}`, true);
    let c2 = (o3 == null ? void 0 : o3[`fill-opacity`]) ?? 0.1, u3 = (o3 == null ? void 0 : o3.stroke) || s3, d2 = (o3 == null ? void 0 : o3[`stroke-width`]) || `${5 * E2}`;
    if (m2 && M2) {
      let e2 = P2.get(a3);
      if (e2 && e2.circles.length > 0) {
        let t4 = e2.circles[0], r2 = M2.circle(t4.x, t4.y, t4.radius * 2, { roughness: 0.7, seed: f2, fill: y(s3, 0.7), fillStyle: `hachure`, fillWeight: 2, hachureGap: 8, hachureAngle: -41 + n3 * 60, stroke: u3, strokeWidth: parseFloat(String(d2)) });
        i3.select(`path`).remove(), (_a2 = i3.node()) == null ? void 0 : _a2.insertBefore(r2, i3.select(`text`).node());
      }
    } else i3.select(`path`).style(`fill`, s3).style(`fill-opacity`, c2).style(`stroke`, u3).style(`stroke-width`, d2).style(`stroke-opacity`, 0.95);
    let p2 = (o3 == null ? void 0 : o3.color) || (F2 ? e(s3, 30) : r(s3, 30));
    i3.select(`text`).style(`font-size`, `${48 * E2}px`).style(`fill`, p2);
  }), m2 && M2 ? A2.selectAll(`.venn-intersection`).each(function(e2) {
    var _a2;
    let t3 = h(this), n3 = Q([...e2.sets].sort()), r2 = C2.get(n3), i3 = r2 == null ? void 0 : r2.fill;
    if (i3) {
      let e3 = t3.select(`path`), n4 = e3.attr(`d`);
      if (n4) {
        let t4 = M2.path(n4, { roughness: 0.7, seed: f2, fill: y(i3, 0.3), fillStyle: `cross-hatch`, fillWeight: 2, hachureGap: 6, hachureAngle: 60, stroke: `none` }), r3 = e3.node();
        (_a2 = r3 == null ? void 0 : r3.parentNode) == null ? void 0 : _a2.insertBefore(t4, r3), e3.remove();
      }
    } else t3.select(`path`).style(`fill-opacity`, 0);
    t3.select(`text`).style(`font-size`, `${48 * E2}px`).style(`fill`, (r2 == null ? void 0 : r2.color) ?? l2.vennSetTextColor ?? O2);
  }) : (A2.selectAll(`.venn-intersection text`).style(`font-size`, `${48 * E2}px`).style(`fill`, (e2) => {
    var _a2;
    let t3 = Q([...e2.sets].sort());
    return ((_a2 = C2.get(t3)) == null ? void 0 : _a2.color) ?? l2.vennSetTextColor ?? O2;
  ...
  c(k2, T2, w2, (s2 == null ? void 0 : s2.useMaxWidth) ?? true);
}, `draw`);
function Q(e2) {
  return e2.join(`|`);
}
