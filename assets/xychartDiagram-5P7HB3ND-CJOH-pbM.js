...
import { t as linear } from "./linear-UZOG-IOW.js";
import { t as ordinal } from "./ordinal-Bs01uwBv.js";
import "./defaultLocale-BExgBGLN.js";
import { t as initRange } from "./init-B8xRTswO.js";
import { Cn as getDiagramTitle, Ft as line_default, In as setDiagramTitle, Jn as __name, Mn as sanitizeText, N as cleanAndMerge, Nn as setAccDescription, Nt as selectSvgElement, Pn as setAccTitle, Tn as getThemeVariables3, Yn as log, bn as getAccTitle, gn as configureSvgSize, pn as clear, vn as defaultConfig_default, x as computeDimensionOfText, xn as getConfig, yn as getAccDescription } from "./index-BgJKKt_a.js";
...
var BarPlot = (_g = class {
  ...
  getDrawableElement() {
    ...
    const barWidth = Math.min(this.xAxis.getAxisOuterPadding() * 2, this.xAxis.getTickDistance()) * 0.95;
          ...
          if (chartConfig.showDataLabel) {
            ...
            if (chartConfig.chartOrientation === "horizontal") {
              ...
              let fitsInBar2 = function(item, fontSize, yOffset2) {
                const { data, label } = item;
                const textWidth = fontSize * label.length * 0.7;
