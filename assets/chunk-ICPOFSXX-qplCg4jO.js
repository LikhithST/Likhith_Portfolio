import { _ as e, g as t, h as n, m as r } from "./src-BWB47EtT.js";
let b, Xt, zn, Hn, ln, ut, Ut, Ft, zt, Dt, An, En, nn, Qn, at, Jt, xn, x, Jn, B, Rt, Kn, Ln, Vn, Lt, X, I, Bn, In, s, Gn, Tn, Q, ce, it, tt, At, yn, l, fn, vn, kt, L, Ht, v, jn, R, Yn, H, _, Sn, rt, y, qn, Rn, Yt, $n, Bt, It;
let __tla = (async () => {
  ...
  let d, ee, f, p, m, te, ne, re, ie, h, g, ae, oe, se, S, le, C, ue, de, fe, pe, w, T, E, me, D, he;
  d = {
    ALL: 0,
    RGB: 1,
    HSL: 2
  ...
  function et() {
    ...
    if (t2.version = `3.3.3`, t2.removed = [], !e2 || !e2.document || e2.document.nodeType !== Xe.document || !e2.Element) return t2.isSupported = false, t2;
    ...
    let { MUSTACHE_EXPR: ce2, ERB_EXPR: b2, TMPLIT_EXPR: x2, DATA_ATTR: S2, ARIA_ATTR: le2, IS_SCRIPT_OR_DATA: C2, ATTR_WHITESPACE: de2, CUSTOM_ELEMENT: fe2 } = Ye, { IS_ALLOWED_URI: pe2 } = Ye, w2 = null, E2 = j({}, [
    ...
    })), He2 = true, Ue2 = true, We2 = false, Ge2 = true, P2 = false, qe2 = true, F2 = false, I2 = false, tt2 = false, L2 = false, nt2 = false, rt2 = false, R2 = true, it2 = false, at2 = true, z2 = false, B2 = {}, V2 = null, H2 = j({}, [
      `annotation-xml`,
      `audio`,
      `colgroup`,
      `desc`,
      ...
      `style`,
      `xmlns`
    ]), st2 = `http://www.w3.org/1998/Math/MathML`, ct2 = `http://www.w3.org/2000/svg`, K2 = `http://www.w3.org/1999/xhtml`, lt2 = K2, ut2 = false, dt2 = null, ft2 = j({}, [
      st2,
      ct2,
      K2
    ], Se), pt2 = j({}, [
      ...
      `text/html`
    ], q2 = null, J2 = null, vt2 = n2.createElement(`form`), yt2 = function(e3) {
      return e3 instanceof RegExp || e3 instanceof Function;
    }, bt2 = function() {
      let e3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      if (!(J2 && J2 === e3)) {
        if ((!e3 || typeof e3 != `object`) && (e3 = {}), e3 = M(e3), gt2 = _t2.indexOf(e3.PARSER_MEDIA_TYPE) === -1 ? `text/html` : e3.PARSER_MEDIA_TYPE, q2 = gt2 === `application/xhtml+xml` ? Se : xe, w2 = O(e3, `ALLOWED_TAGS`) ? j({}, e3.ALLOWED_TAGS, q2) : E2, D2 = O(e3, `ALLOWED_ATTR`) ? j({}, e3.ALLOWED_ATTR, q2) : he2, dt2 = O(e3, `ALLOWED_NAMESPACES`) ? j({}, e3.ALLOWED_NAMESPACES, Se) : ft2, G2 = O(e3, `ADD_URI_SAFE_ATTR`) ? j(M(ot2), e3.ADD_URI_SAFE_ATTR, q2) : ot2, U2 = O(e3, `ADD_DATA_URI_TAGS`) ? j(M(W2), e3.ADD_DATA_URI_TAGS, q2) : W2, V2 = O(e3, `FORBID_CONTENTS`) ? j({}, e3.FORBID_CONTENTS, q2) : H2, Oe2 = O(e3, `FORBID_TAGS`) ? j({}, e3.FORBID_TAGS, q2) : M({}), ke2 = O(e3, `FORBID_ATTR`) ? j({}, e3.FORBID_ATTR, q2) : M({}), B2 = O(e3, `USE_PROFILES`) ? e3.USE_PROFILES : false, He2 = e3.ALLOW_ARIA_ATTR !== false, Ue2 = e3.ALLOW_DATA_ATTR !== false, We2 = e3.ALLOW_UNKNOWN_PROTOCOLS || false, Ge2 = e3.ALLOW_SELF_CLOSE_IN_ATTR !== false, P2 = e3.SAFE_FOR_TEMPLATES || false, qe2 = e3.SAFE_FOR_XML !== false, F2 = e3.WHOLE_DOCUMENT || false, L2 = e3.RETURN_DOM || false, nt2 = e3.RETURN_DOM_FRAGMENT || false, rt2 = e3.RETURN_TRUSTED_TYPE || false, tt2 = e3.FORCE_BODY || false, R2 = e3.SANITIZE_DOM !== false, it2 = e3.SANITIZE_NAMED_PROPS || false, at2 = e3.KEEP_CONTENT !== false, z2 = e3.IN_PLACE || false, pe2 = e3.ALLOWED_URI_REGEXP || Ke, lt2 = e3.NAMESPACE || K2, pt2 = e3.MATHML_TEXT_INTEGRATION_POINTS || pt2, mt2 = e3.HTML_INTEGRATION_POINTS || mt2, A2 = e3.CUSTOM_ELEMENT_HANDLING || {}, e3.CUSTOM_ELEMENT_HANDLING && yt2(e3.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (A2.tagNameCheck = e3.CUSTOM_ELEMENT_HANDLING.tagNameCheck), e3.CUSTOM_ELEMENT_HANDLING && yt2(e3.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (A2.attributeNameCheck = e3.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), e3.CUSTOM_ELEMENT_HANDLING && typeof e3.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == `boolean` && (A2.allowCustomizedBuiltInElements = e3.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), P2 && (Ue2 = false), nt2 && (L2 = true), B2 && (w2 = j({}, Le), D2 = me(null), B2.html === true && (j(w2, je), j(D2, Re)), B2.svg === true && (j(w2, Me), j(D2, ze), j(D2, Ve)), B2.svgFilters === true && (j(w2, Ne), j(D2, ze), j(D2, Ve)), B2.mathMl === true && (j(w2, Fe), j(D2, Be), j(D2, Ve))), O(e3, `ADD_TAGS`) || (N2.tagCheck = null), O(e3, `ADD_ATTR`) || (N2.attributeCheck = null), e3.ADD_TAGS && (typeof e3.ADD_TAGS == `function` ? N2.tagCheck = e3.ADD_TAGS : (w2 === E2 && (w2 = M(w2)), j(w2, e3.ADD_TAGS, q2))), e3.ADD_ATTR && (typeof e3.ADD_ATTR == `function` ? N2.attributeCheck = e3.ADD_ATTR : (D2 === he2 && (D2 = M(D2)), j(D2, e3.ADD_ATTR, q2))), e3.ADD_URI_SAFE_ATTR && j(G2, e3.ADD_URI_SAFE_ATTR, q2), e3.FORBID_CONTENTS && (V2 === H2 && (V2 = M(V2)), j(V2, e3.FORBID_CONTENTS, q2)), e3.ADD_FORBID_CONTENTS && (V2 === H2 && (V2 = M(V2)), j(V2, e3.ADD_FORBID_CONTENTS, q2)), at2 && (w2[`#text`] = true), F2 && j(w2, [
          `html`,
          `head`,
          `body`
        ]), w2.table && (j(w2, [
      ...
      return dt2[e3.namespaceURI] ? e3.namespaceURI === ct2 ? t3.namespaceURI === K2 ? n3 === `svg` : t3.namespaceURI === st2 ? n3 === `svg` && (r3 === `annotation-xml` || pt2[r3]) : !!xt2[n3] : e3.namespaceURI === st2 ? t3.namespaceURI === K2 ? n3 === `math` : t3.namespaceURI === ct2 ? n3 === `math` && mt2[r3] : !!St2[n3] : e3.namespaceURI === K2 ? t3.namespaceURI === ct2 && !mt2[r3] || t3.namespaceURI === st2 && !pt2[r3] ? false : !St2[n3] && (ht2[n3] || !xt2[n3]) : !!(gt2 === `application/xhtml+xml` && dt2[e3.namespaceURI]) : false;
    }, Y2 = function(e3) {
      ye(t2.removed, {
        element: e3
      });
      ...
      gt2 === `application/xhtml+xml` && lt2 === K2 && (e3 = `<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>` + e3 + `</body></html>`);
      let i3 = h2 ? h2.createHTML(e3) : e3;
      if (lt2 === K2) try {
        t3 = new ee2().parseFromString(i3, gt2);
      } catch {
      }
      if (!t3 || !t3.documentElement) {
        t3 = _2.createDocument(lt2, `template`, null);
        try {
          t3.documentElement.innerHTML = ut2 ? g2 : i3;
        } catch {
        }
      }
      let a3 = t3.body || t3.documentElement;
      return e3 && r3 && a3.insertBefore(n2.createTextNode(r3), a3.childNodes[0] || null), lt2 === K2 ? oe2.call(t3, F2 ? `html` : `body`)[0] : F2 ? t3.documentElement : a3;
    }, wt2 = function(e3) {
    ...
    let Dt2 = function(e3) {
      let n3 = null;
      if (Q2(y2.beforeSanitizeElements, e3, null), Tt2(e3)) return Y2(e3), true;
      let r3 = q2(e3.nodeName);
      if (Q2(y2.uponSanitizeElement, e3, {
        tagName: r3,
        allowedTags: w2
      }), qe2 && e3.hasChildNodes() && !Et2(e3.firstElementChild) && k(/<[/\w!]/g, e3.innerHTML) && k(/<[/\w!]/g, e3.textContent) || e3.nodeType === Xe.progressingInstruction || qe2 && e3.nodeType === Xe.comment && k(/<[/\w]/g, e3.data)) return Y2(e3), true;
      if (!(N2.tagCheck instanceof Function && N2.tagCheck(r3)) && (!w2[r3] || Oe2[r3])) {
        if (!Oe2[r3] && kt2(r3) && (A2.tagNameCheck instanceof RegExp && k(A2.tagNameCheck, r3) || A2.tagNameCheck instanceof Function && A2.tagNameCheck(r3))) return false;
        if (at2 && !V2[r3]) {
      ...
      return e3 instanceof c2 && !Ct2(e3) || (r3 === `noscript` || r3 === `noembed` || r3 === `noframes`) && k(/<\/no(script|embed|frames)/i, e3.innerHTML) ? (Y2(e3), true) : (P2 && e3.nodeType === Xe.text && (n3 = e3.textContent, ge([
        ce2,
        b2,
        x2
      ], (e4) => {
      ...
      }), e3.textContent = n3)), Q2(y2.afterSanitizeElements, e3, null), false);
    }, Ot2 = function(e3, t3, r3) {
      if (ke2[t3] || R2 && (t3 === `id` || t3 === `name`) && (r3 in n2 || r3 in vt2)) return false;
      if (!(Ue2 && !ke2[t3] && k(S2, t3)) && !(He2 && k(le2, t3)) && !(N2.attributeCheck instanceof Function && N2.attributeCheck(t3, e3))) {
        ...
        } else if (!G2[t3] && !k(pe2, we(r3, de2, ``)) && !((t3 === `src` || t3 === `xlink:href` || t3 === `href`) && e3 !== `script` && Te(r3, `data:`) === 0 && U2[e3]) && !(We2 && !k(C2, we(r3, de2, ``))) && r3) return false;
      }
      return true;
    }, kt2 = function(e3) {
      return e3 !== `annotation-xml` && Ce(e3, fe2);
    }, At2 = function(e3) {
      Q2(y2.beforeSanitizeAttributes, e3, null);
      ...
      for (; i3--; ) {
        let { name: a3, namespaceURI: o3, value: s3 } = n3[i3], c3 = q2(a3), l3 = s3, u3 = a3 === `value` ? l3 : Ee(l3);
        if (r3.attrName = c3, r3.attrValue = u3, r3.keepAttr = true, r3.forceKeepAttr = void 0, Q2(y2.uponSanitizeAttribute, e3, r3), u3 = r3.attrValue, it2 && (c3 === `id` || c3 === `name`) && (X2(a3, e3), u3 = `user-content-` + u3), qe2 && k(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, u3)) {
          X2(a3, e3);
          continue;
        }
        ...
        if (u3 !== l3) try {
          o3 ? e3.setAttributeNS(o3, a3, u3) : e3.setAttribute(a3, u3), Tt2(e3) ? Y2(e3) : ve(t2.removed);
        } catch {
          X2(a3, e3);
        }
      }
      Q2(y2.afterSanitizeAttributes, e3, null);
    }, $2 = function e3(t3) {
      let n3 = null, r3 = wt2(t3);
      for (Q2(y2.beforeSanitizeShadowDOM, t3, null); n3 = r3.nextNode(); ) Q2(y2.uponSanitizeShadowNode, n3, null), Dt2(n3), At2(n3), n3.content instanceof a2 && e3(n3.content);
      Q2(y2.afterSanitizeShadowDOM, t3, null);
    };
    return t2.sanitize = function(e3) {
      let n3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i3 = null, o3 = null, c3 = null, l3 = null;
      if (ut2 = !e3, ut2 && (e3 = `<!-->`), typeof e3 != `string` && !Et2(e3)) if (typeof e3.toString == `function`) {
      ...
      if (I2 || bt2(n3), t2.removed = [], typeof e3 == `string` && (z2 = false), z2) {
        if (e3.nodeName) {
          let t3 = q2(e3.nodeName);
          if (!w2[t3] || Oe2[t3]) throw De(`root node is forbidden and cannot be sanitized in-place`);
        }
      } else if (e3 instanceof s2) i3 = Z2(`<!---->`), o3 = i3.ownerDocument.importNode(e3, true), o3.nodeType === Xe.element && o3.nodeName === `BODY` || o3.nodeName === `HTML` ? i3 = o3 : i3.appendChild(o3);
      else {
        if (!L2 && !P2 && !F2 && e3.indexOf(`<`) === -1) return h2 && rt2 ? h2.createHTML(e3) : e3;
        if (i3 = Z2(e3), !i3) return L2 ? null : rt2 ? g2 : ``;
      }
      i3 && tt2 && Y2(i3.firstChild);
      let u3 = wt2(z2 ? e3 : i3);
      for (; c3 = u3.nextNode(); ) Dt2(c3), At2(c3), c3.content instanceof a2 && $2(c3.content);
      if (z2) return e3;
      if (L2) {
...
` + d3), P2 && ge([
      ...
      bt2(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), I2 = true;
    }, t2.clearConfig = function() {
      J2 = null, I2 = false;
    }, t2.isValidAttribute = function(e3, t3, n3) {
      return J2 || bt2({}), Ot2(q2(e3), q2(t3), n3);
  ...
  let nt, z, V, U, W, G, ot, st, ct, K, lt, dt, ft, pt, mt, ht, gt, _t, q, J, vt, yt, bt, xt, St, Ct, Y, Z, wt, Tt, Et, Ot, $, jt, Mt, Nt, Pt, Vt, Wt, Gt, Kt, qt, Zt, Qt;
  I = et();
  tt = /^-{3}\s*[\n\r](.*?)[\n\r]-{3}\s*[\n\r]+/s;
  L = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi;
  nt = /\s*%%.*\n/gm;
...
`);
    for (let [n2, { detector: r2 }] of Object.entries(R)) if (r2(e2, t2)) return n2;
    throw new rt(`No diagram type detected matching given configuration for text: ${e2}`);
  }, `detectType`);
  at = n((...e2) => {
    for (let { id: t2, detector: n2, loader: r2 } of e2) z(t2, n2, r2);
  }, `registerLazyLoadedDiagrams`);
  z = n((e2, n2, r2) => {
    R[e2] && t.warn(`Detector with key ${e2} already exists. Overwriting.`), R[e2] = {
      detector: n2,
      loader: r2
    }, t.debug(`Detector with key ${e2} added${r2 ? ` with loader` : ``}`);
  }, `addDetector`);
  B = n((e2) => R[e2].loader, `getDiagramLoader`);
  V = n((e2, t2, { depth: n2 = 2, clobber: r2 = false } = {}) => {
    let i2 = {
      depth: n2,
      clobber: r2
    };
    return Array.isArray(t2) && !Array.isArray(e2) ? (t2.forEach((t3) => V(e2, t3, i2)), e2) : Array.isArray(t2) && Array.isArray(e2) ? (t2.forEach((t3) => {
      ...
      typeof t2[i3] == `object` && t2[i3] !== null && (e2[i3] === void 0 || typeof e2[i3] == `object`) ? (e2[i3] === void 0 && (e2[i3] = Array.isArray(t2[i3]) ? [] : {}), e2[i3] = V(e2[i3], t2[i3], {
        depth: n2 - 1,
        clobber: r2
  ...
  ot = (_b = class {
    ...
    updateColors() {
      var _a2, _b2, _c2, _d2, _e3, _f2, _g2, _h2, _i2, _j2, _k2, _l2, _m2, _n2, _o, _p, _q, _r, _s, _t2, _u, _v;
      ...
      this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || S(this.primaryColor, {
        ...
        h: 120,
        l: -10
      }), this.pieTitleTextSize = this.pieTitleTextSize || `25px`, this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || `17px`, this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || `17px`, this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || `black`, this.pieStrokeWidth = this.pieStrokeWidth || `2px`, this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || `2px`, this.pieOuterStrokeColor = this.pieOuterStrokeColor || `black`, this.pieOpacity = this.pieOpacity || `0.7`, this.venn1 = this.venn1 ?? S(this.primaryColor, {
        l: -30
      }), this.venn2 = this.venn2 ?? S(this.secondaryColor, {
        l: -30
      }), this.venn3 = this.venn3 ?? S(this.tertiaryColor, {
        l: -30
        ...
        dataLabelColor: ((_m2 = this.xyChart) == null ? void 0 : _m2.dataLabelColor) || this.primaryTextColor,
        xAxisTitleColor: ((_n2 = this.xyChart) == null ? void 0 : _n2.xAxisTitleColor) || this.primaryTextColor,
        ...
        yAxisTickColor: ((_t2 = this.xyChart) == null ? void 0 : _t2.yAxisTickColor) || this.primaryTextColor,
  ...
  ct = (_c = class {
    ...
    updateColors() {
      ...
      for (let e2 = 0; e2 < 8; e2++) this[`venn` + (e2 + 1)] = this[`venn` + (e2 + 1)] ?? b(this[`cScale` + e2], 30);
      this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || S(this.primaryColor, {
        ...
        graticuleOpacity: ((_t2 = this.radar) == null ? void 0 : _t2.graticuleOpacity) || 0.3,
  ...
  pt = (_f = class {
    ...
    updateColors() {
      ...
      for (let e2 = 0; e2 < 8; e2++) this[`venn` + (e2 + 1)] = this[`venn` + (e2 + 1)] ?? this[`cScale` + e2];
      this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || S(this.primaryColor, {
        r: 5,
        g: 5,
        b: 5
  ...
  ht = (_g = class {
    constructor() {
      this.background = `#ffffff`, this.primaryColor = `#cccccc`, this.mainBkg = `#ffffff`, this.noteBkgColor = `#fff5ad`, this.noteTextColor = `#333`, this.THEME_COLOR_LIMIT = 12, this.radius = 3, this.strokeWidth = 2, this.primaryBorderColor = G(this.primaryColor, this.darkMode), this.fontFamily = `arial, sans-serif`, this.fontSize = `14px`, this.nodeBorder = `#000000`, this.stateBorder = `#000000`, this.useGradient = true, this.gradientStart = `#0042eb`, this.gradientStop = `#eb0042`, this.dropShadow = `drop-shadow( 0px 1px 2px rgba(0, 0, 0, 0.25));`, this.tertiaryColor = `#ffffff`, this.archEdgeColor = `calculated`, this.archEdgeArrowColor = `calculated`, this.archEdgeWidth = `3`, this.archGroupBorderColor = this.primaryBorderColor, this.archGroupBorderWidth = `2px`, this.noteFontWeight = `normal`, this.fontWeight = `normal`;
    }
    updateColors() {
      var _a2, _b2, _c2, _d2, _e3, _f2, _g2, _h2, _i2, _j2, _k2;
      this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#333`), this.secondaryColor = this.secondaryColor || S(this.primaryColor, {
        h: -120
      }), this.tertiaryColor = this.tertiaryColor || S(this.primaryColor, {
        h: 180,
        l: 5
      }), this.primaryBorderColor = this.primaryBorderColor || G(this.primaryColor, this.darkMode), this.secondaryBorderColor = this.secondaryBorderColor || G(this.secondaryColor, this.darkMode), this.tertiaryBorderColor = this.tertiaryBorderColor || G(this.tertiaryColor, this.darkMode), this.noteBorderColor = this.noteBorderColor || G(this.noteBkgColor, this.darkMode), this.noteBkgColor = this.noteBkgColor || `#fff5ad`, this.noteTextColor = this.noteTextColor || `#333`, this.secondaryTextColor = this.secondaryTextColor || C(this.secondaryColor), this.tertiaryTextColor = this.tertiaryTextColor || C(this.tertiaryColor), this.lineColor = this.lineColor || C(this.background), this.arrowheadColor = this.arrowheadColor || C(this.background), this.textColor = this.textColor || this.primaryTextColor, this.border2 = this.border2 || this.tertiaryBorderColor, this.nodeBkg = this.nodeBkg || this.primaryColor, this.mainBkg = this.mainBkg || this.primaryColor, this.nodeBorder = this.nodeBorder || this.primaryBorderColor, this.clusterBkg = this.clusterBkg || this.tertiaryColor, this.clusterBorder = this.clusterBorder || this.tertiaryBorderColor, this.defaultLinkColor = this.defaultLinkColor || this.lineColor, this.titleColor = this.titleColor || this.tertiaryTextColor, this.edgeLabelBackground = this.edgeLabelBackground || (this.darkMode ? x(this.secondaryColor, 30) : this.secondaryColor), this.nodeTextColor = this.nodeTextColor || this.primaryTextColor, this.actorBorder = this.actorBorder || this.primaryBorderColor, this.actorBkg = this.actorBkg || this.mainBkg, this.actorTextColor = this.actorTextColor || this.primaryTextColor, this.actorLineColor = this.actorLineColor || this.actorBorder, this.labelBoxBkgColor = this.labelBoxBkgColor || this.actorBkg, this.signalColor = this.signalColor || this.textColor, this.signalTextColor = this.signalTextColor || this.textColor, this.labelBoxBorderColor = this.labelBoxBorderColor || this.actorBorder, this.labelTextColor = this.labelTextColor || this.actorTextColor, this.loopTextColor = this.loopTextColor || this.actorTextColor, this.activationBorderColor = this.activationBorderColor || x(this.secondaryColor, 10), this.activationBkgColor = this.activationBkgColor || this.secondaryColor, this.sequenceNumberColor = this.sequenceNumberColor || C(this.lineColor);
      let e2 = `#ECECFE`, t2 = `#E9E9F1`, n2 = S(e2, {
        h: 180,
        l: 5
      });
      if (this.sectionBkgColor = this.sectionBkgColor || n2, this.altSectionBkgColor = this.altSectionBkgColor || `white`, this.sectionBkgColor = this.sectionBkgColor || t2, this.sectionBkgColor2 = this.sectionBkgColor2 || e2, this.excludeBkgColor = this.excludeBkgColor || `#eeeeee`, this.taskBorderColor = this.taskBorderColor || this.primaryBorderColor, this.taskBkgColor = this.taskBkgColor || e2, this.activeTaskBorderColor = this.activeTaskBorderColor || e2, this.activeTaskBkgColor = this.activeTaskBkgColor || b(e2, 23), this.gridColor = this.gridColor || `lightgrey`, this.doneTaskBkgColor = this.doneTaskBkgColor || `lightgrey`, this.doneTaskBorderColor = this.doneTaskBorderColor || `grey`, this.critBorderColor = this.critBorderColor || `#ff8888`, this.critBkgColor = this.critBkgColor || `red`, this.todayLineColor = this.todayLineColor || `red`, this.taskTextColor = this.taskTextColor || this.textColor, this.taskTextOutsideColor = this.taskTextOutsideColor || this.textColor, this.vertLineColor = this.vertLineColor || this.primaryBorderColor, this.taskTextLightColor = this.taskTextLightColor || this.textColor, this.taskTextColor = this.taskTextColor || this.primaryTextColor, this.taskTextDarkColor = this.taskTextDarkColor || this.textColor, this.taskTextClickableColor = this.taskTextClickableColor || `#003163`, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.personBorder = this.personBorder || this.primaryBorderColor, this.personBkg = this.personBkg || this.mainBkg, this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || `#f0f0f0`, this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.specialStateColor = this.lineColor, this.cScale0 = this.cScale0 || e2, this.cScale1 = this.cScale1 || t2, this.cScale2 = this.cScale2 || n2, this.cScale3 = this.cScale3 || S(e2, {
        h: 30
      }), this.cScale4 = this.cScale4 || S(e2, {
        h: 60
      }), this.cScale5 = this.cScale5 || S(e2, {
        h: 90
      }), this.cScale6 = this.cScale6 || S(e2, {
        h: 120
      }), this.cScale7 = this.cScale7 || S(e2, {
        h: 150
      }), this.cScale8 = this.cScale8 || S(e2, {
        h: 210,
        l: 150
      }), this.cScale9 = this.cScale9 || S(e2, {
        h: 270
      }), this.cScale10 = this.cScale10 || S(e2, {
        h: 300
      }), this.cScale11 = this.cScale11 || S(e2, {
        h: 330
      }), this.darkMode) for (let e3 = 0; e3 < this.THEME_COLOR_LIMIT; e3++) this[`cScale` + e3] = x(this[`cScale` + e3], 75);
      else for (let e3 = 0; e3 < this.THEME_COLOR_LIMIT; e3++) this[`cScale` + e3] = x(this[`cScale` + e3], 25);
      for (let e3 = 0; e3 < this.THEME_COLOR_LIMIT; e3++) this[`cScaleInv` + e3] = this[`cScaleInv` + e3] || C(this[`cScale` + e3]);
      ...
      this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
      for (let e3 = 0; e3 < this.THEME_COLOR_LIMIT; e3++) this[`cScaleLabel` + e3] = this[`cScaleLabel` + e3] || this.scaleLabelColor;
      let r2 = this.darkMode ? -4 : -1;
      for (let e3 = 0; e3 < 5; e3++) this[`surface` + e3] = this[`surface` + e3] || S(this.mainBkg, {
        h: 180,
        s: -15,
        l: r2 * (5 + e3 * 3)
      }), this[`surfacePeer` + e3] = this[`surfacePeer` + e3] || S(this.mainBkg, {
        h: 180,
        s: -15,
        l: r2 * (8 + e3 * 3)
      });
      this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || e2, this.fillType1 = this.fillType1 || t2, this.fillType2 = this.fillType2 || S(e2, {
        h: 64
      }), this.fillType3 = this.fillType3 || S(t2, {
        h: 64
      }), this.fillType4 = this.fillType4 || S(e2, {
        h: -64
      }), this.fillType5 = this.fillType5 || S(t2, {
        h: -64
      }), this.fillType6 = this.fillType6 || S(e2, {
        h: 128
      }), this.fillType7 = this.fillType7 || S(t2, {
        h: 128
      }), this.pie1 = this.pie1 || e2, this.pie2 = this.pie2 || t2, this.pie3 = this.pie3 || n2, this.pie4 = this.pie4 || S(e2, {
        l: -10
      }), this.pie5 = this.pie5 || S(t2, {
        l: -10
      }), this.pie6 = this.pie6 || S(n2, {
        l: -10
      }), this.pie7 = this.pie7 || S(e2, {
        h: 60,
        l: -10
      }), this.pie8 = this.pie8 || S(e2, {
        h: -60,
        l: -10
      }), this.pie9 = this.pie9 || S(e2, {
        h: 120,
        l: 0
      }), this.pie10 = this.pie10 || S(e2, {
        h: 60,
        l: -20
      }), this.pie11 = this.pie11 || S(e2, {
        h: -60,
        l: -20
      }), this.pie12 = this.pie12 || S(e2, {
        h: 120,
        l: -10
      }), this.pieTitleTextSize = this.pieTitleTextSize || `25px`, this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || `17px`, this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || `17px`, this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || `black`, this.pieStrokeWidth = this.pieStrokeWidth || `2px`, this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || `2px`, this.pieOuterStrokeColor = this.pieOuterStrokeColor || `black`, this.pieOpacity = this.pieOpacity || `0.7`, this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || e2, this.quadrant2Fill = this.quadrant2Fill || S(e2, {
        r: 5,
        g: 5,
        b: 5
      }), this.quadrant3Fill = this.quadrant3Fill || S(e2, {
        r: 10,
        g: 10,
        b: 10
      }), this.quadrant4Fill = this.quadrant4Fill || S(e2, {
        r: 15,
        g: 15,
        b: 15
      }), this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor, this.quadrant2TextFill = this.quadrant2TextFill || S(this.primaryTextColor, {
      ...
      }, this.requirementBackground = this.requirementBackground || e2, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || `1`, this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? x(this.secondaryColor, 30) : this.secondaryColor), this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || e2, this.git1 = this.git1 || t2, this.git2 = this.git2 || n2, this.git3 = this.git3 || S(e2, {
        h: -30
      }), this.git4 = this.git4 || S(e2, {
        h: -60
      }), this.git5 = this.git5 || S(e2, {
        h: -90
      }), this.git6 = this.git6 || S(e2, {
        h: 60
      }), this.git7 = this.git7 || S(e2, {
        h: 120
      }), this.darkMode ? (this.git0 = b(this.git0, 25), this.git1 = b(this.git1, 25), this.git2 = b(this.git2, 25), this.git3 = b(this.git3, 25), this.git4 = b(this.git4, 25), this.git5 = b(this.git5, 25), this.git6 = b(this.git6, 25), this.git7 = b(this.git7, 25)) : (this.git0 = x(this.git0, 25), this.git1 = x(this.git1, 25), this.git2 = x(this.git2, 25), this.git3 = x(this.git3, 25), this.git4 = x(this.git4, 25), this.git5 = x(this.git5, 25), this.git6 = x(this.git6, 25), this.git7 = x(this.git7, 25)), this.gitInv0 = this.gitInv0 || C(this.git0), this.gitInv1 = this.gitInv1 || C(this.git1), this.gitInv2 = this.gitInv2 || C(this.git2), this.gitInv3 = this.gitInv3 || C(this.git3), this.gitInv4 = this.gitInv4 || C(this.git4), this.gitInv5 = this.gitInv5 || C(this.git5), this.gitInv6 = this.gitInv6 || C(this.git6), this.gitInv7 = this.gitInv7 || C(this.git7), this.branchLabelColor = this.branchLabelColor || (this.darkMode ? `black` : this.labelTextColor), this.gitBranchLabel0 = this.gitBranchLabel0 || this.branchLabelColor, this.gitBranchLabel1 = this.gitBranchLabel1 || this.branchLabelColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.branchLabelColor, this.gitBranchLabel3 = this.gitBranchLabel3 || this.branchLabelColor, this.gitBranchLabel4 = this.gitBranchLabel4 || this.branchLabelColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.branchLabelColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.branchLabelColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || `10px`, this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || `10px`, this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || U, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || W;
    }
    calculate(e2) {
  ...
  xt = (_k = class {
    constructor() {
      this.background = `#ffffff`, this.primaryColor = `#cccccc`, this.mainBkg = `#ffffff`, this.noteBkgColor = `#fff5ad`, this.noteTextColor = `#28253D`, this.THEME_COLOR_LIMIT = 12, this.radius = 12, this.strokeWidth = 2, this.primaryBorderColor = G(this.primaryColor, this.darkMode), this.fontFamily = `"Recursive Variable", arial, sans-serif`, this.fontSize = `14px`, this.nodeBorder = `#28253D`, this.stateBorder = `#28253D`, this.useGradient = false, this.gradientStart = `#0042eb`, this.gradientStop = `#eb0042`, this.dropShadow = `url(#drop-shadow)`, this.nodeShadow = true, this.tertiaryColor = `#ffffff`, this.archEdgeColor = `calculated`, this.archEdgeArrowColor = `calculated`, this.archEdgeWidth = `3`, this.archGroupBorderColor = this.primaryBorderColor, this.archGroupBorderWidth = `2px`, this.actorBorder = `#28253D`, this.noteBorderColor = `#FACC15`, this.noteFontWeight = 600, this.borderColorArray = [
        `#E879F9`,
        `#2DD4BF`,
        `#FB923C`,
        `#22D3EE`,
    ...
    updateColors() {
      ...
      this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#28253D`), this.secondaryColor = this.secondaryColor || S(this.primaryColor, {
        ...
        h: 180,
        l: 5
      }), this.primaryBorderColor = this.primaryBorderColor || G(this.primaryColor, this.darkMode), this.secondaryBorderColor = this.secondaryBorderColor || G(this.secondaryColor, this.darkMode), this.tertiaryBorderColor = this.tertiaryBorderColor || G(this.tertiaryColor, this.darkMode), this.noteBorderColor = this.noteBorderColor || G(this.noteBkgColor, this.darkMode), this.noteBkgColor = this.noteBkgColor || `#fff5ad`, this.noteTextColor = this.noteTextColor || `#28253D`, this.secondaryTextColor = this.secondaryTextColor || C(this.secondaryColor), this.tertiaryTextColor = this.tertiaryTextColor || C(this.tertiaryColor), this.lineColor = this.lineColor || C(this.background), this.arrowheadColor = this.arrowheadColor || C(this.background), this.textColor = this.textColor || this.primaryTextColor, this.border2 = this.border2 || this.tertiaryBorderColor, this.nodeBkg = this.nodeBkg || this.primaryColor, this.mainBkg = this.mainBkg || this.primaryColor, this.nodeBorder = this.nodeBorder || this.primaryBorderColor, this.clusterBkg = this.clusterBkg || this.tertiaryColor, this.clusterBorder = this.clusterBorder || this.tertiaryBorderColor, this.defaultLinkColor = this.defaultLinkColor || this.lineColor, this.titleColor = this.titleColor || this.tertiaryTextColor, this.edgeLabelBackground = this.edgeLabelBackground || (this.darkMode ? x(this.secondaryColor, 30) : this.secondaryColor), this.nodeTextColor = this.nodeTextColor || this.primaryTextColor, this.actorBorder = this.actorBorder || this.primaryBorderColor, this.actorBkg = this.actorBkg || this.mainBkg, this.actorTextColor = this.actorTextColor || this.primaryTextColor, this.actorLineColor = this.actorLineColor || this.actorBorder, this.labelBoxBkgColor = this.labelBoxBkgColor || this.actorBkg, this.signalColor = this.signalColor || this.textColor, this.signalTextColor = this.signalTextColor || this.textColor, this.labelBoxBorderColor = this.labelBoxBorderColor || this.actorBorder, this.labelTextColor = this.labelTextColor || this.actorTextColor, this.loopTextColor = this.loopTextColor || this.actorTextColor, this.activationBorderColor = this.activationBorderColor || x(this.secondaryColor, 10), this.activationBkgColor = this.activationBkgColor || this.secondaryColor, this.sequenceNumberColor = this.sequenceNumberColor || C(this.lineColor);
      let e2 = `#ECECFE`, t2 = `#E9E9F1`, n2 = S(e2, {
        h: 180,
        l: 5
      });
  ...
  Ct = (_l = class {
    ...
    updateColors() {
      var _a2, _b2, _c2, _d2, _e3, _f2, _g2, _h2, _i2, _j2, _k2;
      this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#FFFFFF`), this.secondaryColor = this.secondaryColor || S(this.primaryColor, {
        h: -120
      }), this.tertiaryColor = this.tertiaryColor || S(this.primaryColor, {
        h: 180,
        l: 5
      ...
      for (let e3 = 0; e3 < this.THEME_COLOR_LIMIT; e3++) this.darkMode ? this[`cScalePeer` + e3] = this[`cScalePeer` + e3] || b(this[`cScale` + e3], 10) : this[`cScalePeer` + e3] = this[`cScalePeer` + e3] || x(this[`cScale` + e3], 10);
      this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
      for (let e3 = 0; e3 < this.THEME_COLOR_LIMIT; e3++) this[`cScaleLabel` + e3] = x(this[`cScale` + e3], 75);
      let e2 = this.darkMode ? -4 : -1;
      for (let t2 = 0; t2 < 5; t2++) this[`surface` + t2] = this[`surface` + t2] || S(this.mainBkg, {
        h: 180,
        s: -15,
  ...
  X = {
    ...
    neutral: {
      getThemeVariables: mt
    },
    neo: {
      getThemeVariables: gt
    },
    "neo-dark": {
      getThemeVariables: q
    },
    redux: {
      getThemeVariables: vt
    },
    "redux-dark": {
      getThemeVariables: bt
    },
    "redux-color": {
      getThemeVariables: St
    },
  ...
  Tt = n((e2, t2 = ``) => Object.keys(e2).reduce((n2, r2) => Array.isArray(e2[r2]) ? n2 : typeof e2[r2] == `object` && e2[r2] !== null ? [
    ...n2,
    t2 + r2,
    ...Tt(e2[r2], ``)
  ] : [
  ...
  Dt = n((e2) => {
    if (t.debug(`sanitizeDirective called with`, e2), !(typeof e2 != `object` || !e2)) {
      ...
      for (let n2 of Object.keys(e2)) {
        if (t.debug(`Checking key`, n2), n2.startsWith(`__`) || n2.includes(`proto`) || n2.includes(`constr`) || !Et.has(n2) || e2[n2] == null) {
          t.debug(`sanitize deleting key: `, n2), delete e2[n2];
          continue;
        }
        if (typeof e2[n2] == `object`) {
          t.debug(`sanitizing object`, n2), Dt(e2[n2]);
          continue;
        }
        for (let r2 of [
          `themeCSS`,
          `fontFamily`,
          `altFontFamily`
        ]) n2.includes(r2) && (t.debug(`sanitizing css option`, n2), e2[n2] = Ot(e2[n2]));
      }
  ...
  Pt = n((e2, t2) => {
    let n2 = H({}, e2), r2 = {};
    for (let e3 of t2) Vt(e3), r2 = H(r2, e3);
    if (n2 = H(n2, r2), r2.theme && r2.theme in X) {
      let e3 = H(H({}, jt).themeVariables || {}, r2.themeVariables);
      n2.theme && n2.theme in X && (n2.themeVariables = X[n2.theme].getThemeVariables(e3));
    }
    return Nt = n2, qt(Nt), Nt;
  }, `updateCurrentConfig`);
  Ft = n((e2) => ($ = H({}, kt), $ = H($, e2), e2.theme && X[e2.theme] && ($.themeVariables = X[e2.theme].getThemeVariables(e2.themeVariables)), Pt($, Mt), $), `setSiteConfig`);
  It = n((e2) => {
    jt = H({}, e2);
  }, `saveConfigFromInitialize`);
  Lt = n((e2) => ($ = H($, e2), Pt($, Mt), $), `updateSiteConfig`);
  Rt = n(() => H({}, $), `getSiteConfig`);
  zt = n((e2) => (qt(e2), H(Nt, e2), Bt()), `setConfig`);
  Bt = n(() => H({}, Nt), `getConfig`);
  Vt = n((e2) => {
    e2 && ([
      `secure`,
      ...
      typeof e2[t2] == `string` && (e2[t2].includes(`<`) || e2[t2].includes(`>`) || e2[t2].includes(`url(data:`)) && delete e2[t2], typeof e2[t2] == `object` && Vt(e2[t2]);
    }));
  }, `sanitize`);
  Ht = n((e2) => {
    var _a2;
    Dt(e2), e2.fontFamily && !((_a2 = e2.themeVariables) == null ? void 0 : _a2.fontFamily) && (e2.themeVariables = {
      ...e2.themeVariables,
  ...
  Gt = {};
  Kt = n((e2) => {
    Gt[e2] || (t.warn(Wt[e2]), Gt[e2] = true);
  }, `issueWarning`);
  qt = n((e2) => {
    e2 && (e2.lazyLoadedDiagrams || e2.loadExternalDiagramsAtStartup) && Kt(`LAZY_LOAD_DEPRECATED`);
  }, `checkConfig`);
  Jt = n(() => {
    let e2 = {};
    jt && (e2 = H(e2, jt));
    for (let t2 of Mt) e2 = H(e2, t2);
    return e2;
  }, `getUserDefinedConfig`);
  Yt = n((e2) => {
    var _a2, _b2;
    return ((_a2 = e2.flowchart) == null ? void 0 : _a2.htmlLabels) != null && Kt(`FLOWCHART_HTML_LABELS_DEPRECATED`), At(e2.htmlLabels ?? ((_b2 = e2.flowchart) == null ? void 0 : _b2.htmlLabels) ?? true);
  }, `getEffectiveHtmlLabels`);
  Xt = /<br\s*\/?>/gi;
  Zt = n((e2) => e2 ? cn(e2).replace(/\\n/g, `#br#`).split(`#br#`) : [
    ``
  ], `getRows`);
  Qt = /* @__PURE__ */ (() => {
    let e2 = false;
  ...
  let en, tn, rn, an, on, sn, cn, un, dn, pn, mn, hn, gn, _n, bn, Cn, wn, Dn, On, kn;
  en = n((e2) => (Qt(), I.sanitize(e2)), `removeScript`);
  tn = n((e2, t2) => {
    if (Yt(t2)) {
      let n2 = t2.securityLevel;
      n2 === `antiscript` || n2 === `strict` || n2 === `sandbox` ? e2 = en(e2) : n2 !== `loose` && (e2 = cn(e2), e2 = e2.replace(/</g, `&lt;`).replace(/>/g, `&gt;`), e2 = e2.replace(/=/g, `&equals;`), e2 = sn(e2));
    }
    return e2;
  }, `sanitizeMore`);
  nn = n((e2, t2) => e2 && (e2 = t2.dompurifyConfig ? I.sanitize(tn(e2, t2), t2.dompurifyConfig).toString() : I.sanitize(tn(e2, t2), {
    FORBID_TAGS: [
      `style`
    ]
  }).toString(), e2), `sanitizeText`);
  rn = n((e2, t2) => typeof e2 == `string` ? nn(e2, t2) : e2.flat().map((e3) => nn(e3, t2)), `sanitizeTextOrArray`);
  an = n((e2) => Xt.test(e2), `hasBreaks`);
  on = n((e2) => e2.split(Xt), `splitBreaks`);
  sn = n((e2) => e2.replace(/#br#/g, `<br/>`), `placeholderToBreak`);
  cn = n((e2) => e2.replace(Xt, `#br#`), `breakToPlaceholder`);
  ln = n((e2) => {
    let t2 = ``;
  ...
  fn = n(function(e2) {
    ...
    for (let e3 = 0; e3 < t2.length; e3++) {
      ...
      if (r2 === `,` && e3 > 0 && e3 + 1 < t2.length) {
        ...
        mn(i2, a2) && (r2 = i2 + `,` + a2, e3++, n2.pop());
      }
      n2.push(hn(r2));
    }
    return n2.join(``);
  }, `parseGenericTypes`);
  pn = n((e2, t2) => Math.max(0, e2.split(t2).length - 1), `countOccurrence`);
  mn = n((e2, t2) => {
    let n2 = pn(e2, `~`), r2 = pn(t2, `~`);
    return n2 === 1 && r2 === 1;
  }, `shouldCombineSets`);
  hn = n((e2) => {
    let t2 = pn(e2, `~`), n2 = false;
    if (t2 <= 1) return e2;
  ...
  gn = n(() => window.MathMLElement !== void 0, `isMathMLSupported`);
  _n = /\$\$(.*)\$\$/g;
  vn = n((e2) => {
    var _a2;
    return (((_a2 = e2.match(_n)) == null ? void 0 : _a2.length) ?? 0) > 0;
  }, `hasKatex`);
  yn = n(async (e2, t2) => {
    var _a2;
    let n2 = document.createElement(`div`);
    n2.innerHTML = await xn(e2, t2), n2.id = `katex-temp`, n2.style.visibility = `hidden`, n2.style.position = `absolute`, n2.style.top = `0`, (_a2 = document.querySelector(`body`)) == null ? void 0 : _a2.insertAdjacentElement(`beforeend`, n2);
    let r2 = {
  ...
  bn = n(async (e2, t2) => {
    if (!vn(e2)) return e2;
    if (!(gn() || t2.legacyMathML || t2.forceLegacyMathML)) return e2.replace(_n, `MathML is unsupported in this environment.`);
    {
      let { default: n2 } = await s(async () => {
        let { default: e3 } = await import("./katex-Dn_2n6OD.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        });
        return {
      ...
      }, []), r2 = t2.forceLegacyMathML || !gn() && t2.legacyMathML ? `htmlAndMathml` : `mathml`;
      return e2.split(Xt).map((e3) => vn(e3) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">${e3}</div>` : `<div>${e3}</div>`).join(``).replace(_n, (e3, t3) => n2.renderToString(t3, {
        throwOnError: true,
        displayMode: true,
        output: r2
      }).replace(/\n/g, ` `).replace(/<annotation.*<\/annotation>/g, ``));
    }
    return e2.replace(_n, `Katex is not supported in @mermaid-js/tiny. Please use the full mermaid library.`);
  }, `renderKatexUnsanitized`);
  xn = n(async (e2, t2) => nn(await bn(e2, t2), t2), `renderKatexSanitized`);
  Sn = {
    getRows: Zt,
    sanitizeText: nn,
  ...
  On = n((e2, n2, r2, i2) => {
    let a2 = ``;
    return e2 in Dn && Dn[e2] ? a2 = Dn[e2]({
      ...r2,
      svgId: i2
    }) : t.warn(`No theme found for ${e2}`), ` & {
  ...
  & .edge-thickness-normal {
    stroke-width: ${r2.strokeWidth ?? 1}px;
  }
  ...
  ${a2}
  .node .neo-node {
    stroke: ${r2.nodeBorder};
  }

  [data-look="neo"].node rect, [data-look="neo"].cluster rect, [data-look="neo"].node polygon {
    stroke: ${r2.useGradient ? `url(` + i2 + `-gradient)` : r2.nodeBorder};
    filter: ${r2.dropShadow ? r2.dropShadow.replace(`url(#drop-shadow)`, `url(${i2}-drop-shadow)`) : `none`};
  }
  ...
  [data-look="neo"].icon-shape .icon {
    fill: ${r2.useGradient ? `url(` + i2 + `-gradient)` : r2.nodeBorder};
    filter: ${r2.dropShadow ? r2.dropShadow.replace(`url(#drop-shadow)`, `url(${i2}-drop-shadow)`) : `none`};
  }
...
`;
  ...
  let Mn, Nn, Pn, Fn, Un, Wn, Xn, Zn, er;
  Mn = ``;
  Nn = ``;
  Pn = ``;
  Fn = n((e2) => nn(e2, Bt()), `sanitizeText`);
  In = n(() => {
    Mn = ``, Pn = ``, Nn = ``;
  }, `clear`);
  Ln = n((e2) => {
    Mn = Fn(e2).replace(/^\s+/g, ``);
  }, `setAccTitle`);
  Rn = n(() => Mn, `getAccTitle`);
  zn = n((e2) => {
    Pn = Fn(e2).replace(/\n\s+/g, `
`);
  ...
  Bn = n(() => Pn, `getAccDescription`);
  Vn = n((e2) => {
    Nn = Fn(e2);
  }, `setDiagramTitle`);
  Hn = n(() => Nn, `getDiagramTitle`);
  Un = t;
  Wn = e;
  Gn = Bt;
  Kn = zt;
  qn = kt;
  Jn = n((e2) => nn(e2, Gn()), `sanitizeText`);
  Yn = En;
  Xn = n(() => jn, `getCommonDb`);
  Zn = {};
  Qn = n((e2, t2, n2) => {
    var _a2;
    Zn[e2] && Un.warn(`Diagram with id ${e2} already registered. Overwriting.`), Zn[e2] = t2, n2 && z(e2, n2), kn(e2, t2.styles), (_a2 = t2.injectUtils) == null ? void 0 : _a2.call(t2, Un, Wn, Gn, Jn, Yn, Xn(), () => {
    });
  }, `registerDiagram`);
  $n = n((e2) => {
    if (e2 in Zn) return Zn[e2];
    throw new er(e2);
  }, `getDiagram`);
  er = (_m = class extends Error {
    constructor(e2) {
      super(`Diagram ${e2} not found.`);
    }
  }, n(_m, `DiagramNotFoundError`), _m);
})();
export {
  b as $,
  Xt as A,
