...
import { Cn as t, In as n, Jn as r, Ln as i, Nn as a, Pn as o, Sn as s, _n as c, bn as l, hn as u, pn as d, un as f, yn as p } from "./index-4Ava25sD.js";
function m(e2) {
...
var q = (function() {
  var e2 = r(function(e3, t3, n3, r2) {
    ...
    return n3;
  }, `o`), t2 = [1, 9], n2 = [1, 10], i2 = [1, 5, 10, 12], a2 = { trace: r(function() {
  }, `trace`), yy: {}, symbols_: { error: 2, start: 3, SANKEY: 4, NEWLINE: 5, csv: 6, opt_eof: 7, record: 8, csv_tail: 9, EOF: 10, "field[source]": 11, COMMA: 12, "field[target]": 13, "field[value]": 14, field: 15, escaped: 16, non_escaped: 17, DQUOTE: 18, ESCAPED_TEXT: 19, NON_ESCAPED_TEXT: 20, $accept: 0, $end: 1 }, terminals_: { 2: `error`, 4: `SANKEY`, 5: `NEWLINE`, 10: `EOF`, 11: `field[source]`, 12: `COMMA`, 13: `field[target]`, 14: `field[value]`, 18: `DQUOTE`, 19: `ESCAPED_TEXT`, 20: `NON_ESCAPED_TEXT` }, productions_: [0, [3, 4], [6, 2], [9, 2], [9, 0], [7, 1], [7, 0], [8, 5], [15, 1], [15, 1], [16, 3], [17, 1]], performAction: r(function(e3, t3, n3, r2, i3, a3, o3) {
    var s2 = a3.length - 1;
    switch (i3) {
      case 7:
        let e4 = r2.findOrCreateNode(a3[s2 - 4].trim().replaceAll(`""`, `"`)), t4 = r2.findOrCreateNode(a3[s2 - 2].trim().replaceAll(`""`, `"`)), n4 = parseFloat(a3[s2].trim());
        r2.addLink(e4, t4, n4);
        break;
      case 8:
      case 9:
  ...
  }, `anonymous`), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, { 5: [1, 3] }, { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: t2, 20: n2 }, { 1: [2, 6], 7: 11, 10: [1, 12] }, e2(n2, [2, 4], { 9: 13, 5: [1, 14] }), { 12: [1, 15] }, e2(i2, [2, 8]), e2(i2, [2, 9]), { 19: [1, 16] }, e2(i2, [2, 11]), { 1: [2, 1] }, { 1: [2, 5] }, e2(n2, [2, 2]), { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: t2, 20: n2 }, { 15: 18, 16: 7, 17: 8, 18: t2, 20: n2 }, { 18: [1, 19] }, e2(n2, [2, 3]), { 12: [1, 20] }, e2(i2, [2, 10]), { 15: 21, 16: 7, 17: 8, 18: t2, 20: n2 }, e2([1, 5, 10], [2, 7])], defaultActions: { 11: [2, 1], 12: [2, 5] }, parseError: r(function(e3, t3) {
    ...
    var t3 = this, n3 = [0], i3 = [], a3 = [null], o3 = [], s2 = this.table, c2 = ``, l2 = 0, u2 = 0, d2 = 0, f2 = 2, p2 = 1, m2 = o3.slice.call(arguments, 1), h2 = Object.create(this.lexer), g2 = { yy: {} };
    ...
    for (var S2, C2, w2, T2, E2, D2 = {}, O2, k2, A2, j2; ; ) {
      if (w2 = n3[n3.length - 1], this.defaultActions[w2] ? T2 = this.defaultActions[w2] : (S2 ?? (S2 = x2()), T2 = s2[w2] && s2[w2][S2]), T2 === void 0 || !T2.length || !T2[0]) {
        var M2 = ``;
        for (O2 in j2 = [], s2[w2]) this.terminals_[O2] && O2 > f2 && j2.push(`'` + this.terminals_[O2] + `'`);
        M2 = h2.showPosition ? `Parse error on line ` + (l2 + 1) + `:
` + h2.showPosition() + `
Expecting ` + j2.join(`, `) + `, got '` + (this.terminals_[S2] || S2) + `'` : `Parse error on line ` + (l2 + 1) + `: Unexpected ` + (S2 == p2 ? `end of input` : `'` + (this.terminals_[S2] || S2) + `'`), this.parseError(M2, { text: h2.match, token: this.terminals_[S2] || S2, line: h2.yylineno, loc: v2, expected: j2 });
      }
      if (T2[0] instanceof Array && T2.length > 1) throw Error(`Parse Error: multiple actions possible at state: ` + w2 + `, token: ` + S2);
      switch (T2[0]) {
        case 1:
          n3.push(S2), a3.push(h2.yytext), o3.push(h2.yylloc), n3.push(T2[1]), S2 = null, C2 ? (S2 = C2, C2 = null) : (u2 = h2.yyleng, c2 = h2.yytext, l2 = h2.yylineno, v2 = h2.yylloc, d2 > 0 && d2--);
          break;
        case 2:
          if (k2 = this.productions_[T2[1]][1], D2.$ = a3[a3.length - k2], D2._$ = { first_line: o3[o3.length - (k2 || 1)].first_line, last_line: o3[o3.length - 1].last_line, first_column: o3[o3.length - (k2 || 1)].first_column, last_column: o3[o3.length - 1].last_column }, y2 && (D2._$.range = [o3[o3.length - (k2 || 1)].range[0], o3[o3.length - 1].range[1]]), E2 = this.performAction.apply(D2, [c2, u2, l2, g2.yy, T2[1], a3, o3].concat(m2)), E2 !== void 0) return E2;
          k2 && (n3 = n3.slice(0, -1 * k2 * 2), a3 = a3.slice(0, -1 * k2), o3 = o3.slice(0, -1 * k2)), n3.push(this.productions_[T2[1]][0]), a3.push(D2.$), o3.push(D2._$), A2 = s2[n3[n3.length - 2]][n3[n3.length - 1]], n3.push(A2);
          break;
        case 3:
          return true;
      }
...
` + this.showPosition(), { text: ``, token: null, line: this.yylineno });
  ...
  return r(o2, `Parser`), o2.prototype = a2, a2.Parser = o2, new o2();
})();
q.parser = q;
var J = q, Y = [], X = [], Z = /* @__PURE__ */ new Map(), se = r(() => {
  Y = [], X = [], Z = /* @__PURE__ */ new Map(), d();
}, `clear`), ce = (_a = class {
  constructor(e2, t2, n2 = 0) {
    this.source = e2, this.target = t2, this.value = n2;
  }
}, r(_a, `SankeyLink`), _a), le = r((e2, t2, n2) => {
  Y.push(new ce(e2, t2, n2));
}, `addLink`), ue = (_b = class {
  constructor(e2) {
    this.ID = e2;
  }
}, r(_b, `SankeyNode`), _b), Q = { nodesMap: Z, getConfig: r(() => s().sankey, `getConfig`), getNodes: r(() => X, `getNodes`), getLinks: r(() => Y, `getLinks`), getGraph: r(() => ({ nodes: X.map((e2) => ({ id: e2.ID })), links: Y.map((e2) => ({ source: e2.source.ID, target: e2.target.ID, value: e2.value })) }), `getGraph`), addLink: le, findOrCreateNode: r((e2) => {
  e2 = u.sanitizeText(e2, s());
  let t2 = Z.get(e2);
  return t2 === void 0 && (t2 = new ue(e2), Z.set(e2, t2), X.push(t2)), t2;
}, `findOrCreateNode`), getAccTitle: l, setAccTitle: o, getAccDescription: p, setAccDescription: a, getDiagramTitle: t, setDiagramTitle: n, clear: se }, $ = (_c = class {
  static next(t2) {
...
}, r(_c, `Uid`), _c.count = 0, _c), de = { left: b, right: x, center: C, justify: S }, fe = { draw: r(function(t2, n2, a2, o2) {
  let { securityLevel: l2, sankey: u2 } = s(), d2 = c.sankey, p2;
  l2 === `sandbox` && (p2 = f(`#i` + n2));
  let m2 = f(l2 === `sandbox` ? p2.nodes()[0].contentDocument.body : `body`), g2 = l2 === `sandbox` ? m2.select(`[id="${n2}"]`) : f(`[id="${n2}"]`), _2 = (u2 == null ? void 0 : u2.width) ?? d2.width, v2 = (u2 == null ? void 0 : u2.height) ?? d2.width, y2 = (u2 == null ? void 0 : u2.useMaxWidth) ?? d2.useMaxWidth, b2 = (u2 == null ? void 0 : u2.nodeAlignment) ?? d2.nodeAlignment, x2 = (u2 == null ? void 0 : u2.prefix) ?? d2.prefix, S2 = (u2 == null ? void 0 : u2.suffix) ?? d2.suffix, C2 = (u2 == null ? void 0 : u2.showValues) ?? d2.showValues, w2 = o2.db.getGraph(), T2 = de[b2];
  P().nodeId((e2) => e2.id).nodeWidth(10).nodePadding(10 + (C2 ? 15 : 0)).nodeAlign(T2).extent([[0, 0], [_2, v2]])(w2);
  let E2 = e(h);
  g2.append(`g`).attr(`class`, `nodes`).selectAll(`.node`).data(w2.nodes).join(`g`).attr(`class`, `node`).attr(`id`, (e2) => (e2.uid = $.next(`node-`)).id).attr(`transform`, function(e2) {
    return `translate(` + e2.x0 + `,` + e2.y0 + `)`;
  }).attr(`x`, (e2) => e2.x0).attr(`y`, (e2) => e2.y0).append(`rect`).attr(`height`, (e2) => e2.y1 - e2.y0).attr(`width`, (e2) => e2.x1 - e2.x0).attr(`fill`, (e2) => E2(e2.id));
  let D2 = r(({ id: e2, value: t3 }) => C2 ? `${e2}
${x2}${Math.round(t3 * 100) / 100}${S2}` : e2, `getText`);
  g2.append(`g`).attr(`class`, `node-labels`).attr(`font-size`, 14).selectAll(`text`).data(w2.nodes).join(`text`).attr(`x`, (e2) => e2.x0 < _2 / 2 ? e2.x1 + 6 : e2.x0 - 6).attr(`y`, (e2) => (e2.y1 + e2.y0) / 2).attr(`dy`, `${C2 ? `0` : `0.35`}em`).attr(`text-anchor`, (e2) => e2.x0 < _2 / 2 ? `start` : `end`).text(D2);
  let O2 = g2.append(`g`).attr(`class`, `links`).attr(`fill`, `none`).attr(`stroke-opacity`, 0.5).selectAll(`.link`).data(w2.links).join(`g`).attr(`class`, `link`).style(`mix-blend-mode`, `multiply`), k2 = (u2 == null ? void 0 : u2.linkColor) ?? `gradient`;
  if (k2 === `gradient`) {
    let e2 = O2.append(`linearGradient`).attr(`id`, (e3) => (e3.uid = $.next(`linearGradient-`)).id).attr(`gradientUnits`, `userSpaceOnUse`).attr(`x1`, (e3) => e3.source.x1).attr(`x2`, (e3) => e3.target.x0);
    e2.append(`stop`).attr(`offset`, `0%`).attr(`stop-color`, (e3) => E2(e3.source.id)), e2.append(`stop`).attr(`offset`, `100%`).attr(`stop-color`, (e3) => E2(e3.target.id));
  }
  let A2;
  switch (k2) {
    case `gradient`:
      A2 = r((e2) => e2.uid, `coloring`);
      break;
    case `source`:
      A2 = r((e2) => E2(e2.source.id), `coloring`);
      break;
    case `target`:
      A2 = r((e2) => E2(e2.target.id), `coloring`);
      break;
    default:
      A2 = k2;
  }
  O2.append(`path`).attr(`d`, K()).attr(`stroke`, A2).attr(`stroke-width`, (e2) => Math.max(1, e2.width)), i(void 0, g2, 0, y2);
}, `draw`) }, pe = r((e2) => e2.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, ``).replaceAll(/([\n\r])+/g, `
`).trim(), `prepareTextForParsing`), me = r((e2) => `.label {
