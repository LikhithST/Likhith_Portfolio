var _a, _b;
import { b1 as Se, a2 as _e, a7 as ee, b4 as Ae, a3 as ke, b2 as Fe, b as r, a5 as Et, aF as qt, a$ as vt, F as Pe, u as ve, T as z, a_ as Ce, ag as Le } from "./index-ZamPsWkW.js";
import { l as te } from "./linear-CN2gQIx8.js";
import "./init-Gi6I4Gst.js";
import "./defaultLocale-CrowFXzY.js";
var Ct = (function() {
  var t = r(function(Y, s, l, u) {
  ...
  }, "trace"), yy: {}, symbols_: { error: 2, idStringToken: 3, ALPHA: 4, NUM: 5, NODE_STRING: 6, DOWN: 7, MINUS: 8, DEFAULT: 9, COMMA: 10, COLON: 11, AMP: 12, BRKT: 13, MULT: 14, UNICODE_TEXT: 15, styleComponent: 16, UNIT: 17, SPACE: 18, STYLE: 19, PCT: 20, idString: 21, style: 22, stylesOpt: 23, classDefStatement: 24, CLASSDEF: 25, start: 26, eol: 27, QUADRANT: 28, document: 29, line: 30, statement: 31, axisDetails: 32, quadrantDetails: 33, points: 34, title: 35, title_value: 36, acc_title: 37, acc_title_value: 38, acc_descr: 39, acc_descr_value: 40, acc_descr_multiline_value: 41, section: 42, text: 43, point_start: 44, point_x: 45, point_y: 46, class_name: 47, "X-AXIS": 48, "AXIS-TEXT-DELIMITER": 49, "Y-AXIS": 50, QUADRANT_1: 51, QUADRANT_2: 52, QUADRANT_3: 53, QUADRANT_4: 54, NEWLINE: 55, SEMI: 56, EOF: 57, alphaNumToken: 58, textNoTagsToken: 59, STR: 60, MD_STR: 61, alphaNum: 62, PUNCTUATION: 63, PLUS: 64, EQUALS: 65, DOT: 66, UNDERSCORE: 67, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "ALPHA", 5: "NUM", 6: "NODE_STRING", 7: "DOWN", 8: "MINUS", 9: "DEFAULT", 10: "COMMA", 11: "COLON", 12: "AMP", 13: "BRKT", 14: "MULT", 15: "UNICODE_TEXT", 17: "UNIT", 18: "SPACE", 19: "STYLE", 20: "PCT", 25: "CLASSDEF", 28: "QUADRANT", 35: "title", 36: "title_value", 37: "acc_title", 38: "acc_title_value", 39: "acc_descr", 40: "acc_descr_value", 41: "acc_descr_multiline_value", 42: "section", 44: "point_start", 45: "point_x", 46: "point_y", 47: "class_name", 48: "X-AXIS", 49: "AXIS-TEXT-DELIMITER", 50: "Y-AXIS", 51: "QUADRANT_1", 52: "QUADRANT_2", 53: "QUADRANT_3", 54: "QUADRANT_4", 55: "NEWLINE", 56: "SEMI", 57: "EOF", 60: "STR", 61: "MD_STR", 63: "PUNCTUATION", 64: "PLUS", 65: "EQUALS", 66: "DOT", 67: "UNDERSCORE" }, productions_: [0, [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [21, 1], [21, 2], [22, 1], [22, 2], [23, 1], [23, 3], [24, 5], [26, 2], [26, 2], [26, 2], [29, 0], [29, 2], [30, 2], [31, 0], [31, 1], [31, 2], [31, 1], [31, 1], [31, 1], [31, 2], [31, 2], [31, 2], [31, 1], [31, 1], [34, 4], [34, 5], [34, 5], [34, 6], [32, 4], [32, 3], [32, 2], [32, 4], [32, 3], [32, 2], [33, 2], [33, 2], [33, 2], [33, 2], [27, 1], [27, 1], [27, 1], [43, 1], [43, 2], [43, 1], [43, 1], [62, 1], [62, 2], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [59, 1], [59, 1], [59, 1]], performAction: r(function(s, l, u, d, A, e, ht) {
    var n = e.length - 1;
    switch (A) {
      case 23:
        this.$ = e[n];
    ...
    for (var At in this.yy) Object.prototype.hasOwnProperty.call(this.yy, At) && (j.yy[At] = this.yy[At]);
    ...
    for (var B, G, W, Ft, rt = {}, pt, M, $t, yt; ; ) {
      if (G = u[u.length - 1], this.defaultActions[G] ? W = this.defaultActions[G] : ((B === null || typeof B > "u") && (B = Jt()), W = ht[G] && ht[G][B]), typeof W > "u" || !W.length || !W[0]) {
        var Pt = "";
        yt = [];
        for (pt in ht[G]) this.terminals_[pt] && pt > Te && yt.push("'" + this.terminals_[pt] + "'");
        D.showPosition ? Pt = "Parse error on line " + (gt + 1) + `:
` + D.showPosition() + `
Expecting ` + yt.join(", ") + ", got '" + (this.terminals_[B] || B) + "'" : Pt = "Parse error on line " + (gt + 1) + ": Unexpected " + (B == Zt ? "end of input" : "'" + (this.terminals_[B] || B) + "'"), this.parseError(Pt, { text: D.match, token: this.terminals_[B] || B, line: D.yylineno, loc: kt, expected: yt });
      }
      if (W[0] instanceof Array && W.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + G + ", token: " + B);
      switch (W[0]) {
        case 1:
          u.push(B), A.push(D.yytext), e.push(D.yylloc), u.push(W[1]), B = null, Kt = D.yyleng, n = D.yytext, gt = D.yylineno, kt = D.yylloc;
          break;
        case 2:
          if (M = this.productions_[W[1]][1], rt.$ = A[A.length - M], rt._$ = { first_line: e[e.length - (M || 1)].first_line, last_line: e[e.length - 1].last_line, first_column: e[e.length - (M || 1)].first_column, last_column: e[e.length - 1].last_column }, me && (rt._$.range = [e[e.length - (M || 1)].range[0], e[e.length - 1].range[1]]), Ft = this.performAction.apply(rt, [n, Kt, gt, j.yy, W[1], A, e].concat(qe)), typeof Ft < "u") return Ft;
    ...
    var Y = { EOF: 1, parseError: r(function(l, u) {
...
var Ee = Ct, I = Le(), De = (_a = class {
  ...
  getDefaultConfig() {
    ...
    return { showXAxis: true, showYAxis: true, showTitle: true, chartHeight: ((_a2 = z.quadrantChart) == null ? void 0 : _a2.chartWidth) || 500, chartWidth: ((_b2 = z.quadrantChart) == null ? void 0 : _b2.chartHeight) || 500, titlePadding: ((_c = z.quadrantChart) == null ? void 0 : _c.titlePadding) || 10, titleFontSize: ((_d = z.quadrantChart) == null ? void 0 : _d.titleFontSize) || 20, quadrantPadding: ((_e2 = z.quadrantChart) == null ? void 0 : _e2.quadrantPadding) || 5, xAxisLabelPadding: ((_f = z.quadrantChart) == null ? void 0 : _f.xAxisLabelPadding) || 5, yAxisLabelPadding: ((_g = z.quadrantChart) == null ? void 0 : _g.yAxisLabelPadding) || 5, xAxisLabelFontSize: ((_h = z.quadrantChart) == null ? void 0 : _h.xAxisLabelFontSize) || 16, yAxisLabelFontSize: ((_i = z.quadrantChart) == null ? void 0 : _i.yAxisLabelFontSize) || 16, quadrantLabelFontSize: ((_j = z.quadrantChart) == null ? void 0 : _j.quadrantLabelFontSize) || 16, quadrantTextTopPadding: ((_k = z.quadrantChart) == null ? void 0 : _k.quadrantTextTopPadding) || 5, pointTextPadding: ((_l = z.quadrantChart) == null ? void 0 : _l.pointTextPadding) || 5, pointLabelFontSize: ((_m = z.quadrantChart) == null ? void 0 : _m.pointLabelFontSize) || 12, pointRadius: ((_n = z.quadrantChart) == null ? void 0 : _n.pointRadius) || 5, xAxisPosition: ((_o = z.quadrantChart) == null ? void 0 : _o.xAxisPosition) || "top", yAxisPosition: ((_p = z.quadrantChart) == null ? void 0 : _p.yAxisPosition) || "left", quadrantInternalBorderStrokeWidth: ((_q = z.quadrantChart) == null ? void 0 : _q.quadrantInternalBorderStrokeWidth) || 1, quadrantExternalBorderStrokeWidth: ((_r = z.quadrantChart) == null ? void 0 : _r.quadrantExternalBorderStrokeWidth) || 2 };
  }
...
function mt(t) {
  ...
  for (const p of t) {
    ...
    if (f === "radius") {
      if (ie(o)) throw new Tt(f, o, "number");
      a.radius = parseInt(o);
    } else if (f === "color") {
      ...
      if (ae(o)) throw new Tt(f, o, "number of pixels (eg. 10px)");
      a.strokeWidth = o;
...
function ue(t, a, p, f, o) {
  const x = mt(o);
  V.addPoints([{ x: p, y: f, text: O(t.text), className: a, ...x }]);
}
r(ue, "addPoint");
function xe(t, a) {
  V.addClass(t, mt(a));
...
` + t);
  ...
  Pe(b, q, T, ((_c = h.quadrantChart) == null ? void 0 : _c.useMaxWidth) ?? true), b.attr("viewBox", "0 0 " + T + " " + q), f.db.setHeight(q), f.db.setWidth(T);
...
}, "draw"), Be = { draw: we }, Qe = { parser: Ee, db: Ie, renderer: Be, styles: r(() => "", "styles") };
export {
  Qe as diagram
};
