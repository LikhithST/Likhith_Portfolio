import { Jn as __name, Sn as getConfig2, Yn as log, _ as positionNode, c as insertEdge, d as positionEdgeLabel, f as clear$1, h as insertNode, k as getSubGraphTitleMargins, l as insertEdgeLabel, m as insertCluster, p as clear2, s as clear, u as markers_default, v as setNodeElem, y as updateNodeBounds } from "./index-BgJKKt_a.js";
import "./reduce-Bhlg0TWY.js";
import { a as map_default } from "./flatten-0eP1SDYC.js";
import { n as isUndefined_default, t as Graph } from "./graphlib-QGOTNOh4.js";
import { t as clone_default } from "./clone-DaM9qnXM.js";
import { t as layout } from "./dagre-B_opa2fl.js";
function write(g) {
  var json = {
    options: {
...
var extractor = /* @__PURE__ */ __name((graph, depth) => {
  ...
  for (const node of nodes) {
    ...
    if (data == null ? void 0 : data.clusterNode) extractor(data.graph, depth + 1);
  }
}, "extractor");
...
var recursiveRender = /* @__PURE__ */ __name(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  ...
  await Promise.all(sortNodesByHierarchy(graph).map(async function(v) {
    ...
    if (node == null ? void 0 : node.clusterNode) {
      ...
      log.info("A regular node XBX1 - using the padding", node.id, "parent", node.parentId, node.width, node.height, node.x, node.y, "offsetY", node.offsetY, "parent", parent, parent == null ? void 0 : parent.offsetY, node);
      positionNode(node);
    }
  }));
  graph.edges().forEach(function(e) {
