var _a;
import { B as e, C as t, V as n, W as r, _ as i, a, c as o, d as s, v as c, y as l } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as u, h as d } from "./src-BWB47EtT.js";
import "./dist-DAHuMNYw.js";
import { i as f } from "./chunk-5PVQY5BW-DyH3Wf6D.js";
import { t as p } from "./chunk-426QAEUC-BhmuD47R.js";
...
import { t as m } from "./chunk-4BX2VUAB-BbK9EeOm.js";
import { t as h } from "./mermaid-parser.core-CeQTpQma.js";
var g = s.packet, _ = (_a = class {
  constructor() {
    this.packet = [], this.setAccTitle = n, this.getAccTitle = c, this.setDiagramTitle = r, this.getDiagramTitle = t, this.getAccDescription = i, this.setAccDescription = e;
  }
  getConfig() {
    let e2 = f({ ...g, ...l().packet });
  ...
  let i2 = r2.db, a2 = i2.getConfig(), { rowHeight: s2, paddingY: c2, bitWidth: l2, bitsPerRow: u2 } = a2, d2 = i2.getPacket(), f2 = i2.getDiagramTitle(), m2 = s2 + c2, h2 = m2 * (d2.length + 1) - (f2 ? 0 : s2), g2 = l2 * u2 + 2, _2 = p(t2);
  _2.attr(`viewBox`, `0 0 ${g2} ${h2}`), o(_2, h2, g2, a2.useMaxWidth);
  for (let [e3, t3] of d2.entries()) C(_2, t3, e3, a2);
