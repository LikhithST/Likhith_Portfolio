var _a;
import { B as e, C as t, U as n, V as r, W as i, Z as a, _ as o, a as s, b as c, nt as l, s as u, u as d, v as f } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as p, h as m, p as h } from "./src-BWB47EtT.js";
import { t as g } from "./channel-DWcnL53n.js";
import "./path-CAD_RBb9.js";
import "./dist-DAHuMNYw.js";
import "./array-BsT2bq1e.js";
import { c as _, g as v } from "./chunk-5PVQY5BW-DyH3Wf6D.js";
import "./line-CKQlCIK2.js";
import { n as ee, t as te } from "./chunk-XPW4576I-DW7HTQl0.js";
import "./chunk-BSJP7CBP-BBDH2KVu.js";
import "./identity-B9owP9ru.js";
import "./chunk-ZZ45TVLE-BXYMKbdF.js";
import "./chunk-X2U36JSP-6pKAqsHP.js";
import "./chunk-U2HBQHQK-B952OdWg.js";
import "./rough.esm-1QChbhql.js";
import { o as ne } from "./chunk-5FUZZQ4R-CDUw6eb4.js";
import "./chunk-ENJZ2VHE-Bbq48MLM.js";
import { r as y, t as b } from "./chunk-336JU56O-Cl2uMMXM.js";
import { t as x } from "./chunk-FMBD7UC4-DqZjeowl.js";
import { t as S } from "./chunk-YZCP3GAM-C30yAzNl.js";
import { t as C } from "./chunk-55IACEB6-B0Q28UJr.js";
import { t as w } from "./chunk-EDXVE4YY-OSeYB_F1.js";
var T = `flowchart-`, E = (_a = class {
  constructor() {
    this.vertexCounter = 0, this.config = c(), this.diagramId = ``, this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = true, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = r, this.setAccDescription = e, this.setDiagramTitle = i, this.getAccTitle = f, this.getAccDescription = o, this.getDiagramTitle = t, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen(`gen-2`);
  }
  sanitizeText(e2) {
    return u.sanitizeText(e2, this.config);
  }
  ...
  addVertex(e2, t2, n2, r2, i2, a2, o2 = {}, s2) {
    var _a2, _b;
...
` + s2 + `
    ...
    if (f2 === void 0 && (t2 === void 0 && n2 === void 0 && r2 != null && p.warn(`Style applied to unknown node "${e2}". This may indicate a typo. The node will be created automatically.`), f2 = { id: e2, labelType: `text`, domId: T + e2 + `-` + this.vertexCounter, styles: [], classes: [] }, this.vertices.set(e2, f2)), this.vertexCounter++, t2 === void 0 ? f2.text === void 0 && (f2.text = e2) : (this.config = c(), d2 = this.sanitizeText(t2.text.trim()), f2.labelType = t2.type, d2.startsWith(`"`) && d2.endsWith(`"`) && (d2 = d2.substring(1, d2.length - 1)), f2.text = d2), n2 !== void 0 && (f2.type = n2), r2 == null ? void 0 : r2.forEach((e3) => {
      f2.styles.push(e3);
    }), i2 == null ? void 0 : i2.forEach((e3) => {
      f2.classes.push(e3);
    }), a2 !== void 0 && (f2.dir = a2), f2.props === void 0 ? f2.props = o2 : o2 !== void 0 && Object.assign(f2.props, o2), l2 !== void 0) {
      if (l2.shape) {
        if (l2.shape !== l2.shape.toLowerCase() || l2.shape.includes(`_`)) throw Error(`No such shape: ${l2.shape}. Shape names should be lowercase.`);
        if (!ne(l2.shape)) throw Error(`No such shape: ${l2.shape}.`);
        f2.type = l2 == null ? void 0 : l2.shape;
      }
      (l2 == null ? void 0 : l2.label) && (f2.text = l2 == null ? void 0 : l2.label, f2.labelType = this.sanitizeNodeLabelType(l2 == null ? void 0 : l2.labelType)), (l2 == null ? void 0 : l2.icon) && (f2.icon = l2 == null ? void 0 : l2.icon, !((_a2 = l2.label) == null ? void 0 : _a2.trim()) && f2.text === e2 && (f2.text = ``)), (l2 == null ? void 0 : l2.form) && (f2.form = l2 == null ? void 0 : l2.form), (l2 == null ? void 0 : l2.pos) && (f2.pos = l2 == null ? void 0 : l2.pos), (l2 == null ? void 0 : l2.img) && (f2.img = l2 == null ? void 0 : l2.img, !((_b = l2.label) == null ? void 0 : _b.trim()) && f2.text === e2 && (f2.text = ``)), (l2 == null ? void 0 : l2.constraint) && (f2.constraint = l2.constraint), l2.w && (f2.assetWidth = Number(l2.w)), l2.h && (f2.assetHeight = Number(l2.h));
    }
  }
  addSingleLink(e2, t2, n2, r2) {
    ...
    p.info(`abc78 Got edge...`, i2);
    let a2 = n2.text;
    if (a2 !== void 0 && (i2.text = this.sanitizeText(a2.text.trim()), i2.text.startsWith(`"`) && i2.text.endsWith(`"`) && (i2.text = i2.text.substring(1, i2.text.length - 1)), i2.labelType = this.sanitizeNodeLabelType(a2.type)), n2 !== void 0 && (i2.type = n2.type, i2.stroke = n2.stroke, i2.length = n2.length > 10 ? 10 : n2.length), r2 && !this.edges.some((e3) => e3.id === r2)) i2.id = r2, i2.isUserDefinedId = true;
    else {
      let e3 = this.edges.filter((e4) => e4.start === i2.start && e4.end === i2.end);
      e3.length === 0 ? i2.id = _(i2.start, i2.end, { counter: 0, prefix: `L` }) : i2.id = _(i2.start, i2.end, { counter: e3.length + 1, prefix: `L` });
    }
    if (this.edges.length < (this.config.maxEdges ?? 500)) p.info(`Pushing edge...`), this.edges.push(i2);
...
You have to call mermaid.initialize.`);
  ...
  setClickFun(e2, t2, n2) {
    ...
    r2.length === 0 && r2.push(e2);
    let i2 = this.vertices.get(e2);
    i2 && (i2.haveCallback = true, this.funs.push(() => {
      let n3 = this.lookUpDomId(e2), i3 = document.querySelector(`[id="${n3}"]`);
  ...
  setLink(e2, t2, n2) {
    e2.split(`,`).forEach((e3) => {
      ...
      r2 !== void 0 && (r2.link = v.formatUrl(t2, this.config), r2.linkTarget = n2);
  ...
  setupToolTips(e2) {
    let t2 = S();
    h(e2).select(`svg`).selectAll(`g.node`).on(`mouseover`, (e3) => {
      var _a2;
      let n2 = h(e3.currentTarget), r2 = n2.attr(`title`);
      if (r2 === null) return;
      let i2 = (_a2 = e3.currentTarget) == null ? void 0 : _a2.getBoundingClientRect();
      t2.transition().duration(200).style(`opacity`, `.9`), t2.text(n2.attr(`title`)).style(`left`, window.scrollX + i2.left + (i2.right - i2.left) / 2 + `px`).style(`top`, window.scrollY + i2.bottom + `px`), t2.html(a.sanitize(r2)), n2.classed(`hover`, true);
    }).on(`mouseout`, (e3) => {
      t2.transition().duration(500).style(`opacity`, 0), h(e3.currentTarget).classed(`hover`, false);
    });
  }
  clear(e2 = `gen-2`) {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = ``, this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = true, this.version = e2, this.config = c(), s();
  }
  setGen(e2) {
  ...
  addSubGraph(e2, t2, n2) {
    ...
    }, `uniq`)(t2.flat()), o2 = a2.nodeList, s2 = a2.dir, l2 = c().flowchart ?? {};
    if (s2 ?? (s2 = l2.inheritDir ? this.getDirection() ?? c().direction ?? void 0 : void 0), this.version === `gen-1`) for (let e3 = 0; e3 < o2.length; e3++) o2[e3] = this.lookUpDomId(o2[e3]);
    r2 ?? (r2 = `subGraph` + this.subCount), i2 || (i2 = ``), i2 = this.sanitizeText(i2), this.subCount += 1;
    let u2 = { id: r2, nodes: o2, title: i2.trim(), classes: [], dir: s2, labelType: this.sanitizeNodeLabelType(n2 == null ? void 0 : n2.type) };
    return p.info(`Adding`, u2.id, u2.nodes, u2.dir), u2.nodes = this.makeUniq(u2, this.subGraphs).nodes, this.subGraphs.push(u2), this.subGraphLookup.set(r2, u2), r2;
  }
  getPosForId(e2) {
  ...
  getData() {
    let e2 = c(), t2 = [], n2 = [], r2 = this.getSubGraphs(), i2 = /* @__PURE__ */ new Map(), a2 = /* @__PURE__ */ new Map();
    ...
    for (let n3 = r2.length - 1; n3 >= 0; n3--) {
      let a3 = r2[n3];
      t2.push({ id: a3.id, label: a3.title, labelStyle: ``, labelType: a3.labelType, parentId: i2.get(a3.id), padding: 8, cssCompiledStyles: this.getCompiledStyles(a3.classes), cssClasses: a3.classes.join(` `), shape: `rect`, dir: a3.dir, isGroup: true, look: e2.look });
    }
    this.getVertices().forEach((n3) => {
      this.addNodeFromVertex(n3, t2, i2, a2, e2, e2.look || `classic`);
    });
    let o2 = this.getEdges();
    return o2.forEach((t3, r3) => {
      var _a2;
      let { arrowTypeStart: i3, arrowTypeEnd: a3 } = this.destructEdgeType(t3.type), s2 = [...o2.defaultStyle ?? []];
      t3.style && s2.push(...t3.style);
      let c2 = { id: _(t3.start, t3.end, { counter: r3, prefix: `L` }, t3.id), isUserDefinedId: t3.isUserDefinedId, start: t3.start, end: t3.end, type: t3.type ?? `normal`, label: t3.text, labelType: t3.labelType, labelpos: `c`, thickness: t3.stroke, minlen: t3.length, classes: (t3 == null ? void 0 : t3.stroke) === `invisible` ? `` : `edge-thickness-normal edge-pattern-solid flowchart-link`, arrowTypeStart: (t3 == null ? void 0 : t3.stroke) === `invisible` || (t3 == null ? void 0 : t3.type) === `arrow_open` ? `none` : i3, arrowTypeEnd: (t3 == null ? void 0 : t3.stroke) === `invisible` || (t3 == null ? void 0 : t3.type) === `arrow_open` ? `none` : a3, arrowheadStyle: `fill: #333`, cssCompiledStyles: this.getCompiledStyles(t3.classes), labelStyle: s2, style: s2, pattern: t3.stroke, look: e2.look, animate: t3.animate, animation: t3.animation, curve: t3.interpolate || this.edges.defaultInterpolate || ((_a2 = e2.flowchart) == null ? void 0 : _a2.curve) };
      n2.push(c2);
...
Expecting ` + O3.join(`, `) + `, got '` + (this.terminals_[y3] || y3) + `'` : `Parse error on line ` + (c3 + 1) + `: Unexpected ` + (y3 == f3 ? `end of input` : `'` + (this.terminals_[y3] || y3) + `'`), this.parseError(re3, { text: h3.match, token: this.terminals_[y3] || y3, line: h3.yylineno, loc: v3, expected: O3 });
  ...
  rt.lexer = (function() {
    return { EOF: 1, parseError: m(function(e3, t3) {
      if (this.yy.parser) this.yy.parser.parseError(e3, t3);
      else throw Error(e3);
    }, `parseError`), setInput: m(function(e3, t3) {
...
` + t3 + `^`;
    }, `showPosition`), test_match: m(function(e3, t3) {
      var n3, r3, i3;
...
var ae = ie, oe = m((e2, t2) => {
  let n2 = g;
  return l(n2(e2, `r`), n2(e2, `g`), n2(e2, `b`), t2);
}, `fade`), k = { parser: ae, get db() {
  return new E();
}, renderer: D, styles: m((e2) => `.label {
