...
import { B as n, C as r, K as i, L as a, V as o, W as s, _ as c, a as l, b as u, d, v as f, y as p } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as m, h, p as g } from "./src-BWB47EtT.js";
import "./dist-DAHuMNYw.js";
import { c as _, i as v } from "./chunk-5PVQY5BW-DyH3Wf6D.js";
import { t as y } from "./chunk-426QAEUC-BhmuD47R.js";
import "./identity-B9owP9ru.js";
import { a as b, i as x, n as S, r as C } from "./chunk-U2HBQHQK-B952OdWg.js";
...
import { t as w } from "./chunk-4BX2VUAB-BbK9EeOm.js";
import { t as T } from "./mermaid-parser.core-CeQTpQma.js";
import { t as E } from "./cytoscape.esm-D8iQ9qSD.js";
var D = t(((e2, t2) => {
  (function(n2, r2) {
...
}, `isArchitectureJunction`), re = h((e2) => e2.data(), `edgeData`), U = h((e2) => e2.data(), `nodeData`), W = d.architecture, G = (_a = class {
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.diagramId = ``, this.setAccTitle = o, this.getAccTitle = f, this.setDiagramTitle = s, this.getDiagramTitle = r, this.getAccDescription = c, this.setAccDescription = n, this.clear();
  }
  setDiagramId(e2) {
    this.diagramId = e2;
  }
...
`, `getStyles`), J = h((e2) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e2}</g>`, `wrapIcon`), Y = { prefix: `mermaid-architecture`, height: 80, width: 80, icons: { database: { body: J(`<path id="b" data-name="4" d="m20,57.86c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="c" data-name="3" d="m20,45.95c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="d" data-name="2" d="m20,34.05c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse id="e" data-name="1" cx="40" cy="22.14" rx="20" ry="7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="20" y1="57.86" x2="20" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="60" y1="57.86" x2="60" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>`) }, server: { body: J(`<rect x="17.5" y="17.5" width="45" height="45" rx="2" ry="2" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="32.5" x2="62.5" y2="32.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="47.5" x2="62.5" y2="47.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><g><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g>`) }, disk: { body: J(`<rect x="20" y="15" width="40" height="50" rx="1" ry="1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="14" ry="14.58" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="4" ry="4.17" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m37.51,42.52l-4.83,13.22c-.26.71-1.1,1.02-1.76.64l-4.18-2.42c-.66-.38-.81-1.26-.33-1.84l9.01-10.8c.88-1.05,2.56-.08,2.09,1.2Z" style="fill: #fff; stroke-width: 0px;"/>`) }, internet: { body: J(`<circle cx="40" cy="40" r="22.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="40" y1="17.5" x2="40" y2="62.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="40" x2="62.5" y2="40" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m39.99,17.51c-15.28,11.1-15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m40.01,17.51c15.28,11.1,15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="30.1" x2="60.25" y2="30.1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="49.9" x2="60.25" y2="49.9" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>`) }, cloud: { body: J(`<path d="m65,47.5c0,2.76-2.24,5-5,5H20c-2.76,0-5-2.24-5-5,0-1.87,1.03-3.51,2.56-4.36-.04-.21-.06-.42-.06-.64,0-2.6,2.48-4.74,5.65-4.97,1.65-4.51,6.34-7.76,11.85-7.76.86,0,1.69.08,2.5.23,2.09-1.57,4.69-2.5,7.5-2.5,6.1,0,11.19,4.38,12.28,10.17,2.14.56,3.72,2.51,3.72,4.83,0,.03,0,.07-.01.1,2.29.46,4.01,2.48,4.01,4.9Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>`) }, unknown: b, blank: { body: J(``) } } }, ae = h(async function(e2, t2, n2, r2) {
  let i2 = n2.getConfigField(`padding`), a2 = n2.getConfigField(`iconSize`), o2 = a2 / 2, s2 = a2 / 6, c2 = s2 / 2;
  await Promise.all(t2.edges().map(async (t3) => {
    var _a2, _b;
    let { source: a3, sourceDir: l2, sourceArrow: d2, sourceGroup: f2, target: p2, targetDir: m2, targetArrow: h2, targetGroup: g2, label: v2 } = re(t3), { x: y2, y: b2 } = t3[0].sourceEndpoint(), { x: x2, y: C2 } = t3[0].midpoint(), { x: w2, y: T2 } = t3[0].targetEndpoint(), E2 = i2 + 4;
    if (f2 && (F(l2) ? y2 += l2 === `L` ? -E2 : E2 : b2 += l2 === `T` ? -E2 : E2 + 18), g2 && (F(m2) ? w2 += m2 === `L` ? -E2 : E2 : T2 += m2 === `T` ? -E2 : E2 + 18), !f2 && ((_a2 = n2.getNode(a3)) == null ? void 0 : _a2.type) === `junction` && (F(l2) ? y2 += l2 === `L` ? o2 : -o2 : b2 += l2 === `T` ? o2 : -o2), !g2 && ((_b = n2.getNode(p2)) == null ? void 0 : _b.type) === `junction` && (F(m2) ? w2 += m2 === `L` ? o2 : -o2 : T2 += m2 === `T` ? o2 : -o2), t3[0]._private.rscratch) {
      let t4 = e2.insert(`g`);
      if (t4.insert(`path`).attr(`d`, `M ${y2},${b2} L ${x2},${C2} L${w2},${T2} `).attr(`class`, `edge`).attr(`id`, `${r2}-${_(a3, p2, { prefix: `L` })}`), d2) {
        let e3 = F(l2) ? M[l2](y2, s2) : y2 - c2, n3 = I(l2) ? M[l2](b2, s2) : b2 - c2;
        t4.insert(`polygon`).attr(`points`, j[l2](s2)).attr(`transform`, `translate(${e3},${n3})`).attr(`class`, `arrow`);
      }
      if (h2) {
        let e3 = F(m2) ? M[m2](w2, s2) : w2 - c2, n3 = I(m2) ? M[m2](T2, s2) : T2 - c2;
        t4.insert(`polygon`).attr(`points`, j[m2](s2)).attr(`transform`, `translate(${e3},${n3})`).attr(`class`, `arrow`);
      }
      if (v2) {
        let e3 = L(l2, m2) ? `XY` : F(l2) ? `X` : `Y`, n3 = 0;
        n3 = e3 === `X` ? Math.abs(y2 - w2) : e3 === `Y` ? Math.abs(b2 - T2) / 1.5 : Math.abs(y2 - w2) / 2;
        let r3 = t4.append(`g`);
        if (await S(r3, v2, { useHtmlLabels: false, width: n3, classes: `architecture-service-label` }, u()), r3.attr(`dy`, `1em`).attr(`alignment-baseline`, `middle`).attr(`dominant-baseline`, `middle`).attr(`text-anchor`, `middle`), e3 === `X`) r3.attr(`transform`, `translate(` + x2 + `, ` + C2 + `)`);
        else if (e3 === `Y`) r3.attr(`transform`, `translate(` + x2 + `, ` + C2 + `) rotate(-90)`);
        else if (e3 === `XY`) {
          let e4 = B(l2, m2);
          if (e4 && R(e4)) {
            let t5 = r3.node().getBoundingClientRect(), [n4, i3] = ee(e4);
            r3.attr(`dominant-baseline`, `auto`).attr(`transform`, `rotate(${-1 * n4 * i3 * 45})`);
            let a4 = r3.node().getBoundingClientRect();
            r3.attr(`transform`, `
                translate(${x2}, ${C2 - t5.height / 2})
                translate(${n4 * a4.width / 2}, ${i3 * a4.height / 2})
                rotate(${-1 * n4 * i3 * 45}, 0, ${t5.height / 2})
              `);
          }
        }
      }
...
}, `drawEdges`), X = h(async function(e2, t2, n2, r2) {
  let i2 = n2.getConfigField(`padding`) * 0.75, a2 = n2.getConfigField(`fontSize`), o2 = n2.getConfigField(`iconSize`) / 2;
  await Promise.all(t2.nodes().map(async (t3) => {
    let s2 = U(t3);
    if (s2.type === `group`) {
      let { h: c2, w: l2, x1: d2, y1: f2 } = t3.boundingBox(), p2 = e2.append(`rect`);
      p2.attr(`id`, `${r2}-group-${s2.id}`).attr(`x`, d2 + o2).attr(`y`, f2 + o2).attr(`width`, l2).attr(`height`, c2).attr(`class`, `node-bkg`);
      let m2 = e2.append(`g`), h2 = d2, g2 = f2;
      if (s2.icon) {
        let e3 = m2.append(`g`);
        e3.html(`<g>${await C(s2.icon, { height: i2, width: i2, fallbackPrefix: Y.prefix })}</g>`), e3.attr(`transform`, `translate(` + (h2 + o2 + 1) + `, ` + (g2 + o2 + 1) + `)`), h2 += i2, g2 += a2 / 2 - 1 - 2;
      }
      if (s2.label) {
        let e3 = m2.append(`g`);
        await S(e3, s2.label, { useHtmlLabels: false, width: l2, classes: `architecture-service-label` }, u()), e3.attr(`dy`, `1em`).attr(`alignment-baseline`, `middle`).attr(`dominant-baseline`, `start`).attr(`text-anchor`, `start`), e3.attr(`transform`, `translate(` + (h2 + o2 + 4) + `, ` + (g2 + o2 + 2) + `)`);
      }
      n2.setElementForId(s2.id, p2);
    }
  }));
}, `drawGroups`), oe = h(async function(e2, t2, n2, r2) {
  let i2 = u();
  for (let o2 of n2) {
    let n3 = t2.append(`g`), s2 = e2.getConfigField(`iconSize`);
    if (o2.title) {
      let e3 = n3.append(`g`);
      await S(e3, o2.title, { useHtmlLabels: false, width: s2 * 1.5, classes: `architecture-service-label` }, i2), e3.attr(`dy`, `1em`).attr(`alignment-baseline`, `middle`).attr(`dominant-baseline`, `middle`).attr(`text-anchor`, `middle`), e3.attr(`transform`, `translate(` + s2 / 2 + `, ` + s2 + `)`);
    }
    let c2 = n3.append(`g`);
    if (o2.icon) c2.html(`<g>${await C(o2.icon, { height: s2, width: s2, fallbackPrefix: Y.prefix })}</g>`);
    else if (o2.iconText) {
      c2.html(`<g>${await C(`blank`, { height: s2, width: s2, fallbackPrefix: Y.prefix })}</g>`);
      let e3 = c2.append(`g`).append(`foreignObject`).attr(`width`, s2).attr(`height`, s2).append(`div`).attr(`class`, `node-icon-text`).attr(`style`, `height: ${s2}px;`).append(`div`).html(a(o2.iconText, i2)), t3 = parseInt(window.getComputedStyle(e3.node(), null).getPropertyValue(`font-size`).replace(/\D/g, ``)) ?? 16;
      e3.attr(`style`, `-webkit-line-clamp: ${Math.floor((s2 - 2) / t3)};`);
    } else c2.append(`path`).attr(`class`, `node-bkg`).attr(`id`, `${r2}-node-${o2.id}`).attr(`d`, `M0,${s2} V5 Q0,0 5,0 H${s2 - 5} Q${s2},0 ${s2},5 V${s2} Z`);
    n3.attr(`id`, `${r2}-service-${o2.id}`).attr(`class`, `architecture-service`);
    let { width: l2, height: u2 } = n3.node().getBBox();
    o2.width = l2, o2.height = u2, e2.setElementForId(o2.id, n3);
  }
  return 0;
}, `drawServices`), Z = h(function(e2, t2, n2, r2) {
  n2.forEach((n3) => {
...
function me(e2, t2, n2, r2, i2, { spatialMaps: a2, groupAlignments: o2 }) {
  return new Promise((s2) => {
    ...
    let u2 = fe(i2, a2, o2), d2 = pe(a2, i2), f2 = l2.layout({ name: `fcose`, quality: `proof`, randomize: i2.getConfigField(`randomize`), styleEnabled: false, animate: false, nodeDimensionsIncludeLabels: false, idealEdgeLength(e3) {
...
var he = { parser: K, get db() {
  ...
  let a2 = r2.db;
  a2.setDiagramId(t2);
  let o2 = a2.getServices(), s2 = a2.getJunctions(), c2 = a2.getGroups(), l2 = a2.getEdges(), u2 = a2.getDataStructures(), d2 = y(t2), f2 = d2.append(`g`);
  f2.attr(`class`, `architecture-edges`);
  let p2 = d2.append(`g`);
  p2.attr(`class`, `architecture-services`);
  let m2 = d2.append(`g`);
  m2.attr(`class`, `architecture-groups`), await oe(a2, p2, o2, t2), Z(a2, p2, s2, t2);
  let h2 = await me(o2, s2, c2, l2, a2, u2);
  await ae(f2, h2, a2, t2), await X(m2, h2, a2, t2), le(a2, h2), i(void 0, d2, a2.getConfigField(`padding`), a2.getConfigField(`useMaxWidth`));
}, `draw`) }, styles: q };
export {
  he as diagram
};
