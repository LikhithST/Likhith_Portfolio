var _a;
import { t as channel_default } from "./channel-BWI2pNsX.js";
import { B as utils_default, Cn as getDiagramTitle, Fn as setConfig2, I as getEdgeId, In as setDiagramTitle, Jn as __name, Mt as load, Nn as setAccDescription, Pn as setAccTitle, Sn as getConfig2, Wn as rgba_default, Yn as log, _n as defaultConfig2, a as getRegisteredLayoutAlgorithm, bn as getAccTitle, g as isValidShape, hn as common_default, jt as JSON_SCHEMA, o as render, pn as clear, un as select_default, yn as getAccDescription, zn as purify } from "./index-BgJKKt_a.js";
import { t as getIconStyles } from "./chunk-FMBD7UC4-Ctqn8eS3.js";
import { t as createTooltip } from "./chunk-YZCP3GAM-CVv7DE2a.js";
import { t as getDiagramElement } from "./chunk-55IACEB6-CT2HYb7w.js";
import { t as setupViewPortForSVG } from "./chunk-EDXVE4YY-BmFbq3wW.js";
...
var FlowDB = (_a = class {
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (edge) {
      const edgeDoc = doc;
      if ((edgeDoc == null ? void 0 : edgeDoc.animate) !== void 0) edge.animate = edgeDoc.animate;
      if ((edgeDoc == null ? void 0 : edgeDoc.animation) !== void 0) edge.animation = edgeDoc.animation;
      if ((edgeDoc == null ? void 0 : edgeDoc.curve) !== void 0) edge.interpolate = edgeDoc.curve;
      return;
    }
    let txt;
    ...
    if (doc !== void 0) {
      ...
      if (doc == null ? void 0 : doc.icon) {
        ...
        if (!((_a2 = doc.label) == null ? void 0 : _a2.trim()) && vertex.text === id) vertex.text = "";
      }
      if (doc == null ? void 0 : doc.form) vertex.form = doc == null ? void 0 : doc.form;
      if (doc == null ? void 0 : doc.pos) vertex.pos = doc == null ? void 0 : doc.pos;
      if (doc == null ? void 0 : doc.img) {
        vertex.img = doc == null ? void 0 : doc.img;
        if (!((_b = doc.label) == null ? void 0 : _b.trim()) && vertex.text === id) vertex.text = "";
      }
      if (doc == null ? void 0 : doc.constraint) vertex.constraint = doc.constraint;
...
You have to call mermaid.initialize.`);
  ...
  updateLink(positions, style) {
    positions.forEach((pos) => {
      ...
      if (pos === "default") this.edges.defaultStyle = style;
        ...
        if ((((_b = (_a2 = this.edges[pos]) == null ? void 0 : _a2.style) == null ? void 0 : _b.length) ?? 0) > 0 && !((_d = (_c = this.edges[pos]) == null ? void 0 : _c.style) == null ? void 0 : _d.some((s) => s == null ? void 0 : s.startsWith("fill")))) (_f = (_e = this.edges[pos]) == null ? void 0 : _e.style) == null ? void 0 : _f.push("fill:none");
      }
    });
  }
  addClass(ids, _style) {
  ...
  getCompiledStyles(classDefs) {
    ...
    for (const customClass of classDefs) {
      ...
      if (cssClass == null ? void 0 : cssClass.styles) compiledStyles = [...compiledStyles, ...cssClass.styles ?? []].map((s) => s.trim());
      if (cssClass == null ? void 0 : cssClass.textStyles) compiledStyles = [...compiledStyles, ...cssClass.textStyles ?? []].map((s) => s.trim());
    }
...
var flowRenderer_v3_unified_default = {
  ...
  draw: /* @__PURE__ */ __name(async function(text, id, _version, diag) {
    ...
    utils_default.insertTitle(svg, "flowchartTitleText", (conf == null ? void 0 : conf.titleTopMargin) || 0, diag.db.getDiagramTitle());
