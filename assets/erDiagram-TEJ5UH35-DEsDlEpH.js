...
var _t = (function() {
  var e = l(function(I, n, c, o) {
    ...
    for (var g, v, k, pt, w = {}, et, E, Rt, st; ; ) {
      if (v = o[o.length - 1], this.defaultActions[v] ? k = this.defaultActions[v] : ((g === null || typeof g > "u") && (g = It()), k = U[v] && U[v][g]), typeof k > "u" || !k.length || !k[0]) {
        var yt = "";
        st = [];
        for (et in U[v]) this.terminals_[et] && et > Dt && st.push("'" + this.terminals_[et] + "'");
        _.showPosition ? yt = "Parse error on line " + (tt + 1) + `:
` + _.showPosition() + `
Expecting ` + st.join(", ") + ", got '" + (this.terminals_[g] || g) + "'" : yt = "Parse error on line " + (tt + 1) + ": Unexpected " + (g == At ? "end of input" : "'" + (this.terminals_[g] || g) + "'"), this.parseError(yt, { text: _.match, token: this.terminals_[g] || g, line: _.yylineno, loc: ft, expected: st });
      }
      if (k[0] instanceof Array && k.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + v + ", token: " + g);
      switch (k[0]) {
        case 1:
          o.push(g), f.push(_.yytext), t.push(_.yylloc), o.push(k[1]), g = null, Nt = _.yyleng, s = _.yytext, tt = _.yylineno, ft = _.yylloc;
          break;
        case 2:
          if (E = this.productions_[k[1]][1], w.$ = f[f.length - E], w._$ = { first_line: t[t.length - (E || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (E || 1)].first_column, last_column: t[t.length - 1].last_column }, wt && (w._$.range = [t[t.length - (E || 1)].range[0], t[t.length - 1].range[1]]), pt = this.performAction.apply(w, [s, Nt, tt, x.yy, k[1], f, t].concat(Lt)), typeof pt < "u") return pt;
          E && (o = o.slice(0, -1 * E * 2), f = f.slice(0, -1 * E), t = t.slice(0, -1 * E)), o.push(this.productions_[k[1]][0]), f.push(w.$), t.push(w._$), Rt = U[o[o.length - 2]][o[o.length - 1]], o.push(Rt);
          break;
        case 3:
          return true;
      }
    ...
    var I = { EOF: 1, parseError: l(function(c, o) {
      if (this.yy.parser) this.yy.parser.parseError(c, o);
      else throw new Error(c);
    }, "parseError"), setInput: l(function(n, c) {
      return this.yy = c || this.yy || {}, this._input = n, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
...
` + c + "^";
      ...
      for (var f = this._currentRules(), t = 0; t < f.length; t++) if (o = this._input.match(this.rules[f[t]]), o && (!c || o[0].length > c[0].length)) {
        if (c = o, r = t, this.options.backtrack_lexer) {
          if (n = this.test_match(o, f[t]), n !== false) return n;
          if (this._backtrack) {
            c = false;
            continue;
          } else return false;
      ...
      return c ? (n = this.test_match(c, f[r]), n !== false ? n : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: l(function() {
      var c = this.next();
      return c || this.lex();
    }, "lex"), begin: l(function(c) {
    ...
    }, "_currentRules"), topState: l(function(c) {
      return c = this.conditionStack.length - 1 - Math.abs(c || 0), c >= 0 ? this.conditionStack[c] : "INITIAL";
    }, "topState"), pushState: l(function(c) {
      this.begin(c);
    }, "pushState"), stateStackSize: l(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: l(function(c, o, r, f) {
      switch (r) {
        case 0:
...
var $t = _t, te = (_a = class {
  ...
  addAttributes(e, i) {
    ...
    let a;
    for (a = i.length - 1; a >= 0; a--) i[a].keys || (i[a].keys = []), i[a].comment || (i[a].comment = ""), h.attributes.push(i[a]), V.debug("Added attribute ", i[a].name);
  }
  addRelationship(e, i, h, a) {
    const u = this.entities.get(e), d = this.entities.get(h);
    if (!u || !d) return;
    const y = { entityA: u.id, roleA: i, entityB: d.id, relSpec: a };
  ...
  getCompiledStyles(e) {
    ...
    for (const h of e) {
      ...
      (a == null ? void 0 : a.styles) && (i = [...i, ...a.styles ?? []].map((u) => u.trim())), (a == null ? void 0 : a.textStyles) && (i = [...i, ...a.textStyles ?? []].map((u) => u.trim()));
    }
    return i;
  }
  addCssStyles(e, i) {
    for (const h of e) {
      ...
      if (!i || !a) return;
      for (const u of i) a.cssStyles.push(u);
    }
  }
  addClass(e, i) {
    e.forEach((h) => {
  ...
  setClass(e, i) {
    for (const h of e) {
      const a = this.entities.get(h);
      if (a) for (const u of i) a.cssClasses += " " + u;
    }
  }
  clear() {
  ...
  getData() {
    ...
    for (const d of this.relationships) {
      const y = { id: Ut(d.entityA, d.entityB, { prefix: "id", counter: u++ }), type: "normal", curve: "basis", start: d.entityA, end: d.entityB, label: d.roleA, labelpos: "c", thickness: "normal", classes: "relationshipLine", arrowTypeStart: d.relSpec.cardB.toLowerCase(), arrowTypeEnd: d.relSpec.cardA.toLowerCase(), pattern: d.relSpec.relType == "IDENTIFYING" ? "solid" : "dashed", look: h.look, labelType: "markdown" };
      i.push(y);
    }
...
Wt(xt, { draw: () => ee });
var ee = l(async function(e, i, h, a) {
  V.info("REF0:"), V.info("Drawing er diagram (unified)", i);
  const { securityLevel: u, er: d, layout: y } = it(), p = a.db.getData(), m = Mt(i, u);
  p.type = a.type, p.layoutAlgorithm = Qt(y), p.config.flowchart.nodeSpacing = (d == null ? void 0 : d.nodeSpacing) || 140, p.config.flowchart.rankSpacing = (d == null ? void 0 : d.rankSpacing) || 80, p.direction = a.db.getDirection();
  const { config: j } = p, { look: W } = j;
  W === "neo" ? p.markers = ["only_one_neo", "zero_or_one_neo", "one_or_more_neo", "zero_or_more_neo"] : p.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"], p.diagramId = i, await Xt(p, m), p.layoutAlgorithm === "elk" && m.select(".edges").lower();
  ...
  const Q = 8;
  qt.insertTitle(m, "erDiagramTitleText", (d == null ? void 0 : d.titleTopMargin) ?? 25, a.db.getDiagramTitle()), Bt(m, Q, "erDiagram", (d == null ? void 0 : d.useMaxWidth) ?? true);
}, "draw"), Ct = l((e, i) => {
  const h = Jt, a = h(e, "r"), u = h(e, "g"), d = h(e, "b");
  return jt(a, u, d, i);
}, "fade"), rt = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), se = l((e) => {
  const { theme: i, look: h, bkgColorArray: a, borderColorArray: u } = e;
  if (!rt.has(i)) return "";
  const d = (a == null ? void 0 : a.length) > 0;
  let y = "";
  for (let p = 0; p < e.THEME_COLOR_LIMIT; p++) y += `
...
`;
}, "getStyles"), re = ie, le = { parser: $t, get db() {
  return new te();
}, renderer: xt, styles: re };
export {
  le as diagram
};
