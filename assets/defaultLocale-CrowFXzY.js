...
function Q(n, t) {
  return function(e, i) {
    for (var o = e.length, a = [], c = 0, h = n[0], M = 0; o > 0 && h > 0 && (M + h + 1 > i && (h = Math.max(1, i - M)), a.push(e.substring(o -= h, o + h)), !((M += h + 1) > i)); ) h = n[c = (c + 1) % n.length];
...
function $(n) {
  ...
  var t;
  return new L({ fill: t[1], align: t[2], sign: t[3], symbol: t[4], zero: t[5], width: t[6], comma: t[7], precision: t[8] && t[8].slice(1), trim: t[9], type: t[10] });
}
...
const O = { "%": (n, t) => (n * 100).toFixed(t), b: (n) => Math.round(n).toString(2), c: (n) => n + "", d: J, e: (n, t) => n.toExponential(t), f: (n, t) => n.toFixed(t), g: (n, t) => n.toPrecision(t), o: (n) => Math.round(n).toString(8), p: (n, t) => X(n * 100, t), r: X, s: v, X: (n) => Math.round(n).toString(16).toUpperCase(), x: (n) => Math.round(n).toString(16) };
function R(n) {
  return n;
}
var U = Array.prototype.map, Y = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function nn(n) {
  ...
  function T(f, g) {
    ...
    d === "n" ? (F = true, d = "g") : O[d] || (y === void 0 && (y = 12), C = true, d = "g"), (S || b === "0" && p === "=") && (S = true, b = "0", p = "=");
    ...
    function G(r) {
      ...
      if (d === "c") u = D(r) + u, r = "";
        ...
        r = +r;
        var P = r < 0 || 1 / r < 0;
        if (r = isNaN(r) ? M : D(Math.abs(r), y), C && (r = _(r)), P && +r == 0 && m !== "+" && (P = false), l = (P ? m === "(" ? m : h : m === "-" || m === "(" ? "" : m) + l, u = (d === "s" && !isNaN(r) && N !== void 0 ? Y[8 + N / 3] : "") + u + (P && m === "(" ? ")" : ""), H) {
          for (x = -1, I = r.length; ++x < I; ) if (k = r.charCodeAt(x), 48 > k || k > 57) {
