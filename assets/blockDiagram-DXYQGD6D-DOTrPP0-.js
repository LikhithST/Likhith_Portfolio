...
import { At as getLineFunctionsWithOffset, B as utils_default, En as getUrl, Ft as line_default, Jn as __name, L as getStylesFromArray, Mn as sanitizeText, O as configureLabelImages, P as decodeEntities, Pt as basis_default, S as createText, Sn as getConfig2, Wn as rgba_default, Yn as log, gn as configureSvgSize, hn as common_default, k as getSubGraphTitleMargins, kt as computeLabelTransform, pn as clear, un as select_default, wn as getEffectiveHtmlLabels, xn as getConfig } from "./index-BgJKKt_a.js";
import "./reduce-Bhlg0TWY.js";
import { t as getIconStyles } from "./chunk-FMBD7UC4-Ctqn8eS3.js";
import { t as Graph } from "./graphlib-QGOTNOh4.js";
import { t as clone_default } from "./clone-DaM9qnXM.js";
var parser = (function() {
...
var populateBlockDatabase = /* @__PURE__ */ __name((_blockList, parent) => {
  ...
  const children = [];
  const column = ((_a2 = blockList.find((b) => (b == null ? void 0 : b.type) === "column-setting")) == null ? void 0 : _a2.columns) ?? -1;
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  log.debug("setBlockSizes abc95 (start)", block.id, (_a2 = block == null ? void 0 : block.size) == null ? void 0 : _a2.x, "block width =", block == null ? void 0 : block.size, "siblingWidth", siblingWidth);
...
var shapes = {
  ...
  class_box: /* @__PURE__ */ __name(async (parent, node) => {
    ...
    const interfaceLabel = await createLabel_default(labelContainer, node.classData.annotations[0] ? "\xAB" + node.classData.annotations[0] + "\xBB" : "", node.labelStyle, true, true);
