var _a;
import { B as e, C as t, V as n, W as r, _ as i, a, b as o, nt as s, v as c } from "./chunk-ICPOFSXX-cosQBm9P.js";
import { g as l, h as u, m as d, p as f } from "./src-DiRGiyL4.js";
import { t as p } from "./channel-uzqZXAwD.js";
import "./path-CAD_RBb9.js";
import "./dist-BhM2qfql.js";
import "./array-BsT2bq1e.js";
import { c as m, g as h } from "./chunk-5PVQY5BW-BPITZuxu.js";
  ...
  var e2 = u(function(e3, t3, n3, r3) {
    ...
    for (var S3, C3, w3, T3, E3, D3 = {}, O3, k2, A2, j2; ; ) {
      if (w3 = n3[n3.length - 1], this.defaultActions[w3] ? T3 = this.defaultActions[w3] : (S3 ?? (S3 = x3()), T3 = o3[w3] && o3[w3][S3]), T3 === void 0 || !T3.length || !T3[0]) {
        var M2 = ``;
        for (O3 in j2 = [], o3[w3]) this.terminals_[O3] && O3 > f3 && j2.push(`'` + this.terminals_[O3] + `'`);
...
` + this.showPosition(), { text: ``, token: null, line: this.yylineno });
  ...
  return u(X, `Parser`), X.prototype = Y, Y.Parser = X, new X();
})();
b.parser = b;
var x = b, S = (_a = class {
  constructor() {
    this.entities = /* @__PURE__ */ new Map(), this.relationships = [], this.classes = /* @__PURE__ */ new Map(), this.direction = `TB`, this.Cardinality = { ZERO_OR_ONE: `ZERO_OR_ONE`, ZERO_OR_MORE: `ZERO_OR_MORE`, ONE_OR_MORE: `ONE_OR_MORE`, ONLY_ONE: `ONLY_ONE`, MD_PARENT: `MD_PARENT` }, this.Identification = { NON_IDENTIFYING: `NON_IDENTIFYING`, IDENTIFYING: `IDENTIFYING` }, this.setAccTitle = n, this.getAccTitle = c, this.setAccDescription = e, this.getAccDescription = i, this.setDiagramTitle = r, this.getDiagramTitle = t, this.getConfig = u(() => o().er, `getConfig`), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  addEntity(e2, t2 = ``) {
    var _a2;
    return this.entities.has(e2) ? !((_a2 = this.entities.get(e2)) == null ? void 0 : _a2.alias) && t2 && (this.entities.get(e2).alias = t2, l.info(`Add alias '${t2}' to entity '${e2}'`)) : (this.entities.set(e2, { id: `entity-${e2}-${this.entities.size}`, label: e2, attributes: [], alias: t2, shape: `erBox`, look: o().look ?? `default`, cssClasses: `default`, cssStyles: [], labelType: `markdown` }), l.info(`Added new entity :`, e2)), this.entities.get(e2);
  }
  getEntity(e2) {
  ...
  clear() {
    this.entities = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.relationships = [], a();
  }
  getData() {
    let e2 = [], t2 = [], n2 = o(), r2 = 0;
    for (let t3 of this.entities.keys()) {
      let n3 = this.entities.get(t3);
      n3 && (n3.cssCompiledStyles = this.getCompiledStyles(n3.cssClasses.split(` `)), n3.colorIndex = r2++, e2.push(n3));
    }
    let i2 = 0;
    for (let e3 of this.relationships) {
      let r3 = { id: m(e3.entityA, e3.entityB, { prefix: `id`, counter: i2++ }), type: `normal`, curve: `basis`, start: e3.entityA, end: e3.entityB, label: e3.roleA, labelpos: `c`, thickness: `normal`, classes: `relationshipLine`, arrowTypeStart: e3.relSpec.cardB.toLowerCase(), arrowTypeEnd: e3.relSpec.cardA.toLowerCase(), pattern: e3.relSpec.relType == `IDENTIFYING` ? `solid` : `dashed`, look: n2.look, labelType: `markdown` };
      t2.push(r3);
    }
...
var w = u(async function(e2, t2, n2, r2) {
  ...
  let { securityLevel: i2, er: a2, layout: s2 } = o(), c2 = r2.db.getData(), u2 = v(t2, i2);
  c2.type = r2.type, c2.layoutAlgorithm = _(s2), c2.config.flowchart.nodeSpacing = (a2 == null ? void 0 : a2.nodeSpacing) || 140, c2.config.flowchart.rankSpacing = (a2 == null ? void 0 : a2.rankSpacing) || 80, c2.direction = r2.db.getDirection();
  let { config: d2 } = c2, { look: p2 } = d2;
  p2 === `neo` ? c2.markers = [`only_one_neo`, `zero_or_one_neo`, `one_or_more_neo`, `zero_or_more_neo`] : c2.markers = [`only_one`, `zero_or_one`, `one_or_more`, `zero_or_more`], c2.diagramId = t2, await g(c2, u2), c2.layoutAlgorithm === `elk` && u2.select(`.edges`).lower();
  let m2 = u2.selectAll(`[id*="-background"]`);
  Array.from(m2).length > 0 && m2.each(function() {
    let e3 = f(this), t3 = e3.attr(`id`).replace(`-background`, ``), n3 = u2.select(`#${CSS.escape(t3)}`);
    if (!n3.empty()) {
      let t4 = n3.attr(`transform`);
      e3.attr(`transform`, t4);
    }
  }), h.insertTitle(u2, `erDiagramTitleText`, (a2 == null ? void 0 : a2.titleTopMargin) ?? 25, r2.db.getDiagramTitle()), y(u2, 8, `erDiagram`, (a2 == null ? void 0 : a2.useMaxWidth) ?? true);
}, `draw`), T = u((e2, t2) => {
  let n2 = p;
  return s(n2(e2, `r`), n2(e2, `g`), n2(e2, `b`), t2);
}, `fade`), E = /* @__PURE__ */ new Set([`redux-color`, `redux-dark-color`]), D = u((e2) => {
