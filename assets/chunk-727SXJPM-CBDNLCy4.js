var _a, _b;
import { g as tt } from "./chunk-FMBD7UC4-CT_3MNe0.js";
import { c as st } from "./chunk-ND2GUHAM-DaT9l4oE.js";
import { g as it } from "./chunk-55IACEB6-Bl22fvkg.js";
import { s as at } from "./chunk-2J33WTMH-Bwgx4IxG.js";
import { b as f, aF as Ie, a5 as F, ac as rt, aW as nt, bl as Oe, a$ as de, aS as ut, b2 as lt, a3 as ct, b1 as ot, a2 as ht, b4 as dt, a7 as pt, A as I, u as At, a8 as ft, a_ as gt, aO as G } from "./index-bLSjIDix.js";
var we = (function() {
  var t = f(function(O, o, h, p) {
...
Expecting ` + he.join(", ") + ", got '" + (this.terminals_[B] || B) + "'" : ve = "Parse error on line " + (ce + 1) + ": Unexpected " + (B == Ke ? "end of input" : "'" + (this.terminals_[B] || B) + "'"), this.parseError(ve, { text: D.match, token: this.terminals_[B] || B, line: D.yylineno, loc: Le, expected: he });
    ...
    var O = { EOF: 1, parseError: f(function(h, p) {
      if (this.yy.parser) this.yy.parser.parseError(h, p);
      else throw new Error(h);
    }, "parseError"), setInput: f(function(o, h) {
...
` + h + "^";
    }, "showPosition"), test_match: f(function(o, h) {
      var p, u, C;
      ...
      for (var C = this._currentRules(), e = 0; e < C.length; e++) if (p = this._input.match(this.rules[C[e]]), p && (!h || p[0].length > h[0].length)) {
        if (h = p, u = e, this.options.backtrack_lexer) {
          if (o = this.test_match(p, C[e]), o !== false) return o;
          if (this._backtrack) {
            h = false;
            continue;
          } else return false;
      ...
      return h ? (o = this.test_match(h, C[u]), o !== false ? o : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: f(function() {
      var h = this.next();
      return h || this.lex();
    }, "lex"), begin: f(function(h) {
...
var Bt = we, je = ["#", "+", "~", "-", ""], Xe = (_a = class {
  ...
  parseMember(t) {
    ...
    if (this.memberType === "method") {
      ...
      je.includes(n) && (this.visibility = n), /[$*]/.exec(c) && (i = c), this.id = t.substring(this.visibility === "" ? 0 : 1, i === "" ? r : r - 1);
    }
  ...
  constructor() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.functions = [], this.lineType = { LINE: 0, DOTTED_LINE: 1 }, this.relationType = { AGGREGATION: 0, EXTENSION: 1, COMPOSITION: 2, DEPENDENCY: 3, LOLLIPOP: 4 }, this.setupToolTips = f((i) => {
      ...
      de(i).select("svg").selectAll("g").filter(function() {
        ...
        a.transition().duration(200).style("opacity", ".9"), a.html(ut.sanitize(d)).style("left", `${window.scrollX + m.left + m.width / 2}px`).style("top", `${window.scrollY + m.bottom + 4}px`), l.classed("hover", true);
      }).on("mouseout", (c) => {
        a.transition().duration(500).style("opacity", 0), de(c.currentTarget).classed("hover", false);
      });
  ...
  addClass(i) {
    ...
    this.classes.set(c, { id: c, type: n, label: c, text: `${c}${n ? `&lt;${n}&gt;` : ""}`, shape: "classBox", cssClasses: "default", methods: [], members: [], annotations: [], styles: [], domId: pe + c + "-" + qe }), qe++;
  }
  addInterface(i, a) {
  ...
  addNote(i, a) {
    const r = this.notes.size, n = { id: `note${r}`, class: a, text: i, index: r };
  ...
  setClickEvent(i, a, r) {
    i.split(",").forEach((n) => {
      this.setClickFunc(n, a, r), this.classes.get(n).haveCallback = true;
    }), this.setCssClass(i, "clickable");
  }
  setClickFunc(i, a, r) {
  ...
  createNamespaceNode(i, a, r, n = false) {
    return { id: i, label: a, classes: /* @__PURE__ */ new Map(), notes: /* @__PURE__ */ new Map(), children: /* @__PURE__ */ new Map(), domId: pe + i + "-" + this.namespaceCounter++, parent: r, explicit: n };
  }
  linkParentChild(i, a) {
  ...
  addNamespace(i, a) {
    const r = _b.resolveQualifiedId(i, this.namespaceStack);
    if (this.namespaceStack.push(r), this.namespaces.has(r)) {
      const l = this.namespaces.get(r);
      return l.explicit = true, a && (l.label = a), r;
    }
    const n = r.split("."), c = _b.getAncestorIds(r);
    for (let l = 0; l < c.length; l++) {
      const d = c[l], m = l > 0 ? c[l - 1] : void 0, g = l === c.length - 1, N = g && a ? a : n[l];
      this.namespaces.has(d) ? g && (this.namespaces.get(d).explicit = true) : this.namespaces.set(d, this.createNamespaceNode(d, N, m, g)), m && this.linkParentChild(m, d);
    }
    return r;
  }
  popNamespace() {
  ...
  setCssStyle(i, a) {
    ...
    if (!(!a || !r)) for (const n of a) n.includes(",") ? r.styles.push(...n.split(",")) : r.styles.push(n);
  }
  getArrowMarker(i) {
    let a;
    switch (i) {
  ...
  getData() {
    var _a2, _b2;
    const i = [], a = [], r = F(), n = ((_a2 = r.class) == null ? void 0 : _a2.hierarchicalNamespaces) ?? true;
    for (const l of this.namespaces.values()) {
      if (!n && !l.explicit) continue;
      const d = { id: l.id, label: n ? l.label : l.id, isGroup: true, padding: r.class.padding ?? 16, shape: "rect", cssStyles: [], look: r.look, parentId: n ? l.parent : void 0 };
      i.push(d);
    }
    for (const l of this.classes.values()) {
      const d = n ? l.parent : this.resolveExplicitAncestor(l.parent), m = { ...l, type: void 0, isGroup: false, parentId: d, look: r.look };
      i.push(m);
    }
    for (const l of this.notes.values()) {
      const d = n ? l.parent : this.resolveExplicitAncestor(l.parent), m = { id: l.id, label: l.text, isGroup: false, shape: "note", padding: r.class.padding ?? 6, cssStyles: ["text-align: left", "white-space: nowrap", `fill: ${r.themeVariables.noteBkgColor}`, `stroke: ${r.themeVariables.noteBorderColor}`], look: r.look, parentId: d, labelType: "markdown" };
      i.push(m);
      const g = (_b2 = this.classes.get(l.class)) == null ? void 0 : _b2.id;
      if (g) {
        const N = { id: `edgeNote${l.index}`, start: l.id, end: g, type: "normal", thickness: "normal", classes: "relation", arrowTypeStart: "none", arrowTypeEnd: "none", arrowheadStyle: "", labelStyle: [""], style: ["fill: none"], pattern: "dotted", look: r.look };
        a.push(N);
      }
    }
    for (const l of this.interfaces) {
      const d = { id: l.id, label: l.label, isGroup: false, shape: "rect", cssStyles: ["opacity: 0;"], look: r.look };
      i.push(d);
    }
    let c = 0;
...
}, f(_b, "ClassDB"), _b), mt = f((t) => `g.classGroup text {
...
.edgeLabel[data-look="neo"] {
  ...
  ${tt()}
`, "getStyles"), St = mt, Ct = f((t, i = "TB") => {
  if (!t.doc) return i;
  let a = i;
  for (const r of t.doc) r.stmt === "dir" && (a = r.value);
  return a;
}, "getDir"), bt = f(function(t, i) {
  return i.db.getClasses();
}, "getClasses"), kt = f(async function(t, i, a, r) {
  Ie.info("REF0:"), Ie.info("Drawing class diagram (v3)", i);
  const { securityLevel: n, state: c, layout: l } = F();
  r.db.setDiagramId(i);
  const d = r.db.getData(), m = it(i, n);
  d.type = r.type, d.layoutAlgorithm = rt(l), d.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, d.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, d.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], d.diagramId = i, await nt(d, m);
  const g = 8;
  Oe.insertTitle(m, "classDiagramTitleText", (c == null ? void 0 : c.titleTopMargin) ?? 25, r.db.getDiagramTitle()), at(m, g, "classDiagram", (c == null ? void 0 : c.useMaxWidth) ?? true);
}, "draw"), Nt = { getClasses: bt, draw: kt, getDir: Ct };
export {
  _t as C,
  Nt as a,
  Bt as c,
