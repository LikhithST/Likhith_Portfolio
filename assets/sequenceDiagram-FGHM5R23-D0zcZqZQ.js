var _a;
import { A as ZERO_WIDTH_SPACE, B as utils_default, Cn as getDiagramTitle, En as getUrl, Fn as setConfig2, In as setDiagramTitle, Jn as __name, Mn as sanitizeText, Mt as load, Nn as setAccDescription, On as hasKatex, Ot as require_dist, Pn as setAccTitle, R as parseFontSize, Sn as getConfig2, Yn as log, bn as getAccTitle, dn as assignWithDepth_default, fn as calculateMathMLDimensions, gn as configureSvgSize, hn as common_default, jn as renderKatexSanitized, jt as JSON_SCHEMA, pn as clear, un as select_default, xn as getConfig, yn as getAccDescription } from "./index-BgJKKt_a.js";
import { a as drawRect, c as getTextObj, i as drawImage, n as drawBackgroundRect, r as drawEmbeddedImage, s as getNoteRect } from "./chunk-YZCP3GAM-CVv7DE2a.js";
...
var SequenceDB = (_a = class {
  ...
  addActor(id, name, description, type, metadata) {
    ...
    if ((doc == null ? void 0 : doc.alias) && (!description || description.text === name)) description = {
      text: doc.alias,
    ...
    if ((description == null ? void 0 : description.text) == null) description = {
      text: name,
      type
    };
  ...
  getActorProperty(actor, key) {
    if ((actor == null ? void 0 : actor.properties) !== void 0) return actor.properties[key];
  }
  apply(param) {
...
var drawActorTypeParticipant = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  ...
  var cssclass = "actor";
  if ((_a2 = actor.properties) == null ? void 0 : _a2.class) cssclass = actor.properties.class;
...
var drawActorTypeControl = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter, diagramId, actorIndexMap) {
  ...
  actor.height = actElem.node().getBBox().height + 2 * (((_a2 = conf2 == null ? void 0 : conf2.sequence) == null ? void 0 : _a2.labelBoxHeight) ?? 0);
...
var drawActorTypeEntity = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  ...
  actor.height = actElem.node().getBBox().height + (((_a2 = conf2 == null ? void 0 : conf2.sequence) == null ? void 0 : _a2.labelBoxHeight) ?? 0);
  if (!isFooter) {
    actorCnt++;
    line.append("line").attr("id", "actor" + actorCnt).attr("x1", center).attr("y1", centerY).attr("x2", center).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", actor.name).attr("data-et", "life-line").attr("data-id", actor.name);
    actor.actorCnt = actorCnt;
