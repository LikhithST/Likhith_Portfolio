var _a;
import { a6 as $e, b as dt, b0 as ke, b7 as Ze, aF as Re, b2 as qe, a3 as Qe, b4 as Je, a7 as Ke, a2 as je, b1 as _e, u as tr, t as er, a4 as rr, T as ir, a5 as ye, K as Ee, aa as ve, a_ as ar, a$ as nr, a8 as or, aV as sr, bj as hr } from "./index-bLSjIDix.js";
import { p as lr } from "./chunk-4BX2VUAB-BgiORwHT.js";
import { p as fr } from "./wardley-L42UT6IY-mILw-_Db.js";
import { c as Se } from "./cytoscape.esm-nFXppDBa.js";
  ...
  return we || (we = 1, (function(C, G) {
    (function(U, L) {
      ...
      return (function(w) {
        var U = {};
        function L(u) {
          if (U[u]) return U[u].exports;
          var h = U[u] = { i: u, l: false, exports: {} };
          return w[u].call(h.exports, h, h.exports, L), h.l = true, h.exports;
        }
        return L.m = w, L.c = U, L.i = function(u) {
          return u;
        }, L.d = function(u, h, a) {
          L.o(u, h) || Object.defineProperty(u, h, { configurable: false, enumerable: true, get: a });
        }, L.n = function(u) {
        ...
        function e(f, r, v) {
          u.call(this, v), this.isOverlapingSourceAndTarget = false, this.vGraphObject = v, this.bendpoints = [], this.source = f, this.target = r;
        }
        e.prototype = Object.create(u.prototype);
        for (var i in u) e[i] = u[i];
        e.prototype.getSource = function() {
          ...
          for (var v = this.getOtherEnd(f), t = r.getGraphManager().getRoot(); ; ) {
            if (v.getOwner() == r) return v;
            if (v.getOwner() == t) break;
        ...
        r.prototype.getEdges = function() {
          ...
          if (t.add(this), this.child != null) for (var c = this.child.getNodes(), l = 0; l < c.length; l++) s = c[l], o = s.withChildren(), o.forEach(function(T) {
            t.add(T);
          });
          return t;
          ...
          else for (var o = this.child.getNodes(), c = 0; c < o.length; c++) s = o[c], t += s.getNoOfChildren();
          return t == 0 && (t = 1), t;
        ...
        function s(c, l, T) {
          u.call(this, T), this.estimatedSize = h.MIN_VALUE, this.margin = a.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = c, l != null && l instanceof e ? this.graphManager = l : l != null && l instanceof Layout && (this.graphManager = l.graphManager);
        }
        s.prototype = Object.create(u.prototype);
        for (var o in u) s[o] = u[o];
        s.prototype.getNodes = function() {
          ...
          if (c instanceof i) {
            ...
            for (var T = l.edges.slice(), g, d = T.length, N = 0; N < d; N++) g = T[N], g.isInterGraph ? this.graphManager.remove(g) : g.source.owner.remove(g);
            ...
            if (!(A > -1 && S > -1)) throw "Source and/or target doesn't know this edge!";
        ...
        a.prototype.addRoot = function() {
          ...
          if (f == null && r == null && v == null) {
            ...
            if (t == s) return f.isInterGraph = false, t.add(f, r, v);
            if (f.isInterGraph = true, f.source = r, f.target = v, this.edges.indexOf(f) > -1) throw "Edge already in inter-graph edge list!";
          ...
          if (e instanceof u) {
            ...
            if (!(i == this.rootGraph || i.parent != null && i.parent.graphManager == this)) throw "Invalid parent node!";
            var f = [];
            f = f.concat(i.getEdges());
            for (var r, v = f.length, t = 0; t < v; t++) r = f[t], i.remove(r);
            var s = [];
            s = s.concat(i.getNodes());
            var o;
            v = s.length;
            for (var t = 0; t < v; t++) o = s[t], i.remove(o);
            ...
            if (r.source.edges.splice(c, 1), c = r.target.edges.indexOf(r), r.target.edges.splice(c, 1), !(r.source.owner != null && r.source.owner.getGraphManager() != null)) throw "Edge owner graph or owner graph manager is null!";
          ...
          if (this.allNodes == null) {
            for (var e = [], i = this.getGraphs(), f = i.length, r = 0; r < f; r++) e = e.concat(i[r].getNodes());
            this.allNodes = e;
          }
          ...
          for (var f, r = e.getNodes(), v = r.length, t = 0; t < v; t++) f = r[t], f.inclusionTreeDepth = i, f.child != null && this.calcInclusionTreeDepths(f.child, i + 1);
        }, a.prototype.includesInvalidEdge = function() {
          for (var e, i = [], f = this.edges.length, r = 0; r < f; r++) e = this.edges[r], this.isOneAncestorOfOther(e.source, e.target) && i.push(e);
        ...
        h.calcSeparationAmount = function(a, e, i, f) {
          ...
          if (a.intersects(e)) return i[0] = f, i[1] = r, i[2] = v, i[3] = t, true;
          var s = a.getX(), o = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), g = a.getRight(), d = a.getWidthHalf(), N = a.getHeightHalf(), b = e.getX(), A = e.getY(), S = e.getRight(), V = e.getX(), X = e.getBottom(), Z = e.getRight(), D = e.getWidthHalf(), _ = e.getHeightHalf(), n = false, m = false;
          if (f === v) {
            if (r > t) return i[0] = f, i[1] = o, i[2] = v, i[3] = X, false;
            if (r < t) return i[0] = f, i[1] = T, i[2] = v, i[3] = A, false;
          } else if (r === t) {
            if (f > v) return i[0] = s, i[1] = r, i[2] = S, i[3] = t, false;
            if (f < v) return i[0] = c, i[1] = r, i[2] = b, i[3] = t, false;
          } else {
            var p = a.height / a.width, E = e.height / e.width, y = (t - r) / (v - f), I = void 0, M = void 0, R = void 0, W = void 0, x = void 0, Q = void 0;
            if (-p === y ? f > v ? (i[0] = l, i[1] = T, n = true) : (i[0] = c, i[1] = o, n = true) : p === y && (f > v ? (i[0] = s, i[1] = o, n = true) : (i[0] = g, i[1] = T, n = true)), -E === y ? v > f ? (i[2] = V, i[3] = X, m = true) : (i[2] = S, i[3] = A, m = true) : E === y && (v > f ? (i[2] = b, i[3] = A, m = true) : (i[2] = Z, i[3] = X, m = true)), n && m) return false;
            if (f > v ? r > t ? (I = this.getCardinalDirection(p, y, 4), M = this.getCardinalDirection(E, y, 2)) : (I = this.getCardinalDirection(-p, y, 3), M = this.getCardinalDirection(-E, y, 1)) : r > t ? (I = this.getCardinalDirection(-p, y, 1), M = this.getCardinalDirection(-E, y, 3)) : (I = this.getCardinalDirection(p, y, 2), M = this.getCardinalDirection(E, y, 4)), !n) switch (I) {
              case 1:
        ...
        function h(r, v) {
          if (!(r instanceof v)) throw new TypeError("Cannot call a class as a function");
        }
        var a = function(v) {
          ...
          function r(v) {
            var t = this;
            h(this, r), this.length = 0, this.head = null, this.tail = null, v == null ? void 0 : v.forEach(function(s) {
              return t.push(s);
            });
          }
          return u(r, [{ key: "size", value: function() {
            return this.length;
          } }, { key: "insertBefore", value: function(t, s) {
            return e(s.prev, a(t), s, this);
          } }, { key: "insertAfter", value: function(t, s) {
            return e(s, a(t), s.next, this);
          } }, { key: "insertNodeBefore", value: function(t, s) {
            return e(s.prev, t, s, this);
          } }, { key: "insertNodeAfter", value: function(t, s) {
          ...
          } }, { key: "set_object_at", value: function(t, s) {
            if (t <= this.length()) {
        ...
        function s(o) {
          t.call(this), this.layoutQuality = h.QUALITY, this.createBendsAsNeeded = h.DEFAULT_CREATE_BENDS_AS_NEEDED, this.incremental = h.DEFAULT_INCREMENTAL, this.animationOnLayout = h.DEFAULT_ANIMATION_ON_LAYOUT, this.animationDuringLayout = h.DEFAULT_ANIMATION_DURING_LAYOUT, this.animationPeriod = h.DEFAULT_ANIMATION_PERIOD, this.uniformLeafNodeSizes = h.DEFAULT_UNIFORM_LEAF_NODE_SIZES, this.edgeToDummyNodes = /* @__PURE__ */ new Map(), this.graphManager = new a(this), this.isLayoutFinished = false, this.isSubLayout = false, this.isRemoteUse = false, o != null && (this.isRemoteUse = o);
        }
        s.RANDOM_SEED = 1, s.prototype = Object.create(t.prototype), s.prototype.getGraphManager = function() {
          ...
          var o;
          return this.checkLayoutSuccess() ? o = false : o = this.layout(), h.ANIMATE === "during" ? false : (o && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = true, o);
          ...
          if (o == null) this.transform(new r(0, 0));
            ...
            if (l != null) {
              ...
              for (var T = this.getAllNodes(), g, d = 0; d < T.length; d++) g = T[d], g.transform(c);
            }
          }
          ...
          else for (var c, l, T = o.getNodes(), g = 0; g < T.length; g++) c = T[g], l = c.getChild(), l == null || l.getNodes().length == 0 ? c.scatter() : (this.positionNodesRandomly(l), c.updateBounds());
        }, s.prototype.getFlatForest = function() {
          for (var o = [], c = true, l = this.graphManager.getRoot().getNodes(), T = true, g = 0; g < l.length; g++) l[g].getChild() != null && (T = false);
          if (!T) return o;
          ...
          for (A = A.concat(l); A.length > 0 && c; ) {
            for (N.push(A[0]); N.length > 0 && c; ) {
              ...
              for (var V = S.getEdges(), g = 0; g < V.length; g++) {
                ...
                if (b.get(S) != X) if (!d.has(X)) N.push(X), b.set(X, S);
                else {
                  c = false;
                  break;
                }
          ...
          var c = [];
          c = c.concat(o);
          var l = [], T = /* @__PURE__ */ new Map(), g = false, d = null;
          (c.length == 1 || c.length == 2) && (g = true, d = c[0]);
          ...
          for (S = S.concat(l); !g; ) {
            ...
            l = l.concat(S), (c.length == 1 || c.length == 2) && (g = true, d = c[0]);
          }
          return d;
        ...
        r.prototype.initParameters = function() {
          ...
          for (var t = this.getAllEdges(), s, o = 0; o < t.length; o++) s = t[o], this.calcSpringForce(s, s.idealLength);
        }, r.prototype.calcRepulsionForces = function() {
          var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, o, c, l, T, g = this.getAllNodes(), d;
          if (this.useFRGridVariant) for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), d = /* @__PURE__ */ new Set(), o = 0; o < g.length; o++) l = g[o], this.calculateRepulsionForceOfANode(l, d, t, s), d.add(l);
          else for (o = 0; o < g.length; o++) for (l = g[o], c = o + 1; c < g.length; c++) T = g[c], l.getOwner() == T.getOwner() && this.calcRepulsionForce(l, T);
        }, r.prototype.calcGravitationalForces = function() {
          for (var t, s = this.getAllNodesToApplyGravitation(), o = 0; o < s.length; o++) t = s[o], this.calcGravitationalForce(t);
          ...
          } else this.uniformLeafNodeSizes && t.getChild() == null && s.getChild() == null ? (g = c.getCenterX() - o.getCenterX(), d = c.getCenterY() - o.getCenterY()) : (i.getIntersection(o, c, T), g = T[2] - T[0], d = T[3] - T[1]), Math.abs(g) < a.MIN_REPULSION_DIST && (g = f.sign(g) * a.MIN_REPULSION_DIST), Math.abs(d) < a.MIN_REPULSION_DIST && (d = f.sign(d) * a.MIN_REPULSION_DIST), N = g * g + d * d, b = Math.sqrt(N), A = (t.nodeRepulsion / 2 + s.nodeRepulsion / 2) * t.noOfChildren * s.noOfChildren / N, S = A * g / b, V = A * d / b, t.repulsionForceX -= S, t.repulsionForceY -= V, s.repulsionForceX += S, s.repulsionForceY += V;
          ...
          for (var d = c; d <= l; d++) for (var N = T; N <= g; N++) this.grid[d][N].push(t), t.setGridCoordinates(c, l, T, g);
        }, r.prototype.updateGrid = function() {
          var t, s, o = this.getAllNodes();
          for (this.grid = this.calcGrid(this.graphManager.getRoot()), t = 0; t < o.length; t++) s = o[t], this.addNodeToGrid(s, this.graphManager.getRoot().getLeft(), this.graphManager.getRoot().getTop());
          ...
          if (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && o || c) {
            ...
            for (var T, g = this.grid, d = t.startX - 1; d < t.finishX + 2; d++) for (var N = t.startY - 1; N < t.finishY + 2; N++) if (!(d < 0 || N < 0 || d >= g.length || N >= g[0].length)) {
              for (var b = 0; b < g[d][N].length; b++) if (T = g[d][N][b], !(t.getOwner() != T.getOwner() || t == T) && !s.has(T) && !l.has(T)) {
        ...
        h.prototype.add = function(a) {
          ...
          for (var e = Object.keys(this.set), i = e.length, f = 0; f < i; f++) a.push(this.set[e[f]]);
        }, h.prototype.size = function() {
          return Object.keys(this.set).length;
        ...
        u.multMat = function(h, a) {
          ...
          for (var i = [], f = [], r = [], v = 0; v < a[0].length; v++) {
            for (var t = 0, s = 0; s < a.length; s++) t += -0.5 * a[s][v] * h[s];
            f[v] = t;
          }
          ...
          for (var T = 0; T < a.length; T++) {
            for (var g = 0, d = 0; d < a[0].length; d++) g += a[T][d] * r[d];
            i[T] = g;
          }
          return i;
        }, w.exports = u;
        ...
        var a = L(11), e = (function() {
          ...
          return u(i, [{ key: "_quicksort", value: function(r, v, t) {
            if (v < t) {
              var s = this._partition(r, v, t);
              this._quicksort(r, v, s), this._quicksort(r, s + 1, t);
            }
          } }, { key: "_partition", value: function(r, v, t) {
          ...
          } }, { key: "_get", value: function(r, v) {
            return r instanceof a ? r.get_object_at(v) : r[v];
          } }, { key: "_set", value: function(r, v, t) {
            r instanceof a ? r.set_object_at(v, t) : r[v] = t;
          } }, { key: "_swap", value: function(r, v, t) {
            var s = this._get(r, v);
            this._set(r, v, this._get(r, t)), this._set(r, t, s);
          } }, { key: "_defaultCompareFunction", value: function(r, v) {
            return v > r;
          } }]), i;
        })();
        w.exports = e;
        ...
        u.svd = function(h) {
          ...
          for (var e = (function(Tt) {
            ...
            for (var Ct = []; Tt-- > 0; ) Ct.push(0);
            return Ct;
          })(this.m), f = true, r = Math.min(this.m - 1, this.n), v = Math.max(0, Math.min(this.n - 2, this.m)), t = 0; t < Math.max(r, v); t++) {
            if (t < r) {
              this.s[t] = 0;
              for (var s = t; s < this.m; s++) this.s[t] = u.hypot(this.s[t], h[s][t]);
              if (this.s[t] !== 0) {
            ...
            for (var c = t + 1; c < this.n; c++) {
              if (/* @__PURE__ */ (function(Tt, Ct) {
                ...
                l = -l / h[t][t];
                for (var g = t; g < this.m; g++) h[g][c] += l * h[g][t];
              }
              e[c] = h[t][c];
            }
            if (/* @__PURE__ */ (function(Tt, Ct) {
              return Ct;
            })(f, t < r)) for (var d = t; d < this.m; d++) this.U[d][t] = h[d][t];
            if (t < v) {
              e[t] = 0;
              ...
              if (e[t] = -e[t], /* @__PURE__ */ (function(Tt, Ct) {
                ...
                for (var A = t + 1; A < this.m; A++) i[A] = 0;
                for (var S = t + 1; S < this.n; S++) for (var V = t + 1; V < this.m; V++) i[V] += e[S] * h[V][S];
                for (var X = t + 1; X < this.n; X++) for (var Z = -e[X] / e[t + 1], D = t + 1; D < this.m; D++) h[D][X] += Z * i[D];
              }
          ...
          r < this.n && (this.s[r] = h[r][r]), this.m < n && (this.s[n - 1] = 0), v + 1 < n && (e[v] = h[v][n - 1]), e[n - 1] = 0;
          {
            ...
            for (var E = r - 1; E >= 0; E--) if (this.s[E] !== 0) {
              for (var y = E + 1; y < a; y++) {
                for (var I = 0, M = E; M < this.m; M++) I += this.U[M][E] * this.U[M][y];
                I = -I / this.U[E][E];
          ...
          for (var z = this.n - 1; z >= 0; z--) {
            if (/* @__PURE__ */ (function(Tt, Ct) {
              return Tt && Ct;
            })(z < v, e[z] !== 0)) for (var Y = z + 1; Y < a; Y++) {
              for (var rt = 0, B = z + 1; B < this.n; B++) rt += this.V[B][z] * this.V[B][Y];
              rt = -rt / this.V[z + 1][z];
              for (var O = z + 1; O < this.n; O++) this.V[O][Y] += rt * this.V[O][z];
            }
          ...
          for (var $ = n - 1, tt = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
            ...
            for (J = n - 2; J >= -1 && J !== -1; J--) if (Math.abs(e[J]) <= ht + tt * (Math.abs(this.s[J]) + Math.abs(this.s[J + 1]))) {
              e[J] = 0;
              break;
            }
            if (J === n - 2) It = 4;
              ...
              case 2:
                {
                  ...
                  for (var Rt = J; Rt < n; Rt++) {
                    ...
                    for (var Ft = 0; Ft < this.m; Ft++) Ht = Ut * this.U[Ft][Rt] + Pt * this.U[Ft][J - 1], this.U[Ft][J - 1] = -Pt * this.U[Ft][Rt] + Ut * this.U[Ft][J - 1], this.U[Ft][Rt] = Ht;
                  }
                }
                break;
              case 3:
                {
                  ...
                  for (var nt = (k + Vt) * (k - Vt) + ct, et = k * K, j = J; j < n - 1; j++) {
                    ...
                    for (var xt = 0; xt < this.n; xt++) ut = wt * this.V[xt][j] + pt * this.V[xt][j + 1], this.V[xt][j + 1] = -pt * this.V[xt][j] + wt * this.V[xt][j + 1], this.V[xt][j] = ut;
                    if (ut = u.hypot(nt, et), wt = nt / ut, pt = et / ut, this.s[j] = ut, nt = wt * e[j] + pt * this.s[j + 1], this.s[j + 1] = -pt * e[j] + wt * this.s[j + 1], et = pt * e[j + 1], e[j + 1] = wt * e[j + 1], j < this.m - 1) for (var lt = 0; lt < this.m; lt++) ut = wt * this.U[lt][j] + pt * this.U[lt][j + 1], this.U[lt][j + 1] = -pt * this.U[lt][j] + wt * this.U[lt][j + 1], this.U[lt][j] = ut;
                  }
                  e[n - 2] = nt;
                }
                break;
              case 4:
                {
                  ...
                  for (; J < $ && !(this.s[J] >= this.s[J + 1]); ) {
                    var Lt = this.s[J];
                    if (this.s[J] = this.s[J + 1], this.s[J + 1] = Lt, J < this.n - 1) for (var ft = 0; ft < this.n; ft++) Lt = this.V[ft][J + 1], this.V[ft][J + 1] = this.V[ft][J], this.V[ft][J] = Lt;
                    if (J < this.m - 1) for (var st = 0; st < this.m; st++) Lt = this.U[st][J + 1], this.U[st][J + 1] = this.U[st][J], this.U[st][J] = Lt;
                    J++;
                  }
                  n--;
                }
        ...
        var u = /* @__PURE__ */ (function() {
          function e(i, f) {
            for (var r = 0; r < f.length; r++) {
              var v = f[r];
              v.enumerable = v.enumerable || false, v.configurable = true, "value" in v && (v.writable = true), Object.defineProperty(i, v.key, v);
            }
          }
        ...
        var a = (function() {
          ...
          return u(e, [{ key: "getScore", value: function() {
            return this.score;
            ...
            for (var r = 1; r < this.iMax; r++) this.grid[r][0] = this.grid[r - 1][0] + this.gap_penalty, this.tracebackGrid[r][0] = [false, true, false];
            for (var v = 1; v < this.iMax; v++) for (var t = 1; t < this.jMax; t++) {
              var s = void 0;
      ...
      return (() => {
        var U = { 45: ((a, e, i) => {
          ...
          D.prototype.newGraphManager = function() {
            ...
            var y = function O(H) {
              for (var $ = H.getChild().getNodes(), tt, ht = 0, J = 0; J < $.length; J++) tt = $[J], tt.getChild() == null ? n.fixedNodeSet.has(tt.id) && (ht += 100) : ht += O(tt);
              return ht;
            };
            ...
            if (this.constraints.relativePlacementConstraint) {
              ...
              if (o.RELAX_MOVEMENT_ON_CONSTRAINTS) this.shuffle = function(O) {
                var H, $, tt;
                for (tt = O.length - 1; tt >= 2 * O.length / 3; tt--) H = Math.floor(Math.random() * (tt + 1)), $ = O[tt], O[tt] = O[H], O[H] = $;
                return O;
            ...
            if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(B) {
              ...
              if (this.constraints.alignmentConstraint.horizontal) for (var M = this.constraints.alignmentConstraint.horizontal, p = 0; p < M.length; p++) {
                ...
                for (var W = R / M[p].length, y = 0; y < M[p].length; y++) this.idToNodeMap.get(M[p][y]).displacementY = W;
              }
            }
            if (this.constraints.relativePlacementConstraint) if (o.RELAX_MOVEMENT_ON_CONSTRAINTS) this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(B) {
              ...
              for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
                ...
                if (this.fixedComponentsOnHorizontal[p]) for (var y = 0; y < x.length; y++) this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
                  ...
                  for (var Q = 0, z = 0, y = 0; y < x.length; y++) if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
                  ...
                  for (var rt = Q / z, y = 0; y < x.length; y++) this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
              ...
              for (var p = 0; p < this.componentsOnVertical.length; p++) {
                ...
                if (this.fixedComponentsOnVertical[p]) for (var y = 0; y < x.length; y++) this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function($) {
                  n.idToNodeMap.get($).displacementY = 0;
                }) : this.idToNodeMap.get(x[y]).displacementY = 0;
                else {
                  for (var Q = 0, z = 0, y = 0; y < x.length; y++) if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
                  ...
                  for (var rt = Q / z, y = 0; y < x.length; y++) this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(J) {
            ...
            for (p = 0; p < n.length; p++) {
              ...
              if (!m.has(E)) {
                ...
                if (y == I) E.getBendpoints().push(new d()), E.getBendpoints().push(new d()), this.createDummyNodesForBendpoints(E), m.add(E);
                else {
                  var M = [];
            ...
            var p = this.tileNodesByFavoringDim(n, m, true), E = this.tileNodesByFavoringDim(n, m, false), y = this.getOrgRatio(p), I = this.getOrgRatio(E), M;
            ...
            var E = o.TILING_PADDING_VERTICAL, y = o.TILING_PADDING_HORIZONTAL, I = o.TILING_COMPARE_BY, M = { rows: [], rowWidth: [], rowHeight: [], width: 0, height: m, verticalPadding: E, horizontalPadding: y, centerX: 0, centerY: 0 };
            ...
            if (n.width - n.rowWidth[p] > I && m != p) {
              ...
              for (var M = Number.MIN_VALUE, R = 0; R < E.length; R++) E[R].height > M && (M = E[R].height);
            ...
            var m, p, E = n[0];
            if (E == n[1].source ? p = n[1].target : p = n[1].source, o.PURE_INCREMENTAL) E.setCenter(p.getCenterX() + n[3].getWidth(), p.getCenterY() + n[3].getHeight());
            else {
              var y = p.startX, I = p.finishX, M = p.startY, R = p.finishY, W = 0, x = 0, Q = 0, z = 0, Y = [W, Q, x, z];
              if (M > 0) for (var rt = y; rt <= I; rt++) Y[0] += this.grid[rt][M - 1].length + this.grid[rt][M].length - 1;
              if (I < this.grid.length - 1) for (var rt = M; rt <= R; rt++) Y[1] += this.grid[I + 1][rt].length + this.grid[I][rt].length - 1;
              if (R < this.grid[0].length - 1) for (var rt = y; rt <= I; rt++) Y[2] += this.grid[rt][R + 1].length + this.grid[rt][R].length - 1;
              if (y > 0) for (var rt = M; rt <= R; rt++) Y[3] += this.grid[y - 1][rt].length + this.grid[y][rt].length - 1;
              for (var B = A.MAX_VALUE, O, H, $ = 0; $ < Y.length; $++) Y[$] < B ? (B = Y[$], O = 1, H = $) : Y[$] == B && O++;
              if (O == 3 && B == 0) Y[0] == 0 && Y[1] == 0 && Y[2] == 0 ? m = 1 : Y[0] == 0 && Y[1] == 0 && Y[3] == 0 ? m = 0 : Y[0] == 0 && Y[2] == 0 && Y[3] == 0 ? m = 3 : Y[1] == 0 && Y[2] == 0 && Y[3] == 0 && (m = 2);
              else if (O == 2 && B == 0) {
          ...
          v.prototype.calculateDisplacement = function() {
            ...
            for (var c = this.getChild().getNodes(), l, T = 0; T < c.length; T++) l = c[T], l.getChild() == null ? (l.displacementX += s, l.displacementY += o) : l.propogateDisplacementToChildren(s, o);
          ...
          o.handleConstraints = function(c) {
            ...
            var X = function(P, k) {
              ...
              for (var wt = function() {
                ...
                Lt.forEach(function(ft) {
                  if (et.get(ft.id) < et.get(ot) + ft.gap) if (K && K.has(ft.id)) {
                    var st = void 0;
              ...
              }), k > K && q > at) for (var ct = 0; ct < g.size; ct++) d[ct] = -1 * d[ct], N[ct] = -1 * N[ct];
              else if (k > K) for (var nt = 0; nt < g.size; nt++) d[nt] = -1 * d[nt];
              else if (q > at) for (var et = 0; et < g.size; et++) N[et] = -1 * N[et];
            }, n = function(P) {
            ...
            }, E = [], y = [], I = false, M = false, R = /* @__PURE__ */ new Set(), W = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), Q = [];
            if (l.fixedNodeConstraint && l.fixedNodeConstraint.forEach(function(F) {
              ...
              if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1) l.fixedNodeConstraint.forEach(function(F, P) {
                ...
                if (l.alignmentConstraint.horizontal) {
                  ...
                  }, ct = 0; ct < q.length; ct++) at(ct);
                  I = true;
                }
                l.relativePlacementConstraint && (M = true);
              })();
              else if (l.relativePlacementConstraint) {
                for (var z = 0, Y = 0, rt = 0; rt < Q.length; rt++) Q[rt].length > z && (z = Q[rt].length, Y = rt);
                if (z < x.size / 2) _(l.relativePlacementConstraint), I = false, M = false;
                else {
              ...
              if (I) {
                for (var ht = void 0, J = t.transpose(E), It = t.transpose(y), Nt = 0; Nt < J.length; Nt++) J[Nt] = t.multGamma(J[Nt]), It[Nt] = t.multGamma(It[Nt]);
            ...
            if (r.ENFORCE_CONSTRAINTS) {
              ...
              if (l.alignmentConstraint) {
                if (l.alignmentConstraint.vertical) for (var Dt = l.alignmentConstraint.vertical, Rt = function(P) {
                ...
                if (l.alignmentConstraint.horizontal) for (var Ut = l.alignmentConstraint.horizontal, Pt = function(P) {
                  var k = /* @__PURE__ */ new Set();
              ...
              l.relativePlacementConstraint && (function() {
                ...
                if (R.forEach(function(Gt) {
                  ...
                  if (l.alignmentConstraint.vertical) for (var et = l.alignmentConstraint.vertical, j = function(yt) {
                  ...
                  }, ut = 0; ut < et.length; ut++) j(ut);
                  if (l.alignmentConstraint.horizontal) for (var wt = l.alignmentConstraint.horizontal, pt = function(yt) {
      ...
      return (() => {
        var U = { 658: ((a) => {
          a.exports = Object.assign != null ? Object.assign.bind(Object) : function(e) {
            for (var i = arguments.length, f = Array(i > 1 ? i - 1 : 0), r = 1; r < i; r++) f[r - 1] = arguments[r];
          ...
          var f = /* @__PURE__ */ (function() {
            function t(s, o) {
              var c = [], l = true, T = false, g = void 0;
              try {
                for (var d = s[Symbol.iterator](), N; !(l = (N = d.next()).done) && (c.push(N.value), !(o && c.length === o)); l = true) ;
              } catch (b) {
                T = true, g = b;
              } finally {
                try {
          ...
          v.getTopMostNodes = function(t) {
            for (var s = {}, o = 0; o < t.length; o++) s[t[o].id()] = true;
            var c = t.filter(function(l, T) {
              typeof l == "number" && (l = T);
              for (var g = l.parent()[0]; g != null; ) {
                if (s[g.id()]) return false;
                g = g.parent()[0];
              }
              return true;
            });
            ...
            var l = new r(), T = /* @__PURE__ */ new Set(), g = [], d = void 0, N = void 0, b = void 0, A = false, S = 1, V = [], X = [], Z = function() {
              var _ = t.collection();
              X.push(_);
              ...
              }), g.length == o.length && (A = true), !A || A && S > 1) {
            ...
            if (!o.fixedNodeConstraint) {
              ...
              if (o.quality == "draft") {
                var d = true, N = false, b = void 0;
                try {
                  for (var A = s.nodeIndexes[Symbol.iterator](), S; !(d = (S = A.next()).done); d = true) {
          ...
          var f = i(548), r = i(140).CoSELayout, v = i(140).CoSENode, t = i(140).layoutBase.PointD, s = i(140).layoutBase.DimensionD, o = i(140).layoutBase.LayoutConstants, c = i(140).layoutBase.FDLayoutConstants, l = i(140).CoSEConstants, T = function(d, N) {
            ...
            var n = function(x) {
              ...
              for (var rt = Q.length, B = 0; B < rt; B++) {
                ...
                var $ = void 0, tt = O.layoutDimensions({ nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels });
                if (O.outerWidth() != null && O.outerHeight() != null) if (Y.randomize) if (!O.isParent()) $ = x.add(new v(z.graphManager, new t(Z[X.get(O.id())] - tt.w / 2, D[X.get(O.id())] - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                else {
                ...
                else $ = x.add(new v(z.graphManager, new t(O.position("x") - tt.w / 2, O.position("y") - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                else $ = x.add(new v(this.graphManager));
          ...
          var v = i(658), t = i(548), s = i(657), o = s.spectralLayout, c = i(816), l = c.coseLayout, T = Object.freeze({ quality: "default", randomize: true, animate: true, animationDuration: 1e3, animationEasing: void 0, fit: true, padding: 30, nodeDimensionsIncludeLabels: false, uniformNodeDimensions: false, packComponents: true, step: "all", samplingType: true, sampleSize: 25, nodeSeparation: 75, piTol: 1e-7, nodeRepulsion: function(N) {
            ...
            return f(d, [{ key: "run", value: function() {
              ...
              if (S.layoutUtilities && A.packComponents && (m = S.layoutUtilities("get"), m || (m = S.layoutUtilities()), p = true), V.nodes().length > 0) if (p) {
                ...
                if (D = t.connectComponents(S, A.eles, I), D.forEach(function(vt) {
                  ...
                  if (A.tile) {
                    ...
                    if (D.forEach(function(vt, it) {
                      ...
                      for (var B = Y.length - 1; B >= 0; B--) D.splice(Y[B], 1), X.splice(Y[B], 1), _.splice(Y[B], 1);
                    }
                  }
                  D.forEach(function(vt, it) {
                    A.eles = vt, Z.push(l(A, X[it])), t.relocateComponent(_[it], Z[it], A);
                  });
                } else D.forEach(function(vt, it) {
                  ...
                  D.forEach(function(vt, it) {
                    ...
                    if (A.quality == "draft" && (gt = X[it].nodeIndexes), vt.nodes().not($).length > 0) {
                      ...
                      vt.nodes().not($).forEach(function(Ot) {
                        if (A.quality == "draft") if (!Ot.isParent()) At = gt.get(Ot.id()), mt.nodes.push({ x: X[it].xCoords[At] - Ot.boundingbox().w / 2, y: X[it].yCoords[At] - Ot.boundingbox().h / 2, width: Ot.boundingbox().w, height: Ot.boundingbox().h });
                        else {
                        ...
                        else Z[it][Ot.id()] && mt.nodes.push({ x: Z[it][Ot.id()].getLeft(), y: Z[it][Ot.id()].getTop(), width: Z[it][Ot.id()].getWidth(), height: Z[it][Ot.id()].getHeight() });
                        ...
                        } else Z[it][Et.id()] && Z[it][Dt.id()] && mt.edges.push({ startX: Z[it][Et.id()].getCenterX(), startY: Z[it][Et.id()].getCenterY(), endX: Z[it][Dt.id()].getCenterX(), endY: Z[it][Dt.id()].getCenterY() });
                      }), mt.nodes.length > 0 && (H.push(mt), O.add(it));
                    }
                  });
                  var tt = m.packComponents(H, A.randomize).shifts;
                  if (A.quality == "draft") X.forEach(function(vt, it) {
          ...
          var f = i(548), r = i(140).layoutBase.Matrix, v = i(140).layoutBase.SVD, t = function(o) {
            var c = o.cy, l = o.eles, T = l.nodes(), g = l.nodes(":parent"), d = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), A = [], S = [], V = [], X = [], Z = [], D = [], _ = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = o.piTol, I = o.samplingType, M = o.nodeSeparation, R = void 0, W = function() {
              for (var P = 0, k = 0, K = false; k < R; ) {
                P = Math.floor(Math.random() * m), K = false;
                for (var q = 0; q < k; q++) if (X[q] == P) {
                  K = true;
                  break;
                }
                if (!K) X[k] = P, k++;
              ...
              for (var q = [], at = 0, ct = 0, nt = 0, et = void 0, j = [], ut = 0, wt = 1, pt = 0; pt < m; pt++) j[pt] = p;
              for (q[ct] = P, j[P] = 0; ct >= at; ) {
                nt = q[at++];
                for (var xt = A[nt], lt = 0; lt < xt.length; lt++) et = N.get(xt[lt]), j[et] == p && (j[et] = j[nt] + 1, q[++ct] = et);
                D[nt][k] = j[nt] * M;
              }
              if (K) {
              ...
              if (P) {
                ...
                for (var at = 0; at < R; at++) X[at] = k, k = x(k, at, P);
              } else {
                W();
                for (var K = 0; K < R; K++) x(X[K], K, P);
              }
              for (var ct = 0; ct < m; ct++) for (var nt = 0; nt < R; nt++) D[ct][nt] *= D[ct][nt];
              for (var et = 0; et < R; et++) _[et] = [];
              for (var j = 0; j < R; j++) for (var ut = 0; ut < R; ut++) _[j][ut] = D[X[ut]][j];
            }, z = function() {
              for (var P = v.svd(_), k = P.S, K = P.U, q = P.V, at = k[0] * k[0] * k[0], ct = [], nt = 0; nt < R; nt++) {
                ct[nt] = [];
                for (var et = 0; et < R; et++) ct[nt][et] = 0, nt == et && (ct[nt][et] = k[nt] / (k[nt] * k[nt] + at / (k[nt] * k[nt])));
              }
              n = r.multMat(r.multMat(q, ct), r.transpose(K));
            }, Y = function() {
              for (var P = void 0, k = void 0, K = [], q = [], at = [], ct = [], nt = 0; nt < m; nt++) K[nt] = Math.random(), q[nt] = Math.random();
              K = r.normalize(K), q = r.normalize(q);
              for (var et = E, j = E, ut = void 0; ; ) {
                for (var wt = 0; wt < m; wt++) at[wt] = K[wt];
                if (K = r.multGamma(r.multL(r.multGamma(at), D, n)), P = r.dotProduct(at, K), K = r.normalize(K), et = r.dotProduct(at, K), ut = Math.abs(et / j), ut <= 1 + y && ut >= 1) break;
                j = et;
              }
              for (var pt = 0; pt < m; pt++) at[pt] = K[pt];
              for (j = E; ; ) {
                for (var xt = 0; xt < m; xt++) ct[xt] = q[xt];
                if (ct = r.minusOp(ct, r.multCons(at, r.dotProduct(at, ct))), q = r.multGamma(r.multL(r.multGamma(ct), D, n)), k = r.dotProduct(ct, q), q = r.normalize(q), et = r.dotProduct(ct, q), ut = Math.abs(et / j), ut <= 1 + y && ut >= 1) break;
                j = et;
              }
            ...
            for (var rt = 0, B = 0; B < T.length; B++) T[B].isParent() || N.set(T[B].id(), rt++);
            var O = true, H = false, $ = void 0;
            try {
              for (var tt = d.keys()[Symbol.iterator](), ht; !(O = (ht = tt.next()).done); O = true) {
                var J = ht.value;
                N.set(J, rt++);
              }
            } catch (F) {
            ...
            for (var It = 0; It < N.size; It++) A[It] = [];
            g.forEach(function(F) {
              for (var P = F.children().intersection(l); P.nodes(":childless").length == 0; ) P = P.nodes()[0].children().intersection(l);
            ...
            try {
              for (var mt = d.keys()[Symbol.iterator](), At; !(vt = (At = mt.next()).done); vt = true) {
                var Ot = At.value;
                Nt(Ot);
              }
            } catch (F) {
...
var yr = pr();
const Er = $e(yr);
var De = { L: "left", R: "right", T: "top", B: "bottom" }, xe = { L: dt((C) => `${C},${C / 2} 0,${C} 0,0`, "L"), R: dt((C) => `0,${C / 2} ${C},0 ${C},${C}`, "R"), T: dt((C) => `0,0 ${C},0 ${C / 2},${C}`, "T"), B: dt((C) => `${C / 2},0 ${C},${C} 0,${C}`, "B") }, oe = { L: dt((C, G) => C - G + 2, "L"), R: dt((C, G) => C - 2, "R"), T: dt((C, G) => C - G + 2, "T"), B: dt((C, G) => C - 2, "B") }, mr = dt(function(C) {
  ...
  const G = C;
  return G === "T" || G === "B";
}, "isArchitectureDirectionY"), me = dt(function(C, G) {
  const w = Wt(C) && qt(G), U = qt(C) && Wt(G);
  return w || U;
}, "isArchitectureDirectionXY"), Tr = dt(function(C) {
  const G = C[0], w = C[1], U = Wt(G) && qt(w), L = qt(G) && Wt(w);
  return U || L;
}, "isArchitecturePairXY"), Nr = dt(function(C) {
  return C !== "LL" && C !== "RR" && C !== "TT" && C !== "BB";
}, "isValidArchitectureDirectionPair"), pe = dt(function(C, G) {
  const w = `${C}${G}`;
  return Nr(w) ? w : void 0;
}, "getArchitectureDirectionPair"), Lr = dt(function([C, G], w) {
  const U = w[0], L = w[1];
  return Wt(U) ? qt(L) ? [C + (U === "L" ? -1 : 1), G + (L === "T" ? 1 : -1)] : [C + (U === "L" ? -1 : 1), G] : Wt(L) ? [C + (L === "L" ? 1 : -1), G + (U === "T" ? 1 : -1)] : [C, G + (U === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Cr = dt(function(C) {
  return C === "LT" || C === "TL" ? [1, 1] : C === "BL" || C === "LB" ? [1, -1] : C === "BR" || C === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Ar = dt(function(C, G) {
  return me(C, G) ? "bend" : Wt(C) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), wr = dt(function(C) {
  return C.type === "service";
}, "isArchitectureService"), Mr = dt(function(C) {
  return C.type === "junction";
}, "isArchitectureJunction"), Fe = dt((C) => C.data(), "edgeData"), ie = dt((C) => C.data(), "nodeData"), Or = ir.architecture, be = (_a = class {
  constructor() {
  ...
  addService({ id: C, icon: G, in: w, title: U, iconText: L }) {
    if (this.registeredIds[C] !== void 0) throw new Error(`The service id [${C}] is already in use by another ${this.registeredIds[C]}`);
    if (w !== void 0) {
      if (C === w) throw new Error(`The service [${C}] cannot be placed within itself`);
      if (this.registeredIds[w] === void 0) throw new Error(`The service [${C}]'s parent does not exist. Please make sure the parent is created before this service`);
      if (this.registeredIds[w] === "node") throw new Error(`The service [${C}]'s parent is not a group`);
    }
    this.registeredIds[C] = "node", this.nodes[C] = { id: C, type: "service", icon: G, iconText: L, title: U, edges: [], in: w };
  }
  getServices() {
  ...
  addJunction({ id: C, in: G }) {
    ...
    if (G !== void 0) {
      if (C === G) throw new Error(`The junction [${C}] cannot be placed within itself`);
      if (this.registeredIds[G] === void 0) throw new Error(`The junction [${C}]'s parent does not exist. Please make sure the parent is created before this junction`);
      if (this.registeredIds[G] === "node") throw new Error(`The junction [${C}]'s parent is not a group`);
    }
    this.registeredIds[C] = "node", this.nodes[C] = { id: C, type: "junction", edges: [], in: G };
  }
  getJunctions() {
  ...
  addGroup({ id: C, icon: G, in: w, title: U }) {
    ...
    if (w !== void 0) {
      if (C === w) throw new Error(`The group [${C}] cannot be placed within itself`);
      if (((_b = this.registeredIds) == null ? void 0 : _b[w]) === void 0) throw new Error(`The group [${C}]'s parent does not exist. Please make sure the parent is created before this group`);
      if (((_c = this.registeredIds) == null ? void 0 : _c[w]) === "node") throw new Error(`The group [${C}]'s parent is not a group`);
    }
    this.registeredIds[C] = "group", this.groups[C] = { id: C, icon: G, title: U, in: w };
  }
  getGroups() {
    return Object.values(this.groups);
  }
  addEdge({ lhsId: C, rhsId: G, lhsDir: w, rhsDir: U, lhsInto: L, rhsInto: u, lhsGroup: h, rhsGroup: a, title: e }) {
    if (!Ie(w)) throw new Error(`Invalid direction given for left hand side of edge ${C}--${G}. Expected (L,R,T,B) got ${String(w)}`);
    if (!Ie(U)) throw new Error(`Invalid direction given for right hand side of edge ${C}--${G}. Expected (L,R,T,B) got ${String(U)}`);
    ...
    if (this.nodes[G] === void 0 && this.groups[G] === void 0) throw new Error(`The right-hand id [${G}] does not yet exist. Please create the service/group before declaring an edge to it.`);
    const i = this.nodes[C].in, f = this.nodes[G].in;
    if (h && i && f && i == f) throw new Error(`The left-hand id [${C}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
    if (a && i && f && i == f) throw new Error(`The right-hand id [${G}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
    const r = { lhsId: C, lhsDir: w, lhsInto: L, lhsGroup: h, rhsId: G, rhsDir: U, rhsInto: u, rhsGroup: a, title: e };
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const C = {}, G = Object.entries(this.nodes).reduce((a, [e, i]) => (a[e] = i.edges.reduce((f, r) => {
        var _a2, _b;
        const v = (_a2 = this.getNode(r.lhsId)) == null ? void 0 : _a2.in, t = (_b = this.getNode(r.rhsId)) == null ? void 0 : _b.in;
        if (v && t && v !== t) {
          const s = Ar(r.lhsDir, r.rhsDir);
          s !== "bend" && (C[v] ?? (C[v] = {}), C[v][t] = s, C[t] ?? (C[t] = {}), C[t][v] = s);
        }
        if (r.lhsId === e) {
        ...
        return f;
      }, {}), a), {}), w = Object.keys(G)[0], U = { [w]: 1 }, L = Object.keys(G).reduce((a, e) => e === w ? a : { ...a, [e]: 1 }, {}), u = dt((a) => {
        const e = { [a]: [0, 0] }, i = [a];
        for (; i.length > 0; ) {
          const f = i.shift();
          if (f) {
            ...
            Object.entries(r).forEach(([s, o]) => {
              U[o] || (e[o] = Lr([v, t], s), i.push(o));
            });
          }
        }
        return e;
      }, "BFS"), h = [u(w)];
      for (; Object.keys(L).length > 0; ) h.push(u(Object.keys(L)[0]));
      this.dataStructures = { adjList: G, spatialMaps: h, groupAlignments: C };
    }
...
}, dt(_a, "ArchitectureDB"), _a), Dr = dt((C, G) => {
  ...
  Re.debug(G);
  const w = (_a2 = Pe.parser) == null ? void 0 : _a2.yy;
  if (!(w instanceof be)) throw new Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
  Dr(G, w);
}, "parse") }, xr = dt((C) => `
  .edge {
...
`, "getStyles"), Ir = xr, re = dt((C) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${C}</g>`, "wrapIcon"), ae = { prefix: "mermaid-architecture", height: 80, width: 80, icons: { database: { body: re('<path id="b" data-name="4" d="m20,57.86c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="c" data-name="3" d="m20,45.95c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="d" data-name="2" d="m20,34.05c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse id="e" data-name="1" cx="40" cy="22.14" rx="20" ry="7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="20" y1="57.86" x2="20" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="60" y1="57.86" x2="60" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>') }, server: { body: re('<rect x="17.5" y="17.5" width="45" height="45" rx="2" ry="2" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="32.5" x2="62.5" y2="32.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="47.5" x2="62.5" y2="47.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><g><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g>') }, disk: { body: re('<rect x="20" y="15" width="40" height="50" rx="1" ry="1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="14" ry="14.58" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="4" ry="4.17" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m37.51,42.52l-4.83,13.22c-.26.71-1.1,1.02-1.76.64l-4.18-2.42c-.66-.38-.81-1.26-.33-1.84l9.01-10.8c.88-1.05,2.56-.08,2.09,1.2Z" style="fill: #fff; stroke-width: 0px;"/>') }, internet: { body: re('<circle cx="40" cy="40" r="22.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="40" y1="17.5" x2="40" y2="62.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="40" x2="62.5" y2="40" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m39.99,17.51c-15.28,11.1-15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m40.01,17.51c15.28,11.1,15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="30.1" x2="60.25" y2="30.1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="49.9" x2="60.25" y2="49.9" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>') }, cloud: { body: re('<path d="m65,47.5c0,2.76-2.24,5-5,5H20c-2.76,0-5-2.24-5-5,0-1.87,1.03-3.51,2.56-4.36-.04-.21-.06-.42-.06-.64,0-2.6,2.48-4.74,5.65-4.97,1.65-4.51,6.34-7.76,11.85-7.76.86,0,1.69.08,2.5.23,2.09-1.57,4.69-2.5,7.5-2.5,6.1,0,11.19,4.38,12.28,10.17,2.14.56,3.72,2.51,3.72,4.83,0,.03,0,.07-.01.1,2.29.46,4.01,2.48,4.01,4.9Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>') }, unknown: hr, blank: { body: re("") } } }, Rr = dt(async function(C, G, w, U) {
  ...
  await Promise.all(G.edges().map(async (i) => {
    var _a2, _b;
    const { source: f, sourceDir: r, sourceArrow: v, sourceGroup: t, target: s, targetDir: o, targetArrow: c, targetGroup: l, label: T } = Fe(i);
    let { x: g, y: d } = i[0].sourceEndpoint();
    const { x: N, y: b } = i[0].midpoint();
    let { x: A, y: S } = i[0].targetEndpoint();
    const V = L + 4;
    if (t && (Wt(r) ? g += r === "L" ? -V : V : d += r === "T" ? -V : V + 18), l && (Wt(o) ? A += o === "L" ? -V : V : S += o === "T" ? -V : V + 18), !t && ((_a2 = w.getNode(f)) == null ? void 0 : _a2.type) === "junction" && (Wt(r) ? g += r === "L" ? h : -h : d += r === "T" ? h : -h), !l && ((_b = w.getNode(s)) == null ? void 0 : _b.type) === "junction" && (Wt(o) ? A += o === "L" ? h : -h : S += o === "T" ? h : -h), i[0]._private.rscratch) {
      const X = C.insert("g");
      ...
      if (T) {
        ...
        const _ = X.append("g");
        if (await Ee(_, T, { useHtmlLabels: false, width: D, classes: "architecture-service-label" }, ye()), _.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), Z === "X") _.attr("transform", "translate(" + N + ", " + b + ")");
        else if (Z === "Y") _.attr("transform", "translate(" + N + ", " + b + ") rotate(-90)");
        else if (Z === "XY") {
          const n = pe(r, o);
          if (n && Tr(n)) {
  ...
  await Promise.all(G.nodes().map(async (i) => {
    ...
    if (f.type === "group") {
      ...
      if (f.icon) {
        const g = c.append("g");
        g.html(`<g>${await ve(f.icon, { height: u, width: u, fallbackPrefix: ae.prefix })}</g>`), g.attr("transform", "translate(" + (l + e + 1) + ", " + (T + e + 1) + ")"), l += u, T += h / 2 - 1 - 2;
      }
      if (f.label) {
        const g = c.append("g");
        await Ee(g, f.label, { useHtmlLabels: false, width: v, classes: "architecture-service-label" }, ye()), g.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), g.attr("transform", "translate(" + (l + e + 4) + ", " + (T + e + 2) + ")");
      }
      w.setElementForId(f.id, o);
    }
  }));
}, "drawGroups"), Fr = dt(async function(C, G, w, U) {
  const L = ye();
  for (const u of w) {
    const h = G.append("g"), a = C.getConfigField("iconSize");
    if (u.title) {
      const r = h.append("g");
      await Ee(r, u.title, { useHtmlLabels: false, width: a * 1.5, classes: "architecture-service-label" }, L), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), r.attr("transform", "translate(" + a / 2 + ", " + a + ")");
    }
    const e = h.append("g");
    if (u.icon) e.html(`<g>${await ve(u.icon, { height: a, width: a, fallbackPrefix: ae.prefix })}</g>`);
    else if (u.iconText) {
      e.html(`<g>${await ve("blank", { height: a, width: a, fallbackPrefix: ae.prefix })}</g>`);
      const t = e.append("g").append("foreignObject").attr("width", a).attr("height", a).append("div").attr("class", "node-icon-text").attr("style", `height: ${a}px;`).append("div").html(ar(u.iconText, L)), s = parseInt(window.getComputedStyle(t.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
      t.attr("style", `-webkit-line-clamp: ${Math.floor((a - 2) / s)};`);
    } else e.append("path").attr("class", "node-bkg").attr("id", `${U}-node-${u.id}`).attr("d", `M0,${a} V5 Q0,0 5,0 H${a - 5} Q${a},0 ${a},5 V${a} Z`);
...
sr([{ name: ae.prefix, icons: ae }]);
Se.use(Er);
function Ge(C, G, w) {
  C.forEach((U) => {
    G.add({ group: "nodes", data: { type: "service", id: U.id, icon: U.icon, label: U.title, parent: U.in, width: w.getConfigField("iconSize"), height: w.getConfigField("iconSize") }, classes: "node-service" });
  });
}
dt(Ge, "addServices");
function Ue(C, G, w) {
  C.forEach((U) => {
    G.add({ group: "nodes", data: { type: "junction", id: U.id, parent: U.in, width: w.getConfigField("iconSize"), height: w.getConfigField("iconSize") }, classes: "node-junction" });
  });
}
dt(Ue, "addJunctions");
function Ye(C, G) {
...
function Xe(C, G) {
  C.forEach((w) => {
    G.add({ group: "nodes", data: { type: "group", id: w.id, icon: w.icon, label: w.title, parent: w.in }, classes: "node-group" });
  });
}
dt(Xe, "addGroups");
function He(C, G) {
  C.forEach((w) => {
    const { lhsId: U, rhsId: L, lhsInto: u, lhsGroup: h, rhsInto: a, lhsDir: e, rhsDir: i, rhsGroup: f, title: r } = w, v = me(w.lhsDir, w.rhsDir) ? "segments" : "straight", t = { id: `${U}-${L}`, label: r, source: U, sourceDir: e, sourceArrow: u, sourceGroup: h, sourceEndpoint: e === "L" ? "0 50%" : e === "R" ? "100% 50%" : e === "T" ? "50% 0" : "50% 100%", target: L, targetDir: i, targetArrow: a, targetGroup: f, targetEndpoint: i === "L" ? "0 50%" : i === "R" ? "100% 50%" : i === "T" ? "50% 0" : "50% 100%" };
    G.add({ group: "edges", data: t, classes: v });
  });
}
dt(He, "addEdges");
function We(C, G, w) {
  const U = dt((a, e) => Object.entries(a).reduce((i, [f, r]) => {
    var _a2;
    let v = 0;
    const t = Object.entries(r);
    if (t.length === 1) return i[f] = t[0][1], i;
    for (let s = 0; s < t.length - 1; s++) for (let o = s + 1; o < t.length; o++) {
      const [c, l] = t[s], [T, g] = t[o];
      if (((_a2 = w[c]) == null ? void 0 : _a2[T]) === e) i[f] ?? (i[f] = []), i[f] = [...i[f], ...l, ...g];
      else if (c === "default" || T === "default") i[f] ?? (i[f] = []), i[f] = [...i[f], ...l, ...g];
      else {
        const N = `${f}-${v++}`;
        i[N] = l;
        const b = `${f}-${v++}`;
    ...
    return Object.entries(a).forEach(([f, [r, v]]) => {
      var _a2, _b, _c;
      const t = ((_a2 = C.getNode(f)) == null ? void 0 : _a2.in) ?? "default";
      e[v] ?? (e[v] = {}), (_b = e[v])[t] ?? (_b[t] = []), e[v][t].push(f), i[r] ?? (i[r] = {}), (_c = i[r])[t] ?? (_c[t] = []), i[r][t].push(f);
    }), { horiz: Object.values(U(e, "horizontal")).filter((f) => f.length > 1), vert: Object.values(U(i, "vertical")).filter((f) => f.length > 1) };
  }), [u, h] = L.reduce(([a, e], { horiz: i, vert: f }) => [[...a, ...i], [...e, ...f]], [[], []]);
  return { horizontal: u, vertical: h };
}
dt(We, "getAlignments");
function Ve(C, G) {
  const w = [], U = dt((u) => `${u[0]},${u[1]}`, "posToStr"), L = dt((u) => u.split(",").map((h) => parseInt(h)), "strToPos");
  return C.forEach((u) => {
    const h = Object.fromEntries(Object.entries(u).map(([f, r]) => [U(r), f])), a = [U([0, 0])], e = {}, i = { L: [-1, 0], R: [1, 0], T: [0, 1], B: [0, -1] };
    for (; a.length > 0; ) {
      const f = a.shift();
      if (f) {
        e[f] = 1;
        ...
        if (r) {
          ...
          Object.entries(i).forEach(([t, s]) => {
            ...
            c && !e[o] && (a.push(o), w.push({ [De[t]]: c, [De[mr(t)]]: r, gap: 1.5 * G.getConfigField("iconSize") }));
          });
        }
      }
    }
  ...
  return new Promise((a) => {
    ...
    c.one("layoutstop", () => {
      ...
      function l(T, g, d, N) {
        ...
        return A = Math.abs(A) * _, b = b * n, { distances: A, weights: b };
      }
      dt(l, "getSegmentWeights"), i.startBatch();
      for (const T of Object.values(i.edges())) if ((_a2 = T.data) == null ? void 0 : _a2.call(T)) {
...
}, "draw"), Gr = { draw: Pr }, Wr = { parser: Pe, get db() {
  return new be();
}, renderer: Gr, styles: Ir };
export {
  Wr as diagram
};
