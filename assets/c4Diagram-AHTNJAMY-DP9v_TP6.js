var _a, _b;
import { B as e, L as t, V as n, _ as r, b as i, c as a, r as o, s, v as l } from "./chunk-ICPOFSXX-qplCg4jO.js";
import { g as u, h as d, p as f } from "./src-BWB47EtT.js";
import { t as p } from "./dist-DAHuMNYw.js";
import { _ as m, n as h, r as g } from "./chunk-5PVQY5BW-DyH3Wf6D.js";
import "./identity-B9owP9ru.js";
import { a as _, s as v } from "./chunk-YZCP3GAM-C30yAzNl.js";
var y = p(), b = (function() {
...
}, `drawC4Shape`), ge = d(function(e2, t2) {
...
}, `insertDatabaseIcon`), _e = d(function(e2, t2) {
...
}, `insertComputerIcon`), ve = d(function(e2, t2) {
...
}, `insertClockIcon`), ye = d(function(e2, t2) {
...
}, `insertArrowHead`), be = d(function(e2, t2) {
...
}, `insertArrowEnd`), xe = d(function(e2, t2) {
...
}, `insertArrowFilledHead`), Se = d(function(e2, t2) {
...
}, `insertArrowCrossHead`), Ce = d((e2, t2) => ({ fontFamily: e2[t2 + `FontFamily`], fontSize: e2[t2 + `FontSize`], fontWeight: e2[t2 + `FontWeight`] }), `getC4ShapeFont`), Y = (function() {
  function e2(e3, t3, n3, i2, a2, o2, s2) {
    r2(t3.append(`text`).attr(`x`, n3 + a2 / 2).attr(`y`, i2 + o2 / 2 + 5).style(`text-anchor`, `middle`).text(e3), s2);
  }
  d(e2, `byText`);
  function t2(e3, t3, n3, i2, a2, o2, l2, u2) {
    let { fontSize: d2, fontFamily: f2, fontWeight: p2 } = u2, m2 = e3.split(s.lineBreakRegex);
    for (let e4 = 0; e4 < m2.length; e4++) {
      let o3 = e4 * d2 - d2 * (m2.length - 1) / 2, s2 = t3.append(`text`).attr(`x`, n3 + a2 / 2).attr(`y`, i2).style(`text-anchor`, `middle`).attr(`dominant-baseline`, `middle`).style(`font-size`, d2).style(`font-weight`, p2).style(`font-family`, f2);
      s2.append(`tspan`).attr(`dy`, o3).text(m2[e4]).attr(`alignment-baseline`, `mathematical`), r2(s2, l2);
    }
  }
  d(t2, `byTspan`);
...
}, d(_a, `Bounds`), _a), ke = d(function(e2) {
  o(Z, e2), e2.fontFamily && (Z.personFontFamily = Z.systemFontFamily = Z.messageFontFamily = e2.fontFamily), e2.fontSize && (Z.personFontSize = Z.systemFontSize = Z.messageFontSize = e2.fontSize), e2.fontWeight && (Z.personFontWeight = Z.systemFontWeight = Z.messageFontWeight = e2.fontWeight);
}, `setConf`), Ae = d((e2, t2) => ({ fontFamily: e2[t2 + `FontFamily`], fontSize: e2[t2 + `FontSize`], fontWeight: e2[t2 + `FontWeight`] }), `c4ShapeFont`), je = d((e2) => ({ fontFamily: e2.boundaryFontFamily, fontSize: e2.boundaryFontSize, fontWeight: e2.boundaryFontWeight }), `boundaryFont`), Me = d((e2) => ({ fontFamily: e2.messageFontFamily, fontSize: e2.messageFontSize, fontWeight: e2.messageFontWeight }), `messageFont`);
function Q(e2, t2, n2, r2, i2) {
  if (!t2[e2].width) if (n2) t2[e2].text = m(t2[e2].text, i2, r2), t2[e2].textLines = t2[e2].text.split(s.lineBreakRegex).length, t2[e2].width = i2, t2[e2].height = h(t2[e2].text, r2);
  else {
    let n3 = t2[e2].text.split(s.lineBreakRegex);
    t2[e2].textLines = n3.length;
    let i3 = 0;
    t2[e2].height = 0, t2[e2].width = 0;
    for (let a2 of n3) t2[e2].width = Math.max(g(a2, r2), t2[e2].width), i3 = h(a2, r2), t2[e2].height = t2[e2].height + i3;
  }
}
d(Q, `calcC4ShapeTextWH`);
var Ne = d(function(e2, t2, n2) {
  ...
  let r2 = t2.wrap && Z.wrap, i2 = je(Z);
  i2.fontSize += 2, i2.fontWeight = `bold`, Q(`label`, t2, r2, i2, g(t2.label.text, i2)), X.drawBoundary(e2, t2, Z);
}, `drawBoundary`), Pe = d(function(e2, t2, n2, r2) {
  let i2 = 0;
  for (let a2 of r2) {
    i2 = 0;
    let r3 = n2[a2], o2 = Ae(Z, r3.typeC4Shape.text);
    switch (o2.fontSize -= 2, r3.typeC4Shape.width = g(`\xAB` + r3.typeC4Shape.text + `\xBB`, o2), r3.typeC4Shape.height = o2.fontSize + 2, r3.typeC4Shape.Y = Z.c4ShapePadding, i2 = r3.typeC4Shape.Y + r3.typeC4Shape.height - 4, r3.image = { width: 0, height: 0, Y: 0 }, r3.typeC4Shape.text) {
      case `person`:
      case `external_person`:
    ...
    let s2 = r3.wrap && Z.wrap, l2 = Z.width - Z.c4ShapePadding * 2, u2 = Ae(Z, r3.typeC4Shape.text);
    u2.fontSize += 2, u2.fontWeight = `bold`, Q(`label`, r3, s2, u2, l2), r3.label.Y = i2 + 8, i2 = r3.label.Y + r3.label.height, r3.type && r3.type.text !== `` ? (r3.type.text = `[` + r3.type.text + `]`, Q(`type`, r3, s2, Ae(Z, r3.typeC4Shape.text), l2), r3.type.Y = i2 + 5, i2 = r3.type.Y + r3.type.height) : r3.techn && r3.techn.text !== `` && (r3.techn.text = `[` + r3.techn.text + `]`, Q(`techn`, r3, s2, Ae(Z, r3.techn.text), l2), r3.techn.Y = i2 + 5, i2 = r3.techn.Y + r3.techn.height);
    let d2 = i2, f2 = r3.label.width;
    r3.descr && r3.descr.text !== `` && (Q(`descr`, r3, s2, Ae(Z, r3.typeC4Shape.text), l2), r3.descr.Y = i2 + 20, i2 = r3.descr.Y + r3.descr.height, f2 = Math.max(r3.label.width, r3.descr.width), d2 = i2 - r3.descr.textLines * 5), f2 += Z.c4ShapePadding, r3.width = Math.max(r3.width || Z.width, f2, Z.width), r3.height = Math.max(r3.height || Z.height, d2, Z.height), r3.margin = r3.margin || Z.c4ShapeMargin, e2.insert(r3), X.drawC4Shape(t2, r3, Z);
  }
...
}, d(_b, `Point`), _b), Fe = d(function(e2, t2) {
...
}, `getIntersectPoint`), Ie = d(function(e2, t2) {
  let n2 = { x: 0, y: 0 };
...
}, `getIntersectPoints`), Le = d(function(e2, t2, n2, r2, i2) {
  let a2 = 0;
  for (let e3 of t2) {
    a2 += 1;
    let t3 = e3.wrap && Z.wrap, i3 = Me(Z);
    r2.db.getC4Type() === `C4Dynamic` && (e3.label.text = a2 + `: ` + e3.label.text);
    let o2 = g(e3.label.text, i3);
    Q(`label`, e3, t3, i3, o2), e3.techn && e3.techn.text !== `` && (o2 = g(e3.techn.text, i3), Q(`techn`, e3, t3, i3, o2)), e3.descr && e3.descr.text !== `` && (o2 = g(e3.descr.text, i3), Q(`descr`, e3, t3, i3, o2));
    let s2 = Ie(n2(e3.from), n2(e3.to));
    e3.startPoint = s2.startPoint, e3.endPoint = s2.endPoint;
  }
  X.drawRels(e2, t2, Z, i2);
}, `drawRels`);
...
d(Re, `drawInsideBoundary`);
var ze = { drawPersonOrSystemArray: Pe, drawBoundary: Ne, setConf: ke, draw: d(function(e2, t2, n2, r2) {
  Z = i().c4;
  let o2 = i().securityLevel, s2;
  o2 === `sandbox` && (s2 = f(`#i` + t2));
  let l2 = f(o2 === `sandbox` ? s2.nodes()[0].contentDocument.body : `body`), d2 = r2.db;
  r2.db.setWrap(Z.wrap), Ee = d2.getC4ShapeInRow(), De = d2.getC4BoundaryInRow(), u.debug(`C:${JSON.stringify(Z, null, 2)}`);
  let p2 = o2 === `sandbox` ? l2.select(`[id="${t2}"]`) : f(`[id="${t2}"]`);
  X.insertComputerIcon(p2, t2), X.insertDatabaseIcon(p2, t2), X.insertClockIcon(p2, t2);
  let m2 = new Oe(r2);
  m2.setData(Z.diagramMarginX, Z.diagramMarginX, Z.diagramMarginY, Z.diagramMarginY), m2.data.widthLimit = screen.availWidth, we = Z.diagramMarginX, Te = Z.diagramMarginY;
  let h2 = r2.db.getTitle();
  Re(p2, ``, m2, r2.db.getBoundaries(``), r2), X.insertArrowHead(p2, t2), X.insertArrowEnd(p2, t2), X.insertArrowCrossHead(p2, t2), X.insertArrowFilledHead(p2, t2), Le(p2, r2.db.getRels(), r2.db.getC4Shape, r2, t2), m2.data.stopx = we, m2.data.stopy = Te;
  let g2 = m2.data, _2 = g2.stopy - g2.starty + 2 * Z.diagramMarginY, v2 = g2.stopx - g2.startx + 2 * Z.diagramMarginX;
  h2 && p2.append(`text`).text(h2).attr(`x`, (g2.stopx - g2.startx) / 2 - 4 * Z.diagramMarginX).attr(`y`, g2.starty + Z.diagramMarginY), a(p2, _2, v2, Z.useMaxWidth);
  let y2 = h2 ? 60 : 0;
  p2.attr(`viewBox`, g2.startx - Z.diagramMarginX + ` -` + (Z.diagramMarginY + y2) + ` ` + v2 + ` ` + (_2 + y2)), u.debug(`models:`, g2);
}, `draw`) }, Be = { parser: x, db: ue, renderer: ze, styles: d((e2) => `.person {
