  ...
  var e = h(function($, r, a, c) {
    ...
    for (var b, z, N, Ie, J = {}, ge, F, Ue, ye; ; ) {
      if (z = c[c.length - 1], this.defaultActions[z] ? N = this.defaultActions[z] : ((b === null || typeof b > "u") && (b = Pe()), N = me[z] && me[z][b]), typeof N > "u" || !N.length || !N[0]) {
        var ke = "";
        ye = [];
        for (ge in me[z]) this.terminals_[ge] && ge > He && ye.push("'" + this.terminals_[ge] + "'");
        y.showPosition ? ke = "Parse error on line " + (Re + 1) + `:
` + y.showPosition() + `
Expecting ` + ye.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : ke = "Parse error on line " + (Re + 1) + ": Unexpected " + (b == $e ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(ke, { text: y.match, token: this.terminals_[b] || b, line: y.yylineno, loc: be, expected: ye });
      }
      if (N[0] instanceof Array && N.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + z + ", token: " + b);
      switch (N[0]) {
        case 1:
          c.push(b), m.push(y.yytext), t.push(y.yylloc), c.push(N[1]), b = null, Fe = y.yyleng, l = y.yytext, Re = y.yylineno, be = y.yylloc;
          break;
        case 2:
          if (F = this.productions_[N[1]][1], J.$ = m[m.length - F], J._$ = { first_line: t[t.length - (F || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (F || 1)].first_column, last_column: t[t.length - 1].last_column }, We && (J._$.range = [t[t.length - (F || 1)].range[0], t[t.length - 1].range[1]]), Ie = this.performAction.apply(J, [l, Fe, Re, G.yy, N[1], m, t].concat(Ke)), typeof Ie < "u") return Ie;
    ...
    var $ = { EOF: 1, parseError: h(function(a, c) {
      if (this.yy.parser) this.yy.parser.parseError(a, c);
      else throw new Error(a);
    }, "parseError"), setInput: h(function(r, a) {
...
` + a + "^";
    }, "showPosition"), test_match: h(function(r, a) {
      var c, s, m;
      if (this.options.backtrack_lexer && (m = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (m.yylloc.range = this.yylloc.range.slice(0))), s = r[0].match(/(?:\r\n?|\n).*/g), s && (this.yylineno += s.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: s ? s[s.length - 1].length - s[s.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + r[0].length }, this.yytext += r[0], this.match += r[0], this.matches = r, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(r[0].length), this.matched += r[0], c = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), c) return c;
      if (this._backtrack) {
      ...
      for (var m = this._currentRules(), t = 0; t < m.length; t++) if (c = this._input.match(this.rules[m[t]]), c && (!a || c[0].length > a[0].length)) {
        if (a = c, s = t, this.options.backtrack_lexer) {
          if (r = this.test_match(c, m[t]), r !== false) return r;
          if (this._backtrack) {
            a = false;
            continue;
          } else return false;
      ...
      return a ? (r = this.test_match(a, m[s]), r !== false ? r : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: h(function() {
      var a = this.next();
      return a || this.lex();
    }, "lex"), begin: h(function(a) {
    ...
    }, "_currentRules"), topState: h(function(a) {
      return a = this.conditionStack.length - 1 - Math.abs(a || 0), a >= 0 ? this.conditionStack[a] : "INITIAL";
    }, "topState"), pushState: h(function(a) {
      this.begin(a);
    }, "pushState"), stateStackSize: h(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: h(function(a, c, s, m) {
      switch (s) {
        case 0:
          return "title";
        case 1:
...
var ct = qe, ot = (_a = class {
  ...
  setCssStyle(e, u) {
    for (const o of e) {
      ...
      if (!u || !n) return;
      for (const i of u) i.includes(",") ? n.cssStyles.push(...i.split(",")) : n.cssStyles.push(i);
    }
  }
  setClass(e, u) {
    var _a2;
    for (const o of e) {
      const n = this.requirements.get(o) ?? this.elements.get(o);
      if (n) for (const i of u) {
        n.classes.push(i);
        const f = (_a2 = this.classes.get(i)) == null ? void 0 : _a2.styles;
  ...
  getData() {
    ...
    for (const n of this.relations) {
      let i = 0;
      const f = n.type === this.Relationships.CONTAINS, _ = { id: `${n.src}-${n.dst}-${i}`, start: ((_a2 = this.requirements.get(n.src)) == null ? void 0 : _a2.name) ?? ((_b = this.elements.get(n.src)) == null ? void 0 : _b.name), end: ((_c = this.requirements.get(n.dst)) == null ? void 0 : _c.name) ?? ((_d = this.elements.get(n.dst)) == null ? void 0 : _d.name), label: `&lt;&lt;${n.type}&gt;&gt;`, classes: "relationshipLine", style: ["fill:none", f ? "" : "stroke-dasharray: 10,7"], labelpos: "c", thickness: "normal", type: "normal", pattern: f ? "normal" : "dashed", arrowTypeStart: f ? "requirement_contains" : "", arrowTypeEnd: f ? "" : "requirement_arrow", look: e.look, labelType: "markdown" };
      o.push(_), i++;
    }
    return { nodes: u, edges: o, other: {}, config: e, direction: this.getDirection() };
  }
}, h(_a, "RequirementDB"), _a), ht = h((e) => {
  const u = Ye(), { themeVariables: o, look: n } = u, { bkgColorArray: i, borderColorArray: f } = o;
  if (!(f == null ? void 0 : f.length)) return "";
  let _ = "";
  for (let E = 0; E < e.THEME_COLOR_LIMIT; E++) _ += `

    [data-look="${n}"][data-color-id="color-${E}"].node path {
    stroke: ${f[E]};
    fill: ${(i == null ? void 0 : i.length) ? i[E] : ""};
    }
...
rt(Be, { draw: () => mt });
var mt = h(async function(e, u, o, n) {
  ...
  g.type = n.type, g.layoutAlgorithm = nt(_), g.nodeSpacing = (f == null ? void 0 : f.nodeSpacing) ?? 50, g.rankSpacing = (f == null ? void 0 : f.rankSpacing) ?? 50, g.markers = E === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], g.diagramId = u, await at(g, S);
  const k = 8;
  lt.insertTitle(S, "requirementDiagramTitleText", (f == null ? void 0 : f.titleTopMargin) ?? 25, n.db.getDiagramTitle()), ze(S, k, "requirementDiagram", (f == null ? void 0 : f.useMaxWidth) ?? true);
}, "draw"), Rt = { parser: ct, get db() {
  return new ot();
}, renderer: Be, styles: ft };
export {
  Rt as diagram
};
