import { a as e, i as t, n, r, t as i } from "./linear-DpWPTl-K.js";
import "./defaultLocale-BExgBGLN.js";
import { t as a } from "./init-B8xRTswO.js";
import { B as o, Cn as s, In as c, Jn as l, Nn as u, Ot as d, Pn as f, Qn as p, Sn as m, Xn as h, Yn as g, an as _, bn as v, cn as y, gn as b, hn as x, in as S, ln as C, nn as w, pn as T, rr as E, sn as D, tn as O, un as k, yn as ee } from "./index-4Ava25sD.js";
function te(e2, t2) {
  let n2;
...
y(j, De, C(S, { brighter(e2) {
  ...
  return t2 = be * ke(t2), e2 = xe * ke(e2), n2 = Se * ke(n2), new _(Ae(3.1338561 * t2 - 1.6168667 * e2 - 0.4906146 * n2), Ae(-0.9787684 * t2 + 1.9161415 * e2 + 0.033454 * n2), Ae(0.0719453 * t2 - 0.2289914 * e2 + 1.4052427 * n2), this.opacity);
} }));
function Oe(e2) {
...
function Fe(e2) {
  return function(t2, n2) {
    var r2 = e2((t2 = Ne(t2)).h, (n2 = Ne(n2)).h), i2 = w(t2.c, n2.c), a2 = w(t2.l, n2.l), o2 = w(t2.opacity, n2.opacity);
    return function(e3) {
...
function lt(n2, r2, i2, a2, o2, s2) {
  let c2 = [[z, 1, F], [z, 5, 5 * F], [z, 15, 15 * F], [z, 30, 30 * F], [s2, 1, I], [s2, 5, 5 * I], [s2, 15, 15 * I], [s2, 30, 30 * I], [o2, 1, L], [o2, 3, 3 * L], [o2, 6, 6 * L], [o2, 12, 12 * L], [a2, 1, R], [a2, 2, 2 * R], [i2, 1, Be], [r2, 1, Ve], [r2, 3, 3 * Ve], [n2, 1, He]];
  function l2(e2, t2, n3) {
    let r3 = t2 < e2;
    r3 && ([e2, t2] = [t2, e2]);
    let i3 = n3 && typeof n3.range == `function` ? n3 : u2(e2, t2, n3), a3 = i3 ? i3.range(e2, +t2 + 1) : [];
    return r3 ? a3.reverse() : a3;
  }
  function u2(r3, i3, a3) {
    let o3 = Math.abs(i3 - r3) / a3, s3 = e(([, , e2]) => e2).right(c2, o3);
    if (s3 === c2.length) return n2.every(t(r3 / He, i3 / He, a3));
    if (s3 === 0) return P.every(Math.max(t(r3, i3, a3), 1));
    let [l3, u3] = c2[o3 / c2[s3 - 1][2] < c2[s3][2] / o3 ? s3 - 1 : s3];
    return l3.every(u3);
  }
  return [l2, u2];
}
...
function zn(e2, t2, i2, a2, o2, s2, c2, l2, u2, d2) {
  var f2 = n(), p2 = f2.invert, m2 = f2.domain, h2 = d2(`.%L`), g2 = d2(`:%S`), _2 = d2(`%I:%M`), v2 = d2(`%I %p`), y2 = d2(`%a %d`), b2 = d2(`%b %d`), x2 = d2(`%B`), S2 = d2(`%Y`);
  function C2(e3) {
    return (u2(e3) < e3 ? h2 : l2(e3) < e3 ? g2 : c2(e3) < e3 ? _2 : s2(e3) < e3 ? v2 : a2(e3) < e3 ? o2(e3) < e3 ? y2 : b2 : i2(e3) < e3 ? x2 : S2)(e3);
  }
  return f2.invert = function(e3) {
    return new Date(p2(e3));
  }, f2.domain = function(e3) {
    return arguments.length ? m2(Array.from(e3, Rn)) : m2().map(Ln);
  }, f2.ticks = function(t3) {
    var n2 = m2();
    return e2(n2[0], n2[n2.length - 1], t3 ?? 10);
  }, f2.tickFormat = function(e3, t3) {
    return t3 == null ? C2 : d2(t3);
  }, f2.nice = function(e3) {
    var n2 = m2();
    return (!e3 || typeof e3.range != `function`) && (e3 = t2(n2[0], n2[n2.length - 1], e3 ?? 10)), e3 ? m2(Le(n2, e3)) : f2;
  }, f2.copy = function() {
    return r(f2, zn(e2, t2, i2, a2, o2, s2, c2, l2, u2, d2));
  }, f2;
}
function Bn() {
  return a.apply(zn(ft, pt, G, st, Ye, B, Ge, Ue, z, Fn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
var Vn = p(((e2, t2) => {
  (function(n2, r2) {
  ...
  var e2 = l(function(e3, t3, n3, r3) {
  ...
  }, `anonymous`), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, e2(t2, [2, 2], { 5: 3 }), { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: 17, 12: n2, 13: r2, 14: i2, 15: a2, 16: o2, 17: s2, 18: c2, 19: 18, 20: u2, 21: d2, 22: f2, 23: p2, 24: m2, 25: h2, 26: g2, 27: _2, 28: v2, 29: y2, 30: b2, 31: x2, 33: S2, 35: C2, 36: w2, 37: 24, 38: T2, 40: E2 }, e2(t2, [2, 7], { 1: [2, 1] }), e2(t2, [2, 3]), { 9: 36, 11: 17, 12: n2, 13: r2, 14: i2, 15: a2, 16: o2, 17: s2, 18: c2, 19: 18, 20: u2, 21: d2, 22: f2, 23: p2, 24: m2, 25: h2, 26: g2, 27: _2, 28: v2, 29: y2, 30: b2, 31: x2, 33: S2, 35: C2, 36: w2, 37: 24, 38: T2, 40: E2 }, e2(t2, [2, 5]), e2(t2, [2, 6]), e2(t2, [2, 17]), e2(t2, [2, 18]), e2(t2, [2, 19]), e2(t2, [2, 20]), e2(t2, [2, 21]), e2(t2, [2, 22]), e2(t2, [2, 23]), e2(t2, [2, 24]), e2(t2, [2, 25]), e2(t2, [2, 26]), e2(t2, [2, 27]), { 32: [1, 37] }, { 34: [1, 38] }, e2(t2, [2, 30]), e2(t2, [2, 31]), e2(t2, [2, 32]), { 39: [1, 39] }, e2(t2, [2, 8]), e2(t2, [2, 9]), e2(t2, [2, 10]), e2(t2, [2, 11]), e2(t2, [2, 12]), e2(t2, [2, 13]), e2(t2, [2, 14]), e2(t2, [2, 15]), e2(t2, [2, 16]), { 41: [1, 40], 43: [1, 41] }, e2(t2, [2, 4]), e2(t2, [2, 28]), e2(t2, [2, 29]), e2(t2, [2, 33]), e2(t2, [2, 34], { 42: [1, 42], 43: [1, 43] }), e2(t2, [2, 40], { 41: [1, 44] }), e2(t2, [2, 35], { 43: [1, 45] }), e2(t2, [2, 36]), e2(t2, [2, 38], { 42: [1, 46] }), e2(t2, [2, 37]), e2(t2, [2, 39])], defaultActions: {}, parseError: l(function(e3, t3) {
    ...
    for (var S3, C3, w3, T3, E3, D3 = {}, O3, k2, ee2, te2; ; ) {
      if (w3 = n3[n3.length - 1], this.defaultActions[w3] ? T3 = this.defaultActions[w3] : (S3 ?? (S3 = x3()), T3 = o3[w3] && o3[w3][S3]), T3 === void 0 || !T3.length || !T3[0]) {
        var ne2 = ``;
        for (O3 in te2 = [], o3[w3]) this.terminals_[O3] && O3 > f3 && te2.push(`'` + this.terminals_[O3] + `'`);
        ne2 = h3.showPosition ? `Parse error on line ` + (c3 + 1) + `:
` + h3.showPosition() + `
Expecting ` + te2.join(`, `) + `, got '` + (this.terminals_[S3] || S3) + `'` : `Parse error on line ` + (c3 + 1) + `: Unexpected ` + (S3 == p3 ? `end of input` : `'` + (this.terminals_[S3] || S3) + `'`), this.parseError(ne2, { text: h3.match, token: this.terminals_[S3] || S3, line: h3.yylineno, loc: v3, expected: te2 });
      }
      if (T3[0] instanceof Array && T3.length > 1) throw Error(`Parse Error: multiple actions possible at state: ` + w3 + `, token: ` + S3);
      switch (T3[0]) {
        case 1:
          n3.push(S3), i3.push(h3.yytext), a3.push(h3.yylloc), n3.push(T3[1]), S3 = null, C3 ? (S3 = C3, C3 = null) : (u3 = h3.yyleng, s3 = h3.yytext, c3 = h3.yylineno, v3 = h3.yylloc, d3 > 0 && d3--);
          break;
        case 2:
          if (k2 = this.productions_[T3[1]][1], D3.$ = i3[i3.length - k2], D3._$ = { first_line: a3[a3.length - (k2 || 1)].first_line, last_line: a3[a3.length - 1].last_line, first_column: a3[a3.length - (k2 || 1)].first_column, last_column: a3[a3.length - 1].last_column }, y3 && (D3._$.range = [a3[a3.length - (k2 || 1)].range[0], a3[a3.length - 1].range[1]]), E3 = this.performAction.apply(D3, [s3, u3, c3, g3.yy, T3[1], i3, a3].concat(m3)), E3 !== void 0) return E3;
...
` + this.showPosition(), { text: ``, token: null, line: this.yylineno });
  ...
  return l(O2, `Parser`), O2.prototype = D2, D2.Parser = O2, new O2();
})();
Zn.parser = Zn;
var Qn = Zn;
Y.default.extend(Kn.default), Y.default.extend(qn.default), Y.default.extend(Jn.default);
var $n = { friday: 5, saturday: 6 }, X = ``, er = ``, tr = void 0, nr = ``, rr = [], ir = [], ar = /* @__PURE__ */ new Map(), or = [], sr = [], cr = ``, lr = ``, ur = [`active`, `done`, `crit`, `milestone`, `vert`], dr = [], fr = ``, pr = false, mr = false, hr = `sunday`, gr = `saturday`, _r = 0, vr = l(function() {
  or = [], sr = [], cr = ``, dr = [], Zr = 0, ti = void 0, ni = void 0, Z = [], X = ``, er = ``, lr = ``, tr = void 0, nr = ``, rr = [], ir = [], pr = false, mr = false, _r = 0, ar = /* @__PURE__ */ new Map(), fr = ``, T(), hr = `sunday`, gr = `saturday`;
}, `clear`), yr = l(function(e2) {
  fr = e2;
}, `setDiagramId`), br = l(function(e2) {
  er = e2;
}, `setAxisFormat`), xr = l(function() {
  return er;
}, `getAxisFormat`), Sr = l(function(e2) {
  tr = e2;
}, `setTickInterval`), Cr = l(function() {
  return tr;
}, `getTickInterval`), wr = l(function(e2) {
  nr = e2;
}, `setTodayMarker`), Tr = l(function() {
  return nr;
}, `getTodayMarker`), Er = l(function(e2) {
  X = e2;
}, `setDateFormat`), Dr = l(function() {
  pr = true;
}, `enableInclusiveEndDates`), Or = l(function() {
  return pr;
}, `endDatesAreInclusive`), kr = l(function() {
  mr = true;
}, `enableTopAxis`), Ar = l(function() {
  return mr;
}, `topAxisEnabled`), jr = l(function(e2) {
  lr = e2;
}, `setDisplayMode`), Mr = l(function() {
  return lr;
}, `getDisplayMode`), Nr = l(function() {
  return X;
}, `getDateFormat`), Pr = l(function(e2) {
  rr = e2.toLowerCase().split(/[\s,]+/);
}, `setIncludes`), Fr = l(function() {
  return rr;
}, `getIncludes`), Ir = l(function(e2) {
  ir = e2.toLowerCase().split(/[\s,]+/);
}, `setExcludes`), Lr = l(function() {
  return ir;
}, `getExcludes`), Rr = l(function() {
  return ar;
}, `getLinks`), zr = l(function(e2) {
  cr = e2, or.push(e2);
}, `addSection`), Br = l(function() {
  return or;
}, `getSections`), Vr = l(function() {
  let e2 = oi(), t2 = 0;
  for (; !e2 && t2 < 10; ) e2 = oi(), t2++;
  return sr = Z, sr;
}, `getTasks`), Hr = l(function(e2, t2, n2, r2) {
...
}, `isInvalidDate`), Ur = l(function(e2) {
  hr = e2;
}, `setWeekday`), Wr = l(function() {
  return hr;
}, `getWeekday`), Gr = l(function(e2) {
  gr = e2;
}, `setWeekend`), Kr = l(function(e2, t2, n2, r2) {
  ...
  return o2.toDate();
}, `getEndDate`), Zr = 0, Qr = l(function(e2) {
  return e2 === void 0 ? (Zr += 1, `task` + Zr) : e2;
}, `parseId`), $r = l(function(e2, t2) {
  let n2;
...
}, `compileData`), ei = l(function(e2, t2) {
  let n2;
  n2 = t2.substr(0, 1) === `:` ? t2.substr(1, t2.length) : t2;
  let r2 = n2.split(`,`), i2 = {};
  fi(r2, i2, ur);
  ...
  return i2;
}, `parseData`), ti, ni, Z = [], ri = {}, ii = l(function(e2, t2) {
...
}, `addTask`), Q = l(function(e2) {
  let t2 = ri[e2];
  return Z[t2];
}, `findTaskById`), ai = l(function(e2, t2) {
  ...
  return t2;
}, `compileTasks`), si = l(function(e2, t2) {
  let n2 = t2;
  m().securityLevel !== `loose` && (n2 = (0, Gn.sanitizeUrl)(t2)), e2.split(`,`).forEach(function(e3) {
    Q(e3) !== void 0 && (ui(e3, () => {
      window.open(n2, `_self`);
    }), ar.set(e3, n2));
  }), ci(e2, `clickable`);
}, `setLink`), ci = l(function(e2, t2) {
  e2.split(`,`).forEach(function(e3) {
    let n2 = Q(e3);
    n2 !== void 0 && n2.classes.push(t2);
  });
}, `setClass`), li = l(function(e2, t2, n2) {
  if (m().securityLevel !== `loose` || t2 === void 0) return;
  let r2 = [];
  if (typeof n2 == `string`) {
    r2 = n2.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
...
}, `setClickFun`), ui = l(function(e2, t2) {
  dr.push(function() {
...
}, `pushFun`), di = { getConfig: l(() => m().gantt, `getConfig`), clear: vr, setDateFormat: Er, getDateFormat: Nr, enableInclusiveEndDates: Dr, endDatesAreInclusive: Or, enableTopAxis: kr, topAxisEnabled: Ar, setAxisFormat: br, getAxisFormat: xr, setTickInterval: Sr, getTickInterval: Cr, setTodayMarker: wr, getTodayMarker: Tr, setAccTitle: f, getAccTitle: v, setDiagramTitle: c, getDiagramTitle: s, setDiagramId: yr, setDisplayMode: jr, getDisplayMode: Mr, setAccDescription: u, getAccDescription: ee, addSection: zr, getSections: Br, getTasks: Vr, addTask: ii, findTaskById: Q, addTaskOrg: ai, setIncludes: Pr, getIncludes: Fr, setExcludes: Ir, getExcludes: Lr, setClickEvent: l(function(e2, t2, n2) {
  e2.split(`,`).forEach(function(e3) {
    li(e3, t2, n2);
  }), ci(e2, `clickable`);
}, `setClickEvent`), setLink: si, getLinks: Rr, bindFunctions: l(function(e2) {
...
l(fi, `getTaskTags`), Yn.default.extend(Xn.default);
var pi = l(function() {
  g.debug(`Something is calling, setConf, remove the call`);
}, `setConf`), mi = { monday: Xe, tuesday: Ze, wednesday: Qe, thursday: H, friday: $e, saturday: et, sunday: Ye }, hi = l((e2, t2) => {
  ...
  return i2;
}, `getMaxIntersections`), $, gi = 1e4, _i = { parser: Qn, db: di, renderer: { setConf: pi, draw: l(function(e2, t2, n2, r2) {
  let a2 = m().gantt;
  r2.db.setDiagramId(t2);
  let o2 = m().securityLevel, s2;
  o2 === `sandbox` && (s2 = k(`#i` + t2));
  let c2 = k(o2 === `sandbox` ? s2.nodes()[0].contentDocument.body : `body`), u2 = o2 === `sandbox` ? s2.nodes()[0].contentDocument : document, d2 = u2.getElementById(t2);
  $ = d2.parentElement.offsetWidth, $ === void 0 && ($ = 1200), a2.useWidth !== void 0 && ($ = a2.useWidth);
  let f2 = r2.db.getTasks(), p2 = [];
  for (let e3 of f2) p2.push(e3.type);
  p2 = re2(p2);
  let h2 = {}, _2 = 2 * a2.topPadding;
  if (r2.db.getDisplayMode() === `compact` || a2.displayMode === `compact`) {
    let e3 = {};
    for (let t4 of f2) e3[t4.section] === void 0 ? e3[t4.section] = [t4] : e3[t4.section].push(t4);
    let t3 = 0;
    for (let n3 of Object.keys(e3)) {
      let r3 = hi(e3[n3], t3) + 1;
      t3 += r3, _2 += r3 * (a2.barHeight + a2.barGap), h2[n3] = r3;
    }
  } else {
    _2 += f2.length * (a2.barHeight + a2.barGap);
    for (let e3 of p2) h2[e3] = f2.filter((t3) => t3.type === e3).length;
  }
  d2.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + _2);
  let v2 = c2.select(`[id="${t2}"]`), y2 = Bn().domain([ne(f2, function(e3) {
    return e3.startTime;
  }), te(f2, function(e3) {
    return e3.endTime;
  })]).rangeRound([0, $ - a2.leftPadding - a2.rightPadding]);
  function S2(e3, t3) {
    let n3 = e3.startTime, r3 = t3.startTime, i2 = 0;
    return n3 > r3 ? i2 = 1 : n3 < r3 && (i2 = -1), i2;
  }
  l(S2, `taskCompare`), f2.sort(S2), C2(f2, $, _2), b(v2, _2, $, a2.useMaxWidth), v2.append(`text`).text(r2.db.getDiagramTitle()).attr(`x`, $ / 2).attr(`y`, a2.titleTopMargin).attr(`class`, `titleText`);
  function C2(e3, t3, n3) {
    let o3 = a2.barHeight, s3 = o3 + a2.barGap, c3 = a2.topPadding, l2 = a2.leftPadding, u3 = i().domain([0, p2.length]).range([`#00B9FA`, `#F95002`]).interpolate(Ie);
    T2(s3, c3, l2, t3, n3, e3, r2.db.getExcludes(), r2.db.getIncludes()), D2(l2, c3, t3, n3), w2(e3, s3, c3, l2, o3, u3, t3, n3), O2(s3, c3, l2, o3, u3), ee2(l2, c3, t3, n3);
  }
  l(C2, `makeGantt`);
  function w2(e3, n3, i2, o3, s3, c3, l2) {
    e3.sort((e4, t3) => e4.vert === t3.vert ? 0 : e4.vert ? 1 : -1);
    let u3 = [...new Set(e3.map((e4) => e4.order))].map((t3) => e3.find((e4) => e4.order === t3));
    v2.append(`g`).selectAll(`rect`).data(u3).enter().append(`rect`).attr(`x`, 0).attr(`y`, function(e4, t3) {
      return t3 = e4.order, t3 * n3 + i2 - 2;
    }).attr(`width`, function() {
      return l2 - a2.rightPadding / 2;
    }).attr(`height`, n3).attr(`class`, function(e4) {
      for (let [t3, n4] of p2.entries()) if (e4.type === n4) return `section section` + t3 % a2.numberSectionStyles;
      return `section section0`;
    }).enter();
    let d3 = v2.append(`g`).selectAll(`rect`).data(e3).enter(), h3 = r2.db.getLinks();
    if (d3.append(`rect`).attr(`id`, function(e4) {
      return t2 + `-` + e4.id;
    }).attr(`rx`, 3).attr(`ry`, 3).attr(`x`, function(e4) {
      return e4.milestone ? y2(e4.startTime) + o3 + 0.5 * (y2(e4.endTime) - y2(e4.startTime)) - 0.5 * s3 : y2(e4.startTime) + o3;
    }).attr(`y`, function(e4, t3) {
      return t3 = e4.order, e4.vert ? a2.gridLineStartPadding : t3 * n3 + i2;
    }).attr(`width`, function(e4) {
      return e4.milestone ? s3 : e4.vert ? 0.08 * s3 : y2(e4.renderEndTime || e4.endTime) - y2(e4.startTime);
    }).attr(`height`, function(e4) {
      return e4.vert ? f2.length * (a2.barHeight + a2.barGap) + a2.barHeight * 2 : s3;
    }).attr(`transform-origin`, function(e4, t3) {
      return t3 = e4.order, (y2(e4.startTime) + o3 + 0.5 * (y2(e4.endTime) - y2(e4.startTime))).toString() + `px ` + (t3 * n3 + i2 + 0.5 * s3).toString() + `px`;
    }).attr(`class`, function(e4) {
      let t3 = ``;
      e4.classes.length > 0 && (t3 = e4.classes.join(` `));
      let n4 = 0;
      for (let [t4, r4] of p2.entries()) e4.type === r4 && (n4 = t4 % a2.numberSectionStyles);
      let r3 = ``;
    ...
    }), d3.append(`text`).attr(`id`, function(e4) {
      return t2 + `-` + e4.id + `-text`;
    }).text(function(e4) {
      return e4.task;
    }).attr(`font-size`, a2.fontSize).attr(`x`, function(e4) {
      let t3 = y2(e4.startTime), n4 = y2(e4.renderEndTime || e4.endTime);
      if (e4.milestone && (t3 += 0.5 * (y2(e4.endTime) - y2(e4.startTime)) - 0.5 * s3, n4 = t3 + s3), e4.vert) return y2(e4.startTime) + o3;
      let r3 = this.getBBox().width;
      return r3 > n4 - t3 ? n4 + r3 + 1.5 * a2.leftPadding > l2 ? t3 + o3 - 5 : n4 + o3 + 5 : (n4 - t3) / 2 + t3 + o3;
    }).attr(`y`, function(e4, t3) {
      return e4.vert ? a2.gridLineStartPadding + f2.length * (a2.barHeight + a2.barGap) + 60 : (t3 = e4.order, t3 * n3 + a2.barHeight / 2 + (a2.fontSize / 2 - 2) + i2);
    }).attr(`text-height`, s3).attr(`class`, function(e4) {
      let t3 = y2(e4.startTime), n4 = y2(e4.endTime);
      e4.milestone && (n4 = t3 + s3);
      let r3 = this.getBBox().width, i3 = ``;
      e4.classes.length > 0 && (i3 = e4.classes.join(` `));
      let o4 = 0;
      for (let [t4, n5] of p2.entries()) e4.type === n5 && (o4 = t4 % a2.numberSectionStyles);
      let c4 = ``;
      return e4.active && (c4 = e4.crit ? `activeCritText` + o4 : `activeText` + o4), e4.done ? c4 = e4.crit ? c4 + ` doneCritText` + o4 : c4 + ` doneText` + o4 : e4.crit && (c4 = c4 + ` critText` + o4), e4.milestone && (c4 += ` milestoneText`), e4.vert && (c4 += ` vertText`), r3 > n4 - t3 ? n4 + r3 + 1.5 * a2.leftPadding > l2 ? i3 + ` taskTextOutsideLeft taskTextOutside` + o4 + ` ` + c4 : i3 + ` taskTextOutsideRight taskTextOutside` + o4 + ` ` + c4 + ` width-` + r3 : i3 + ` taskText taskText` + o4 + ` ` + c4 + ` width-` + r3;
    }), m().securityLevel === `sandbox`) {
      let e4;
      e4 = k(`#i` + t2);
      let n4 = e4.nodes()[0].contentDocument;
      d3.filter(function(e5) {
        return h3.has(e5.id);
      }).each(function(e5) {
        var r3 = n4.querySelector(`#` + CSS.escape(t2 + `-` + e5.id)), i3 = n4.querySelector(`#` + CSS.escape(t2 + `-` + e5.id + `-text`));
        let a3 = r3.parentNode;
        var o4 = n4.createElement(`a`);
        o4.setAttribute(`xlink:href`, h3.get(e5.id)), o4.setAttribute(`target`, `_top`), a3.appendChild(o4), o4.appendChild(r3), o4.appendChild(i3);
      });
    }
  }
  l(w2, `drawRects`);
  function T2(e3, n3, i2, o3, s3, c3, l2, u3) {
    if (l2.length === 0 && u3.length === 0) return;
    let d3, f3;
    for (let { startTime: e4, endTime: t3 } of c3) (d3 === void 0 || e4 < d3) && (d3 = e4), (f3 === void 0 || t3 > f3) && (f3 = t3);
    if (!d3 || !f3) return;
    ...
    let p3 = r2.db.getDateFormat(), m2 = [], h3 = null, _3 = (0, Yn.default)(d3);
    for (; _3.valueOf() <= f3; ) r2.db.isInvalidDate(_3, p3, l2, u3) ? h3 ? h3.end = _3 : h3 = { start: _3, end: _3 } : h3 && (h3 = (m2.push(h3), null)), _3 = _3.add(1, `d`);
    v2.append(`g`).selectAll(`rect`).data(m2).enter().append(`rect`).attr(`id`, (e4) => t2 + `-exclude-` + e4.start.format(`YYYY-MM-DD`)).attr(`x`, (e4) => y2(e4.start.startOf(`day`)) + i2).attr(`y`, a2.gridLineStartPadding).attr(`width`, (e4) => y2(e4.end.endOf(`day`)) - y2(e4.start.startOf(`day`))).attr(`height`, s3 - n3 - a2.gridLineStartPadding).attr(`transform-origin`, function(t3, n4) {
      return (y2(t3.start) + i2 + 0.5 * (y2(t3.end) - y2(t3.start))).toString() + `px ` + (n4 * e3 + 0.5 * s3).toString() + `px`;
    }).attr(`class`, `exclude-range`);
  }
  l(T2, `drawExcludeDays`);
  function E2(e3, t3, n3, r3) {
    if (n3 <= 0 || e3 > t3) return 1 / 0;
    let i2 = t3 - e3, a3 = Yn.default.duration({ [r3 ?? `day`]: n3 }).asMilliseconds();
    return a3 <= 0 ? 1 / 0 : Math.ceil(i2 / a3);
  }
  l(E2, `getEstimatedTickCount`);
  function D2(e3, t3, n3, i2) {
    let o3 = r2.db.getDateFormat(), s3 = r2.db.getAxisFormat(), c3;
    c3 = s3 || (o3 === `D` ? `%d` : a2.axisFormat ?? `%Y-%m-%d`);
    let l2 = ge(y2).tickSize(-i2 + t3 + a2.gridLineStartPadding).tickFormat(Fn(c3)), u3 = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(r2.db.getTickInterval() || a2.tickInterval);
    if (u3 !== null) {
      let e4 = parseInt(u3[1], 10);
      if (isNaN(e4) || e4 <= 0) g.warn(`Invalid tick interval value: "${u3[1]}". Skipping custom tick interval.`);
      else {
        let t4 = u3[2], n4 = r2.db.getWeekday() || a2.weekday, i3 = y2.domain(), o4 = i3[0], s4 = i3[1], c4 = E2(o4, s4, e4, t4);
        if (c4 > gi) g.warn(`The tick interval "${e4}${t4}" would generate ${c4} ticks, which exceeds the maximum allowed (${gi}). This may indicate an invalid date or time range. Skipping custom tick interval.`);
        else switch (t4) {
          case `millisecond`:
            l2.ticks(P.every(e4));
            break;
    ...
    if (v2.append(`g`).attr(`class`, `grid`).attr(`transform`, `translate(` + e3 + `, ` + (i2 - 50) + `)`).call(l2).selectAll(`text`).style(`text-anchor`, `middle`).attr(`fill`, `#000`).attr(`stroke`, `none`).attr(`font-size`, 10).attr(`dy`, `1em`), r2.db.topAxisEnabled() || a2.topAxis) {
      let n4 = he(y2).tickSize(-i2 + t3 + a2.gridLineStartPadding).tickFormat(Fn(c3));
      if (u3 !== null) {
        let e4 = parseInt(u3[1], 10);
        if (isNaN(e4) || e4 <= 0) g.warn(`Invalid tick interval value: "${u3[1]}". Skipping custom tick interval.`);
        else {
          let t4 = u3[2], i3 = r2.db.getWeekday() || a2.weekday, o4 = y2.domain(), s4 = o4[0], c4 = o4[1];
          if (E2(s4, c4, e4, t4) <= gi) switch (t4) {
            case `millisecond`:
              n4.ticks(P.every(e4));
              break;
            case `second`:
      ...
      v2.append(`g`).attr(`class`, `grid`).attr(`transform`, `translate(` + e3 + `, ` + t3 + `)`).call(n4).selectAll(`text`).style(`text-anchor`, `middle`).attr(`fill`, `#000`).attr(`stroke`, `none`).attr(`font-size`, 10);
    }
  }
  l(D2, `makeGrid`);
  function O2(e3, t3) {
    let n3 = 0, r3 = Object.keys(h2).map((e4) => [e4, h2[e4]]);
    v2.append(`g`).selectAll(`text`).data(r3).enter().append(function(e4) {
      let t4 = e4[0].split(x.lineBreakRegex), n4 = -(t4.length - 1) / 2, r4 = u2.createElementNS(`http://www.w3.org/2000/svg`, `text`);
      r4.setAttribute(`dy`, n4 + `em`);
      for (let [e5, n5] of t4.entries()) {
        let t5 = u2.createElementNS(`http://www.w3.org/2000/svg`, `tspan`);
      ...
      return r4;
    }).attr(`x`, 10).attr(`y`, function(i2, a3) {
      if (a3 > 0) for (let o3 = 0; o3 < a3; o3++) return n3 += r3[a3 - 1][1], i2[1] * e3 / 2 + n3 * e3 + t3;
      else return i2[1] * e3 / 2 + t3;
    }).attr(`font-size`, a2.sectionFontSize).attr(`class`, function(e4) {
      for (let [t4, n4] of p2.entries()) if (e4[0] === n4) return `sectionTitle sectionTitle` + t4 % a2.numberSectionStyles;
      return `sectionTitle`;
    });
  }
  l(O2, `vertLabels`);
  function ee2(e3, t3, n3, i2) {
    let o3 = r2.db.getTodayMarker();
    if (o3 === `off`) return;
    let s3 = v2.append(`g`).attr(`class`, `today`), c3 = /* @__PURE__ */ new Date(), l2 = s3.append(`line`);
    l2.attr(`x1`, y2(c3) + e3).attr(`x2`, y2(c3) + e3).attr(`y1`, a2.titleTopMargin).attr(`y2`, i2 - a2.titleTopMargin).attr(`class`, `today`), o3 !== `` && l2.attr(`style`, o3.replace(/,/g, `;`));
  }
  l(ee2, `drawToday`);
  function re2(e3) {
    let t3 = {}, n3 = [];
    for (let r3 = 0, i2 = e3.length; r3 < i2; ++r3) Object.prototype.hasOwnProperty.call(t3, e3[r3]) || (t3[e3[r3]] = true, n3.push(e3[r3]));
    return n3;
  }
  l(re2, `checkUnique`);
}, `draw`) }, styles: l((e2) => `
